...
{
$find_field=db_query("SELECT a.DOMAIN_DESC FROM domai a, personnel_basic_info b WHERE b.PBI_DOMAIN=a.DOMAIN_CODE and b.PBI_ID='$employee_selected'");
//var_dump($find_field);
$fo=mysqli_fetch_row($find_field);
//print_r($fo);

$find_department=db_query("SELECT a.DEPT_DESC FROM department a, personnel_basic_info b WHERE b.PBI_DEPARTMENT=a.DEPT_ID and b.PBI_ID='$employee_selected'");
$find_de=mysqli_fetch_row($find_department);


$find_designation=db_query("SELECT a.DESG_DESC FROM designation a, personnel_basic_info b WHERE b.PBI_DESIGNATION=a.DESG_ID and b.PBI_ID='$employee_selected'");
$find_des=mysqli_fetch_row($find_designation);


$find_job_status=db_query("SELECT a.job_status FROM job_status a, personnel_basic_info b WHERE b.PBI_JOB_STATUS=a.id and b.PBI_ID='$employee_selected'");
$find_job=mysqli_fetch_row($find_job_status);


$find_office_time=db_query("SELECT a.schedule_name FROM hrm_schedule_info a, personnel_basic_info b WHERE b.office_time=a.id and b.PBI_ID='$employee_selected'");
$find_time=mysqli_fetch_row($find_office_time);


$place_birth=db_query("SELECT a.ZONE_NAME FROM zon a, personnel_basic_info b WHERE b.PBI_POB=a.ZONE_CODE and b.PBI_ID='$employee_selected'");
$find_bir=mysqli_fetch_row($place_birth);


$find_edu_qua=db_query("SELECT a.EDU_QUA_DESC FROM edu_qua a, personnel_basic_info b WHERE b.PBI_EDU_QUALIFICATION=a.EDU_QUA_CODE and b.PBI_ID='$employee_selected'");
$find_edu=mysqli_fetch_row($find_edu_qua);
