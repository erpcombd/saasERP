  ...
  <form class="n-form1 fo-width pt-4" action="../od_report/master_report.php" autocomplete="off" method="post" name="form1" target="_blank" id="form1">
    <div class="row m-0 p-0">
      <div class="col-sm-5">
        ...
        <div class="form-check">
          <input name="report" type="radio" class="radio1" value="226644" tabindex="1"/>
          <label class="form-check-label p-0" for="report1-btn">
        ...
        <div class="form-check">
          <input name="report" type="radio" class="radio1" value="201912" tabindex="1"/>
          <label class="form-check-label p-0" for="report1-btn">
            OD Report (201912)
          </label>
        </div>
        ...
        <div class="form-check">
          <input name="report" type="radio" class="radio1" value="201914" tabindex="1"/>
          <label class="form-check-label p-0" for="report1-btn">
            Not Approved OD Report (201914)
          </label>
        </div>

        <div class="form-check">
          <input name="report" type="radio" class="radio1" value="999" tabindex="1"/>
          <label class="form-check-label p-0" for="report1-btn">
            Progress Repor (999)
          </label>
        </div>
