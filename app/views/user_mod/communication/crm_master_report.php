...
if($_POST['emp_code']!=''){ $contact_con = " and b.emp_code='".$_POST['emp_code']."' ";}

if($_POST['con_type']!=''){ $types = " and b.conveyance_type='".$_POST['con_type']."' ";}



if($_POST['f_date']!='' && $_POST['t_date']!=''){ $service_con = " and b.conveyance_date between '".$_POST['f_date']."' and  '".$_POST['t_date']."' ";}
...
<table width="100%" cellspacing="0" cellpadding="0" border="1" style="border-collapse:collapse; font-size:14px; font-family:'Times New Roman', Times, serif; padding:5px;">
...
<?
 ...
 $sqld="select b.*,a.PBI_NAME,a.PBI_MOBILE


from personnel_basic_info a,bills b

where a.PBI_CODE=b.emp_code and b.status!='Pending' ".$project_con.$contact_con.$service_con.$types.$status_con." order by b.conveyance_date";
...
<tr <? ++$sl; if(($sl%2)==0) { echo "style='background: #F0F0F0'" ;} ?>>
  ...
  <td align="center"><?=$data->emp_code?> </td>
  <td align="center"><?=$data->conveyance_no?> </td>

  <td><?=$data->PBI_NAME?></td>

  <td align="center"><?=$data->PBI_MOBILE?></td>

  <td align="center"><?=$data->conveyance_date?></td>

  <td align="center"><?=$data->from_address?></td>

  <td align="center"><?=$data->to_address?></td>

  <td align="right"><?=$data->conveyance_type?></td>
	<td align="right"><?=$data->status?></td>

  <td align="right"><?=$data->amount; $amount_tot +=$data->amount;?></td>

  <td align="right"><?=$data->means?></td>
 <td align="right"><?=$data->remarks?></td>
 
 <td align="right"><?=$data->hr_remarks?></td>
...
<td align="right"><strong><?=number_format($amount_tot,2)?></strong></td>
