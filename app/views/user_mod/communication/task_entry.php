...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <?   $res='select c.id,c.contact_person,cc.organization,c.return_note,c.total_bill,c.overcome as service,c.c_time as contact_time, c.c_date as contact_date,c_reason from crm_comunication c,crm_customer_info cc where 1 and cc.dealer_code=c.customer_name and c.entry_by="'.$_SESSION['employee_selected'].'" and c.status in ("PENDING","MANUAL") order by c.id desc ';
        ...
        <thead style="background: #1ABB9C;">
            ...
            <tr><th>Feedback</th><th>Contact Person</th><th>Organization</th><th>Contact Date</th><th>Return</th><th>Total Bill</th>
