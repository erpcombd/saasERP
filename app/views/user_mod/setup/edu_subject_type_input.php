...
// ::::: Edit This Section ::::: 
$title='Education Subjet Type Information';			// Page Name and Page Title
$page="edu_subject_type.php";		// PHP File Name
$input_page="edu_subject_type_input.php";
$root='setup';

$table='edu_subject';		// Database Table Name Mainly related to this page
$unique='SUBJECT_CODE';			// Primary Key of this Database table
$shown='SUBJECT_NAME';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Education Type :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="SUBJECT_NAME" type="text" id="SUBJECT_NAME" value="<?=$SUBJECT_NAME?>" /></td>
