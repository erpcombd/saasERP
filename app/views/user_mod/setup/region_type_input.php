...
// ::::: Edit This Section ::::: 
$title='Region Information';			// Page Name and Page Title
$page="region_type.php";		// PHP File Name
$input_page="region_type_input.php";
$root='setup';

$table='region';		// Database Table Name Mainly related to this page
$unique='region_id';			// Primary Key of this Database table
$shown='region_name';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Region Name :</td>
                  ...
                  <input name="region_name" type="text" id="region_name" value="<?=$region_name?>" /></td>
