...
// ::::: Edit This Section ::::: 
$title='Category Manage';			// Page Name and Page Title
$page="category_manage.php";		// PHP File Name
$input_page="category_manage_input.php";
$root='inventory';

$table='inv_item_category';		// Database Table Name Mainly related to this page
       ...
       <form action="" method="post"> <div class="ui-dialog ui-widget ui-widget-content ui-corner-all oe_act_window ui-draggable ui-resizable openerp" style="outline: 0px none; z-index: 1002; position: absolute; height: auto; width: 900px; display: block; /* [disabled]left: 217.5px; */" tabindex="-1" role="dialog" aria-labelledby="ui-id-19">
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
                ...
                <tr class="oe_form_group_row">
                  <td width="1%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Category:</td>
                  <td width="99%" colspan="1" class="oe_form_group_cell"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                    <input name="category_name" type="text" id="category_name" value="<?=$category_name?>" /></td>
                </tr>
                </tbody></table></td><td colspan="1" class="oe_form_group_cell oe_group_right" width="50%"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row"><td colspan="1" class="oe_form_group_cell oe_form_group_cell_label" width="1%"><label>Category Type:</label></td><td colspan="1" class="oe_form_group_cell" width="99%"><input name="category_type" type="text" id="category_type" value="<?=$category_type?>" /></td></tr></tbody></table></td></tr></tbody></table></div>
                      </div>
                    </div>
                  </div>
                </div>
