...
<table width="100%" border="1" cellspacing="5" cellpadding="2" align="center" style="padding:5px;">
       ...
       <table width="100%" border="1" cellspacing="5" cellpadding="2" align="center" style="padding:5px;">
		<tr height="30" style="background:#00CCFF">
		  ...
		  <td width="15%"><div align="center"><strong>Submitted</strong></div></td>
	  ...
	  <?
	    $ssql = 'select * from kpi_log_sheet where PBI_ID="'.$_GET['id'].'"';
		$qr = db_query($ssql);
		while($task_data=mysqli_fetch_object($qr)){
	  ?>
	 <tr>
		  <td width="10%"><div align="center"><strong><?=++$i?></strong></div></td>
		  <td width="60%"><div align="center"><?=$task_data->task_name?></div></td>
		  <td width="15%"><div align="center"><strong><select name="submitted" id="submitted" style="width: 95%;
    border-radius: 0px;height: 40px;margin-top: 1%;"><option></option><option>YES</option><option>NO</option></select></strong></div></td>
		  <td width="10%">
		   <table width="50%">
		   <tr>
		     <td><input type="checkbox" name="c" id="c" style="width:60px;"/></td><td>Check</td>
		  </tr>
		  </table>
		  </td>
