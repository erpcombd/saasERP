...
<form action="master_report.php" target="_blank" method="post" autocomplete="off">
                        ...
                        <table width="100%" border="0" class="oe_list_content">
                          ...
                          <thead>
                            ...
                            <tr class="oe_list_header_columns">
                              ...
                              <th colspan="4"><span style="text-align: center; font-size:19px; color:#35b1ea"><center>KPI REPORT</center></span></th>
                            ...
                            <tr >
                              ...
                              <td align="left">
							   ...
							   <?
							     ...
							     $check = find_a_field('hrm_kpi_set','PBI_ID','LINE_MANAGER="'.$_SESSION['employee_selected'].'"');
...
<input type="text"  list='eip_ids' name="PBI_ID" id="PBI_ID" value="<?=$_POST['PBI_ID']?>" />
<datalist id='eip_ids'>
  <option></option>
  <?
foreign_relation('personnel_basic_info','PBI_CODE','concat(PBI_NAME)',$PBI_ID,'1');
?>
...
<div id="suggesstion-box"></div>
							  ...
							  <input type="text" id="PBI_CODE" name="PBI_CODE" value="<?=find_a_field('personnel_basic_info','PBI_CODE','PBI_ID="'.$_SESSION['employee_selected'].'"');?>" readonly="readonly" />

							   <input type="hidden" id="PBI_ID" name="PBI_ID" value="<?=$_SESSION['employee_selected']?>" readonly="readonly" />
                            ...
                            <tr >
                             ...
                             <td align="right" style="background-color:#35b1ea; color:#FFFFFF; font-size:16px"><span>Month:</span> </td>
                              ...
                              <!--  <select name="kpi_weeks" style="width:160px;" id="kpi_weeks">

                                  <? // foreign_relation('hrm_weeks','week_name','week_name',$kpi_weeks);?>
                          ...
                          <table width="100%" class="oe_list_content">
                            ...
                            <tbody>
							   ...
							   <tr >
                                ...
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="878" /></td>

                                <td class="alt"><strong>KPI Report (Individual)</strong><strong></strong></td>
							  ...
							  <tr >
                                ...
                                <td class="alt"><strong>KPI Report (Final)</strong><strong></strong></td>
							...
							<!--  
                                ...
                                <td class="alt"><strong>Report (Individual)</strong><strong></strong></td>
							  ...
							  <tr >
                                ...
                                <td class="alt"><strong>Report (Final)</strong><strong></strong></td>
