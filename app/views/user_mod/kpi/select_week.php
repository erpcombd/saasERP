...
$appraiser = find_all_field('personnel_basic_info','','PBI_ID="'.$PBI_ID.'"');
...
$required_id=find_a_field($table,$unique,'PBI_ID='.$PBI_ID);
...
$$unique = $_SESSION['employee_selected']=$_POST['PBI_ID'];*/
...

	{
		...
		if($_FILES['emp_pic']['tmp_name']!=''){
			...
			move_uploaded_file($file_tmp, $path.$PBI_ID.'.jpeg');
...
$data = find_all_field('personnel_basic_info','','PBI_ID='.$PBI_ID);
