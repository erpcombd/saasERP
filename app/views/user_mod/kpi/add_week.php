...
// if(isset($$unique)) $$unique=mysqli_last_insert_id($conn);
...
<table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	   ...
	   <? 	 $res = 'select id,week_name,date_format(s_date,"%d-%b-%y") as start_date,date_format(e_date,"%d-%b-%y") as end_date from hrm_weeks where 1 order by s_date';
