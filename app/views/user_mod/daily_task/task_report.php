...
<tr class="oe_list_header_columns">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td width="4%" align="center"><input name="report" type="radio" class="radio" value="420" checked="checked" /></td>



      <td width="44%"><strong> Task Status Report </strong><strong></strong></td>
      ...
      <td width="4%" align="center"><input name="report" type="radio" class="radio" value="5482"/></td>
