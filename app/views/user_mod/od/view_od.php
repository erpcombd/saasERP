...
$title='My OD Status';			// Page Name and Page Title
...
.thead,tr{
    ...
    color: #000000; background-color:#D4EDDA;
...
if($PBI_ID>0)
   ...
   a.PBI_ID='".$PBI_ID."' and o.od_date between '".$g_s_date."' and '".$g_e_date."' order by o.s_date desc";
...
where a.DESG_ID=c.DESG_ID and a.DEPT_ID=d.DEPT_ID  and a.PBI_ID=o.PBI_ID  order by o.id desc";
