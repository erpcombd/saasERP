            ...
            <td class="oe_form_group_cell"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0">
              <tbody>
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="total_installment" type="text" id="total_installment" value="<?=$total_installment?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
				  ...
				  <select name="start_mon" style="width:160px;" id="start_mon" required>
	    <option value="0" <?=($start_mon=='0')?'selected':''?>></option>
...
<option <?=($start_year=='0')?'selected':''?>></option>
