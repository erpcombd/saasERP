...
echo $old_iom = find_a_field('hrm_att_summary','iom_sl_no',' att_date between "'.$_REQUEST['f_date'].'" and  "'.$_REQUEST['t_date'].'" and  emp_id="'.$emp_id.'" and iom_sl_no>0');
...
<div class="oe_view_manager oe_view_manager_current">
                      ...
                      <div  class="oe_list oe_view">
                        <table width="80%" border="1" align="center">
                          ...
                          <tr>
                            ...
                            <td><input type="text" name="f_date" id="f_date" style="width:100px;" value="<?=$f_date?>"  /></td>
                            <td align="right"><div align="right">TO:</div></td>
                            <td><input type="text" name="t_date" id="t_date" style="width:100px;" value="<?=$t_date?>"  /></td>
                          </tr>
                          <tr>
                            <td colspan="5"><label>
                              <div align="center">
 ...
 <table class="oe_list_content"><thead><tr class="oe_list_header_columns"><th>Id</th><th>Emp Id</th><th>Iom Type</th>
   <th>Iom No</th>
