...
var strURL="monthly_attendence_delete_ajax.php?PBI_ID="+PBI_ID+"&td="+td+"&fd="+fd+"&od="+od+"&hd="+hd+"&lt="+lt+"&ab="+ab+"&lv="+lv+"&lwp="+lwp+"&pre="+pre+"&pay="+pay+"&deduction="+deduction+"&mon="+mon+"&year="+year+"&bonus="+bonus+"&benefits="+benefits;
...
var strURL="monthly_attendence_ajax.php?PBI_ID="+PBI_ID+"&td="+td+"&fd="+fd+"&od="+od+"&hd="+hd+"&lt="+lt+"&ab="+ab+"&lv="+lv+"&lwp="+lwp+"&pre="+pre+"&pay="+pay+"&mon="+mon+"&year="+year+"&benefits="+benefits;
...
<tr class="oe_list_header_columns">
  ...
  <tr >
    ...
    <td align="left" class="alt"><span class="oe_form_group_cell">
      <select name="PBI_BRANCH" style="width:160px;" id="PBI_BRANCH">
	  <option></option>
...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <div class="oe_view_manager_view_list"><div class="oe_list oe_view">
          <? if(isset($_POST['create'])){?>
		<table width="100%" class="oe_list_content"><thead>
...
<td style="color: #FF0000"><b><?=$info->PBI_NAME?></b></td>
<? }else{ ?>
<td><?=$info->PBI_NAME?></td>
<? } ?>
...
<td align="center">
<input name="ab_<?=$info->PBI_ID?>" type="text" id="ab_<?=$info->PBI_ID?>" style="font-size:10px; width:40px; min-width:40px;" 
