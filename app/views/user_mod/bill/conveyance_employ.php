                      ...
                      <thead  class="thead1">
                        ...
                        <tr class="bgc-info">
			             ...
			             <th style="text-align: center">Leader Status</th>
						  ...
						  <th style="text-align: center">HR Cancel Reason</th>
						  
						  <th style="text-align: center">Leader Cancel Reason</th>
...
//and a.entry_by='.$_SESSION['employee_selected'].'
  ...
  //and  a.PBI_ID="'.$PBI_ID.'"
	...
	where p.PBI_CODE=a.emp_code and p.PBI_ID="'.$PBI_ID.'"  and a.conveyance_date between "'.$g_s_date.'" and "'.$g_e_date.'" '.$con.' GROUP by a.conveyance_no';
...
?>
                        ...
                        <tr>                 
						  ...
						  <td  style="text-align:center"><?=$data->cancel_reason?></td>
						  <td  style="text-align:center"><?=$data->leader_cancel_status?></td>
						...
						<td style="width:50px"> 
						  ...
						  <div class="btn-group"><a href="conveyance_view_users.php?con_id=<?=$data->conveyance_no?>" class="buttonn btn btn-primary">Open</a></div>
