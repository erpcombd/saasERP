...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',GUARDIAN_NAME as Name, GUARDIAN_RELATION as Relation, GUARDIAN_PHONE as Phone, GUARDIAN_MOBILE as Mobile from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
