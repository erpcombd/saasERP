...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',ED_ACTION_NO as Ac_No, ED_ACTION_REGISTER_NO as Reg_No, ED_ACTION_DATE as Date, ED_ACTION_MEMO_NO as Memo_No from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
