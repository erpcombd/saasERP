...
<body>
       ...
       <form action="" method="post" enctype="multipart/form-data"> <div class="ui-dialog ui-widget ui-widget-content ui-corner-all oe_act_window ui-draggable ui-resizable openerp" style="outline: 0px none; z-index: 1002; position: absolute; height: auto; width: 900px; display: block; /* [disabled]left: 217.5px; */" tabindex="-1" role="dialog" aria-labelledby="ui-id-19">
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td colspan="1" class="oe_form_group_cell" width="50%"><table width="235" height="171" border="0" cellpadding="0" cellspacing="0" class="oe_form_group "><tbody>
                <tr class="oe_form_group_row">
                  <td width="35%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">ID :</td>
                  <td width="65%" colspan="1" class="oe_form_group_cell"><input name="<?=$PBI_ID?>" id="<?=$PBI_ID?>" value="<?=$PBI_ID?>" type="hidden" />
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td colspan="1" class="oe_form_group_cell"><input name="POSTING_NAME" type="text" id="POSTING_NAME" value="<?=$POSTING_NAME?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
      ...
      <? foreign_relation('inv_unit','id','unit',$unit_id);?>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Deparment :</td>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <? foreign_relation('inv_item_category','id','category_name',$category_id);?>
                      ...
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>Posting By :</label></td>
                      ...
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Memo No :</td>
                        <td colspan="1" class="oe_form_group_cell"><span class="oe_form_field oe_datepicker_root oe_form_field_date">
