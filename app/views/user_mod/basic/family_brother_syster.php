...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',FAMILY_BS_NAME as Name, FAMILY_BS_RELATION as Relation, FAMILY_BS_PROFESSION as Profession, FAMILY_BS_DEPEND as Depend from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
