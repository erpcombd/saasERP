...
<body>
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td class="oe_form_group_cell"><table width="100%" height="171" border="0" cellpadding="0" cellspacing="0" class="oe_form_group "><tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" width="28%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;ID :</td>
                  ...
                  <td bgcolor="#E8E8E8" width="36%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Zone :</span></td>
                  <td bgcolor="#E8E8E8" width="72%" class="oe_form_group_cell"><select name="POSTING_ZONE">
                    <? foreign_relation('zon','ZONE_CODE','ZONE_NAME',$POSTING_ZONE);?>
                  </select></td>
                </tr>
                <tr class="oe_form_group_row">
                  ...
                  <td class="oe_form_group_cell"><select name="POSTING_AREA">
                    <? foreign_relation('area','AREA_CODE','AREA_NAME',$POSTING_AREA);?>
                  </select></td>
                </tr>
                <tr class="oe_form_group_row">
      ...
      <? foreign_relation('designation','DESG_ID','DESG_DESC',$POSTING_DESIGNATION);?>
    </select></td>
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="POSTING_BRANCH">
                    <? foreign_relation('branch','BRANCH_ID','BRANCH_NAME',$POSTING_BRANCH);?>
                  </select></td>
                </tr>
                <tr class="oe_form_group_row">
                ...
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Deparment :</td>
