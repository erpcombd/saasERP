...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',PROMOTION_TYPE as Promotion_Type, PROMOTION_DATE as Date, PROMOTION_PAST_DESG as Past_Desg, PROMOTION_PRESENT_DESG as Present_Desg, PROMOTION_CROSSED_LEVEL as Level_Crossed from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
