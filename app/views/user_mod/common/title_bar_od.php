...
<?  $unique_idd =  $_GET['id'];?>
			...
			<?
			  if($unique_idd>0){
			  $unique_pbi_id = find_a_field('hrm_od_info','PBI_ID','id='.$unique_idd);
			?>
			...
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="height:25px; float:right">
              ...
              <tr>
                ...
                <td width="80" align="center" valign="middle" bgcolor="#CCCCFF"><strong style="color:#FFF; font-size:16px;"><em><img src="../../../hrm_mod/pic/staff/<?=$unique_pbi_id?>.jpeg" width="70" height="85" hspace="5" vspace="0" /></em></strong></td>
				...
				$sql =  @db_query("select PBI_NAME, PBI_DEPARTMENT, PBI_DESIGNATION,JOB_LOCATION, PBI_CODE from personnel_basic_info where PBI_ID = ".$unique_pbi_id."");
			...
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="height:25px; float:right">
              ...
              <tr>
                ...
                <td width="80" align="center" valign="middle" bgcolor="#CCCCFF"><strong style="color:#FFF; font-size:16px;"><em><img src="../../../hrm_mod/pic/staff/<?=$_SESSION['employee_selected']?>.jpeg" width="70" height="85" hspace="5" vspace="0" /></em></strong></td>
				...
				$sql =  @db_query("select PBI_NAME, PBI_DEPARTMENT, PBI_DESIGNATION,JOB_LOCATION, PBI_CODE from personnel_basic_info where PBI_ID = ".$_SESSION['employee_selected']."");
