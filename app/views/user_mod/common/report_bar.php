<header>
    ...
    <span class="oe_form_buttons_edit" style="display: inline;">
      <a href="<?=$input_page?>" rel = "gb_page_center[940, 600]"><button name="insert" accesskey="S" class="btn1 btn1-bg-submit" type="button">Add New</button></a>
    </span>
...
<!--<span class="oe_form_buttons_edit" style="display: inline;">
    ...
    <span class="oe_form_buttons_edit" style="display: inline;">
    <button name="reset" class="btn1 btn1-bg-update" type="button" onclick="parent.location='<?=$page?>'">Refresh</button>
    </span>
    <span class="oe_form_buttons_edit" style="display: inline;">
    <button name="reset" class="btn1 btn1-bg-help" type="button">Help</button>
    </span>
