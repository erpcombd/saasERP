...
if($_POST['PBI_ID']>0){
$conss = ' and entry_by="'.$_POST['PBI_ID'].'"';
}
$report="Customer Information Report";

$sql="select dealer_code as customer_code, organization as customer_organization,dealer_name_e  as contact_person,designation, address_e as address,mobile_no,tel_no as telephone_no,email from crm_customer_info where 1 ".$conss."";
...
<script type="text/javascript" src="../../js/../assets/jquery-ui-1.8.2.custom.min.js"></script>

<script type="text/javascript" src="../../js/../assets/jquery.ui.datepicker.js"></script>

<script type="text/javascript" src="../../js/../assets/jquery.autocomplete.js"></script>

<script type="text/javascript" src="../../js/../assets/jquery.validate.js"></script>

<script type="text/javascript" src="../../js/../assets/paging.js"></script>

<script type="text/javascript" src="../../js/../assets/ddaccordion.js"></script>

<script type="text/javascript" src="../../../assets/js/js.js"></script>

<script type="text/javascript" src="../../../assets/js/pg.js"></script>
...
<?
		...
		$str 	.= '<br>Contact Person  : '.find_a_field('personnel_basic_info','PBI_NAME','PBI_ID="'.$_POST['PBI_ID'].'"').'&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;';
...
if($_POST['project_id']!=''){ $project_con = " and c.PROJECT_ID='".$_POST['project_id']."' ";}



if($_POST['PBI_ID']!=''){ $contact_con = " and c.PBI_ID='".$_POST['PBI_ID']."' ";}

if($_POST['service_id']!=''){ $service_con = " and c.service_id='".$_POST['service_id']."' ";}
if($_REQUEST['lead_no']!=''){ $lead_con = " and c.lead_no='".$_REQUEST['lead_no']."' ";}
...
<?
   ...
   $sqld="select c.id,c.lead_no,c.PROJECT_ID,(select PROJECT_DESC from crm_project where PROJECT_ID=c.PROJECT_ID) as project,(select PBI_NAME from personnel_basic_info where PBI_ID=c.EMP_ID) as Contact_Person, (select service_name from crm_service where service_id=c.service_id) as service,c.c_reason,c.c_detail,c.c_time,c.c_date,(select PBI_NAME from personnel_basic_info where PBI_ID=c.entry_by) as entry_by, c.entry_at from crm_comunication c where 1 ".$project_con.$contact_con.$service_con.$lead_con."";
...
<tr <? ++$sl; if(($sl%2)==0) { echo "style='background: #F0F0F0'" ;} ?>>
  ...
  <td width="300px"><?=$data->c_detail?></td>
  ...
  $select = 'select b.PBI_NAME, (select DEPT_DESC from department where DEPT_ID=b.PBI_DEPARTMENT) as PBI_DEPARTMENT,(select DESG_DESC from designation where DESG_ID=b.PBI_DESIGNATION) as PBI_DESIGNATION from crm_com_detail_emp a , personnel_basic_info b where a.PBI_ID=b.PBI_ID and a.com_id="'.$data->id.'"';
  ...
  <td  style="border: 1px solid black; background:#CCCCCC;">Name</td>


  <td style="border: 1px solid black; background:#CCCCCC;">Designation</td>

  <td style="border: 1px solid black; background:#CCCCCC;">Department</td>
  ...
  <td  style="border: 1px solid black"><?=$rows->PBI_NAME?></td>


  <td style="border: 1px solid black"><?=$rows->PBI_DESIGNATION?></td>

  <td style="border: 1px solid black"><?=$rows->PBI_DEPARTMENT?></td>
  ...
  $select = 'select a.PROJECT_DESC,a.project_desg,a.project_dept,b.dealer_name_e from crm_com_detail a , crm_customer_info b where a.dealer_code=b.dealer_code and a.com_id="'.$data->id.'"';
  ...
  <td style="border: 1px solid black; background:#CCCCCC;">Company</td>
  ...
  <td  style="border: 1px solid black"><?=$rows->dealer_name_e?></td>

  <td style="border: 1px solid black"><?=$rows->PROJECT_DESC?></td>

  <td style="border: 1px solid black"><?=$rows->project_desg?></td>

  <td style="border: 1px solid black"><?=$rows->project_dept?></td>
  ...
  $select = 'select b.dealer_name_e from crm_com_detail_unassign a , crm_customer_info b where a.dealer_code=b.dealer_code and a.com_id="'.$data->id.'"';
