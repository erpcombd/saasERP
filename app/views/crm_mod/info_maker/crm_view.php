					...
					<a href="../home/home.php" class="btn btn-warning" style="margin-top:12px; margin-bottom:14px;" >Go Back</a>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex">
                                ...
                                <div class="col-md-6" style="background: #edeeee;/* margin: 5px; */border-radius: 13px;box-shadow: rgba(0, 0, 0, 0.75) 0px 3px 8px;margin-right: 10px;margin-left: -8px; padding: 51px;">
                                    ...
                                    <?php } ?>
									  ...
									  <p class="card-text"><b>Contact Person</b>: <?=$rows->contact_person?></p>
                                        
                                         <p class="card-text"><b>Contact Person</b>: <?=$rows->contact_number?></p>
                                    ...
                                    <?php } ?>
                                     ...
                                     <?php if($rows->latitude !=''){ ?>

                                    <p class="card-text mt-1"><b>latitude</b>:

                                        <?=$rows->latitude?></p>

                                    <?php } ?>
                                    
                                     <?php if($rows->longitude !=''){ ?>

                                    <p class="card-text mt-1"><b>longitude</b>:
...
<?php if($rows->latitude != '' && $rows->longitude != ''): ?>
    <a 
        href="https://www.latlong.net/c/?lat=<?= $rows->latitude ?>&long=<?= $rows->longitude ?>" 
        target="_blank" 
...
<?php endif; ?>
                                ...
                                <div class="col-md-6 lead-contacts" style=" background: #edeeee; margin: 5px; border-radius: 13px; box-shadow: rgba(0, 0, 0, 0.75) 0px 3px 8px; ">
                                ...
                                <?php   
                                    ...
                                    if($flag == 0){ 
                                       ...
                                       echo '<h5 class="text-muted" style="    text-align: center;
    padding-top: 10px;">No Contacts Found!</h5>';  
