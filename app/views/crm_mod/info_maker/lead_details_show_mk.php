...
<p style=" font-size: 17px !important; text-align: center; padding: 15px; background-color: whitesmoke; "> <!--<a href="../home/home.php"><button type="button" onclick="custom(319)" class="btn2 btn1-bg-hrm"><i class="fa-solid fa-home"></i></button> </a>--> <i class="fa-duotone fa-hashtag" style="--fa-primary-color: #043995; --fa-secondary-color: #15a286;"></i> <strong style=" font-weight: 700; "><?=find_a_field('crm_project_lead','lead_name','id="'.$id.'"');?></strong></p>
 ...
 <div class="col-md-4">
		...
		<h4 class="text-center bg-titel bold pt-2 pb-2">Orgranation information </h4>
        <?php
...
?>
		...
		<div class="col-sm-4">
					<a href="../../../assets/support/upload_view.php?name=<?=$row->logo?>&folder=Organization_logo&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank"><img src="../../../assets/support/upload_view.php?name=<?=$row->logo?>&folder=Organization_logo&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" style="width: 100%;  height: 80%;  border-radius: 5%;  border: 1px solid #26d126;  background-color: whitesmoke;"/></a>
					
		
		</div>
		<div class="col-sm-8">
		<p class="p" style=""> <i class="fa-solid fa-building" style="color: #064a7f; "></i> <strong><?=$orgname?></strong></p>
		<p class="p" style="">  <i class="fa-duotone fa-link" style="--fa-secondary-color: #0886fd;"></i> Source: <strong><?=find_a_field('crm_lead_source','source','id="'.$row->lead_source.'"');?></strong></p>
		
		<p class="p" style=""><i class="fa-duotone fa-chart-mixed" style="--fa-primary-color: #27eb00; --fa-secondary-color: #0798f2;"></i>Revenue: <strong><?=$row->annual_revenue?></strong> </p>
				
<!--<p class="p" style=""><i class="fa-duotone fa-users" style="--fa-secondary-color: #0656e0;"></i>Total Employees: <strong><?=$row->total_employees?></strong> </p>-->
		<p class="p" style=" color: #0241b1; ">Office Address</p>
		<p class="p" style=""><i class="fa-duotone fa-location-dot" style="--fa-primary-color: #0414f1; --fa-secondary-color: #0a64ff;"></i> Address: <strong><?=$row->address?>, <?=$row->city?>,<?=$row->district?>,<?=$row->division?>, <?=$row->zip?></strong> </p>
		<p class="p" style=""> <i class="fa-duotone fa-globe" style="--fa-primary-color: #045bf1; --fa-secondary-color: #14b1ff;"></i> Website: <strong style=" text-transform: lowercase; "><?=$row->website?></strong> </p>
		</div>
            ...
            <div class="officetype">
				<p class="p"> <i class="fa-solid fa-building" style="color: #064a7f; "></i> Lead Name : <strong><?=$name_of_lead_name = $row->lead_name?></strong></p>
           		<p class="p"> <i class="fa-duotone fa-coins" style="--fa-secondary-color: #2e9900;"></i> Lead Value : <strong><?=$row->lead_value?></strong></p>
				<p class="p"> <i class="fa-duotone fa-coins" style="--fa-secondary-color: #2e9900;"></i> Campaign : <strong><?=find_a_field('crm_campaign_management','camp_platform','id="'.$row->campaign.'"');?></strong></p>
				<p class="p"> <i class="fa-duotone fa-coins" style="--fa-secondary-color: #2e9900;"></i> Lead Status : <strong>
						<?=find_a_field('crm_lead_status','status','id="'.$row->status.'"');?>
				</strong> <button class="btn2 btn1-bg-update toggle" style="height: 25px; width: 25px;" data-toggle="modal" data-target="#statusmodal"  onclick="openModalStatusUpdate('<?=$row->status;?>')"><i class="fa-solid fa-pen-to-square"  style="color: #ffffff;margin: 0px;font-size: 16px;margin-left: -3px;"  ></i></button> </p>
            </div>
            <div class="circle"></div>
			<a href="../../../assets/support/upload_view.php?name=<?=$row->visiting_card_img?>&folder=Organization_card&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank"><img src="../../../assets/support/upload_view.php?name=<?=$row->visiting_card_img?>&folder=Organization_card&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" style="width: 100%;height: 170px;border: 1px solid #00469e;background-color: whitesmoke;"/></a>
	  ...
	  <div class="col-md-6">
		...
		<div class="card m-0 p-0 scrollable-div" style="max-width: 100% !important;">
		  ...
		  <div class="d-flex justify-content-between">
		  	<div class="pt-2 pb-2 pr-2"><h4 class="text-center bold pt-2 pb-2 pl-2 m-0" >Contact Information</h4></div>
			<div class="pt-2 pb-2 pr-2">
			   <button class="btn2 btn1-bg-update toggle"><i class="fa-solid fa-user-plus" style="color: #ffffff;" data-toggle="modal" data-target="#contactmodal">ADD</i></button></div>
		  </div>
	  	<div></div>
	  </div>
...
?> <div class="col-sm-6 p-3" >
                <div class="content1 rounded p-2 " style="background-color:#f9f9f9 !important !important; box-shadow: rgba(17, 17, 26, 0.05) 0px 1px 0px, rgba(17, 17, 26, 0.1) 0px 0px 8px;">
                   <div class="d-flex justify-content-between align-items-center ">
                      <h1>Name: <strong style=" font-weight: 600; "><?=$row->contact_name;?></strong></h1>

                      <button type="button" class="border-0 btn2 btn1-bg-help" data-toggle="modal"
                        ...
                        <div class="social">
                            <h1>Designation: <strong  style=" font-weight: 600; "><?=$row->contact_designation?></strong></h1>
                            <h1><i class="fa-duotone fa-phone" style="--fa-primary-color: #4e8efd; --fa-secondary-color: #18af22;"></i> <strong style=" padding-left:5px; font-weight: 600; "> <?=$row->contact_phone?></strong></h1>
                        </div>
                        <div class="social">
                            
                            <h1><i class="fa-duotone fa-envelope" style="--fa-primary-color: #054ac2; --fa-secondary-color: #07922a;"></i><strong style=" padding-left:5px; font-weight: 600; "><?=$row->contact_email?></strong></h1>
                        </div>
                        <div class="circle"></div>
                </div>
				</div>
      ...
      <div class="col-md-2">
	   ...
	   <div style="text-align: center; background-color: whitesmoke; font-weight: 800; width:100%;">
		  <div class="d-flex justify-content-between">
		  	<div class="pt-2 pb-2 pr-2"><h4 class="text-center bold pt-2 pb-2 pl-2 m-0" >Product List</h4></div>
			<div class="pt-2 pb-2 pr-2">
			   <button class="btn2 btn1-bg-update toggle"><i class="fa-solid fa-plus" data-toggle="modal" data-target="#productaddmodal">ADD</i></button>
			   </div>
		  </div>
	  	<div></div>
	  </div>
         ...
         $sqlTasks = "SELECT * FROM crm_lead_products  JOIN crm_lead_product_individual ON crm_lead_products.id=crm_lead_product_individual.product_id WHERE crm_lead_product_individual.lead_id=$id;";
            ...
            while ($row = mysqli_fetch_object($resultTasks)) { ?>
                ...
                <div class="list-group " style="">
                    ...
                    ?>
                     <button type="button" class="border-0 btn2 btn1-bg-cancel" data-toggle="modal"
...
<div class="mycontainer">
    ...
    <ul class="nav nav-tabs rounded" id="taskTabs">
        <li class="nav-item"> <a class="nav-link active" id="pending-tab" data-toggle="tab" href="#meeting"> <i class="fas fa-exclamation-circle"></i> Meeting </a> </li>
        <li class="nav-item"> <a class="nav-link" id="complete-tab" data-toggle="tab" href="#call"> <i class="fas fa-check-circle"></i> Call </a> </li>
        <li class="nav-item"> <a class="nav-link" id="archives-tab" data-toggle="tab" href="#visit"> <i class="fas fa-archive"></i> Visit </a> </li>
        <li class="nav-item"> <a class="nav-link" id="pending-tab" data-toggle="tab" href="#email"> <i class="fas fa-exclamation-circle"></i> Email </a> </li>
        <li class="nav-item"> <a class="nav-link" id="complete-tab" data-toggle="tab" href="#addtask"> <i class="fas fa-check-circle"></i> Add Task </a> </li>
    </ul>
    ...
    <div class="tab-content mt-3">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-margin">
                                        <div class="card-header no-border">
                                            <h5 class="card-title">Meeting Ticket No#</h5>
                                        </div>
                                            ...
                                            <div class="widget-49">
                                                <div class="widget-49-title-wrapper">
                                                    ...
                                                    <div class="widget-49-meeting-info">
                                                        ...
                                                        <span class="widget-49-meeting-time">Task time</span>
                                                    </div>
                                                </div>
                                                <ol class="widget-49-meeting-points">
                                                    <li class="widget-49-meeting-item"><span>Task details</span></li>
                                                </ol>
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-margin">
                                        <div class="card-header no-border">
                                            <h5 class="card-title"> Call Ticket No#</h5>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="widget-49">
                                                <div class="widget-49-title-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-margin">
                                        <div class="card-header no-border">
                                            <h5 class="card-title"> Visit Ticket No#</h5>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="widget-49">
                                                <div class="widget-49-title-wrapper">
                    ...
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-margin">
                                        <div class="card-header no-border">
                                            <h5 class="card-title"> Email Ticket No#</h5>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="widget-49">
                                                <div class="widget-49-title-wrapper">
		...
		<!-- Visit Tab -->
        <div class="tab-pane fade show active" id="addtask">
            <div class="row">
                <div class="col">
                    <div class="container">
                        <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="card card-margin">
                                        <div class="card-header no-border">
                                            <h5 class="card-title">Add task Ticket No#</h5>
                                        </div>
                                        <div class="card-body pt-0">
                                            <div class="widget-49">
                                                <div class="widget-49-title-wrapper">
                                    ...
                                    <div class="card-big-shadow">
                                        <div class="mycard card-just-text" data-background="color" data-color="blue" data-radius="none">
											...
											<div>
                                                ...
                                                <p class="description" style=" line-height: 20px; ">Note: <?=$row->details;?> </p>
												</div>
												<div>
                                                  <div class="d-flex justify-content-between align-items-center ">
...
<div>
                ...
                <p class="description" style=" line-height: 20px; "><strong> Email Body:</strong> <?=$row->details;?> </p>
</div>
<div>
                <div class="d-flex justify-content-between align-items-center ">
                                                       <a class="btn btn-sm btn-info mr-2" href="../info_maker/lead_task_details_show.php?leadid=<?=encrypTS($id)?>&activityid='<?=encrypTS($row->id)?>'"><i class="fa-solid fa-eye"></i></a>
...
<div class="col-sm-12 mycontent-card">
    ...
    <div class="card-big-shadow">
        <div class="mycard card-just-text"data-background="color" data-color="blue" data-radius="none">
            ...
            <div class="ourcontent"style="position: relative;">
			</strong> <button class="btn2 btn1-bg-update toggle" style="height: 25px;position: absolute; top: 5px; right: 5px; width: 25px;"data-toggle="modal" data-target="#updatetaskmodal"
                        data-task-id="<?=$row->task_id;?>"
                        data-task-name="<?=$row->task_name;?>"
                        data-task-details="<?=$row->task_details;?>"
						data-task-Date="<?=$row->task_date;?>"
						data-task-time="<?=$row->task_time;?>"
                        onclick="openModalfortask('<?=$row->task_id;?>', '<?=$row->task_name;?>','<?=$row->task_details;?>','<?=$row->task_time;?>','<?=$row->task_date;?>')">
                ...
                <p class="description">Task Details :<?=$row->task_details;?> </p>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body shadow rounded m-3  ">
					<p  id="exampleDateid"></p>
					<p  id="exampleTimeid"></p>
...
<form action="#" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-outline mb-2">
                                ...
                                <input name="task_name" id="task_name" value="" type="text" id="form3Example3" class="form-control form-control-lg" value="<?=$row->task_name;?>"
                                placeholder="Enter your task name"/>
