...
// ::::: Edit This Section ::::: 
$title='Add Task' ; 
require_once "../include/custom.php";
$leadid = decrypTS($_GET['leadid']);
 $activityd = decrypTS($_GET['activityid']);
...
<!-- Start sticky note -->
 ...
 <button class="btn btn-warning" style="margin-top:12px; margin-bottom:14px;" onclick="history.back()">Go Back</button>
