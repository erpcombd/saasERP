...
<div class="col-sm-12 mycontent-card">
    ...
    <div class="card-big-shadow">
        <div class="mycard card-just-text"data-background="color" data-color="blue" data-radius="none">
			...
			<?php /*?><button class="btn2 btn1-bg-update toggle" style="height: 25px;position: absolute; top: 5px; right: 5px; width: 25px;"data-toggle="modal" 
...
<form action="" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-outline mb-2">
                                ...
                                <input name="task_name" id="task_name form3Example3" value="" type="text"  class="form-control form-control-lg"
                                placeholder="Enter your task name" />
                            
                            </div>

                            <input type="hidden" name="lead_id" id="lead_id" value="<?=$id?>" />
                            <input type="text" name="activity_id" id="activity_id" value="<?=$activityd?>" />
