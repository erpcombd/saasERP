...
$crud12 = new crud($table1);
$_POST['entry_at']=date('Y-m-d h:i:sa');
$_POST['entry_by'] = $_SESSION['user']['id'];
$log_id=$crud12->insert();
...
<div class="col-md-12  m-0 p-0">
    ...
    <table id="example" class="table">
	   ...
	   '<?=$row->contact_person;?>','<?=$row->contact_number;?>','<?=$row->contact_email;?>',)"><i class="fa-solid fa-pencil" style="color: #ffffff;" ></i></button>
