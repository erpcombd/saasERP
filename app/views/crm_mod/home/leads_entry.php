    ...
    <div class="card card-style shadow-lg p-3 bg-white rounded">
        <div class="content">
            <form method="post" action="">
                <h1 class="text-center text-primary m-4">Lead Information</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border"><i class="fa fa-user"></i></span>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border"><i class="fa fa-briefcase"></i></span>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border"><i class="fa fa-envelope"></i></span>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border"><i class="fa fa-phone"></i></span>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text bg-light border"><i class="fa fa-globe"></i></span>
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="" name="lead_source" id="lead_source" required>
                                <option value=""></option>
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="" name="lead_status" id="lead_status" required>
                                <option value=""></option>
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="" name="industry" id="industry" required>
                                <option value=""></option>
                    ...
                    <div class="col-md-6">
                        <div class=" mb-4">
                            ...
                            <div class="input-group-prepend">
                                ...
                                <input type="text" class="form-control" name="no_of_employees" id="no_of_employees" placeholder="No. of Employees">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                            ...
                            <div class="input-group">
                                <span class="input-group-text bg-light border"><i class="fa fa-envelope"></i></span>
                                <input type="email" class="form-control" name="secondary_email" id="secondary_email" placeholder="Secondary Email">
                            </div>
                ...
                <!-- Address Information -->
                <h1 class="text-center text-primary m-4">Address Information</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                            ...
                            <select class="" name="division" id="division" required>
                                
                                <?=foreign_relation('division','division_CODE','division_name','1');?>
                            </select>
					...
					<div class="col-md-6">
					 ...
					 <!-- Address Information -->
                <h1 class="text-center text-primary m-4">Contact Information</h1>
					
					<div class="col-md-6">
                   
                            <label for="zipCode" >Person</label>
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-user"></i></span>
                                <input type="text" class="form-control" name="contact_person" id="contact_person" placeholder="Person">
                            </div>
					...
					<div class="col-md-6">
                            ...
                            <label for="zipCode" >Number</label>
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fa fa-map-pin"></i></span>
                    ...
                    <label for="form1" class="color-highlight">Description Information</label>
   					<textarea class="form-control " name="description_information" id="description_information" placeholder="Description Information"></textarea>
                ...
                <div class="text-center">
                    <button type="submit" name="submitinfo" class="btn btn-success"> Submit </button>
                   <a  href="leads.php"> <ptype="reset" name="cancelinfo" class="btn btn-secondary px-5">Cancel</p></a>
                </div>
            </form>
        </div>
    </div>
