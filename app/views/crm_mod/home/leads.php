...
<div class="shadow-lg p-5 mb-5 bg-white rounded">
    <div class="content d-flex justify-content-between align-items-center">
        <span class="fs-2 mb-0 color-black font-weight-bold">Leads</span>
        <div >
            <a href="../home/leads_entry.php" class=" icon-xxl bg-success gradient-green color-white shadow p-3 rounded">
                            ...
                            <tr>
                                ...
                                <?php 
                                    ...
                                    if($user_role=="Admin"){
                                        ...
                                        $leadsQry = "SELECT * FROM crm_lead_manage";
                    ...
                    break;*/
                                ...
                                ?>
                                    ...
                                    <tr class="<?=$class?>">
										...
										<td><?=find_a_field('crm_lead_source', 'source', 'id = "'.$row->lead_source.'"')?></td>
                                        <td><?=find_a_field('personnel_basic_info', 'PBI_NAME', 'PBI_ID = "'.$row->lead_owner.'"')?></td>

                                        <td class="d-flex">

                    <a class="btn2 btn1-bg-submit text-light mr-2" 
					href="../info_maker/leads_details_page.php?view=<?=encrypTS($row->lead_id)?>&tp='<?=encrypTS('lead')?>'"><i class="fa-solid fa-eye"></i></a>
