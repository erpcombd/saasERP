...
<body>
   ...
   <td bgcolor="#E8E8E8" width="25%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Lead No :</td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
				  <select name="lead_no" id="lead_no" class="form-control" style="width: 200px">
                  <? foreign_relation('crm_lead_master','lead_no','lead_no',$lead_no,'1'); ?>
				  </select>
				  </td>
				  <td bgcolor="#E8E8E8" width="25%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Contact Person :</td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
				  <select name="c_person" id="c_person"  style="width: 200px">
                  <? foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$c_person,'1'); ?>
				  </select>
				  </td>
