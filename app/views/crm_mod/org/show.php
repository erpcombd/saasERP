...
$id=$_REQUEST['id'];
$condition="id=".$id;
$data=db_fetch_object('crm_project_org',$condition);
...
$crud->update('id');
 ...
 $sql='INSERT INTO `crm_org_contacts`( `project_id`, `contact_name`, `contact_phone`, `contact_email`, `contact_designation`,department, `entry_by`, `entry_at`) VALUES ("'.$id.'","'.$_POST['contact_name1'][$key].'","'.$_POST['contact_phone1'][$key].'","'.$_POST['contact_email1'][$key].'","'.$_POST['contact_designation1'][$key].'","'.$_POST['dept'][$key].'","'.$_SESSION['user']['id'].'","'.date('Y-m-d H:i:s').'")';
 db_query($sql);
 }
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
						   ...
						   <tr>
                            <td>Department </td>
                            <td><input type="text" name="dept[]" class="form-control" value="<?=$data->department?>" style="border-left:3.5px solid #df5b5b!important;" ></td>
                        </tr>
