...
//     $_POST['contact_designation'] = $_POST['designation'];
     ...
     $lastId =getLastInsertID($table1, 'id');
	  ...
	  @$HYPERLOOPGLOBAL;
			...
			$_POST['department'] = 			$_POST['dept'][$key];
        ...
        <div class="">
            ...
            <table id="example" class="table">
                ...
                <?php 
                    ...
                    $leadsQry = "SELECT * FROM $table1 WHERE1 ";
                      ...
                      <?if($user_role=="Admin"){?>
                        <td class="d-flex justify-content-center">
                            ...
                            <a class="btn btn-sm btn-warning" href="show.php?id=<?=$row->id?>"><i class="fa-solid fa-pencil"></i></a>
							 ...
							 <a class="btn btn-sm btn-success text-light ml-2" href="org_lead.php?id=<?=$row->id?>">Convert to Lead</a>
                ...
                <table class="table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>Division</td>
                      <td>
                          <select name="division" id="division" class="selectpicker input_general" data-live-search="true">
                ...
                <table class="table">
                  ...
                  <tbody>
					...
					<tr>
                      <td>District</td>
                      <td>
                          <select name="district" id="district" class="selectpicker input_general" data-live-search="true">
                            <option value="">--Select One--</option>
