	...
	<div class="row">
		<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 p-3">
			<div class="container pt-2 bgc">
				...
				<?php
				$psql = 'select * from crm_lead_activity where main="1"';
				$pquery = db_query($psql);
				$i = 1;

				$exc = find_a_field('crm_lead_activity', 'id', 'main="1"');
				if ($exc == '') {
				...
				<div class="row p-2 m-0">
					<div class="crm-top-sa col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="right" align="left">
							...
							<!-- Button trigger modal start-->
							<button type="button" class="btn toggle" data-toggle="modal" data-target="#exampleModa3">
		...
		<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 p-3">
			<div class="container pt-2 bgc">
				<div class="row p-2 m-0">
					<div class="crm-top-sa col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="right" align="left">
							...
							<!-- Button trigger modal start-->
							<button type="button" class="btn toggle" data-toggle="modal" data-target="#exampleModa4">
								<i class="fa-solid fa-plus"></i>
							</button>
							<!-- Button trigger modal end-->
				...
				<?php
				$msql = 'select * from crm_lead_activity where activity_type="Meeting" order by id DESC limit 2';
				...
				<div class="row p-2 m-0">
					<div class="crm-top-sa col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="right" align="left">
							...
							<!-- Button trigger modal start-->
							<button type="button" class="btn toggle" data-toggle="modal" data-target="#exampleModa5">
								<i class="fa-solid fa-plus"></i>
							</button>
							<!-- Button trigger modal end-->
...
<?php */ ?>
				...
				<?php
				$esql = 'select * from crm_lead_activity where activity_type="Email" order by id DESC limit 2';
				...
				<div class="row p-2 m-0">
					<div class="crm-top-sa col-sm-12 col-md-12 col-lg-12 col-xl-12">
						...
						<div class="right" align="left">
							...
							<!-- Button trigger modal start-->
							<button type="button" class="btn toggle" data-toggle="modal" data-target="#exampleModa6">
								<i class="fa-solid fa-plus"></i>
							</button>
							<!-- Button trigger modal end-->
