 ...
 if(isset($_POST['insert'])){
     ...
     if(isset($_FILES['logo'])){
        ...
        if($imageOK==0){
         ...
         echo '<script>alert("Logo Insert Failed! Size should be below 2MB and only supported formats are JPG, JPEG, PNG.");</script>';
     ...
     if(isset($_FILES['logo'])){
        ...
        if($imageOK==0){
          ...
          if(move_uploaded_file($_FILES["logo"]["tmp_name"], $target_file)){
            ...
            $oldImageName = find_a_field($table1, 'logo', 'id = "'.$_POST['id'].'"');
         ...
         echo '<script>alert("Logo Update Failed! Size should be below 2MB and only supported formats are JPG, JPEG, PNG.");</script>';
...
?>
    ...
    <div class="row well">
        <div class="col-md-12 text-right">
            ...
            <a href="show_all_org.php?update=<?=encrypTS('new')?>" class="btn btn-success text-light" style="margin-top:12px; margin-bottom:14px;">+ Add New</a>
        </div>    
    </div>
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td class="d-flex">
                            ...
                            <a class="btn btn-sm btn-warning" href="show_all_org.php?update=<?=encrypTS($row->id)?>"><i class="fa-solid fa-pencil"></i></a>
                        </td>
                    </tr>
