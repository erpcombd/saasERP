  ...
  <div class="row m-0 p-0 pt-4">
	...
	<div class="col-6  pt-4 pb-4">
		...
		<div class="fileuploadcontainereventinfo" >
						...
						<div align="center" class="filepercentageandloader" style="display: none !important;">
...
<!--  stype 2nd start-->
		...
		<hr style="height:1px;border:none;color:#333;background-color:#333;">
		  ...
		  <hr style="height:1px;border:none;color:#333;background-color:#333;">
		<div class="row">
			<div class="col-sm-6 col-md-6 col-lg-6" style="background-color: #2f2f2f !important;height: 70px !important;">

			</div>
			<div class="col-sm-6 col-md-6 col-lg-6" style="background-color: #dfe3e3 !important;">
  ...
  <div class="row m-0 p-0 pt-4">
  	<div class="col-12 pt-4 pb-4">
		<h1 class="h1 m-0 p-0 pl-3 text-center"><i class="fa-solid fa-message-arrow-up-right"></i>  Items and Services </h1>
		...
		<div class="row m-0 p-0 pt-5">
			...
			<div class="pl-3 pt-3">
				...
				<div class="form-group row">
					<label for="staticEmail" class="col-sm-2 col-form-label">Attachment</label>
					<div class="col-sm-9">
			...
			<div id="attachmentshowcontainer">
