...
<th bgcolor="#45777B"><span class="style3">Direct Journal </span></th>
</tr>
</thead>
...
$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.' ,   a.direct_journal from '.$table.' a	where  1  '.$con.' order by a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Voucher Type  :</td>
                        				...
                        				<input name="voucher_type" required type="text" id="voucher_type" tabindex="1"  style="width:220px;" value="<?=$voucher_type?>"  >	
									  ...
									  <tr>
                                        ...
                                        <td><select name="direct_journal" id="direct_journal" style="width:220px;" >
