    ...
    <table style="width: 100%; border-collapse: collapse; border: 1px solid #EEEEEE;">
        ...
        <tbody>
            <tr style="background: #EEEEEE;">
                <td style="padding: 12px; text-align: center; border: 1px solid #EEEEEE;"><?=date('Y-m-d H:i:s');?> </td>
