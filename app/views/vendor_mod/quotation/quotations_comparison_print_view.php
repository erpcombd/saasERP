...
<tr>
		...
		<?
$q_sql = 'select * from quotation_detail where req_no="'.$req_no.'" and item_id="'.$info2->item_id.'" order by id,vendor_id asc';
...
?>
	...
	<td><?=number_format($totalP[$i][$qdata->vendor_id][$info2->item_id],2)?></td>
