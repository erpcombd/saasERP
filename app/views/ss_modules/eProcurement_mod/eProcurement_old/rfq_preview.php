...
<div class="row p-0 pb-5">
	...
	<div class="d-flex justify-content-center align-items-center ep-clock-bg w-100   p-3">
...
<section class="bsb-timeline-7 ">
 ...
 <? ?>
  ...
  <? ?> 
  	<div class="container mt-1 p-0 " style=" background-color: #fffefe; ">
  	<table class="table1  table-striped table-bordered table-hover table-sm">
		...
		?>
					    <tr>
                            ...
                            <td></td>
							<td></td>
							<td><input type="checkbox" name="vendor_id_<?=$vendor->vendor_id?>" id="vendor_id_<?=$vendor->vendor_id?>" value="<?=$vendor->vendor_id?>" checked="checked"/>&nbsp;</td>
                        </tr>
						<? } ?>
  ...
  <div class="row m-0 p-0 pt-4">
  	...
  	<table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody class="tbody1" id="evaluator_details">
						...
						<? 
						$sql = 'select a.id,u.fname,u.user_id,a.action from rfq_evaluation_team a, user_activity_management u where a.user_id=u.user_id and a.rfq_no="'.$_SESSION['rfq_no'].'" ';
		 $qry = db_query($sql);
		 while($data=mysqli_fetch_object($qry)){
