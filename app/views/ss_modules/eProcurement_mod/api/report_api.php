...
$query = "
    INSERT INTO report_structure_information (report_id, visibility, column_name,column_index,original_index) 
    VALUES (?, ?, ?,?,?) 
...
$stmt->bind_param("issss", $reportId, $visibility, $columnName,$column_index,$column_index);
