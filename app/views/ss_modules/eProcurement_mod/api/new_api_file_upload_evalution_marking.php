...
foreach ($data['files'] as $file) {
    ...
    /*if ($file_size > $max_file_size) {
        $responses[] = array(
            "status" => "error",
            "message" => "File '$file_name' exceeds the maximum allowed size (50MB).",
    ...
    $attachment_id = insertIntoDatabase($rfq_no, $tr_from, $file_name, $random_eprocfiles_name, $entry_by, $section_id,$vendor_id);
...
function insertIntoDatabase($rfq_no, $tr_from, $original_name, $new_name, $entry_by, $section_id='',$vendor_id)
{
    global $conn;
    $query = "INSERT INTO evaluation_documents_information (rfq_no,tr_from,vendor_id,original_name,new_name,entry_by,entry_at,section_id) VALUES ('$rfq_no','$tr_from','$vendor_id','$original_name','$new_name','$entry_by', NOW(), '$section_id')";
