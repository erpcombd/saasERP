...
foreach ($_FILES['eprocfiles']['tmp_name'] as $key => $tmp_name) {
    ...
    if (!empty($eprocfiles)) {
        ...
        if (move_uploaded_file($eprocfiles, $eprocfiles_path)) {
         ...
         $query = "INSERT INTO rfq_documents_information (vendor_id,rfq_no,tr_from,folder_path,original_name,new_name,entry_by,entry_at) VALUES ('$vendor_id','$rfq_no','$tr_from','../../../../uploaded_documents/','$original_eprocfiles_name','$random_eprocfiles_name','$entry_by', NOW())";
