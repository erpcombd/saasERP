...
<tbody>
				<?  $data = "SELECT r.id, u.fname, s.team, r.entry_by FROM  event_visibility_team_member r, event_visibility_team s, user_activity_management u WHERE u.user_id=r.team_member and s.id=r.group_id"; 
					$query = db_query($data);
