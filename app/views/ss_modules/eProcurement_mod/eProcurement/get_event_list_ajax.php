...
$input_data = $data[1];
		...
		and t.user_id="'.$user_id.'" and u.user_id=r.entry_by and (r.rfq_no like "%'.$input_data.'%" or event_name like "%'.$input_data.'%") and r.del !=1 group by t.rfq_no,r.rfq_no order by r.rfq_no desc';
		$qry2 = db_query($sql2);
