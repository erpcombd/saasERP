...
<?php  $sql = 'select DISTINCT u.user_id,a.id,u.fname,a.action from rfq_evaluation_team a, user_activity_management u where a.user_id=u.user_id and a.rfq_no="'.$_SESSION['rfq_no'].'" and a.action in ("Owner","Evaluator")';
		 $qry = db_query($sql);
