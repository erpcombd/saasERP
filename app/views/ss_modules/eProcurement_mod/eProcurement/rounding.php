...
$up = 'update rfq_master set status="COMPLETE",eventEndDate="'.$end_date.'",eventEndTime="'.$end_time.'",eventEndAt="'.$end_at.'" where rfq_no="'.$old_rfq_no.'"';
db_query($up);
$unique='rfq_no';
...
$_POST['eventEndDate'] =  date('Y-m-d', strtotime('+3 day'));
