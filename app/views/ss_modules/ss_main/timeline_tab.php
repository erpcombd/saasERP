...
<div class="pt-5 pl-3">
		...
		<div   class="mt-2 row align-items-center">
		  ...
		  <input type="Time" style="border: 1px solid #ced4da; border-radius: 0.25rem;" class="form-control  pt-1 col-3 ml-2" id="eventStartTime" name="eventStartTime" value="<? if($eventStartTime!='00:00:00') echo $eventStartTime; else echo '00:00 AM';?>" style="width: 12% !important;" onchange="master_data(this.name,this.value)" />&nbsp;<lebel>At Event Submission</lebel>&nbsp;<input type="checkbox" name="immediate_event_shoot" id="immediate_event_shoot" <?=$immediate_event_shoot?> onchange="master_data(this.name,this.value)" value="checked" />
		</div>
		
		<div   class="mt-2 row align-items-center">
		  <label class="col-3 fs-18 bold" style="font-size: 14px !important;color: #60768a; !important" for="eventend" style="font-size: 14px !important;color: #60768a; !important">Event End Time</label>
		  ...
		  <input type="time" style="border: 1px solid #ced4da; border-radius: 0.25rem;" class="form-control pt-1 col-3 ml-2" id="eventEndTime" name="eventEndTime" value="<? if($eventEndTime!='00:00:00') echo $eventEndTime; else echo '00:00 AM';?>"  style="width: 12% !important;" onchange="master_data(this.name,this.value)" />
		</div>
