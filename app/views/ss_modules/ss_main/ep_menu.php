    ...
    <div class="container mt-0 mb-0 p-0">
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link menu-option <?php if ($current_page == 'events') {echo 'ep_selected';} ?>" href="../eProcurement/eprocurement_entry.php">Home</a>
          </li>
          <li class="nav-item">
            <a class="nav-link menu-option <?php if ($current_page == 'response') {echo 'ep_selected';} ?>" href="../eProcurement/response.php">Items List</a>
          </li>
          <li class="nav-item">
