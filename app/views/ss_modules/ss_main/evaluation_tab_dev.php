	...
	<div class="col-6 ">
	 ...
	 <table class="w-100" border="0" cellspacing="5" cellpadding="5">
	  ...
	  <tr>
		...
		<td><input type="radio" name="evaluation_method" id="evaluation_method" value="pass_fail" />&nbsp;Pass/Fail</td>
		<td><input type="radio" name="evaluation_method" id="evaluation_method" value="combined" />&nbsp;Combined</td>
		</tr>
		<tr>
		...
		<td><? if($_SESSION['master_status']=='MANUAL'){?><button type="button" name="section" class="btn1 btn1-bg-update" onclick="add_evaluation_section(document.getElementById('event_section_name').value,document.getElementById('event_section_percent').value,document.getElementById('evaluation_method').value)">Add Section</button><? } ?></td>
		</tr>
