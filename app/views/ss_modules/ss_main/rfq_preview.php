...
if(isset($_POST['event_submit'])){
 ...
 db_query($up);
 $_SESSION['msg'] = '<span style="color:green; font-size:20px;"></span>';
...
<div class="container-fluid  mt-1 p-0 " style=" background-color: #fffefe; ">
			...
			<table class="w-100">
				...
				<tr class="sr">
					...
					<form  id="uploadlogobasicsourcing" enctype="multipart/form-data">
												...
												<?
												    $imgsrc="../../../controllers/utilities/api_upload_attachment_show.php?name=default.svg.png&folder=logo";
	...
	<div class="col-12 pt-4 pb-4">
		...
		<div class="pt-1">
						...
						<table class="table1  table-striped table-bordered table-hover table-sm" id="item_details">
						                    <thead class="thead1">
                    <tr class="bgc-info" style=" background-color: #f7f7f7 !important; color: #333 !important; ">
                        <th scope="col">SL</th>
						...
						<th scope="col">Delivery Lead Time(Day)</th>
  ...
  <form method="post">
	<button type="submit" name="event_submit" class="btn1 btn1-bg-update" style="width:20% !important;">Submit</button>
	<button type="submit" name="back" class="btn1 btn1-bg-cancel" style="width:20% !important;">Back To</button>
	</form>
	</div>
