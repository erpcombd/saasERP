  ...
  <div class="tab-pane fade" id="tab2" role="tabpanel" aria-labelledby="timeline-tab" style="display: none;">
	...
	<div class="col-12 pt-4 pb-4">		
  	...
  	<table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody class="tbody1">
					<?
					$sql = ' select t.*, m.* from rfq_vendor_terms_condition t, rfq_master m where m.rfq_no=t.rfq_no and t.vendor_id='.$vendor.' group by m.rfq_no ';
					$query = db_query($sql);
	...
	<? } ?>			
			...
			<div class="attachment-toggle"> 
						...
						<div class="fileuploadcontainer" >
							...
							<div class="attachmentshowcontainer container row m-0">
		  <?php
		  $sql1 = 'select * from rfq_documents_information where tr_from like "sourcing_attachment_response'.$res->id.'" and rfq_no="'.$_SESSION['rfq_no'].'"';
		  $qry1 = db_query($sql1);
...
<?php
  $sql = 'select d.* from rfq_form_details d where   rfq_no="'.$rfq->rfq_no.'" group by form_no ';
  $qry = db_query($sql);
  while($res = mysqli_fetch_object($qry)){
?> 
		<div class="row">
