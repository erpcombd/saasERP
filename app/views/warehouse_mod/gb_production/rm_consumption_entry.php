...
journal_item_control($item_id, $warehouse_id, $issue_date,  0, $issue_qty, 'Issue', $xid, $avg_price, '', $issue_no, '', '', $group_for, $avg_price, '' );
...
if($issue_no>0)
{
auto_insert_rm_consumption_secoundary($issue_no);
}

?>

<script language="javascript">
window.location.href = "rm_consumption_entry.php";
</script>
...
var total_amt = document.getElementById('total_amt_'+item_id).value= (issue_qty*avg_price);
