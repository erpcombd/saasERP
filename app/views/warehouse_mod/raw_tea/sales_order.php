...
<td bgcolor="#66CC99"><input name="issue_<?=$data->item_id?>" id="issue_<?=$data->item_id?>" type="text" size="10"  value="<?=$info->today_receive;?>" style="width:50px;" onKeyUp="calculation(<?=$data->item_id?>)" /></td>

<td bgcolor="#FF9999"><input name="sale_<?=$data->item_id?>" id="sale_<?=$data->item_id?>" type="text" size="10"  value="<?=$info->today_issue;?>" style="width:50px;" onKeyUp="calculation(<?=$data->item_id?>)" /></td>
