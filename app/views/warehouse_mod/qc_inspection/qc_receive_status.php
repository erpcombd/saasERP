...
?>
                        ...
                        <tr>
							...
							<td><?=$data->entry_at?></td>
                            <td>
							<!--<a href="chalan_view2.php?qc_no='<?=url_encode($data->qc_no);?>'" target="_blank"><input type="button" class="bgc-info" value="View" /></a>-->
<a href="chalan_view2.php?c='<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($data->qc_no));?>'" target="_blank"><input type="button" class="bgc-info" value="View" /></a>
							</td>
