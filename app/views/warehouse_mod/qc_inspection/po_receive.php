...
?>
  ...
  <a href="../../../views/purchase_mod/po/po_print_view_store.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($po_no));?>" target="_blank">
    <img src="../../../images/print.png" width="26" height="26" alt="Print" />
  </a>
</td>
                    ...
                    <div class="container n-form2">
                       ...
                       <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								...
								<input  name="upload_file" type="text" id="upload_file" value=""   autocomplete="off"/>
                            </div>
                        </div>
