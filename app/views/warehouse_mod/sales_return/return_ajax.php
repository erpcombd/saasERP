...
$data=explode('##',$str);
   ...
   $item_id=$data[0];
   $do_no=$data[1];
  //echo 'select * from item_info where item_id="'.$item_id.'"';
...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="15%"><input name="unit_price" type="text" class="input3" id="unit_price"  style="width:90%; height:30px;" required="required" onkeyup="count()"  /></td>
</tr>
</table>

<?php /*?> value="<?=$item_all->d_price;?>"<?php */?>
