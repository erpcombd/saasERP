...

{
		...
		$_POST['sr_no'] = find_a_field($table_master,'max(do_no)','0')+0;
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input  name="sr_date" type="text" id="sr_date" value="<?=($sr_date!='')?$sr_date:date('Y-m-d')?>"  required />
                            </div>
									<? }?>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <select name="do_type" required id="do_type"   >
...
auto_complete_from_db('item_info','concat(item_id,"-> ",item_name)','item_id',' product_nature in("Salable","Both")','item_id');
...
<input name="item_id" type="text"  value="" id="item_id" onblur="getData2('return_ajax.php', 'so_data_found', this.value, document.getElementById('sr_no').value);"/>
...
<input type="hidden" id="sr_date" name="sr_date" value="<?=$sr_date?>"  />
...
<input name="sr_date" type="hidden" id="sr_date" value="<?=$sr_date;?>"/>
...
<input  name="sr_no" type="hidden" id="sr_no" value="<?=$$unique_master?>"/>
<input  name="sr_date" type="hidden" id="sr_date" value="<?=$sr_date?>"/>
                <input name="confirm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM AND FORWARD REQUSITION"  />
            </div>
...
<label style="width:220px;">SR No: </label>
