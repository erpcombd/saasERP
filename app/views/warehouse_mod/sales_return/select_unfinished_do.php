    ...
    <form action="" method="post" name="codz" id="codz">
        ...
        <div class="container-fluid pt-5 p-0 ">
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<? 
if($_POST['fdate']!='') {$con=' and a.sr_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';}else{$con=' and a.sr_date between "'.date('Y-m-o1').'" 
and "'.date('Y-m-d').'"';}

    $res ='select a.do_no,a.entry_by,a.sr_date,a.dealer_code,d.dealer_name_e,u.fname
		...
		?>
					...
					?>
                        ...
                        <tr>
							...
							<a href="do.php?old_do_no=<?=$row->do_no?>">
							<input type="button" value="Complete SR" class="btn1 btn1-submit-input"/ >
...
<td class="text-center"><a href="do.php?old_do_no=<?=$data->do_no?>"><button class="btn1 btn1-bg-submit">Complete SR</button></a></td>
</tr>
<?php } ?>
</tbody></table>
</div></td>
