...
if(isset($_POST['confirmm']))
{
		...
		$labour_ledger=find_a_field('config_group_class','labour_ledger','group_for="'.$_SESSION['user']['group'].'"');
       // $localPurchaseLedger = find_a_field('config_group_class','localPurchase','group_for="'.$group_for.'"');
		while($data=mysqli_fetch_object($qry)){
		$tr_id = $data->id;
		journal_item_control($data->item_id ,$_SESSION['user']['depot'],$data->or_date,$data->qty,0,$tr_from,$tr_id,$data->rate,'',$_SESSION['or_no2']);
        ...
        <div class="container-fluid bg-form-titel">
            ...
            <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                              ...
                              <option> </option>
								<? foreign_relation('general_sub_ledger','sub_ledger_id','sub_ledger_name',$$field,'ledger_id in (124)')?>
							</select>
...
<span id="sub">
<?
//auto_complete_from_db('item_info i, item_sub_group s','concat(i.item_id,"- ",i.item_name)','concat(i.item_id,"- ",i.item_name)','i.sub_group_id=s.sub_group_id and s.group_id!=1096000100000000 
//group by i.item_id','item_id');
