...
?>
                    ...
                    <td bgcolor="#99CCCC"><input type="submit" name="submitit" id="submitit" value="Set Opening Balance" style="width:170px; font-weight:bold; font-size:12px; height:30px; color:#090"/></td>
                  </tr>
