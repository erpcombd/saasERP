...
function nav(lkf){document.location.href = '<?=$page?>?<?=$unique?>='+lkf;}
  ...
  <div class="container-fluid p-0">
    ...
    <div class="row">
	 ...
	 $rrr = "select * from unit_management";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      <div class="col-md-4  p-0  pl-2">
        ...
        <form id="form1" name="form1" class="n-form setup-fixed" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
		  ...
		  <div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label">Unit Name:</label>

            <div class="col-sm-8 col-md-8 col-lg-8 p-0">

					 <input type="text" name="unit_name" class="form-control"  id="unit_name" value="<?=$unit_name;?>"/>
            ...
            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label"> Unit Description :</label>

            <div class="col-sm-8 col-md-8 col-lg-8 p-0">

					
				<textarea name="unit_detail" class="form-control"  id="unit_detail"><?=$unit_detail;?></textarea>
