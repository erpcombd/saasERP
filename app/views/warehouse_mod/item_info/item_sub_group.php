...
<?php /*?>                    <?php
            ...
            <div class="col-sm-5 p-0  pl-2">
                <form id="form1" name="form1" class="n-form setup-fixed" method="post" action="" onsubmit="return check()">
                        ...
                        <div class="col-sm-8 p-0">
                            	...
                            	<? if ($item_ledger==0) {?>
									<select name="ledger_group" required="required" id="ledger_group" tabindex="9">
										...
										<option></option>
										<? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class in(122,121,123)  ');?>
									</select>
								<? }?>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
									...
									<select name="cogs_ledger" id="cogs_ledger" tabindex="9">
										...
										foreign_relation('accounts_ledger','ledger_id','ledger_name',$cogs_ledger,'ledger_group_id 	in(411001,121022,426069,426066,426067,426068,426069,426070,511001,411002) ');?>
									</select>
					...
					<!--<div class="form-group row m-0 pl-3 pr-3 p-1">
                        <label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label req-input">Company : </label>
                        <div class="col-sm-8 p-0">
