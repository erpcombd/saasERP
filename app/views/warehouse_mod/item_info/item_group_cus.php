...
$title=' Create Product Sub Group';
...
unset($$unique);
$tr_type="Add";
header("Location: item_group_cus.php");
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-sm-7 p-0 pr-2">
			...
			<h4 align="center" class="n-form-titel1">Search Product Group</h4>
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					if($_POST['group_for']!="")
					  ...
					  $rrr = "select b.group_id,  b.group_name, b.description,b.group_id_cus,cg.group_id,cg.group_name from item_group b,item_group_cus cg, user_group a where b.group_id_cus=cg.group_id and a.id=b.group_for and b.group_for='".$_SESSION['user']['group']."' ";
		...
		<div class="col-sm-5 p-0  pl-2">
			<form id="form1" class="n-form setup-fixed" name="form1" method="post" action="" onsubmit="return check()">
				<h4 align="center" class="n-form-titel1"><?=$title?></h4>
				

				<div class="form-group row m-0 pl-3 pr-3">
					<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Sub Group Name </label>
					<div class="col-sm-9 p-0">
...
<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            <select name="group_id_cus" id="group_id_cus" required="required">
                                <option></option>
                                <?	$sql="select * from item_group_cus where  group_for='".$_SESSION['user']['group']."' order by group_id";
...

                                {
                                    ...
                                    ?>
                                    <option <? if($datas->group_id==$group_id_cus) echo 'Selected ';?> value="<?=$datas->group_id?>">
                                        <?=$datas->group_name?>
                                    </option>
                                <? } ?>
                            </select>
...
$con .= 'and b.group_for="'.$_POST['group_for'].'"';
	...
	$rrr = "select b.group_id,  b.group_name, b.description from item_group b, user_group a where a.id=b.group_for  ".$con." ";
