...
<!--					</div>-->
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Sub Group :</label>
						<div class="col-sm-9 p-0">
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Category :</label>
						<div class="col-sm-9 p-0">
							<span id="product_category">
										<?php
										$a2="select id, category_name from item_category where 1 and group_for='".$_SESSION['user']['group']."'";
										//echo $a2;
										$a1=db_query($a2);
						...
						<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Sub Category :</label>
						<div class="col-sm-9 p-0">
							<span id="product_subcategory">
										<?php
										$a2="select id, subcategory_name from item_subcategory where 1 and group_for='".$_SESSION['user']['group']."'";
										//echo $a2;
										$a1=db_query($a2);
										echo "<select name=\"subcategory_id\" id=\"subcategory_id\"\" >";
										echo "<option></option>";
										while($a=mysqli_fetch_row($a1))
										{
