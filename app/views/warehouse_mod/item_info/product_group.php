...
$table='item_group_cus';
$page="product_group.php";
$crud      =new crud($table);
$$unique = $_GET[$unique];
$tr_type="Show";
        ...
        <div class="col-sm-7 p-0 pr-2">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select b.group_id,  b.group_name, b.description from item_group_cus b, user_group a where a.id=b.group_for and group_for='".$_SESSION['user']['group']."' ";
...
$con .= 'and b.group_for="'.$_POST['group_for'].'"';
	...
	$rrr = "select b.group_id,  b.group_name, b.description from item_group_cus b, user_group a where a.id=b.group_for  ".$con." ";
