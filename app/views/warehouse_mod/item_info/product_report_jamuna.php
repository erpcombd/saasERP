...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4" action="master_report_jamuna.php" method="post" name="form1" target="_blank" id="form1" style="width:90%">
        <div class="row m-0 p-0">
                   ...
                   <!-- <input name="report" type="radio" class="radio1" id="report2-btn"  value="888833"  tabindex="2"/> -->
                    ...
                    <label class="form-check-label p-0" for="report2-btn">
                        Product Information Report (888811)
				          ...
				          <div class="form-check">
                   <!-- <input name="report" type="radio" class="radio1" id="report2-btn"  value="888833"  tabindex="2"/> -->
					<input name="report" type="radio" class="radio1" id="report2-btn"  value="888121"  tabindex="2"/>
                    <label class="form-check-label p-0" for="report2-btn">
                        Product Group, Sub Group,Sub Sub Group,Item Report (888121)
                    </label>
                </div>
				<div class="form-check">
                   <!-- <input name="report" type="radio" class="radio1" id="report2-btn"  value="888833"  tabindex="2"/> -->
					<input name="report" type="radio" class="radio1" id="report2-btn"  value="28518"  tabindex="2"/>
                    <label class="form-check-label p-0" for="report2-btn">
                       Product Wise Warehouse,Zone,Location,Aisle,Shelf,Bin Position Report(28518)
                    </label>
                </div>
				<div class="form-check">
                   <!-- <input name="report" type="radio" class="radio1" id="report2-btn"  value="888833"  tabindex="2"/> -->
					<input name="report" type="radio" class="radio1" id="report2-btn"  value="285186"  tabindex="2"/>
                    <label class="form-check-label p-0" for="report2-btn">
                      Warehouse wise Location,Zone,Lane,Rack,Tray,Bin/Position Report(285186)
                    </label>
                </div>
            ...
            <div class="col-sm-6">
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Product Catagory </label>
                    <div class="col-sm-8 p-0">
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Product Sub Catagory</label>
                    <div class="col-sm-8 p-0">
                        <span class="oe_form_group_cell">
            ...
            <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Product Sub  Sub Catagory</label>
                    <div class="col-sm-8 p-0">
                        <span class="oe_form_group_cell">
