...
$unique_field='room_no';

$table='room_setup';

$page="room_manage.php";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      <div class="col-md-4">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1"> Room Manage</h4>
		  ...
		  <div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
                      ...
                      <input type="text" name="room_no" id="room_no" value="<?=$room_no?>" class="form-control"/>
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
					...
					<input type="text" name="room_name" id="room_name" value="<?=$room_name?>" class="form-control"/>
          ...
          <div class="form-group row m-0 pl-3 pr-3  p-1">
			...
			<select id="warehouse_id" name="warehouse_id" value="<?php echo $_POST['warehouse_id'];?>" onchange="getData2('buyer_ajax_alamin.php', 'buyer_filter', this.value, 
document.getElementById('warehouse_id').value);">
              <option></option>
              <? foreign_relation('warehouse','warehouse_id','warehouse_name',$warehouse_id,'1 order by warehouse_name asc');?>
            </select>
			...
			<span id="buyer_filter"><select id="floor_no" name="floor_no">
				
				<? foreign_relation('floor_setup','id','floor_short_name',$_POST['floor_no'],'1');?>
			</select>	    </span>
