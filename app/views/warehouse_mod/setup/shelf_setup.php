...
$unique_field='shelf_name';

$table='item_location_shelf';

$page="shelf_setup.php";
...
function nav(lkf){document.location.href = '<?=$page?>?<?=$unique?>='+lkf;}
  ...
  <div class="container-fluid p-0">
    ...
    <div class="row">
	 ...
	 $rrr = "select * from item_location_shelf where 1";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      <div class="col-md-4 p-0">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1">Shelf</h4>

		  

		  <div class="form-group row m-0 pl-3 pr-3  p-1">

            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label">Shelf Name:</label>

            <div class="col-sm-8 col-md-8 col-lg-8 p-0">

						 <input type="text" name="shelf_name" class="form-control"  id="shelf_name" value="<?=$shelf_name;?>"/>
