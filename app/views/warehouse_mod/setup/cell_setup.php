  ...
  <div class="container-fluid">
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
            ...
            <tr<?=$cls?> >
              ...
              <td><?=find_a_field('rak_setup','rak_name','rak_no='.$rp[3]);?></td>
      ...
      <div class="col-md-4">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1"> Cell Manage</h4>

		  

		  <div class="form-group row m-0 pl-3 pr-3  p-1">

            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label">Selve No:</label>

            <div class="col-sm-8 col-md-8 col-lg-8 p-0">

                      <input type="hidden" name="id" id="id" value="<?=$id?>" class="form-control"/>

                      <input type="text" name="sub_cell_no" id="sub_cell_no" value="<?=$sub_cell_no?>" class="form-control"/>
            ...
            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label"> Selve Name :</label>
		...
		<div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
              ...
              <select name="rak_no" id="rak_no">
							<? foreign_relation('rak_setup','rak_no','rak_name',$rak_no,'1 order by rak_no asc');?>
