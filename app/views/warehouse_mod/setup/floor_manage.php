...
$unique_field='floor_short_name';

$table='floor_setup';

$page="floor_manage.php";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      <div class="col-md-4">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1"> Floor Manage</h4>

		  

		  <div class="form-group row m-0 pl-3 pr-3  p-1">

            <label for="group_name" class="col-sm-4 col-md-4 col-lg-4 pl-0 pr-0 col-form-label">Floor Short Name:</label>

            <div class="col-sm-8 col-md-8 col-lg-8 p-0">

                      <input type="hidden" name="id" id="id" value="<?=$id?>" class="form-control"/>

                      <input type="text" name="floor_short_name" id="floor_short_name" value="<?=$floor_short_name?>" class="form-control"/>
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
					...
					<input type="text" name="floor_name" id="floor_name" value="<?=$floor_name?>" class="form-control"/>
