...
function nav(lkf){document.location.href = '<?=$page?>?<?=$unique?>='+lkf;}
  ...
  <div class="container-fluid">
    <div class="row">
	 ...
	 $rrr = "select * from warehouse where use_type != 'PL' order by warehouse_id desc";
	$report=db_query($rrr);
		...
		<?php /*?><div class="form-group row m-0 pl-3 pr-3 p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
					<select name="master_warehouse_id" id="master_warehouse_id">
                     <option ></option>					
					 <? foreign_relation('warehouse','warehouse_id','warehouse_name',$master_warehouse_id,'1 and use_type="WH" ');?>
					</select>
