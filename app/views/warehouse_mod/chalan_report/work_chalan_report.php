...
<form action="master_report_chalan.php" method="post" name="form1" target="_blank" id="form1">
  <table class="w-100" border:0;>
    ...
    <tr>
      <td><div class="box4">
          <table  style="border:0; text-align: center;"><th></th>
            <tr>
              <td><table  class="w-100" border="0"><th></th>
                  <tr>
                    <td class="align-top"><table class="w-100" border="0"><th></th>
                        <tr>
                          <td><table style="border:0;">
                            <tr>
                                <td colspan="2" class="title1"><div class="text-left">Select Report </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="1" checked="checked" /></td>
                                <td><div class="text-left">Delivery Chalan Brief Report</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="2" /></td>
                                <td><div class="text-left">Undelivered Do Details Report</div></td>
                              </tr>
                              
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="3" /></td>
                                <td><div class="text-left">Delivered Chalan Report (Chalan Wise)</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="4" /></td>
                                <td><div class="text-left">Chalan Report(Chalan Date Wise)</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="5" /></td>
                                <td><div class="text-left">Delivery Order Brief Report (Region Wise)</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="6" /></td>
                                <td><div class="text-left">View Chalan Report (Single)</div></td>
                              </tr>
                              <tr>
                                <td>&nbsp;</td>
                                <td>&nbsp;</td>
                              ...
                              <tr>
                                ...
                                <td><div class="text-left">Corporate Chalan Summary Brief</div></td>
                              </tr>
                          </table></td>
                        </tr>
                    </table></td>
              ...
              <td><table class="w-100" style="margin:0 auto; border:0;"><th></th>
                  <tr>
                    <td>&nbsp;</td>
                    <td>&nbsp;</td>
                  </tr>
    ...
    <tr>
      <td><div class="box">
        <table style=" margin:0 auto;"><th></th>
            <tr>
