...
<form action="master_report.php" method="post" name="form1" target="_blank" id="form1">
                          ...
                          <td><table><th></th>
                             ...
                             <tr>
                              ...
                              <tr>
                                ...
                                <td><div class="text-left">Delivery Order Brief Report</div></td>
                              ...
                              <tr>
                                ...
                                <td><div class="text-left">DO Report Dealer Wise</div></td>
                              ...
                              <tr>
                                ...
                                <td><div class="text-left">Item Wise DO Report</div></td>

                              </tr>

                              <tr>

                                <td><input name="report" type="radio" class="radio" value="50" /></td>

                                <td><div class="text-left">DO List </div></td>
  ...
  <tr>
    ...
    <td><div class="text-left">View Single Report: DO NO</div></td>
...
<tr>
	...
	<td><input name="report" type="radio" class="radio" value="51" /></td>

	<td><div class="text-left">Undelivered Item Lisr(DO Wise) </div></td>
              ...
              <td  class="align-top"><table><th></th>
