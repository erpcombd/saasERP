...
<table class="table table-bordered">
  ...
  <tbody>
  <?php
 $sql='SELECT s.do_no,s.chalan_no,s.item_id,s.dealer_code,s.unit_price,sum(s.total_unit) as total_unit,sum(s.total_amt) as total_amt,s.chalan_date,s.dealer_code,i.item_name,i.unit_name
from sale_do_chalan s,item_info i
