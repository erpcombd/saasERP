...
$data5=mysqli_fetch_object($query);
 ...
 $sql1='SELECT s.chalan_no,s.dealer_code,s.chalan_date,d.dealer_name_e,d.dealer_code,d.address_e,d.email,d.contact_no,d.contact_person_name,d.contact_person_designation,s.do_no,m.po_no from sale_do_chalan s,dealer_info d,sale_do_master m where s.do_no=m.do_no and s.chalan_no="'.$challan.'" and s.dealer_code=d.dealer_code limit 1 ';   
...
window.print();
  ...
  <p class="text-center">Cell: <?php echo find_a_field('project_info','sales_phone','1');?>. Email: <?php echo find_a_field('project_info','proj_email','1')?><br>www.habibindustries.net</p>
                </div>
                <div class="d-flex align-items-center">
...
<!--<h4 class="text-center"><u>Invoice</u></h4>-->
  ...
  <tbody>
  <?php
  $sql='SELECT s.chalan_no,s.item_id,s.dealer_code,s.unit_price,s.total_unit,s.total_amt,s.chalan_date,s.dealer_code,i.item_name,i.unit_name,s.do_no 
...
?>
<tr class="text-center">
<td colspan="4" style="text-align:left;font-weight:bold;"> Cash Discount </td></td><td></td><td></td><td></td>
...
<div class="row">
      ...
      <tr style="border:0px solid;">
		...
		<td align="center" valign="bottom"  style="border:0px solid;"><div style="border-bottom:1px solid black;width:90%;"><b><?php  find_a_field('user_activity_management','fname','user_id='.$all_appro->check_inv_by); ?></b></div></td>


        <td align="center" valign="bottom"  style="border:0px solid;"><div style="border-bottom:1px solid black;width:90%;"><b><?php echo find_a_field('user_activity_management','fname','user_id='.$all_appro->check_inv_by); ?></b></div></td>
		
		<td align="center" valign="bottom"  style="border:0px solid;"><div style="border-bottom:1px solid black;width:90%;"><b><?php echo find_a_field('user_activity_management','fname','user_id='.$all_appro->check_appr_by); ?></b></div></td>
      ...
      <tr  style="border:0px solid;">
        ...
        <td  style="border:0px solid;"><div align="center">Received By</div></td>


        <td style="border:0px solid;"><div align="center">Checked By</div></td>
		
		<td style="border:0px solid;"><div align="center">Approved By</div></td>
