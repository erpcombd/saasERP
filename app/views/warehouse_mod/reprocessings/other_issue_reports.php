...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4 fo-width1" action="master_report.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                <div align="left">Select Report </div>
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1100" checked="checked" tabindex="1">
            ...
            <div class="col-sm-7">
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
						<input type="text" name="item_id" id="item_id" style="width:250px" />
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                      <span class="oe_form_group_cell">
                        	<input name="f_date" type="text" id="f_date" value="2022-10-01" required="" autocomplete="off" class="form-control hasDatepicker">
                      </span>
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
                            <input name="t_date" type="text" id="t_date" value="2022-10-31" required="" autocomplete="off" class="form-control hasDatepicker">
