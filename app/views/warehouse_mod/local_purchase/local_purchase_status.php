    ...
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          ...
          <input type="text" name="tdate" id="tdate" style="width:107px;" value="<?=date('Y-m-d')?>" />

        </strong></td>

        <td bgcolor="#FF9966" style="text-align:center"><strong>

          <input type="submit" name="submitit" id="submitit" value="VIEW DETAIL" style="width:120px; font-weight:bold; font-size:12px; height:30px; color:DodgerBlue"/ >
