...
<option></option>
<option <?=($issued_to==0)?'Selected':'';?> value="0">Self Reprocess</option>
<option <?=($issued_to==2)?'Selected':'';?> value="2">Sajeeb Corporation</option>
<option <?=($issued_to==3)?'Selected':'';?> value="3">HFL</option>
<option <?=($issued_to==10)?'Selected':'';?> value="10">HFML</option>
<option <?=($issued_to==4)?'Selected':'';?> value="4">HAPL</option>
</select>
      </div>
      <div>
        <? $field='approved_by';?>
