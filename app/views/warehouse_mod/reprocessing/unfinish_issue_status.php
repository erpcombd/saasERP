...
$unique = 'po_no';
$status = 'CHECKED';
$target_url = '../reprocessing/other_issue.php';
...
{
	window.open('<?=$target_url?>?oi_no='+theUrl);
}
</script>
...
where  a.issue_type = "Reprocess Issue" and a.status="MANUAL" and a.oi_no=b.oi_no and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" '.$con.' group by a.oi_no order by a.oi_no desc';
