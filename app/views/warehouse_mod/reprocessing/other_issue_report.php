		  ...
		  <tr>
		    <td width="55%">
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        <tr>
		          <td width="25%" align="right" valign="middle"><strong>Issue To  : </strong></td>
		          <td width="75%"><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            <tr>
		        ...
		        <tr>
		          <td align="right" valign="middle">  <strong>Entry By :</strong></td>
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            <tr>
				  ...
				  <tr>
		          <td align="right" valign="middle"><strong>Approved By :</strong></td>
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            <tr>
		              <td width="45%"><?php echo $approved_by;?></td>
		              <td width="55%"> <strong>Time:</strong> <?php echo $entry_at;?></td>
		              </tr>
		            </table></td>
		          </tr>
		        </table></td>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  <tr>
                <td width="47%" align="right" valign="middle"><strong>Issue No :</strong></td>
				...
				<tr>
				<td align="right" valign="middle"><strong>Issue Date :</strong> </td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
				...
				<tr>
				<td align="right" valign="middle"><strong>Store Serial No :</strong></td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
...
?>
<h2 style="text-align:center;">Kit Pack Name: <?=$kit_item?> </h2>
