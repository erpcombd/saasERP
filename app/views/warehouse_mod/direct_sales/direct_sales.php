...
if(isset($_POST['new']))
{
		...
		$_POST['vendor_name']=find_a_field('dealer_info','dealer_name_e','dealer_code="'.$_POST['vendor_id'].'"');
...
if(isset($_POST['confirmm']))
{
		...
		$oi_no = $_POST['oi_no'];
        $sql = 'select w.*,s.item_ledger, s.sub_group_name,s.cogs_ledger from warehouse_other_issue_detail w, item_info i, item_sub_group s where i.item_id=w.item_id and s.sub_group_id=i.sub_group_id and w.oi_no="'.$oi_no.'" and w.issue_type="DirectSales"';
		$qry = db_query($sql);
		$page_for = 'DirectSales';
		...
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->item_ledger, $narration, '0',$cogs_amt,  $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
		$narration = 'DirectSales#Cogs#'.$oi_no;
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->cogs_ledger, $narration, $cogs_amt,'0',  $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
		$total_amt +=$data->amount;
		}
		$narration = 'DirectSales#'.$oi_no;
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $ledgers->directSales, $narration, '0',$total_amt, $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		$narration = 'DirectSales#Customer#'.$oi_no;
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $customer_ledger, $narration, $total_amt,'0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		unset($_POST);
		$_POST[$unique]=$$unique;
		$_POST['entry_by']=$_SESSION['user']['id'];
		$_POST['entry_at']=date('Y-m-d h:s:i');
...
if($$unique>0) $btn_name='Update DS Information'; else $btn_name='Initiate DS Information';
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							<div class="form-group row m-0 pb-1">
							    <? $field='oi_no';?>
								<label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Direct Sales  No:</label>
							...
							<div class="form-group row m-0 pb-1">
								...
								<label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Direct Sales Date:</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
									   ...
									   <option value="<?php echo $vendor_id;?>"><?php echo find_a_field('dealer_info','dealer_name_e','dealer_code="'.$vendor_id.'"');?></option>
											<option></option>
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						<tr>
							...
							<input name="item_id" type="text"  value="" id="item_id" onblur="getData2('direct_sales_ajax.php', 'so_data_found', this.value, document.getElementById('oi_no').value);"/>
							...
							<td id="so_data_found" colspan="4">
								...
								<tr>
									 <td width="43%"><input name="item_name" type="text"  readonly=""  autocomplete="off"  value="" id="item_name" /> </td>
									 <td width="10%"><input name="pcs_stock" type="text"  readonly=""  autocomplete="off"  value="" id="pcs_stock" /></td>
									 <td width="14%"><input name="ctn_price" type="text"  id="ctn_price" readonly=""   required  value="<?=$do_data->ctn_price;?>"   /></td>
									 <td width="15%"><input name="pcs_price" type="text"  id="pcs_price" readonly=""   required="required"  value="<?=$do_data->pcs_price;?>"  /></td>
								</tr>
								</table>
							</td>
