...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      <tr>
                        ...
                        <td align="center" bgcolor="#0099FF" width="10%"><strong>Stock</strong></td>
                        <td align="center" bgcolor="#0099FF" width="10%"><strong>Unit</strong></td>
                        <td align="center" bgcolor="#0099FF" width="10%"><strong>Price</strong></td>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:320px;" required onblur="getData2('sr_receive_ajax.php', 'po',this.value,document.getElementById('warehouse_id').value);"/></td>
<td colspan="3" align="center" bgcolor="#CCCCCC">
<span id="po">
 <table width="100%" cellpadding="0" cellspacing="0" border="1">
   <tr>
     <td>
<input name="stk" type="text" class="input3" id="stk" style="width:100%;" readonly/>
</td>
<td>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM SR Receive" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" />
