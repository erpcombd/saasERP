...
<tr bgcolor="#CCCCCC">
	 <td width="21%">
	 <input name="pkt_size" type="hidden" class="input3" id="pkt_size"  value="<?=$item_all->pack_size?>" readonly="readonly"/>
	 
	 <input name="item_name" type="text" class="input3"  value="<?=$item_all->item_name;?>" id="item_name"   readonly="" /> </td>
	 <td width="7%"><input name="unit_name" type="text" class="input3"  value="<?=$item_all->unit_name;?>" id="unit_name"  /></td>
	 <td width="8%"><input name="pcs_stock" type="text" class="input3"  value="<?=(int)$stock_in_pcs;?>" id="pcs_stock"  /></td>
	 <td width="14%"><input name="unit_price" type="text" class="input3" id="unit_price"  required="required" onkeyup="count()"  value="<?=$item_all->d_price;?>"   /></td>
</tr>
</table>
