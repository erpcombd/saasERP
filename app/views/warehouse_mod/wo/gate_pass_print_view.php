  ...
  <tr>
    <td><div class="header"> 
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/warehouse_mod/wo/gate_pass_print_view.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
              ...
              <img src="<?=$qr_code?>" alt="QR Code" style="width:100px; height:100px;">
					  ...
					  <?php /*?><td><span style="font-size:14px; padding: 3px 0 0 10px; letter-spacing:7px;"><?=$chalan_no?></span></td><?php */?>
					  </tr>
					  </table>						</td>
                      </tr>
                    </table></td>
