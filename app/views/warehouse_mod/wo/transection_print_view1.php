                        ...
                        <td width="60%"><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                            <tr>
                              <td style="text-align:center; color:#000; font-size:14px; font-weight:bold;">
								...
								<p style="font-size:28px; color:#000000; margin:0; padding: 0 0 5px 0; text-transform:uppercase;  font-weight:700; font-family: 'TradeGothicLTStd-Extended';"><?=find_a_field('user_group','group_name','id='.$master->group_for)?></p>
 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td><div id="pr">
	  ...
	  <h2 style="text-align:center; font-size: 16px;">Challan Details</h2>
...
<tr >
 ...
 <?=number_format($invoice_amt= ($tot_amt_after_discount+$vat_amt+$ait_amt),2); ?>
	...
	<h2 style="text-align:center; font-size: 16px;">Journal Details</h2>
	
	<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">
      <tr bgcolor="#e6d7ff">

        <th align="center"><div align="center">SL</div></th>

        <th align="left">Accounts Head </th>
...
$sub_ledger = find_a_field('general_sub_ledger','sub_ledger_name','sub_ledger_id="'.$info->sub_ledger.'"');
      ...
      <tr>
        ...
        <td align="left"><?=$sub_ledger?></td>
		   <td align="center"><?=$info->narration?></td>
...
<?php }?>
      ...
      <tr bgcolor="#fff">
        ...
        <td colspan="4" align="right"><b>Total Taka: </b></td>

        <td align="right"><b><?=number_format($ttd,2)?></b></td>

        <td align="right"><b><?=number_format($ttc,2)?></b></td>
  ...
  <tr>
    ...
    <td>Amount in Word : 
	 ...
	 <b><? echo convertNumberMhafuz($ttc)?></b>	 </td>
  ...
  <tr>
	...
	<h2 style="text-align:center; font-size: 16px;">COGS Details</h2>
	<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">

      <tr bgcolor="#7db6a3">

        <th align="center" style="color: #fff;"><div align="center">SL</div></th>

        <th align="left" style="color: #fff;">Accounts Head </th>
<th align="left" style="color: #fff;">Sub Ledger </th>
        <th align="center" style="color: #fff;">Particulars</th>
...
<?php }?>
      ...
      <tr bgcolor="#fff">
       ...
       <td colspan="4" align="right"><b>Total Taka: </b></td>
        ...
        <td align="right"><b><?=number_format($ttdd,2)?></b></td>

        <td align="right"><b><?=number_format($ttcc,2)?></b></td>
  ...
  <tr>
	...
	<h2 style="text-align:center; font-size: 16px;">Stock Details </h2>
	<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">

      <tr>
		<th rowspan="2" bgcolor="#008080" color="#fff" style="text-align:center; color: #fff;" >S/L</th>
		<th rowspan="2" bgcolor="#008080"  color="#fff" style="text-align:center; color: #fff;" >Date</th>
		<th rowspan="2" bgcolor="#008080"  color="#fff" style="text-align:left; color: #fff;" >Item Name</th>
		<th rowspan="2" bgcolor="#008080"  color="#fff" style="text-align:center ; color: #fff;" >SR No</th>
		<th colspan="1" bgcolor="#ADD8E6" style="text-align:center">OPENING BALANCE</th>
		<th colspan="2" bgcolor="#ADD8E6" style="text-align:center">PRODUCT RECEIVED</th>
		<th colspan="2" bgcolor="#ADD8E6" style="text-align:center">PRODUCT ISSUED</th>
		<th colspan="1" bgcolor="#ADD8E6" style="text-align:center">CLOSING BALANCE</th>
		</tr>
		<tr>
		<th bgcolor="#D3D3D3 " style="text-align:center">Qty</th>

		<th bgcolor="#D3D3D3 " style="text-align:center">Tr Type</th>
		<th bgcolor="#D3D3D3 " style="text-align:center">Qty</th>
		<th bgcolor="#D3D3D3 " style="text-align:center">Tr Type</th>
		<th bgcolor="#D3D3D3 " style="text-align:center">Qty</th>
		<th bgcolor="#D3D3D3 " style="text-align:center">Qty</th>
...
$stock = $opening - $info->qty;
      ...
      <tr>
        ...
        <td align="center"><?=$info->chalan_date?></td>
 <td align="left"><?=$info->item_name?></td>
        <td align="center"><?=$info->chalan_no?></td>
...
<?php }?>
  ...
  <tr>
    ...
    <td>Amount in Word : 
	 ...
	 <b><? echo convertNumberMhafuz($ttcc)?> </b></td>
...
<tr>
		...
		<table width="100%" cellspacing="0" cellpadding="7" border="1" class="mb-1 mt-5">
			<tr>
  ...
  <tfoot>
   ...
   <tr><td><hr class="hr mt-1 mb-1"/></td></tr>
	<table class="footer-table" width="100%" cellspacing="0" cellpadding="0">
						<tr style=" font-size: 12px; font-weight: 500; border-top: 2px solid #333;">
