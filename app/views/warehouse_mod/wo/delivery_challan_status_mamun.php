                    ...
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <select name="dealer_code" id="dealer_code"  >
									...
									<? foreign_relation('dealer_info','dealer_code','dealer_name_e',$_POST['dealer_code'],'group_for="'.$_SESSION['user']['group'].'" order by dealer_code');?>
								</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								...
								<? foreign_relation('sale_do_master','do_no','job_no',$_POST['do_no'],'group_for="'.$_SESSION['user']['group'].'"');?>
								</select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <select name="chalan_no" id="chalan_no" >
									...
									<? foreign_relation('sale_do_chalan','chalan_no','chalan_no',$_POST['chalan_no'],'group_for="'.$_SESSION['user']['group'].'" group by chalan_no');?>
									</select>
        ...
        <div class="container-fluid pt-5 p-0 ">
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr <?=($data->RCV_AMT>0)?'style="background-color:#FFCCFF"':'';?>>
				  <td><a title="Challan Preview" target="_blank" href="sales_invoice_print_view_mamun.php?v_no=<?=$data->chalan_no?>" style=" font-weight:700; color:#000000" >
					<?=$data->chalan_no;?>
				  </a></td>
				  <td><a title="Challan Preview" target="_blank" href="delivery_challan_print_view_mamun.php?v_no=<?=$data->chalan_no?>" style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a></td>
				  <td><a title="Gate Pass Preview" target="_blank" href="gate_pass_print_view_mamun.php?v_no=<?=$data->chalan_no?>"  style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a></td>
