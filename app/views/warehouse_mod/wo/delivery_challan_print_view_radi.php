...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <tr>
	...
	<table width="100%" cellspacing="0" cellpadding="2" border="0">
      <tr>
        <td>
		<h5 class=" text-center font-weight-bold mt-0 ml-0 mb-2 ">DELIVERY CHALAN</h5>
...
<td class="text-center"><strong>
 ...
 <tr>
		<table width="100%" cellspacing="0" cellpadding="0"  style="margin-bottom: 200px;" >
		
		   <tr>
		 	  <td align="center">
  <?php
    $ucid = find_a_field('sale_do_master', 'entry_by', 'do_no="' . $do_no . '"');
    $entry_by = find_a_field('user_activity_management', 'fname', 'user_id="' . $ucid . '"');
    echo ($entry_by) ? $entry_by : 'Not Applicable';
  ?>
</td>
<td align="center">
  <?php
    $uid = find_a_field('sale_do_chalan', 'entry_by', 'chalan_no="' . $chalan_no . '"');
    $entry_by_chalan = find_a_field('user_activity_management', 'fname', 'user_id="' . $uid . '"');
    echo ($entry_by_chalan) ? $entry_by_chalan : 'Not Applicable';
  ?>
</td>
<td align="center">
  <?php
    $uid = find_a_field('sale_do_chalan', 'checked_by', 'chalan_no="' . $chalan_no . '"');
    $checked_by = find_a_field('user_activity_management', 'fname', 'user_id="' . $uid . '"');
    echo ($checked_by) ? $checked_by : 'Not Applicable';
  ?>
</td>
<td align="center">
  <?php
    $uid = find_a_field('secondary_journal', 'checked_by', 'tr_from="Sales" and tr_no="' . $chalan_no . '"');
    $checked_by_secondary = find_a_field('user_activity_management', 'fname', 'user_id="' . $uid . '"');
    echo ($checked_by_secondary) ? $checked_by_secondary : 'Not Applicable';
  ?>
</td>
