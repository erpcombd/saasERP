...
<!--        top form start hear-->
        ...
        <div class="container-fluid pt-5 p-0 "><?=$_SESSION['cmsg'];unset($_SESSION['cmsg']);?>
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				where 
				 ...
				 m.group_for=u.id  and m.dealer_code=d.dealer_code and m.depot_id='".$_SESSION['user']['depot']."' and m.do_no=c.do_no and c.delivery_confirmation='No' ".$group_for_con.$con.$dealer_con.$job_no_con.$chalan_con."  group by c.chalan_no order by  c.chalan_date DESC, m.do_no,c.chalan_no ";
				$query = db_query($res);
				...
				<?php /*?>  <td><a title="Challan Preview" href="delivery_confirmation.php?v_no='<?=rawurlencode(url_encode($data->chalan_no));?>'" style=" font-weight:700; color:#000000" ><?=$data->chalan_no;?></a></td><?php */?>
				  
				  
				<td>
  <a title="Challan Preview"
     href="delivery_confirmation.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($data->chalan_no));?>"
