...
$target_url = 'musok_for_debit_note.php';
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody class="tbody1">
                       ...
                       <? 
							...
							where 
							  m.group_for=u.id  and m.vendor_id=d.vendor_id and m.pr_no=c.pr_no and m.status!='MANUAL' ".$group_for_con.$con.$dealer_con."  group by c.pr_no order by m.pr_no desc";
							$query = db_query($res);
							...
							<td <?=$data->pr_no;?>;" <?=(++$z%2)?'':'class="alt"';?>>&nbsp;
							  ...
							  <td><input type="button" name="submitit2"  value="View" class="btn1 btn1-bg-submit" onclick="custom('<?=url_encode($data->pr_no);?>');" <?=(++$z%2)?'':'class="alt"';?> / ></td>
							</tr>
