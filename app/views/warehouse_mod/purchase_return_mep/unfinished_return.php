...
and "'.date('Y-m-d').'"';}
  ...
  where a.vendor_id=d.vendor_id and a.entry_by=u.user_id and  a.status="MANUAL" '.$con.' order by a.pr_no desc';
          ...
          while($data = mysqli_fetch_object($query)){
            ...
            <tr>
              ...
              <td class="text-center">
                <a href="new_return.php?old_pr_no=<?=$data->pr_no?>">
                  <input type="button"  value="Complete SR"  class="btn1 btn1-bg-submit"/>
                </a>
              </td>
            </tr>
          <?php } ?>
