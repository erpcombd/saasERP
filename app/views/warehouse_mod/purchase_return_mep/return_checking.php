...
<input style="width:250px;"  name="pr_date" type="text" id="pr_date" value="<?=($pr_date!='')?$pr_date:date('Y-m-d')?>"  required readonly />
</div>
<? }?>
...
<div>
<label style="width:220px;">Return Date: </label>
<input style="width:250px;"  name="pr_date" type="hidden" id="pr_date" value="<?=$pr_date;?> "readonly/>
...
<select  id="depot_id" name="depot_id" class="form-control"  style="width:250px;" checked>
...
<select name="return_type" required id="return_type"   style="width:250px;" class="form-control"  checked >
...
<form action="unapproved_pr.php" method="post" name="cz" id="cz" onSubmit="if(!confirmm('Are You Sure Execute this?')){return false;}">
