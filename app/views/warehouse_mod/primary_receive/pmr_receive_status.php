...
where u.user_id=a.entry_by and a.warehouse_id=b.warehouse_id and  a.vendor_id=v.vendor_id   '.$con.' group by a.pmr_no order by a.pmr_no desc';
...
?>
                        ...
                        <tr>
							...
							<td><?=$data->entry_at?></td>
                            <td>
							<!--<a href="chalan_view2.php?pmr_no=<?=$data->pmr_no?>" target="_blank"><input type="button" class="bgc-info" value="View" /></a>-->
	<a href="chalan_view2.php?c='<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($data->pmr_no));?>'" target="_blank"><input type="button" class="bgc-info" value="View" /></a>
