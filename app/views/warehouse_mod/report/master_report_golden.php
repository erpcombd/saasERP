  ...
  if(isset($warehouse_id)) {$warehouse_con=' and a.warehouse_id='.$warehouse_id;
  	...
  	$warehouse_con=' and a.warehouse_id='.$_SESSION['user']['depot'];
		...
		$stockSql='select distinct i.item_id,i.unit_name,i.item_name,s.sub_group_name,i.finish_goods_code,i.d_price
		   ...
		   i.sub_group_id=s.sub_group_id'.$item_sub_con.$item_con.' and i.status = "Active" order by i.finish_goods_code,s.sub_group_name,i.item_name';
...
<thead>
<tr>
<td style="border:0px;" colspan="10"><div class="header"><h1><?=$_SESSION['company_name']?></h1><h2><?=$report?></h2>
<h2>Closing Stock of Date-<?=$to_date?></h2></div><div class="left"></div><div class="right"></div><div class="date">Reporting Time: <?=date("h:i A d-m-Y")?></div>
</td>
</tr>
