...
?>
    ...
    <tr>
	 ...
	 <?php /*?><td><a href="delivery_challan_print_view.php?v_no=<?=rawurlencode(url_encode(find_a_field('sale_do_chalan','chalan_no','do_no='.$data->do_no))); ?>" target="_blank">
	   <?=$data->do_no?>
	 </a></td><?php */?>
	 
	 
	  <td><a href="delivery_challan_print_view.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode(find_a_field('sale_do_chalan','chalan_no','do_no='.$data->do_no)));?>" target="_blank">
	   <?=$data->do_no?>
	 </a></td>
