...
$title='Cash Purchase Order  Report';
            ...
            <div class="col-sm-5">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label p-0" for="report1-btn">
                       ...
                       Cash Purchase Order Report(1105)
                        ...
                        <tr>
                          ...
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td width="6%"><input name="report" type="radio" class="radio" value="1105" /></td>

                                <td width="94%"><div align="left">Local Purchase Order Report</div></td>
