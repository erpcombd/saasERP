...
$title='Delivery Order Challan Report';
$tr_type="Show";
do_calander("#f_date");
do_calander("#t_date");
...
auto_complete_from_db('item_info','concat(finish_goods_code,"-",item_name)','item_id','1 and group_for="'.$_SESSION['user']['group'].'" and finish_goods_code>0','item_id');
$tr_from="Warehouse";
?>
...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4" action="do_master.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-5">
				...
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="7111" checked="checked" tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn">
                        Undeliverd Qty (Do Wise)
                    </label>
                </div>
            ...
            <div class="col-sm-7">
                ...
                <?php /*?><div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Marketing Person:</label>
                    <div class="col-sm-8 p-0">
				...
				<?php /*?><div class="form-group row m-0 mb-1 pl-3 pr-3">
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Client Type:</label>
                    <div class="col-sm-8 p-0">
				...
				<?php /*?><div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
								...
								<input  name="do_no" type="text" id="do_no" value="" class="form-control" />
                        </span>
                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><div align="left">Chalan Report</div></td>
                              </tr>
                              -->
  ...
  <tr>
         ...
         <tr>
           ...
           <tr>
                    ...
                    <td><select name="marketing_person" class="form-control" >
           <option></option>
            <option value="31502">Md Saud Sadrul Anam - Managing Director</option>
