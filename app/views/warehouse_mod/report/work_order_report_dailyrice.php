...
<div class="d-flex justify-content-center">
    <form class="n-form1 fo-width pt-4" action="master_report_dailyrice.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                <div align="left">Select Report </div>
				
				
<fieldset class="scheduler-border" style="padding: 7px !important;border: 1px solid #817777 !important;border-radius: 5px !important;">
    <legend class="scheduler-border" style="font-size: 12px !important; width: 125px; margin: 0px;">Production Report</legend>
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label p-0" for="report1-btn">
                        Warehouse Item Transection Report(1)
                    </label>
                </div> 
				
<!--	
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report6-btn" value="403"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report6-btn">
                        RM Receive & Comsumption(403)
                    </label>
                </div>

				  				
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report7-btn" value="404"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report7-btn">
                        Finish Goods Receive (404)
                    </label>
                </div> -->
				
									
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report8-btn" value="405"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report8-btn">
                        Production Report(405)
                    </label>
                </div>
				
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report411-btn" value="411"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report406-btn">
                        Production Report (Batch Wise)(411)
                    </label>
                </div>
				
													
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report406-btn" value="406"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report406-btn">
                        Finish Goods Received(406)
                    </label>
                </div>
				...
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report407-btn" value="407"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report407-btn">
                        Raw Material Received(407)
                    </label>
                </div>
				...
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report408-btn" value="408"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report408-btn">
                        Raw Material Comsumption(408)
                    </label>
                </div>
...
<fieldset class="scheduler-border" style="padding: 7px !important;border: 1px solid #817777 !important;border-radius: 5px !important;">
    <legend class="scheduler-border" style="font-size: 12px !important; width: 175px; margin: 0px;">SO/PO Undelivered report</legend>
