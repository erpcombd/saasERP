...
<table  style="width:100%; border:0; margin:0 auto; border-spacing:0; padding:0;">
  <tr>
    <td><div class="left_report">
							<table style="width:100%; border:0; margin:0 auto; border-spacing:0; padding:0;">
								  <tr>
								    <td><div class="box"><form id="form1" name="form1" method="post" action=""><table style="width:100%; border:0; margin:0 auto; border-spacing:2px; padding:0;">
                                      ...
                                      <tr>
                                        <td>&nbsp;</td>
										<td>
										<table  style="width:20%; border:0; boder-collapse:collapse; border-spacing:0; padding:0; text-align:left;">
											  <tr>
