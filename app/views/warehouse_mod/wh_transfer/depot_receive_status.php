    ...
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          ...
          <input type="text" name="fdate" id="fdate" style="width:120px;" value="<?=isset($_POST['fdate'])?$_POST['fdate']:date('Y-m-01');?>" />
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          ...
          <input type="text" name="tdate" id="tdate" style="width:120px;" value="<?=isset($_POST['tdate'])?$_POST['tdate']:date('Y-m-d');?>" />
      ...
      <tr>
        ...
        <td colspan="3" bgcolor="#FF9966"><select name="warehouse_id" id="warehouse_id" style="width:250px;">
...
$con .= 'and a.pi_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
 ...
 $res='select  a.pi_no,a.pi_no as TR_no, a.pi_date as TR_date,  w.warehouse_name as warehouse_name, a.status,  c.fname as entry_by, a.entry_at
