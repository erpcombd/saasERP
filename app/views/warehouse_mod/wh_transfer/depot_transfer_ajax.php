...
$price_sql='SELECT  * FROM sales_price_warehouse WHERE item_id="'.$item_all->item_id.'" and warehouse_id="'.$warehouse_to.'" ';
...
<td width="25%">
		...
		<td width="25%">
        <input name="unit_price" type="hidden" class="input3" id="unit_price"  maxlength="100" style="width:70px;" onkeyup="total_amtt()" value="<?=$price_data->unit_price?>"/>
		
		<input name="crt_price" type="text" class="input3" id="crt_price"  maxlength="100" style="width:70px;" onkeyup="total_amtt()" value="<?=$price_data->crt_price?>"/>
