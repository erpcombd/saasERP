...
<div class="body">
	<div class="header">
        ...
        $print_url = "https://saaserp.ezzy-erp.com/app/views/warehouse_mod/mr/mr_print_view.php?c=".rawurlencode($company_id)."&v=" . rawurlencode($req_no_qr_data);
...
<div class="main-content">
	...
	<table id="table-print" class="table1">
		<thead>
			<tr>
				<th>SL</th>
	 ...
	 $last_p_date=$info->last_p_date;
		...
		?>
			 ...
			 <td align="middle"><?=$vendor_name[$po_all->vendor_id]?></td>
		...
		<? }?>
			  ...
			  <tr>
				<td align="right" colspan="9" style="text-align:right;"><strong>Total Qty </strong></td>
...
<div class="footer"  id="footer">
	<table class="footer-table">
        ...
        <tr>
		  ...
		  <p style="font-size:11px; margin: 0;">(<?=find_a_field('user_activity_management','designation','user_id='.$all->checked_by);?>) <br/> <?=$all->checked_at?></p>		  </td>
        </tr>
        <tr>
        ...
        <tr>
          <td class="text-center"><strong>Request By</strong></td>
		  <td class="text-center"><strong>Checked By</strong></td>
          <td class="text-center"><strong>Dept Head</strong></td>
          <td class="text-center"><strong>HOP</strong></td>
