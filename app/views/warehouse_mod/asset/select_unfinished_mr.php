...
do_calander('#tdate');
$tr_type="Show";
$table = 'asset_requisition_master';
$unique = 'req_no';
$status = 'UNCHECKED';
$target_url = '../asset/mr_create.php';
/*if($_POST[$unique]>0)
{
  ...
  <div class="form-container_large">
    <form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        echo $res='select  	a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status from asset_requisition_master a,warehouse b,user_activity_management c where a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id '.$con.' and a.status in ("MANUAL") and a.product_requisition_type IN ("asset") order by a.req_no desc';
...
/*		  $raw_or_not = find_a_field ('requisition_order r, item_info i','COUNT(r.id)','1 and r.item_id=i.item_id and i.item_group != 200000000 and r.req_no = "'.$row->req_no.'"');
