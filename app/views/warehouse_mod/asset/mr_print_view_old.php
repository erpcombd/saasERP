...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	  ...
	  <div class="header">
		...
		<tr>
		<td class="logo">
			<img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$all->group_for?>.png" class="logo-img"/>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="2" cellpadding="2" style="border-collapse:collapse;">
       <tr bgcolor="#ffec62">
        ...
        <td><strong>In Stock</strong></td>
		 <td><strong>Last Pur. Vendor</strong></td>
...
?>
      <tr>
        ...
        <td align="left" valign="top">Code:<?=$info->item_id?><br><?=$item->item_name.' : '.$item->item_description?></td>
		 <td valign="top"><?=$info->specification;?></td>
    ...
    <div class="footer1">
            <table width="730" border="0">
                ...
                <tr>
                    ...
                    <td align="center"><strong>Checked By:</strong></td>
					<td align="center"><strong>Dept Head :</strong></td>
					<td align="center"><strong>HOP:</strong></td>
