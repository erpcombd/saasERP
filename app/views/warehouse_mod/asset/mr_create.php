...
$table_master='asset_requisition_master';

$table_details='asset_requisition_order';
 ...
 <?php /*?> <? foreign_relation('warehouse','warehouse_id','warehouse_name',$warehouse_id,'1 and group_for='.$_SESSION['user']['group'].'') ;?><?php */?>
							...
							<div class="form-group row m-0 pb-1">
								...
								<select name="product_requisition_type"  id="product_requisition_type"  tabindex="7" required="required">
									<option></option>
							 		<option value="asset" <?= $product_requisition_type == 'asset' ? 'selected' : '' ?>>Asset</option>
...
<a href="mr_print_view.php?req_no=<?=$_GET['req_no']?>" target="_blank"><input type="button" class="btn btn-success btn-sm" value="View MR" /></a>
<?php } ?>
