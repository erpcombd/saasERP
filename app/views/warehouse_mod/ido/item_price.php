...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
	...
	<input name="crt_price_<?=$data->item_id?>" id="crt_price_<?=$data->item_id?>" type="text" size="10" maxlength="10" value="<? echo $crt_price = find_a_field('sales_price_warehouse','crt_price','warehouse_id="'.$_POST['warehouse'].'" and item_id= "'.$data->item_id.'"');?>" style="width:70px;" onkeyup="TRcalculation(<?=$data->item_id?>)" /></td>
