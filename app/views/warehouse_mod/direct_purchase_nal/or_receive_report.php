...
$entry_sql = 'select u.fname from user_activity_management u, warehouse_other_receive b where u.user_id=b.entry_by and b.or_no='.$or_no;
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">OTHER RECEIVE REPORT </td>
		  ...
		  <tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
                ...
                <td align="right" valign="middle">OR No :</td>
			  ...
			  <tr>
                ...
                <td align="right" valign="middle"> OR Date :</td>
                ...
                <td align="right" valign="middle">Slip No :</td>

			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">

                    <tr>

                      <td><?php echo $or_subject;?>
