        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            if(isset($_POST['submitit'])){
                ...
                if($_POST['fdate']!=''&&$_POST['tdate']!='')
                 ...
                 $res='select  a.or_no,a.or_no as lp_no,a.or_date as lp_date, v.vendor_name as purchase_from,a.requisition_from,sum(amount) as Total,a.entry_at,c.fname as user,a.status 
				 
				 from warehouse_other_receive a,warehouse_other_receive_detail b, user_activity_management c ,vendor v
				 
				 where a.or_no=b.or_no and v.vendor_id=a.vendor_id and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" and a.receive_type = "Direct Purchase" '.$con.' group by a.or_no order by a.or_no desc';
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    ?>
                        ...
                        <tr>
                            <td><?=$lps->lp_no?></td>
                            <td><?=$lps->lp_date?></td>
                            <td style="text-align:left"><?=$lps->purchase_from?></td>
                            ...
                            <td><?=$lps->user?></td>
                            <td><?=$lps->status?></td>
                            <td><input type="submit" name="submitit" id="submitit" value="View" class="btn1 btn1-submit-input" onclick="custom(<?=$lps->lp_no?>);" /></td>
