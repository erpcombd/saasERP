...
<tbody>
	...
	<tr>
		...
		<th><div align="left">DP No</div></th>
		<th><div align="left">DP Date</div></th>
		<th><div align="left">Item Name</div></th>
...
select a.or_no as or_no, a.or_date, e.item_name,a.requisition_from,a.vendor_name as Purchase_From,b.unit_name,b.rate,b.qty,b.amount,a.receive_type,u.username,a.entry_at from  
 warehouse_other_receive a, warehouse_other_receive_detail b, item_info e, user_activity_management u  where a.or_no=b.or_no and a.receive_type="Direct Purchase" and b.item_id=e.item_id and u.user_id=a.entry_by '.$con.$item_con.$ctg_warehouse_con.$status_con.' order by a.or_no';
