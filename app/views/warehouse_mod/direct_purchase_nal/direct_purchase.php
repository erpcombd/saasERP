...
if(isset($_POST['confirmm']))
{
		...
		$or_no = $_POST['or_no'];
        $sql = 'select w.*,s.item_ledger from warehouse_other_receive_detail w, item_info i, item_sub_group s where i.item_id=w.item_id and s.sub_group_id=i.sub_group_id and w.or_no="'.$or_no.'"';
		$qry = db_query($sql);
		$page_for = 'DirectPurchase';
        ...
        $cc_code = '1';
        $tr_no = $or_no;
        $tr_from = 'DirectPurchase';
        $narration = 'DirectPurchase#'.$or_no;
		$vendor_id=find_a_field('warehouse_other_receive','vendor_id','or_no="'.$or_no.'"');
		$master_all=find_all_field('warehouse_other_receive','*','or_no="'.$or_no.'"');
		$vendor_ledger=find_a_field('vendor','ledger_id','vendor_id="'.$vendor_id.'"');
        $direct_purchase_ledgers = find_all_field('direct_purchase_ledgers','*','1');
		////////////types of cost ledger while direct Purchase//////////
		$labour_bill=$direct_purchase_ledgers->labour_bill;
		$cutting_charge=$direct_purchase_ledgers->cutting_charge;
		$scaling_cost=$direct_purchase_ledgers->scaling_cost;
		$loading_charge=$direct_purchase_ledgers->loading_charge;
		$vat=$direct_purchase_ledgers->vat;
		$transport=$direct_purchase_ledgers->transport;
		$pur_discount=$direct_purchase_ledgers->pur_discount;
		...
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->item_ledger, $narration, $data->amount,'0',  $tr_from, $tr_no,'',$tr_id,$cc_code,$group_for);
		$total_amt +=$data->amount;
		}
		if($master_all->labour_bill>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $labour_bill, $narration, $master_all->labour_bill,'0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
				if($master_all->cutting_charge>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $cutting_charge, $narration, $master_all->cutting_charge,'0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
				if($master_all->scaling_cost>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $scaling_cost, $narration, $master_all->scaling_cost,'0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
					if($master_all->loading_charge>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $loading_charge, $narration, $master_all->loading_charge, '0',$tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
					if($master_all->macking_change>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $loading_charge, $narration, $master_all->macking_change, '0',$tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
					if($master_all->transport>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $transport, $narration,$master_all->transport, '0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
						if($master_all->vat>0){
						$pur_vat_amt=$master_all->vat;
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $vat, $narration, $pur_vat_amt,'0', $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
					if($master_all->discount>0){
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $pur_discount, $narration, '0',$master_all->discount, $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		}
		
		
		$total_purchase_amt_final=($total_amt+$master_all->labour_bill+$master_all->cutting_charge+$master_all->scaling_cost+$master_all->loading_charge+$master_all->macking_change+$master_all->transport+$pur_vat_amt)-$master_all->discount;
		
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $vendor_ledger, $narration, '0',$total_purchase_amt_final, $tr_from, $tr_no,'',$tr_id=0,$cc_code,$group_for);
		unset($_POST);
		$_POST[$unique]=$$unique;
		$_POST['entry_by']=$_SESSION['user']['id'];
		$_POST['entry_at']=date('Y-m-d h:s:i');
...
if($$unique>0) $btn_name='Update DP Information'; else $btn_name='Initiate DP Information';
if($_SESSION['or_no2']<1)
$$unique=db_last_insert_id($table_master,$unique);

//auto_complete_from_db($table,$show,$id,$con,$text_field_id);
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_id)','1','item_id');
auto_complete_from_db('vendor','vendor_name','concat(vendor_name,"#>",vendor_id)','1','vendor_id');
?>
            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
						...
						<? $field='or_no';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">DP NO</label>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">DP Date</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
...
<div class="form-group row m-0 pb-1">
						<? $field='labour_bill';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Labour Bill</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="form-group row m-0 pb-1">
						<? $field='cutting_charge';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Cutting Charge</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="form-group row m-0 pb-1">
						<? $field='scaling_cost';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Scaling Cost</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<? $field='loading_charge';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Loading Charge</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="form-group row m-0 pb-1">
						<? $field='macking_change';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Macking Charge</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
        					...
        					<input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=find_a_field('vendor','vendor_name','vendor_id='.$$field);?>" required="required"/>
						...
						<div class="form-group row m-0 pb-1">
						<? $field='vat';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">VAT(Taka)</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="form-group row m-0 pb-1">
						<? $field='transport';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Transport</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
						...
						<div class="form-group row m-0 pb-1">
						<? $field='discount';?>
                            <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Discount(Taka)</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
...
<input name="item_id" width="10%" type="text"   value="" style="text-align:left" id="item_id"  onblur="getData2('local_purchase_ajax.php', 'so_data_found', this.value, document.getElementById('or_no').value);"/>
                    ...
                    <td colspan="4">
						...
						<table style="width:100%;" border="1">
							<tr>
								...
								<td width="23%"><input name="item_name" type="text" class="input3"  readonly=""  autocomplete="off"  value="" id="item_name"  /></td>

								<td width="10%"><input name="pcs_stock" type="text" class="input3"  readonly=""  autocomplete="off"  value="" id="pcs_stock"  /></td>

								<td width="10%"><input name="ctn_price" type="text" class="input3" id="ctn_price" readonly=""    required  value="<?=$do_data->ctn_price;?>"   /></td>

								<td width="12%"><input name="pcs_price" type="text" class="input3" id="pcs_price" readonly=""    required="required"  value="<?=$do_data->pcs_price;?>"  /></td>
							</tr>
						</table>
						</span>
							</div>
    ...
    <form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
        <div class="container-fluid p-0 ">
            ...
            <div class="n-form-btn-class">
				...
				<input  name="receive_type" type="hidden" id="receive_type" value="<?=$page_for?>"  required="required"/>
<input type="hidden" id="or_date" name="or_date" value="<?=$or_date?>"  />
                <input name="confirmm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM AND FORWARD DP" />
            </div>
