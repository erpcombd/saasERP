    ...
    <form action="" method="post" name="codz" id="codz">
        ...
        <div class="row">
          ...
          <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
            <div class="form-group row m-0">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                <input type="text" name="tdate" id="tdate" value="<?=date('Y-m-d')?>" required autocomplete="off"/>
              </div>
            </div>
          </div>
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        if(isset($_POST['submitit'])){
          ...
          $res='select  a.or_no,a.or_no as or_no,a.receive_type as type,a.or_date as or_date,a.or_subject as slip_no,a.status as status, a.vendor_name as receive_from,sum(amount) as Total,a.entry_at,c.fname as user
        ...
        <table class="table1  table-striped table-bordered table-hover table-sm">
          ...
          while($row = mysqli_fetch_object($query)){
            ...
            <tr>
              ...
              <td><input type="submit" name="submitit" id="submitit" value="VIEW" class="btn1 btn1-submit-input" onclick="custom('<?=url_encode($row->or_no);?>','<?=url_encode($c_id);?>');"></td>
