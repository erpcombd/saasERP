...
$datas=find_all_field('stock_transfer_master','','st_no='.$st_no);
  ...
  $sql1="select b.*,(select warehouse_name from warehouse where warehouse_id=b.warehouse_from)as warehouse_from,(select warehouse_name from warehouse where warehouse_id=b.warehouse_to) as warehouse_to from stock_transfer_master b where b.st_no = '".$st_no."'";
...
$sql1="select b.* from stock_transfer_details b where b.st_no = '".$st_no."'";
...
<title>.: Stock Trasnfer Report :.</title>
		  ...
		  <tr>
		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
		          ...
		          <td width="40%" align="right" valign="middle">Warehouse To  : </td>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td ><strong><?php echo $warehouse_to;?></strong>&nbsp;</td>
		        ...
		        <tr>
                  ...
                  <td align="right" valign="middle">Warehouse From:</td>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
                ...
                <td width="47%" align="right" valign="middle">St No :</td>
			    ...
			    <td width="53%"><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>&nbsp;<strong><?php echo $st_no;?></strong></td>
				...
				<td align="right" valign="middle">St Date : </td>
			    ...
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td>&nbsp; <?=date("d M, Y",strtotime($st_date))?></td>
			    ...
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td><?php echo find_a_field('user_activity_management','fname','user_id='.$approved_by);?></td>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr>
		...
		<td align="right" valign="top"><?=$unit_pcs[$i]; $tot_unit += $unit_pcs[$i];?></td>
