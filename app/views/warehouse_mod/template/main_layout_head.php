...
<div class="wrapper" align="">
			...
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
			  <tr>
				<td>
				<img src="<?=SERVER_ROOT?>public/uploads/logo/logo.jpg"  height="35" border="0" />
				</td>
				<td><div class="header2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  <tr>
					...
					<? if(isset($_SESSION['proj_name'])) echo $_SESSION['proj_name']; else echo '.: Hotel Management Software :.';?></div></td>
                  </tr>
                  <tr>
                    <td><div align="right">
