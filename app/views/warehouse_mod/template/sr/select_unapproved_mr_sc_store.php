  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><strong>
      <select name="<?=$unique?>" id="<?=$unique?>">
        <? foreign_relation($table.' r, warehouse w','r.'.$unique,'r.'.$unique,$$unique,'r.warehouse_id=w.warehouse_id and w.use_type="SD" and w.group_for='.$_SESSION['user']['group'].' and r.status="'.$status.'"');?>
      </select>
    </strong></td>
    <td bgcolor="#FF9966"><strong>
