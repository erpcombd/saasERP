...
if(isset($_POST['confirmm']))
{
		...
		//NOW
		$_POST['status']='PRE-CHECKED';
		$_POST['operation_manager']=$_SESSION['employee_selected'];
  ...
  <tr>
    ...
    <? $field='warehouse_id'; $table='warehouse';$get_field='warehouse_id';$show_field='warehouse_name';?>
      <div>
		...
		<input name="warehouse_id2" id="warehouse_id2" value="<?=find_a_field('user_group','group_name','id='.$warehouse_id)?>"/>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <td align="center">
	  <input name="entry_by" type="hidden" value="<?=$entry_by;?>"  />	
