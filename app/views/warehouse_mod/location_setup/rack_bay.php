...
$title='Rack/Bay Setup';



$unique='rack_bay_id';

$unique_field='rack_bay_name';
  ...
  <td><?=$rp[5];?></td>
      ...
      <div class="col-md-4 p-0">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1">Rack/Bay</h4>
...
<div class="form-group row m-0 pl-3 pr-3  p-1">
		  ...
		  <div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="rack_bay_name" class="form-control"  id="rack_bay_name" value="<?=$rack_bay_name;?>"/>
...
<div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="rack_description" class="form-control"  id="rack_description" value="<?=$rack_description;?>"/>
