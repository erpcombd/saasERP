...
$title='Shelf/Level Setup';



$unique='shelf_level_id';

$unique_field='shelf_level_name';

$table='item_shelf_level';
  ...
  <td><?=$rp[6];?></td>
      ...
      <div class="col-md-4 p-0">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1">Shelf/Level</h4>
...
<div class="form-group row m-0 pl-3 pr-3  p-1">
		  ...
		  <div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="shelf_level_name" class="form-control"  id="shelf_level_name" value="<?=$shelf_level_name;?>"/>
	...
	<div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="shelf_description" class="form-control"  id="shelf_description" value="<?=$shelf_description;?>"/>
