...
$title='Zone/Location Setup';



$unique='zone_loc_id';

$unique_field='zone_loc_name';

$table='item_zone_location';

$page="zone_location.php";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      <div class="col-md-4 p-0">
        ...
        <form id="form1" name="form1" class="n-form" method="post" action="<?=$page?>?<?=$unique?>=<?=$$unique?>">
          ...
          <h4 align="center" class="n-form-titel1">Zone/Location</h4>
<div class="form-group row m-0 pl-3 pr-3  p-1">
		  ...
		  <div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="zone_loc_name" class="form-control"  id="zone_loc_name" value="<?=$zone_loc_name;?>"/>
...
<div class="form-group row m-0 pl-3 pr-3  p-1">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 p-0">
						 ...
						 <input type="text" name="zone_description" class="form-control"  id="zone_description" value="<?=$zone_description;?>"/>
