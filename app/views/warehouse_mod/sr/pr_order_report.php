...
$title='Work Order Advence Reports';do_calander("#f_date");

do_calander("#t_date");

auto_complete_from_db('item_info','item_name','item_id','1','item_id');

?><form action="../report/pr_master_report.php" method="post" name="form1" target="_blank" id="form1">
      ...
      <td><div class="box4">
          ...
          <table width="95%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
                          ...
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<!--  <tr>
							   ...
							   <tr>
                                 ...
                                 <td width="6%"><input name="report" type="radio" class="radio" checked="checked" value="400001" /></td>

							     <td width="94%"><div align="left">MR Summery Receive Date Wise </div></td>
						      </tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">                  <tr>
                    <td>Item Code  : </td>
                    <td>
