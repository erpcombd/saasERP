  ...
  <tr>
    ...
    <? $field='or_no';?>
      ...
      <div>
        ...
        <label for="<?=$field?>">Purchase Return  No: </label>
    ...
    <? $field='or_date'; if($or_date=='') $or_date =date(''); ?>
      ...
      <div>
        ...
        <label for="<?=$field?>">Purchase Return Date:</label>
...
<? $field='receive_date'; if($receive_date=='') $receive_date =date(''); ?>
    ...
    <? $field='or_subject';?>
      ...
      <div>
        ...
        <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<? if($vendor_name=='') echo find_a_field('vendor','concat(vendor_name,"(",vendor_id,")")','vendor_id='.$vendor); else echo $vendor_name;?>" required="required"/>

        <input  name="vendor_id" type="hidden" id="vendor_id" value="<?=($vendor_id>0)?$vendor_id:$vendor;?>" required="required"/>
...
<div>
          ...
          <label for="<?=$field?>">Receive PR No :</label>
...
<!--          <input name="new" type="submit" class="btn1" value="Update Purchase Return" style="width:200px; font-weight:bold; font-size:12px; tabindex="12>
-->		   <button type="submit" name="new" id="new" class="btn btn-success">Update Purchase Return</button>
          ...
          <? }else{?>
<!--          <input name="new" type="submit" class="btn1" value="Initiate Purchase Return" style="width:200px; font-weight:bold; font-size:12px;" tabindex="12" />
-->		   <button type="submit" name="new" id="new" class="btn btn-primary">Initiate Purchase Return</button>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <input name="confirmm" id="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD PR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" /><input  name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
