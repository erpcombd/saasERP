...
$target_url = '../pr/chalan_view_edit_manual.php';
...
$res='select  a.pr_no,a.pr_no, DATE_FORMAT(a.rec_date, "%d-%m-%y") as rec_date,  v.vendor_name,a.po_no, a.entry_at from purchase_receive a,warehouse b,user_activity_management c, vendor v where  a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id and a.vendor_id=v.vendor_id and a.pr_status="'.$status.'" and a.warehouse_id = "'.$_SESSION['user']['depot'].'" '.$con.' group by a.pr_no order by a.pr_no';
