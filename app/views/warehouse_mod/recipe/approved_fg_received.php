  ...
  <form action="" method="post" name="codz" id="codz">
    ...
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td align="right" bgcolor="#FF9966"><strong>From Date :</strong></td>
        ...
        <td width="202" bgcolor="#FF9966"><table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
              ...
              <td width="13%"><div align="center"><strong>To Date:</strong></div></td>
              <td width="46%"><strong>
...
$con .= 'and m.batch_type="'.$_POST['batch_type'].'"';
  ...
  $res='select m.pi_no,m.pi_date, w.warehouse_name, m.batch_type, m.status from production_floor_issue_master m, warehouse w where m.warehouse_to=w.warehouse_id '.$con.' and m.status="COMPLETE" group by m.pi_date order by  m.pi_date';
...
<tbody>
<tr>
<td style="text-align: center;"><a href="daily_fg_receive_summery.php?pi_date=<?=$row->pi_date?>&&warehouse_to=<?=$_POST['warehouse_to']?>&&batch_type=<?=$_POST['batch_type'];?>" target="_blank" style="display:block;">Pi Date : <?=$row->pi_date?></a></td>
</tr>
</tbody>
