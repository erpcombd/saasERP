...
if(isset($_POST['return'])){
        ...
        $delete_approval_sql = 'DELETE FROM approval_matrix_history WHERE tr_no="'.$$unique.'" and tr_from="Purchase" and remarks="CHECKED"';
     ...
     echo $msg='<span style="color:green;">Successfully Returned</span>';
		...
		echo '<script>window.location.replace("select_upcoming_po.php")</script>';
        ...
        <div class="container-fluid p-0 ">
            ...
            <div class="n-form-btn-class">
				...
				if($cow<1){
					...
					<? 	$received = find_a_field('purchase_receive','sum(qty)','po_no="'.$po_no.'"');

			if($received==0){
                     ?>
					 <input name="return" type="submit" id="return" onclick="return_function()" class="btn btn-danger" value="Return To Purchase Department" 
					 style="width:270px; font-weight:bold; font-size:12px;" />

					 <? } ?>
					<input type="button" class="btn1 btn1-bg-help" value="CLOSE"  onclick="window.location.href='select_upcoming_po.php'" />
