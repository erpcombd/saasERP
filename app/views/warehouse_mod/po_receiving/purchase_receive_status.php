...
$target_url = '../po_receiving/chalan_view_store.php';
                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    if(isset($_POST['submitit'])){
                        ...
                        while($info=mysqli_fetch_object($sqlq)){
							...
							<?php /*?>	 <td><a title="GRN Preview" target="_blank" href="chalan_view_store.php?v_no=<?=rawurlencode(url_encode($info->pr_no));?>" style=" font-weight:700; color:#000000" >
								   <?=$info->pr_no;?>
								 </a></td>
								 <?php */?>
								 
								  <td><a title="GRN Preview" target="_blank" href="chalan_view_store.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($info->pr_no));?>" style=" font-weight:700; color:#000000" >
								   <?=$info->pr_no;?>
								 </a></td>
								 
								<?php /*?>  <td><a title="GRN Preview" target="_blank" href="transaction_view.php?v_no=<?=rawurlencode(url_encode($info->pr_no));?>" style=" font-weight:700; color:#000000" >
								    <?=$info->pr_no;?>
								  </a></td><?php */?>
								  
								  <td><a title="GRN Preview" target="_blank" href="transaction_view.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($info->pr_no));?>" style=" font-weight:700; color:#000000" >
								    <?=$info->pr_no;?>
								  </a></td>
                                ...
                                <td><?=$info->status?></td>
                                <td >
								<button type="submit" name="submitit" id="submitit" value="View" onclick="custom('<?=url_encode($info->pr_no);?>','<?=url_encode($c_id);?>')" class="btn2 btn1-bg-submit">
