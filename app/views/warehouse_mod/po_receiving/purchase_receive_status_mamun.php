...
$target_url = '../po_receiving/chalan_view2_mamun.php';
                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0">
                            <select name="vendor_id" id="vendor_id">
        						  ...
        						  <? foreign_relation('vendor','vendor_id','vendor_name',$_POST['vendor_id'],' 1 and group_for="'.$_SESSION['user']['group'].'" order by vendor_name');?>
                    ...
                    if(isset($_POST['submitit'])){
                        ...
                        while($info=mysqli_fetch_object($sqlq)){
                            ...
                            <tr>
                                ...
                                <td><?=$info->status?></td>
                                <td >
								<button type="submit" name="submitit" id="submitit" value="View" onclick="custom(<?=$info->pr_no?>)" class="btn2 btn1-bg-submit">
