...
if(isset($_POST['return'])){
		...
		header('location:select_upcoming_po_jamuna.php');
...
$tr_type="Add";
	...
	header("Location:po_receive_jamuna.php?po_no=".$po_no);
}
        ...
        <div class="n-form1 fo-white pt-0 p-0">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
					  ...
					  <tr>
						...
						<td rowspan="2" align="center" ><a href="../../../views/purchase_mod/po/po_print_view_store.php?po_no=<?=rawurlencode(url_encode($po_no));?>" target="_blank"><img src="../../../images/print.png" width="26" height="26" /></a></td>
...
<div class="container-fluid bg-form-titel">
	...
	<? if($row->is_complete==0){ ?>
              ...
              <input name="chalan_<?=$row->id?>" type="text" id="chalan_<?=$row->id?>"  class="text-center" value="<?=$unrec_qty?>" onkeyup="cal2(<?=$row->id?>)" style="width:50%"  />
        ...
        <div class="container-fluid p-0 ">
            ...
            <div class="n-form-btn-class">
				...
				if($cow<1){
					...
					<input type="button" class="btn1 btn1-bg-help" value="CLOSE"  onclick="window.location.href='select_upcoming_po_jamuna.php'" />
...
<input type="hidden" name="confirm_remarks" id="confirm_remarks">
				<input name="confirm" type="submit" class="btn1 btn1-bg-submit" onclick="return confirm_function()" value="RECEIVE" />
...
function confirm_function() {
  ...
  if (notes !== null && notes.trim() !== "") {
    document.getElementById("confirm_remarks").value = notes.trim();

    // Let the form submit naturally — DO NOT call `.submit()`
    return true;
  } else {
