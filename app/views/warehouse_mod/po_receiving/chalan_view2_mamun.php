...
<tr>
<td>Chalan View :</td>
<td align="right"><?php if ($datas->upload_chalan_1!=''){?>
<a href="../../../assets/support/upload_view.php?name=<?=$datas->upload_chalan_1?>&folder=mrr_chalan_1&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank">Chalan 1 </a>
<?php } ?></td>

<td align="right"><?php if ($datas->upload_chalan_2!=''){?>
<a href="../../../assets/support/upload_view.php?name=<?=$datas->upload_chalan_2?>&folder=mrr_chalan_2&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank">Chalan 2 </a>
<?php } ?></td>
<td align="right"><?php if ($datas->upload_chalan_3!=''){?>
<a href="../../../assets/support/upload_view.php?name=<?=$datas->upload_chalan_3?>&folder=mrr_chalan_3&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank">Chalan 3  s</a>
<?php } ?></td>
</tr>

<tr>
<td align="right">Purchase Order: </td>
<td><a href="../../../../../purchase_mod/pages/po/po_print_view_mamun.php?po_no=<?=$po_no; ?>" target="_blank"><?=$po_no; ?></a></td>
</tr>
  ...
  <tr>
	...
	<div class="row">
 			<div class="col-1"></div>
			  ...
			  echo find_a_field('user_activity_management','fname','user_id="'.$datas->entry_by.'"');?><?php */?></b>
                <br>
			  ...
			  <div class="col-1"></div>
              <div class="col-2 text-center">
               <b><?php /*?><?php echo find_a_field('user_activity_management','fname','user_id="'.$qc_all.'"');?><?php */?></b>
                <br>
               <p style="border-top:1px solid">Checked By</p>
			  	...
			  	<div class="col-1"></div>
              <div class="col-2 text-center">
               <b><?php /*?><?php echo find_a_field('user_activity_management','fname','user_id="'.$datas->post_pur_verify.'"');?><?php */?></b>
                <br>
