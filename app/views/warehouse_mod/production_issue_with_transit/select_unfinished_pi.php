                    ...
                    <tbody class="tbody1">
						...
						?>
									...
									<tr>
										...
										<td><?=$rs->status?></td>
 <td><a href="../production_issue_with_transit/production_issue.php?old_pi_no=<?=$rs->pi_no?>"><span class="btn1 btn1-bg-submit">Show</span></a></td>                    

									</tr>

				<!--<a href="../production_issue/production_issue_check.php?old_pi_no=<?=$rs->pi_no?>"><span class="btn1 btn1-bg-submit">Show</span></a>-->
