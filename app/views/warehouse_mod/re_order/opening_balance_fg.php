...
<script>
...

  {
    ...
    if (warehouse_id > 0) {
            ...
            var strURL = "opening_balance_fg_ajax.php?item_id=" + item_id + "&opkt=" + opkt + "&opic=" + opic + "&opkt_sz=" + opkt_sz + "&odate=" + odate + "&flag=" + flag + "&warehouse_id=" + warehouse_id + "&group_for=" + group_for+"&sub_group="+sub_group;
        ...
        <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
              <input name="odate" type="text" id="odate" value="<?= find_a_field('opening_date', 'start_date', '1'); ?>" required autocomplete="off" readonly="" />
            </div>
          </div>
    ...
    <div class="container-fluid pt-5 p-0 ">
      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          ...
          $sql = "select distinct id,item_id,sum(item_in) as item_in,warehouse_id from re_order_item where warehouse_id='" . $_POST['warehouse_id'] . "' and tr_from = 'Re-Order' group by item_id,warehouse_id";
