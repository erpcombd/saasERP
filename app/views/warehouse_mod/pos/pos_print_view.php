    ...
    <td><div class="header">
        ...
        <!--<td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">WORK ORDER </td>-->
					...
					<table width="100%" border="0" cellspacing="0" cellpadding="0">
					  ...
					  <td><?='<img class="barcode Qrl_code_barcode" alt="'.$barcodeText.'" src="barcode.php?text='.$barcodeText.'&codetype='.$barcodeType.'&orientation='.$barcodeDisplay.'&size='.$barcodeSize.'&print='.$printText.'"/>' ?><p class="qrl-text"><?= $pos_id?></p></td>
					  </tr>
		  ...
		  <tr>
		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
				...
				<tr>
		          <td width="4%" align="left" valign="middle" style="font-size:12px; font-weight:700;">POS NO:</td>
		          <td width="96%" style="font-size:12px; font-weight:700;">:	&nbsp;
		            <?= $pos_id?></td>
	              </tr>
		        <tr>
