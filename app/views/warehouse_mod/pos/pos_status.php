...
$res='select m.pos_id,m.pos_id,m.pos_date,d.dealer_name_e,u.fname as created_by,m.entry_at,m.status from sale_pos_master m left join dealer_info d on d.dealer_code=m.dealer_id left join user_activity_management u on u.user_id=m.entry_by where 1 '.$con.'';
