...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td width="51%"><fieldset style="width:250px;">
    ...
    <div>
      ...
      <?=foreign_relation('warehouse','warehouse_id','warehouse_name',$warehouse_to,'1 order by warehouse_name')?>
...
<form action="select_unfinished_pr.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
