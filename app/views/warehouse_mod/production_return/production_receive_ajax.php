...
<input name="total_unit2" type="text" class="input3" style="width:80px;" onfocus="focuson('total_unit')" value="<?=$item_all->unit_name?>"/>      

<input name="total_unit3" type="text" class="input3" style="width:80px;" onfocus="focuson('total_unit')" value="<?=$stock?>"/>       
