...
$datas=find_all_field('production_floor_return_master','s','pr_no='.$pr_no);



$sql1="select b.* from production_floor_return_master b where b.pr_no = '".$pr_no."'";
...
$remarkss=$info->remarks;

}



$sql1="select b.*,i.unit_name from production_floor_return_detail b,item_info i where b.item_id=i.item_id and b.pr_no = '".$pr_no."'";
  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  ...
	  <tr>
        ...
        <td bgcolor="" style="text-align:center; color:#000; font-size:20px; font-weight:bold;">Alin Food Products Ltd.</td>
      ...
      <tr>
        ...
        <td bgcolor="" style="text-align:center; color:#000; font-size:18px; font-weight:bold;">Production Return </td>
		  ...
		  <tr>
			...
			<td width="30%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
				...
				<tr>
                <td align="right" valign="middle">Goods Type</td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    <tr>
                      <td>&nbsp;
                          <?=$datas->goods_type?></td>
...
<? for($i=0;$i<$pr;$i++){?>
      ...
      <tr>
        ...
        <td align="right" valign="top"><?=number_format($total_unit[$i],2); $tot += $total_unit[$i];?></td>
...
<tr>
	...
	<td align="right"> <? echo number_format($tot,2); ?></td>
	<td></td>
</tr>
    ...
    <td colspan="2" align="center"><strong><br />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
			...
			<td><div align="center"><?=find_a_field('user_activity_management','fname','user_id='.$entry_by);?></br>
			-----------------------
			</br>Return By </div></td>
			
			<td><div align="center">-----------------------
			</br>Checked By </div></td>

          <td><div align="center"><?=find_a_field('user_activity_management','fname','user_id='.$datas->received_by);?></br><?=$datas->received_at;?><br>
