...
do_calander('#req_date','0');
do_calander('#need_by','0');
			...
			<div class="container-fluid pt-5 p-0 ">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.required_in,a.qty,a.unit_name,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
					...
					<tr>
						...
						<input type="text" class="text-center" name="qty<?=$data->id?>" id="qty<?=$data->id?>" value="<?=$data->qty?>"/>
						
						</td>
						<td><?=$data->required_in;?></td>
