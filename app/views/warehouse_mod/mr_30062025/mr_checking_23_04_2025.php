  ...
  document.getElementById("req_date").focus();
    ...
    <div class="d-flex justify-content-center pt-5">
		...
		<div class="container-fluid pt-5 p-0 ">
			...
			$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.required_in from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
