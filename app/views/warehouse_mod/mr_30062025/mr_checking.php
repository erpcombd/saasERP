...
if(document.getElementById("warehouse_id").value>0)
  ...
  document.getElementById("req_date").focus();
		...
		<form action="" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
			...
			<div class="container-fluid bg-form-titel">
				...
				<table border="1" cellpadding="5" cellspacing="0" style="padding: 5px; font-size: 9px !important;">
					...
					<a href="mr_print_view.php?req_no=<?=rawurlencode(url_encode($req_no));?>" target="_blank">
    ...
    <!-- <div class="d-flex justify-content-center pt-5">
		...
		<?php /*?><div class="container-fluid pt-2 p-0 ">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						...
						<td>
							...
							<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/>						</td>
						...
						<table style="width:100%;" border="1">
							...
							<tr>
								...
								<td width="23%"><input name="last_p_qty" type="text"  id="last_p_qty" class="form-control" onfocus="focuson('qty')" /></td>
						...
						<td><input name="required_in" id="required_in" type="date" value="<?=$futureDate=date('Y-m-d', strtotime('+15 days'));?>" required /></td>
						<td>
			...
			$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.required_in,a.remarks from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
			...
			?>
					...
					<tr>
						...
						<input type="text" class="text-center" name="qty<?=$row->id?>" id="qty<?=$row->id?>" value="<?=$row->qty?>"/>
						
						</td>
						<td><?=$row->required_in?></td>
						<td><?=$row->remarks?></td>
						<td><span id="ppp<?=$row->id?>"><input name="<?='edit#'.$row->id?>" type="button" id="Edit" value="Set" class="btn1 btn1-bg-update"  onclick="update_edit(<?=$row->id?>);" /></span></td>
...
getData2('mr_edit_ajax.php', 'ppp'+id,id,qty);
