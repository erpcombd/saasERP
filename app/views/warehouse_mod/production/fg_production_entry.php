...
$title='Finished Goods Production  Entry';
...
<label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Production  Receive Date :</label>
      ...
      <?=$data->unit_name;?>
							...
							<td><input name="cost_price_<?=$data->item_id?>" id="cost_price_<?=$data->item_id?>" type="text"  value="<?=$data->cost_price;?>"  onkeyup="EXPcalculation(<?=$data->item_id?>)"  /></td>
