...
$target_url = '../pr_black_tea_new/chalan_unchecked_approval.php';
...
$con .= 'and a.rec_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
 ...
 $res='select  a.pr_no,a.pr_no,a.po_no, a.rec_date, a.sale_no,  v.vendor_name as party_name,a.entry_at from purchase_receive a,warehouse b,user_activity_management c, vendor v where  a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id and a.vendor_id=v.vendor_id and v.vendor_category=2 and a.status="UNCHECKED" and a.warehouse_id = "'.$_SESSION['user']['depot'].'" '.$con.' group by a.pr_no order by a.pr_no';
