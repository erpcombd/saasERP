...
<div class="row ">
	...
	<? $field='or_no';?>
          ...
          <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>" required class="form-control" class="form-control"/>
          </div>
		 ...
		 <div class="col-md-3 form-group">
		  <? $field='receive_date'; if($receive_date=='') $receive_date =date(''); ?>
           ...
           <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>" required class="form-control"/>
          </div>
        ...
        <input  name="receive_type" type="hidden" id="receive_type" value="<?=$page_for?>"  required="required"/>
		  ...
		  <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<? if($vendor_name=='') echo find_a_field('dealer_info','concat(dealer_name_e,"(",dealer_code,")")',       'dealer_code='.$dealer); else echo $vendor_name;?>" required="required" class="form-control"/>
    ...
    <td colspan="2"><div class="buttonrow text-center" ><span class="buttonrow" >
      ...
      <? if($_SESSION[$unique]>0) {?>
         <!-- <input name="new" type="submit" class="btn1" value="Update Sales Return" style="width:200px; font-weight:bold; font-size:12px; tabindex="12>-->
		  <button type="submit" name="new" id="new" class="btn btn-success">Update Sales Return</button>
		  ...
		  <button type="submit" name="new" id="new" class="btn btn-primary">Initiate Sales Return</button>
