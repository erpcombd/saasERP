          ...
          <div class="form-group row m-0">
            ...
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
			 ...
			 <? if($_POST['warehouse_id']>0) {?>
			   <input type="hidden" name="warehouse_id" id="warehouse_id" value="<?=$_POST['warehouse_id'];?>" />
		<input type="text" name="warehouse_id_show" id="warehouse_id_show" 
		value="<?=find_a_field('warehouse','warehouse_name','warehouse_id='.$_POST['warehouse_id']);?>" readonly=""/>

			   <? } else { ?>
              <select name="warehouse_id" id="warehouse_id" value="<?=$_POST['warehouse_id'];?>" required>
    ...
    <div class="container-fluid pt-5 p-0 ">
      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
		  ...
		  $sql = "select distinct id,item_id,item_price,sum(item_in) as item_in,sum(item_ex) as item_ex,warehouse_id 
		  from journal_item 
		  where warehouse_id='" . $_POST['warehouse_id'] . "' and tr_from = 'Opening' group by item_id,warehouse_id";
          ...
          $sql = "select * from item_info where 1 and group_for='".$_POST['group_for']."' and sub_group_id=" . $_POST['sub_group'];
