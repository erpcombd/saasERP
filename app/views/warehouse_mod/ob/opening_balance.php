    ...
    <form action="" method="post" name="codz" id="codz">
            ...
            <div class="row">
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <div class="form-group row m-0">
                        <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Opening Date</label>
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            <input name="odate" type="text" id="odate"  value="<?=$odate?>" />
                        </div>
                    </div>
                ...
                <div class="col-sm-5 col-md-5 col-lg-5 col-xl-5">
                    <div class="form-group row m-0">
                        <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Select Product Sub-Group</label>
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                ...
                <div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
                    ...
                    <input type="submit" name="submitit" id="submitit" class="btn1 btn1-submit-input" value="Open Balance"/>
                </div>
        ...
        <div class="container-fluid pt-5 p-0 ">
					...
					<?
					  ...
					  ?>
                       ...
                       <tr>
						...
						<td><input name="oqty_<?=$data->item_id?>" id="oqty_<?=$data->item_id?>" type="text" size="10" maxlength="10" value="<?=$op->final_stock;?>"  /></td>
					
						<td><input name="orate_<?=$data->item_id?>" id="orate_<?=$data->item_id?>" type="text" size="10" maxlength="10" value="<?=$data->f_price;?>"  />      </td>
            ...
            <? 
			  ...
			  <input type="button" class="btn1 btn1-bg-update" name="Button" value="Edit"  onclick="update_value(<?=$data->item_id?>)" /><?
			  ...
			  <input type="button" name="Button" class="btn1 btn1-bg-submit" value="Save"  onclick="update_value(<?=$data->item_id?>)" /><? }?>
...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><input name="odate" type="text" id="odate" style="width:107px;background-color:white;" value="<?=$odate?>" /></td>
...
?>
    ...
    <td bgcolor="#FF9966" ><strong>
      ...
      <input type="submit" name="submitit" id="submitit" value="Open Balance" style="width:170px; background-color:white; font-weight:bold; font-size:12px; height:30px; color:#090"/>
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
    ...
    <td><span id="divi_<?=$data->item_id?>">
            ...
            <? 
			  ...
			  <input type="button" class="btn1 btn-bg-update" name="Button" value="Edit"  onclick="update_value(<?=$data->item_id?>)" /><?

			  }

			  elseif($info->id==0 || $info->id=='')
			  ...
			  <input type="button" name="Button" value="Save"  onclick="update_value(<?=$data->item_id?>)" style="width:46px; height:30px;background-color:#66CC66"/><? }?>
