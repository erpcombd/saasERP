...
<form action="" method="post" name="cz" id="cz" >
  <table width="100%" border="0">
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn2" value="CONFIRM AND FORWARD WO" style="width:270px; float:right; font-weight:bold; font-size:12px; height:30px; color:#000" />
