...
echo '<script type="text/javascript">parent.parent.document.location.href = "po_create.php";</script>';
}
...
if(($vendor->ledger_id==0)&&($group_for==2||$group_for==3||$group_for==4||$group_for==10)){ ?>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:260px;" required onblur="getData2('po_ajax.php', 'po',this.value,document.getElementById('warehouse_id').value);"/></td>
<td colspan="3" align="center" bgcolor="#CCCCCC">
<span id="po">
<input name="stk" type="text" class="input3" id="stk" style="width:68px;" readonly="readonly"/>
...
<? 
$res='select a.id,concat(b.item_name) as item_name,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
