...
$datasks = mysqli_fetch_object(db_query($sql_proj));
...
<form action="" method="post">
  <table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
    <tr>
		<td width="20%"><p><strong><img src="<?=SERVER_ROOT?>public/uploads/logo/title.png" width="100%" /></strong></p></td>
      ...
      <td colspan="3" align="left"><p class="style4" style="font-size:20px;text-align:center;"><strong><ins></ins></strong></p>
        <table width="100%" cellpadding="0">
          <tr>
            ...
            <td width="39%" valign="top"><span style="font-size:12px">&nbsp;&nbsp;<strong>&nbsp;PO No.#
              <?=$_GET['po_no']?>
              </strong> <br />
              &nbsp;&nbsp;&nbsp;PO Date:
              <?=$bd_style = date("d-m-Y")?>
      ...
      <td colspan="3"><div id="pr">
        ...
        <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0" style="width:800px;">
          <tr style="font-size:12px;">
            ...
            <td bgcolor="#CCCCCC"><strong>Qty.</strong></td>
            <td bgcolor="#CCCCCC"><strong>Rate</strong></td>
            <td bgcolor="#CCCCCC"><strong>Value
            ...
            <td colspan="4" align="left" style="font-size:10px" ><table width="100%" border="0" cellspacing="0" cellpadding="0">
				...
				$calculate = $total+$data->transport_bill+$tax_total+$data->labor_bill-$data->cash_discount ;?></p></td><br /><br />
                  ...
                  <td width='25%' valign='top'><p>
                      <strong><?=find_a_field('user_activity_management','fname','user_id='.$data->checked_by);?></strong>
                      <br />
                      -----------------------<br />
                      Head Of Operation
