...
$target_url = '../reprocessing_tor/other_issue_report.php';
    ...
    <form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        if(isset($_POST['submitit'])){
          ...
          $res='select  a.oi_no,a.oi_no,a.oi_date, a.requisition_from as serial, a.oi_subject as note, a.issued_to as issue_to,a.issue_type,sum(amount) as Total,a.entry_at,c.fname as user

from warehouse_other_issue a, warehouse_other_issue_detail b, user_activity_management c

where  a.issue_type = "Reprocess Issue" and a.oi_no=b.oi_no and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" '.$con.' group by a.oi_no order by a.oi_no desc';
        ...
        <th>Issue Type</th>
          ...
          while($row = mysqli_fetch_object($query)){
            ...
            <tr>
              ...
              <td><?=$row->entry_at?></td>
              <td><?=$row->user?></td>
              <td><input type="submit" name="submitit" id="submitit" value="VIEW" class="btn1 btn1-submit-input" onclick="custom(<?=$row->oi_no?>);"></td>
