  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        ...
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">REPROCESS RECEIVE REPORT </td>
		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><?php echo find_a_field('user_group','group_name','id='.$rec_frm);?>&nbsp;</td>
		        ...
		        <tr>
		          ...
		          <td align="right" valign="top"> Approved By :</td>
