...
<table style="width:99%; border:0; border-collapse:collapse; border-spacing:0; margin:0 auto;" >
  <tr>
...
<form action="<?=$page?>" method="post" name="codz2" id="codz2">
<? if($$unique_master>0){?>
<table  style="width:100%; border-collapse:collapse; text-align:left; border:1px solid #caf5a5; padding:2px; border-spacing:2px;" >
  <tr>
    ...
    <td style="text-align:center; background-color:#0099FF;"><span style="font-weight: bold">Stk</span></td>
    <td style="text-align:center; background-color:#0099FF;"><span style="font-weight: bold">LIQ </span></td>
    <td style="text-align:center; background-color:#0099FF;"><span style="font-weight: bold">LID</span></td>
    <td style="text-align:center; background-color:#0099FF;"><strong> Qty</strong></td>
    <td  rowspan="2"  style="text-align:center; background-color:#FF0000;"><div class="button">
...
<table  style="width:100%; border:0;">
  <tr>
      <td  style="text-align:center;"><input  name="pr_no" type="hidden" id="pr_no" value="<?=$$unique_master?>"/></td><td  style="text-align:right">
