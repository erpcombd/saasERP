    ...
    <td>
			...
			<fieldset style="width:220px;">
			  ...
			  <div>
			    ...
			    <label style="width:105px;">Invoice No: </label>

			    <input name="invoice_no" type="text" id="invoice_no" style="width:105px;" value="<?=$invoice_no?>" tabindex="105" required />
...
<table   style="width:100%; text-align:left; border-collapse:collapse; border:1px solid #caf5a5; boder-spacing:2px; padding:2px;">

  <tr>

    <td style="text-align:center; background-color:#0099FF;"><strong>Item Name</strong></td>

    <td style="text-align:center; background-color:#0099FF;"><span style="font-weight: bold">Unit</span></td>

    <td style="text-align:center; background-color:#0099FF;"><strong>Stock</strong> </td>

    <td style="text-align:center; background-color:#0099FF;"><strong>Rate</strong></td>
    <td style="text-align:center; background-color:#0099FF;"><strong>Kg</strong></td>
  ...
  <tr>
    ...
    <td colspan="3" style="text-align:center; background-color:#CCCCCC;"><div  style="text-align:center;"><span id="pr">
...
<input name="total_unit" type="hidden" class="input3" id="total_unit"  maxlength="100" style="width:40px;" required/>
        <input name="total_pkt" type="hidden" class="input3" id="total_pkt"  maxlength="100" style="width:40px;" required/><input name="total_pcs" type="text" class="input3" id="total_pcs"  maxlength="100" style="width:60px;" required /></td>
  </tr>
</table>
...
$res='select a.id,b.finish_goods_code as FG_code,b.item_name,b.unit_name,a.total_unit as total_qty,"X" from production_issue_detail a,item_info b where b.item_id=a.item_id and a.pi_no='.$$unique_master.' order by a.id';
...
<table  style="width:100%;margin:0 auto; border:0;">
  ...
  <tr>
      ...
      <td  style="text-align:center;"><input  name="pi_no" type="hidden" id="pi_no" value="<?=$$unique_master?>"/></td><td align="right" style="text-align:right">
