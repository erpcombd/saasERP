...
<form action="master_report.php" method="post" name="form1" target="_blank" id="form1">
  <table class="w-100" border="0"><th></th>
    <tr>
      <td><div class="box4">
          <table  border="0" class="text-center"><th></th>
            <tr>
              <td><table  border="0" ><th></th>
                  <tr>
                    <td class="align-top"><table border="0"><th></th>
                        <tr>
                          <td><table border="0"><th></th>
                              <tr>
							  ...
							  <td><input name="report" type="radio" class="radio" value="3" checked="checked" /></td>
                                <td><div class="text-left">Damage Report  Summary </div></td>
                                
                              </tr>
                              
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="2" /></td>
                                <td><div class="text-left">Damage Report  Dealer Wise</div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="1" /></td>
                                <td><div class="text-left">Item Wise Damage Report </div></td>
                              </tr>
                          </table></td>
                        </tr>
                    </table></td>
              ...
              <td class="align-top"><table border="0">
                  <tr>
