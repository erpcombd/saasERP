...
$query = "select a.do_no,b.dealer_code,b.dealer_name_e from sale_do_master a,dealer_info b where status='CHECKED' and b.dealer_code=a.dealer_code  order by a.do_no";
