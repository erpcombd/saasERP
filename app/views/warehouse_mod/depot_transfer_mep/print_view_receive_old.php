...
$amount = $all->total_amt;
journal_item_control($all->item_id ,$warehouse_to,$_POST['receive_date'],$all->total_unit,'0','Transfered',$all->id,$all->unit_price,$warehouse_from,$pi_no);
...
?>
      <tr>
        ...
        <!--<td align="center" valign="top"><span class="style18"><?=number_format($rate,2);?></span></td>-->
        <td valign="top"><div align="right" class="style18">
          <?=number_format($total_qty,2);?>
        </div></td>
        <!--<td valign="top"><div align="right" class="style18"><?=number_format($total_amount,2);?></div></td>-->
      </tr>
