...
$res='select a.id,b.finish_goods_code as FG_code,b.item_name,b.unit_name,FLOOR(a.total_unit/b.pack_size) as total_qty,"X" from fg_issue_detail a,item_info b where b.item_id=a.item_id and a.pi_no='.$$unique_master.' order by a.id';
