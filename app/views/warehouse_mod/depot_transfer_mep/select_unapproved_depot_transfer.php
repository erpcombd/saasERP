...
$unique = 'pi_no';
$status = 'UNCHECKED';
$target_url = '../depot_transfer/depot_transfer_checking.php';
...
//auto_insert_depot_sales_issue($pi->pi_date,$ledger,$sales_ledger,$pi_no,find_a_field('fg_issue_detail','sum(total_amt)','pi_no='.$$unique_master),$pi_no,$cc_code,$narration);
    ...
    <form action="" method="post" name="codz" id="codz">
        <div class="container-fluid bg-form-titel">
            <div class="row">
                ...
                <? 
		$sql = "select b.pi_no, concat(w.warehouse_name,' - ',b.pi_no) from fg_issue_master b,warehouse w 
