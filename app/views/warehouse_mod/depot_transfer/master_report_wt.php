...
switch ($_REQUEST['report']) {
	...
	break;
	case 1100:
	$report="Warehouse Depot Transfer Report";
	break;
...
elseif($_REQUEST['report']==1100) { // do summery report modify jan 24 2018
  ...
  $sql="SELECT m.pi_no,m.pi_date,m.warehouse_from,m.warehouse_to,m.receive_date,w.warehouse_name,m.status,m.carried_by,m.received_by,i.item_name,i.unit_name,s.unit_price,s.total_unit,s.total_amt from production_issue_master m, production_issue_detail s, item_info i,warehouse w WHERE i.item_id=s.item_id and  m.pi_no=s.pi_no and w.warehouse_id=s.warehouse_to 
