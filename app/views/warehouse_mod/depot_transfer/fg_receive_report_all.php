...
<div class="form-container_large">
    ...
    <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10">
		...
		<option <? if($_POST['status']=='UNCHECKED') {echo 'Selected'; } ?>>UNCHECKED</option>
...
<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['depot'],'1 order by warehouse_name');?>
</select>
...
elseif($_POST['status']=='TRANSFERED'){
$con .=  'and a.status!="SEND"';}
elseif($_POST['status']=='UNCHECKED'){
$con .=  'and a.status="UNSEND"';}
else
{$do = 'nothing';}
