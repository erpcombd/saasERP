...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <strong><font style="font-size:20px">Purchased (Packing Materials) </font></strong></td>
  ...
  <tr>
	...
	<td>	<div align="center"><span class="style4">VAT REG NO: 22011011918 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span><br />
...
<?=$data->quotation_no?><br />


&nbsp;&nbsp;&nbsp;Ref. Date:

<?=$data->quotation_date?><br />
...
<?=$data->status?><br />
	  ...
	  <p style="margin:0; padding:0; font-size:16px;">Dear Sir, <br />
