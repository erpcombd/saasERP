              ...
              <tr>
                ...
                <td><? if($_SESSION['user']['depot']!=5){?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:14px; font-weight:bold;">
					
					<span class="style4"><?php echo find_a_field('user_group','group_name','id=2')?><br />

                          <span class="style6"><?php echo find_a_field('user_group','address','id=2')?></span></span></td>
