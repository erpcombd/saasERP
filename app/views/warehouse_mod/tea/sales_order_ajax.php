...
{
$sql = "INSERT INTO item_sale_issue (sale_no,sale_date, item_id, warehouse_id, se_id, item_rate, today_open, today_issue, today_sale, today_close, today_sale_amt, status, entry_at, entry_by) VALUES
...
$sql = "UPDATE item_sale_issue SET today_issue = '".$issue."', today_sale = '".$sale."', today_close = '".$closing."', today_sale_amt = '".$sale_amt."', edit_by = '".$entry_by."', edit_at = '".$entry_at."' WHERE sale_date = '".$p_date."' and item_id = '".$item_id."' and se_id = '".$se_id."' ";
...
db_query('delete from journal_item where item_id='.$item_id.' and tr_no = '.$sale_no);
