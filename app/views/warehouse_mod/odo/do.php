...
if(isset($_POST['add'])&&($_POST[$unique_master]>0))
{
		...
		//$gift = find_all_field('sale_gift_offer','','item_id="'.$_POST['item_id'].'" and start_date<"'.$do_date.'" and end_date>"'.$do_date.'" and group_for="'.$_POST['group_for'].'"');
		$sss = "select * from sale_gift_offer where item_id='".$_POST['item_id']."' and start_date<='".$do_date."' and end_date>='".$do_date."' and group_for='".$_POST['group_for']."' limit 1";
		$qqq = db_query($sss);
...
{	
		...
		echo $condition=$unique_detail."=".$del;		
  ...
  <tr>
    ...
    <td><fieldset style="width:240px;">
      <div>
        ...
        <option <?=($bank=='')?'':'selected'?>><?=$bank?></option>
