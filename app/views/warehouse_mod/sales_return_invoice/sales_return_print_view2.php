...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td align="left"><strong style="font-size:24px">
				...
				<img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png" style="width:200px;" height="50px"> 
				<br /></strong>    </td>
  </tr>
    </table>	</td>
    <td width="40%">
   ...
   <tr>
	...
	<table  width="400" border="0" cellspacing="0" cellpadding="0" align="center">
  	...
  	<tr style="font-size:14px;">
		...
		<td  height="25"  width="35%">: <?=$dealer->dealer_name_e;?></td>
		<td  height="25" width="10%"></td>
		</tr>
		
		<tr style="font-size:14px;">
		<td  height="25"  width="10%">&nbsp;&nbsp;Code</td>
		<td  height="25"  width="35%">: <?=$dealer->dealer_code;?></td>
		<td  height="25" width="10%"></td>
		</tr>
		
	<tr style="font-size:14px;">
		<td  height="25"  width="10%">&nbsp;&nbsp;Address</td>
		<td  height="25"  width="35%">: <?=$dealer->address_e;?></td>
		<td  height="25" width="10%"></td>
		</tr>
	<tr style="font-size:14px;">
		<td  height="25"  width="10%">&nbsp;&nbsp;Phone</td>
		<td  height="25"  width="35%">: <?=$dealer->mobile_no;?></td>
		<td  height="25" width="10%"></td>
		</tr>
	
	<tr style="font-size:14px;">
		<td  height="25"  width="10%">&nbsp;&nbsp;E-mail</td>
		<td  height="25"  width="35%">: <?=$dealer->email;?></td>
		<td  height="25" width="10%"></td>
		</tr>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
       <tr>
        ...
        <td width="13%" bgcolor="#004269"><span class="style8">FG Code </span></td>
...
<tr>
        ...
        <td align="left" valign="top"><?=$item->item_name?>
...
<? }?>
    ...
    <td width="40%">
		<table width="100%" border="1">
			...
			<? if($cash_discount>0){?>
			<tr>
			  <td><div align="right"><strong>Discount: (<?=$data->sp_discount?> %)</strong></div></td>
