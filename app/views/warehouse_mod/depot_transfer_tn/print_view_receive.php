...
db_query('update production_issue_master set status = "'.$_POST['status'].'", rec_sl_no = "'.$_POST['rec_sl_no'].'", receive_date = "'.$_POST['receive_date'].'", received_by = "'.$_POST['received_by'].'" where pi_no="'.$req_no.'"');
                  ...
                  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      ...
                      <td width="32%" bgcolor="#FFFFCC"><label>
                        <select style="width: 100%;" name="receive_date" id="receive_date" required />
						<? for($i=0;$i<62;$i++){?>
