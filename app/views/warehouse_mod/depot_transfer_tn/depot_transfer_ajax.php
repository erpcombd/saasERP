...
$item_price = find_a_field('journal_item','final_price','item_id="'.$item_all->item_id.'"  order by id desc ');
...
<td width="33%"><input name="unit_price" id="unit_price" type="text" class="input3" id="unit_price"   style="width:98%;" value="<?=$item_price; ?>" /></td>
</tr></table>