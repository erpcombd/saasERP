...
where (a.issue_type != "Sample Issue" and a.issue_type != "Other Issue" and a.issue_type != "Gift Issue" and a.issue_type != "Entertainment Issue") and a.warehouse_id = "'.$_SESSION['user']['depot'].'" and a.oi_no=b.oi_no and a.entry_by=c.user_id  '.$con.' group by a.oi_no order by a.oi_no desc';
