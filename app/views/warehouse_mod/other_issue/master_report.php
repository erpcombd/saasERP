...
where m.status in ('CHECKED','COMPLETED') and m.oi_no=s.oi_no and m.warehouse_id='".$_SESSION['user']['depot']."' and m.warehouse_id=w.warehouse_id and i.item_id=s.item_id
