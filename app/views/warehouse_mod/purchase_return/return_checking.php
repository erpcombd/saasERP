                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <? if($pr_date=="") {?>
										...
										<input  name="pr_date2" type="text" id="pr_date2" value="<?=$pr_date;?>" required/>
...
?>
                ...
                <tr>
                   <td><?=$i++?></td>
					...
					<td><?=$data->total_unit; $total_unit+=$data->total_unit;?></td>
					...
					<td></td>
					<td align="left"><?=number_format($total_unit,2)?></td>
					<td></td>
					<td align="left"><?=number_format($total_amount,2)?></td>
					<td></td>
					</tr>
                </tbody>
            </table>
    ...
    <form action="unapproved_pr.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
	   ...
	   <input  name="pr_no" type="hidden" id="pr_no" value="<?=$pr_no?>"/><input  name="pr_date" type="hidden" id="pr_date" value="<?=$pr_date?>"/>
	   <input  name="vendor_id" type="hidden" id="vendor_id" value="<?=$vendor_id?>"/><input type="hidden" name="return_remarks" id="return_remarks">
  
	   <input name="cancel"  type="submit" class="btn1 btn1-bg-cancel" value="CANCEL"/>
      
	 	<input type="button" class="btn1 btn1-bg-help" value="CLOSE"  onclick="window.location.href='unapproved_pr.php'" />
 
	 	<input name="confirmm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM AND FORWARD PR"  />
...
<form action="unapproved_pr.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td align="center">
	  <input name="confirmm" type="submit" class="btn btn-info" value="CONFIRM AND FORWARD PR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:white;" />
	  </td>
