...
w.warehouse_name as depot,s.unit_price,s.total_unit,s.total_amt,m.status,m.depot_id from purchase_return_master m,purchase_return_details s,vendor d  , warehouse w, item_info i
where m.status in ('CHECKED','COMPLETED') and m.pr_no=s.pr_no and m.vendor_id=d.vendor_id and s.item_id=i.item_id
".$depot_con.$date_con.$item_con.$vondor_con.$dtype_con." and m.depot_id=w.warehouse_id   order by m.pr_date,m.pr_no";
