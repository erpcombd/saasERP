...
$title='Bulk Purchase  Return Entry';
do_calander('#pr_date');
...
header("Location: new_return.php?pr_no=".$$unique_master);
                    ...
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                <input   name="pr_no" type="text" id="pr_no" value="<? if($$unique_master>0) echo $$unique_master; else echo (find_a_field($table_master,'max('.$unique_master.')','1')+1);?>" readonly/>
						...
						<div class="form-group row m-0 pb-1">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input  name="pr_date" type="text" id="pr_date" value="<?=($pr_date!='')?$pr_date:date('Y-m-d')?>"  required />
                            </div>
                        </div>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <select name="return_type" required id="return_type"  >
...
auto_complete_from_db('item_info','concat(item_id,"-> ",item_name)','item_id',' product_nature="purchasable"','item_id');
...
<input name="item_id" type="text" class="input3"  value="" id="item_id"  onblur="getData2('return_ajax.php', 'so_data_found', this.value, document.getElementById('pr_no').value);" required />
                    ...
                    <td colspan="4">
						...
						<table >
							<tr>
								...
								<td width="38%"><input name="item_name" type="text" class="input3"  readonly=""  autocomplete="off"  value="" id="item_name"  /> </td>

								<td width="14%"><input name="pcs_stock" type="text" class="input3"  readonly=""  autocomplete="off"  value="" id="pcs_stock"  /></td>

								<td width="16%"><input name="ctn_price" type="text" class="input3" id="ctn_price" readonly=""    required  value="<?=$do_data->ctn_price;?>"   /></td>

								<td width="23%"><input name="pcs_price" type="text" class="input3" id="pcs_price" readonly=""    required="required"  value="<?=$do_data->pcs_price;?>"  /></td>
							</tr>
						</table>
						</span>
							</div>
...
<input name="total_unit" type="hidden"    id="total_unit" readonly/>
		...
		<input name="total_amt" type="text"  id="total_amt"     readonly/>
					...
					<input name="add" type="submit" id="add" value="ADD" class="btn1 btn1-bg-submit" /></td>
    ...
    <form action="new_return.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
        <div class="container-fluid p-0 ">
            ...
            <div class="n-form-btn-class">
					...
					<input name="delete"  type="submit" class="btn1 btn1-bg-cancel" value="DELETE PURCHASE RETURN"  />
					<input  name="pr_no" type="hidden" id="pr_no" value="<?=$$unique_master?>"/>
					<input  name="pr_date" type="hidden" id="pr_date" value="<?=$pr_date?>"/></td>
					
					<input name="confirm" type="submit" class="btn1 btn1-submit-input" value="CONFIRM PURCHASE RETURN" />
            </div>
