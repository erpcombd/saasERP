...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="16%"><input name="pcs_stock" type="text" class="input3"  value="<?=(int)$stock_in_pcs;?>" id="pcs_stock" style="width:90%; height:30px;" readonly /></td>
	 <td width="23%"><input name="unit_price" type="text" class="input3" id="unit_price"  style="width:90%; height:30px;" required="required" onkeyup="count()"  value="<?=$item_all->d_price;?>"   /></td>
</tr>
</table>
