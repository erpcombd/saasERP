            ...
            <div class="row">
                <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10">
                    <div class="form-group row m-0">
                        <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Select Warehouse</label>
...
?>
	  ...
	  <? foreign_relation('warehouse','warehouse_id','warehouse_name','','1 and use_type !="VW"');?>
