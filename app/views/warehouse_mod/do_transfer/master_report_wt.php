...
switch ($_REQUEST['report']) {
	...
	break;
	case 1100:
	$report="Warehouse DO Transfer Report";
	break;
...
elseif($_REQUEST['report']==1100) { // do summery report modify jan 24 2018
  ...
  $sql="SELECT m.pi_no,m.pi_date,m.warehouse_from,m.warehouse_to,m.receive_date,w.warehouse_name,m.status,m.carried_by,m.received_by,i.item_name,i.unit_name,s.unit_price,s.total_unit,s.total_amt ,s.do_no,s.req_no
  from do_issue_master m, do_issue_detail s, item_info i,warehouse w 
  WHERE i.item_id=s.item_id and  m.pi_no=s.pi_no and w.warehouse_id=s.warehouse_to 
".$depot_con.$item_con.$dealer_con.$dtype_con." order by m.pi_no,m.pi_no";
...
<td><?=$data->pi_no?></td>
<td><?=$data->pi_date?></td>
<td><a href="../do_purchase/chalan_view2.php?v_no=<?=$data->req_no;?>" target="_blank"><?=$data->do_no;?></a></td>
<td><?=$data->item_name?></td>
<td <?=$data->warehouse_from?>><?=$data->warehouse_name?></td>
<td <?=$data->warehouse_to?>><?=$data->warehouse_name?></td>
<td><?=$data->receive_date?></td>
<td><?=$data->carried_by?></td>
<td><?=$data->received_by?></td>
<td><?=$data->status?></td>
<td style="text-align:center;"><?=$data->unit_price?></td>
<td style="text-align:right;"><?=$data->total_unit; $total_unit += $data->total_unit;?></td>
...
<td style="text-align:right"><?=number_format($total_unit,2)?></td>
