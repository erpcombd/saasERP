...
auto_complete_from_db('dealer_info d,dealer_type t','concat(d.dealer_name_e," - ",t.dealer_type)','concat(dealer_code,"#",dealer_name_e)','d.dealer_type=t.id','dealer'); //changed by alamin on 11-20-2021
$tr_from="Warehouse";
?>
...
var strURL="price_setup_dealer_ajax.php?item_id="+item_id+"&dealer_code="+dealer_code+"&discount="+discount+"&set_price="+set_price+"&flag="+flag;
...
<!--            This is the input filed code start hear-->
        <div class="container-fluid bg-form-titel">
            <div class="row">
                <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10">
                    <div class="form-group row m-0">
                        <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Dealer Name</label>
        ...
        <div class="container-fluid pt-5 p-0 ">
			...
			$dealer = explode("#",$_POST['dealer']);
                ...
                <h4 class="text-center bg-titel bold pt-2 pb-2">
                    ...
                    <?=(find_a_field('dealer_info','concat(dealer_name_e,"-",dealer_code)','dealer_code='.$dealer[0]))?>

                    &nbsp;

                    <input name="dealer_code" id="dealer_code" type="hidden" size="10" maxlength="10" value="<? echo $dealer[0];?>" style="width:60px;" />&nbsp;&nbsp;&nbsp;
...
<div class="tabledesign2" style="width:100%"><table width="70%" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
    ...
    <td bgcolor="#6699CC"><strong>
      ...
      <input name="dealer_code" id="dealer_code" type="hidden" size="10" maxlength="10" value="<? echo $_POST['dealer'];?>" style="width:60px;" />&nbsp;&nbsp;&nbsp;
...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0">
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
    ...
    <td><input name="set_<?=$data->item_id?>" id="set_<?=$data->item_id?>" type="text" size="10" maxlength="10" value="<? echo $set_price = find_a_field('sales_price_dealer','set_price','dealer_code="'.$_POST['dealer'].'" and item_id= "'.$data->item_id.'"');?>" style="width:100px;" onblur="auto_blank(<?=$data->item_id?>)" />      </td>
