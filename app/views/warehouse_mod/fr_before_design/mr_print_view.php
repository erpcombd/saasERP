...
//("select group_name from user_group where id='".$all->group_for."'");
...
<div class="row no-print">
    ...
    <div class="col-6">
        <? if(($all->status=='CHECKED' || $all->status=='PENDING') ){?>    
            <a class="btn btn-primary" href="../depot_transfer_mep/depot_transfer_entry2.php?line_id=<?=$all->warehouse_id?>&req_no=<?=$req_no?>" role="button">Make Transfer</a>
        <? } ?> 
    </div> 
</div>
</form>
