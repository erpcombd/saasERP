		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
		            ...
		            <tr>
		              ...
		              <td  valign="top"><span style="font-size:14px; " class="style8">Chalan No: <?php echo $return_master->chalan_no?>&nbsp;</span></td>
		              </tr>
				  ...
				  <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
		            ...
		            <tr>
<? $poNum=find_a_field('purchase_receive','po_no','pr_no='.$return_master->invoice_no)?>
		              <td  valign="top"><span style="font-size:14px; " class="style8">PO: <a href="../../purchase_mod/po/po_print_view.php?po_no=<?php echo rawurlencode(url_encode($poNum)); ?>" target="_blank"><?php echo $poNum; ?></a><??>&nbsp;</span></td>
		              </tr>
		            ...
		            <tr>
		              ...
		              <td  valign="top"><span style="font-size:14px; " class="style8">GRN Number: 
					  <a target="_blank" href="../po_receiving/chalan_view2.php?v_no=<?=rawurlencode(url_encode($return_master->invoice_no));?> "><?php echo $return_master->invoice_no?></a>&nbsp;</span></td>
		              </tr>
...
<?php /*?>
		  ...
		  <td><table width="100%" border="1" cellspacing="0" cellpadding="5">
		            ...
		            <tr>
		              ...
		              <td  valign="top"><span style="font-size:14px; " class="style8">Reasons : <?php echo $return_master->remarks?>&nbsp;</span></td>
		              </tr>
