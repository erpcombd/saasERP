    ...
    <div class="row">
        <div class="col-md-8">
            ...
            <table id="example">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><a class="btn btn-sm <?php if($products->status == '0'){echo 'btn-danger';}else{echo 'btn-warning';} ?>" href="company_products.php?update=<?=encrypTS($products->id)?>"><?=$sn?></a></td>
        ...
        <div class="col-md-4">
            <div class="text-right mt-3">
                <a href="company_products.php" class="btn btn-success text-light">+ Add New</a>
            </div>
            <form method="post">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" name="products" value="<?=$datas->products?>" required>
                    </div>
                    <div class="form-group">
