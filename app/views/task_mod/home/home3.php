        ...
        <div class="col-md-3 col-xl-3">
            <div class="mycard2 bg-c-pink order-card">
                <div class="card-block">
                    ...
                    <h2 class="text-right"><i class="fas fa-tasks f-left"></i><span class="textspan">48</span></h2>
                </div>
            </div>
        </div>
...
$sqlTasks = "SELECT * FROM crm_lead_activity WHERE CONCAT(reaminder_start_date, ' ', reaminder_start_time) <= '$currentDateTime'";
