            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Service Name :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                      <input name="service_name" type="text" id="service_name" value="<?=$service_name?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td width="18%" height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">Service Details </td>
                  <td width="82%" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
				  
				  <textarea name="service_detail" id="service_detail" style="height: 80px; width: 400px;"><?=$service_detail?></textarea>
				  </td>
