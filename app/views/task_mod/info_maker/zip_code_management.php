...
<nav class="navbar navbar-light bg-light" style="box-shadow: 0 3px #888888;">
  <form class="form-inline">
    ...
    <div style="right;!important;">
                ...
                <a href="zip_code_management.php?update=<?=encrypTS('new')?>" class="btn btn-outline-info btn-sm">Add New <i class="fa fa-plus-square" aria-hidden="true"></i></a>
                <a href="zip_code_management.php" class="btn btn-outline-warning btn-sm">Refresh <i class="fa fa-refresh" aria-hidden="true"></i></a>
        </div>
</nav>
            ...
            <table id="example" class="table">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?=$row->po_name?></td>
                        <td><?=$row->po_code?></td>
                        <td><a class="btn btn-info btn-sm" href="#"><?=find_a_field('crm_project_lead', 'count(*)', 'zip="'.$row->id.'"')?></a></td>
                        <td><?=find_a_field('user_activity_management', 'fname', 'PBI_ID = "'.$row->entry_by.'"')?></td>
                        <td><?=$row->entry_at?></td>
                        <td><a class="btn btn-sm <?php if($row->is_active=='1'){echo 'btn-warning';}else{echo 'btn-danger';}?>" href="zip_code_management.php?update=<?=encrypTS($row->id)?>"><i class="fa-solid fa-pencil"></i></a></td>
                    </tr>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Postal Code Management</h5>
          ...
          <h5 class=text-center>Postal Information</h5>
            <div class="row">
            ...
            <div class="col-md-12">
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <td>Name: </td>
                        <td><input type="text" name="po_name" class="form-control" value="<?=$datas->po_name?>" style="border-left:3.5px solid #df5b5b!important;" required></td>
                      </tr>
                      <tr>
                        <td>Code: </td>
                        <td><input type="text" name="po_code" class="form-control" value="<?=$datas->po_code?>" style="border-left:3.5px solid #df5b5b!important;" required></td>
                      </tr>
