                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td width="95%"><div align="left">Collection Statement(Total) </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="24" /></td>
                                <td><div align="left">Collection Statement (Cash) </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="25" /></td>
                                <td><div align="left">Collection Statement (Chaque) </div></td>
                              </tr>
                              
                              
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="11" /></td>
                                <td><div align="left"> Outstanding dues </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="12" /></td>
                                <td><div align="left">Expected Collection  </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="13" /></td>
                                <td><div align="left">Payment Schedule </div></td>
                              </tr>
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="7" /></td>
                                <td><div align="left">Payment Statement (Money Receipt)</div></td>
                              </tr>
