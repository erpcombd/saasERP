...
//echo $sql;
	...
	if($proj=@mysql_fetch_object($sql))
	{
		...
		echo $user_sql="select h.service_group,h.id from user_activity_management u,hms_service_group h where u.service_group=h.id and u.username='$uid' and u.password='$passward'  and u.service_group>0";
