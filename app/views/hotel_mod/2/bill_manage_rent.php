          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
			  ...
			  advance_foreign_relation($sql,$room_id);?>
							...
							<div>
						<div class="button" style="padding-left:115px">
                        <div align="center">
                          
                          <input name="room" type="submit" id="room" value="Confirm" style="width:120px;"/>
                          </div>
                      </div>
							</div>
					  ...
					  <br /></td>
                      <td valign="top">
					  <div class="tabledesign1" style="height:157px; width:440px">
						                            <? if($reserve_id>0){?>   <table cellspacing="0" cellpadding="0" width="440px">
                                <tr>
                                  <th>Bill No</th>
                                  <th>Date</th>
                                  <th>Bill Amt </th>
...
while($payable=mysql_fetch_row($query1)){
						  ?>
                                ...
                                <tr class="alt">
                                  ...
                                  <td><?=$payable[2]?></td>
                                  <td><?=$payable[3]?></td>
                                  <td><? if($payable[3]!=3){?><a href="bill_invoice_room.php?bill_no=<?= $payable[0];?>" target="_blank"><img src="../../images/print.png" width="16" height="16" border="0"></a><? }?></td>
                                </tr>
                ...
                <tr>
				  ...
				  <table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      <tr>
                        <td align="center">Holding Room No </td>
...
?>
                          ...
                          <td align="center">
                            <span id="pid">
<input name="unit_price" type="text" class="input3" id="unit_price"  maxlength="100" style="width:95px;text-align:right;" onchange="billamt()"/><input name="temp_dis" type="hidden" class="input3" id="temp_dis" readonly value=""/>
                          </span>						</td>
						  
                          <td><input name="qty" type="text" class="input3" id="qty"  maxlength="50" style="width:95px;text-align:right;" onchange="billamt()" value="0"/></td>
