...
<table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#3f590a" bgcolor="#c7eb8e" style="border:1px solid #3f590a; border-collapse:collapse; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#000000;">
  ...
  <tr>
	...
	{ 
	?>
	<a href="check_in_info.php?reserve_id=<?=$reserve_id?>">CHECK IN DETAILS</a>
	<?
	}
	elseif($status==1)
	{
	?><a href="reservation_info.php?reserve_id=<?=$reserve_id?>">UPDATE RESERVATION</a>
	<?}
	else
	{?><a href="reservation_info.php?id=<?=$id?>&date=<?=$date?>">NEW RESERVATION</a>
	<? }
	?>
