...
$reserve_all = find_all_field('hms_reservation','id',"id='".$bill->reserve_id."'");
?>
 <?php
...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td><div class="header2">
      <div class="header2_left"> Name of Guest : <?php echo $reserve_all->client_name;?><br />
        ...
        Contact No : <?php echo $reserve_all->contact_no;?> </div>
      <div class="header2_right">
        <p> Bill No: <?php echo $bill_no;?><br />
          Bill Date:
          <?=$date[0]?>
          <br />
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
      ...
      <table width="100%" border="0" bordercolor="#000000" cellspacing="3" cellpadding="3" class="tabledesign1" style="width:700px">
		...
		<td>In Word: Taka <?=CLASS_Numbertoword::convert(((int)($bill->bill_amt)),'en')?> Only</td>
          <td align="right">Service Charge(<?=$service_group->service_charge?>%)(+):</td>
		...
		<tr>
		  <td align="right">&nbsp;</td>
		  <td align="right">Tax/Vat(<?=$service_group->vat?>%)(+):</td>
		  <td align="right"><strong>
