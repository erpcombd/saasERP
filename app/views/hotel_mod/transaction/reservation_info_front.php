...
if(isset($_POST['room_add']))
{
	...
	$out_time=$_POST['out_time'];
			...
			echo $sql="INSERT INTO `hms_hotel_room_status` 
(`room_id` ,
`room_status` ,
`date` ,
`status_date` ,
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
	...
	<form name="check" action="check_in_info_front.php?reserve_id=<?=$reserve_id?>" method="post" enctype="multipart/form-data">
	<table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#3f590a" bgcolor="#c7eb8e" style="border:1px solid #3f590a; border-collapse:collapse; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#000000;">
      <tr bgcolor="#679435">
        <td colspan="2" align="center" style="padding:3px; font-weight:bold;  font-size:13px; color:#FFFFFF;">Guest  Information </td>
      </tr>
      <tr bgcolor="#f8fbc1">
      ...
      <tr>
        ...
        <td align="left" style="padding:3px;"><input name="company_name" type="text" id="company_name" value="<?=$company_name?>
      " size="20" /></td>
      </tr>
      <tr bgcolor="#f8fbc1">
        <td style="padding:3px;" align="right">Nationality  : </td>
        <td align="left" style="padding:3px;"><input name="nationality" type="text" id="nationality" value="<?=$nationality?>
      " size="20" /></td>
      </tr>
      <tr>
...
<? }?>  
	  ...
	  <form action="reservation_info_front.php?reserve_id=<?=$reserve_id?>" method="post" enctype="multipart/form-data" name="account" id="account">
<table width="98%" border="1" align="center" cellpadding="0" cellspacing="0" bordercolor="#3f590a" bgcolor="#c7eb8e" style="border:1px solid #3f590a; border-collapse:collapse; font-family:Verdana, Arial, Helvetica, sans-serif; font-size:11px; color:#000000;">
          <tr bgcolor="#679435">
