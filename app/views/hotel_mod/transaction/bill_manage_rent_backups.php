                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td valign="top">
						...
						<legend class="text-dark">Customer Info</legend>

						<div>
						<label class="text-dark">Holding Room : </label>
