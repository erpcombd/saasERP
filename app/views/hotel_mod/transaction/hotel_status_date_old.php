                ...
                <tr>
                  <td><form id="form1" name="form1" method="post" action="">
                    <table width="70%" border="0" align="left" cellpadding="0" cellspacing="0">
                      <tr>
                        <td class="blue">Room Type :</td>
                        <td class="blue"><select name="room_type" id="room_type">
              <? foreign_relation('hms_room_type','id','room_type',$room_type);?>
            </select>&nbsp;</td>
                        <td class="blue"><input type="submit" name="Submit" value="Submit" /></td>
						<td align="right" class="blue"><table width="150" border="0" cellspacing="0" cellpadding="0">
                          <tr>
                            <td>Free/Ready : </td>
...
$sql="select id,room_no,status from hms_hotel_room where room_type_id=".$room_type;
$floorq=db_query($sql);
