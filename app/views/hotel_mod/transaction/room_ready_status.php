...
SUM(IF(status = "29", 1,0)) AS `checked_in_dirty`,
...
$checked_in_dirty=$room_table_status->checked_in_dirty;
                ...
                <tr>
                  <td><form id="form1" name="form1" method="post" action="">
                    <table width="150" border="0" align="center" cellpadding="2" cellspacing="0">
                      ...
                      <tr>
                        <td background="../images/25.gif"><strong>Occupied Dirty : </strong></td>
                        <td background="../images/25.gif"><div align="center"><strong>
                            <?=$checked_in_dirty?>
                        </strong></div></td>
                      </tr>
                      <tr>
...
elseif($room_status==29)
$class='yellow'; // Dirty
elseif($room_status==9)
$class='purple'; // Occupied
else
$class='red'; //Out of Order

//$class2		='yallow';
echo '<td class="'.$class.'"><a href = "room_ready.php?id='.$data[0].'" title = "'.$room_no.' :: '.$room_type.'" rel = "gb_page_center[840, 600]">'.$room_no.'<br><font size="1px">('.$room_type.')</font></a></td>';
}
echo '</tr>';
}
					?>            
