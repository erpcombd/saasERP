...
<body>
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center" style="font-size:10px;">
  <tr>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px;">
                <tr>
                  <td colspan="3" align="center" valign="bottom" style="text-align:center"><div style="width:500px; text-align:center; float:left">
                    <div style="float:left"><span style="widows:20%"></span><br />
                      <span style=" float:left;width:100px; text-align:left">No: <?php echo $reserve_all->id;?><br />Room No:
                      <?
	...
	hms_hotel_room r where s.room_id=r.id and s.reserve_id=".$reserve_all->id;
                    ...
                    <div style="float:none"><img src="../../../logo/golden_inn.jpg" height="95"  style="margin-left:130px;" /><br />
                      <font size="18px;" style="line-height:22px;" face="Bauhaus 93,Arial, Helvetica, sans-serif"><img src="golden_inn.png" style="margin-left:130px;" /></font>
                    </div>
                  </div></td>
                </tr>
                <tr>
                  <td align="center" style="widows:20%">&nbsp;</td>
<td align="center" style="line-height:20px;"><nobr>336 Station Road, Chittagong-4000,Bangladesh,</nobr><br> Phone: +880 31 611004-8,Eamil: goldeninnctg@gmail.com, </nobr><br>Web: www.goldeninnbd.com</td>
				  <?
...
$sss = "select GROUP_CONCAT(distinct r.room_no SEPARATOR ', ') Room_No from hms_hotel_room_status s, hms_hotel_room r, hms_reservation h where s.room_id=r.id and h.id=s.reserve_id group by s.reserve_id";
  ...
  <tr>
    <td colspan="3"><div id="pr">
      ...
      <table width="100%" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0" style=" ">
        <tr>
          <td><center><table width="90%" height="450px;" border="0" cellspacing="0" cellpadding="0" style="font-size:12px;">
              <tr style="">
                <td width="2%" style="font-size:10px;"><strong>Service Name </strong></td>
                <td width="3%">&nbsp;</td>
                <td width="6%"><strong>Amount</strong></td>
                </tr>
              <tr>
...
Only</td>
  ...
  <tr>
    <td colspan="3" align="center"><table width="80%" border="0" cellspacing="0" cellpadding="0" style="font-size:11px;">
        <tr>
          <td><?
