...
parent.parent.document.location.href = "../transaction/room_ready_status.php";
</script>';
}
...
<?
	if($data[6]==29){
	?>
	<option value="9">Clean Occupird Room</option>
	<? }
	if($data[6]==9){
	?>
	<option value="29">Dirty Occupird Room</option>
	<? }
	elseif($data[6]!=9)
	{ 
		if($data[6]!=1)
