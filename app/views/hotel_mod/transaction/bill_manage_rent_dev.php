...
<input name="dis_amt" type="text" id="dis_amt"  tabindex="10" class="input3" style="width:95px;text-align:right;"  onchange="billamt()"/> 
						   ...
						   <td>
						   	<input name="bill_amt" type="text" class="input3" id="bill_amt"  maxlength="100" class=" btn1 btn1-bg-update" readonly/>
						   </td>
						   <td>	<input name="add" type="button" id="add" value="ADD" tabindex="12" class="update" onclick="check();" />                       
</td>
					</tr>
