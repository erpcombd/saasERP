...
$service_group_id=$_SESSION['user']['group'];
...
`service_staff_id` ,
`service_point_id`
) VALUES ('$name', '$contact_no', '$reserve_id', '$room_id', '$service_group_id', '$total_amt', '$paid_amt', '$detail', '$bill_date','$discount_amt','$vat_amt','$bill_amt', '$service_charge', '$paid_date','$paid_in','$service_staff_id','$service_point_id')";
db_query($sql);
...
<form id="form1" name="form1" method="post" action="">
  <div class="container-fluid">
    <div class="row">
      <div class="col-sm-6">
        <div class="n-form">
          ...
          <div class="form-group row m-0 pl-3 pr-3 p-1">
            ...
            <div class="col-sm-9 p-0">
              <input name="contact_no" type="text" id="contact_no" value=""/>
            </div>
          </div>
          <div class="form-group row m-0 pl-3 pr-3 p-1">
          ...
          <div class="n-form">
            ...
            <div class="form-group row m-0 pl-3 pr-3 p-1">
              <label for="group_name" class="req-input col-sm-3 pl-0 pr-0 col-form-label ">Service Point :</label>
              <div class="col-sm-9 p-0">
                <select name="service_point_id" id="service_point_id" style="width:100px">
                  <option value="0">Select One</option>
                  <?php
                  $sql="SELECT a.id,a.point_name FROM `hms_service_point` a WHERE a.service_group_id=".$_SESSION['user']['group'];
            ...
            <div class="form-group row m-0 pl-3 pr-3 p-1">
              <label for="group_name" class="req-input col-sm-3 pl-0 pr-0 col-form-label ">Service Provider :</label>
              <div class="col-sm-9 p-0">
      ...
      <div class="col-sm-6">
        <div class="tabledesign1" style="height:275px; width:100%">
    ...
    <table class="table1 table-striped table-bordered table-hover table-sm">
      ...
      <tbody class="tbody1">
        <tr>
          <td>
            <?php
            $sql="SELECT a.id,a.service_name FROM `hms_services` a WHERE a.service_group_id=".$_SESSION['user']['group'];
            ?>
          ...
          <td><input name="qty" type="text" class="input3" id="qty" maxlength="50" style="width:95px;text-align:right;" onChange="billamt()"/>
          </td>
          <td><span id="inst_amt">
            <input name="dis_amt" type="text" id="dis_amt" tabindex="10" class="input3" style="width:95px;text-align:right;" onchange="billamt()"/>
            </span>
          </td>
          <td><input name="bill_amt" type="text" class="input3" id="bill_amt" maxlength="100" style="width:95px;text-align:right;" readonly/>
          </td>
    ...
    <tr>
      <td>
        <table width="90%" border="0" cellspacing="0" cellpadding="0">
              ...
              <table width="2%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                  <td>
                    <div class="button">
                      <div align="center">
                        <input name="count" id="count" type="hidden" value="<?php if(isset($count) && $count > 0) echo $count;?>" />
                        <input name="save" type="submit" id="save" value="Confirm" class=" btn1 btn1-bg-update" onClick="check_ability()" />
                      </div>
                    </div>
                  </td>
                </tr>
          ...
          <tr>
            <td bgcolor="#669966"><strong>Service Charge (<?=$service_rate?>%) :</strong></td>
            <td bgcolor="#663366">
              <input name="service_rate" type="hidden" id="service_rate" tabindex="10" class="input3" style="width:100px;" readonly="readonly" value="<?=$service_rate?>" />
              <input name="service_charge" type="text" id="service_charge" tabindex="10" class="input3" style="width:100px;text-align:right;" onchange="total_cal()" />
            </td>
          </tr>
          <tr>
          ...
          <tr>
            <td bgcolor="#FF6699"><strong>Vat (<?=$vat?>%) :</strong></td>
            <td bgcolor="#FF6699">
              <input name="vat_amt" type="text" id="vat_amt" tabindex="10" class="input3" style="width:100px;text-align:right;" readonly="readonly" />
          ...
          <tr>
            <td bgcolor="#FF3300"><strong>Adjust/Paid Amount :
              <label>
            ...
            <td bgcolor="#FF3300"><input name="paid_amt" type="text" id="paid_amt" tabindex="10" class="input3" /></td>
          </tr>
        </table>
      </td>
    </tr>
