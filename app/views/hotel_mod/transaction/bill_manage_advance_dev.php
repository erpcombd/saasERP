...
if($_POST['service_group_id'] !=''){
$service_group_id=$_SESSION['service_group_id']=$_POST['service_group_id'];

}elseif($_SESSION['service_group_id']>0)
$service_group_id=$_SESSION['service_group_id'];
$group=find_all_field('hms_service_group','vat','id='.$service_group_id);
$vat=$group->vat;
...
$sql1="select id,name,bill_amt,paid_amt from hms_bill_payment where service_group_id='$service_group_id'  order by id desc limit 7";
...
<td>
<?
 $sql="SELECT a.id,a.service_name FROM `hms_services` a WHERE a.service_group_id=".$service_group_id;
?>
...
<td>
	<input name="qty" type="text" class="input3" id="qty"  maxlength="50" style="width:95px;text-align:right;" onchange="billamt()"/>
</td>
<td>
<span id="inst_amt">
...
<td>
        <input name="bill_amt" type="text" class="input3" id="bill_amt"  maxlength="100" style="width:95px;text-align:right;" readonly/>
</td>
<td>
	
						  <input name="add" type="button" id="add" value="ADD" tabindex="12" class="btn1 btn1-bg-update"  onclick="check();"/>                       
...
<tr>
  ...
  <tr>
    <td><div class="button">
                      ...
                      <td width="20%"><input name="total_amt" type="text" id="total_amt"  tabindex="10" class="input3" style="width:100px;text-align:right;" readonly="readonly" /></td>
                    </tr>
