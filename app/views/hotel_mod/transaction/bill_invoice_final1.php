...
<table width="700" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	hms_hotel_room r where s.room_id=r.id and s.reserve_id=".$reserve_all->id;
                    ...
                    <div style="float:none"><img src="../../../logo/golden_inn.jpg" height="95" /><br />
                      <font size="18px;" style="line-height:22px;" face="Bauhaus 93,Arial, Helvetica, sans-serif"><img src="golden_inn.png" /></font>
                    </div>
                  </div></td>
                </tr>
                <tr>
