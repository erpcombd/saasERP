...
$data = array();
	...
	$data['service_name'] = find_a_field('hms_services','service_name','id='.$data['service_id']);
...
<td width="60px"><a href="#" onclick="deletethis<?=$count;?>();"><img src="../../images/delete.png" width="16" height="16" />X</a></td>
	</tr>		
</table>
