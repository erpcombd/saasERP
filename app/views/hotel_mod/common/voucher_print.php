...
//?>
        ...
        <tr>
          ...
          <td width="75%" class="tabledesign_text"><?=$data2[0]?></td>
        </tr>
        <tr>
      ...
      <tr>
        ...
        <td width="75%" class="tabledesign_text"><?=$data1[0]?>
,
  <?=$data3[0]?>
, #
<?=$data4[0]?></td>
      ...
      <tr>
        ...
        <td width="75%" class="tabledesign_text"><?=$data1[1]?></td>
        </tr>
    </table>
      <p>&nbsp;</p>
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000">
...
?>
        ...
        <tr>
          <td width="14%" class="tabledesign_text">Cash/Chaque No: </td>
          <td width="7%" class="tabledesign_text"><? if(is_numeric($data[0])) echo $data[0];?></td>
          <td width="8%" class="tabledesign_text">Bank:</td>
          <td width="27%" class="tabledesign_text"><?=$data[2]?></td>
        </tr>
        <tr>
          <td class="tabledesign_text">Branch:</td>
          <td class="tabledesign_text"><?=$data[3]?>&nbsp;</td>
          <td class="tabledesign_text">Cash/Chaque Date: </td>
          <td class="tabledesign_text"><?=$data[1]?></td>
        </tr>
      </table></td>
  </tr>
