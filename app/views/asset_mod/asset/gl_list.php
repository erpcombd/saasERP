      ...
      <div id="reporting">
        ...
        <div id="grp">
          ...
          <table class="table1  table-striped table-bordered table-hover table-sm">
            ...
            $a = "select id,class_name from acc_class where 1 and id=1 ".$con." ";
            ...
            while($adata=mysqli_fetch_row($aqry)){?>
              ...
              <?  $b = "select id,sub_class_name from acc_sub_class where acc_class=".$adata[0]." and sub_class_name LIKE '%FIXED ASSET%' order by sub_class_name asc";
