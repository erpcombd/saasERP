...
<table width="90%" align="center" cellpadding="0" cellspacing="0">
          ...
          <tr>
			...
			<img  src="../../../logo/<?=$_SESSION['user']['group']?>.png" style=" height:50px; width:auto;" />
            </td>
...
echo $_SESSION['proj_name'];
              ...
              <tr>
                ...
                <td align="center" style="border:0px; padding-left:25px;">House No: 710 (1-A) , Road N0:  10, Avenue : 3 , 

Mirpur DOHS, Mirpur , Dhaka-1216, Bangladesh.</td>
