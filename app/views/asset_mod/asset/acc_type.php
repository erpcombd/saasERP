...
$page="acc_type.php";		// PHP File Name
...
$subClassId=find_a_field('acc_sub_class','id','sub_class_name LIKE "%FIXED ASSET%"');				

						

			 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_class from '.$table.' a where 1 and acc_sub_class='.$subClassId.'  '.$con.' order by a.group_id';
