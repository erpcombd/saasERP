...
$page="g_ledger.php";		// PHP File Name
...
$accId=find_a_field('acc_sub_class','id','sub_class_name LIKE "%FIXED ASSET%"');
				

				 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_class,  a.ledger_group_id from '.$table.' a where 1 and acc_sub_class='.$accId.' '.$con.' order by a.ledger_id  ';
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0"><span id="sub_class2">
                        ...
                        <select name="acc_sub_class" required id="acc_sub_class"  tabindex="2">
								...
								<? foreign_relation('acc_sub_class','id','sub_class_name',$acc_sub_class,'sub_class_name LIKE "%FIXED ASSET%"');?>
                    	</select>
                    ...
                    <div class="col-sm-9 p-0">
                       ...
                       <span id="acc_group">
                        ...
                        <select name="ledger_group_id" required id="ledger_group_id"  tabindex="2">
                      		...
                      		<? foreign_relation('ledger_group','group_id','group_name',$ledger_group_id,'acc_sub_class='.$accId.'');?>
