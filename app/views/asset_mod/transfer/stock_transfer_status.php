...
$sql1=" select i.*,d.*,b.*,b.entry_at,sum(d.total_unit) as total_unit from production_issue_master b,production_issue_detail d,item_info i  where d.item_id=i.item_id and b.pi_no=d.pi_no  and b.pi_no = '".$chalan_no."' group by d.item_id ";
...
$master = find_all_field('production_issue_master','','pi_no="'.$chalan_no.'"');
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="text-align:center; color:white; font-size:18px; font-weight:bold;"><span class="style1" >Transfer Report<br /><?php echo find_a_field('warehouse','warehouse_name','warehouse_id="'.$master->warehouse_from.'"');?></span></td>
      </tr>
    </table></td>
              </tr>
            </table></td>
		  ...
		  <tr>
		    <td valign="top">
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        <tr>
		         ...
		         <tr>
                <td width="48%" align="right" valign="middle"> <div align="left">Prepared By</div></td>
				<td>:</td>
			    <td width="52%"><?=find_a_field('user_activity_management','fname','user_id="'.$master->entry_by.'"')?></td>
			  </tr>
			  <tr>
                <td width="48%" align="right" valign="middle"> <div align="left">Note</div></td>
				<td>:</td>
			    <td width="52%"><?=$master->remarks?></td>
			  </tr>
			...
			<td width="30%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
			   ...
			   <tr>
                <td width="48%" align="right" valign="middle"> <div align="left">Carried By</div></td>
				<td>:</td>
			    <td width="52%"><?=$master->carried_by?></td>
			  </tr>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="2" style="font-size:11px;">
       ...
       <tr>
         ...
         <td align="center" bgcolor="#FFFFFF"><strong>Product Model</strong></td>
...
?>
      ...
      <tr style="line-height:30px;">
        ...
        <td align="left" valign="top"><? echo $item_model[$i]; ?></td>
        <td align="left" valign="top"><? echo $item_brand[$i].' '.$item_name[$i].'<br> '.$item_desc[$i].'<br>'; ?>
		<?
		  $gsql = 'select serial_no from production_issue_detail where pi_no="'.$chalan_no.'" and item_id="'.$item_id[$i].'"';
		$gquery = mysql_query($gsql);
		$rowCount = mysql_num_rows($gquery);
		if($rowCount>0) echo 'Serial : ';
 ...
 <!-- <tr>
  ...
  <tr>
      ...
      <tr>
        ...
        <td width="34%"><div align="left">Transfered By </div></td>
