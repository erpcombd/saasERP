                ...
                <div class="col-sm-5">
                    ...
                    <div class="form-check">
                        ...
                        <label class="form-check-label p-0" for="report1-btn">
                           Fixed Asset Schedule(230303001)
                        </label>
                    </div>
					
					<div class="form-check">
                        <input name="report" type="radio" class="radio1" id="report1-btn" value="30525"  checked="checked" />
                        <label class="form-check-label p-0" for="report1-btn">
                          Asset Item Info (30525)
                        </label>
                    </div>
					
					<div class="form-check">
                        <input name="report" type="radio" class="radio1" id="report1-btn" value="506"  checked="checked" />
                        <label class="form-check-label p-0" for="report1-btn">
                          Registered Asset Info (506)
                        </label>
                    </div>
...
<? foreign_relation('item_group','concat(group_name,"#",group_id)','""',$group_id,'ptype="asset"')?>
				</datalist>
                        </div>
                    </div>
					...
					<datalist id="itms">
<? foreign_relation('item_sub_group s,item_group g','concat(s.sub_group_name,"#",s.sub_group_id)','""',$sub_group_id,'s.group_id=g.group_id and g.ptype="asset"')?>
				</datalist>
                        </div>
                    </div>
					
					<div class="form-group row m-0 mb-1 pl-3 pr-3">
                        <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Asset Item :	</label>
                        <div class="col-sm-8 p-0">
                            <input list="ass_item" name="item_id" type="text" value="" id="item_id" autocomplete="off">
					<datalist id="ass_item">
<? foreign_relation('item_info s,item_group g','concat(s.item_name,"#",s.item_id)','concat(s.item_name,"#",s.item_id)',$item_id,'s.item_group=g.group_id and g.ptype="asset"')?>
				</datalist>
                        </div>
                    </div>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <select name="evaluation_group" id="evaluation_group" class="m-0" >
							 <option></option>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <select name="asset_category" id="asset_category" class="m-0" >
							 <option></option>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <select name="section" id="section" class="m-0" >
							 <option></option>
