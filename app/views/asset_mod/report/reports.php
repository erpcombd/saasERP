...
<div class="d-flex justify-content-center">
 ...
 <input list="itms" name="item_id" type="text" value="" id="item_id" autocomplete="off">
					<datalist id="itms">
<? foreign_relation('item_info i,asset_register r','i.item_id','i.item_name',$item_id,'r.item_id=i.item_id group by r.item_id')?>
				</datalist>
    ...
    <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Serial No:</label>

          <div class="col-sm-8 p-0">

 <input list="iv" name="sl_no" type="text" value="" id="sl_no" autocomplete="off">
					<datalist id="iv">
<? foreign_relation('asset_register r','r.sl_no','r.sl_no',$sl_no,'1 group by r.sl_no')?>
				</datalist>
...
<?php /*?>
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0">
            <span class="oe_form_group_cell">
              <input name="f_date" type="text" id="f_date" value="<?= date('Y-m-01') ?>" autocomplete="off" / class="form-control">
            </span>
          </div>
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0">
            <span class="oe_form_group_cell">
              <input name="t_date" type="text" id="t_date" value="<?= date('Y-m-d') ?>" autocomplete="off" / class="form-control">
            </span>
          </div>
