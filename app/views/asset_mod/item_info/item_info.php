...
<option></option>
									...
									$a2="select s.sub_group_id, s.sub_group_name from item_sub_group s,item_group g  where s.group_id=g.group_id and g.group_name like '%FIXED ASSET%'";
...
<!--					</div>-->
					...
					<div class="form-group row m-0 pl-3 pr-3">
						...
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Depreciation Price(%)</label>

						<div class="col-sm-9 p-0">



							<input type="text" class="m-0" name="dep_price" id="dep_price" value="<?=$dep_price?>" />
