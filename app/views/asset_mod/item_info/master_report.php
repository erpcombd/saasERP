...
//	<?
		...
		$str 	.= '<img src="../../../logo/'.$group_for.'.png"  />';
...
if(isset($t_date))
        ...
        <?
		  ...
		  while($bardata = mysqli_fetch_object($barquery)){
		...
		<tr>
		  ...
		  <td style="border:1px solid #333333">&nbsp;&nbsp;&nbsp;<?='<img class="barcode" alt="'.$barcodeText.'" src="barcode.php?text='.$barcodeText.'&codetype='.$barcodeType.'&orientation='.$barcodeDisplay.'&size='.$barcodeSize.'&print='.$printText.'"/>' ?>&nbsp;&nbsp;&nbsp;</td>
...
<tr><td style="border:0px; text-align:center;" colspan="11"><img src="../../../logo/<?= $_SESSION['user']['group']?>.png" width="15%" /></td></tr>
...
<tr><td style="border:0px; text-align:center;" colspan="13"><img src="../../../logo/80.png" width="300" /></td></tr>
...

{
           ...
           $sql="select g.group_name, s.sub_group_name, i.item_id, i.item_name, i.unit_name,  i.d_price,  i.status, i.finish_goods_code, i.cost_price, i.sale_price  from item_group g, item_sub_group s, item_info i where g.group_id=s.group_id and s.sub_group_id=i.sub_group_id   ".$item_sub_group_con.$item_id_con.$product_nature.$group_for_con.$group_id_con;
...
<tr><td style="border:0px; text-align:center;" colspan="9"><img src="../../../logo/<?= $_SESSION['user']['group']?>.png" width="15%" /></td></tr>
