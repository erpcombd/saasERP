...
<?php */?>
          ...
          <td><input name="unit_price_<?=$data->item_id?>" id="unit_price_<?=$data->item_id?>" type="text" size="10" maxlength="10" value="<? echo $unit_price = find_a_field('sales_price_warehouse','unit_price','warehouse_id="'.$_POST['warehouse'].'" and item_id= "'.$data->item_id.'"');?>"  onkeyup="TRcalculation(<?=$data->item_id?>)" />  </td>
