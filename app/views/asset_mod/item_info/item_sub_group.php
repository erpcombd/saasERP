...
echo $_POST[$unique]=number_format(next_value('sub_group_id','fa_item_sub_group','10000',$min,$min,$max), 0, '.', '');
    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-sm-7">
                        ...
                        <div class="form-group row m-0 pl-3 pr-3">
                            ...
                            <div class="col-sm-9 p-0">
                                <select name="item_group" id="item_group">
                                    <option ></option>
                                    <? foreign_relation('fa_item_group','group_id','group_name',$_POST['item_group'],'1 order by group_name');?>
                                </select>
              ...
              $rrr = "select b.sub_group_id,b.sub_group_id,a.group_name, b.sub_group_name, b.description from fa_item_sub_group b,fa_item_group a where a.group_id=b.group_id order by a.status";
            ...
            <div class="col-sm-5">
                <form id="form1" name="form1" class="n-form" method="post" action="" onsubmit="return check()">
                    ...
                    <div class="form-group row m-0 pl-3 pr-3">
                        ...
                        <div class="col-sm-9 p-0">
                            <select name="group_id" id="group_id" required="required">
								 ...
								 <? foreign_relation('fa_item_group','group_id','group_name',$group_id,' 1');?>
                    ...
                    <div class="form-group row m-0 pl-3 pr-3">
                        <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Short Code </label>
                        <div class="col-sm-9 p-0">
