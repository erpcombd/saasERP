...
<? foreign_relation('item_info i,item_sub_group s,item_group g','i.item_id','i.item_name',$pName,'i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and g.group_name like "%ASSET%"')?>
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <select name="type" id="type" class="form-control">
							...
							<option name="New Purchase">New Purchase</option>
