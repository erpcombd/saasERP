    ...
    <form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 ">
        ...
        <table class="table1  table-striped table-bordered table-hover table-sm">
          ...
          <tbody class="tbody1">
          <?
          if($_POST['fdate']!='') {$con=' and m.date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';}else{$con=' and m.date between "'.date('Y-m-01').'"
and "'.date('Y-m-d').'"';}

       
	  $res ='select m.*,u.PBI_NAME  from fixed_asset_receive_master m,personnel_basic_info u where m.PBI_ID=u.PBI_ID and m.status="MANUAL"'.$con;
          ...
          ?>
            <tr>
              ...
              <td class="text-left"><?=$data->PBI_NAME?></td>
              <td class="text-center">
                <a href="receive.php?old_do_no=<?=$data->id?>">
                  <input type="button" value="View"  class="btn1 btn1-submit-input"/>
                </a>
              </td>
            </tr>
