...
$con .= 'and a.item_id="'.$_POST['item_id'].'"';}
 ...
 $res='select a.*,p.fname,i.item_name,r.asset_id
 
 
from fixed_asset_issue_master a,user_activity_management p,item_info i,asset_register r
 
 
where a.user_id=p.user_id and a.item_id=i.item_id and a.serial_no=r.serial_no '.$con.'';
