...
$sec_jv = find_all_field('secondary_journal','','jv_no='.$jv_no);
...
<img src="../../../logo/<?=$jv->group_for;?>.png" style=" height:70px; width:auto;" />		</td>
...
<a target="_blank" class="jvbutton" href="../../../warehouse_mod/pages/wo/route_bill_view.php?v_no=<?=$jv->tr_no;?>">Invoice View # <?=$jv->tr_no;?> </a>	

<? }?>

<? if($jv->tr_from=='Sales Return'){?>

<a target="_blank" class="jvbutton" href="../../../warehouse_mod/pages/sales_return/sales_invoice_print_view.php?v_no=<?=$jv->tr_no;?>">SR View # <?=$jv->tr_no;?> </a>	

<? }?>

<? if($jv->tr_from=='Purchase'){?>

<a target="_blank" class="jvbutton" href="../../../warehouse_mod/pages/po_receiving/chalan_view2.php?v_no=<?=$jv->tr_no;?>">MRR View # <?=$jv->tr_no;?> </a>	
