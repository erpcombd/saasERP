...
$title='Fixed Assets Ledger Group';			// Page Name and Page Title
...
<?php
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.acc_sub_class, a.acc_class  from '.$table.' a,acc_sub_class b where a.acc_sub_class=b.id and b.sub_class_name like "%Non-Current Asset%" order by a.id';
...
<?php }?>
		...
		<form class="n-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="req-input col-sm-4 pl-0 pr-0 col-form-label "> Acc. Group:</label>
