...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Accounts Sub Sub Class </span></th>
...
<td><?=find_a_field('acc_class','class_name','id='.$rp[3]);?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;; color: #FF0000">*</span>Acc. Sub Class:</td>
                        				...
                        				<input name="sub_sub_class_name" required type="text" id="sub_sub_class_name" tabindex="1" value="<?=$sub_sub_class_name?>"  style="width:220px;" >	
