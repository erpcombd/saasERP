...
$title='Fixed Assets Ledger Sub Group';			// Page Name and Page Title
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_sub_class,b.sub_sub_class_name from '.$table.' a, acc_sub_sub_class b, acc_sub_class c where a.acc_sub_sub_class=b.id and c.id=b.acc_sub_class and c.sub_class_name like "%Non-Current Asset%"';
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
										...
										<select name="acc_sub_sub_class" required id="acc_sub_sub_class"  tabindex="2">
                      						...
                      						<? foreign_relation('acc_sub_sub_class a, acc_sub_class b','a.id','CONCAT(a.id, ": ", a.sub_sub_class_name)',$acc_sub_sub_class,'a.acc_sub_class=b.id and b.sub_class_name like "%Non-Current Asset%"');?>
                    					</select></span>								
                    </div>
                </div>
