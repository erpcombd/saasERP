...
$title='Area Information Add';			// Page Name and Page Title

do_datatable('vendor_table');

$page="area.php";		// PHP File Name

$table='asset_area';		// Database Table Name Mainly related to this page
...
echo "<script>window.top.location='area.php'</script>";
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Area Name:</label>

<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">

<input name="area_name" type="text" id="area_name" tabindex="14" value="<?=$area_name?>" />
...
<?php
 ...
 $td='select a.'.$unique.',  a.'.$shown.' from '.$table.' a

where 1 '.$con.' order by a.id ';
