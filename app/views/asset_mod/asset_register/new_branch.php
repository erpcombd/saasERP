            ...
            <div class="col-sm-7">
                ...
                <div class="container n-form1">
                    <table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
                        ...
                        $rrr = "select * from warehouse where 1";
                        ...
                        while($rp=mysqli_fetch_object($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
                            ...
                            <tr<?=$cls?> onclick="DoNav('<?php echo $rp->warehouse_id;?>');">
                                <td><?=$rp->warehouse_id;?></td>
								<td><?=$rp->warehouse_code;?></td>
            ...
            <div class="col-sm-5">
                <form id="form1" name="form1" class="n-form" method="post" action="" onsubmit="return check()">
                    ...
                    <div class="form-group row m-0 pl-3 pr-3 p-1">
                        <label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Branch Code :</label>
                        <div class="col-sm-8 p-0">

                            <input name="<?=$unique?>" type="hidden"  id="<?=$unique?>" value="<?=$$unique?>"  />

                            <input name="warehouse_code" type="text" id="warehouse_code" value="<?php echo $warehouse_code;?>" class="required" />
                            ...
                            <input name="entry_at" type="hidden" required id="entry_at" tabindex="10" value="<?=date('Y-m-d H:i:s');?>" />
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        <label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Branch Name :</label>
                        <div class="col-sm-8 p-0">

                            
                            <input name="warehouse_name" type="text" id="warehouse_name" value="<?php echo $warehouse_name;?>" class="required" />
