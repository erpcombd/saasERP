...
$datas=find_all_field('purchase_receive_asset','s','pr_no='.$pr_no);



$sql1="select b.* from purchase_receive_asset b where b.pr_no = '".$pr_no."'";
                ...
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:14px; font-weight:bold;"><span class="style4"><?=find_a_field('user_group','group_name','id="'.$_SESSION['user']['group'].'"')?><br />
                          ...
                          <span class="style6"><?=find_a_field('user_group','address','id="'.$_SESSION['user']['group'].'"')?></span></span></td>
		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
		          ...
		          <td align="right" valign="middle">Purchase note :</td>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><?php echo find_a_field('purchase_master','payment_details','po_no="'.$po_no.'"');?></td>
		          ...
		          <td align="right" valign="middle">Receive note :</td>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td><?php echo $datas->receive_note;?></td>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       ...
       <tr>
        ...
        <td align="center" bgcolor="#CCCCCC"><strong>Item Serial Number</strong></td>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr>
		...
		<td align="right" valign="top"><?=$serial_no[$i]?></td>
...
<? }?>
  ...
  <td colspan="6" bgcolor="#CCCCCC" align="center" valign="top">&nbsp;</td>
