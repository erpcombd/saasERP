        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0">
            <select name="item_id" id="item_id" class="form-control">
              ...
              <? foreign_relation('item_info i,item_sub_group s,item_group g', 'i.item_id', 'i.item_name', $item_id, 'i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and g.group_name like "%FIXED ASSET%"') ?>
            </select>
          </div>
        </div>
