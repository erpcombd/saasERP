...
$target_url = 'po_receive_serialized.php';
...
<div class="form-container_large">
    ...
    <form action="" method="post" name="codz" id="codz">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            $res='select  a.po_no,a.po_no, DATE_FORMAT(a.po_date, "%d-%m-%Y") as po_date,   v.vendor_name as party_name,c.fname as entry_by, a.checked_at 
			
			from purchase_master a,purchase_invoice p,warehouse b,user_activity_management c, vendor v,item_info i,item_sub_group s,item_group g 
			
			where  a.po_no=p.po_no and p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and g.group_name like "%FIXED ASSET%" and a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id and a.vendor_id=v.vendor_id  and a.status="CHECKED"  '.$con.' group by a.po_no order by a.po_no DESC';
