...
$unique_field='maintenance_type';

$table='maintenance_type';

$page="maintanence_type.php";
                ...
                <div class="container p-0">
                    <form id="form1" name="form1" class="n-form1" method="post" action="">
                        <div class="form-group row m-0 pl-3 pr-3">
                            <label for="group_for" class="col-sm-3 pl-0 pr-0 col-form-label">Maintenance Type :</label>
                            <div class="col-sm-9 p-0">
                               <select name="m_type" id="m_type" required="required">
                                
                                <?	$sql="select * from maintenance_type where 1";
...
<?php /*?>                    <?php
                    ...
                    <table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
                        ...
                        <tr class="bgc-info">
                            <th><span>ID</span></th>
                            <th><span>Maintenance Type</span></th>
                            <th><span>Maintenance Ledger</span></th>
							<th><span>Capitalized</span></th>
                        </tr>
                        </thead>
...
//                            $con .= ' and b.id = "'.$_POST['m_type'].'" ';
                         ...
                         $rrr = "select b.* ,dt.ledger_name
						
						from maintenance_type b 
						
						left join accounts_ledger dt on dt.ledger_id=b.maintenance_ledger
                ...
                <form id="form1" name="form1" class="n-form" method="post" action="" onsubmit="return check()">
					...
					<?php /*?><div class="form-group row m-0 pl-3 pr-3 p-1">
					 ...
					 <div class="form-group row m-0 pl-3 pr-3 p-1">
                        <label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Maintenance Type :</label>
                        <div class="col-sm-8 p-0">
                            <input name="maintenance_type" type="text" id="maintenance_type" value="<?php echo $maintenance_type;?>" class="required" />
                    ...
                    <div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
							...
							<select name="maintenance_ledger" id="maintenance_ledger" class="m-0" required>
							 <option></option>
							 <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$maintenance_ledger,'1 and ledger_group_id= 10101');?>
							</select>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Capitalized</label>
						<div class="col-sm-8 p-0">

							<select name="capitalized" id="capitalized" class="m-0" required>
							 <option></option>
							 <option <?=($capitalized=='YES')?'selected':''?>>YES</option>
							 <option <?=($capitalized=='NO')?'selected':''?>>NO</option>
