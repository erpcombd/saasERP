...
$_POST['ledger_group_id'] = end(explode("#",$_POST['ledger_group_id']));
$_POST['ptype'] = 'asset';
$crud->insert();
...
<?php /*?>                    <?php
                    ...
                    <table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
                        ...
                        <tr class="bgc-info">
                            <th><span>Asset Group Code</span></th>
                            <th><span>Asset Group Name</span></th>
							<th><span>Ledger</span></th>
                        ...
                        $rrr = "select a.*,l.ledger_name from item_group a left join accounts_ledger l on a.ledger_group_id=l.ledger_id where a.ptype='asset'";
                        ...
                        while($rp=mysqli_fetch_object($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
                            ...
                            <tr<?=$cls?> onclick="DoNav('<?php echo $rp->group_id;?>');">
                                <td><?=$rp->manual_code;?></td>
                                <td><?=$rp->group_name;?></td>
            ...
            <div class="col-sm-5">
                <form id="form1" name="form1" class="n-form" method="post" action="" onsubmit="return check()">
                    ...
                    <div class="form-group row m-0 pl-3 pr-3 p-1">
                        <label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Asset Group Code :</label>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <input type="text" class="m-0" name="ledger_group_id" id="ledger_group_id" value="<?=find_a_field('accounts_ledger','concat(ledger_name,"#",ledger_id)','ledger_id="'.$ledger_group_id.'"')?>" list="ledgerList"  autocomplete="off"/>
							<datalist id="ledgerList">
							 <? foreign_relation('accounts_ledger a, ledger_group g,acc_sub_class s','concat(ledger_name,"#",ledger_id)','""',$ledger_group_id,'a.ledger_group_id=g.group_id and g.acc_sub_class=s.id and s.sub_class_name in ("Non-Current Assets","Non Current Assets") and a.ledger_name like "WIP%"');?>
							</datalist>
					...
					<!--<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <select name="depreciation_type" id="depreciation_type" class="m-0" required>
							 <option></option>
							 <option <?=($depreciation_type=='Straight-Line')?'selected':''?>>Straight-Line</option>
							 <option <?=($depreciation_type=='Written Down')?'selected':''?>>Written Down</option>
							</select>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
                            ...
                            <input type="text" class="m-0" name="asset_ledger" id="asset_ledger" value="<?=find_a_field('accounts_ledger','concat(ledger_name,"#",ledger_id)','ledger_id="'.$asset_ledger.'"')?>" list="ledgerList" />
							<datalist id="ledgerList">
