...
$con .= ' and a.sales_date between "'.$_POST['f_date'].'" and "'.$_POST['t_date'].'"';}
...
$res='select a.*,p.fname,i.item_name,s.sub_group_name from asset_sales_info a,user_activity_management p,item_info i, item_sub_group s where a.entry_by=p.user_id and a.item_id=i.item_id and s.sub_group_id=i.sub_group_id '.$con.'';
...
?>
	...
	<tr>
	     ...
	     <td valign="top" align="right"><?=number_format($data->wdv,2)?></td>
	  	 <td valign="top" align="right"><?=number_format($data->sales_amount,2)?></td>
	 	 <td valign="top" align="right"><?=number_format($profit=$data->sales_amount-$data->wdv,2)?></td>
		 <td><?=$data->fname?></td>
	</tr>
...
$total_profit +=$profit;
	...
	<tr>
	  ...
	  <td align="right"><?=number_format($total_profit,2);?></td>
		<td></td>
