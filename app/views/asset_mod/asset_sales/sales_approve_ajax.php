...
$ledger_all=find_all_field('item_info s','s.item_id','s.item_id='.$item_id.'');

 $disposal_ac=$ledger_all->disposal_acc;
 $receivable=$ledger_all->asset_sales;
 $los_gain_disposal =$ledger_all->gain_disposal;
...
('MEP',".$jv_no.", '".$jv_date."', ".$receivable.",'".$narration."',".$info->current_value.",'0', '".$tr_from."', ".$_POST['id'].",'',".$info->group_for.",".$_SESSION['user']['id'].",''),
('MEP',".$jv_no.", '".$jv_date."', ".$los_gain_disposal.",'".$narration."',".$info->total_dpc.",'0', '".$tr_from."', ".$_POST['id'].",".$sub_ledger.",".$info->group_for.",".$_SESSION['user']['id'].",''),
('MEP',".$jv_no.", '".$jv_date."', ".$disposal_ac.",'".$narration."','0',".$info->po_value.", '".$tr_from."', ".$_POST['id'].",".$sub_ledger.",".$info->group_for.",".$_SESSION['user']['id'].",'')";
