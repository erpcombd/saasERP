...
<div class="d-flex justify-content-center">
  ...
  <form class="n-form1 pt-4" action="sales_master_report.php" method="post" name="form1" target="_blank" id="form1">
        ...
        <div class="form-group row m-0 mb-1 pl-3 pr-3">
          ...
          <div class="col-sm-8 p-0">
            ...
            <select name="item_id" id="item_id" class="form-control">
              ...
              <? foreign_relation('item_info i,asset_register s', 'i.item_id', 'i.item_name', $item_id, 'i.sub_group_id=s.sub_group_id and i.item_id=s.item_id group by item_id') ?>
