...
<div class="d-flex justify-content-center">
  ...
  <form class="n-form1 pt-4" action="audit_master_report.php" method="post" name="form1" target="_blank" id="form1">
    ...
    <div class="row m-0 p-0">
      ...
      <div class="col-sm-5">
		...
		<div class="form-check">
          ...
          <input name="report" type="radio" class="radio1" id="report1-btn" value="506"  tabindex="1" />
