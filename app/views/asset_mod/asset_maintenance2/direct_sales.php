...
<form method="post" action="sales.php">
  ...
  <tbody>
    ...
    <?php
     ...
     $sql='select r.*,i.item_name,s.sub_group_name from asset_disposal_info r,item_info i, item_sub_group s where r.item_id=i.item_id and s.sub_group_id=i.sub_group_id and r.status="Checked" group by r.asset_id';
