...
$report="Asset Maintenance Report";
...
$con .= ' and m.m_date between "'.$_POST['f_date'].'" and "'.$_POST['t_date'].'"';}



if($_POST['item_id']!=''){

$con .= 'and s.item_id="'.$_POST['item_id'].'"';}

$res='select s.*,m.m_date,m.status,u.fname,w.warehouse_name,i.item_name,g.sub_group_name from asset_maintenance_info m, asset_maintenance_detail s, warehouse w, user_activity_management u, item_info i, item_sub_group g where i.item_id=s.item_id and i.sub_group_id=g.sub_group_id and s.m_id=m.m_id and m.warehouse_id=w.warehouse_id and u.user_id=m.entry_by '.$con.'';
...
?>
	...
	<tr>
		 <td><?=++$i;?></td>
		 <td><?=$data->asset_id?></td>
		 <td valign="top"><?=$data->sub_group_name;?></td>
	 	 <td valign="top"><?=$data->item_name;?></td>
		 <td valign="top"><?=$data->item_name;?></td>
		 <td valign="top"><?=$data->m_date;?></td>
	     <td valign="top" align="right"><?=number_format($data->m_cost,2)?></td>
		 <td valign="top"><?=$data->m_type;?></td>
		 <td><?=$data->fname?></td>
	</tr>

<?
$total_cost += $data->m_cost;
 }?>

	<tr>

	  <td colspan="6" valign="top"><div align="right"><strong>Total:</strong></div></td>
