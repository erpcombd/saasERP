<table class="oe_view_manager_header" >
	...
	<? $unique_id =  $_GET['id'];?>
		...
		<?
		   ...
		   <td  align="center" valign="middle" width="80"><strong style="color:#FFF; font-size:16px;"><em><img src="../../../asstes/images/employee/<?=$unique_pbi_id?>.jpg" style="border-radius: 100%; width: 100px; margin:0px; margin-top: 7px; " class="img-circle profile_img modal-content" width="120" height="100" hspace="5" vspace="0" /></em></strong></td>
