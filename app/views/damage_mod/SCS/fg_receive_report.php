...
$res='select  	a.pi_no,a.pi_no, a.pi_date,  b.warehouse_name as Depot_from, a.remarks as sl_no, a.carried_by,a.entry_at,u.fname as entry_by from user_activity_management u, production_issue_master a,warehouse b where    a.warehouse_to='.$_SESSION['user']['depot'].' and a.entry_by=u.user_id and a.warehouse_from=b.warehouse_id and a.warehouse_to="'.$_SESSION['user']['depot'].'" and b.use_type!="PL" '.$con.' order by a.pi_no desc';
