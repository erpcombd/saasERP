...
if($_REQUEST['or_no']>0) 
{$or_no = $_SESSION[$unique] = 	$_REQUEST['or_no'];
}
if(isset($_POST['new']))
{
...
<form action="select_dealer_damage_problem_approval.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
