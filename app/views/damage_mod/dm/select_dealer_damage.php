...
//$sql = 'select or_no from warehouse_damage_receive where or_no>4148';
//$query = db_query($sql);
...
if(isset($_POST['confirmm']))
{
		...
		$crud->update($unique);
		auto_insert_damage_return_secoundary($$unique);
		unset($$unique);
...
?>
<input name="dealer" type="text" id="dealer" required />
    </strong></td>
    <td bgcolor="#FF9966"><strong>
