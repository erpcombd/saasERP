...
if(isset($_POST['add'])&&($_POST[$unique_master]>0))
{
		...
		$xid = $crud->insert();
		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['pr_date'],$_POST['total_unit'],0,'Receive',$xid);
		journal_item_control($_POST['item_id'] ,$_SESSION['line_id'],$_POST['pr_date'],0,$_POST['total_unit'],'Receive',$xid);
}
...
if($$unique_master>0)
{
		...
		auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_description,"#>",item_id)','1','item_id','product_nature="Salable"');
?>
    ...
    <td>
			<fieldset style="width:220px;">
			  <div>
			    ...
			    <input style="width:105px;"  name="pr_date" type="text" id="pr_date" value="<?=date('Y-m-d')?>" readonly="readonly"/>
		      </div>
			  <div>
