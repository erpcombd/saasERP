...
if(isset($_POST['add'])&&($_POST[$unique_master]>0))
{
		...
		$xid = $crud->insert();
		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['pi_date'],0,$_POST['total_unit'],'Issue',$xid);
		journal_item_control($_POST['item_id'] ,$_SESSION['line_id'],$_POST['pi_date'],$_POST['total_unit'],'0','Issue',$xid);
		//journal_item_control($_POST['item_id'] ,$_SESSION['line_id'],$_POST['pi_date'],$_POST['total_unit'],0,'Issue',$xid);
}
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <div>
      <label style="width:75px;">Issue No : </label>
    ...
    <td>
			<fieldset style="width:220px;">
			  <div>
			    ...
			    <input style="width:105px;"  name="pi_date" type="text" id="pi_date" value="<?=date('Y-m-d')?>" readonly="readonly"/>
		      </div>
			  <div>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <input  name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$warehouse_to?>"/>
      ...
      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:300px;" required="required" onblur="getData2('production_issue_ajax.php', 'pi', this.value, document.getElementById('warehouse_to').value);"/></td>
