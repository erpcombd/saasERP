...
$sql="select i.* from item_info i where i.product_nature='Salable' and finish_goods_code>0 and finish_goods_code<8000 ".$item_con.$pg_con." order by i.item_name";
$query = db_query($sql);
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.chalan_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
...
<td bgcolor="#FFFF66"><div align="right">
  ...
  %</div></td>
<td bgcolor="#FFFF66"><div align="right">
  <?=@number_format(${'dtotald'}*100/${'totalc'},2);?>
  %</div></td>
<td bgcolor="#FFFF66"><div align="right">
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.chalan_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));
...
?>
  ...
  <tr bgcolor="#<? echo (($i%2)==0)?'fff':'EBEBEB';?>">
    <td><?=++$j?></td>
    <td><a target="_blank"  href="?submit=1&report=109&zone_id=<?=$ZONE_CODE?>&f_date=<?=$_REQUEST['f_date']?>&t_date=<?=$_REQUEST['t_date']?>"><?=$item->ZONE_NAME?></a></td>
...
<td bgcolor="#FFFF66"><div align="right"><?=number_format((${'totalb'}),2);?></div></td>
<td bgcolor="#FFFF66"><div align="right"> <?=number_format((${'totalc'}),2);?></div></td>
<td bgcolor="#FFFF66"><div align="right"><?=number_format((${'totald'}),2);?></div></td>
<td bgcolor="#FFFF66"><div align="right"> <?=number_format((${'totalm'}),2);?></div></td>
<td bgcolor="#FFFF99"><div align="right"><?=number_format($totalall,2);?>
</div></td>
<td bgcolor="#FFFF66"><div align="right">
  <?=number_format(${'dtotala'},2);?>
</div></td>
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.chalan_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.chalan_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and   d.dealer_code='".$dealer_code."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='A' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='B' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
${'sqlmonb'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='C' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
${'sqlmonc'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a, zon z where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='M' and d.area_code=a.AREA_CODE and z.ZONE_CODE=a.ZONE_ID and z.REGION_ID='".$BRANCH_ID."'".$con;
${'sqlmonm'} = mysqli_fetch_row(db_query($sqql));
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Corporate'".$con;
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='A' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='B' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmonb'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='C' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmonc'} = mysqli_fetch_row(db_query($sqql));


$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,area a where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='M' and d.area_code=a.AREA_CODE and a.ZONE_ID='".$ZONE_CODE."'".$con;
${'sqlmonm'} = mysqli_fetch_row(db_query($sqql));
...
$sql = "select d.dealer_code,d.dealer_name_e as dealer_name,a.AREA_NAME as area from area a,zon z, dealer_info d where 
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,item_info i where c.item_id=i.item_id and c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='A' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,item_info i where c.item_id=i.item_id and c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='B' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonb'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,item_info i where c.item_id=i.item_id and c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='C' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonc'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,item_info i where c.item_id=i.item_id and c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d,item_info i where c.item_id=i.item_id and c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='M' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonm'} = mysqli_fetch_row(db_query($sqql));
...
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='A' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='B' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonb'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='C' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonc'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='D' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmond'} = mysqli_fetch_row(db_query($sqql));

$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and d.dealer_type='Distributor' and d.product_group='M' and  d.dealer_code='".$dealer_code."'".$con;
${'sqlmonm'} = mysqli_fetch_row(db_query($sqql));
...
$dealer_code = $dealer->dealer_code;
$sqql = "select sum(c.total_amt) from sale_do_chalan c,dealer_info d where c.do_date between '".$f_date."' and '".$t_date."' and c.dealer_code=d.dealer_code and   d.dealer_code='".$dealer_code."'".$con;
${'sqlmona'} = mysqli_fetch_row(db_query($sqql));
