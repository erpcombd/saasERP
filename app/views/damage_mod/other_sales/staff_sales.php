...
$title='Staff Sales';
$page = "staff_sales.php";
$ajax_page = "staff_sales_ajax.php";
$page_for = 'Staff Sales';
do_calander('#oi_date');
...
if(isset($_POST['add'])&&($_POST[$unique]>0))
{
		...
		$_POST['edit_at']=date('Y-m-d h:s:i');
		$xid = $crud->insert();
		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['oi_date'],0,$_POST['qty'],$page_for,$xid,$_POST['rate']);
}
...
if($$unique>0) $btn_name='Update SS Information'; else $btn_name='Initiate SS Information';
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <? $field='oi_subject';?>
      ...
      <? $field='issued_to'; ?>
      <div>
        <label for="<?=$field?>">Staff Name  :</label>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD SS" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" />
