...
auto_complete_from_db('item_info','finish_goods_code','concat(item_name,"#>",item_id)','product_nature="Saleable"','item_id');
...
$res='select a.id,b.finish_goods_code,b.item_name,d.damage_cause,a.rate as unit_price,a.qty,a.unit_name as unit,a.amount,d.payable  
from sales_damage_receive_detail a,item_info b,damage_cause d 
where a.receive_type=d.id and b.item_id=a.item_id and a.or_no='.$or_no.' order by a.id desc';
