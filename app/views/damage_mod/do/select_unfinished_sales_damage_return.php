...
$title='Unfinished Damage Return List';
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><strong>
      ...
      <select name="<?=$unique?>" id="<?=$unique?>">
        ...
        <? foreign_relation($table,$unique,$unique,$or_no,'warehouse_id='.$_SESSION['user']['depot'].' and status="'.$status.'"');?>
