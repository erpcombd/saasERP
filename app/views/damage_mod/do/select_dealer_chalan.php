...
<?
$query = "select a.do_no,b.dealer_code,b.dealer_name_e from sale_do_master a,dealer_info b where b.dealer_code=a.dealer_code and a.status ='CHECKED' and b.depot=".$_SESSION['user']['depot']." and a.do_date>'".date('y-').(date('m')-2).'-01'."'  order by a.do_no";
?>
