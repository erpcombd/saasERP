    ...
    <div class="row">
        <div class="col-sm-7 p-0 pr-2">
            <div class="container p-0">
				<form id="form1" name="form1" class="n-form1 pt-0" method="post" action="">
						<h4 align="center" class="n-form-titel1">Search Terms & Condition:</h4>
			...
			<div class="container n-form1">
				<table id="table_head" class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						$td='select a.'.$unique.',  a.'.$shown.',  a.sl_no, a.status from '.$table.' a	where 1  order by a.sl_no  ';
        ...
        <div class="col-sm-5 p-0  pl-2">
            <form class="n-form setup-fixed" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
				<h4 align="center" class="n-form-titel1">Terms & Condition:</h4>
				...
				<div class="form-group row m-0 pl-3 pr-3">
					...
					<div class="col-sm-9 p-0">
						...
						<input name="terms_condition" required type="text" id="terms_condition" tabindex="1" value="<?=$terms_condition?>"  style="width:220px;" >
					</div>

					<label for="group_name" class="req-input col-sm-3 pl-0 pr-0 col-form-label ">Sl No :</label>
					<div class="col-sm-9 p-0">
						<input name="sl_no" required type="text" id="sl_no" tabindex="1" value="<?=$sl_no?>"  style="width:220px;" >
					</div>
					
					<label for="group_name" class="req-input col-sm-3 pl-0 pr-0 col-form-label ">Status :</label>
					<div class="col-sm-9 p-0">
