						...
						<div class="form-group row m-0 pb-1">
                          ...
                          <? $quotation=find_a_field('purchase_master','quotation_no','po_no="'.$$unique.'"');
						   ...
						   ?>
								...
								<a href="../../../assets/support/upload_view.php?name=<?=$att?>&folder=quotation" target="_blank">View Attachment</a>
    ...
    <form action="" method="post" name="cloud" id="cloud">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<?
					$res='select a.id, b.finish_goods_code as item_code, concat(b.item_name) as item_name,a.unit_name as unit,a.qty as total_unit,a.rate, a.amount,"x" from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
