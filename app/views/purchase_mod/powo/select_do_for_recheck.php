...
do_calander('#fdate');
do_calander('#tdate');
$table_master='sale_do_master_vat_cal';
$unique_master='memo_no';

//$table_detail='sale_do_details';
//$unique_detail='id';

$table_chalan='sale_do_chalan_vat_cal';
$unique_chalan='id';
...
$table='sale_do_master_vat_cal';
$show='dealer_code';
$id='memo_no';
$text_field_id='old_do_no';

$target_url = '../posp/po_checking.php';
...
<td onClick="custom(<?=$data->po_no;?>);" <?=(++$z%2)?'':'class="alt"';?>><?=find_a_field('purchase_type','purchase_type','id='.$data->purchase_type)?></td>
