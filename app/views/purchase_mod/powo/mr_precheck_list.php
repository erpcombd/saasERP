...
$title='Unapproved Product Requisition';
...
$con .= 'and b.warehouse_id = "'.$_POST['warehouse_id'].'"';
 ...
 $res='select  	a.req_no,a.req_no, DATE_FORMAT(a.req_date, "%d-%m-%Y") as req_date,  b.warehouse_name as warehouse_from,  (select warehouse_name from warehouse where warehouse_id=a.warehouse_to) as warehouse_to, DATE_FORMAT(a.need_by, "%d-%m-%Y") as need_by, c.fname as entry_by, a.entry_at,a.status from requisition_fg_master a,warehouse b,user_activity_management c where a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id '.$con.'  order by a.req_no';
