    ...
    <td><div class="left_report">
		    ...
		    Period :                                       </td>
                                        ...
                                        <td width="26%" align="left">
                                         <?php /*?> <input name="fdate" type="text" id="fdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['fdate'];?>" /><?php */?>         <input style="width:250px;"  name="fdate" type="text" id="fdate" value="<?=$_REQUEST['fdate'];?>" />                               </td>
