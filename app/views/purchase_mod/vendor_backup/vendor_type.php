...
$title='Vendor Type';			// Page Name and Page Title
$page="vendor_type.php";		// PHP File Name

$table='vendor_type';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='vendor_type';				// For a New or Edit Data a must have data field
  ...
  <tr>
    <td valign="top"><div class="left">
							<table width="100%" border="0" cellspacing="0" cellpadding="0">
								  ...
								  <tr>
                                    <td style="padding-left:10px;line-height:4px;">
