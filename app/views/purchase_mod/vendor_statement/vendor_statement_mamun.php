...
and j.tr_from in ('payment','Journal')
...
// --------------- OPENING BALANCE
$sql="select a.ledger_id, sum(j.cr_amt- j.dr_amt) balance 
from accounts_ledger a, journal j
where a.ledger_id=j.ledger_id and a.ledger_group_id in ($code_link)
...
// --------------- UnVerified GR
$sql="select a.ledger_id, sum(j.cr_amt) balance 
from accounts_ledger a, secondary_journal j
where a.ledger_id=j.ledger_id and a.ledger_group_id in ($code_link)
and j.jv_date > '".$f_date."'
and j.tr_from in('Purchase') and j.checked='NO'
".$pg_con.$con.$dealer_con." group by a.ledger_id";
						...
						<div class="form-group row  m-0 mb-1 pl-3 pr-3">
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
								...
								<select name="ledger_id" id="ledger_id" class="form-control"  >
									...
									foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,"ledger_group_id in (426005)  and group_for=".$_SESSION['user']['group']."  order by ledger_id");
			...
			<div id="reporting">
				<div id="grp">
					...
					<table class="table1  table-striped table-bordered table-hover table-sm" cellpadding="0" cellspacing="0" width="100%">
						...
						from accounts_ledger a, vendor v
						where a.ledger_id=v.ledger_id and a.ledger_id like '".$_POST['ledger_id']."'
						and a.ledger_group_id in (426005) 
						".$con.$dealer_con." 
