						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
							<div class="form-group row m-0">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									<input  name="fdate" type="text" id="fdate" value="<?=$_REQUEST['fdate'];?>" required  autocomplete="off"/>
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
							<div class="form-group row m-0">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									...
									<input name="tdate" type="text" id="tdate" size="12" value="<?php echo $_REQUEST['tdate'];?>" required autocomplete="off"/>
