...
<tbody>
<?
  $sql_item="SELECT item_id as code,i.finish_goods_code as fg_code,i.sub_group_id,s.sub_group_name,i.item_name,i.unit_name,i.group_for, u.company_name
...
<td><?=$data->company_name;?></td>
  ...
  <td><?=$sec_receive[$data->code]?></td>
  <td><?=$production[$data->code]?></td>
  ...
  <td><?=$in_total?></td>
  <td><?=$sales[$data->code]?></td>
  <td><?=$consumption[$data->code]?></td>
  <td><?=$production_issue[$data->code]?></td>
  <td><?=$wip_issue[$data->code]?></td>
  <td><?=$replace_issue[$data->code]?></td>
   <td><?=$damage_issue[$data->code]?></td>
  <td><?=$out_total?></td><?php $closing = $in_total - $out_total; ?>  
  <td><?=number_format($closing,4);?></td>
  <td><? if($_SESSION['user']['level']==5) echo $bin_closing[$data->code]; else echo $bin_closing[$data->code]=0;?></td>
  <td><?=number_format(($closing-$bin_closing[$data->code]),4);?></td>
...
<tr>
  ...
  <td bgcolor="#99CC99"><strong><?=$total_sec_receive;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_production;?></strong></td>
  ...
  <td bgcolor="#99CC99"><strong><?=$total_sales;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_consumption;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_production_issue;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_wip_issue;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_replace_issue;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_damage_issue;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_out_total;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_closing;?></strong></td>
  <td bgcolor="#99CC99"><strong><?=$total_bin_closing;?></strong></td>
  <td bgcolor="#99CC99"><? ($total_closing-$total_bin_closing); 
  							$closingone = number_format($total_closing, 3, '.', '');
							$closingtwo = number_format($total_bin_closing, 3, '.', '');
...
<td></td>
<td></td>
<td style="text-align:right"><?=number_format($stockk,2);?></td>
</tr>
<?
