...
div.form-container_large input {
  ...
  <table style="width:80%; margin:0 auto; border-collapse:collapse;">
    <tr>
      ...
      <td rowspan="5" style="width:340px; text-align:center; background-color:#FF9966;">
    ...
    <tr>
      <td style="text-align:right; background-color:#FF9966; font-weight:bold;">REQ. No:</td>
      <td colspan="3" style="background-color:#FF9966;">
        <select name="req_no" id="req_no" style="width:200px;">
          <option value=""></option>
          <?php foreign_relation('purchase_rfq_master','req_no','view_req_no',$_POST['req_no'],'1'); ?>
        </select>
      </td>
    </tr>
  </table>
...
<tr>
  <th style="width:11%;">RFQ No </th>
  <th style="width:18%;">RFQ Date </th>
  <th style="width:25%;"><strong>Requisition No </strong></th>
  <th style="width:24%;">Vendor Name </th>
  <th style="width:22%;">Entry By </th>
  </tr>
