...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="4%" bgcolor="#F5F5F5" ><strong>SL</strong></td>

        <td width="21%" bgcolor="#F5F5F5" ><strong> Category </strong></td>
        <td width="45%" bgcolor="#F5F5F5" ><strong> Item Description </strong></td>

        <td width="12%" bgcolor="#F5F5F5" ><strong>Unit</strong></td>
        <td width="18%" bgcolor="#F5F5F5" ><strong>RFQ Qty </strong></td>
        </tr>
