...
div.form-container_large input {
  ...
  <table style="width:80%; margin:0 auto; border-collapse:collapse;">
    <tr>
      ...
      <td rowspan="5" style="width:344px; text-align:center; background-color:#FF9966;">
    ...
    <tr>
      ...
      <td colspan="3" style="background-color:#FF9966;">
        <select name="req_no" id="req_no" style="width:200px;">
          <option value=""></option>
          <?php foreign_relation('purchase_requisition_master','invoice_no','view_invoice_no',$_POST['req_no'],'1'); ?>
        </select>
      </td>
    </tr>
  </table>
...
<tr>
  ...
  <th  style="width:19%"><strong>REQ.</strong> Date </th>
...
$con .= ' and m.invoice_no in ('.$_POST['invoice_no'].') ';}
   ...
   $res="select  m.* from  purchase_requisition_master m, purchase_requisition_details d where m.invoice_no=d.invoice_no and  m.status!='MANUAL'  ".$con.$req_no_con." group by m.invoice_no order by m.invoice_date, m.invoice_no";
