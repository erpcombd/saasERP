...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="6%" bgcolor="#F5F5F5" ><strong>SL</strong></td>

        <td width="40%" bgcolor="#F5F5F5" ><strong> Item Description </strong></td>

        <td width="8%" bgcolor="#F5F5F5" ><strong>Unit</strong></td>
        <td width="11%" bgcolor="#F5F5F5" ><strong>PO Qty </strong></td>
        <td width="17%" bgcolor="#F5F5F5" ><strong>Each Price in <?=$ms_data->currency_type;?></strong></td>
        <td width="18%" bgcolor="#F5F5F5" ><strong>Amount in <?=$ms_data->currency_type;?></strong></td>
       </tr>
