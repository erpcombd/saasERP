...
$table='terms_conditions';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='tearms';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Terms</span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.terms_conditions from '.$table.' a	where 1  '.$con.' order by a.id  ';
...
<? //}?>
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
							  ...
							  <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box style2" style="width:500px;">
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:500px; float:right">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Terms:</td>
                        				...
                        				<input name="tearms" required type="text" id="tearms" tabindex="1" value="<?=$tearms?>"  style="width:220px;" >	
                                     ...
                                     <td>Terms & Condition:</td>
                        				...
                        				<input name="terms_conditions" required type="text" id="terms_conditions" tabindex="1" value="<?=$terms_conditions?>"  style="width:220px;" >	
