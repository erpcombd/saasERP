...
div.form-container_large input {
  ...
  <table style="width:80%; margin:0 auto; border-collapse:collapse;">
    ...
    <tr>
      <td style="text-align:right; background-color:#FF9966; font-weight:bold;">QUOTE No:</td>
...
<tr>
  ...
  <th  style="width:18%"><strong>QUOTE</strong><strong> </strong>Date </th>
  <th style="width:21%">REQ. No </th>
  <th style="width:23%"><strong>Vendor Name </strong></th>
  <th style="width:25%">Entry By </th>
  </tr>
