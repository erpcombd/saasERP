...
<table id="grp" style="width:100%; border-collapse:collapse;"><tbody>
<tr>
  <th style="width:14%; font-weight:bold;">REQ No</th>
  <th style="width:19%; font-weight:bold;">REQ Date</th>
  <th style="width:23%; font-weight:bold;">Warehouse</th>
...
$con .= ' and m.invoice_no in ('.$_POST['invoice_no'].') ';}
    ...
    HAVING SUM(qd.unit_price * qd.req_qty) > 100000
