...
{$to_date=$t_date; $fr_date=$f_date; $date_con=' and a.quotation_date between \''.$fr_date.'\' and \''.$to_date.'\'';}
		   ...
		   from quotation_master a, quotation_detail b, vendor c, item_info e
		   where a.quotation_no=b.quotation_no and a.group_for="'.$_SESSION['user']['group'].'" and a.vendor_id=c.vendor_id and b.item_id=e.item_id and a.status!="MANUAL" '.$date_con.$by_con.$vendor_con.$cat_con.$item_con.$item_sub_con.$status_con.' order by a.quotation_no';
