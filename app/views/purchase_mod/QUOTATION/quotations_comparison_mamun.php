...
$target_url = 'quotations_comparison_print_view_mamun.php';
$tr_from="Purchase";
	  ...
	  <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 p-0">
        <div class="form-group row m-0">
          ...
          <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
				...
				<option value=""></option>		
				<? foreign_relation('requisition_master','req_no','req_no',$_POST['req_no'],'1 and warehouse_id="'.$_SESSION['user']['depot'].'"');?>		
			  </select>
