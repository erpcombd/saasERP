...
if(isset($_POST['master_data_update'])){
...
<input name="requisition_user_name" type="text" id="requisition_user_name" readonly="readonly" style="width:90%; height:32px;" value="<?=find_a_field('user_activity_management','fname','user_id='.$req_data->entry_by);?>"   tabindex="1" /></td>
		...
		<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['section'],'1 and warehouse_id="'.$req_data->warehouse_id.'"');?>
								  ...
								  <tr>
								    ...
								    <td ><input name="ait" type="text" id="ait" style="width:90%; height:32px;" value=""   tabindex="1"  readonly=""/></td>
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	  ...
	  <select name="vat_include" type="text" id="vat_include" style="width:90%; height:32px;"    tabindex="1"  required>
											...
											<option value="Including" <?=$ms_data->$vat_include == 'Including' ? 'selected' : '' ?>>Including</option>
    										<option value="Excluding" <?=$ms_data->$vat_include == 'Excluding' ? 'selected' : '' ?>>Excluding</option>
									</select>
      </td>
      <td align="right" ><strong> Tax: </strong></td>
      <td ><!--<input name="tax_include" type="text" id="tax_include" style="width:90%; height:32px;" value="<?=$ms_data->tax_include;?>" readonly=""   tabindex="1" />-->
	  <select name="tax_include" type="text" id="tax_include" style="width:90%; height:32px;"    tabindex="1"  required>
									
									
											<option value="Including" <?=$ms_data->$tax_include == 'Including' ? 'selected' : '' ?>>Including</option>
    										<option value="Excluding" <?=$ms_data->$tax_include == 'Excluding' ? 'selected' : '' ?>>Excluding</option>
									</select>
	  </td>
      <td align="right"><strong> VDS Payable: </strong></td>
      <td ><!--<input name="deductible" type="text" id="deductible" style="width:90%; height:32px;" value="<?=$ms_data->deductible;?>"   tabindex="1" />-->
	  		<select name="deductible" type="text" id="deductible" style="width:90%; height:32px;"    tabindex="1" required>
									
									
											<option value="Yes" <?= $ms_data->$deductible == 'Yes' ? 'selected' : '' ?>>Yes</option>
    										<option value="No" <?= $ms_data->$deductible == 'No' ? 'selected' : '' ?>>No</option>
									</select>
	  </td>
    </tr>
    <tr>
      <td align="right" ><strong> AIT: </strong> </td>
      <td ><input name="ait" type="text" id="ait" style="width:90%; height:32px;" value="<?=$ms_data->ait;?>"   tabindex="1" readonly/></td>
      <td align="right" ><strong> Discount: </strong></td>
      <td ><input name="discount" type="text" id="discount" style="width:90%; height:32px;" value="<?=$ms_data->discount;?>"   tabindex="1" /></td>
      <td align="right"><strong> Vat Rebate: </strong></td>
    ...
    <tr>
	  ...
	  <input name="po_type1" type="text" id="po_type1" style="width:90%; height:32px;" value="<?=find_a_field('purchase_type','po_type','id='.$ms_data->po_type);?>"   tabindex="1" readonly="" />
	  </td>
    </tr>
	...
	<tr>
      ...
      <td></td>
      <td></td>
      <td><input type="submit" name="master_data_update" id="master_data_update" value="Update Entry" style="width:160px; text-transform:uppercase; background:#87CEFA; color:#000000; text-align:center; font-weight:bold; font-size:12px; height:30px; "/></td>
      <td></td>
      <td></td>
    </tr>
