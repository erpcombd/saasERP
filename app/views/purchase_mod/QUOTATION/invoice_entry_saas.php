...
window.location.href = "invoice_entry_saas.php?request_no=<?=$invoice_no?>";
</script>
...
<script language="javascript">
window.location.href = "create_quotation_saas.php";
</script>
...
<input name="req_qty_<?=$datafg->id?>" type="text" id="req_qty_<?=$i?>" value="<?=$datafg->qty;?>" onkeyup="TRcalculationpo(<?=$i?>)" readonly="" style="width:80px; height:30px; " /></td>
    <td bgcolor="#99CCFF"><input name="unit_price_<?=$datafg->id?>" type="text" id="unit_price_<?=$i?>" onkeyup="calculateTotal()" onChange="calculateTotal()" value="" style="width:80px; height:30px;  "/></td>
 ...
 <?php /*?>   <td bgcolor="#99CCFF"><input name="total_unit_<?=$datafg->id?>" type="text" id="total_unit_<?=$i?>" value="1"  readonly="" style="width:50px; height:30px; "/></td><?php */?>
