...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="2%" bgcolor="#F5F5F5" ><strong>SL</strong></td>

        <td width="19%" bgcolor="#F5F5F5" ><strong> Category </strong></td>
        <td width="37%" bgcolor="#F5F5F5" ><strong> Item Description </strong></td>

        <td width="5%" bgcolor="#F5F5F5" ><strong>Unit</strong></td>
        <td width="9%" bgcolor="#F5F5F5" ><strong>RFQ Qty </strong></td>
        <td width="18%" bgcolor="#F5F5F5" ><strong>Each Price in <?=$ms_data->currency_type;?></strong></td>
        <td width="10%" bgcolor="#F5F5F5" ><strong>Per Unit</strong> </td>
       </tr>
