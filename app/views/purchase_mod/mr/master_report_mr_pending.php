...
<div class="main">
	...
	if(isset($_SESSION['user']['group']))
		$str 	.= '<img width="50%" src="../../../../public/uploads/logo/'.$_SESSION['proj_id'].'.png'.'">';
		...
		$str 	.= '<h2 style="margin: 2px; font-size:14px;"> <strong>'.find_a_field('warehouse','warehouse_name','warehouse_id='.$_SESSION['user']['depot']).'</strong></h2>';

	if(isset($report))
		$str 	.= '<h2 style="margin: 1px; font-size:14px;">'.$report.'</h2>';
...
<table width="100%" cellspacing="0" cellpadding="2" border="0" id="ExportTable"><thead><tr><td style="border:0px;" colspan="9"><div class="header"><h1><?=$_SESSION['company_name']?></h1><h2><?=$report?></h2>
...
<tbody>
	...
	<tr>
		...
		<th><div align="left">MR Date</div></th>
		<th><div align="left">Item Name</div></th>
		<th><div align="left">Product Sub-Group</div></th>
		<th><div align="left">Entry By </div></th>
		<th><div align="left">Entry At</div></th>
...
if($_POST['sub_group_id']){$sub_group_con=' and g.sub_group_id='.$_POST['sub_group_id'];}
...
if(isset($garden_id)) 	{$garden_id_con=' and b.garden_id='.$garden_id;}
  ...
  $res='
select a.req_no as req_no, a.req_date, a.entry_by, a.entry_at, b.qty as qty,g.sub_group_id,g.sub_group_name, i.item_name as item_name,a.status,b.unit_name,b.qty from requisition_master a, requisition_order b, item_info i,item_sub_group g where a.req_no=b.req_no and a.warehouse_id="'.$_SESSION['user']['depot'].'" and i.item_id=b.item_id and i.sub_group_id=g.sub_group_id  '.$con.$item_con.$sub_group_con.' order by a.req_no';
...
?>
    ...
    <tr>
	  ...
	  <td valign="top" style="border:none; ">&nbsp;</td>
	  <td valign="top" style="border:none;">&nbsp;</td>
	  <td valign="top" colspan="2" rowspan="2" style="border:none; font-weight:bold; text-align:right;">Total Quantity</td>
	  <td valign="top" style="border:none; font-weight:bold;"><?php echo $total; ?></td>
