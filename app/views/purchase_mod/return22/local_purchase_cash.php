...
$page_for = 'Local_Purchase_Cash';



do_calander('#or_date','-15','+0');
...

{
		...
		auto_insert_purchase_secoundary_local_purchase_cash($$unique);
...
auto_complete_from_db('vendor','concat(vendor_name,"#>",vendor_id)','vendor_id','1','vendor_name');
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td align="center" bgcolor="#0099FF"><strong>Qty</strong></td>
						     <td align="center" bgcolor="#0099FF">Narration</td>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:239px;" required onblur="getData2('local_purchase_ajax.php', 'po',this.value,document.getElementById('warehouse_id').value);"/></td>
...
<td align="center" bgcolor="#CCCCCC"><input name="narration" type="text" class="input3" id="narration"  maxlength="100" style="width:60px;" /></td>
...
$res='select a.id,b.item_name,a.narration,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from warehouse_other_receive_detail a,item_info b where b.item_id=a.item_id and a.or_no='.$or_no;

echo link_report_add_del_auto_cus($res,'',6);
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
	  ...
	  <input name="delete" type="submit" class="btn1" value="DELETE ENTRY" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" /></td>
