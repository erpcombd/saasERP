...
<th class="text-center">Action</th>
 ...
 $con=' and a.or_date between "'.date('Y-m-o1').'" and "'.date('Y-m-d').'"';
  ...
  where a.entry_by=u.user_id  and a.status="UNCHECKED" and receive_type="Import" '.$con.' order by a.or_no desc';
...
<td class="text-center"><a href="../import/import_raw_approval.php?or_no=<?=$data->or_no?>"><button class="btn btn-success btn-sm">Complete Import</button></a></td>
