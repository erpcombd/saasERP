...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../warehouse_mod/pages/do/chalan_bill_corporate_acc.php?v_no=<?=$ch->chalan_no?>">CH-
...
<input name="voucher_date" type="text" id="voucher_date" value="<?=date('Y-m-d')?>" />    </td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../warehouse_mod/pages/do/chalan_bill_corporate_acc.php?v_no=<?=$ch->chalan_no?>">CH-
...
<a target="_blank" href="../../warehouse_mod/pages/pr/chalan_view2.php?v_no=<?=$ch->pr_no?>"></a></div><? }?>
 ...
 $sql2="SELECT a.ledger_id,a.ledger_name,sum(cr_amt) as cr_amt,sum(dr_amt) as dr_amt,b.narration FROM accounts_ledger a, secondary_journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id group by ledger_id";
