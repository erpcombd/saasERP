...
<div class="body">
	<div class="header">
		...
		<td width="17%" align="right" class="qr-code">
              ...
              $req_no_qr_data = url_encode($po_no); // Change variable as needed
              $print_url = "https://saaserp.ezzy-erp.com/app/views/purchase_mod/po/po_print_view_store.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-lg-6 left">
			...
			<div class="new-div">
				...
				<p class="text1">Address: <span><?php $vendor_address = find_a_field('vendor','address','vendor_id="'.$master->vendor_id.'"'); if(!empty($vendor_address) && $vendor_address != 0){echo $vendor_address;} else {echo "N/A";}?></span>
</p>
		...
		<div class="col-md-6 col-sm-6 col-lg-6 right">
			...
			<p class="right-text"> RFQ No: <span><? if(!empty($master->quotation_no) && $master->quotation_no != 0){ echo $master->quotation_no;} else {echo "N/A";}
    ?>
  </span>
</p>
