                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<?
                        ...
                        <tr>
							...
							<button type="button" onclick="custom('<?=url_encode($row->po_no);?>','<?=url_encode($c_id);?>')" class="btn2 btn1-bg-submit"><i class="fa-solid fa-eye"></i></button>
