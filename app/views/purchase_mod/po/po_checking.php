                    ...
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
								...
								<select id="group_for" name="group_for" disabled >
						...
						<div class="form-group row m-0 pb-1">
                            ...
                            <label for="qc_with_parameter" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Qc Enable</label>
...
<? $field='purchase_type';?>
    ...
    <select id="<?=$field?>" name="<?=$field?>" value="<?=$_POST['purchase_type']?>" required style="width:220px;" disabled="disabled" >
    ...
    <select id="<?=$field?>" name="<?=$field?>" required style="width:220px;" <? if(!empty($$field)){ echo'disabled';} ?>    >
        ...
        <? foreign_relation($table,$get_field,$show_field,$$field,'1 and group_for="'.$_SESSION['user']['group'].'"');?>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="padding: 5px; font-size: 9px !important;">
              ...
              <?php /*?>  <td style="padding: 2px;" align="center">
                    <a href="po_print_view.php?po_no=<?= url_encode($po_no) ?>" target="_blank">
                    <img src="../../../../public/assets/images/print.png" style="width: 20px;" />
                    </a>
                </td><?php */?>
				
				<td style="padding: 2px;" align="center">
                    <a href="po_print_view.php?c='<?=rawurlencode(url_encode($c_id))?>&v=<?=rawurlencode(url_encode($po_no))?>'" target="_blank">
                    <img src="../../../../public/assets/images/print.png" style="width: 20px;" />
                    </a>
                </td>
                </tr>
...
<? if($all->purchase_type !=1){ ?>
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<?  
					$res='select a.id, b.finish_goods_code as item_code, concat(b.item_name) as item_name,b.unit_name as unit,a.rate,a.qty as total_unit, a.amount,"x",b.item_id from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
                ...
                <tr>
                    <td <? if($all->qc_with_parameter == 'Yes'){echo 'rowspan="2"';}?> ><?=++$s?></td>
                    ...
                    <td><?=$data->amount; $total_amt=$total_amt+$data->amount;?></td>
	  ...
	  <div class="n-form-btn-class">
           <input type="text" name='entry_time' id='entry_time' value='<?=date('Y-m-d h:s:i');?>' readonly="">
			...
			<input type="hidden" name="confirm_remarks" id="confirm_remarks">
				  <input name="confirmm" type="submit" class="btn1 btn1-bg-submit" onclick="confirm_function()" value="CONFIRM AND FORWARD PO"  />
