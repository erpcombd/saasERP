 ...
 //unset($_POST);
    ...
    if($next_level_avaliable>0){
      ...
      $crud->update($unique);
		...
		unset($_SESSION[$unique]);
		$type=1;
		header('location:select_unapproved_po_jamuna.php');
        ...
        <? foreign_relation($table,$get_field,$show_field,$$field,'1 and group_for="'.$_SESSION['user']['group'].'"');?>
            ...
            <table border="1" cellpadding="5" cellspacing="0" style="padding: 5px; font-size: 9px !important;">
                ...
                <td style="padding: 2px;" align="center">
                    <a href="po_print_view_jamuna.php?po_no=<?= url_encode($po_no) ?>" target="_blank">
    ...
    <form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
	  ...
	  <div class="n-form-btn-class">
           <input type="text" name='entry_time' id='entry_time' value='<?=date('Y-m-d h:s:i');?>' readonly="">
				  ...
				  <td><input type="button" class="btn1 btn1-bg-help" value="CLOSE"  onclick="window.location.href='select_unapproved_po_jamuna.php'" /></td>
