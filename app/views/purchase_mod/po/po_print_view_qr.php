...
$po_no = url_decode(str_replace(' ', '+', $_REQUEST['v'])); // url value pass by "v" not "po_no"
...
<?php /*?>		<td class="Qrl_code">
		...
		<td class="qr-code">
			...
			$print_url = "https://saaserp.ezzy-erp.com/app/views/purchase_mod/po/po_print_view_qr.php?c=7oKXlrqDK1N%2FpLMXEJWzTQ%3D%3D&v=" . $req_no_qr_data;
