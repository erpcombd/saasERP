...
//   AND pm.entry_by = 'your_user_id';
 ...
 $pending_purchase_order=find_a_field('requisition_master','count(*)','1 and YEAR(req_date) ="'.$current_year.'" and status="CHECKED"');
...
<div class="container-fluid">
    ...
    <i class="fas fa-check-circle"></i> Create Order 
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Pending Purchase Order<span> || Year <?=date('Y');?></span></h5>
						
						<div class="d-flex ustify-content-between p-3">
						<div class="new-icon success"><?=$pending_purchase_order?></div>
						<?php /*?><div class="new-icon-text">
						 	<!--<p class="p-sub bold">&nbsp;</p>-->
    ...
    <i class="fas fa-check-circle"></i>Pending PR
</button>
						</a>
					  </div>
					</div>
