...
<script src="//cdnjs.cloudflare.com/ajax/libs/raphael/2.1.0/raphael-min.js"></script>
  ...
  <script src="<?=SERVER_ROOT?>public/dashboard_assets/morris/morris.min.js" type="text/javascript"></script>
  <script src=""></script>
  <link rel="stylesheet" href="<?=SERVER_ROOT?>public/dashboard_assets/morris/morris.css"/>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats" style="border: 1px solid green;">
                ...
                <div class="card-footer" style="border-top:1px solid green">
                  ...
                  <div class="stats m-0"><h5 class="m-0 font-weight-bold"> LOCAL PURCHASE</h5></div>
...
<!--		  <div class="col-lg-3 col-md-6 col-sm-6">-->
    ...
    <!--      <div class="row">
		  ...
		  <!--2nd Dealy seals reporte chart-->
				<div class="col-lg-6 col-md-12">
					<div class="card card-chart">
						<div class="card-body">
							<h4 class="card-title">MONTHLY PURCHASE CHART </h4>
						</div>
			  ...
			  <div class="col-lg-6 col-md-12">
				<div class="card card-chart">
					<div class="card-body">
					  	<h4 class="card-title">ONE WEEK PURCHASE CHART </h4>
	<!--				 	<p class="card-category"><span class="text-success"><i class="fa fa-long-arrow-up"></i> 15% </span> increase. </p>-->
				...
				<div class="col-lg-6 col-md-12">
					<div class="card card-chart">
						<div class="card-body">
							<h4 class="card-title">ONE YEAR PURCHASE REPORTS </h4>
						</div>
						<div class="card-header">
								<div id="reportPage">
				...
				<div class="col-lg-6 col-md-12">
					<div class="card card-chart">
						<div class="card-body">
							<h4 class="card-title">LAST 3 YEAR PURCHASE REPORTS </h4>
						</div>
						<div class="card-header">
								<div id="reportPage">
...
var myChart = new Chart(ctx, {
    ...
    data: {
        ...
        datasets: [{
            label: 'Purchase', // Name the series
            ...
            borderWidth: 1 // Specify bar border width
                  ...
                  {
            label: 'Purchase Return', // Name the series
...
function view_data(){
$.ajax({
url:"purchase_dashboard_ajax.php",
method:"POST",
dataType:"JSON",
