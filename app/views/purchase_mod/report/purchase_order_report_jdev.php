        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                <div align="left">Select Report </div>
					...
					echo $res2 ='SELECT  r.folder_name, r.report_no, r.feature_id,r.page_id, p.id AS page_id, f.id AS feature_id, f.feature_name,  m.id AS module_id,  m.module_name
			...
			WHERE  m.module_file="'.$mod_name.'" and p.folder_name="'.$folder_name.'" and p.page_link="'.$page_name .'" and r.folder_name="'.$folder_name.'" and r.feature_id=f.id and r.page_id=p.id';
								...
								While($row=mysqli_fetch_object($query)){
								 ...
								 $res ='select report_no from report_manage where page_id="'.$row->page_id.'"';
