...
$title='Supplier Category';			// Page Name and Page Title
		    ...
		    Company:                                       </td>
					  ...
					  id="'.$_SESSION['user']['group'].'"');?>
                                      ...
                                      <tr>
                                        ...
                                        <td align="right"><input name="category_name" type="text" id="category_name" style="width:250px; float:left;" value="<?php echo $_POST['category_name']; ?>" size="20" /></td>
