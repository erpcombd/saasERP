				...
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<div class="container vendor_info_img">
							<a href="../../../assets/support/upload_view.php?name=<?=$tin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download><img src="../../../assets/support/upload_view.php?name=<?=$tin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" /></a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<div class="container vendor_info_img">
							<a href="../../../assets/support/upload_view.php?name=<?=$trade?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download><img src="../../../assets/support/upload_view.php?name=<?=$trade?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" /></a>
						</div>
					</div>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
							...
							<div class="container vendor_info_img">
								<a href="../../../assets/support/upload_view.php?name=<?=$bin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download><img src="../../../assets/support/upload_view.php?name=<?=$bin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" /></a>
							</div>
					</div>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<div class="container vendor_info_img">
							<a href="../../../assets/support/upload_view.php?name=<?=$cheque?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank" download><img src="../../../assets/support/upload_view.php?name=<?=$cheque?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" /></a>
						</div>
					</div>
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
								<? if ($ledger_id==0) {?>
									<select class="vendor_label_text" name="ledger_group" required="required" id="ledger_group" tabindex="9">
										...
										<option></option>
										<? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class=231 and group_for="'.$_SESSION['user']['group'].'"'); //acc_sub_class=203?>
									</select>
								<? }?>
