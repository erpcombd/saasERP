...
createSubLedger($custome_code,$_POST['ledger_name'],'vendor',$_POST[$unique],$_POST['ledger_id'] ,$_POST['vendor_category'],$_POST['group_for']);
}
...
$_POST['cheque']=upload_file($folder,$field,$file_name);
	...
	$sub_ledger_id = $_POST['sub_ledger_id'];
	  ...
	  $sql1 = 'update  general_sub_ledger set sub_ledger_name="'.$_POST['vendor_name'].'" ,group_for="'.$_POST['group_for'].'",edit_at="'.$_POST['edit_at'].'",
	  edit_by="'.$_POST['edit_by'].'" where sub_ledger_id  = '.$sub_ledger_id;
		db_query($sql1);
...
<div class="container-fluid pt-5 p-0 ">
			...
			<table id="vendor_table" class="table1  table-striped table-bordered table-hover table-sm">
				...
				where   a.group_for=u.id  and a.group_for in ('.$user_group_define.')   '.$con.' order by a.vendor_id ';
		...
		<form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
			...
			<div class="container-fluid n-form1">
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$tin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$tin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" /></a>
					...
					<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$trade?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$trade?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" /></a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
							...
							<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$bin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$bin?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" /></a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$cheque?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$cheque?>&folder=vendor&proj_id=<?=$_SESSION['proj_id']?>" /></a>
			...
			<div class="container-fluid bg-form-titel">
				...
				<div class="row">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						<div class="form-group row m-0">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text rrq-input req-input">Vendor Credit Days:</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
			 <input class="vendor_label_text" name="vendor_credit_days" type="text" id="vendor_credit_days" tabindex="18" value="<?=$vendor_credit_days?>" />
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						<div class="form-group row m-0">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Company :</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
