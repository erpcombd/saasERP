...
$_POST['cheque']=upload_file($folder,$field,$file_name);
	...
	$sub_ledger_id = $_POST['sub_ledger_id'];
	  ...
	  $sql1 = 'update  general_sub_ledger set sub_ledger_name="'.$_POST['vendor_name'].'" ,group_for="'.$_POST['group_for'].'" 
			...
			<div class="container-fluid n-form1">
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<a href="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_tin&&name=<?=$tin;?>" target="_blank">
    						<img src="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_tin&&name=<?=$tin;?>" onerror="this.onerror=null; this.src='<?= $defaultImage ?>';" alt="Image" />
						</a>
					...
					<?php /*?>	<a href="<?= $imageUrl ?>" target="_blank" download><?php */?>
				
						
						<a href="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_trade&&name=<?=$trade;?>" target="_blank">
    						<img src="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_trade&&name=<?=$trade;?>" onerror="this.onerror=null; this.src='<?= $defaultImage ?>';" alt="Image" />
						</a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<?php /*?><a href="<?= $imageUrl ?>" target="_blank" download><?php */?>
							...
							<a href="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_bin&&name=<?=$bin;?>" target="_blank">
    						<img src="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_bin&&name=<?=$bin;?>" onerror="this.onerror=null; this.src='<?= $defaultImage ?>';" alt="Image" />
						</a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<?php /*?><a href="<?= $imageUrl ?>" target="_blank" download><?php */?>
    						...
    						<img src="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=vendor_cheque&&name=<?=$cheque;?>" onerror="this.onerror=null; this.src='<?= $defaultImage ?>';" alt="Image" />
						</a>
