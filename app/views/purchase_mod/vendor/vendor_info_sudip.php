...
.bg-form-titel .nav-tabs .nav-item  .customer_button {
...
.bg-form-titel .nav-tabs .nav-item .customer_button.active {
  background-color: #39768f!important;
  border-radius: 0!important;
  border: 1px solid #333!important;
...
.bg-form-titel .nav-tabs .nav-item .customer_button:not(:last-child) {
...
.tab-content{
  ...
  <li class="nav-item" role="presentation">
    <button class="nav-link active customer_button" id="home-tab" data-toggle="tab" data-target="#customer" type="button" role="tab" aria-controls="home" aria-selected="true">Vendor Information</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link customer_button" id="profile-tab" data-toggle="tab" data-target="#file" type="button" role="tab" aria-controls="profile" aria-selected="false">Vendor File Upload</button>
  </li>
</ul>
...
<div class="tab-content" id="myTabContent">
 ...
 <div class="container-fluid bg-form-titel">
 <h4 class="text-center bg-titel bold pt-2 pb-2 text-uppercase"> Vendor Information Add </h4>
   ...
   <div class="tab-pane fade" id="file" role="tabpanel" aria-labelledby="profile-tab">
		<h4 class="text-center bg-titel bold pt-2 pb-2 text-uppercase">VENDOR FILE UPLOAD</h4>
