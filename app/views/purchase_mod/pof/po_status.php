...
$unique = 'po_no';
$status = 'UNCHECKED';
$target_url = '../pof/po_print_view.php';
...
$con .= 'and b.warehouse_id = "'.$_POST['warehouse_id'].'"';
 ...
 $res='select  a.po_no,a.po_no, DATE_FORMAT(a.po_date, "%d-%m-%Y") as po_date, v.vendor_name as suppliyer_name, b.warehouse_name as warehouse, c.fname as "entry_by", a.entry_at,a.status from purchase_master a,warehouse b,user_activity_management c, vendor v where a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id and a.vendor_id=v.vendor_id '.$con.' order by a.po_no desc';
