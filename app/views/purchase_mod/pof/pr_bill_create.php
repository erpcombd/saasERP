  ...
  <tr>
    ...
    <? $field='req_no';?>
      ...
      <div></div>
		...
		<label style="width:120px;" for="<?=$field?>">Material Type:</label>

		<input  name="<?=$field?>" type="text" id="<?=$field?>" 
		value="<?=find_a_field('material_type','material_type','id='.$$field)?>" />
...
<?php /*?>	<? if($ex<time()){?>
	...
	<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td width="8%" align="right" bgcolor="#9999FF"><strong>Bill NO: </strong></td>

        <td width="14%" align="right" bgcolor="#9999FF"><strong>

          <input style="width:105px;"  name="bill_no" type="text" id="bill_no" value="" required="required"/>

        </strong></td>

        <td width="13%" align="right" bgcolor="#9999FF"><strong> Date :</strong></td>

        <td width="22%" bgcolor="#9999FF"><strong>

          <input style="width:120px;"  name="bill_date" type="text" id="bill_date" value="" required="required"/>

          <input style="width:105px;"  name="qc_by" type="hidden" id="qc_by"/>
          <input style="width:105px;"  name="ch_no" type="hidden" id="ch_no"/>
        </strong></td>

        <td width="9%" bgcolor="#9999FF"><strong>Remarks: </strong></td>
        <td width="34%" bgcolor="#9999FF"><strong>
          <input style="width:250px;"  name="acc_note" type="text" id="acc_note" value="" />
        </strong></td>
      </tr>
    </table></td>
...
$sql='select a.id, m.tax, a.item_id, d.group_name, b.finish_goods_code, b.item_name, b.unit_name,a.qty,a.rate, a.amount from purchase_master m, purchase_receive a,item_info b, item_sub_group c, item_group d where m.po_no=a.po_no and b.sub_group_id=c.sub_group_id and c.group_id=d.group_id and b.item_id=a.item_id and a.pr_no='.$$unique;
...
<table width="90%" border="0" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <tbody>
		  ...
		  <tr >
		    <td colspan="6"><div align="right"><strong>VAT (<? echo  number_format($vat,1); ?> %) : </strong></div></td>
		    <td align="center"><strong><? echo  number_format($vat_amt=($sub_total*$vat)/100,2); ?></strong></td>
		    </tr>
		  <tr >
		    <td colspan="6"><div align="right"><strong>Payable Amount: </strong></div></td>
		    <td align="center"><strong><? echo  number_format($payable_amt=($sub_total+$vat_amt),2); ?></strong></td>
		    </tr>
      </tbody>
      </table>
...
<input name="confirm" type="submit" class="btn1" value="BILL CREATE" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" /></td>
