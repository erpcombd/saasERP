...
$title='PO Wise Vendor Statement';
...
.custom-combobox-input{
    ...
    <div class="form-container_large">
        ...
        <form id="form1" name="form1" method="post" action="master_report.php">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
                        <div class="form-group row m-0">
                            ...
                            <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
                                <select name="vendor_ledger" id="vendor_ledger" required>
                                    <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$_REQUEST['vendor_ledger'],"ledger_group_id=223001");?>
                                </select>
		    ...
		    Period :                                       </td>
                                        ...
                                        <td width="26%" align="left">
                                          <!--<input name="fdate" type="text" id="fdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['fdate'];?>" />-->
                                            <input style="width:250px;"  name="fdate" type="text" id="fdate" value="<?=$_REQUEST['fdate'];?>" required />
									    ...
									    <td width="47%" align="left">
                                              ...
                                              <input name="tdate" type="text" id="tdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['tdate'];?>" required/>
                                        </td>
                                      </tr>
									  ...
									  <tr>
                                       ...
                                       <tr>
                                         ...
                                         <td colspan="2" align="left">
										   ...
										   <? foreign_relation('ledger_group','group_id','group_name',$_REQUEST['group_id'],"group_id=30211");?>
                                           </select>
