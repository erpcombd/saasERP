...
<!--						<div class="form-group row m-0 pb-1">
						...
						<div class="form-group row m-0 pb-1">
								   <? $field='moisture';?>
                            <label for="<?=$field?>"  class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Moisture :</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                    ...
                    <div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
                          ...
                          <? $quotation=find_a_field('purchase_master','quotation_no','po_no="'.$$unique.'"');
						   ...
						   ?>
								<!--<a href="<?=$att?>" target="_blank" >View Attachment<?=$quotation?></a>-->
								<a href="../../../assets/support/upload_view.php?name=<?=$att?>&folder=quotation&proj_id=<?=$_SESSION['proj_id']?>&mod=<?=$module_name?>" target="_blank">View Attachment</a>
    ...
    <form action="" method="post" name="cloud" id="cloud">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<?
					$res='select a.id, b.finish_goods_code as item_code, concat(b.item_name) as item_name,b.unit_name as unit,a.qty as total_unit, a.amount,"x" from purchase_invoice a,item_info b where b.item_id=a.item_id and a.po_no='.$po_no;
...
<label for="<?=$field?>" style="text-align:left">AIT (%):</label>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
	  ...
	  <td><input type="button" class="btn btn-primary" value="CLOSE" style="width:240px; font-weight:bold; font-size:12px;color:white; height:30px" onclick="window.location.href='select_unapproved_po.php'" /></td>
