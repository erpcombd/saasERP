...
<!--  <script src="//cdn.ckeditor.com/4.14.1/standard/ckeditor.js"></script>
			<div class="row pt-3">
				<div class="col-md-12">
							<textarea name="terms_condition"  id="terms_condition"><? if($terms_condition != '') echo $terms_condition; else echo find_a_field('purchase_master','terms_condition','terms_condition !="" ');?></textarea>
				</div>
			</div>-->
