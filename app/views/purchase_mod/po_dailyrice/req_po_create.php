...
<div class="form-container_large">
    <form form action="" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
<!--        top form start hear-->
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                             <? if($vendor_id<1) { ?>
							 <input type="text" list="vendor_id_draft_list" name="vendor_id_draft_a" id="vendor_id_draft_a" required>
  ...
  ?>
                ...
                <tr>
				 ...
				 <input type="hidden" name="po_qty<?=$i?>" id="po_qty<?=$i?>" value="<?=$already_po_qty?>" /></td>
					...
					<td><input type="hidden" required name="details_id<?=$data->id?>"  value="<?  echo $data->id; ?>" />
				
				<input type="text" onkeyup="count_1(<?=$i?>);total_cal()" onblur="update_item(<?=$data->id?>)" required name="unit_price<?=$data->id?>" id="unit_price<?=$i?>" value="<?=$this_po->rate?>" /></td>
