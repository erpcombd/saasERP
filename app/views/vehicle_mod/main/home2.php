...
$sq2 = mysql_query($ssql2);
$result2 = mysql_fetch_object($sq2);
...
while($datas = mysql_fetch_assoc($all_query)){
	extract($datas);
	$dd['do_no'][] = $do_no;
	$dd['do_date'][] = $do_date;
...
$all_query2 = mysql_query($all_sql2);

while($datas2 = mysql_fetch_assoc($all_query2)){
	extract($datas2);
	$d['pos_id'][] = $pos_id;
	$d['pos_date'][] = $pos_date;
