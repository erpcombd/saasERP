...
?>
      ...
      <tr>
        ...
        <td align="right" valign="top"><?=($items->demo_price==0&&$dealer->dealer_type='SuperShop')?number_format($items->t_price*$fit_size,0):number_format($items->demo_price*$fit_size,0);?></td>
        ...
        <td align="right" valign="top"><? $tttt=($items->demo_price==0&&$dealer->dealer_type='SuperShop')?(($items->t_price*$fit_size)*$item_ex[$i]):(($items->demo_price*$fit_size)*$item_ex[$i]);
echo  number_format($tttt,2); $ttttt = $ttttt + $tttt;
?></td>

        <td align="right" valign="top"><? $discount = ($items->t_price-$unit_price[$i])* $item_ex[$i]; echo  number_format($discount,2); $tdiscount = $tdiscount + $discount;?></td>
