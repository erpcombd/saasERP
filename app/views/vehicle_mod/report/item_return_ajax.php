...
if($v_type=='Corporate')
{ $rate = find_a_field('sales_corporate_price','set_price','item_id="'.$item_all->item_id.'" and dealer_code="'.$vendor.'"');}else $rate = $item_all->d_price;
?>
...
<input name="rate" type="text" class="input3" id="rate"  maxlength="100" style="width:50px;" onchange="count()" value="<?=$rate?>"    required/>