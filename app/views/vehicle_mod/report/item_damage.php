...
<? 
$res='select a.id,b.finish_goods_code as code,b.item_name,d.damage_cause,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from warehouse_damage_receive_detail a,item_info b,damage_cause d where a.receive_type=d.id and b.item_id=a.item_id and a.or_no='.$or_no;
