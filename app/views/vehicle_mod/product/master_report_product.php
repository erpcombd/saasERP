...
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="9"><div class="header"><h1>ZISAN FOOD AND BEVERAGE LIMITED</h1><h2><?=$report?></h2>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="10"><div class="header"><h1>ZISAN FOOD AND BEVERAGE LIMITED</h1><h2><?=$report?></h2>
<h2>Closing Stock of Date-<?=$to_date?></h2></div><div class="left"></div><div class="right"></div><div class="date">Reporting Time: <?=date("h:i A d-m-Y")?></div></td></tr><tr>
<th rowspan="2">S/L</th>
...
?>
	...
	<table width="100%" border="0" cellpadding="2" cellspacing="0">
		...
		<tr><td style="border:0px;" colspan="10"><div class="header"><h1><?php echo $str ?></h1><h2><?=$report?></h2>
</div><div class="left"></div></td></tr>
...
if(isset($warehouse_id)) 	{$warehouse_id_con=' and w.warehouse_id='.$warehouse_id;}



  $res='
select w.warehouse_name, i.item_id, i.finish_goods_code as FG_COde, i.item_name,i.sale_price, i.unit_name from warehouse w,item_info i where 1  '.$item_con.' order by i.finish_goods_code';
...
elseif($_POST['report']==71) 
{
		...
		$query =mysql_query($sql);  
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0"><thead><tr><td style="border:0px;" colspan="12"><div class="header"><h1>ZISAN FOOD AND BEVERAGE LIMITED</h1><h2>Warehouse Present Stock</h2></div><div class="left"></div><div class="right"></div><div class="date">Reporting Time: <?=date("h:i A d-m-Y")?></div></td></tr><tr>
<th>S/L</th>
<th>FG Code </th>
<th>Brand</th>
<th>Group</th>
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <thead><tr><td style="border:0px;" colspan="31"><div class="header"><h1>ZISAN FOOD AND BEVERAGE LIMITED</h1>
...
?>
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  <thead><tr><td style="border:0px;" colspan="35"><div class="header"><h1>ZISAN FOOD AND BEVERAGE LIMITED</h1>
