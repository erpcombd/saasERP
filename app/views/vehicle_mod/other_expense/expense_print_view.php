...
$datas=find_all_field('office_expense','s','expense_no='.$expense_no);

$sql1=" select d.*,m.* from office_expense_detail d, office_expense m where d.expense_no=m.expense_no and m.expense_no=".$expense_no;
...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center" style="border-collapse:collapse;">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td style="text-align:center; color:white; font-size:18px; font-weight:bold;"><span class="style1" >Office Expense Claim</span></td>
      </tr>
    </table></td>
              </tr>
            </table></td>
	    ...
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			<td width="30%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			 <tr>
		          <td width="20%" align="left" valign="middle">Date. </td>
				  <td>:</td>
		          <td width="80%"><?php echo date('d-M-y',strtotime($datas->expense_date));?></td>
		        </tr>
...
?>
      ...
      <tr style="line-height:20px;">
		...
		<td align="left" valign="top"><?=$items[$i]?></td>
  ...
  <tr>
	...
	<tr>
        ...
        <tr>
          ...
          <td width="23%"> <div align="center">Calculation </div></td>

		  <td width="23%"><div align="center">Released By</div></td>
