...
$table_detail='office_expense_detail';
$unique_detail='id';

$table_chalan='office_expense_detail';
$unique_chalan='id';
...
$target_url = '../other_expense/expense_print_view.php';
...
$res="select c.*,m.* from office_expense_detail c, office_expense m where m.expense_no=c.expense_no ".$con." group by c.expense_no";
