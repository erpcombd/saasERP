...
$res='select a.id,b.item_name,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from sales_return_details a,item_info b where b.item_id=a.item_id and a.or_no='.$or_no;
...
<form action="select_uncheck_return.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
