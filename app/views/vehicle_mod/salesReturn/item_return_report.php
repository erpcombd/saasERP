	  ...
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            ...
            <tr>
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;"><?php echo find_a_field('user_group','group_name','id=2')?></td>
      </tr>
	  	  <tr>
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;"><?php echo find_a_field('user_group','address','id=2')?></td>
      </tr>
