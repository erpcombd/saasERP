...
<table width="701" border="0" cellspacing="0" cellpadding="0" align="center" id="section-to-print">
  ...
  <tr>
    ...
    <td align="left"><strong style="font-size:24px">
				...
				<img src="../../../logo/<?=$group_for?>.png" style="width:250px;" />
				<br /></strong>    </td>
  </tr>
    </table>	</td>
...
?>
  ...
  <tr>
    ...
    <td>
		<table width="100%" border="1">
			...
			<tr>
				<td width="50%"><div align="right"><strong>VAT (<?= $all->vat_percent; ?>%): </strong></div></td>
  ...
  <tr>
    ...
    <td>  <?=find_a_field('user_activity_management','fname','user_id='.$all->entry_by)?> <br  />
		  <?=$all->entry_at?></td>
    <td>&nbsp;</td>
    <td>
	<? if ($all->checked_by>0) {?>
