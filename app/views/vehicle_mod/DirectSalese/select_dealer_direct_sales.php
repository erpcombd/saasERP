...
$title='Select Dealer for Direct Sales Order';
...
<form action="item_direct_sales.php" method="post" name="codz" id="codz">
...
<?
$query = "select b.dealer_code,b.dealer_name_e from dealer_info b where   b.depot=".$_SESSION['user']['depot']."  order by b.dealer_code";
?>
<input name="dealer" type="text" id="dealer" />
    </strong></td>
    <td bgcolor="#FF9966"><strong>
      <input type="submit" name="submitit" id="submitit" value="Submit" style="width:170px; font-weight:bold; font-size:12px; height:30px; color:#090"/>
    </strong></td>
  </tr>
</table>
