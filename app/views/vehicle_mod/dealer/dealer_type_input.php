...
{
    $deal_type=$_POST['dealer_type'];
$up_sql="update dealer_type set dealer_type='".$deal_type."' where id='".$_GET['id']."'";
...
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=1,width=800,height=800,left = 383,top = -16');");
    ...
    <div class="col-sm-10">
      <div class="md-form mt-0">
        <input name="dealer_type" class="form-control" type="text" id="dealer_type" tabindex="2" value="<?=$dealer_type?>">
      </div>
    </div>
  </div>
