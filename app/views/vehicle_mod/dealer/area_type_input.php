...
// ::::: Edit This Section ::::: 
$title='Area Type Information';			// Page Name and Page Title
$page="area_type.php";		// PHP File Name
$input_page="area_type_input.php";
$root='setup';
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Area Name :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="AREA_NAME" type="text" id="AREA_NAME" value="<?=$AREA_NAME?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Zone Name:</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <select name="ZONE_ID">
                    <? foreign_relation('zon','ZONE_CODE','ZONE_NAME',$ZONE_ID);?>
                  </select></td>
