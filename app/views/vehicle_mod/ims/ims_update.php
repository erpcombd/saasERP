...
if(isset($_POST['delete']))
{
		...
		$del_ims=mysql_query("delete from ims_details where ims_no=".$_POST[$unique_master]);
		$del_ims_m=mysql_query("delete from ims_master where ims_no=".$_POST[$unique_master]);
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<?php
	$ims_data=mysql_fetch_object(mysql_query("select * from ims_master where ims_no=".$_GET['v_no']));
	?>
