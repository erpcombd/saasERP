...
$title='Fuel Expense Checking..';

$page = "fuel_expense_checking.php";
...
<? 
$res='select a.id,b.expense_name,a.expense_no,a.expense_date,a.rate as unit_price,a.qty ,a.uom as unit_name,a.amount,a.vendor,a.att_file,"x" from fuel_expense_detail a,expense_head b where  b.id=a.item_id and a.expense_no='.$expense_no;
$qrry = db_query($res);
...
echo link_report_add_del_auto($res,'',4,6);
      ...
      <tr bgcolor="#215470" style="color:#FFFFFF;">
        <th><div align="center">Form No</div></th>
		<th><div align="center">Expense Date</div></th>
	  ...
	  <tr>
		...
		<td style="padding:5px;"><?='Purchased '.$data->expense_name.' From '.$data->vendor?></td>
		<td style="padding:5px;"><?=$data->qty?></td>
		<td style="padding:5px;">101.58</td>
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <td align="center"><input name="return" type="submit" class="btn1" value="Return To User" style="width:270px; float:right; font-weight:bold; font-size:12px; height:30px; color:red;" /></td>
	   <td align="center">&nbsp;</td>
      <td align="center"><input name="confirmm" type="submit" class="btn1" value="Checked" style="width:270px; float:right; font-weight:bold; font-size:12px; height:30px; color:#090" /></td>
    </tr>
  </table>
