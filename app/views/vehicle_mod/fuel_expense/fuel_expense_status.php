...
$target_url = '../fuel_expense/fuel_expense_print_view.php';
...
$res="select c.*,m.* from fuel_expense_detail c, fuel_expense m where m.expense_no=c.expense_no ".$con." group by c.expense_no";
$query =db_query($res);
