...
auto_complete_from_db('expense_head','concat(expense_name,"#>",id)','concat(expense_name,"#>",id)','1','item_id');
...
<form action="fuel_expense.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}" enctype="multipart/form-data">
...
<form action="" method="post" name="codz2" id="codz2" autocomplete="off" enctype="multipart/form-data">
    ...
    <table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
      <tr>
        <td align="center" width="10%" bgcolor="#0099FF"><strong>Expense Head</strong></td>
        <td align="center" width="30%" bgcolor="#0099FF"><span style="font-weight: bold">Vendor</span></td>
        <td align="center" width="15%" bgcolor="#0099FF">Expense Date </td>
        <td align="center" width="15%" bgcolor="#0099FF">Vehicle </td>
		<td align="center" width="15%" bgcolor="#0099FF">Meter Reading </td>
        <td align="center" width="15%" bgcolor="#0099FF">Qty</td>
  ...
  <input  name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
			...
			<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:98%;" required />
        ...
        <!--<td align="center" bgcolor="#CCCCCC"><div align="center"><span id="pr">
	        ...
	        <tr>
            <td width="33%"><input name="uom" type="text" class="input3" id="uom"  maxlength="100" style="width:98%;" required/></td>
			...
			<td align="center" bgcolor="#CCCCCC"><input name="mileage" type="text" class="input3" id="mileage"  maxlength="100" style="width:98%;" /></td>            
...
//$res='select a.id,b.finish_goods_code as code,b.item_name,b.unit_name,FLOOR(a.total_unit/b.pack_size) as total_qty,a.total_unit%b.pack_size as pcs_qty,"X" from production_issue_detail a,item_info b where b.item_id=a.item_id and a.pi_no='.$$unique_master.' order by a.id';
 ...
 $res='select a.id,b.expense_name as item_name,a.rate as unit_price,a.vendor,a.qty ,a.uom as unit_name,a.amount,a.att_file,"x" from fuel_expense_detail a,expense_head b where  b.id=a.item_id and a.expense_no='.$expense_no;
