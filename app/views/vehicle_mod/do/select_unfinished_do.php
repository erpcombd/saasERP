...
and "'.date('Y-m-d').'"';}
  ...
  $res ='select a.do_no,a.entry_by,a.do_date,a.dealer_code,d.team_name,d.dealer_name_e
 
  from sale_do_master a,dealer_info d
  
  where a.dealer_code=d.dealer_code and a.status="MANUAL" '.$con.' group by a.do_no DESC';
...
<td class="text-center"><a href="do.php?old_do_no=<?=$data->do_no?>" target="_blank" >
<button class="btn btn-success btn-sm">Complete SO</button>
</a></td>
