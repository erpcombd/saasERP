...
<td bgcolor="#CCCCCC">
 ...
 <tr>
  ...
  <tr>
<td><input name="item2" type="text" class="input3" id="item2"  style="width:260px;margin-right: -50px;" required="required" tabindex="3" value="<?=$item_all->item_name?>" onfocus="focuson('dist_unit')"/></td>
...
<? 
$res='select a.id,b.finish_goods_code as code,b.item_name,a.in_stock, b.unit_name as unit,a.unit_price as price,a.dist_unit as qty ,a.dope_qty as sec_qty,a.total_amt,"X"
...
<table style="cursor:pointer" width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><div class="tabledesign2">
	     <span id="codzList">
        <? 
             echo link_report_add_del_auto($res,'',9);
		?>
         </span>
      </div></td>
