...
<?php /*?><?php */?>
  ...
  <td bgcolor="#CCCCCC">
    ...
    <tr>
      ...
      <td><input name="pkt_unit" type="hidden" value="0" readonly class="input3" id="pkt_unit" style="width:55px;" onkeyup="count()" required="required"  tabindex="4"/>
          <input name="pkt_unit" type="text" value="Pcs" readonly class="input3" id="pkt_unit" style="width:55px;" onkeyup="count()" required="required"  tabindex="4"/></td>
...
<form action="verify_so.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
