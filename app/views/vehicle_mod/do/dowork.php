...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
      ...
      <div>
        ...
        <div>
          ...
          <select  id="depot_id" name="depot_id" readonly="readonly">
            ...
            <option value="<?=find_a_field('warehouse','warehouse_id','warehouse_id='.$_SESSION['user']['depot'])?>">
    ...
    <td width="33%">
			...
			<fieldset style="height:225px;" >
			  ...
			  <div>
			    ...
			    <label style="width:162px;">Order Date : </label>
			...
			<div>
			    ...
			    <label style="width:162px;">Delivery Request Date : </label>

			    <input   name="delivery_req_date" type="date" id="delivery_req_date" value="<?=$delivery_req_date?>" />
		      </div>
            ...
            <div>
              <label style="width:162px;">Address: </label>
              <input name="delivery_address" type="text" id="delivery_address"  value="<? if($delivery_address!='') echo $delivery_address; else echo $dealer->address_e?>" />
			   ...
			   <div>
              <label style="width:162px;">PO No: </label>
    ...
    <td width="33%"><fieldset style="height:225px;" >
...
<td align="center" bgcolor="#0099FF" width="9%" ><strong>Dope Qty</strong></td>
...
<?php /*?><?php */?>
  ...
  <!--<td><input name="undel" type="hidden" class="input3" id="undel"  style="width:55px;" readonly  value="<?=($ordered_qty+$del_qty)?>"/></td>-->



  <td><input name="unit_price" type="hidden" class="input3" id="unit_price"  style="width:55px;" onchange="count()" value="<?=$item_all->d_price?>" />
  ...
  <td bgcolor="#CCCCCC"><table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
	 ...
	 <?php /*?> <input name="pkt_unit" type="text" value="<?=$item_all->unit_name?>" readonly class="input3" id="pkt_unit" style="width:55px;" onkeyup="count()" required="required"  tabindex="4"/></td><?php */?>
...
$res='select a.id,b.finish_goods_code as code,b.item_name,a.carton_qty,a.dope_qty, a.unit_price as price,a.dist_unit as qty ,a.total_amt,"X" from sale_do_details a,item_info b where b.item_id=a.item_id and a.do_no='.$$unique_master.' order by a.id';
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td><div class="tabledesign2">
	     <span id="codzList">
        <? 
             echo link_report_add_del_auto($res,'',8);
		?>
         </span>
      </div></td>
