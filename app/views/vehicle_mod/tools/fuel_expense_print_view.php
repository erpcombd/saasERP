...
$datas=find_all_field('tool_maintenance','s','expense_no='.$expense_no);

 $sql1=" select d.*,m.*, i.driver_name as item_name,d.expense_date as claim_date from tool_maintenance_detail d, tool_maintenance m, tools i where i.driver_id=d.item_id and d.expense_no=m.expense_no and m.expense_no=".$expense_no;
$data1=db_query($sql1);
