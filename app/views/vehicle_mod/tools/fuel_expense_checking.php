...
<? 
$res='select a.id,b.expense_name,a.expense_no,a.expense_date,a.rate as unit_price,a.qty,a.rate,a.uom as unit_name,a.amount,a.vendor,a.att_file,"x" from tool_maintenance_detail a,expense_head b where  b.id=a.item_id and a.expense_no='.$expense_no;
