...
$target_url = '../tools/tools_entry.php';
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td style="width:107px;" width="1" bgcolor="#FF9966"><strong>
...
//where m.status in ('PROCESSING') and d.area_code=a.AREA_CODE  and m.dealer_code=d.dealer_code ".$con." and d.dealer_type='Distributor' order by m.do_date,d.dealer_name_e";
 ...
 $res="select c.* from tool_maintenance_detail c where c.status='MANUAL' ".$con." group by expense_no";
$query = db_query($res);
