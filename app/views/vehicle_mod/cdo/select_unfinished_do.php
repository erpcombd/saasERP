...
<table width="70%" border="0" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><strong>
	  ...
	  <?
$query ="select a.do_no,a.dealer_code,d.product_group,d.dealer_name_e from sale_do_master a,dealer_info d where d.dealer_code=a.dealer_code and d.dealer_type='Corporate' and a.status='MANUAL' and do_date='".date('Y-m-d')."' and a.entry_by=".$_SESSION['user']['id'];
?>
