	...
	<form id="form1" name="form1" method="post" action="?" onsubmit="return checking()">
				...
				<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7  p-0 pr-2">
					...
					<div class="container-fluid p-0 drophere">
						<div class="col-12 shadow1 pb-3 draghere">
							<div class="row add">
								<div class="col-9 new_left p-2"><p> select option</p></div>
					...
					<div class="col-12 shadow1 mt-3 draghere ">
						<div class="row add">
							<div class="col-9 new_left p-2"><p> Add Information</p></div>
							<div class="col-3 new_right p-2"><p>&nbsp;</p></div>
						</div>
		...
		<div class="container-fluid pt-4 p-0">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<!--Right form-->
				<div class="col-sm-5 col-md-5 col-lg-5 col-xl-5 drophere  p-0  pl-2">
