...
$table = 'vendor_message';    // Database Table Name Mainly related to this page
...
$crud      = new crud($table);
  ...
  if (isset($_POST['insert'])) {
	  ...
	  foreach($_POST['vendor_id']  as $key=> $value){
...
//      $_POST['entry_at'] =date('Y-m-d H:i:s');
 ...
 $sql='insert into vendor_message (vendor_id,message,start_date,end_date,entry_by,entry_at) values("'.$_POST['vendor_id'][$key].'","'.$_POST['message'].'","'.$_POST['start_date'].'","'.$_POST['end_date'].'","'. $_SESSION['user']['id'].'","'.date('Y-m-d H:i:s').'")';
...
<div class="container-fluid">
	...
	<div class="col-md-12">
            ...
            <form class="n-form" method="post" action="" autocomplete="off">
                ...
                <h4 align="center" class="n-form-titel1"> <?=$title?><?= $data?>  </h4>



                <div class="form-group row m-0 pl-3 pr-3">

                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Vendor</label>
                    ...
                    <div class="col-sm-9 p-0">
                        ...
                        <select name="vendor_id[]" required type="text" id="vendor_id[]" tabindex="1"  multiple class="chosen-select">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        ...
                        <textarea name="message"  type="text" id="message" tabindex="1" value="<?=$message?>" ></textarea>
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        ...
                        <input name="start_date" type="text" id="start_date" tabindex="2" value="<?=$start_date?>">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                       ...
                       <input name="end_date" type="text" id="end_date" tabindex="2" value="<?=$end_date?>">
          ...
          <tbody>
            ...
            while ($rp = mysqli_fetch_object($report)) {
              ...
              <tr<?= $cls ?> ">
                ...
                <td><?= find_a_field('vendor','vendor_name','vendor_id="'.$rp->vendor_id.'"'); ?></td>
