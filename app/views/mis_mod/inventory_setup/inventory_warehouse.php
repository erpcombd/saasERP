  ...
  <tr>
    ...
    <td valign="top"><div class="left">
		    ...
		    Warehouse Name : </td>
                               ...
                               <td width="60%" align="right"><input type="text" name="cus_name" id="cus_name" value="<?php echo $_REQUEST['cus_name']; ?>" / class="form-control"></td>
                                      ...
                                      <tr>
                                        ...
                                        <td align="right"><input name="cus_company" type="text" id="cus_company" value="<?php echo $_REQUEST['cus_company']; ?>" size="20" / class=                                   "form-control"></td>
	...
	<div class="rights">  <form action="?warehouse_id=<?php echo $warehouse_id;?>" method="post" enctype="multipart/form-data" name="form2" id="form2" onsubmit="return check()">
              ...
              <td><input name="warehouse_name" type="text" id="warehouse_name" value="<?php echo $data[1];?>" size="30" maxlength="100"  / class="form-control"></td>
									  </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><select name="group_for" id="group_for" class="form-control">
                                          <option></option>
...
<option <? if($datas->id==$data[12]) echo 'Selected ';?> value="<?=$datas->id?>"><?=$datas->group_name?></option>
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="warehouse_company" type="text" id="warehouse_company" value="<?php echo $data[2];?>" size="30" maxlength="100"  / class="form-control"></td>
									  </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><textarea name="address" cols="30" id="address" class="form-control"><?php echo $data[3];?></textarea></td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="contact" type="text" id="contact" size="15" maxlength="15" value="<?php echo $data[5];?>" class="form-control" /></td>
                                      </tr>

                                      <tr>
                                        <td>Able to:</td>
                                        <td><select name="warehouse_type" class="form-control">
                                      ...
                                      <tr>
                                        ...
                                        <td><select name="use_type" class="form-control">
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="ap_name" type="text" id="ap_name" value="<?php echo $data[8];?>" size="30" maxlength="100" class="form-control" /></td>
                                      </tr>
                                      <tr>
                                        <td>Authorise P Designation:</td>
                                        <td><input name="ap_designation" type="text" id="ap_designation" value="<?php echo $data[9];?>" size="30" maxlength="100" class="form-control" /></td>
                                      </tr>
                                      <tr>
                                      ...
                                      <tr>
                                        <td>Ledger ID:</td>
                                        <td><input name="ledger_id" type="text" id="ledger_id" value="<?php echo $data[10];?>" size="30" maxlength="100" class="form-control" /></td>
                                      </tr>
                                      <tr>
                                        <td>Sales Return Ledger  ID:</td>
                                        <td><input name="return_ledger_id" type="text" id="return_ledger_id" value="<?php echo $data[15];?>" size="30" maxlength="100" class="form-control" /></td>
                                      </tr>
                                    </table>
                                ...
                                <tr>
								  ...
								  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tr>
                                      ...
                                      <td><input name="nwarehouse" type="submit" id="nwarehouse" value="Record" class="btn btn-primary"/></td>

                                      <td><input name="mwarehouse" type="submit" id="mwarehouse" value="Modify" class="btn btn-success"/></td>

                                      <td><input name="Button" type="button" class="btn btn-warning" value="Clear" onClick="parent.location='inventory_warehouse.php'"/></td>
