...
if(isset($_POST['insert'])){
    ...
    //if(){
        ...
        if ($newID) {
            echo "<script>location.href='success_page.php?ticket=".$newID."';</script>"; 
            exit;
        }

        if (!$newID) {
            die("Failed to insert data into the database. Please check your database connection and query.");
        }
