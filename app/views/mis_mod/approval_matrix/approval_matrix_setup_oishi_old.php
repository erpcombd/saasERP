...
<?php ?><table border="0">
  ...
  <tr>
    ...
    <td class="w-75" style="vertical-align: top;" ><div class="left">
...
<tr>
  ...
  <th style="background-color:#45777B"><span class="style3">Logo</span></th>
  <th style="background-color:#45777B"><span class="style3">Company Name </span></th>
  </tr>
</thead>
...
<? //}?>
    ...
    <td ><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
							  ...
							  <tr>
                                  ...
                                  <td colspan="2"><div class="box style2" style="width:400px;">
                                ...
                                <tr>
                                  ...
                                  <td colspan="2"><div class="box" style="width:400px;">
