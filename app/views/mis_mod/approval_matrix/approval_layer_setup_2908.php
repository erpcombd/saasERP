        ...
        <div class="col-sm-5 p-0  pl-2">
            ...
            <form id="form1" name="form1" class="n-form setup-fixed" method="post" action="" enctype="multipart/form-data">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <input name="layer_name"  type="text" id="layer_name" value="<?=$level_name?>" >
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        <input name="layer_level"  type="text" id="layer_level"  value="<?=$layer_level?>" >
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        <input name="signatory_tittle"  type="text" id="signatory_tittle" value="<?=$signatory_tittle?>" >
