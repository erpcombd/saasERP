...
$td='select a.'.$unique.',d.dealer_name_e,  a.'.$shown.',  a.start_date, a.end_date from '.$table.' a,dealer_info d	where a.dealer_code=d.dealer_code  '.$con.' order by a.id  ';					
      ...
      <div class="col-sm-5">
		<form action="" method="post" class="n-form" name="form1" id="form1" >
          ...
          <div class="form-group row m-0 pl-3 pr-3">
            ...
            <div class="col-sm-9 p-0">
                ...
                <input name="dealer_code" list="did" required type="text" id="dealer_code" tabindex="1" <?=($dealer_code!='') ?  'value="'.$dcode.'"': ''?> autocomplete="off">	
				<datalist id="did">
