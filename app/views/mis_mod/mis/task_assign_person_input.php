...
// ::::: Start Edit Section ::::: 
$title='Task Assign Person';			// Page Name and Page Title
$page="task_assign_person.php";			// PHP File Name
$input_page="task_assign_person_input.php";
$root='mis';

$table='mis_assign_person';					// Database Table Name Mainly related to this page
$unique='id';						// Primary Key of this Database table
$shown='person_name';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Person Name </td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="person_name" type="text" id="token_no" value="<?=$person_name?>" /></td>
