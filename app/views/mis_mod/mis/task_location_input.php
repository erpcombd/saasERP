...
// ::::: Start Edit Section ::::: 
$title='Location Information';			// Page Name and Page Title
$page="task_location.php";			// PHP File Name
$input_page="task_location_input.php";
$root='mis';

$table='mis_location_info';					// Database Table Name Mainly related to this page
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Location</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="location_name" type="text" id="location_name" value="<?=$location_name?>" /></td>
