            ...
            <td width="552" class="oe_form_group_cell"><table width="757" height="66" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#fff" class="oe_form_group_cell oe_form_group_cell_label">
				 <input name="attached_file" type="file" id="attached_file" value="upload" style="height:auto; width:213px">
				  </td>
				  </tr>
