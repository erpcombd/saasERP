...
// ::::: Start Edit Section ::::: 
$title=' Task Type';			// Page Name and Page Title
$page="task_type.php";			// PHP File Name
$input_page="task_type_input.php";
$root='mis';

$table='mis_task_type';					// Database Table Name Mainly related to this page
$unique='id';						// Primary Key of this Database table
$shown='task_type';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Task Type </td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="task_type" type="text" id="location" value="<?=$task_type?>" /></td>
