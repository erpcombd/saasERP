...
$unique='item_id';
$input_page="item_info_input.php"; $add_button_bar = 'Mhafuz';
...
function DoNav(theUrl){ document.location.href = '<?=$input_page?>?<?=$unique?>='+theUrl;
  ...
  <tr>
    <td style="vertical-align: top"><div class="left">
        <table class="w-100" border="0">
            <th></th>
          <tr>
            <td><?php ?><div class="box">
                <form id="form1" name="form1" method="post" action="">
                  <table class="w-100" border="0">
                      <th></th>
                    <tr>
                      <td> Group: </td>
                      <td><select name="item_group" id="item_group">
                          <option></option>
                          <?php
...
?>
                    ...
                    <tr>
                      <td > Sub Group: </td>
                      <td ><select name="src_sub_group_id" id="src_sub_group_id">
                          <option></option>
                          <?php
...
?>
                    ...
                    <tr>
                      <td >Item Name: </td>
                      <td ><input name="src_item_id" type="text" id="src_item_id" value="<?php echo $_SESSION['src_item_id']; ?>" size="20" /></td>
                    </tr>
                    <tr>
                      <td >Finish Goods Code: </td>
                      <td ><input name="fg_code" type="text" id="fg_code" value="<?php echo $_SESSION['fg_code']; ?>" size="20" /></td>
                    </tr>
                    <tr>
...
$td="select a.item_id,a.item_name,a.sub_group_id, a.item_description FROM item_info a";
...
while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
      ...
      </div></td>    <?php ?><td style="width:30%; padding-left:8px">
	<div class="rights">
