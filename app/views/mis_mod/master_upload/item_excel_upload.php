...
require_once 'csv_object_item_info.php';

$title = "Item Information Excel Upload";
$excel_file_format = "item_information_format.csv";
$page = "item_excel_upload.php";
...
if (isset($_POST['upload']) && isset($_FILES['csv_file']['tmp_name'])) {
    ...
    if ($_FILES['csv_file']['size'] > 0) {
        $importer = new TorCsvImporterItemInfo($file, 'item_info');

        $importer->setMappings([
            [
                'column' => 'sub_group_id',
                'source_column' => 'sub_group_name',
                'table' => 'item_sub_group',
                'id_field' => 'sub_group_id',
                'name_field' => 'sub_group_name'
            ]
 ...
 <div class="container mt-5">
  ...
  <div class="card shadow">
    <div class="card-header bg-primary text-white">
      <h4 class="mb-0">Upload CSV to Import Item Information</h4>
    </div>
    <div class="card-body">
