...
$title = "General Ledger Excel Upload";
$excel_file_format = "general_ledger_format.csv";
$page = "sub_ledger_excel_upload.php";
...
if (isset($_POST['upload']) && isset($_FILES['csv_file']['tmp_name'])) {
    ...
    if ($_FILES['csv_file']['size'] > 0) {
        $importer = new TorCsvImporter($file, 'general_sub_ledger');
...
<div class="container mt-5">
    ...
    <div class="card shadow">
        <div class="card-header bg-primary text-white">
            <h4 class="mb-0">Upload CSV to Import Sub Ledger</h4>
        </div>
        <div class="card-body">
