...
$title='Item Delivery';			// Page Name and Page Title
$page="item_delivery.php";		// PHP File Name
$input_page="item_delivery_input.php";

if($_GET['cat_id']>0)
{		// Page Name and Page Title
$cat_id=$_GET['cat_id'];
$title=find_a_field('inv_item_category','category_name','id='.$cat_id).' Item Delivery';
$page="item_delivery.php?cat_id=".$cat_id;		// PHP File Name
$input_page="item_delivery_input.php?cat_id=".$cat_id;
}
$root='inventory';

$table='inv_item_delivery';		// Database Table Name Mainly related to this page
...
<body>
       ...
       <form action="" method="post"> <div class="ui-dialog ui-widget ui-widget-content ui-corner-all oe_act_window ui-draggable ui-resizable openerp" style="outline: 0px none; z-index: 1002; position: absolute; height: auto; width: 900px; display: block; /* [disabled]left: 217.5px; */" tabindex="-1" role="dialog" aria-labelledby="ui-id-19">
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
                ...
                <tr class="oe_form_group_row">
                  <td width="40%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">DO No:</td>
                  <td width="60%" colspan="1" class="oe_form_group_cell"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                    <input name="do_no" type="text" id="do_no" value="<?=$do_no?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Delivery Point:</td>
                  <td colspan="1" class="oe_form_group_cell"><select name="customer_id" id="customer_id">
      <? foreign_relation('inv_customer','id','customer_name',$customer_id);?>
    </select>&nbsp;</td>
                </tr>
                <tr class="oe_form_group_row">
	  ...
	  ?>
                      ...
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Delivery Date:</td>
