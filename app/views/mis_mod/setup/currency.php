...
$title='Currency Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="currency.php";		// PHP File Name



$table='currency_type';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='currency_type';				// For a New or Edit Data a must have data field
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-sm-7 p-0 pr-2">
			...
			<h4 align="center" class="n-form-titel1">Search Currency</h4>


                   
					<div class="form-group row m-0 pl-3 pr-3">
                        <label for="group_for" class="col-sm-3 pl-0 pr-0 col-form-label">Currency</label>
                        <div class="col-sm-9 p-0">
                             <select name="scurrency" required id="scurrency" tabindex="7">
                                  <option></option>
                     			 <? foreign_relation('currency_type','id','currency_type',$_POST['scurrency'],'1')?>
                   			 </select>
               ...
               <table  id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					<thead>
						<tr>
							...
							<th><span>Currency Type </span></th>
							
							<th><span>Sign</span></th>
							
							<th><span>Conversation Rate</span></th>
					...
					if($_POST['scurrency']>0)
					
					$con .=' and id="'.$_POST['scurrency'].'"';
					
					
					
					
					
					 $td='select * from currency_type where 1 '.$con.'';
					...
					<td><?=$rp->currency_type?></td>
					
					<td><?=$rp->icon;?></td>
					<td><?=$rp->conversation_rate;?></td>
        ...
        <div class="col-sm-5  p-0  pl-2">
            ...
            <form class="n-form  setup-fixed" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label  req-input">Currency Type</label>
                    <div class="col-sm-9 p-0">
                       <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       	
                        <input type="text" name="currency_type" required id="currency_type" value="<?=$currency_type?>" tabindex="1">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Sign: </label>
                    <div class="col-sm-9 p-0">
                       
                       <input type="text" name="icon" id="icon" value="<?=$icon?>" tabindex="1">

                    </div>
                </div>
				
				<div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Conversation Rate: </label>
                    <div class="col-sm-9 p-0">
                       
                       <input type="text" name="conversation_rate" id="conversation_rate" value="<?=$conversation_rate?>" tabindex="1">
