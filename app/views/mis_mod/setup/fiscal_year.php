...
$page="fiscal_year.php";		// PHP File Name



$table='fiscal_year';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='fiscal_year';				// For a New or Edit Data a must have data field
...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-sm-7 p-0 pr-2">
			...
			<h4 align="center" class="n-form-titel1">Search Fiscal Year</h4>
            ...
            <div class="container n-form1">
               <table  id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$con .=' and id="'.$_POST['sitem'].'"';
					 ...
					 $td='select * from fiscal_year where 1 '.$con.'';
        ...
        <div class="col-sm-5  p-0  pl-2">
            ...
            <form class="n-form  setup-fixed" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label  req-input">Fiscal Year</label>
                    <div class="col-sm-9 p-0">
                       <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       	
                        <input type="text" name="fiscal_year" required id="fiscal_year" value="<?=$fiscal_year?>" tabindex="1">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                       ...
                       <input type="date" name="end_date" id="end_date" value="<?=$end_date?>" tabindex="1">
