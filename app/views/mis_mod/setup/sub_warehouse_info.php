...
$title='Sub Warehouse Information';			// Page Name and Page Title

do_datatable('table_head');

$page="sub_warehouse_info.php";		// PHP File Name
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.' as warehouse_name,  a.address, a.status from '.$table.' a, user_group u where a.group_for=u.id and a.group_for="'.$_SESSION['user']['group'].'"  and a.use_type="SD" '.$con.' order by a.warehouse_id';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Warehouse Name:</td>
                        				...
                        				<input name="warehouse_name" required type="text" id="warehouse_name" tabindex="1" value="<?=$warehouse_name?>"  style="width:250px;" >	
										 <input name="use_type" type="hidden" id="use_type" value="SD" size="30" maxlength="100" class="required" />
