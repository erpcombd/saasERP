            ...
            <div class="col-sm-6">
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        <select name="group_for" id="group_for" tabindex="2" style="width:220px;" >
                            <option></option>
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        <input type="text" name="f_date" id="f_date" class="from-control" value="<?=($f_date) ? $f_date : date('Y-m-01')  ;?>">
                    </div>
                </div>
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        <input type="text" name="t_date" id="t_date" class="from-control" value="<?=($t_date) ? $t_date : date('Y-m-t')  ;?>">
                    </div>
                </div>
