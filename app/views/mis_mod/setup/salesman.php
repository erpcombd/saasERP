...
$title='Salesman Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="salesman.php";		// PHP File Name



$table='salesman';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='salesman';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Salesman </span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', u.group_name, a.warehouse_id, a.status from '.$table.' a, user_group u	where   a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.id  ';
...
<td><?= find_a_field('warehouse','warehouse_name',"warehouse_id=".$rp[3]);?></td>
<td><?=$rp[4];?></td>
</tr>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Salesman:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="salesman" required type="text" id="salesman" tabindex="1" value="<?=$salesman?>"  style="width:220px;" >	
                                     ...
                                     <td>Mobile No:</td>
                        				...
                        				<input name="mobile_no"  type="text" id="mobile_no" tabindex="1" value="<?=$mobile_no?>"  style="width:220px;" >	
                                     ...
                                     <td>Email:</td>
                        				...
                        				<input name="email"  type="text" id="email" tabindex="1" value="<?=$email?>"  style="width:220px;" >	
                                     ...
                                     <td>Address:</td>
                        				...
                        				<input name="address"  type="text" id="address" tabindex="1" value="<?=$address?>"  style="width:220px;" >	
									  ...
									  <tr>
										...
										<select name="warehouse_id" required id="warehouse_id"  tabindex="7" style="width:220px;">
									  ...
									  <tr>
										...
										<select name="status" required id="status"  tabindex="7" style="width:220px;">
										
										<option></option>
				

                    					  <? foreign_relation('activation','activation','activation',$status,'1');?>
                   						 </select></td>
                                      </tr>
