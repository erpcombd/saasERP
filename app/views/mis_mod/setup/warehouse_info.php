...
<div class="container-fluid p-0">
    <div class="row">
        <div class="col-sm-7 p-0 pr-2">
			...
			<h4 align="center" class="n-form-titel1">Search Warehouse Information</h4>
        ...
        <div class="col-sm-5 p-0  pl-2">
            ...
            <? if(!isset($_GET[$unique])){?>
              <h4 align="center" class="n-form-titel1">Create Warehouse Information</h4>
            <? }?>
            <? if(isset($_GET[$unique])){?>
              <h4 align="center" class="n-form-titel1">Update Warehouse Information</h4>
            <? }?>
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                       <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                        ...
                        <input name="warehouse_name" required type="text" id="warehouse_name" tabindex="1" value="<?=$warehouse_name?>" >	
						<input name="use_type" type="hidden" id="use_type" value="WH" class="required" />
										 
					    <input name="ledger_group" required type="hidden" id="ledger_group" tabindex="1" value="<?=$ledger_group?>">
										 
					    <input name="cash_ledger" required type="hidden" id="cash_ledger" tabindex="1" value="<?=$cash_ledger?>" >
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        <input name="description" type="text" id="description" tabindex="2" value="<?=$description?>">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Contact Name:  </label>
                    <div class="col-sm-9 p-0">

                        <input name="contact_persone" type="text" id="contact_persone" tabindex="2" value="<?=$contact_persone?>">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-9 p-0">
                        ...
                        <input name="contact_no" type="text" id="contact_no" tabindex="8" value="<?=$contact_no?>"/>
