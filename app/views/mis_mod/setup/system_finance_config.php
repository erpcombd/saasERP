...
$title = 'System Finance Config';      // Page Name and Page Title

do_datatable('table_head');

$page = "system_finance_config.php";    // PHP File Name



$table = 'system_finance_config';    // Database Table Name Mainly related to this page
