    ...
    <div class="row">
        ...
        <div class="container n-form1">
          ...
          <table id="table_head" class="table1  table-striped table-bordered table-hover table-sm">
            ...
            <tbody class="tbody1">
					...
					$td='select a.'.$unique.',  a.'.$shown.',  a.sl_no, a.status, a.type, a.category from '.$table.' a	where 1  '.$con.$group.' order by a.sl_no  ';					
					$report=db_query($td);					
      ...
      <div class="col-sm-5  p-0  pl-2">
		...
		<form action="" method="post" enctype="multipart/form-data" class="n-form  setup-fixed" name="form1" id="form1" onsubmit="return check()">
          ...
          <div class="form-group row m-0 pl-3 pr-3">
            <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Type of T&C: </label>
            <div class="col-sm-9 p-0">
			    <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                <input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
             	<input name="category" id="category" type="text"  tabindex="1" required  value="<?=$category?>" >
