...
$title='Customer Location';			// Page Name and Page Title

do_datatable('table_head');

$page="customer_area.php";		// PHP File Name
...
<th bgcolor="#45777B"><span class="style3">Customer Location </span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', u.group_name from '.$table.' a, user_group u	where   a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.AREA_CODE  ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Location:</td>
										...
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="AREA_CODE" type="hidden" id="AREA_CODE" tabindex="1" value="<?=$AREA_CODE?>" readonly>
                        				<input name="AREA_NAME" required type="text" id="AREA_NAME" tabindex="1" value="<?=$AREA_NAME?>"  style="width:220px;" >	
