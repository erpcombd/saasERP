...
$title='Company Settings';			// Page Name and Page Title
...
$crud->insert();
		...
		$folder = "../../../logo/";
		move_uploaded_file($file_temp, $folder.$id.'.png');}
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            ...
            <form id="form1" name="form1" class="n-form" method="post" action="">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input"> Company Name</label>
                    <div class="col-sm-9 p-0">
