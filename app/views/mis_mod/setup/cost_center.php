...
<th bgcolor="#45777B"><span class="style3">Cost Center </span></th>



<th bgcolor="#45777B"><span class="style3">Cost Category </span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', u.group_name, c.category_name from '.$table.' a, cost_category c, user_group u	where  a.category_id=c.id and  a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.id  ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Cost Center:</td>
									  ...
									  <tr>
										...
										<select name="category_id" required id="category_id"  tabindex="7" style="width:220px;">
