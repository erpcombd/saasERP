...
if($_GET['update']=='Update'){
	...
	$ssql='update production_planning_master set status="'.$_GET['req_status'].'" where req_no="'.$req_no.'"';
	db_query($ssql);
}

$sql="select * from production_planning_master where  req_no='$req_no'";
        	...
        	<tr>
                ...
                <td colspan="3" align="center">
                    ...
                    <h6><span align="center" style="border:1px solid #000000; padding:2px;width:180px;">
						...
						Production Planning Status</span>
...
<table style=" width:800px; margin:0px auto" class="" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
  ...
  <th rowspan="1" width="2%" style="text-align:center"><strong>SL.</strong></th>

<!--

        <td><strong>REQ-ID</strong></td>-->

		<th width="17%" rowspan="1" style="text-align:center" ><strong>Product Name</strong></th>
        <th width="10%" rowspan="1" style="text-align:center" ><strong> Unit</strong></th>
		<th width="7%" rowspan="1" style="text-align:center" ><strong> Production Qty</strong></th>
...
$sql2="select * from production_planning_details where  req_no='$req_no'";
...
?>
      ...
      <tr>
        ...
        <td align="center" valign="top"><?=number_format($qty,2,".",","); $total_qty+=$qty;?></td>
...
<? }?>
 ...
 <td align="center" valign="top"><strong><?=number_format($total_qty,2,".",",")?></strong></td>
 </tr>
