...
$table = 'production_planning_master';
...
<form action="" method="post" name="codz" id="codz">
      <div class="container-fluid bg-form-titel">
		...
		<select name="req_for" id="req_for">
			...
			<!--foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['req_for'],' use_type="PL"');-->
				<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['req_for'],'1');?>
		</select>
      ...
      <div class="container-fluid pt-5 p-0 tabledesign2">
			...
			$con .= ' and a.req_for = "'.$_POST['req_for'].'"  ';
			  ...
			  $res='select a.req_no,a.req_no,a.req_date,(select warehouse_name from warehouse where warehouse_id=a.req_for) as req_for, 
			  b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status
			 
			  from production_planning_master a,warehouse b,user_activity_management c 
			  
			  where  a.warehouse_id=b.warehouse_id  and a.entry_by=c.user_id '.$con.'  order by a.req_no asc';
