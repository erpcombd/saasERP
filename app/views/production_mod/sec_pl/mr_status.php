...
$target_url = '../sec_pl/mr_print_view.php';
...
<form action="" method="post" name="codz" id="codz">
      ...
      <div class="container-fluid pt-5 p-0 tabledesign2">
			...
			$con .= ' and a.req_for = "'.$_POST['req_for'].'"  ';
			  ...
			  from pl_issue_master a,warehouse b,user_activity_management c 

			  

			  where  a.warehouse_id=b.warehouse_id  and a.entry_by=c.user_id '.$con.' and a.status!="MANUAL"  order by a.manual_req_no asc';
