...
auto_complete_from_db('item_info i, item_sub_group s','i.item_name','concat(i.item_name,"#>",i.item_description,"#>",i.item_id)','1 and i.sub_group_id=s.sub_group_id and s.group_id like "%'.$get_data.'%"','item_id');
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <div>
      ...
      <?=foreign_relation('warehouse','warehouse_id','warehouse_name',$warehouse_to,'1 and use_type="WH" and warehouse_id="9" order by warehouse_name')?>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <input  name="warehouse_from" type="hidden" id="warehouse_from" value="<?=$warehouse_from?>"/>
      ...
      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:300px;" required="required" onblur="getData2('production_receive_ajax.php', 'pr', this.value, document.getElementById('warehouse_from').value);"/></td>
