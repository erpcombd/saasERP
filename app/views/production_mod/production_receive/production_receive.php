...

{
		...
		$_POST['unit_price']= $item->cost_price;
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="45%" rowspan="2" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>

    <td width="15%" rowspan="2" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Unit</span></td>

    <td width="14%" rowspan="2" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Stk</span></td>

    <td width="9%" rowspan="2" align="center" bgcolor="#0099FF" ><b>Remarks</b></td>
    <td width="9%" colspan="2" align="center" bgcolor="#0099FF"><strong> Qty</strong></td>

    <td width="8%"  rowspan="3" align="center" bgcolor="#FF0000"><div class="button">
  ...
  <tr>
    ...
    <input name="total_unit2" type="text" class="input3" id="total_unit2"  maxlength="100" style="width:40px;" required="required"/>

    <input name="total_unit3" type="text" class="input3" id="total_unit3"  maxlength="100" style="width:40px;" required="required"/>

    <input name="total_unit4" type="hidden" class="input3" id="total_unit4"  maxlength="100" style="width:60px;" required="required"/>

    <input name="total_unit5" type="hidden" class="input3" id="total_unit5"  maxlength="100" style="width:60px;" required="required"/>
	...
	<input name="total_ctn" type="text" class="input3" id="total_ctn"  maxlength="100" style="width:67px;" required="required"/>
	</td>
    <td align="center" bgcolor="#CCCCCC"><input name="total_pcs" type="text" class="input3" id="total_pcs"  maxlength="100" style="width:67px;" required="required"/></td>
  </tr>
</table>
...
$res='select a.id,b.item_id as item_code,b.item_name,b.unit_name,a.remarks,a.total_unit,"X" from production_floor_receive_detail a,item_info b where b.item_id=a.item_id and a.pr_no='.$$unique_master.' order by a.id';
