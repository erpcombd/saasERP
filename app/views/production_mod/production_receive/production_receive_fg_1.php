...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <input name="total_unit2" type="text" class="input3" id="total_unit2"  maxlength="100" style="width:60px;" required="required"/>
...
$res='select a.id,b.item_id as item_code,b.item_name,a.total_unit,CAST((a.total_unit/b.pack_size) as UNSIGNED) as pkt_qty,a.total_unit%b.pack_size as pcs_qty,"X" from production_floor_receive_detail a,item_info b where b.item_id=a.item_id and a.pr_no='.$$unique_master.' order by a.id';
?>
