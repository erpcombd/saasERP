...
if($row->total_unit >0){
	...
	journal_item_control($row->item_id ,$master->warehouse_to,$master->pi_date,$row->total_unit,'0','Issue',$row->id,$row->unit_price,$master->warehouse_from,$master->req_no);
...
window.onload = function() {document.getElementById("dealer").focus();}
	...
	<div class="form-container_large">
				...
				<div class="row">
					...
					<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Select Section:	</label>
							...
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0">
								...
								<select name="line_id" id="line_id">
									...
									<? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['line_id'],'use_type="SC"  order by warehouse_name');?>
		...
		$res='select p.pi_no,a.manual_req_no,p.req_no,w.warehouse_name as req_for,b.fname as entry_by ,a.entry_at,a.status
		...
		<tbody class="tbody1">
			...
			while($rs=mysqli_fetch_object($r)){
				...
				<tr>
					...
					<td><a href="../store_recieve/production_issue_check.php?req_no=<?=$rs->req_no?>&&old_pi_no=<?=$rs->pi_no?>"><span><strong>Show</strong></span></a></td>
