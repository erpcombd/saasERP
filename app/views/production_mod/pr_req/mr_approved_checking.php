      ...
      <tr>
        ...
        <td><fieldset>
          ...
          <div>
			...
			<input  name="<?=$field?>111" type="test" id="<?=$field?>111" value="<?=find_a_field('warehouse','warehouse_name','warehouse_id='.$$field)?>" readonly/>
          </div>
          <? $field='need_by';?>
          <div>
...
<table id="grp" width="100%" cellspacing="0" cellpadding="0"><tbody><tr><th>Item Name</th><th>Stock Qty</th><th>Exp Date</th><th>Remarks</th><th>Qty</th>
  <th>Edit</th>
  <th>Delete</th>
</tr>
