...
window.location = "process_loss_entry.php";
...
echo '<script> window.location.href = "process_loss_entry.php?new=2"; </script>';
...
window.location.href = "../mr/process_loss_entry.php?sub_group=" + id;
...
<form action="process_loss_entry.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
