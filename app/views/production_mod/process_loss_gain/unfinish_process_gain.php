...
and "'.date('Y-m-d').'"';}
  ...
  where m.warehouse_id=w.warehouse_id and m.status="MANUAL" and m.issue_type="PROCESS_GAIN" '.$con.' order by m.req_no desc';
          ...
          ?>
            <tr>
              ...
              <td class="text-center">
                <a href="process_gain_entry.php?old_req=<?=$data->req_no?>">
                  <input type="button" value="Complete Process Gain"  class="btn1 btn1-submit-input"/>
                </a>
              </td>
            </tr>
