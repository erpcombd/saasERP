...
$master= find_all_field('process_loss_gain_master','','req_no='.$do_no);
...
<div class="body">
	...
	<div class="row">
		...
		<div class="col-md-6 col-sm-6 col-lg-6 left">
			...
			<p class="left-text mt-1 mb-1">From Warehouse : <span><?=find_a_field('warehouse','warehouse_name','warehouse_id='.$master->warehouse_id);?> </span></p>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select d.*,i.item_name
   from process_loss_gain_details d, item_info i 
