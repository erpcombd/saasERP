  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
        <tr>
          ...
          <td width="247" style="background-color:#FF9966;"><input type="text" name="tdate" id="tdate" value="<?=$_POST['tdate']?>" style="width:150px; font-weight:bold; font-size:12px; height:30px; color:#090"/></td>
          <td width="340" rowspan="5" style="background-color:#FF9966;" align="center"><strong>
          <input type="submit" name="submitit" id="submitit" value="VIEW DETAIL" style="width:120px; font-weight:bold; font-size:12px; height:30px; color:#090"/>
          </strong></td>
        </tr>
        <tr>
          <td align="right" style="background-color:#FF9966;"><strong> REQ. No: </strong></td>
          <td colspan="3" style="background-color:#FF9966;">
		  <select name="req_no" id="req_no" style="width:200px;" >

        <option value=""></option>

		<? foreign_relation('purchase_rfq_master','req_no','view_req_no',$_POST['req_no'],'1 group by req_no');?>
...
<tr>
  <th width="9%"><strong>QUOTE</strong> No </th>
  <th width="12%"><strong>QUOTE</strong> Date </th>
  <th width="13%"><strong>RFQ</strong> No </th>
  <th width="11%"><strong>REQ</strong> No </th>
  <th width="32%">Vendor Name </th>
  <th width="23%">Entry By </th>
  </tr>
...
//		}
    ...
    $res="select  m.* from  purchase_quotation_master m, purchase_quotation_details d where m.invoice_no=d.invoice_no and  m.status!='MANUAL'  ".$con.$req_no_con." group by m.invoice_no order by m.invoice_date, m.invoice_no";
...
<td onClick="custom(<?=$data->invoice_no;?>);" <?=(++$z%2)?'':'class="alt"';?>><?=$data->view_rfq_no;?></td>
