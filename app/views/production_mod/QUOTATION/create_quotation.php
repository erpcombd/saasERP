...
{
	window.open('<?=$target_url?>?rfq_no='+theUrl);
}
...
<tr>
  <th width="14%"><strong>RFQ</strong> No </th>
  <th width="19%"><strong>RFQ</strong><strong> </strong>Date </th>
  <th width="23%">REQ. No </th>
...
$con .= ' and m.invoice_no in ('.$_POST['invoice_no'].') ';
 	...
 	if($_POST['req_no']!='')
	$req_no_con=" and m.invoice_no='".$_POST['req_no']."'";
