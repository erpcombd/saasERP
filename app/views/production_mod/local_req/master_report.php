...
if(isset($t_date)) 
		...
		if($_POST['sub_group_id']!=''){echo '<h1 style="text-align: center; font-size: 15px; height: 10px; font-weight: bold;"> Sub Group :'.find_a_field('item_sub_group','sub_group_name','1 and sub_group_id='.$_POST['sub_group_id'],$sub_group_name).'</h1>';};
...
$sub_group_con=' and s.sub_group_id='.$_POST['sub_group_id'];
}

if($_POST['warehouse_id']!='') {	
$s_con=' and a.req_for='.$_POST['warehouse_id'];
}
  $r='select a.req_no,a.req_no,a.req_date, b.qty, b.item_id, i.item_name,b.unit_name, g.group_name from  requisition_master_local a, requisition_order_local b, item_info i, item_sub_group s, item_group g where  a.req_no=b.req_no '.$con.$group_con.$s_con.$sub_group_con.' and b.item_id=i.item_id and i.sub_group_id=s.sub_group_id and a.status="CHECKED" and s.group_id=g.group_id group by g.group_name order by a.req_no asc';
...
<th width="5%">SL/NO</th>
	  ...
	  <th width="9%"><div align="center">Group Name</div></th>
	  <th width="9%"><div align="center">Sub Group Name</div></th>
	  <th width="8%"><div align="center">Remarks</div></th>

	</tr>
 <?

 $res='select b.id,b.item_id, a.req_no,a.req_no,a.req_date,sum(b.qty) as qty,s.sub_group_name, sum(b.purchase_qty) as purchase_qty,a.req_note, b.item_id, i.item_name,b.unit_name, g.group_name from  requisition_master_local a, requisition_order_local b, item_info i, item_sub_group s, item_group g where  a.req_no=b.req_no and a.status="CHECKED" and b.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and g.group_name="'.$s->group_name.'" '.$sub_group_con.$con.$s_con.' group by b.item_id  order by i.item_name asc';
...
$dcon .= ' and c.rec_date between "'.$_POST['f_date'].'" and "'.$_POST['t_date'].'"';
 ...
 $rec_qty=find_a_field('purchase_master_local a, purchase_invoice_local b, purchase_receive_local c, item_info i, item_sub_group s, item_group g','sum(c.qty)',' 1 '.$dcon.'  and a.po_no=b.po_no and b.id=c.order_no and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and b.item_id=i.item_id and b.item_id="'.$data->item_id.'" group by c.item_id');
  ?>
  <tr>
	<td valign="top"><div align="center"><?=++$sl?></div></td>
...
<th width="14%">SL/NO</th>
 ...
 $res = 'select a.req_no,a.req_date,i.item_name,w.warehouse_name,g.group_name,b.qty,b.remarks from requisition_master_local a,requisition_order_local b, item_info i, item_sub_group s, item_group g, warehouse w where w.warehouse_id=a.req_for and a.status="CHECKED" and a.req_no=b.req_no and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and b.item_id=i.item_id '.$item_con.$date_con.$con.$g_con.$w_con.' ';
...
$res = 'select a.req_no, a.po_no,a.po_date,c.rec_date,i.item_name,g.group_name,c.qty,c.remarks from   purchase_master_local a, purchase_invoice_local b,purchase_receive_local c, item_info i, item_sub_group s, item_group g where a.po_no=b.po_no and b.id=c.order_no and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and b.item_id=i.item_id '.$item_con.$date_con.$g_con.$w_con.' ';
