...
$rec_qty=find_a_field('purchase_invoice i','sum(i.qty)','i.req_no='.$data->id.'');
 ...
 <a href="master_report.php?report=300002&item_id=<?=$data->item_id?>&t_date=<?=$_POST['t_date']?>&f_date=<?=$_POST['f_date']?>&group_id=<?=$_POST['group_id']?>&warehouse_id=<?=$_POST['warehouse_id']?>" target="_blank"> <?=$data->qty;?> </a> 
		...
		<td valign="top">
		<div align="center">
		  <?=$due_qty=($data->qty-$data->purchase_qty);?> 
	    </div>		</td>
		<td valign="top">
		<div align="center">
		  <?=$data->unit_name;?> 
...
<? $tot = $tot+$data->qty;$tot_purchase_qty = $tot_purchase_qty+$data->purchase_qty;$tot_due_qty = ($tot_due_qty+$due_qty); ?>
...
<th width="4%">SL/NO</th>
	  ...
	  <th width="7%"><div align="center">Receive qty</div></th>

	  <th width="8%"><div align="center">Due qty</div></th>
...
echo $rec_qty=find_a_field('purchase_invoice i','sum(i.qty)',' i.req_id="'.$data->id.'"');
  ?>
  <tr>
	<td valign="top"><div align="center"><?=++$sl?></div></td>
  ...
  <? $toot = $toot+$data->qty; $tot_p_qty=$tot_p_qty+$data->purchase_qty;$tot_due_qty=$tot_due_qty+$due_qty; ?>
  <? } ?>
