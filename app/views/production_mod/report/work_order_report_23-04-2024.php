        ...
        <div class="row m-0 p-0">
            ...
            <div class="col-sm-6">
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report0-btn" value="111" checked="checked" tabindex="1">

                    <label class="form-check-label p-0" for="report0-btn">

                    Recipe And Deduction Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="12823" tabindex="1">

                    <label class="form-check-label p-0" for="report1-btn">

                    Warehouse  Transection Report(12823)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report2-btn" value="1008" tabindex="1">
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report3-btn" value="091119" tabindex="1">

                    <label class="form-check-label p-0" for="report3-btn">

                    Category Wise Stock Report Including Nill Balance
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report4-btn" value="09112019" tabindex="1">

                    <label class="form-check-label p-0" for="report4-btn">

                    Group & Warehouse wise Stock Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report5-btn" value="21082022" tabindex="1">

                    <label class="form-check-label p-0" for="report5-btn">

                    Warehouse  Purchase Pending  Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report6-btn" value="8" tabindex="1">

                    <label class="form-check-label p-0" for="report6-btn">

                    Warehouse Transection Report (Entry Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report7-btn" value="201916" tabindex="1">

                    <label class="form-check-label p-0" for="report7-btn">

                    Warehouse Present Stock Floor details
                    ...
                    <input name="report" type="radio" class="radio1" id="report8-btn" value="21092019" tabindex="1">

                    <label class="form-check-label p-0" for="report8-btn">

                    Warehouse Present Stock Floor
                    ...
                    <input name="report" type="radio" class="radio1" id="report9-btn" value="20181223" tabindex="1">

                    <label class="form-check-label p-0" for="report9-btn">

                    Warehouse Present Stock CWH
                    ...
                    <input name="report" type="radio" class="radio1" id="report10-btn" value="4" tabindex="1">

                    <label class="form-check-label p-0" for="report10-btn">

                    Warehouse Present Stock (Finish Goods)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report11-btn" value="2019" tabindex="1">

                    <label class="form-check-label p-0" for="report11-btn">

                    Floor Requisition History Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report12-btn" value="1004" tabindex="1">

                    <label class="form-check-label p-0" for="report12-btn">

                    RM Consumtion Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report13-btn" value="1005" tabindex="1">

                    <label class="form-check-label p-0" for="report13-btn">

                    FG Production Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report14-btn" value="1001" tabindex="1">

                    <label class="form-check-label p-0" for="report14-btn">
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report15-btn" value="1003" tabindex="1">

                    <label class="form-check-label p-0" for="report15-btn">
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report16-btn" value="1006"  tabindex="1">

                    <label class="form-check-label p-0" for="report16-btn">

                    Product Movement Detail Report (FG)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report17-btn" value="1007" tabindex="1">

                    <label class="form-check-label p-0" for="report17-btn">

                    Product Movement Summary Report (FG)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report18-btn" value="1011" tabindex="1">

                    <label class="form-check-label p-0" for="report18-btn">

                    Production Entry Form (Line Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report19-btn" value="10101" tabindex="1">

                    <label class="form-check-label p-0" for="report19-btn">

                    Closing Stock Report (Production Line Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report20-btn" value="10102" tabindex="1">

                    <label class="form-check-label p-0" for="report20-btn">

                    Closing Stock Report (Production Section Wise)
                ...
                <div align="left">Advance Report</div>
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report21-btn" value="1009" tabindex="1">

                    <label class="form-check-label p-0" for="report21-btn">

                    Product IN OUT Report (Line Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report22-btn" value="1010" tabindex="1">

                    <label class="form-check-label p-0" for="report22-btn">

                    Production Breif Report (Line Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report23-btn" value="1012" tabindex="1">

                    <label class="form-check-label p-0" for="report23-btn">

                    Consumption Report (Recipe Wise)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report24-btn" value="1013" tabindex="1">

                    <label class="form-check-label p-0" for="report24-btn">

                    Brief Consumption Report
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report25-btn" value="1014" tabindex="1">

                    <label class="form-check-label p-0" for="report25-btn">

                    Sales Terget Vs. Production Report(Brief)
                ...
                <div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report26-btn" value="1015" tabindex="1">

                    <label class="form-check-label p-0" for="report26-btn">

                    Sales Terget Vs. Production Report(ALL)
                    ...
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1005" tabindex="1">
            ...
            <div class="col-sm-6">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <input type="text" name="item_id" id="item_id" class="btn"style="width:250px" />
