...
$req_all=find_all_field('master_requisition_master','*','req_no="'.$_SESSION['req_no'].'"');
...
$center_stock= find_a_field('journal_item','sum(item_in-item_ex)','item_id="'.$item_id.'" and warehouse_id ='.$req_all->warehouse_id);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  	...
  	<td><input name="cwh_qoh" type="text" class="input3" id="cwh_qoh" style="width:60px;" value="<? if($center_stock == 0){ echo "0.00";}else { echo $center_stock;}?>" onfocus="focuson('qty')" readonly/> </td>
