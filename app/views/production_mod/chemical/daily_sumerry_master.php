...
$rec_qty=find_a_field('purchase_invoice i','sum(i.qty)','i.req_no='.$data->id.'');
  ...
  <tr>
	<td valign="top"><div align="center"><?=++$sl?></div></td>
		...
		<td valign="top">
		<div align="center">
 <a href="daily_sumerry_master.php?report=300002&item_id=<?=$data->item_id?>&t_date=<?=$_POST['t_date']?>&f_date=<?=$_POST['f_date']?>&group_id=<?=$_POST['group_id']?>&warehouse_id=<?=$_POST['warehouse_id']?>" target="_blank"> <?=$data->qty;?> </a> 
	    </div>		</td>
		<td valign="top">
		<div align="center">
		  <?=$data->unit_name;?> 
...
<tbody>
	...
	<tr>
<th width="4%">SL/NO</th>
		<th width="4%">Req Id </th>
		<th width="4%">PR No</th>
		<th width="6%">PR Date</th>
		
	  <th width="14%"><div align="center">Item Name</div></th>
	  <th width="8%"><div align="center">Warehouse</div></th>
	  <th width="8%"><div align="center">Group Name</div></th>
	  <th width="7%"><div align="center">Req qty</div></th>
		
	  <th width="9%"><div align="center">Total Unit</div></th>
...
<tr>
  ...
  <th style="background-color:#CCFFFF;">ctr</th>

  <th style="background-color:#CCFFFF;">pcs</th>
</tr>
...
<th style="background-color:#CCCCFF;">CRT</th>

<th style="background-color:#CCCCFF;">PCS</th>
...
<td style="background-color:#CCCCFF;" style="text-align:right"><?=(int)($i->final_stock/$data->pack_size)?></td>
...
if(isset($t_date)) 
		...
		<th colspan="3" style="background-color:#99CC99;" style="text-align:center">OPENING BALANCE</th>

		<th colspan="3" style="background-color:#339999;" style="text-align:center">PRODUCT RECEIVED</th>

		<th colspan="3" style="background-color:#FFFF99;" style="text-align:center">PRODUCT ISSUED</th>

		<th colspan="3" style="background-color:#FFFF99;" style="text-align:center">CLOSING BALANCE</th>

		</tr>

		<tr>

		<th style="background-color:#99CC99;">Qty</th>

		<thstyle="background-color:#99CC99;">Rate</th>		

		<th style="background-color:#99CC99;">Taka</th>

		<th style="background-color:#339999;">Qty</th>

		<th style="background-color:#339999;">Rate</th>		

		<th style="background-color:#339999;">Taka</th>

		<th style="background-color:#FFCC66;">Qty</th>

		<th style="background-color:#FFCC66;">Rate</th>

		<th style="background-color:#FFCC66;">Taka</th>

		<th style="background-color:#FFFF99;" >Qty</th>

		<th style="background-color:#FFFF99;" >Rate</th>

		<th style="background-color:#FFFF99;" >Taka</th>
