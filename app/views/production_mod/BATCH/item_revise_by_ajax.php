...
$up_sql='update batch_by_product set  final_qty="'.$total_unit.'", final_unit="'.$final_unit.'",  edit_by="'.$entry_by.'", entry_at="'.$entry_at.'" where id='.$order_no;
db_query($up_sql);
