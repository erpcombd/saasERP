...
$data=explode('##',$str);
 ...
 $stock_in_pcs = find_a_field('journal_item','sum(item_in)-sum(item_ex)','item_id="'.$item_all->item_id.'" and warehouse_id="'.$warehouse.'" ');
...
?>
	 ...
	 <input name="stock" type="text" class="input3"  value="<?=$stock_in_pcs;?>" id="stock" style="width:80%; height:30px;"  readonly="" />
