...
$unique = 'po_no';
$status = 'CHECKED';
$target_url = '../production_issue/production_issue_edit.php';
...
if(isset($_POST['submitit'])){
  ...
  if($_POST['line_id']>0)
  $con .= 'and a.warehouse_from = "'.$_POST['line_id'].'"';
  ...
  from production_floor_issue_master a, production_floor_issue_detail b, warehouse c, user_activity_management u
  where a.pi_no=b.pi_no and a.warehouse_from=c.warehouse_id and a.entry_by=u.user_id  '.$con.' group by a.pi_no order by a.pi_no desc';
    ...
    <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        while($row = mysqli_fetch_object($query)){
            ...
            <tr>
                ...
                <td>
                  <input type="submit" name="submitit" id="submitit" value="RECEIVED" class="btn1 btn1-submit-input" onclick="custom(<?=$row->pi_no?>);" />
              </td>
