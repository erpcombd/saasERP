	...
	while($databy =mysqli_fetch_object($queryby)){
		...
		if($by_product_qty>0){
			...
			db_query($updateby);
			 ...
			 $updateby_rec = "update  production_receive_detail  set unit_price = ".$rate.",total_unit=".$by_product_qty.",total_amt=".$rate*$by_product_qty."
			...
			journal_item_control($databy->item_id ,$section_id,$pr_date,$by_product_qty,0,'Production Receive',$pr_no,$rate,0,$pr_no,'','',$group_for,'','','',$batch_no);
