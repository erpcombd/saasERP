       ...
       <table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              $print_url = "https://saaserp.ezzy-erp.com/app/views/production_mod/BATCH_FG/invoice_print_view.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
...
<div style="width:48%; padding:5px;">
  ...
  <?php /*?>  <div style="display:flex; align-items:center; width:100%; justify-content:flex-end; gap:10px;">
  ...
  <h1 style="flex:0 0 50%; font-size:16px; font-weight:normal; border:1px solid #000; padding:3px 0 3px 5px; margin:0;">
    &nbsp;
    <a href="../BATCH/invoice_print_view.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($ms_data->batch_no));?>" target="_blank">
      BATCH-<?= $ms_data->batch_no; ?>
    </a>
  </h1>
</div>
