...
auto_reinsert_sales_chalan_secoundary('18041112002');
...
<form action="daily_sumerry_master.php" method="post" name="form1" target="_blank" id="form1">
                          ...
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<!--  <tr>
							   ...
							   <tr>
                                 ...
                                 <td width="6%"><input name="report" type="radio" class="radio" value="300001" /></td>


							     <td width="94%"><div align="left">PR Summery </div></td>
						      </tr>
