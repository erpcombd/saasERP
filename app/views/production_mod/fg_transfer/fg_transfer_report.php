...
<tr>
		...
		<td rowspan="3" width="30% px" height="" align="right"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$c_id?>.png" style="width:73%;height:63 px;"/></td>
	...
	<td class="qr-code">
        ...
        $print_url = "https://saaserp.ezzy-erp.com/app/views/production_mod/fg_transfer/fg_transfer_report.php?c=".rawurlencode($company_id)."&v=" . rawurlencode($req_no_qr_data);
