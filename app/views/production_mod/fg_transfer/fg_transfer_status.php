...
?>				<tr>
			...
			<td>
			<!--<a href="../fg_transfer/fg_transfer_report.php?v_no=<?=rawurlencode(url_encode($data->st_no));?>" target="_blank"><?=$data->st_no;?></a>-->
			
			<a href="../fg_transfer/fg_transfer_report.php?c='<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($data->st_no));?>'" target="_blank"><?=$data->st_no;?></a>
