...
<input name="unit_name" type="text" class="input3" style="width:40px;" onfocus="focuson('total_unit')" value="<?=$item_all->unit_name?>"/>      

<input name="stock" type="text" class="input3" style="width:40px;" onfocus="focuson('total_unit')" value="<?=$stock?>"/>       
