...
$title='Warehouse Requisition Status';
...
$table = 'production_order_requisition_master';
...
$res='select  	a.req_no,a.req_no, a.req_date, (select warehouse_name from warehouse where warehouse_id=a.req_for) as req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status from production_order_requisition_master a,warehouse b,user_activity_management c where a.warehouse_id='.$_SESSION['user']['depot'].' and a.warehouse_id=b.warehouse_id  and a.entry_by=c.user_id '.$con.'  order by a.req_no';
