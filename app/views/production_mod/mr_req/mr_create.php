...
$table_master='production_order_requisition_master';
$table_details='production_order_requisition_details';
$unique='req_no';
if($_GET['mahfuz']>0)
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td width="7%" align="center" bgcolor="#0099FF" style="width: 50px;"><strong>Floor Qty</strong></td>
                        <td width="9%" align="center" bgcolor="#0099FF"  style="width: 50px;"><strong>C.W.H </strong></td>
                        <td width="9%" align="center" bgcolor="#0099FF"><strong>P.R.P.Qty</strong> </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input name="cwhqty" type="text" class="input3" id="cwhqty" style="width:60px;" onFocus="focuson('qty')" readonly/></td>
    <td><input name="prpqty" type="text" class="input3" id="prpqty" style="width:60px;" onFocus="focuson('qty')" readonly/></td>
...
<? 
$res='select a.id,concat(b.item_name," :: ",b.item_description) as item_name,a.qoh as stock_qty,a.exp_date,a.remarks,a.order_qty,"x" from production_order_requisition_details a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
?>
