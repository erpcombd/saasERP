    ...
    <label for="<?=$bom_no?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Batch :</label>
		  ...
		  <div class="container n-form2">
			...
			<?php /*?> <div class="form-group pb-1 row m-0">
              ...
              <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Requisition Quantity :</label>
