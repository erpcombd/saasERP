...
$sql_ms="select * from purchase_foreign_master where invoice_no='$invoice_no'";
                      ...
                      <tr>
                        <td width="100%"> 
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px; margin:0; padding:0; text-align:center; " >
									...
									<tr>
   <td colspan="2" align="center"><h4 style="font-size:18px; width: 50%; padding:5px 0; margin:0; border:2px solid #000000; margin: 8px 0; background:#F5F5F5; border-radius: 5px; font-family:  'MYRIADPRO-REGULAR'; letter-spacing:1px; text-transform:uppercase;">Purchase Order </h4></td>
  </tr>
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="96%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr style=" line-height:20px;">
		          <td align="left" valign="middle"  style="font-size:14px;"><strong>Address</strong></td>
			...
			<tr>
                ...
                <td width="52%" align="right" valign="middle"><strong> PO No: </strong></td>
			  ...
			  <tr>
                ...
                <td width="52%" align="right" valign="middle"><strong> PO Date: </strong></td>
...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="6%" style="background-color:#F5F5F5;"><strong>SL</strong></td>

        <td width="40%" bgcolor="#F5F5F5" ><strong> Item Description </strong></td>

        <td width="8%" style="background-color:#F5F5F5;" ><strong>Unit</strong></td>
        <td width="11%" style="background-color:#F5F5F5;"><strong>PO Qty </strong></td>
        <td width="17%" style="background-color:#F5F5F5;"><strong>Each Price in <?=$ms_data->currency_type;?></strong></td>
        <td width="18%" style="background-color:#F5F5F5;" ><strong>Amount in <?=$ms_data->currency_type;?></strong></td>
       </tr>
...
$sql3="select a.*, s.sub_group_name, i.sub_group_id, i.item_name, i.finish_goods_code from purchase_foreign_details a, item_info i, item_sub_group s where  a.item_id=i.item_id  and i.sub_group_id=s.sub_group_id and a.invoice_no='".$invoice_no."' order by i.sub_group_id, i.item_name";
...
<tr>
        ...
        <td valign="top"><?=number_format($info2->total_amt,2); $total_total_amt +=$info2->total_amt;?></td>
</tr>
<? }?>

<? if($ms_data->freight_charge>0) {?>
<tr>
  <td valign="top"><?=$sl+1?></td>
  <td align="left" valign="top">Freight Charge</td>
  <td valign="top">&nbsp;</td>
  <td valign="top">&nbsp;</td>
  <td valign="top">&nbsp;</td>
  <td valign="top"><strong><?=number_format($ms_data->freight_charge,2);?></strong></td>
</tr>
<? }?>
<tr>
  <td valign="top">&nbsp;</td>
  ...
  <td valign="top">&nbsp;</td>
  <td valign="top">&nbsp;</td>
  <td valign="top"><strong><?=number_format($grand_total=($total_total_amt+$ms_data->freight_charge),2);?></strong></td>
</tr>
...
<td>
	 ...
	 echo ' Only';
        ...
        <tr>
          <td colspan="4" align="Left"><strong>TERMS &amp; CONDITIONS</strong>:</td>
          </tr>
 ...
 $sql_trms="select tearms, terms_conditions from purchase_terms_conditions where  invoice_no = '".$invoice_no."' and tearms!=''  order by id";

$query_trms=db_query($sql_trms);

while($data_trms=mysqli_fetch_object($query_trms)){ 
...
$sltr=$tr;
		  ...
		  ?>
		  	<tr >
				<td width="3%" style="padding: 5px 0; font-size:12px;" valign="top"><?=$sltr?>. </td>
				<td width="22%" align="left" style="padding: 5px 0; font-size:12px;" valign="top"><strong><?=$data_trms->tearms; ?></strong></td>
				<td width="3%"  align="left" style="padding: 5px 0; font-size:12px;" valign="top"><strong>:</strong></td>
				<td width="72%" align="left" style="padding: 5px 0; font-size:12px; line-height:16px; valign="top""><?=$data_trms->terms_conditions; ?></td>
			</tr>
			<? }?>
