...
<article class="oe_page">
    <section class="oe_container">
        ...
        <div class="oe_row oe_appstore">
                ...
                $sql22="select a.module_name,a.module_link,a.module_icon_img,a.module_description,a.id,a.dev_status,b.user_id,b.module_id ,b.status from user_module_manage a,user_module_define b where b.module_id=a.id and b.user_id='".$u_id."' and b.status='enable' ";
            ...
            <a href="<?=SERVER_VIEW?><?=$data22->module_link?>?mod_id=<?=$data22->id?>" title="<?=$data22->module_name?>" class="card" >
