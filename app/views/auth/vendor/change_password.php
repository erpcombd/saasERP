 ...
 $old_pass = md5($_POST['old_pass']);
  ...
  if($old_pass==$orginal_old_pass){
      ...
      if($new_pass==$confirm_pass){
        ...
        $update = 'update user_activity_management set password="'.$confirm_pass.'",pass_change="YES" where user_id="'.$u_id.'"';
                ...
                <div class="row ds-row">
                    <div class="col-md-6 d-flex justify-content-center align-items-center">
                        <div class="AppFormLeft">
							...
							<input name="old_pass" type="password" id="old_pass" value="" placeholder="Old Password" required autocomplete="off"/>
                            <hr>
                            </div>

                            <div class="form-group position-relative mb-4">
							<input name="new_pass" type="password" id="new_pass" value="" placeholder="New Password" required autocomplete="off"/>
                            <hr>
                            </div>
