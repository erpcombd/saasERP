...
<div class="container h-100" style=" zoom: 70%; " style="transform: scale(0.7);">
    <div class="row h-100 justify-content-center align-items-center">
        <form action="pass_change.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
<div><?=$_SESSION['mmsg'];unset($_SESSION['mmsg']);?></div>
							...
							<input name="new_password" type="text" id="new_password" value="" placeholder="Enter New Password.." onClick="pass_criteria()" required autocomplete="off"/>
                                
                            <hr>
                            </div>
							
							<div class="form-group position-relative mb-4">
							<input name="confirm_password" type="text" id="confirm_password" value="" onClick="pass_criteria()" placeholder="Enter Confirm Password.." required autocomplete="off"/>
