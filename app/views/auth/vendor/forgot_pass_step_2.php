...
<div class="container h-100" style=" zoom: 70%; " style="transform: scale(0.7);">
    <div class="row h-100 justify-content-center align-items-center">
        <form action="otp_checker.php" method="post" enctype="multipart/form-data" autocomplete="off">
...
<div><?=$_SESSION['mmsg'];unset($_SESSION['mmsg']);?></div>
							...
							<input name="new_otp" type="text" id="new_otp" value="" placeholder="Enter Your OTP.." required/>
                            <hr>
                            </div>
