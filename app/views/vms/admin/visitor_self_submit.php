...
// new filename
$filename = 'p'.$company_id.''.$user_id.''.date('YmdHis') . '.jpeg';
...
if($_POST['visitor_name']==!''){
    ...
    $company_id 			    = get_safe_value($conn,$_POST['company_id']);
    ...
    $sql = "insert ignore into visitor_table_self
    ...
    '$visitor_meet_person_name','$visitor_department','$visitor_reason_to_meet','$visitor_card_no','Self')";
