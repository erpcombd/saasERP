...
$_SESSION['filename'] = 'pic2_'.date('YmdHis') . '.jpeg';
?>
            ...
            <div class="row">
                <div class="col-9">
                    <div class="content-header">
                        <h2 class="content-title">Add New Visitor</h2>
<!--                        <div>
                            ...
                            <form method="post" enctype="multipart/form-data">
							  ...
							  <div class="row">  
								<div class="mb-4 col-lg-8">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="visitor_name" name="visitor_name">
                                <div class="text-danger" id="name_error"></div>
								</div>
								
								     <div class="col-lg-4">
                                        <label class="form-label">Card NO</label>
                                        <select class="form-select" name="visitor_card_no" id="visitor_card_no" required>
                                          <option></option>
										   <?php for ($x = 1; $x <= 20; $x++) { ?> 
							  ...
							  <div class="row">
									<div class="mb-4 col-lg-6">
										...
										<input placeholder="" type="text" name="visitor_email" id="visitor_email" class="form-control">
							   	...
							   	<div class="mb-4">
                                    ...
                                    <input type="text" placeholder="Type here" class="form-control" id="visitor_address" name="visitor_address">
								...
								<div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <input placeholder="visitor_meet_person_name" type="text" name="visitor_meet_person_name" id="visitor_meet_person_name" class="form-control">
...
function visitor_register(){
	...
	var visitor_email=jQuery("#visitor_email").val();
...
data:'visitor_name='+visitor_name+'&visitor_email='+visitor_email+'&visitor_mobile_no='+visitor_mobile_no+'&image='+base64image+'&visitor_address='+visitor_address+'&visitor_meet_person_name='+visitor_meet_person_name+'&visitor_department='+visitor_department+'&visitor_reason_to_meet='+visitor_reason_to_meet+'&visitor_card_no='+visitor_card_no,
