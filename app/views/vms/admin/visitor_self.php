...
if($company_id==''){ die("Scan QR Code");}


$filename = $_SESSION['filename'] = 'p'.$company_id.''.$user_id.''.date('YmdHis') . '.jpeg';
?>
        
<!--Top header	-->	
<?php include("inc/header_self.php");?>
<?php //include("inc/header_top_self.php");?>
<!--BODY Start	-->	
...
if(isset($_POST['submit'])){
	...
	$sql = "insert into visitor_table(categories_id,sub_categories,status) values('$categories','$sub_categories','1')";
...
<div class="col-lg-3">
    <div class="card mb-4">
        ...
        <div class="card-body">
			...
			<input type=button class="btn btn-info" value="Take Selfie" id="snapshot" onClick="take_snapshot()">
		  ...
		  <div class="row">
				...
				<div class="mb-4 col-lg-6">
					...
					<input placeholder="" type="number" name="visitor_mobile_no" id="visitor_mobile_no" class="form-control">
...
<div class="mb-4">
<button name="submit" id="submit" type="button" onclick="visitor_register()" class="btn btn-success">Apply Request</button>
</div>
	...
	if(is_error==''){
	    ...
	    // Image upload system
			var base64image =  document.getElementById("imageprev").src;
		 	Webcam.upload( base64image, 'visitor_self_submit.php', function(code, text) {
		...
		jQuery.ajax({
			url:'visitor_self_submit.php',
			type:'post',

//data:'name='+name+'&email='+email+'&mobile='+mobile+'&password='+password,
data:'visitor_name='+visitor_name+'&company_id='+company_id+'&visitor_nid='+visitor_nid+'&visitor_mobile_no='+visitor_mobile_no+'&image='+base64image+'&visitor_address='+visitor_address+'&visitor_meet_person_name='+visitor_meet_person_name+'&visitor_department='+visitor_department+'&visitor_reason_to_meet='+visitor_reason_to_meet+'&visitor_card_no='+visitor_card_no,
...
jQuery('.success').show();
jQuery('.success').html('Please collect Visiting Card from Help Desk');	
