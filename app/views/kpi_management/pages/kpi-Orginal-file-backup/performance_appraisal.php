...
if(isset($_POST['add']))
	{
			...
			$in = 'INSERT INTO `kpi_task_temporary` (`PBI_ID`, `task_name`, `week`, `year`, `entry_by`) VALUES ("'.$_GET['id'].'", "'.$_POST['task_name'].'", "'.$_SESSION['week_name'].'", "'.date('Y').'", "'.$_SESSION['employee_selected'].'")';
			mysql_query($in);
