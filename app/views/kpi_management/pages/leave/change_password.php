...
// ::::: Edit This Section ::::: 
$title='Password Change Form';			// Page Name and Page Title
$page="change_password.php";		// PHP File Name
...
$shown='pass';				// For a New or Edit Data a must have data field
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Password :</td>
                  <td bgcolor="#E8E8E8" colspan="4" class="oe_form_group_cell">
				  <?
				 
				  ?>
				  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
				  <input name="pass" type="password" id="pass" value="<?=$pass?>"  style="width:420px;"/>                  </td>
                  </tr>
