        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td colspan="1" class="oe_form_group_cell" width="100%"><table width="105%" height="171" border="0" cellpadding="0" cellspacing="0" class="oe_form_group "><tbody>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <select name="RECEIVED_CERTIFICATE" id="RECEIVED_CERTIFICATE">
                    <option selected><?=$RECEIVED_CERTIFICATE?></option>
                            <option>Yes</option>
                            <option>No</option>
                  </select></td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">Nominee Photo :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><select name="EMPLOYEE_VARIFICATION_FORM" id="EMPLOYEE_VARIFICATION_FORM">
                    <option selected>
