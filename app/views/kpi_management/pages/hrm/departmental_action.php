...
$shown='DEPARTMENTAL_OBJ_TYPE';				// For a New or Edit Data a must have data field
...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',DEPARTMENTAL_OBJ_TYPE as Dept_Action_Type, DEPARTMENTAL_OBJ_SUBJECT as Subject from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
