            ...
            <td class="oe_form_group_cell"><table width="228" height="98" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" width="18%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Demotion Reason :</td>
                  <td bgcolor="#E8E8E8" width="32%" colspan="1" class="oe_form_group_cell">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="DEMOTION_REASON" type="text" id="DEMOTION_REASON" value="<?=$DEMOTION_REASON?>" /></td>
                  <td bgcolor="#E8E8E8" width="20%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Date :</span></td>
                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell"><input name="DEMOTION_DATE" type="text" id="DEMOTION_DATE" value="<?=$DEMOTION_DATE?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                  ...
                  <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Present Designation :</span></td>
                  <td class="oe_form_group_cell"><select name="DEMOTION_PRESENT_DESG">
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"> <select name="DEMOTION_CROSSED_LEVEL" id="DEMOTION_CROSSED_LEVEL">
     				 <option selected><?=$DEMOTION_CROSSED_LEVEL?></option>
                            <option>1</option>
                            <option>2</option>
                            <option>3</option>
                            <option>4</option>
