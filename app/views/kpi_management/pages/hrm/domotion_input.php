...
$vars['PBI_DESIGNATION']=$_POST['DEMOTION_PRESENT_DESG'];
$vars['PBI_DOJ_PP']=$_POST['DEMOTION_DATE'];
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td colspan="1" class="oe_form_group_cell">
                    <select name="DEMOTION_PAST_DESG">
                      <? foreign_relation('designation','DESG_SHORT_NAME','DESG_DESC',$DEMOTION_PAST_DESG);?>
                    </select></td>
                </tr>
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" colspan="1" class="DEMOTION_PAST_DESG"><select name="DEMOTION_CROSSED_LEVEL" id="DEMOTION_CROSSED_LEVEL">
                     ...
                     <option>5</option>
                      ...
                      <? foreign_relation('designation','DESG_SHORT_NAME','DESG_DESC',$DEMOTION_PRESENT_DESG);?>
                    </select></td>
                      </tr>
                      <tr class="oe_form_group_row">
