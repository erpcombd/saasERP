...
// ::::: Edit This Section ::::: 
$title='Unit Management';			// Page Name and Page Title
$page="unit_manage.php";		// PHP File Name
$input_page="unit_manage_input.php";
$root='inventory';

$table='inv_unit';		// Database Table Name Mainly related to this page
       ...
       <form action="" method="post"> <div class="ui-dialog ui-widget ui-widget-content ui-corner-all oe_act_window ui-draggable ui-resizable openerp" style="outline: 0px none; z-index: 1002; position: absolute; height: auto; width: 900px; display: block; /* [disabled]left: 217.5px; */" tabindex="-1" role="dialog" aria-labelledby="ui-id-19">
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
                ...
                <tr class="oe_form_group_row">
                  <td width="1%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Unit:</td>
                  <td width="99%" colspan="1" class="oe_form_group_cell"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                    <input name="unit" type="text" id="unit" value="<?=$unit?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>Full Name:</label></td>
                  <td colspan="1" class="oe_form_group_cell"><input name="unit_name" type="text" id="unit_name" value="<?=$unit_name?>" /></td>
                </tr>
                </tbody></table></td><td colspan="1" class="oe_form_group_cell oe_group_right" width="50%"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row"><td colspan="1" class="oe_form_group_cell oe_form_group_cell_label" width="1%"><label>Unit Type:</label></td><td colspan="1" class="oe_form_group_cell" width="99%"><select name="unit_type" id="unit_type">
      <option <? ($unit_type=='Basic Unit')?'Selected':'';?>>Basic Unit</option>
      <option <? ($unit_type=='Packing Unit')?'Selected':'';?>>Packing Unit</option>
    </select></td></tr><tr class="oe_form_group_row"><td colspan="1" class="oe_form_group_cell oe_form_group_cell_label" width="1%"><label>Description:</label></td><td colspan="1" class="oe_form_group_cell" width="99%"><span class="oe_form_field oe_datepicker_root oe_form_field_date"><span>
