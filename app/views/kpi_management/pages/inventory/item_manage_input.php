...
// ::::: Edit This Section ::::: 
$title='Item Management';			// Page Name and Page Title
$page="item_manage.php";		// PHP File Name
$input_page="item_manage_input.php";
$root='inventory';

$table='inv_item';		// Database Table Name Mainly related to this page
...
<body>
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td colspan="1" class="oe_form_group_cell" width="50%"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody>
                <tr class="oe_form_group_row">
                  <td width="1%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Item Name:</td>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>Category:</label></td>
      ...
      <? foreign_relation('inv_item_category','id','category_name',$category_id);?>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Unit:</td>
                  <td colspan="1" class="oe_form_group_cell"><select name="unit_id" id="unit_id">
      <? foreign_relation('inv_unit','id','unit',$unit_id);?>
    </select></td>
                </tr>
                <tr class="oe_form_group_row">
                ...
                </tbody></table></td><td colspan="1" class="oe_form_group_cell oe_group_right" width="50%"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row"><td colspan="1" class="oe_form_group_cell oe_form_group_cell_label" width="1%"><label>Cost Price:</label></td><td colspan="1" class="oe_form_group_cell" width="99%"><input name="cost_price" type="text" id="cost_price" value="<?=$cost_price?>" /></td></tr>
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Sale Price:</td>
                        <td colspan="1" class="oe_form_group_cell"><input name="sale_price" type="text" id="sale_price" value="<?=$sale_price?>" /></td>
                      </tr>
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Re-Order Level:</td>
                        <td colspan="1" class="oe_form_group_cell"><input name="reorder_level" type="text" id="reorder_level" value="<?=$reorder_level?>" /></td>
                      </tr>
                      <tr class="oe_form_group_row">
                        <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>Description:</label></td>
