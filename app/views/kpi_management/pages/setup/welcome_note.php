...
// ::::: Edit This Section ::::: 
$title='Welcome Note';			// Page Name and Page Title
$page="welcome_note.php";		// PHP File Name

$root='setup';

$table='welcome_note';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='note';				// For a New or Edit Data a must have data field
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
				  ...
				  <input name="note" type="text" id="note" value="<?=$note?>"  style="width:420px;"/>                  </td>
                  </tr>
