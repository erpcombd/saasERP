...
// ::::: Edit This Section ::::: 
$title='Institute Type Information';			// Page Name and Page Title
$page="institute_type.php";		// PHP File Name
$input_page="institute_type_input.php";
$root='setup';

$table='institute';		// Database Table Name Mainly related to this page
$unique='institute_id';			// Primary Key of this Database table
$shown='institute_name';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Institute Type :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="institute_name" type="text" id="institute_name" value="<?=$institute_name?>" /></td>
