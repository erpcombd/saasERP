...
// ::::: Edit This Section ::::: 
$title='Education Qualification Type Information';			// Page Name and Page Title
$page="edu_qua_type.php";		// PHP File Name
$input_page="edu_qua_type_input.php";
$root='setup';

$table='edu_qua';		// Database Table Name Mainly related to this page
$unique='EDU_QUA_CODE';			// Primary Key of this Database table
$shown='EDU_QUA_DESC';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Education Type :</td>
                  ...
                  <input name="EDU_QUA_DESC" type="text" id="EDU_QUA_DESC" value="<?=$EDU_QUA_DESC?>" /></td>
