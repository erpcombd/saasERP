...
// ::::: Edit This Section ::::: 
$title='Action Subject Information';			// Page Name and Page Title
$page="action_subject.php";		// PHP File Name
$input_page="action_subject_input.php";
$root='setup';

$table='action_subject';	    	// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='action_subject';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Action Subject  :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="action_subject" type="text" id="action_subject" value="<?=$action_subject?>" /></td>
