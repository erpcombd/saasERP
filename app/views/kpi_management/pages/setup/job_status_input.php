...
// ::::: Edit This Section ::::: 
$title='Job Status Information';			// Page Name and Page Title
$page="job_status.php";		// PHP File Name
$input_page="job_status_input.php";
$root='setup';

$table='job_status';	    	// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='job_status';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Job Status  :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="job_status" type="text" id="job_status" value="<?=$job_status?>" /></td>
