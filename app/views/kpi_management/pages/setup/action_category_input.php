...
// ::::: Edit This Section ::::: 
$title='Action Category Information';			// Page Name and Page Title
$page="action_category.php";		// PHP File Name
$input_page="action_category_input.php";
$root='setup';

$table='action_category';	    	// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='action_category';			// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Action Category  :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="action_category" type="text" id="action_category" value="<?=$action_category?>" /></td>
