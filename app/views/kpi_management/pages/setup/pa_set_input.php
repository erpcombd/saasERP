...
if (isset($_POST[$shown])) {
  ...
  if (isset($_POST['insert']) || isset($_POST['insertn'])) {
    ...
    $duplicate_entry = find_a_field('hrm_pa_set', 'PBI_ID', 'PBI_ID="' . $_POST[$shown] . '" 
    and LINE_MANAGER="' . $_POST['LINE_MANAGER'] . '"  and DEPT_HEAD="' . $_POST['DEPT_HEAD'] . '" and status="Active"');

    if ($duplicate_entry > 0) {
      echo "<p style='color:red'>Emp ID already exists</p>";
    } else {
                        ...
                        <tbody>
                          <tr class="oe_form_group_row">
                            ...
                            <td class="oe_form_group_cell">
                              <table width="261" height="66" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">

                                <tbody>

                                  <tr class="oe_form_group_row">

                                    <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;PA For :</td>
                                    ...
                                    <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <select name="PBI_ID" id="PBI_ID" class="selectpicker" data-show-subtext="true" data-live-search="true">
                                        ...
                                        <? foreign_relation('personnel_basic_info', 'PBI_ID', 'concat(PBI_NAME," (", PBI_CODE,") ")', $PBI_ID, 'PBI_JOB_STATUS="In Service"') ?>
                                  ...
                                  <tr class="oe_form_group_row">
                                    ...
                                    <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;PA Authority :</td>
                                    ...
                                    <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <select name="LINE_MANAGER" id="LINE_MANAGER" class="selectpicker" data-show-subtext="true" data-live-search="true">
                                        ...
                                        <? foreign_relation('personnel_basic_info', 'PBI_ID', 'concat(PBI_NAME," (", PBI_CODE,") ")', $LINE_MANAGER, 'PBI_JOB_STATUS="In Service"') ?>
                                  ...
                                  <tr class="oe_form_group_row">
                                    ...
                                    <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <select name="DEPT_HEAD" id="DEPT_HEAD" class="selectpicker" data-show-subtext="true" data-live-search="true">
                                        ...
                                        <? foreign_relation('personnel_basic_info', 'PBI_ID', 'concat(PBI_NAME," (", PBI_CODE,") ")', $DEPT_HEAD, 'PBI_JOB_STATUS="In Service"') ?>
