...
?>
    <table width="100%"  cellspacing="0" cellpadding="2" border="0">
      <thead>
        ...
        <tr>
          <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Short Leave Report of
              <? $test = new DateTime('01-'.$_POST['mon'].'-'.$_POST['year'].' ');
...
if($_POST['PBI_ID']!=''){
  ...
  $pbi_id = find_a_field('personnel_basic_info','PBI_ID','PBI_CODE="'.$_POST['PBI_ID'].'"');
...
?>
    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
      <thead>
        <tr>
          <td style="border:0px; font-family:bank gothic; font-size:20px; font-weight:bold;" colspan="11" align="center"></td>
        </tr>
        <tr>
          <td style="border:0px;font-family:bank gothic; font-size:25px; font-weight:bold;" colspan="11" align="center">AKSID CORPORATION LIMITED</td>
        </tr>
        <tr>
          <td style="border:0px;font-family:cambria; font-size:18px;" colspan="11" align="center">Key Performance Indicator (KPI) Weekly Report</td>
        </tr>
      </thead>
    </table>
    <br />
    <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
      <thead>
        <tr>
          <td style="border:0px;font-family:cambria; font-size:12px;" colspan="11" align="right">&nbsp;&nbsp;Reporting Time :
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
      <tr height="60">
        <td style=" border-bottom:0px; border-right:0px; border-left:0px;"><table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-family:cambria;">
            <tr>
              <td style="font-size:16px; padding:2px;"> ID NO : <strong>
                <?=$employee->PBI_CODE?>
                </strong></td>
              <td style="padding:2px; font-size:14px;">Name : <strong>
                <?=$employee->PBI_NAME?>
                </strong> </td>
              <td style="padding:2px; font-size:14px;">Designation : <strong>
                <?=find_a_field('designation','DESG_DESC','DESG_ID='.$employee->PBI_DESIGNATION);?>
                </strong></td>
              <td rowspan="3"><table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
                  <tr>
                  ...
                  <tr>
                    <td>Errors</td>
                    <td>(
                      <?=number_format($error = find_a_field('kpi_error_overtime_details','sum(score)','PBI_ID="'.$pbi_id.'" and mon="'.$mon.'" and year="'.$year.'"'),2);?>
                      )</td>
                  </tr>
                  <tr>
                    <td>Over Time</td>
...
?>
            ...
            <tr>
              <td style="padding:2px; font-size:14px;">Department : <strong>
                <?=find_a_field('department','DEPT_DESC','DEPT_ID='.$employee->PBI_DEPARTMENT);?>
                </strong></td>
              <td style="padding:2px; font-size:14px;"> Project Name : <strong>
                <?=find_a_field('project','PROJECT_DESC','PROJECT_ID='.$employee->JOB_LOCATION);?>
                </strong> </td>
              <td style="padding:2px; font-size:14px;">Joining Date : <strong>
                <?=date('d-M-Y',strtotime($employee->PBI_DOJ))?>
                </strong></td>
            </tr>
            <tr>
              <td style="padding:2px; font-size:14px;">KPI Authorised Person: <strong>
                <?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID="'.$reporting_data->PBI_ID.'"');?>
                </strong></td>
              <td style="padding:2px; font-size:14px;">Designation of Authorised Person : <strong>
                <?=find_a_field('designation','DESG_DESC','DESG_ID='.$reporting_data->PBI_DESIGNATION);?>
                </strong></td>
              <td style="font-size:14px;">Service Length : <strong>
                <?php
    ...
    <table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
	  ...
	  ?>
      <tr>
        <td width="5%"><div align="center"><strong>
            <?=++$i?>
            </strong></div></td>
        ...
        <td width="10%"><div align="center">
            <?=$task_data->documentart_evidence?>
          </div></td>
        <td width="10%"><div align="center">
            <? if($task_data->att_file!=''){?>
            <a href="../../pic/kpi_log/<?=$task_data->att_file?>" target="_blank">Attachment</a>
            <? } ?>
          </div></td>
      </tr>
      <? } ?>
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Score :
            <?=number_format($weekly_task = find_a_field(' kpi_log_sheet_details','sum(point)','PBI_ID="'.$pbi_id.'" and week="Week 1" and  mon="'.$mon.'" and year="'.$year.'"'),2);?>
          </div></td>
      </tr>
    </table>
    <br />
    ...
    <table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      ...
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Score :
            <?=number_format($weekly_task2 = find_a_field(' kpi_log_sheet_details','sum(point)','PBI_ID="'.$pbi_id.'" and week="Week 2" and  mon="'.$mon.'" and year="'.$year.'"'),2);?>
          </div></td>
      </tr>
    </table>
    <br />
    <table width="100%"  cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      <tr>
        <td colspan="9" style="background:#337AB7; color:#FFFFFF;"><div align="center" style="font-size:16px; font-weight:bold;">Week 3</div></td>
      </tr>
    </table>
    <table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      <tr height="30" style="background:#00CCFF">
      ...
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Score :
            <?=number_format($weekly_task3 = find_a_field(' kpi_log_sheet_details','sum(point)','PBI_ID="'.$pbi_id.'" and week="Week 3" and  mon="'.$mon.'" and year="'.$year.'"'),2);?>
          </div></td>
      </tr>
    </table>
    <br />
    <table width="100%"  cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      <tr>
        <td colspan="9" style="background:#337AB7; color:#FFFFFF;"><div align="center" style="font-size:16px; font-weight:bold;">Week 4</div></td>
      </tr>
    </table>
    <table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      <tr height="30" style="background:#00CCFF">
      ...
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Score :
            <?=number_format($weekly_task4 = find_a_field(' kpi_log_sheet_details','sum(point)','PBI_ID="'.$pbi_id.'" and week="Week 4" and  mon="'.$mon.'" and year="'.$year.'"'),2);?>
          </div></td>
      </tr>
    </table>
    <br />
    ...
    <table width="100%" cellspacing="0" cellpadding="0" align="center" style="padding:0px; border: 0px solid #666666;font-family:cambria;">
      ...
      <tr height="30">
        ...
        <td width="40%"><div align="center">
            <?=$data->overtime_justification?>
          </div></td>
      </tr>
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Error Deductions :
            <?=number_format($data->score,2)?>
          </div></td>
      </tr>
      <tr>
        <td colspan="8" style="background:#fff; color:#000;"><div align="center" style="font-size:16px; font-weight:bold;"> Total Over Time Marks :
...
?>
  <table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
    <thead>
      ...
      <tr>
        <td style="border:0px;font-family:cambria; font-size:18px;" colspan="11" align="center">Key Performance Indicator (KPI) Final Report</td>
      </tr>
    </thead>
  </table>
  <br />
...
$sqld="select desg.DESG_DESC,p.PBI_DOJ,p.PBI_NAME,p.PBI_ID,p.PBI_CODE,k.GRADE,k.SCORE,k.YEAR from designation desg, personnel_basic_info p,
...
?>
      <tr align="center">
        ...
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=01&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="01"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=02&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="02"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=03&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="03"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=04&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="04"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=05&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="05"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=06&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="06"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=07&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="07"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=08&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="08"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=09&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="09"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=10&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="10"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=11&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="11"');?>
          </a></td>
        <td align="center"><a href="kpi_single_week_view.php?PBI_ID=<?=$data->PBI_ID?>&mon=12&year=<?=$data->YEAR?>" target="_blank">
          <?=find_a_field('kpi_final_score','grade','PBI_ID="'.$data->PBI_ID.'" and year="'.$data->YEAR.'" and mon="12"');?>
          </a></td>
...
$pbi_code = find_a_field('personnel_basic_info','PBI_ID','PBI_CODE="'.$_POST['PBI_CODE'].'"');
...
$pa_check_entry = find_all_field('performance_appraisal','','PBI_ID="'.$pbi_code.'" and entry_by="'.$_SESSION['employee_selected'].'" and EMPLOYMENT_TYPE="Permanent" 
and status="DONE" and year="'.$_POST['year'].'"');

$pa_check_dep_head = find_all_field('performance_appraisal','','PBI_ID="'.$pbi_code.'" and DEPT_HEAD="'.$_SESSION['employee_selected'].'" and EMPLOYMENT_TYPE="Permanent" and 
year="'.$_POST['year'].'"');

   
	   
if($pa_check_user->PBI_ID==$pbi_code){  
...
$appraiser = find_all_field('personnel_basic_info','','PBI_ID="'.$line_manager.'"');
 ...
 $pa = find_all_field('performance_appraisal','','PBI_ID="'.$_SESSION['employee_selected'].'" and year="'.$_POST['year'].'"');
  ...
  $sql2=  'select * from performance_appraisal where PBI_ID = '.$_SESSION['employee_selected'].' and 
 EMPLOYMENT_TYPE="Permanent" and year='.$_POST['year'].' and report_approval="1" and status="DONE" order by PBI_ID';
...
$employee = find_all_field('personnel_basic_info','','PBI_ID="'.$pbi_code.'"');
$line_manager = find_a_field('hrm_pa_set','LINE_MANAGER','PBI_ID="'.$_SESSION['employee_selected'].'"');
$appraiser = find_all_field('personnel_basic_info','','PBI_ID="'.$line_manager.'"');

 $pa = find_all_field('performance_appraisal','','PBI_ID="'.$_SESSION['employee_selected'].'" and year="'.$_POST['year'].'"');

  $sql2=  'select * from performance_appraisal where PBI_ID = '.$pbi_code.' and EMPLOYMENT_TYPE="Permanent" and  entry_by="'.$_SESSION['employee_selected'].'" and year='.$_POST['year'].' and report_approval="1" and status="DONE"';
$query = mysql_query($sql2);
...
$employee = find_all_field('personnel_basic_info','','PBI_ID="'.$pbi_code.'"');
$line_manager = find_a_field('hrm_pa_set','LINE_MANAGER','PBI_ID="'.$pbi_code.'"');
$appraiser = find_all_field('personnel_basic_info','','PBI_ID="'.$line_manager.'"');
$pa = find_all_field('performance_appraisal','','PBI_ID="'.$pbi_code.'" and year="'.$_POST['year'].'"');

echo $sql2=  'select * from performance_appraisal where PBI_ID = '.$pbi_code.' and EMPLOYMENT_TYPE="Permanent" and DEPT_HEAD="'.$_SESSION['employee_selected'].'" and  year='.$_POST['year'].' and report_approval="1" and status="DONE"';
$query = mysql_query($sql2);
...
while($result = mysql_fetch_object($query)){
	...
	$entry_byyyyy = $result->entry_by;
	
     $line_man = find_a_field('essential_info','ESSENTIAL_REPORTING','PBI_ID='.$employee->PBI_ID); 

	
	if($line_man == $entry_byyyyy){
	$appraiser_name = find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$entry_byyyyy);
	$desig = find_a_field('personnel_basic_info','PBI_DESIGNATION','PBI_ID='.$result->entry_by);
	$appraiser_desg= find_a_field('designation','DESG_DESC','DESG_ID='.$desig);
	}else{
	
	$appraiser_name = "Anonymous";
	$appraiser_desg= "Anonymous";
	}
...
?>
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
    <thead>
      <!--<tr>
        <td style="border:0px; font-family:bank gothic; font-size:20px; font-weight:bold;" colspan="11" align="center">AKSID CORPORATION LIMITED</td>
      </tr>-->
      <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
      <tr style="font-family: Cambria,Georgia,serif;">
        <td style="font-size:16px; padding:2px;"> ID NO : <b>
          <?=$employee->PBI_CODE?>
          </b></td>
        <td style="font-size:16px; padding:2px;">NAME : <b>
          <?=$employee->PBI_NAME?>
          </b> </td>
        <td style="font-size:16px; padding:2px;">DESIGNATION : <b>
          <?=find_a_field('designation','DESG_DESC','DESG_ID='.$employee->PBI_DESIGNATION);?>
          </b></td>
      </tr>
      <tr style="font-family: Cambria,Georgia,serif;">
        <td style="font-size:16px; padding:2px;">DEPARTMENT : <b>
          <?=find_a_field('department','DEPT_DESC','DEPT_ID='.$employee->PBI_DEPARTMENT);?>
          </b></td>
        <td style="font-size:16px; padding:2px;"> PROJECT NAME : <b>
          <?=find_a_field('project','PROJECT_DESC','PROJECT_ID='.$employee->JOB_LOCATION);?>
          </b></td>
        <td style="font-size:16px; padding:2px;">JOINING DATE : <b>
          <?=date('d-M-Y',strtotime($employee->PBI_DOJ)) ?>
          </b></td>
      </tr>
      <tr style="font-family: Cambria,Georgia,serif;">
        <td style="font-size:16px; padding:2px;">Name of Appraiser : <b>
          <?=$appraiser_name; 
	/*$sql_line = "SELECT * FROM hrm_pa_set WHERE LINE_MANAGER='".$result->entry_by."' GROUP BY LINE_MANAGER";
	$query_line = mysql_query($sql_line);
	while($line = mysql_fetch_object($query_line)){
	
	$line_man = $line->LINE_MANAGER;
	 
	$appraiser_name = find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$line_man);
	$desig = find_a_field('personnel_basic_info','PBI_DESIGNATION','PBI_ID='.$line_man);   }*/
        ...
        <td style="font-size:16px; padding:2px;">Designation of Appraiser : <b>
          <?=$appraiser_desg;?>
          </b></td>
        <td></td>
      </tr>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px; text-align:center">5-Point</td>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:18px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">1. Able and willing to work effectively with others in a team.<br>
        <span style="font-size:14px">দলের অন্যদের সঙ্গে কাজ করতে ইচ্ছুক এবং সক্ষম কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">2. Highly disciplined in conveying information through presentations and does proper use of English while communicating via email or any other medium.<br>
        <span style="font-size:14px">উপস্থাপনার মাধ্যমে তথ্য জানানোর ক্ষেত্রে অত্যন্ত সুশৃঙ্খল এবং ইমেইল বা অন্য কোনো মাধ্যমে যোগাযোগ করার সময় ইংরেজির যথাযথ ব্যবহার করে থাকে।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">4. Completes tasks in an error free manner and within the timeframe.<br>
        <span style="font-size:14px">নির্ভুলভাবে এবং নির্ধারিত সময়সীমার মধ্যে কাজগুলি সম্পূর্ণ করে। </span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="3"><?=$result->part_1_comment?></td>
    </tr>
    <!--Part-1 End-->
    <!--Part-2-->
    <tr>
      <td style="padding:5px;font-family: Cambria,Georgia,serif; font-size: 18px;width:40%;background-color:#59B2EA" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <b>PART II &nbsp;&nbsp;</b> <b>PRODUCTS AND SERVICES</b></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">5. Possesses knowledge of work procedures and requirements of job.<br>
        <span style="font-size:14px">কাজের পদ্ধতি জানে এবং কাজের জন্য প্রয়োজনীয় জ্ঞান সম্পন্ন কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$question3?></td>
      <td style="padding:5px;" align="center"><?=rating($question3)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">6. Shows technical competence/skill in area of specialization.<br>
        <span style="font-size:15px">বিশেষ ক্ষেত্রে প্রযুক্তিগত দক্ষতা বা পারদর্শিতা রয়েছে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">7. Displays commitment to work and willingness to learn.<br>
        <span style="font-size:14px">কাজের প্রতি নিবেদিত বা প্রতিজ্ঞাবদ্ধ এবং নতুন কিছু শিখতে আগ্রহী কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">8. Has a sense of urgency in acting on work matters.<br>
        <span style="font-size:14px">জরুরীভিত্তিতে কাজ করার প্রবণতা রয়েছে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">10. Is able to handle a reasonable volume of work.<br>
        <span style="font-size:14px">নির্দিষ্ট পরিমানের কাজের চাপ সামলাতে সক্ষম কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$question9?></td>
      <td style="padding:5px;" align="center"><?=rating($question9)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px"></tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">11. Seeks to continuously improve processes and work methods.<br>
        <span style="font-size:14px">সবসময় কাজের পদ্ধতি এবং প্রক্রিয়ার উন্নতি করতে চায় কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$question11?></td>
      <td style="padding:5px;" align="center"><?=rating($question11)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px; text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$result->part_2_comment?></td>
    </tr>
    <!--Part-2 End-->
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">12. Helps resolve problems on work-related matters.<br>
        <span style="font-size:14px">কাজ সম্পর্কিত বিষয়ে সমস্যা সমাধান করতে পারে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">13. Is a positive role model for other staff.<br>
        <span style="font-size:14px">অন্য কর্মীদের জন্য একজন আদর্শবান কর্মী কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$question14?></td>
      <td style="padding:5px;" align="center"><?=rating($question14)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">14. Motivates team members to improve their quality of work.<br>
        <span style="font-size:14px">দলের অন্যান্য সদস্যদের কাজের মান উন্নত করতে অনুপ্রাণিত করে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$question15?></td>
      <td style="padding:5px;" align="center"><?=rating($question15)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$result->part_3_comment?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px;background-color:#59B2EA">
      <td style="padding:5px; width:40%" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <input type="hidden" name="pre_score" id="pre_score" value="<?=find_a_field(' performance_appraisal','total_score','PBI_ID="'.$_GET['id'].'" and year="'.$_GET['year'].'"');?>" />
        <strong>PART IV &nbsp;&nbsp; &nbsp; FAIRNESS</strong></td>
      <td style="padding:5px; width:10%" align="center" colspan="2" ><strong>Rating</strong></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">15. Is able to work with limited supervision.<br>
        <span style="font-size:14px">অল্পতেই কাজ বুঝিয়ে দিলে কাজ করতে সক্ষম কি না।</span> </td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">16. Is adaptable and willing to accept new responsibilities.<br>
        <span style="font-size:14px">যে কোন নতুন পরিস্থিতিতে বা অবস্থায় মানিয়ে চলতে পারে এবং নতুন দায়িত্ব গ্রহণ করতে আগ্রহী কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">17. Is punctual and has good attendance.<br>
        <span style="font-size:14px">কর্মক্ষেত্রে সময়নিষ্ঠ  এবং পর্যাপ্ত উপস্থিতি বা হাজিরা রয়েছে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$result->part_4_comment?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px;background-color:#59B2EA">
      <td style="padding:5px; width:40%" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <input type="hidden" name="pre_score" id="pre_score" value="<?=find_a_field(' performance_appraisal','total_score','PBI_ID="'.$_GET['id'].'" and year="'.$_GET['year'].'"');?>" />
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">19. Willingness to work harmoniously with others in getting a job done.<br>
        <span style="font-size:14px">একটি কাজ সম্পন্ন করার জন্য অন্যদের সাথে তাল মিলিয়ে চলার ইচ্ছা শক্তি পোষণ করে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="4"><?=$result->part_5_comment?></td>
    </tr>
	...
	<tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="4"><?=$result->achievements?></td>
    </tr>
	...
	<tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="4">Late : <?=find_a_field('salary_attendence_lock','sum(lt)','year="'.$_POST['year'].'" and PBI_ID='.$employee->PBI_ID);?></td>
	 
 </tr>
	
	<tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;" colspan="4">Absent : <?=find_a_field('salary_attendence_lock','sum(ab)','year="'.$_POST['year'].'" and PBI_ID='.$employee->PBI_ID);?></td>
...
$welcome = find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$employee->PBI_ID);

$g_s_date= $_POST['year'].'-'.'01'.'-01'; //date('Y-01-01');
$g_e_date= $_POST['year'].'-'.'12'.'-31'; //date('Y-12-31');    

$hrm_leave_info=find_all_field('hrm_leave_info','','PBI_ID='.$employee->PBI_ID);
...
?>
	...
	<div align="center" class="style1"><b>Individual Leave Status <?php echo $_POST['year'];?></b></div></td>
    </tr>
...
<!-- Leave STATUS OFFFFFF -->
 ...
 <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-color:#ccc">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px; border:1px">
      <td style="padding:5px;" colspan="4"><b>Total Score : <?=$Total_Score;?></b></td>
  ...
  <!--    <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr style="font-family: Cambria,Georgia,serif;">
        ...
        <td style="font-size:16px; padding:2px;">Designation of Appraiser : <b>
          <?=find_a_field('designation','DESG_DESC','DESG_ID='.$appraiser->PBI_DESIGNATION);?>
          </b></td>
        <td></td>
      </tr>
    </table>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:18px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <!--
		...
		<td style="padding:5px;">8. Displays a willingness to learn <br> <span style="font-size:14px">নতুন কিছু শিখতে আগ্রহী কি না </span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <?php /*?><td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Safety</span></td>
		...
		<td style="padding:5px;">Ensures careful work habits that comply with safety requirements<br>
			<span style="font-size:14px">সাবধানতার সহিত কাজ করে প্রয়োজনীয় নিরাপত্তা সন্তুষ্ট করে কি না</span></td>



		<td style="padding:5px;" align="center"><?=$question10?></td>

		<td style="padding:5px;" align="center"><?=rating($question10)?></td><?php */?>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Process Improvement </span></td>
      <td style="padding:5px;">11. Seeks to continuously improve processes and work methods.<br>
...
-->
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <?php /*?>
		...
		<td style="padding:5px;">13. Handles problem situations effectively<br><span style="font-size:14px">যে কোন সমস্যা সামনে আসলে তা সঠিকভাবে পরিচালনা করতে বা সামলাতে পারে কি না </span></td>



		<td style="padding:5px;" align="center"><?=$question13?></td>

		<td style="padding:5px;" align="center"><?=rating($question13)?></td><?php */?>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="2"  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Motivation of Staff</span> </th>
      <td style="padding:5px;">13. Is a positive role model for other staff.<br>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <?php /*?>
		...
		<td style="padding:5px;">Is trustworthy, responsible and reliable<br><span style="font-size:14px">বিশ্বাসযোগ্য, দায়িত্ববান এবং নির্ভরযোগ্য কি না</span> </td>



		<td style="padding:5px;" align="center"><?=$question17?></td>

		<td style="padding:5px;" align="center"><?=rating($question17)?></td><?php */?>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">16. Is adaptable and willing to accept new responsibilities.<br>
        <span style="font-size:14px">যে কোন নতুন পরিস্থিতিতে বা অবস্থায় মানিয়ে চলতে পারে এবং নতুন দায়িত্ব গ্রহণ করতে আগ্রহী কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <?php /*?> <td style="padding:5px;">Is punctual at work <br> <span style="font-size:14px">কর্মক্ষেত্রে সময়নিষ্ঠ কি না</span></td>
     <td style="padding:5px;" align="center"><?=$question20?></td>
     <td style="padding:5px;" align="center"><?=rating($question20)?></td><?php */?>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="4"><?=$extension_dateee = '(Extension Date:'.date('d-M-Y',strtotime($extension_datee)).')';?></td>
    </tr>
    <? }?>
    <!--Part-2 End-->
    <!--Part-2 End-->
...
$sql2=  'select id, part_1 as part_1,part_2 as part_2,part_3 as part_3,part_4 as part_4,part_5 as part_5,part_6 as part_6,part_7 as part_7,part_8 as part_8,
 part_9 as part_9,part_10 as part_10,part_11 as part_11,part_12 as part_12,part_13 as part_13,part_14 as part_14,part_15 as part_15,
 part_16 as part_16,part_17 as part_17,part_18 as part_18,part_19 as part_19,part_20 as part_20,part_21 as part_21,part_22 as part_22,part_23 as part_23,
 part_24 as part_24,part_25 as part_25,total_score as total_score,extension_date,part_1_comment,part_2_comment,part_3_comment,part_4_comment,part_5_comment,PBI_ID,entry_by

 from performance_appraisal where PBI_ID = "'.$pbi_code.'" and   EMPLOYMENT_TYPE="Probationary"   and 
 year='.$_POST['year'].' and status="DONE" order by id desc LIMIT 1';
$query = mysql_query($sql2);
...
$appraiser_info=find_a_field('personnel_basic_info','PBI_DESIGNATION','PBI_ID="'.$result->entry_by.'"');
...
?>
    ...
    <thead>
      ...
      <tr height="60">
        <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
          ...
          <tr style="font-family: Cambria,Georgia,serif;">
            <td style="font-size:16px; padding:2px;">Name of Appraiser : <b>
              <? //=$appraiser->PBI_NAME?>   <?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID="'.$result->entry_by.'"');?>
              </b></td>
            <td style="font-size:16px; padding:2px;">Designation of Appraiser : <b>
              <?=find_a_field('designation','DESG_DESC','DESG_ID='.$appraiser_info);?>  
              </b></td>
            <td></td>
          </tr>
        </table>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:18px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Teamwork</span></td>
      <td style="padding:5px;">Able and willing to work effectively with others in a team <br>
        <span style="font-size:14px">দলের অন্যদের সঙ্গে কাজ করতে ইচ্ছুক এবং সক্ষম কি না</span></td>
      <td style="padding:5px;" align="center"><?=$question1?></td>
      <td style="padding:5px;" align="center"><?=rating($question1)?></td>
    </tr>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold; text-align:center" ><span style="writing-mode: sideways-lr;">Individual  Task</span></td>
      <td style="padding:5px;">Completes tasks in an error free manner and within the timeframe.<br>
        <span style="font-size:14px">নির্ভুলভাবে এবং নির্ধারিত সময়সীমার মধ্যে কাজগুলি সম্পূর্ণ করে। </span></td>
      <td style="padding:5px;" align="center"><?=$question22?></td>
      <td style="padding:5px;" align="center"><?=rating($question22)?></td>
    </tr>
    ...
    <!--Part-2-->
    <tr>
      <td style="padding:5px;font-family: Cambria,Georgia,serif;background-color:#59B2EA; font-size: 18px;width:40%" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <b>PART II &nbsp;&nbsp;</b> <b>PRODUCTS AND SERVICES</b></td>
      <td style="padding:5px; font-family: Cambria,Georgia,serif; font-size:18px;width:10%;background-color:#59B2EA" align="center" colspan="2"><b>Rating</b></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Shows technical competence/skill in area of specialization<br>
        <span style="font-size:15px">বিশেষ ক্ষেত্রে প্রযুক্তিগত দক্ষতা বা পারদর্শিতা রয়েছে কি না</span></td>
      <td style="padding:5px;" align="center"><?=$question4?></td>
      <td style="padding:5px;" align="center"><?=rating($question4)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="3" style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Work Attitude </span></th>
      <td style="padding:5px;">Displays commitment to work<br>
        <span style="font-size:14px">কাজের প্রতি নিবেদিত বা প্রতিজ্ঞাবদ্ধ কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question5?></td>
      <td style="padding:5px;" align="center"><?=rating($question5)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Displays a willingness to learn <br>
        <span style="font-size:14px">নতুন কিছু শিখতে আগ্রহী কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question6?></td>
      <td style="padding:5px;" align="center"><?=rating($question6)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;"> Quantity of Work </span></td>
      <td style="padding:5px;">Is able to handle a reasonable volume of work<br>
        <span style="font-size:14px">নির্দিষ্ট পরিমানের কাজের চাপ সামলাতে সক্ষম কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question9?></td>
      <td style="padding:5px;" align="center"><?=rating($question9)?></td>
    </tr>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:16px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">Helps resolve staff problems on work related matters<br>
        <span style="font-size:14px">কাজ সম্পর্কিত বিষয়ে স্টাফদের সমস্যা সমাধান করতে আন্তরিক কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question12?></td>
      <td style="padding:5px;" align="center"><?=rating($question12)?></td>
    </tr>
    <!--Part-1 End-->
    <!--Part-2-->
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Handles problem situations effectively<br>
        <span style="font-size:14px">যে কোন সমস্যা সামনে আসলে তা সঠিকভাবে পরিচালনা করতে বা সামলাতে পারে কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question13?></td>
      <td style="padding:5px;" align="center"><?=rating($question13)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="2"  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Motivation of Staff</span> </th>
      <td style="padding:5px;">Is a positive role model for other staff?<br>
        <span style="font-size:14px">অন্য কর্মীদের জন্য একজন আদর্শবান কর্মী কি না</span></td>
      <td style="padding:5px;" align="center"><?=$question14?></td>
      <td style="padding:5px;" align="center"><?=rating($question14)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Effectively supervises work of subordinates<br>
        <span style="font-size:14px">সঠিকভাবে অধীনস্তদের কাজ তত্ত্বাবধান করে কি না</span></td>
      <td style="padding:5px;" align="center"><?=$question15?></td>
      <td style="padding:5px;" align="center"><?=rating($question15)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="3"  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Dependability / Responsibility</span></th>
      <td style="padding:5px;">Is able to work with limited supervision<br>
        <span style="font-size:14px">অল্পতেই কাজ বুঝিয়ে দিলে কাজ করতে সক্ষম কি না </span> </td>
      <td style="padding:5px;" align="center"><?=$question16?></td>
      <td style="padding:5px;" align="center"><?=rating($question16)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Is trustworthy, responsible and reliable<br>
        <span style="font-size:14px">বিশ্বাসযোগ্য, দায়িত্ববান এবং নির্ভরযোগ্য কি না</span> </td>
      <td style="padding:5px;" align="center"><?=$question17?></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="2"  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Attendance/Punctuality</span></th>
      <td style="padding:5px;">Has good attendance<br>
        <span style="font-size:14px">পর্যাপ্ত উপস্থিতি বা হাজিরা রয়েছে কি না </span></td>
      <td style="padding:5px;" align="center"><?=$question19?></td>
      <td style="padding:5px;" align="center"><?=rating($question19)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Is punctual at work <br>
        <span style="font-size:14px">কর্মক্ষেত্রে সময়নিষ্ঠ কি না</span></td>
      <td style="padding:5px;" align="center"><?=$question20?></td>
      <td style="padding:5px;" align="center"><?=rating($question20)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
...
//date_format(a.PBI_DOJ,'%d-%M-%Y')
    ...
    $sqld="select a.PBI_ID,a.PBI_CODE,a.PBI_NAME,date_format(a.PBI_DOJ,'%d-%b-%Y') as joining_date,desg.DESG_DESC as designation,(select DEPT_DESC from department where DEPT_ID=a.PBI_DEPARTMENT) as department,
		...
		from personnel_basic_info a,performance_appraisal b, designation desg
		 where b.status='DONE' and b.EMPLOYMENT_TYPE='Permanent'  and year='".$_POST['year']."' and a.PBI_DESIGNATION=desg.DESG_ID and a.PBI_ID=b.PBI_ID ".$cons." group by b.PBI_ID";
...
$avg_score = round($data->total_score);
...
//date_format(a.PBI_DOJ,'%d-%M-%Y')
    ...
    $sqld="select a.PBI_ID,a.PBI_CODE,a.PBI_NAME,date_format(a.PBI_DOJ,'%d-%b-%Y') as joining_date,desg.DESG_DESC as designation,(select DEPT_DESC from department where DEPT_ID=a.PBI_DEPARTMENT) as department,
		(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) as project,AVG(b.total_score) as total_score,b.recommendation as final_recommendation,b.extension_date
		from personnel_basic_info a,performance_appraisal b, designation desg
		 where b.status='DONE' and b.EMPLOYMENT_TYPE='Probationary'  and year='".$_POST['year']."' and a.PBI_DESIGNATION=desg.DESG_ID and a.PBI_ID=b.PBI_ID ".$cons." group by b.PBI_ID";
...
//for loop 
 $sql2=  'select *
from performance_appraisal where PBI_ID = '.$pbi_id.'  and year='.$_POST['year'].' and status="DONE" group by entry_by ';
...
$employee = find_all_field('personnel_basic_info','','PBI_ID="'.$pbi_id.'"');

$line_manager = find_a_field('hrm_pa_set','LINE_MANAGER','PBI_ID="'.$pbi_id.'"');

//$appraiser = find_all_field('personnel_basic_info','','PBI_ID="'.$line_manager.'"');

$pa = find_all_field('performance_appraisal','','PBI_ID="'.$pbi_id.'" and year="'.$_POST['year'].'" and status="DONE"');
 ...
 AVG(part_24) as part_24,AVG(part_25) as part_25,AVG(total_score) as total_score,entry_by,extension_date

 from performance_appraisal where PBI_ID = '.$pbi_id.'  and year='.$_POST['year'].' and status="DONE"';
...
-->
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px; text-align:center" >Achievement (Only for reporting authorities )</td>
      <td style="padding:5px;" colspan="3"><?=$pa->achievements?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;" >Total Score : </td>
      <td style="padding:5px;" colspan="4"><?=$Total_Score;?></td>
...
//for loop 
  $sqlll2=  'select * from performance_appraisal where PBI_ID = '.$pbi_id.'  and year='.$_POST['year'].' and status="Done" and EMPLOYMENT_TYPE="Permanent" GROUP BY entry_by ';
$querylll2 = mysql_query($sqlll2);
//echo mysql_num_rows($querylll2);
while($loop2= mysql_fetch_object($querylll2)){

$employee = find_all_field('personnel_basic_info','','PBI_ID="'.$pbi_id.'"');
$line_manager = find_a_field('hrm_pa_set','LINE_MANAGER','PBI_ID="'.$pbi_id.'"');
$pa = find_all_field('performance_appraisal','','PBI_ID="'.$pbi_id.'" and year="'.$_POST['year'].'" and status="DONE"');
$appraiser_info=find_a_field('personnel_basic_info','PBI_DESIGNATION','PBI_ID="'.$loop2->entry_by.'"');
 ...
 ?>
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center">
      ...
      <tr style="font-family: Cambria,Georgia,serif;">
        <td style="font-size:16px; padding:2px;">Name of Appraiser : <b>
          <?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID="'.$loop2->entry_by.'"');?>
          </b></td>
        <td style="font-size:16px; padding:2px;">Designation of Appraiser : <b>
          <?=find_a_field('designation','DESG_DESC','DESG_ID='.$appraiser_info);?>
          </b></td>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:18px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">1. Able and willing to work effectively with others in a team. <br>
        <span style="font-size:14px">দলের অন্যদের সঙ্গে কাজ করতে ইচ্ছুক এবং সক্ষম কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_1;?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_1)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold; text-align:center" ><span style="writing-mode: sideways-lr;">Communication Skills</span></td>
      <td style="padding:5px;">2. Highly disciplined in conveying information through presentations and does proper use of English while communicating via email or any other medium.<br>
        <span style="font-size:14px">উপস্থাপনার মাধ্যমে তথ্য জানানোর ক্ষেত্রে অত্যন্ত সুশৃঙ্খল এবং ইমেইল বা অন্য কোনো মাধ্যমে যোগাযোগ করার সময় ইংরেজির যথাযথ ব্যবহার করে থাকে।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_2?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_2)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold; text-align:center" ><span style="writing-mode: sideways-lr;">Analytical Skills</span></td>
      <td style="padding:5px;">3. Analyzes data and information from several sources and arrives at logical conclusions.<br>
        <span style="font-size:14px">বিভিন্ন উৎস থেকে ডেটা এবং তথ্য বিশ্লেষণ করে এবং যৌক্তিক সিদ্ধান্তে পৌঁছায় কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_21?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_21)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold; text-align:center" ><span style="writing-mode: sideways-lr;">Individual  Task</span></td>
      <td style="padding:5px;">4. Completes tasks in an error free manner and within the timeframe.<br>
        <span style="font-size:14px">নির্ভুলভাবে এবং নির্ধারিত সময়সীমার মধ্যে কাজগুলি সম্পূর্ণ করে। </span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_22?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_22)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$loop2->part_1_comment?></td>
    </tr>
    <!--Part-1 End-->
    <!--Part-2-->
    <tr>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">5. Possesses knowledge of work procedures and requirements of job.<br>
        <span style="font-size:14px">কাজের পদ্ধতি জানে এবং কাজের জন্য প্রয়োজনীয় জ্ঞান সম্পন্ন কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_3?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_3)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">6. Shows technical competence/skill in area of specialization.<br>
        <span style="font-size:15px">বিশেষ ক্ষেত্রে প্রযুক্তিগত দক্ষতা বা পারদর্শিতা রয়েছে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_4?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_4)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="3" style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Work Attitude </span></th>
      <td style="padding:5px;">7. Displays commitment to work and willingness to learn.<br>
        <span style="font-size:14px">কাজের প্রতি নিবেদিত বা প্রতিজ্ঞাবদ্ধ এবং নতুন কিছু শিখতে আগ্রহী কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_5?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_5)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px"></tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">8. Has a sense of urgency in acting on work matters.<br>
        <span style="font-size:14px">জরুরীভিত্তিতে কাজ করার প্রবণতা রয়েছে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_7?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_7)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Quality of Work</span> </td>
      <td style="padding:5px;">9. Is accurate, thorough and careful with work performed.<br>
        <span style="font-size:14px">কাজ নির্ভুল,সঠিক এবং সতর্কতার সঙ্গে সম্পন্ন করে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_8?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_8)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;"> Quantity of Work </span></td>
      <td style="padding:5px;">10. Is able to handle a reasonable volume of work.<br>
        <span style="font-size:14px">নির্দিষ্ট পরিমানের কাজের চাপ সামলাতে সক্ষম কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_9?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_9)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px"></tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Process Improvement </span></td>
      <td style="padding:5px;">11. Seeks to continuously improve processes and work methods.<br>
        <span style="font-size:14px">সবসময় কাজের পদ্ধতি এবং প্রক্রিয়ার উন্নতি করতে চায় কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_11?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_11)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px; text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$loop2->part_2_comment?></td>
    </tr>
    <!--Part-2 End-->
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">12. Helps resolve problems on work-related matters.<br>
        <span style="font-size:14px">কাজ সম্পর্কিত বিষয়ে সমস্যা সমাধান করতে পারে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_12?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_12)?></td>
    </tr>
    <!--Part-1 End-->
    <!--Part-2-->
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px"></tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">13. Is a positive role model for other staff.<br>
        <span style="font-size:14px">অন্য কর্মীদের জন্য একজন আদর্শবান কর্মী কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_14?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_14)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">14. Motivates team members to improve their quality of work.<br>
        <span style="font-size:14px">দলের অন্যান্য সদস্যদের কাজের মান উন্নত করতে অনুপ্রাণিত করে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_15?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_15)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$loop2->part_3_comment?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px;background-color:#59B2EA">
      <td style="padding:5px; width:40%" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <input type="hidden" name="pre_score" id="pre_score" value="<?=find_a_field(' performance_appraisal','total_score','PBI_ID="'.$_GET['id'].'" and year="'.$_GET['year'].'"');?>" />
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">15. Is able to work with limited supervision.<br>
        <span style="font-size:14px">অল্পতেই কাজ বুঝিয়ে দিলে কাজ করতে সক্ষম কি না।</span> </td>
      <td style="padding:5px;" align="center"><?=$loop2->part_16?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_16)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px"></tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">16. Is adaptable and willing to accept new responsibilities.<br>
        <span style="font-size:14px">যে কোন নতুন পরিস্থিতিতে বা অবস্থায় মানিয়ে চলতে পারে এবং নতুন দায়িত্ব গ্রহণ করতে আগ্রহী কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_18?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_18)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <th rowspan="2"  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Attendance/Punctuality</span></th>
      <td style="padding:5px;">17. Is punctual and has good attendance.<br>
        <span style="font-size:14px">কর্মক্ষেত্রে সময়নিষ্ঠ  এবং পর্যাপ্ত উপস্থিতি বা হাজিরা রয়েছে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_20?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_20)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:20px;text-align:center" >Comments</td>
      <td style="padding:5px;" colspan="3"><?=$loop2->part_4_comment?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px;background-color:#59B2EA">
      <td style="padding:5px; width:40%" align="left" colspan="2"><input type="hidden" name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" />
        <input type="hidden" name="pre_score" id="pre_score" value="<?=find_a_field(' performance_appraisal','total_score','PBI_ID="'.$_GET['id'].'" and year="'.$_GET['year'].'"');?>" />
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">18. Able to stay polite in any interaction and treat everybody with respect.<br>
        <span style="font-size:14px">যেকোনো পরিস্থিতিতে মার্জিত এবং সবার সাথে সম্মানের সাথে আচরণ করতে সক্ষম কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_23?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_23)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Cooperation</span></td>
      <td style="padding:5px;">19. Willingness to work harmoniously with others in getting a job done.<br>
        <span style="font-size:14px">একটি কাজ সম্পন্ন করার জন্য অন্যদের সাথে তাল মিলিয়ে চলার ইচ্ছা শক্তি পোষণ করে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_24?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_24)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td  style="padding:5px; background-color: #EAEAE8; font-weight:bold;text-align:center" ><span style="writing-mode: sideways-lr;">Emotional Intelligence</span></td>
      <td style="padding:5px;">20. Tries to understand others’ point of view before making judgments.<br>
        <span style="font-size:14px">বিচার করার আগে অন্যদের দৃষ্টিভঙ্গি বোঝার চেষ্টা করে কি না।</span></td>
      <td style="padding:5px;" align="center"><?=$loop2->part_25?></td>
      <td style="padding:5px;" align="center"><?=rating($loop2->part_25)?></td>
    </tr>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;" >Comments</td>
      <td style="padding:5px;" colspan="4"><?=$loop2->part_5_comment?></td>
    </tr>
  ...
  <tr>
	...
	<tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;" colspan="4"><?=$loop2->achievements?></td>
    </tr>
...
<!-- Leave STATUS OFFFFFF -->
 ...
 <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-color:#ccc">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px; border:1px">
      <td style="padding:5px;" colspan="4"><b>Total Score : <?=$loop2->total_score;?></b></td>
  
    </tr>
	
	
    <? if($loop2->extension_date>0){ ?>
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;" >Remarks : </td>
      <td style="padding:5px;" colspan="4"><?=$extension_dateee = '(Extension Date:'.date('d-M-Y',strtotime($loop2->extension_date)).')';?></td>
    </tr>
    <? }?>
    <!--Part-2 End-->
	</table>
