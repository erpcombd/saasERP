  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:18px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">6. Shows technical competence/skill in area of specialization.<br>
        <span style="font-size:15px">বিশেষ ক্ষেত্রে প্রযুক্তিগত দক্ষতা বা পারদর্শিতা রয়েছে কি না।</span></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;">15. Is able to work with limited supervision.<br>
        <span style="font-size:14px">অল্পতেই কাজ বুঝিয়ে দিলে কাজ করতে সক্ষম কি না।</span> </td>
  ...
  <table width="100%" border="1" cellspacing="0" cellpadding="0" align="center" style="font-size:16px;">
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;">Is trustworthy, responsible and reliable<br>
        <span style="font-size:14px">বিশ্বাসযোগ্য, দায়িত্ববান এবং নির্ভরযোগ্য কি না</span> </td>
      <td style="padding:5px;" align="center"><?=$question17?></td>
    ...
    <tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      ...
      <td style="padding:5px;font-family: Cambria,Georgia,serif; font-size: 18px;width:40%;background-color:#59B2EA" align="center" colspan="11">
	    <b>ATTENDANCE (Late and absenteeism) </b></td>
    ...
    <td style="padding:5px;" colspan="11">Late : <?=find_a_field('salary_attendence_lock','sum(lt)','year="'.$_GET['year'].'" and PBI_ID='.$_GET['id']);?></td>
	 
 </tr>
	
	<tr style="font-family: Cambria,Georgia,serif; font-size:18px">
      <td style="padding:5px;" colspan="11">Absent : <?=find_a_field('salary_attendence_lock','sum(ab)','year="'.$_GET['year'].'" and PBI_ID='.$_GET['id']);?></td>
...
if($_POST['PBI_CODE']!='') $cons.=' and a.PBI_ID ="'.$pbi_id.'"';

if($_POST['gender']!='') $cons.=' and a.PBI_SEX ="'.$_POST['gender'].'"';

//if($_POST['year']!='') $year.=' and b.year ="'.$_POST['year'].'"';
if($_POST['assessment_year']!='') $ass_year.=' and b.assessment_year ="'.$_POST['assessment_year'].'"';
...
//and year='".$_POST['year']."'
    ...
    $sqld="select a.PBI_ID,a.PBI_CODE,a.PBI_NAME,date_format(a.PBI_DOJ,'%d-%b-%Y') as joining_date,desg.DESG_DESC as designation,(select DEPT_DESC from department where DEPT_ID=a.PBI_DEPARTMENT) as department,
		...
		from personnel_basic_info a,performance_appraisal b, designation desg
		 where b.status='DONE' and b.EMPLOYMENT_TYPE='Permanent' and 
		 
		 a.PBI_DESIGNATION=desg.DESG_ID and a.PBI_ID=b.PBI_ID ".$cons.$year.$ass_year." group by b.PBI_ID";
