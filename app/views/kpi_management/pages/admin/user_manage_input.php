...
<body>
    ...
    </span></span></td></tr><tr class="oe_form_group_row"><td colspan="1" class="oe_form_group_cell oe_form_group_cell_label" width="1%"><label>Password:</label></td><td colspan="1" class="oe_form_group_cell" width="99%"><input name="password" type="password" id="password" value="<?=$password?>" /></td></tr></tbody></table></td></tr></tbody></table></div>
                      </div>
                    </div>
                  </div>
                </div>
