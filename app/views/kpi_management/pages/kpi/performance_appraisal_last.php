...
if(isset($_POST['submit']))
	{
		...
		$total_score = ($task_total+$log_total+$over_time)-$error_total;
  ...
  <script>
     function cal(){
		...
		var ot = parseInt(document.getElementById('over_time').value);
		 ...
		 var total_score = gm_deduct+sm_deduct;
		 
		 document.getElementById('score').value = total_score;
		 document.getElementById('overtime').value = ot_score;
...
<table width="100%" border="0" cellspacing="5" cellpadding="2" align="center" style="padding:5px;">
			<tr>
			   ...
			   <td colspan="9"><div align="center"><strong>Total Overtime Marks:</strong> <input type="text" name="overtime" value="0" id="overtime" style="width: 15%; border-radius: 0px; height: 40px;border-color:#337AB7;" /></div></td>
			</tr>
