...
<div class="oe_view_manager oe_view_manager_current">
  ...
  from personnel_basic_info p, designation desg, hrm_kpi_set e where p.PBI_DESIGNATION=desg.DESG_ID and p.PBI_ID=e.PBI_ID and p.PBI_JOB_STATUS='In Service' and e.LINE_MANAGER=".$_SESSION['employee_selected'];
