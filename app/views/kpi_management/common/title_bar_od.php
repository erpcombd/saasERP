...
<?  $unique_idd =  $_GET['id'];?>
			...
			<table width="100%" border="0" align="left" cellpadding="0" cellspacing="0" style="height:25px; float:right">
              ...
              <tr>
				...
				$sql =  @mysql_query("select PBI_NAME, PBI_DEPARTMENT, PBI_DESIGNATION,JOB_LOCATION, PBI_CODE from personnel_basic_info where PBI_ID = ".$_SESSION['employee_selected']."");
