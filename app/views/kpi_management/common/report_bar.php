<header>
    ...
    <span class="oe_form_buttons_edit" style="display: inline;">
      <a href="<?=$input_page?>" rel = "gb_page_center[940, 600]"><button name="insert" accesskey="S" class="oe_button oe_form_button_save oe_highlight" type="button">Add New</button></a>
    </span>
