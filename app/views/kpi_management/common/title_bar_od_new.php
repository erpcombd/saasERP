<table class="oe_view_manager_header" >
	...
	<? $unique_id =  $_GET['id'];?>
		...
		<?
			  if($unique_id>0){
			  $unique_pbi_id = find_a_field('hrm_od_info','PBI_ID','id='.$unique_id);
			?>
			<td colspan="2">
		   ...
		   <td  align="center" valign="middle" width="80"><strong style="color:#FFF; font-size:16px;"><em><img src="../../../hrm_mod/pic/staff/<?=$unique_pbi_id?>.jpeg" style="border-radius: 100%; width: 100px; margin:0px; margin-top: 7px; " class="img-circle profile_img modal-content" width="120" height="100" hspace="5" vspace="0" /></em></strong></td>
				...
				$sql =  @mysql_query("select PBI_NAME, PBI_DEPARTMENT, PBI_DESIGNATION,JOB_LOCATION, PBI_ID from personnel_basic_info where PBI_ID = ".$unique_pbi_id."");
  ...
  <? } else{?>
	...
	<td colspan="2">
		   ...
		   <td  align="center" valign="middle" width="80"><strong style="color:#FFF; font-size:16px;"><em><img src="../../../hrm_mod/pic/staff/<?=$_SESSION['employee_selected']?>.jpeg" style="border-radius: 100%; width: 100px; margin:0px; margin-top: 7px; " class="img-circle profile_img modal-content" width="120" height="100" hspace="5" vspace="0" /></em></strong></td>
