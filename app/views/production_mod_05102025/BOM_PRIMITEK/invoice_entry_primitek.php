...
window.location.href = "invoice_entry_primitek.php?request_no=<?=$bom_no?>";
...
if(isset($_POST['create'])){
 ...
 $unit_per_qty = (((float)$_POST['total_unit_r']) / ((float)$ms_data->quantity));
	...
	/* if($item_id>0 && $_POST['unit_price']>0) {}else{echo "<script>alert('Rate Not Found.')</script>";}*/

	   $ins_sql = 'INSERT INTO bom_raw_material 
	   (bom_no, group_for, bom_date, fg_item_id, item_id, unit_name,total_unit,unit_per_qty, status, entry_at, entry_by) 
	   VALUES
("'.$bom_no.'", "'.$group_for.'", "'.$bom_date.'", "'.$fg_item_id.'", "'.$item_id.'", "'.$unit_name.'", "'.$total_unit.'","'.$unit_per_qty.'", "'.$status.'", "'.$entry_at.'", "'.$entry_by.'")';
...
window.location.href = "invoice_entry_primitek.php";
...
<div class="box" style="width:100%;">
  ...
  <form method="post">
    <div class="row mb-3">
      <!-- Company -->
      <div class="col-md-2">
        <label for="group_for" class="form-label"><strong>Company:</strong></label>
      ...
      <!-- Date -->
      <div class="col-md-2">
        <label for="inv_date" class="form-label"><strong>Date:</strong></label>
        <input type="text" name="inv_date" id="inv_date" 
               class="form-control"
               value="<?=$_POST['inv_date']?>" required autocomplete="off" />
      </div>

      <!-- Product -->
      <div class="col-md-3">
        <label for="fg_item_id" class="form-label"><strong>Product:</strong></label>
        <select name="fg_item_id" id="fg_item_id" class="form-control">
      ...
      <!-- Section -->
      <div class="col-md-3">
        <label for="warehouse_id" class="form-label"><strong>Section:</strong></label>
    ...
    <!-- View Data button row -->
    <div class="row">
      <div class="col text-center">
        <input type="submit" name="master_data" id="master_data" 
               value="View Data" 
...
<div class="box" style="width:100%;">
	...
	<input name="bom" type="text" id="bom" style="width:90%; height:32px;" value="<?=$ms_data->inv_type;?><?=$ms_data->bom_no;?>" readonly="" required tabindex="1" /></td>
	...
	<input name="item_name" type="text" id="item_name" style="width:90%; height:32px;" value="<?=find_a_field('item_info','item_name','item_id="'.$ms_data->fg_item_id.'"'); ?>" readonly="" required tabindex="1" />
					...
					<input name="group_for" type="hidden" id="group_for" style="width:90%; height:32px;" value="<?=$ms_data->group_for;?>" readonly="" required tabindex="1" />
									...
									<input name="warehouse_id" type="hidden" id="warehouse_id" style="width:90%; height:32px;" value="<?=$ms_data->warehouse_id;?>" readonly="" required tabindex="1" />									</td>
