...
window.location.href = "../mr/select_unchecked_wip.php?sub_group=" + id;
...
<label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">From Warehouse :</label>
