...
and "'.date('Y-m-d').'"';}
  ...
  from master_wip_master m,warehouse w

  where m.from_warehouse_id=w.warehouse_id and m.status="UNCHECKED" '.$con.' order by m.req_no desc';
          ...
          ?>
            <tr>
              ...
              <td class="text-center">
                <a href="mr_check.php?old_req=<?=$data->req_no?>">
                  <input type="button" value="Complete Now"  class="btn1 btn1-submit-input"/>
                </a>
              </td>
            </tr>
