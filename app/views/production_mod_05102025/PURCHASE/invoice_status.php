...
div.form-container_large input {
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
        ...
        <tr>
          <td align="right" style="background-color:#FF9966;"><strong> PO No: </strong></td>
          <td colspan="3" style="background-color:#FF9966;">
		  <select name="invoice_no" id="invoice_no" style="width:200px;" >

        <option value=""></option>

		<? foreign_relation('purchase_foreign_master','invoice_no','view_invoice_no',$_POST['invoice_no'],'1 group by invoice_no');?>
...
<tr>
  <th width="9%"><strong>PO</strong> No </th>
  <th width="12%"><strong>PO</strong> Date </th>
...
//		}
    ...
    $res="select  m.* from  purchase_foreign_master m, purchase_foreign_details d where m.invoice_no=d.invoice_no and  m.status!='MANUAL'  ".$con.$req_no_con." group by m.invoice_no order by m.invoice_date, m.invoice_no";
