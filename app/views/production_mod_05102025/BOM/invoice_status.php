...
<td  <?=(++$z%2)?'':'';?>><?=$data->bom_no;?></td>

<td  <?=(++$z%2)?'':'';?>>&nbsp;<?= date("d-m-Y",strtotime($data->bom_date));?></td>

<td <?=(++$z%2)?'':'';?>><?= find_a_field('item_info','concat(finish_goods_code,"-",item_name)','item_id="'.$data->fg_item_id.'"');?></td>

<td  <?=(++$z%2)?'':'';?>><?= find_a_field('user_activity_management','fname','user_id="'.$data->entry_by.'"');?></td>
