...
$con .= ' and m.group_for in ('.$user_group_define.') ';
...
//		}
   ...
   $res="select  m.* from  bom_master m where m.status='MANUAL' ".$con." order by m.bom_date, m.bom_no";
...
<td onClick="custom(<?=$data->bom_no;?>);" <?=(++$z%2)?'':'class="alt"';?>><?=$data->bom_no;?></td>
