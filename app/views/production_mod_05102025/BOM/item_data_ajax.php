...
$data=explode('##',$str);
 ...
 $rate = find_a_field('journal_item','final_price','item_id= '.$item_id.' and final_price>0 order by id desc');
...
?>
	 ...
	 <input name="unit_price" type="hidden" class="input3"  value="<?=$rate;?>" id="unit_price" style="width:90%; height:30px;" />
