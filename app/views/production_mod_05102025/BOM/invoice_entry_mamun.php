...
window.location.href = "invoice_entry_mamun.php?request_no=<?=$bom_no?>";
</script>
...
if(isset($_POST['foe_amt'])){
	...
	db_query($sql_del_foe);
	 ...
	 where l.group_id=a.ledger_group_id and a.ledger_group_id=411135 order by l.group_id, a.ledger_id';
...
<script language="javascript">
window.location.href = "invoice_entry_mamun.php";
</script>
...
<?
	...
	from ledger_group l, accounts_ledger a where l.group_id=a.ledger_group_id and a.ledger_group_id=411135
...
<div class="box" style="width:100%;">
    ...
    <td  ><input name="inv_date" type="text" id="inv_date" style="width:90%; height:32px;" value="<?=$_POST['inv_date']?>" required tabindex="1" /></td>
	...
	<td  align="right" ><strong> Production Line: </strong></td>
	 <td  >
...
<input name="foe_amt_<?=$data->ledger_id?>" type="text" id="foe_amt_<?=$data->ledger_id?>" value="<?=$foe_exp[$data->ledger_id]; $tot_foe_exp +=$foe_exp[$data->ledger_id];?>" onkeyup="SUMcalculation(<?=$data->ledger_id?>)"  style="width:120px; height:30px;" />	
 ...
 <? } ?>
  ...
  <tr>
    ...
    <td align="center" style="background-color:#99CCFF;"><div align="center"><strong>Total</strong></div></td>
    <td style="background-color:#99CCFF;" align="right"><input name="foe_amt" id="foe_amt" type="text" size="10"  value="<?=$tot_foe_exp;?>" style="width:120px; height:30px;" readonly="" /></td>
  </tr>
...
<? //if($po_no[$data->po_no]==0) { } ?>
  ...
  <tr style="background-color: <?= ($i % 2) ? '#E8F3FF' : '#fff'; ?>;">
    ...
    <td bstyle="background-color:#99CCFF;">
