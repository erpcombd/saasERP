...
<tr>
        ...
        <td valign="top" style="text-align:right;"><?=number_format($info2->total_unit,5); $total_unit_quantity_raw += number_format($info2->total_unit,5) ?> </td>
...
<tr style="background-color:#CFFCF0;" class="print-bg-row">
        ...
        <td align="right" valign="top"><strong><?=number_format($total_unit_quantity_raw,5); ?></strong></td>
...
<tr>
        ...
        <td valign="top" style="text-align: right;"><?=number_format($info4->total_unit,5); $total_quantity_by_product += number_format($info4->total_unit,5) ?></td>
...
<tr style="background-color:#CFFCF0;" class="print-bg-row">
        ...
        <td align="right" valign="top"><strong><?=number_format($total_quantity_by_product,5); ?></strong></td>
