...
<td style="text-align: left"><?=find_a_field('acc_class','class_name','id='.$rp[2]);?></td>
<td style="text-align: left"><?=find_a_field('acc_sub_class','sub_class_name','id='.$rp[3]);?></td>
<td style="text-align: left"><?=find_a_field('acc_sub_sub_class','sub_sub_class_name','id='.$rp[5]);?></td>
<td style="text-align: left"><?=find_a_field('ledger_group','group_name','group_id='.$rp[4]);?></td>
...
<?php }?>
		...
		<form class="n-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <h4 style="text-align: center" class="n-form-titel1"> <?=$title?></h4>
