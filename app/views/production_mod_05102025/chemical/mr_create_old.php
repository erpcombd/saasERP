...
if(isset($_POST['add'])&&($_POST[$unique]>0)){
	$crud   = new crud($table_details);
		echo $_POST['qty']=$_POST['order_qty'];
	$_POST['req_for'] = $req;
...
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_description,"#>",item_id)',' sub_group_id like "%'.$get_data.'%"','item_id');
  ...
  <tr>
    ...
    <? $field='req_for';?>
      ...
      <div>
        ...
        <select id="<?=$field?>" name="<?=$field?>"  onchange="getData2('manual_req_no_ajax.php', 'manual_req_no', this.value, document.getElementById('req_no').value);" required  >
<? 
if($_POST['req_for']>0)
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
						...
						<td width="12%" align="center" bgcolor="#0099FF"><strong>Sub Group</strong></td>
                        <td width="31%" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>
                        <td width="11%" align="center" bgcolor="#0099FF"><strong>Delivery Date</strong></td>
						
                        <td width="13%" align="center" bgcolor="#0099FF"><strong>CWH Qty</strong></td>
                        <td width="7%" align="center" bgcolor="#0099FF"><strong>Floor Qty</strong></td>
                        <td width="9%" align="center" bgcolor="#0099FF"><strong>Unit</strong></td>
                        <td width="4%" align="center" bgcolor="#0099FF"><strong>Req Qty</strong></td>


                        <td width="9%" align="center" bgcolor="#0099FF"><strong>Remark</strong></td>


                        <td width="4%"  rowspan="2" align="center" bgcolor="#FF0000">
                      ...
                      <tr>
                        ...
                        <td align="center" bgcolor="#CCCCCC"><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
                            ...
                            <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:170px;" required="required" onBlur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('req_for').value);"/>                         </td>
						<td align="center" bgcolor="#CCCCCC">	
                        	<? $field="exp_date"; ?>
						 ...
						 <td colspan="3" align="center" bgcolor="#CCCCCC"><span id="mr">
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
  
  
  	<td><input name="cwh_qoh" type="text" class="input3" id="cwh_qoh" style="width:60px;" onFocus="focuson('qty')" readonly/></td>
    ...
    <td><input name="unit_name" type="text" class="input3" id="unit_name"  maxlength="100" style="width:30px;" onFocus="focuson('qty')" readonly/></td>
                         ...
                         <td align="center" bgcolor="#CCCCCC"><input name="order_qty" type="number" step="any" class="input3" id="order_qty"  maxlength="100" style="width:40px;" required/></td>
...
<? 
 $res='select a.id,concat(b.item_name," :: ",b.item_description) as item_name,a.qoh as Floor_qty,a.exp_date,a.remarks,a.qty,"x" from master_requisition_details a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
?>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
 ...
 <?php $detai=find_a_field('master_requisition_details','count(id)','req_no='.$req_no); if($detai>0){?>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD REQUISITION" style="width:auto; font-weight:bold; font-size:12px; height:30px; color:#090;margin-left:450px;" />
