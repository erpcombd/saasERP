...
<div class="tabledesign2">
  <table width="60%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <th valign="top"><strong>PR No </strong></th>
        <th valign="top"><strong>PQ</strong></th>
...
$con .= ' and m.req_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
...
$res='select  r.*,m.* from 
requisition_order r, user_activity_management u, requisition_master m where m.req_no=r.req_no and
u.user_id=r.entry_by and r.warehouse_id="'.$_SESSION['user']['depot'].'" '.$con.' order by r.req_no asc';
...
<? $tqty = $tqty + $data->qty;}}?>
<tr>
	  <td colspan="3" valign="top" style="background:#AEC495;"><div align="right"><strong>Total:</strong></div></td>
	  <td style="background: #AEC495;"><strong>
...
<? 
$sql = 'select a.* from purchase_invoice a where   a.po_no="'.$data->po_no.'" and  item_id='.$item_id;
$sqlq = db_query($sql);
