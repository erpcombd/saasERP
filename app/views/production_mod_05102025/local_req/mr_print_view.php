...

{
	...
	$ssql='update requisition_master_local set status="'.$_GET['req_status'].'" where req_no="'.$req_no.'"';
...
$sql="select * from requisition_master_local where  req_no='$req_no'";
...
$sql2="select * from requisition_order_local where  req_no='$req_no'";
