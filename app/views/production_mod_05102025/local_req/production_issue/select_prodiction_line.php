...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><strong>
	  ...
	  <? foreign_relation('warehouse','warehouse_name','warehouse_name','','use_type="PL"  order by warehouse_name');?>
...
<? 
$res='select a.req_no,a.req_no,a.req_for,b.fname as entry_by ,a.entry_at,a.status
from warehouse_requsition_master a,user_activity_management b where b.user_id = a.entry_by and a.req_for like "%'.$_POST['line_id'].'%"';
echo $res;
?>
...
echo link_report_del($res,'production_issue.php');
		?>
      </div>
      </td>
    </tr>
