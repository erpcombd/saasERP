...
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_description,"#>",item_id)','product_nature = "Purchasable" and sub_group_id like "%'.$_SESSION['session_sub_group'].'%"','item_id');
...
function sub_group_function(id){
	...
	window.location.href = "../por/por_create.php?sub_group=" + id;
}
...
<form action="por_create.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    <td><fieldset>
    <? $field='req_no';?>
      <div>
        <label for="<?=$field?>">Return No: </label>
        <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>"/>
      </div>
    <? $field='return_date'; if($return_date=='') $return_date =date('Y-m-d');?>
      <div>
        <label for="<?=$field?>">Return Date:</label>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
      <tr>
            ...
            <td width="42%" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>
            <td width="9%" align="center" bgcolor="#0099FF"><strong>Stk Qty</strong></td>
            ...
            <td width="14%" align="center" bgcolor="#0099FF"><strong>Remark</strong></td>
            <td width="7%"  rowspan="2" align="center" bgcolor="#FF0000">
              ...
              <tr>
                ...
                <td align="center" bgcolor="#CCCCCC"><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
                    ...
                    <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:270px;" required="required" onBlur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/>                         </td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td width="51%"><input name="qoh" type="text" class="input3" id="qoh" style="width:60px;" onFocus="focuson('qty')" readonly/></td>
    <td width="49%"><input name="unit_name" type="text" class="input3" id="unit_name"  maxlength="100" style="width:30px;" onFocus="focuson('qty')" readonly/></td>
  </tr>
</table>
         ...
         <td align="center" bgcolor="#CCCCCC"><label>
           <input name="remarks" type="text" id="remarks" style="width:auto;">
         </label></td>
      </tr>
    </table>
