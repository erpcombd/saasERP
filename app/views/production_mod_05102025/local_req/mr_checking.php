...
$esql="select * from requisition_order_local where req_no=".$_POST[$unique];
...
while($edata=mysqli_fetch_object($equery)){
		...
		$usql="update requisition_order_local set qty='".$qty."' where id=".$edata->id;
...

{
		...
		$crud   = new crud('requisition_order_local');
...
<td align="left">  
    ...
    <div align="left">
      ...
      <input name="confirmmm" type="submit" class="btn1" value="RETURN REQUSITION" style=" float:left; width:270px; font-weight:bold; font-size:12px; height:30px; color: #990000" />
