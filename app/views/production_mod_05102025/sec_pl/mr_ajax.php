...
$center_stock= find_a_field('journal_item','sum(item_in-item_ex)','item_id="'.$item_id.'" and warehouse_id ='.$_SESSION['user']['depot']);
...
<tr>
<td><input name="cwh_qoh" type="text" class="input3" id="cwh_qoh" style="width:60px;" value="<? if($stock == 0){ echo "0.00";}else { echo $stock;}?>" onfocus="focuson('qty')" readonly/> </td>
