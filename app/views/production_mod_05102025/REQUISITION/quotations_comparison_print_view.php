...
?>
       ...
       <tr>
        ...
        <td width="9%" style="background-color:#F5F5F5;"><strong>SL</strong></td>

        <td width="66%" style="background-color:#F5F5F5;"><strong> Item Description </strong></td>

        <td width="8%" style="background-color:#F5F5F5;"><strong>Unit</strong></td>
        <td width="17%" style="background-color:#F5F5F5;"><strong>Per Unit  </strong></td>
