							...
							<table style="width:100%" border="0"><th></th>
								  <tr>
								    <td><div class="box"><form id="form1" name="form1" method="post" action=""><table style="width:100%" border="0"><th></th>
                                      ...
                                      <tr>
                                        <td style="text-align: right; width:40%">Old Password: </td>
                                        <td style="text-align: right; width:60%"><input name="old_pass" id="old_pass" type="text" /></td>
                                      </tr>
                                      ...
                                      <tr>
                                        <td>&nbsp;</td>
										<td>
										<table style="width:20%" border="0"><th></th>
											  <tr>
