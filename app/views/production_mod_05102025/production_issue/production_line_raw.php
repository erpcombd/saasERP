...
<option value=""></option>
<? 
foreign_relation('item_info','item_id','concat(item_name)',$fg_item_id,'product_nature="Purchasable" order by item_name');?>
</select>
...
<? 
$res='select a.id,b.warehouse_id as id,c.item_name,a.hourly_production,a.unit_name,"X" from production_line_raw a,warehouse b,item_info c where b.warehouse_id=a.line_id and c.item_id=a.fg_item_id and b.warehouse_id='.$line_id;
?>
