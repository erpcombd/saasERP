...
$datas=find_all_field('production_floor_receive_master','s','pr_no='.$pr_no);

$sql1="select b.* from production_floor_receive_master b where b.pr_no = '".$pr_no."'";
$data1=db_query($sql1);
...
$sql1="select b.*,i.unit_name from production_floor_receive_detail b,item_info i where b.item_id=i.item_id and b.pr_no = '".$pr_no."'";
$data1=db_query($sql1);
