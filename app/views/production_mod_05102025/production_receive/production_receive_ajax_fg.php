...
?>
<input name="total_unit2" type="text" class="input3" style="width:60px;" onfocus="focuson('total_pkt')" value="<?=$item_all->unit_name?>"/>      
...
<input name="total_unit5" type="text" class="input3" style="width:60px;" onfocus="focuson('total_pkt')" value="<?=$last_p->pr_date?>"/>
