    ...
    <td>
			...
			<fieldset style="width:220px;">
			  ...
			  <div>
			    ...
			    <input style="width:105px;"  name="pi_date" type="text" id="pi_date" value="<?=$pi_date?>"/>
	...
	while($row=mysqli_fetch_object($rs)){
		...
		?>
		  <tr>
                ...
                <td><?=$row->order_qty?></td>
                <td>
					<input type="text" id="id<?=$row->id?>" name="id<?=$row->id?>" value="<?=$row->qty?>" style="width:100px;" required/>
                </td>
            </tr>
		<?
	}
