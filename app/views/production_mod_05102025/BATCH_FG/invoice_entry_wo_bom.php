...
<td style="width:9%; text-align: right" ><strong> Company :</strong></td>
<td style="width:16%" >
...
<td style="width:13% ; text-align:right"><strong>  Product of <?=find_a_field('user_group','company_short_code','id='.$_SESSION['user']['group'])?>: </strong></td>
...
<td style="width:9%; text-align:right"><strong>BATCH Qty: </strong></td>
...
<td style="width:17%" rowspan="8" class="text-center" ><strong>
...
<td ><input name="pr_date" type="text" id="pr_date" style="width:90%; height:32px;" value="<?=date('Y-m-d');?>"  required autocomplete="off" readonly/></td>
...
<td style="width:10%; text-align: right"><strong>Company :</strong></td>
...
<td style="width:15%; text-align: right" ><strong> Factory Unit: </strong></td>
...
<td style="text-align: center; background-color:#90EE90"><div align="center"><strong>Total</strong></div></td>
...
<table style="width:100%" border="0" class="text-center" id="grp" style="font-size:12px; text-transform:uppercase;">
...
<td style="background-color:#99CCFF"><input name="qty" type="text" id="qty" value="" onkeyup="TRcalculationpo()" style="width:80px; height:30px; "  /></td>

<td style="background-color:#99CCFF"><input name="total_amt" type="text" id="total_amt" value="" style="width:80px; height:30px; "  readonly="readonly" /></td>
...
<td style="background-color:#99CCFF"><?=$datafg->unit_name; $std_qty=$datafg->bom_qty*$ms_data->pr_qty;?></td>
...
<td style="background-color:#99CCFF"><input name="unit_price_<?=$datafg->id?>" type="text" id="unit_price_<?=$datafg->id?>" value="<?=$final_price; ?>" style="width:80px;height:30px;"<? if($final_price<=0) { echo "color:red";}?>" "   readonly="readonly" /></td>
