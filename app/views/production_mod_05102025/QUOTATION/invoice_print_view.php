...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="2%" style="background-color:#F5F5F5;"><strong>SL</strong></td>

        <td width="19%" style="background-color:#F5F5F5;"><strong> Category </strong></td>
        <td width="37%" style="background-color:#F5F5F5;"><strong> Item Description </strong></td>

        <td width="5%" style="background-color:#F5F5F5;"><strong>Unit</strong></td>
        <td width="9%" style="background-color:#F5F5F5;"><strong>RFQ Qty </strong></td>
        <td width="18%" style="background-color:#F5F5F5;"><strong>Each Price in <?=$ms_data->currency_type;?></strong></td>
        <td width="10%" style="background-color:#F5F5F5;"><strong>Per Unit</strong> </td>
       </tr>
...
<tr>
        ...
        <td valign="top"><?=number_format($info2->rfq_qty,2);?></td>
