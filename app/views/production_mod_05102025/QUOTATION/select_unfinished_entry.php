  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
        <tr>
          ...
          <td width="239" style="background-color:#FF9966;"><input type="text" name="tdate" id="tdate" value="<?=$_POST['tdate']?>" style="width:150px; font-weight:bold; font-size:12px; height:30px; color:#090"/></td>
          <td width="348" rowspan="4" style="background-color:#FF9966;" align="center"><strong>
...
<tr>
  ...
  <th width="13%"><strong>QUOTE</strong> Date </th>
  <th width="13%"><strong>RFQ</strong> No </th>
  <th width="15%"><strong>REQ</strong> No </th>
  <th width="29%"><strong>Vendor Name </strong></th>
  <th width="21%">Entry By </th>
  </tr>
...
//		}
   ...
   $res="select  m.* from  purchase_quotation_master m where m.status='MANUAL' ".$con." order by m.invoice_date, m.invoice_no";
