	 ...
	 <td width="17%" rowspan="8" align="center" ><strong>
      ...
      <input type="submit" name="master_data" id="master_data" value="Initiate Entry" style="width:180px; text-align:center; font-weight:bold; font-size:12px; height:30px; color:#090"/>
								  ...
								  <tr>
								    ...
								    <td ><input name="pr_date" type="text" id="pr_date" style="width:90%; height:32px;" value="<?=$pr_date;?>"  required tabindex="1" /></td>
...
<? //if($po_no[$data->po_no]==0) { } ?>
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
	...
	<td bgcolor="#99CCFF"><input name="stock_<?=$datafg->id?>" type="text" id="stock_<?=$datafg->id?>" value="<?=$final_stock[$datafg->item_id]; ?>" onkeyup="TRcalculationpo(<?=$data->id?>)" style="width:80px; height:30px; " /></td>
