...
if($$unique>0) $btn_name='Update FG Information'; else $btn_name='Initiate FG Information';
...
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_id,"#>",finish_goods_code)','status="Active" and group_for="'.$group_for.'"','item_id');
...
<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
 ...
 <select name="group_for" id="group_for" value="<?=$group_for;?>" required>
...
<input name="confirmm" type="submit" class="btn1 btn1-bg-submit" value="CONFIRM AND FORWARD FG" />
