...
<tr>
  ...
  <div>
    <img style="width:200px" src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png" class="logo-img"/>
  </div>
...
<div style="width:48%; padding:5px;">
  ...
  <div style="width:48%; display:flex; flex-direction:column; align-items:flex-end; padding-right:10px; gap:5px;">
    ...
    <div style="display:flex; align-items:center; width:100%; justify-content:flex-end; gap:10px;">
      ...
      <h1 style="flex:0 0 50%; font-size:16px; font-weight:normal; border:1px solid #000; padding:3px 0 3px 5px; margin:0;">
        &nbsp; <a href="../BOM/invoice_print_view.php?bom_no=<?=$ms_data->bom_no;?>" target="_blank"> BOM-<?= $ms_data->bom_no;?></a>
      </h1>
    </div>
...
<tr>
        ...
        <td valign="top" align="right"><?=number_format($info2->final_qty,5); $total_qty_raw += number_format($info2->final_qty,5) ?></td>
...
<tr style="background-color:#CFFCF0;" class="print-bg-row">
        ...
        <td align="right" valign="top"><strong><?=number_format($total_qty_raw,5); ?></strong></td>
