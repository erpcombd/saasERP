...
<th width="14%">SL/NO</th>
 ...
 $res = 'select a.req_no,a.req_date,i.item_name,g.group_name,b.qty,b.remarks from   requisition_master a, requisition_order b, item_info i, item_sub_group s, item_group g where  a.status in ("CHECKED","PENDING") and a.req_no=b.req_no and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and b.item_id=i.item_id '.$item_con.$date_con.$con.$g_con.$w_con.' ';
