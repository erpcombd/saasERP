...
and "'.date('Y-m-d').'"';}
  ...
  where m.warehouse_id=w.warehouse_id and m.status="UNCHECKED" and m.issue_type="PROCESS_LOSS" '.$con.' order by m.req_no desc';
          ...
          ?>
            <tr>
              ...
              <td class="text-center">
                <a href="process_loss_checking.php?old_req=<?=$data->req_no?>">
