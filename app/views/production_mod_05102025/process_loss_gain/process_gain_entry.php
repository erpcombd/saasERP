...
window.location = "process_gain_entry.php";
...
$res='select a.id,a.item_id,concat(b.item_name) as item_name,a.qoh as Floor_qty,a.exp_date,a.remarks,a.qty,a.rate,"x" from process_loss_gain_details a,item_info b where b.item_id=a.item_id and  a.req_no='.$$unique;
...
//journal_item_control($r->item_id, $masterAll->warehouse_id, $masterAll->req_date, 0, $r->qty, 'WIPIssue', $r->id, $r->rate, '', $$unique, '', '',0, $r->rate,'');
...
echo '<script> window.location.href = "process_gain_entry.php?new=2"; </script>';
...
window.location.href = "../process_loss_gain/process_gain_entry.php?sub_group=" + id;
...
<form action="process_gain_entry.php" method="post" name="codz" id="codz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
