...
$title='Select Production Line Return';
...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td>&nbsp;</td>
  		...
  		<?php if($_SESSION['user']['id']==10146){ 
					$ware_con=' and warehouse_id="'.$_SESSION['user']['depot'].'"';
					}
					else if($_SESSION['user']['id']==10147){
					$ware_con=' and warehouse_id="'.$_SESSION['user']['depot'].'"';
					}
						else if($_SESSION['user']['id']==10148){
					$ware_con=' and warehouse_id="'.$_SESSION['user']['depot'].'"';
					}
					else{
					$ware_con='';
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><strong>
		  ...
		  <option></option>
	  <? foreign_relation('warehouse','warehouse_id','warehouse_name','','use_type in ("PL","SC") '.$ware_con.' order by warehouse_name');?>
	  </select>
