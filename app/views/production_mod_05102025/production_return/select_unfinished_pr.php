...
$select = "update production_floor_return_master set status='COMPLETE' where pr_no=".$_POST['pr_no'];
...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <?
        $sql = 'select pr_no from production_floor_return_master where  status="MANUAL" ';
        $rs = db_query($sql);
