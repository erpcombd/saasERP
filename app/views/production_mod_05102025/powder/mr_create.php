        ...
        <div class="row">
		  ...
		  <div class="container n-form2">
            ...
            <div class="form-group pb-1 row m-0">
			 ...
			 <? $field='req_no';?>
              ...
              <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Profile No :</label>
			...
			<?php /*?><div class="form-group pb-1 row m-0">
			 ...
			 <div class="form-group pb-1 row m-0">
              ...
              <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Plant Name :</label>
		  ...
		  <div class="container n-form2">
            ...
            <div class="form-group pb-1 row m-0">
              ...
              <label  for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Anodization Plant :</label>
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
					...
					<option></option>
					<option>Anodization Plant 01</option>
					<option>Anodization Plant 02</option>
            ...
            <div class="form-group pb-1 row m-0">
              ...
              <label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Type :</label>

              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">	

			<select name="<?=$field?>" id="<?=$field?>">	

			 <option <? if ($$field=='DSTR') echo ' selected="selected"';?>>CHEMICAL CODING</option>	
