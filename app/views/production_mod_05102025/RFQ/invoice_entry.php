...
<div class="box" style="width:100%;">
	...
	<a href="../REQUISITION/invoice_print_view.php?invoice_no=<?=$req_no;?>" target="_blank"><input name="view_req_no" type="text" id="view_req_no" style="width:90%; height:32px;" value="<?=$req_data->view_invoice_no;?>" readonly="" required tabindex="1" /></a>	</td>
     ...
     <input type="submit" name="master_data" id="master_data" value="Initiate Entry" style="width:160px; text-transform:uppercase; background:#87CEFA; color:#000000; text-align:center; font-weight:bold; font-size:12px; height:30px; "/>
								  ...
								  <tr>
								    <td align="right" ><strong> RFQ Date: </strong></td>
								    ...
								    <td   align="right" ><strong>Quotation Deadline:</strong>  </td>
...
<div class="box" style="width:100%;">
	...
	<input name="view_invoice_no" type="text" id="view_invoice_no" style="width:90%; height:32px;" value="<?=$ms_data->view_invoice_no;?>" readonly="" required tabindex="1" /></td>
	 ...
	 <td width="11%" align="right"><strong>  RFQ Date: </strong></td>
	 <td width="18%" align="right"><input name="invoice_date" type="text" id="invoice_date" style="width:90%; height:32px;" value="<?=$ms_data->invoice_date?>" required readonly="" tabindex="1" /></td>
	...
	<input name="view_req_no" type="text" id="view_req_no" style="width:90%; height:32px;" value="<?=$ms_data->view_req_no;?>" readonly="" required tabindex="1" /></a>	 </td>
								  ...
								  <tr>
								    ...
								    <td align="right" width="11%"><strong>Currency:</strong></td>
		...
		<? foreign_relation('currency_type','currency_type','currency_type',$_POST['currency_type'],'currency_type="'.$ms_data->currency_type.'"');?>
								    ...
								    <td align="right" width="19%"><strong>Quotation Deadline:</strong></td>
...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0" style="font-size:12px; text-transform:uppercase;">
  ...
  <tr>
    ...
    <th width="14%">Requisition Qty </th>
    <th width="15%">RFQ Qty </th>
    </tr>
...
<tr style="background-color: <?= ($i % 2) ? '#F5F5F5' : '#fff'; ?>;">
    ...
    <td style="background-color:#99CCFF;"> <input name="req_qty_<?=$datafg->id?>" type="text" id="req_qty_<?=$datafg->id?>" value="<?=$datafg->total_unit?>" style="width:100px; height:30px; " readonly=""/></td>
	...
	<input name="rfq_qty_<?=$datafg->id?>" type="text" id="rfq_qty_<?=$datafg->id?>" value="<?=$datafg->total_unit; ?>" onkeyup="TRcalculationpo(<?=$data->id?>)" style="width:100px; height:30px; " /></td>
    </tr>
