...
$title='Request For Quotation (RFQ) Status';
do_calander('#fdate');
do_calander('#tdate');
...
div.form-container_large input {
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
		...
		<? foreign_relation('purchase_rfq_master','req_no','view_req_no',$_POST['req_no'],'1');?>
...
<tr>
  <th width="11%">RFQ No </th>
  <th width="18%">RFQ Date </th>
  <th width="25%"><strong>Requisition No </strong></th>
...
//		}
    ...
    $res="select  m.* from  purchase_rfq_master m, purchase_rfq_details d where m.invoice_no=d.invoice_no and  m.status!='MANUAL'  ".$con.$req_no_con." group by m.invoice_no order by m.invoice_date, m.invoice_no";
