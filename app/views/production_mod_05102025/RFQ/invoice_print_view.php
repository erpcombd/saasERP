...
$sql_ms="select * from purchase_rfq_master where invoice_no='$invoice_no'";
                      ...
                      <tr>
                        <td width="100%"> 
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px; margin:0; padding:0; text-align:center; " >
									...
									<tr>
   <td colspan="2" align="center"><h4 style="font-size:18px; width: 50%; padding:5px 0; margin:0; border:2px solid #000000; margin: 8px 0; background:#F5F5F5; border-radius: 5px; font-family:  'MYRIADPRO-REGULAR'; letter-spacing:1px; text-transform:uppercase;">Request For Quotation (RFQ)</h4></td>
  </tr>
  ...
  <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			...
			<tr>
                ...
                <td width="52%" align="right" valign="middle"><strong> RFQ No: </strong></td>
			  ...
			  <tr>
                ...
                <td width="52%" align="right" valign="middle"><strong> RFQ Date: </strong></td>
                ...
                <td width="52%" align="right" valign="middle"><strong> Quotation Deadline: </strong></td>


			    <td width="48%"><table width="100%" border="1" cellspacing="0" cellpadding="1">
                  <tr height="20">
                    <td>&nbsp; <?= date("d-m-Y",strtotime($ms_data->quotation_deadline));?></td>
                  </tr>
                </table></td> </tr>
...
<table width="100%" class="tabledesign"  bordercolor="#000000" cellspacing="0" cellpadding="0">
       ...
       <tr>
        ...
        <td width="4%" style="background-color:#F5F5F5;"><strong>SL</strong></td>

        <td width="21%" style="background-color:#F5F5F5;"><strong> Category </strong></td>
        <td width="45%" style="background-color:#F5F5F5;"><strong> Item Description </strong></td>

        <td width="12%" style="background-color:#F5F5F5;"><strong>Unit</strong></td>
        <td width="18%" style="background-color:#F5F5F5;"><strong>RFQ Qty </strong></td>
        </tr>
...
$sql3="select a.*, s.sub_group_name, i.sub_group_id, i.item_name, i.finish_goods_code from purchase_rfq_details a, item_info i, item_sub_group s where  a.item_id=i.item_id  and i.sub_group_id=s.sub_group_id and a.invoice_no='".$invoice_no."' order by i.sub_group_id, i.item_name";
