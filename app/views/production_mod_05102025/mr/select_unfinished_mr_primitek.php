...
$target_url = 'mr_create_batch.php';
$re_target_url = $target_url.'?req_no='.$_POST[$unique];
          ...
          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8">
            <div class="form-group row m-0">
              ...
              <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
				   ...
				   <?php /*?> <? foreign_relation($table,$unique,$unique,$$unique,'warehouse_id='.$_SESSION['user']['depot'].' and status="'.$status.'"');?><?php */?>
					<? 
