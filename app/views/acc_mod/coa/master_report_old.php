...
<th bgcolor="#66CCCC">TOTAL AMT</th>
...
<td bgcolor="#ADD8E6"><strong><?=number_format($all_total,3);?></strong></td>
...
<td bgcolor="#ADD8E6"><strong>&nbsp;</strong></td>
		  ...
		  <tr>
		  <td bgcolor="#ADD8E6">&nbsp;</td>
		  <td bgcolor="#ADD8E6"><div align="right"><strong> GRAND TOTAL AMT:</strong></div></td>
		  <?
...
<td bgcolor="#ADD8E6"><strong><?=number_format($all_total_amt,2);?></strong></td>
...
elseif($_POST['report']==221021001)
{
		...
		<th width="2%" bgcolor="#d6eaf8">SL</th>
		<th width="8%" bgcolor="#d6eaf8">CODE NO </th>
		<th width="23%" bgcolor="#d6eaf8">SUPPLIER NAME </th>
		<th width="19%" bgcolor="#d6eaf8" style="text-align:center">Proprietor Name </th>
		<th width="20%" bgcolor="#d6eaf8" style="text-align:center">Mobile No</th>
		<th width="28%" bgcolor="#d6eaf8" style="text-align:center">Address  </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
...
if ($_POST['item_id_in'] != '') {
    $item_id_in_con .= " and i.item_id in (" . $_POST['item_id_in'] . ")";
		...
		<tr>
		<th width="4%" bgcolor="#FFFACD">SL</th>
		<th width="19%" bgcolor="#FFFACD">SUPPLIER NAME </th>
...
<th width="24%" bgcolor="#66CCCC">TOTAL</th>

<th width="27%" bgcolor="#66CCCC">TOTAL AMT</th>
		</tr>
		</thead>
...
elseif($_POST['report']==251022001)
{
		...
		<tr style="text-transform:uppercase">
		<th width="5%" bgcolor="#d6eaf8">L-01</th>
		<th width="9%" bgcolor="#d6eaf8" style="text-align:center">CLASS</th>
		<th width="14%" bgcolor="#d6eaf8" style="text-align:center">SUB CLASS </th>
		<th width="14%" bgcolor="#d6eaf8" style="text-align:center">SUB SUB CLASS   </th>
		<th width="17%" bgcolor="#d6eaf8" style="text-align:center">GL Group </th>
		<th width="9%" bgcolor="#d6eaf8" style="text-align:center">Budget Date</th>
		<th width="18%" bgcolor="#d6eaf8" style="text-align:center">Budget Amount</th>
		<th width="18%" bgcolor="#d6eaf8" style="text-align:center">Expense Amount</th>
		</tr>
		</thead><tbody>
		<? 
...
if ($_POST['acc_class'] != '') {
    $acc_con .= ' and l.acc_class = "' . $_POST['acc_class'] . '" ';
}

if ($_POST['acc_sub_class'] != '') {
    $acc_con .= ' and l.acc_sub_class = "' . $_POST['acc_sub_class'] . '" ';
}

if ($_POST['acc_sub_sub_class'] != '') {
    $acc_con .= ' and l.acc_sub_sub_class = "' . $_POST['acc_sub_sub_class'] . '" ';
}

if ($_POST['ledger_group_id'] != '') {
    $acc_con .= ' and l.group_id = "' . $_POST['ledger_group_id'] . '" ';
}
		...
		echo $sql = "select l.*, a.ledger_id from ledger_group l, accounts_ledger a where l.group_id=a.ledger_group_id  ".$acc_con." group by l.group_id";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		...
		<tr <?=$sl++;?>>
		<td><?=$info->acc_class;?></td>
		<td><?=$class_name[$info->acc_class]?></td>
		<td ><?=$sub_class_name[$info->acc_sub_class]?></td>
		<td ><?=$sub_sub_class_name[$info->acc_sub_sub_class]?></td>
		<td ><?=$group_name[$info->group_id]?></td>
		<td ><?=find_a_field('budget_balance','entry_at','ledger_id="'.$info->ledger_id.'"');?></td>
		<td ></td>
		<td ></td>
		</tr>
<?  } ?>
...
elseif($_POST['report']==221023002)
{
		...
		<tr style="text-transform:uppercase">
		<th width="2%" bgcolor="#d6eaf8">SL</th>
		<th width="17%" bgcolor="#d6eaf8">Item Group </th>
		<th width="25%" bgcolor="#d6eaf8" style="text-align:center">Item  Name </th>
		<th width="15%" bgcolor="#d6eaf8" style="text-align:center">Unit Name </th>
		<th width="14%" bgcolor="#d6eaf8" style="text-align:center">Quantity</th>
		<th width="9%" bgcolor="#d6eaf8" style="text-align:center">Rate</th>
		<th width="18%" bgcolor="#d6eaf8" style="text-align:center">Amount  </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
...
elseif($_POST['report']==221023003)
{
		...
		<tr style="text-transform:uppercase">
		<th width="2%" bgcolor="#d6eaf8">SL</th>
		<th width="17%" bgcolor="#d6eaf8">PO No </th>
		<th width="25%" bgcolor="#d6eaf8" style="text-align:center">Challan No </th>
		<th width="15%" bgcolor="#d6eaf8" style="text-align:center">Supplier Name </th>
		<th width="14%" bgcolor="#d6eaf8" style="text-align:center">Quantity</th>
		<th width="9%" bgcolor="#d6eaf8" style="text-align:center">AVG Price</th>
		<th width="18%" bgcolor="#d6eaf8" style="text-align:center">Amount  </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
