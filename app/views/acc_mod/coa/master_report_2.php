...
if (isset($item_mother_group)) {
    $item_mother_group_con = ' and g.mother_group_id=' . $item_mother_group;
}

if (isset($item_group)) {
    $item_group_con = ' and s.group_id=' . $item_group;
}

if (isset($item_sub_group)) {
    $item_sub_con = ' and i.sub_group_id=' . $item_sub_group;
}

if (isset($item_id)) {
    $item_id_con = ' and i.item_id=' . $item_id;
}

if (isset($item_type)) {
    $item_type_con = ' and i.item_type=' . $item_type;
}
...
if ($_POST['item_id_in'] != '') {
    $item_id_in_con .= " and i.item_id in (" . $_POST['item_id_in'] . ")";
		...
		<th width="17%" style="background-color:##FFFACD;">SUPPLIER NAME </th>
...
elseif($_POST['report']==221021001)
{
		...
		$day = date('d',strtotime($t_date));
		$inv_id = sprintf("%04d", $row->dealer_code);
		
		 $invoice_no=$year.''.$month.''.$day.''.$inv_id;
		?><?php */?>
...
if ($_POST['item_id_in'] != '') {
    $item_id_in_con .= " and i.item_id in (" . $_POST['item_id_in'] . ")";
		...
		<th width="19%" style="background-color:#FFFACD;">SUPPLIER NAME </th>
				  ...
				  <th width="14%" bgcolor="#FFFACD">Challan No </th>
				  <?
...
for($i=1;$i<=$cols;$i++)
{
echo '<td style="background-color:#ADD8E6;"><strong>'.number_format($total_item[$item_id[$i]],3).'</strong></td>';
...
elseif($_POST['report']==251022001)
{
		...
		<th width="9%" style="background-color:#d6eaf8;" style="text-align:center">CLASS</th>
		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">L-02</th>
		<th width="14%" style="background-color:#d6eaf8;" style="text-align:center">SUB CLASS </th>
		<th width="6%" style="background-color:#d6eaf8;" style="text-align:center">L-03</th>
		<th width="14%" style="background-color:#d6eaf8;" style="text-align:center">SUB SUB CLASS   </th>
		<th width="7%" style="background-color:#d6eaf8;" style="text-align:center">L-04</th>
		<th width="17%" style="background-color:#d6eaf8;" style="text-align:center">GL Group </th>
		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">L-05</th>
		<th width="18%" style="background-color:#d6eaf8;" style="text-align:center">Head OF ACCOUNTS  </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
