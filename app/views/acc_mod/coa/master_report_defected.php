...

{
        ...
        <tr>
		 ...
		 <tr>
          ...
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white; font-weight:700">For Date of: <?php echo date('d-m-Y',strtotime($_POST['t_date']));?></td>
...
if($ix == 0){$item_sub_group_in .= $selectedOption.' ';}

else{ $item_sub_group_in .= ', '.$selectedOption;$ix++;}
...
if($item_sub_group_in!='')    {
    $item_sub_group_in_con .= " and i.sub_group_id in (".$item_sub_group_in.")";}
		...
		<th width="4%" style="background-color: #FFFACD;"> SL</th>

		<th width="17%" bgcolor="#FFFACD">SUPPLIER NAME </th>
...
<th style="background-color: #66CCCC;">TOTAL AMT</th>
		...
		<td><strong><?  echo  number_format($zone_code_total_gtotal_amt[$old_zone_code],2);?></strong></td>
...
<? }?>
		...
		<tr>
		  ...
		  <td bgcolor="#ADD8E6"><div align="right"><strong> GRAND TOTAL:</strong></div></td>
...
<td style="background-color: #ADD8E6;"><strong>&nbsp;</strong></td>
		  ...
		  <td style="background-color: #ADD8E6;"><div align="right"><strong> GRAND TOTAL AMT:</strong></div></td>
...

{
		...
		<th width="2%" style="background-color: #d6eaf8;">SL</th>

		<th width="8%" style="background-color: #d6eaf8;">CODE NO </th>

		<th width="23%" style="background-color: #d6eaf8;">SUPPLIER NAME </th>

		<th width="19%" style="background-color: #d6eaf8;" style="text-align:center">Proprietor Name </th>

		<th width="20%" style="background-color: #d6eaf8;" style="text-align:center">Mobile No</th>

		<th width="28%" style="background-color: #d6eaf8;" style="text-align:center">Address  </th>
		...
		<tr>
		  ...
		  <td><div align="left" style="text-transform:uppercase; font-size:14px; font-weight:700;"><strong><?=$info_sub->category_name?></strong></div></td>
...
if(!empty($_POST['item_sub_group_in']))foreach ($_POST['item_sub_group_in'] as $selectedOption)
...
$item_sub_group_in_con .= " and i.sub_group_id in (".$item_sub_group_in.")";}
		...
		<th width="19%" style="background-color:#FFFACD;">SUPPLIER NAME </th>

		



				  <th width="14%" style="background-color:#FFFACD;">Challan No </th>
...
<th width="24%" style="background-color:#66CCCC;">TOTAL</th>



<th width="27%" style="background-color:#66CCCC;">TOTAL AMT</th>
		...
		<td width="12%"><strong><?  echo  number_format($zone_code_total_gtotal_amt[$old_zone_code],2);?></strong></td>
...
<? }?>
		...
		<tr>
		  ...
		  <td style="background-color:#ADD8E6;"><div align="right"><strong> GRAND TOTAL:</strong></div></td>
...

{
        ...
        <tr>
          ...
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong>Supplier Name:

		   <?=find_a_field('vendor','concat(vendor_id," - ",vendor_name)','vendor_id='.$_POST['vendor_id'])?></strong></td>
        ...
        <tr>
		 ...
		 <?php /*?><tr>
          ...
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white; font-weight:700">
		...
		<th width="5%" style="background-color:#d6eaf8;">L-01</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">CLASS</th>

		<th width="4%" style="background-color:#d6eaf8;" style="text-align:center">L-02</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">SUB CLASS </th>

		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">L-03</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">SUB SUB CLASS   </th>

		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">L-04</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">GL Group </th>

		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">L-05</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">Head OF ACCOUNTS  </th>
...

{
		...
		<th width="2%" style="background-color:#d6eaf8;">L-01</th>

		<th width="5%" style="background-color:#d6eaf8;" style="text-align:center">CLASS</th>

		<th width="8%" style="background-color:#d6eaf8;" style="text-align:center">SUB CLASS </th>

		<th width="15%" style="background-color:#d6eaf8;" style="text-align:center">SUB SUB CLASS   </th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">GL Group </th>

		<th width="15%" style="background-color:#d6eaf8;" style="text-align:center">Head OF ACCOUNTS  </th>

		<th width="9%" style="background-color:#d6eaf8;" style="text-align:center">Budget Date</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">Budget Amount</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">Expense Amount</th>

		<th width="12%" style="background-color:#d6eaf8;" style="text-align:center">Available Balance</th>
		...
		<td ><?=find_a_field('budget_balance','entry_at','ledger_id="'.$row->ledger_id.'"');?></td>
...

{
		...
		<th width="17%" style="background-color:#d6eaf8;">Item Group </th>

		<th width="25%" style="background-color:#d6eaf8;" style="text-align:center">Item  Name </th>

		<th width="15%" style="background-color:#d6eaf8;" style="text-align:center">Unit Name </th>

		<th width="14%" style="background-color:#d6eaf8;" style="text-align:center">Quantity</th>

		<th width="9%" style="background-color:#d6eaf8;" style="text-align:center">Rate</th>

		<th width="18%" style="background-color:#d6eaf8;" style="text-align:center">Amount  </th>
		...
		<td align="center"><strong><?=$info_sub->category_name;?></strong></td>
...
<?  } ?>
		...
		<td align="right"><strong>SUB TOTAL:</td>

		<td align="right"><strong><?=number_format($total_purchase_qty,3); $grand_total_purchase_qty +=$total_purchase_qty; ?></strong></td>

		<td align="right">&nbsp;</td>

		<td align="right"><strong><?=number_format($total_purchase_amt,2); $grand_total_purchase_amt +=$total_purchase_amt;?></strong></td>
	...
	$total_purchase_amt=0;
		...
		<td align="right"><strong>GRAND TOTAL:</td>

		<td align="right"><strong><?=number_format($grand_total_purchase_qty,3); ?></strong></td>

		<td align="right">&nbsp;</td>

		<td align="right"><strong><?=number_format($grand_total_purchase_amt,2); ?></strong></td>
...

{
		...
		<th width="17%" style="background-color:#d6eaf8;">PO No </th>

		<th width="25%" style="background-color:#d6eaf8;" style="text-align:center">Challan No </th>

		<th width="15%" style="background-color:#d6eaf8;" style="text-align:center">Supplier Name </th>

		<th width="14%" style="background-color:#d6eaf8;" style="text-align:center">Quantity</th>

		<th width="9%" style="background-color:#d6eaf8;" style="text-align:center">AVG Price</th>
...
<?  } ?>
		...
		<td align="right"><strong><?=number_format($total_purchase_qty,3); ?></strong></td>

		<td align="right">&nbsp;</td>

		<td align="right"><strong><?=number_format($total_purchase_amt,2); ?></strong></td>
