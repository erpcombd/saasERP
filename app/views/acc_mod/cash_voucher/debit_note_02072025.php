							...
							if(mysqli_num_rows($data2)>0){
								...
								{$dataa[2]=substr($dataa[2],0,20).'...';
									...
									<tr>
										...
										<a href="../cheque_setup/cheque_print_jv.php?jv_no=<?php echo rawurlencode(url_encode($dataa[4]));?>" target="_blank"><button type="button" class="btn2 btn1-bg-help"><i class="fa-solid fa-print"></i></button></a>
