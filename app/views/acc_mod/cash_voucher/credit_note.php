						...
						<div class="row pb-1">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								...
								<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
									<div class="form-group row m-0 pb-1">
										<label
											class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Receive Mode:</label>
										<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
...
<td style="padding:1px;">
  <a href="general_voucher_print_view_for_draft.php?c=<?=rawurlencode(url_encode($c_id));?>&v=<?=rawurlencode(url_encode($dataa[4]));?>" target="_blank" onclick="custom('<?=url_encode($dataa[4]);?>','<?=url_encode($c_id);?>');">
