...
<!--				<p class="text">Cell: <?=$group_data->mobile?>. Email: <?=$group_data->email?> <br> <?=$group_data->vat_reg?></p>-->
		...
		<td width="17%" align="right" class="qr-code">
			  ...
			  $req_no_qr_data = url_encode($sub_ledger);
              $print_url = "https://saaserp.ezzy-erp.com/app/views/acc_mod/cash_voucher/general_voucher_print_view_for_draft_client.php?c=" . rawurlencode($company_id) . "&v=" . rawurlencode($req_no_qr_data);
