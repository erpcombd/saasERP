                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<table width="100%" border="0" cellspacing="0" align="center" cellpadding="0" style="font-size:15px; margin:0; padding:0;">
									...
									<tr>
									<td>
						  	          <div align="left"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png"   style="width:75%;"  />
 ...
 <tr> <td><hr /></td></tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; background:#c5f591; padding:8px 30px; font-weight:bold; border: 2px solid #000000; border-radius: 5px; ">
	  SALES ORDER</span> </td>
  ...
  <tr>
	...
	<td style="vertical-align: top;"><span style="font-size:14px; " class="style8"><strong>VAT No:</strong> <?php echo $dealer->vat_no?>&nbsp;</span></td>
		              </tr>
...
<td style="vertical-align: top;"><span style="font-size:14px; " class="style8"><strong>Contact No:</strong> <?php echo $dealer->contact_no?>&nbsp;</span></td>
		              </tr>
	...
	<td style="vertical-align: top;">><span style="font-size:14px; " class="style8"><strong>C.R No:</strong> <?php echo $dealer->cr_no?>&nbsp;</span></td>
		              </tr>
...
<td style="vertical-align: top;"><span style="font-size:14px; " class="style8"><strong>Address:</strong> <?php echo $dealer->address_e?>&nbsp;</span></td>
		              </tr>
