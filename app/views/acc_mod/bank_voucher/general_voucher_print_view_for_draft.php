...
while($info=mysqli_fetch_object($data2)){		  
      ...
      <tr>
		...
		<? if ($jv_all->tr_from=='Payment') { ?>
					<td align="left"><a style="text-decoration:none !important;" target="_blank" href="general_voucher_print_view_for_draft_client.php?jv_no=<?=rawurlencode(url_encode($jv_no))?>&sub_ledger=<?=rawurlencode(url_encode($info->sub_ledger))?>"><?=$info->ledger_id?></a></td>
			<? } else { ?> 
