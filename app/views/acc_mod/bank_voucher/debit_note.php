...
/>
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
    <div class="form-group row m-0 pb-1">
        <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text font-size12 req-input">
            Paid To:
        </label>
        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
            <input 
...
<div id="bank_check" class="form-group row m-0 pb-1">
    <label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text req-input">
        Bank A/C Credit:
    </label>
    <div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
		<span id="type_bank" >
