...
<div class="form-container_large">
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="row pb-1">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Receive Mode:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
	...
	<?php 
						...
						<div id="bank_check" class="form-group row display-mamun m-0 pb-1">
							...
							<label class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 font-size12 bg-form-titel-text req-input">Bank A/C Debit:</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td><input type="text"  id="ledger_id" name="ledger_id2" onblur="getData2('acc_reference_ajax.php', 'acc_reference', this.value,
...
from  secondary_journal a, accounts_ledger l where a.ledger_id=l.ledger_id and l.group_for='".$_SESSION['user']['group']."' and a.jv_no='".$_SESSION['jv_no']."' and a.cr_amt>0 and tr_from='Receipt'";
