		...
		<form  id="form1" name="form1" method="post" action="">
				...
				<div class="n-form1 fo-short pt-2">
					<div class="container">
						...
						<div class="col-6 m-0">
							<label  class="   bg-form-titel-text">From Date  :</label>
								<input name="fdate"  type="text" id="fdate"  class="form-control" value="<?php echo $_REQUEST['fdate'];?>" autocomplete="off"/>
							</div>
							<div class="col-6">
							<label  class="   bg-form-titel-text">To Date  :</label>
								<input name="tdate" type="text" id="tdate"  class="form-control" value="<?php echo $_REQUEST['tdate'];?>" autocomplete="off"/>
							</div>
						</div>
