...
from  secondary_journal a where a.tr_from='Receipt'  and SUBSTRING(a.tr_no,5,1)='0' and  a.dr_amt>0 group by a.tr_no order by a.tr_no desc limit 6";
...
<td width="20%" align="center" bgcolor="#45777B"><span class="style3">Reference</span></td>

<td width="20%" align="center" bgcolor="#45777B"><span class="style3">Cost Center</span></td>
...
document.getElementById('ledger_id').value);" tabindex="1" style="width:400px;" />
...
<td width="30%" align="center" bgcolor="#45777B"><strong>Ledger Name</strong></td>
...
<td width="21%" align="center" bgcolor="#45777B"><strong>Narration</strong></td>
<td width="16%" align="center" bgcolor="#45777B"><strong>Amount</strong></td>
...
$sql2="select a.id, a.tr_no,l.ledger_name, a.cr_amt, a.narration,a.jv_date , a.jv_no, a.cc_code, a.reference_id
