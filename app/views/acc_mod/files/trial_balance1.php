...
<table class="table" style="margin: 0px; background: #82D8CF; color: black;">
    <tr style="background: #5c0632 !important; color: white !important;">
      <th style="width: 35%; text-align:center; border: 1px solid;">Head Title</th>
      <th style="width: 15%; text-align:center; border: 1px solid;">Opening</th>
	  <th style="width: 15%; text-align:center; border: 1px solid;">Debit</th>
      <th style="width: 15%; text-align:center; border: 1px solid;">Credit</th>
	  <th style="width: 15%; text-align:center; border: 1px solid;">Closing</th>
...
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($cls_opening_amt[$row->id]>0) echo number_format($cls_opening_amt[$row->id],2).' <strong class="dr">(Dr)</strong>'; elseif($cls_opening_amt[$row->id]<0) echo number_format(((-1)*$cls_opening_amt[$row->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?></td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-dr-amt"><?=$cls_dr_amt[$row->id]?></td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-cr-amt"><?=$cls_cr_amt[$row->id]?></td> 
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($cls_closing_amt[$row->id]>0) echo number_format($cls_closing_amt[$row->id],2).' <strong class="dr">(Dr)</strong>'; elseif($cls_closing_amt[$row->id]<0) echo number_format(((-1)*$cls_closing_amt[$row->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
...
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($sub_cls_opening_amt[$row2->id]>0) echo number_format($sub_cls_opening_amt[$row2->id],2).' <strong class="dr">(Dr)</strong>'; elseif($sub_cls_opening_amt[$row2->id]<0) echo number_format(((-1)*$sub_cls_opening_amt[$row2->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-dr-amt"><?=$sub_cls_dr_amt[$row2->id]?></td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-cr-amt"><?=$sub_cls_cr_amt[$row2->id]?></td> 
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($sub_cls_closing_amt[$row2->id]>0) echo number_format($sub_cls_closing_amt[$row2->id],2).' <strong class="dr">(Dr)</strong>'; elseif($sub_cls_closing_amt[$row2->id]<0) echo number_format(((-1)*$sub_cls_closing_amt[$row2->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
<td style="width: 5%;" class="sr-ledger-action"  align="center"><button data-toggle="collapse" data-parent="#faqAccordion"
...
<? if($sub_sub_cls_opening_amt[$row3->id]>0) echo number_format($sub_sub_cls_opening_amt[$row3->id],2).' <strong class="dr">(Dr)</strong>'; elseif($sub_sub_cls_opening_amt[$row3->id]<0) echo number_format(((-1)*$sub_sub_cls_opening_amt[$row3->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>

</td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-dr-amt"><?=$sub_sub_cls_dr_amt[$row3->id]?></td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-cr-amt"><?=$sub_sub_cls_cr_amt[$row3->id]?></td> 
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($sub_sub_cls_closing_amt[$row3->id]>0) echo number_format($sub_sub_cls_closing_amt[$row3->id],2).' <strong class="dr">(Dr)</strong>'; elseif($sub_sub_cls_closing_amt[$row3->id]<0) echo number_format(((-1)*$sub_sub_cls_closing_amt[$row3->id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
...
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($grp_opening_amt[$row4->group_id]>0) echo number_format($grp_opening_amt[$row4->group_id],2).' <strong class="dr">(Dr)</strong>'; elseif($grp_opening_amt[$row4->group_id]<0) echo number_format(((-1)*$grp_opening_amt[$row4->group_id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-dr-amt"><?=$grp_dr_amt[$row4->group_id]?> </td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-cr-amt"><?=$grp_cr_amt[$row4->group_id]?> </td> 
<td style="width: 15%; text-align: right; padding-right: 15px !important;">

<? if($grp_closing_amt[$row4->group_id]>0) echo number_format($grp_closing_amt[$row4->group_id],2).' <strong class="dr">(Dr)</strong>'; elseif($grp_closing_amt[$row4->group_id]<0) echo number_format(((-1)*$grp_closing_amt[$row4->group_id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
 </td>
...
<? if($opening_amt[$row5->ledger_id]>0) echo number_format($opening_amt[$row5->ledger_id],2).' <strong class="dr">(Dr)</strong>'; elseif($opening_amt[$row5->ledger_id]<0) echo number_format(((-1)*$opening_amt[$row5->ledger_id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>

</td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-dr-amt"><?=$dr_amt[$row5->ledger_id]?></td>
<td style="width: 15%; text-align: right; padding-right: 15px !important;" class="sr-ledger-cr-amt"><?=$cr_amt[$row5->ledger_id]?></td> 
<td style="width: 15%; text-align: right; padding-right: 15px !important;">
<? if($closing_amt[$row5->ledger_id]>0) echo number_format($closing_amt[$row5->ledger_id],2).' <strong class="dr">(Dr)</strong>'; elseif($closing_amt[$row5->ledger_id]<0) echo number_format(((-1)*$closing_amt[$row5->ledger_id]),2).' <strong class="cr">(Cr)</strong>';else echo "0.00"; ?>
</td>
