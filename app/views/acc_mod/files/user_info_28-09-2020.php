  ...
  <tr>
    ...
    <td valign="top" width="60%"><div class="left">
		    ...
		    Company:                                       </td>
										...
										<select name="group_for"  id="group_for" style="width:250px; float:left;" tabindex="7">
...
$con .='and a.username like "%'.$_POST['username'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.' ,  a.fname, w.warehouse_name, u.group_name from '.$table.' a, user_group u, warehouse w	where   a.group_for=u.id   and a.warehouse_id=w.warehouse_id   '.$con.' order by a.user_id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Password:</td>
                        				...
                        				<input name="username" required type="password" id="username" tabindex="1" value="<?=$username?>"  style="width:250px;; height:35px;" >	
						...
						<? $_POST['entry_by'] = $_SESSION['user']['id'];?>
						 ...
						 <input name="entry_at" type="hidden" required id="entry_at" tabindex="10" value="<?=$now=date('Y-m-d H:i:s');?>" style=" width:250px" />
									  ...
									  <tr>
                                        ...
                                        <td><input style="padding:5px 5px 7px 5px; width:250px" name="user_pic" type="file" id="user_pic" value="<?=$user_pic?>"  /></td>
                                      </tr>
