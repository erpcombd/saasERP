...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  ...
  <tr>
    ...
    <td width="180" align="right"><a target="_blank" href="../../../views/warehouse_mod/wo/sales_invoice_print_view_acc.php?v_no=<?=rawurlencode(url_encode($ch->chalan_no))?>">CH-
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#339900">
  ...
  <tr>
    ...
    <td width="200" align="right"><a target="_blank" href="../../../views/warehouse_mod/wo/sales_invoice_print_view_acc.php?v_no=<?=rawurlencode(url_encode($ch->chalan_no))?>">CH-
