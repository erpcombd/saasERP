...
if($jv_no>0){	
	...
	add_to_sec_journal($proj_id, $jv_no, $jv_date, $ledger_id, $dnarr, $amount, '0', $tr_from, $tr_no,$sub_ledger,'',$cc_code,'',$user_id,'',$r_from, $bank,$c_no,$cheq_date,$receive_ledger,$checked,$type,$employee,$remarks,$reference_id);

	$up = 'update secondary_journal set   manual_voucher_no="'.$manual_voucher_no.'" where jv_no="'.$_SESSION['jv_no'].'"';
	db_query($up);
...
if(isset($_POST['limmit'])){
	  ...
	  if($_SESSION['tr_no']>0){
		if($_SESSION['jv_no']>0){
			...
			add_to_sec_journal($proj_id, $_SESSION['jv_no'], $j_data->jv_date, $sub_led->ledger_id,  $detail, '0',$_POST['t_amount'], $tr_from,$j_data->tr_no,$j_data->relavent_cash_head,'',0,'',$_SESSION['user']['id'],'',$j_data->received_from,$j_data->bank,$j_data->cheq_no,$j_data->cheq_date,$j_data->relavent_cash_head,$checked,
			$j_data->type,$j_data->employee_id, $j_data->remarks , '0' );




			$up = 'update secondary_journal set checked="NO",   manual_voucher_no="'.$j_data->manual_voucher_no.'" where jv_no="'.$_SESSION['jv_no'].'"';
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="row pb-1">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pr-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text font-size12 req-input">Paid To:</label>
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
							...
							<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pl-0">
								<div class="form-group row m-0 pb-1">
									<label class="col-sm-5 col-md-5 col-lg-5 col-xl-5 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input font-size12">Payment Mode:</label>
									<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0 pr-2 ">
		...
		<div class="container-fluid pt-4 p-0 ">
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tr>
					...
					<td align="center">
<input list="sub_ledgers"  name="sub_ledger" id="sub_ledger" value="<?=$sub_ledger?>" autocomplete="off" />
