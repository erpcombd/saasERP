...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
  <tr>
	...
	<? if($master_invoice>0){?>
		<a target="_blank" href="../../warehouse_mod/po_return/purchase_invoice_print_view.php?v_no=<?=rawurlencode(url_encode($ch->pr_no));?>">PR-<?=$ch->pr_no?></a>
	<? } else{?>
		<a target="_blank" href="../../warehouse_mod/purchase_return/purchase_invoice_print_view.php?v_no=<?=rawurlencode(url_encode($ch->pr_no));?>">PR-<?=$ch->pr_no?></a>
		<? }?>
...
<a target="_blank" href="../../warehouse_mod/purchase_return/purchase_invoice_print_view.php?v_no=<?=$ch->pr_no?>"></a></div><? }else{?>
<div align="left">
<form action="" method="post">
