...
and a.ledger_group_id in (10201,10202)','ledger_id');
...
<td width="19%" align="center" style="background-color:#45777B;"><strong>Narration</strong></td>
<td width="12%" align="center" style="background-color:#45777B;"><span class="style3">Debit</span></td>
<td width="12%" align="center" style="background-color:#45777B;"><span class="style3">Credit</span></td>

<td width="7%" align="center" style="background-color:#45777B;"><strong>Action</strong></td>
</tr>
...
<? auto_complete_from_db('accounts_ledger a, ledger_group g','concat(a.ledger_id,"::",a.ledger_name," >>> ",g.group_name)','a.ledger_id','a.ledger_group_id=g.group_id
and a.ledger_group_id  in (10201,10202)','ledger_id_'.$data->id);?>
