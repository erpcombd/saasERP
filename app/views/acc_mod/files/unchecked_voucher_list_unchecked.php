		...
		<form class="n-form1 fo-width1 pt-4" id="form1" name="form1" method="post" action="">
			...
			<div class="container-fluid">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
					<label for="group_for" class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Voucher Type :</label>
