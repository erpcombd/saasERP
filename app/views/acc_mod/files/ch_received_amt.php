                    ...
                    <div class="form-group row m-0">
                        ...
                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
                            <select name="depot_id" id="depot_id"  class="form-control" >
								<? foreign_relation('warehouse','warehouse_id','warehouse_name',$depot_id,' order by warehouse_name');?>
								 <option value=""></option>
								<option value="">cumilla depot</option>
								<option value="">feni depot</option>
								<option value="">dhaka depot</option>
								<option value="">mirpur depot</option>
								<option value="">Barisal depot</option>
								<option value="">Bogora depto</option>
								<option value="">Dhaka Marketing depto</option>
							  </select>
                        </div>
                    </div>
