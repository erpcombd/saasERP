    ...
    <div class="row">
        ...
        <div class="col-sm-5 p-0  pl-2">
            ...
            <form class="n-form setup-fixed"  action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Sub Ledger Name</label>
                    <div class="col-sm-9 p-0">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Type</label>
                    <div class="col-sm-9 p-0">
				...
				<div class="form-group row m-0 pl-3 pr-3">
                    <label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Accounts Ledger</label>
                    <div class="col-sm-9 p-0">
