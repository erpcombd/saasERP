...
?>
			...
			<table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<tbody class="tbody1">
					 <?
						  ...
						  $ledger_con .=' and a.ledger_group_id = "'.$only_ledger_id.'"';
						  }
					
					
							 $sql="select a.ledger_id,a.ledger_name,a.ledger_group_id from accounts_ledger a
							  where 1 ".$ledger_con." order by a.ledger_id";
	  ...
	  <? echo $data[1];?></td>
	  					...
	  					<td ><input type="text" name="sub_ledger_id" id="sub_ledger_id" list="subledgerList" value="" >
						 <datalist id="subledgerList">
						<? foreign_relation('general_sub_ledger','concat(sub_ledger_name,"->",sub_ledger_id)','""',$_POST['sub_ledger_id'],'1');?>
						</datalist>
						</td>
