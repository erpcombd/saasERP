...
$j_sql="select ledger_id,cr_amt,dr_amt,narration from journal where tr_from='Opening' and group_for ='".$_POST['group_for']."' ";
...
var strURL="opening_balance_ajax.php?item_id="+item_id+"&cr="+cr+"&dr="+dr+"&opdate="+opdate+"&narration="+narration+"&flag="+flag+"&group_for="+group_for;
			...
			<div class="row">
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
					<div class="form-group row m-0 pb-1 pt-1">
						...
						<!--value="<?=find_a_field('opening_date','start_date','1');?>"-->
							<input name="op_date" type="text" class="required " id="op_date"  
value="<?=$_POST['op_date']?>"  required autocomplete="off" readonly=""/>
						</div>
					</div>
