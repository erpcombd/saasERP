...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.acc_class, a.acc_sub_class,  a.ledger_group_id, a.acc_sub_sub_class from '.$table.' a where  a.group_for="'.$_SESSION['user']['group'].'"  '.$con.' order by a.ledger_id  ';
                ...
                <div class="form-group row m-0 pl-3 pr-3 p-1">
                    ...
                    <div class="col-sm-7 p-0">
										...
										<option></option>
                      						...
                      						<? foreign_relation('ledger_group a','a.group_id','CONCAT(a.group_id, ": ", a.group_name)',$ledger_group_id,'a.group_for="'.$_SESSION['user']['group'].'"');?>
                    					</select></span>
                    </div>
                </div>
