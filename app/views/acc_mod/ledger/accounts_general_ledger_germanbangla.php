		...
		<form class="n-form" action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
							...
							<select name="acc_class" required id="acc_class"  tabindex="2" onchange="getData2('acc_sub_class_ajax_gm.php', 'sub_class', this.value, document.getElementById('acc_class').value);">
										<option></option>
