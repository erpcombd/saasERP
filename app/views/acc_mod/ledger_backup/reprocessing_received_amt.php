...
$title='Reprocessing Receive Varification';
$now=time();
				...
				group by  j.tr_no";
						...
						while($data=mysqli_fetch_object($query)){
							...
							<tr <?=($i%2==0)?'class="alt"':'';?>>
								...
								<td ><a target="_blank" href="reprocess_receive_sec_print_view.php?jv_no=<?=$data->jv_no ?>"><img src="../images/print_hover.png" width="20" height="20" /></a></td>
								<td ><span id="divi_<?=$data->tr_no?>">
<?
if(($data->checked=='YES')){
	?>
	<input type="button" name="Button" value="YES"  onclick="window.open('reprocess_receive_sec_print_view.php?jv_no=<?=$data->jv_no;?>');" class="btn1 btn1-bg-submit"/>
	<?
}elseif(($data->checked=='NO')){
	?>
	<input type="button" name="Button" value="NO"  onclick="window.open('reprocess_receive_sec_print_view.php?jv_no=<?=$data->jv_no;?>');" class="btn1 btn1-bg-submit"/>
<? }?>
          </span></td>
							</tr>
						<? }}?>
					<tr>
						<td colspan="6" align="center"><div align="right"><strong>Total Amt : </strong></div></td>
