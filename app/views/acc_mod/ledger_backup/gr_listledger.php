...
if(isset($_REQUEST['show']))
{
	...
	if($cc_code > 0)
	{
		...
		$c="select sum(a.dr_amt),sum(a.cr_amt) from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date<'$fdate' and a.ledger_id like '%$ledger_id%' and b.group_for=".$_SESSION['user']['group']." AND a.cc_code=$cc_code";
		 $p="select a.jv_date,b.ledger_name,sum(a.dr_amt) as dr_amt,sum(a.cr_amt) as cr_amt,a.tr_from,a.narration,a.jv_no,a.tr_no,a.jv_no from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '%$ledger_id%' and 1 AND a.cc_code=$cc_code and b.group_for=".$_SESSION['user']['group']." group by jv_no,narration order by a.jv_date,a.id";
	...
	else
	{
		...
		$p="select a.jv_date,b.ledger_name,sum(a.dr_amt) as dr_amt,sum(a.cr_amt) as cr_amt,a.tr_from,a.narration,a.jv_no,a.tr_no,a.jv_no,a.cheq_no,a.cheq_date from journal a,accounts_ledger b where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' and a.ledger_id like '%$ledger_id%' and b.group_for=".$_SESSION['user']['group']." group by jv_no,narration  order by a.jv_date,a.id";
