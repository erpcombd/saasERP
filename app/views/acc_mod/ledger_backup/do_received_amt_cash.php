...
$title='DO Cash Received Date';
$now=time();
do_calander('#f_date');
do_calander('#t_date');


$bank_head = '108600010001';
			...
			<div class="row">
					...
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								<input name="f_date" type="text" id="f_date" value="<?=$_POST['f_date']?>"  />
							</div>
						</div>
						...
						<div class="form-group row m-0 pb-1">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
								<input name="t_date" type="text" id="t_date" value="<?=$_POST['t_date']?>" />
							</div>
						</div>
				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
					<div class="container n-form2">
						...
						<div class="form-group row m-0 pb-1">
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Cash Acc :</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
...
a.acc_note
	 ...
	 a.payment_by = 'cash' and a.rcv_amt>0 and a.status!='Manual' and b.AREA_CODE=d.area_code and a.dealer_code=d.dealer_code and d.dealer_type='Distributor' ".$con;
	 ...
	 $con .= " and a.do_date between '".$_POST['f_date']."' and '".$_POST['t_date']."'";
	  ...
	  ?>
				<tr <? if(++$i%2==0) echo ''; else echo ' class="alt"';?>>
					...
					<td><b><? echo $data[0];?></b><br /><? echo $data[12];?></td>
					...
					<td><?
						  ...
						  ?>
						  <input name="rec_date_<?=$data[0]?>" type="text" id="rec_date_<?=$data[0]?>" value="<?=$data[11]?>"  /></td>
    ...
    <td>      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
			<td><table width="50%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FF9999">
              ...
              <tr>
                <td><div align="left"><strong>Cash Acc: </strong></div></td>
