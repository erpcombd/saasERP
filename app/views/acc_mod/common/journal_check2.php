...
<table width='100%' border="0"  bgcolor="#FFFFFF" style="border-collapse:collapse" class="datagtable">
	<tr align="left" id="rowid<?php echo $count;?>" height="30">
        <td width="8%">
        	<input name="type<?php echo $count;?>" id="type<?php echo $count;?>" type="text" readonly="true" value="<?php echo $type ?>" size="10" />
        </td>
        <td width="40%">
        	<input name="ledger_id<?php echo $count;?>" id="ledger_id<?php echo $count;?>" type="text" readonly="true" value="<?php echo $ledger; ?>" size="80" class="input1" style="width:285px;" />
            <input name="cur_bal<?php echo $count;?>" id="cur_bal<?php echo $count;?>" type="hidden" readonly="true" value="<?php echo $cur_bal; ?>" size="10" />
        </td>
        <td width="26%"><input name="detail<?php echo $count;?>" id="detail<?php echo $count;?>" type="text" value="<?php echo $detail; ?>" size="25" style="width:175px;" /></td>
        <td width="10%">
        	<input name="debit<?php echo $count;?>" id="debit<?php echo $count;?>" type="text" value="<?php echo $debit; ?>" onblur="editamount<?php echo $count;?>();" readonly="true" size="10" />
        </td>
        <td width="10%">
        	<input name="credit<?php echo $count;?>" id="credit<?php echo $count;?>" type="text" value="<?php echo $credit; ?>" onblur="editamount<?php echo $count;?>();" readonly="true" size="10" />
        </td>
        <td width="2%">
