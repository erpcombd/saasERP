...
add_to_sec_journal($proj_id, $jv_no, $jv_date, $noc_doc_vendor, $narration, $total_payable, 0, $tr_from, $tr_no,$info->sub_ledger_id,$tr_id,$cc_code,$group,$entry_by,$entry_at);
add_to_sec_journal($proj_id, $jv_no, $jv_date, $doc_vendor, $narration, 0, $total_payable, $tr_from, $tr_no,$info->sub_ledger_id,$tr_id,$cc_code,$group,$entry_by,$entry_at);
add_to_journal($proj_id, $jv_no, $jv_date, $noc_doc_vendor, $narration, $total_payable, 0, $tr_from, $tr_no,$info->sub_ledger_id,$tr_id,$cc_code,$group,$entry_by,$entry_at);
add_to_journal($proj_id, $jv_no, $jv_date, $doc_vendor, $narration, 0, $total_payable, $tr_from, $tr_no,$info->sub_ledger_id,$tr_id,$cc_code,$group,$entry_by,$entry_at);
