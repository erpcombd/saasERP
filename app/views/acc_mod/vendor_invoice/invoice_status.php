                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    while($row = mysqli_fetch_object($query)){
                        ...
                        <tr>
						  ...
						  <td><a href="../../purchase_mod/po/po_print_view_store.php?po_no='<?=rawurlencode(url_encode($row->po_no));?>'" target="_blank"><span class="style13" >
						    <?=$row->po_no?>
						  </span></a></td>
							<td><a href="../../warehouse_mod/po_receiving/chalan_view_store.php?v_no='<?=rawurlencode(url_encode($row->grn_no));?>'" target="_blank"><span class="style13" >
						 <?=$row->grn_no?></span></a></td>
