...
<?php /*?>	<? if($ex<time()){?>
	...
	<table width="96%" border="1" align="center" cellpadding="0" cellspacing="0">
      ...
      <tr>
        ...
        <td bgcolor="#66CCCC"><input style="width:120px;" name="mushak_no" type="text" id="mushak_no" value="<?=$info->mushak_no?>" /></td>
	  ...
	  <td bgcolor="#66CCCC">
                            <label  class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Upload Bill</label>

                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2"> 

        						<input type="file" name="file_upload" id="file_upload" class="pt-1 pb-1 pl-1" />
								</div>
		</td>
