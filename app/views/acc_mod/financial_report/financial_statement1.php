									...
									<table width="100%" border="0" cellspacing="2" cellpadding="0">
                                      ...
                                      <tr>
                                        ...
                                        <td width="50%" align="left">
												<input name="tdate" type="text" id="tdate" size="12" style="max-width:250px;" value="<?php echo $_REQUEST['tdate'];?>" autocomplete="off"/>
										</td>
...
?>									<table id="grp" width="100%" border="1" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<th width="55%" bgcolor="#82D8CF">&nbsp; Particular</th>
											<th width="5%" bgcolor="#82D8CF"> Notes</th>
											<th width="20%" bgcolor="#82D8CF" align="center"><div align="center">30th June'2022 <br/> Amount in Taka</div></th>
											<th width="20%" bgcolor="#82D8CF" align="center"><div align="center">30th June'2021 <br/> Amount in Taka</div></th>
										</tr>
										</thead>
...
<? }?>	
 						...
 						<tr>
										  ...
										  <td align="right"><strong>Sub Total:</strong></td>
											<td>&nbsp;</td>
										  <td align="right"><strong>
									      <?=number_format($tot_equity_amt=$equity_amt+$retained_earnings,2);?>
										  </strong></td>
										  <td >&nbsp;</td>
 						</tr>
...
<? }?>	
		...
		$tot_liability_amt=0;
									...
									<tr>
										  ...
										  <td align="right"><strong> Total Equity & Liabilities:</strong></td>
											<td>&nbsp;</td>
										  <td align="right"><strong>
