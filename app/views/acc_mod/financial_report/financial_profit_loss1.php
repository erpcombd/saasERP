...
?>									<table width="100%" id="grp" border="1" cellspacing="0" cellpadding="0">
										...
										<tr align="center">
											...
											<th width="20%" bgcolor="#82D8CF">30th June'2022 <br/> Amount in Taka</th>
											<th width="20%" bgcolor="#82D8CF">30th June'2021 <br/> Amount in Taka</th>
										</tr>
										</thead>
...
<? }?>	
		...
		$tot_sales_amt=0;
									...
									<tr>
										  ...
										  <td align="right"><strong>Total Sales [A]:</strong></td>
										  <td>&nbsp;</td>
...
<? }?>	
		...
		$tot_expenses_amt=0;
									...
									<tr>
										  ...
										  <td align="right"><strong> Total Expenses [B]:</strong></td>
										  <td>&nbsp;</td>
									...
									<tr>
									  <td align="right" bgcolor="#FF6347"><strong>Net Profit /(Loss) [A-B]:</strong></td>
	 ...
	 <?=($net_profit>0)?number_format($net_profit,2):'('.number_format($net_profit*(-1),2).')';?>
									...
									<tr>
									  <td align="right" bgcolor="#FF6347"><strong>Total Comprehensive Income for The Year:</strong></td>
									  <td bgcolor="#FF6347">&nbsp;</td>
									  <td align="right" bgcolor="#FF6347"><strong>
