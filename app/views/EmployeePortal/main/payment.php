    ...
    <main class="h-100">
        ...
        <div class="main-container container">
            ...
            <div class="row mb-3">
                ...
                <div class="col-auto">
                    <a href="index.php" class="small">Offers <i class="bi bi-chevron-right vm"></i></a>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-12">
                    <a href="index.php" class="btn btn-default shadow-sm btn-lg w-100 btn-rounded">Confirm</a>
                </div>
            </div>
        </div>
