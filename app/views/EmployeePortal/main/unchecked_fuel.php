...
<!-- User list items  -->
<div class="row">
<div class="row text-center mb-2"><h4>Pending Checking..<br /><?=$_SESSION['msg'];unset($_SESSION['msg']);?></h4></div>    
...
$sql = "select m.* from fuel_expense m where 1 and m.status='UNCHECKED' ".$con." order by m.expense_no asc";
