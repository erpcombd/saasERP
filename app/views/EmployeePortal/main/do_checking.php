...
if(isset($_POST['hold'])){
		...
		?><script>window.location.href='unchecked_fuel.php';</script><?php 
}
...
if(isset($_POST['confirmm'])){
		unset($_POST);
		$_POST[$unique]=$$unique;
		$_POST['checked_by']=$_SESSION['user_id'];
        ...
        $_SESSION['msg']='<span style="color:green; font-weight:bold">Checked Successfully.</span>';

?><script>window.location.href='unchecked_fuel.php';</script><?  
} // End confirm
