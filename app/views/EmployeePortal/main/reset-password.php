    ...
    <main class="container-fluid h-100 ">
        <div class="row h-100">
            <div class="col-11 col-sm-11 col-md-6 col-lg-5 col-xl-3 mx-auto align-self-center py-4">
                <h2 class="mb-3"><span class="text-secondary fw-light">Change your</span><br />password</h2>
                <p class="text-secondary mb-4">Thank you for confirming email address and username.</p>

                <div class="form-group form-floating mb-3">
                    <input type="password" class="form-control is-valid" value="maxartkiller" id="passowrd1" placeholder="New Password">
                    <label class="form-control-label" for="passowrd1">New Password</label>
                </div>

                <div class="form-group form-floating mb-3">
                    <input type="password" class="form-control is-invalid" id="password" placeholder="Confirm Password">
            ...
            <div class="col-11 col-sm-11 mt-auto mx-auto py-4">
                <div class="row ">
                    <div class="col-12 d-grid">
                        <a href="thankyou.php" class="btn btn-default btn-lg shadow-sm btn-rounded">Update</a>
                    </div>
                </div>
            </div>
        </div>
