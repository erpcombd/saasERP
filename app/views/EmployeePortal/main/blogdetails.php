                ...
                <div class="col-12 px-0">
                    <div class="card mb-4 overflow-hidden shadow-sm card-theme text-white rounded-0">
                        ...
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="col">
                                    <span class="tag bg-theme text-white">Trending</span>
                                </div>
                                <div class="col-auto">
                                    <button class="btn btn-info text-white avatar avatar-40 p-0 rounded-circle shadow-sm"><i class="bi bi-share"></i></button>
                                    <button class="btn btn-success text-white avatar avatar-40 p-0 rounded-circle shadow-sm"><i class="bi bi-bookmark"></i></button>
                                </div>
                            </div>
                            <br>
                            <a href="blogdetails.php" class="h4 mb-1 text-normal d-block text-white">Best Discovery
                                ever
                                in UX</a>
                            ...
                            <div class="d-flex">
                                ...
                                <p class="mx-2 lh-small align-self-center">Alessia Monks<br /><span class="small">Author</span></p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-12 col-md-10 col-lg-8 mx-auto">
                    ...
                    <div class="card mb-4 overflow-hidden shadow-sm card-theme text-white">
                        ...
                        <div class="card-body">
                            <br><br><br>
                            <a href="blogdetails.php" class="h5 text-normal d-block text-white">Best Discovery ever
                                in UX</a>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="card mb-4 overflow-hidden shadow-sm card-theme text-white">
                                ...
                                <div class="card-body">
                                    <br><br><br>
                                    <a href="blogdetails.php" class="h6 text-normal d-block text-white">Best
                                        Discovery ever in
                                        UX</a>
                    ...
                    <div class="row mb-4">
                        <div class="col-12">
                            <div class="row py-3 gx-3">
                                ...
                                <div class="col">
                                    <a href="profile.php" class="mb-0 text-normal d-block text-color-theme">Ajinkya
                            ...
                            <div class="row py-3 gx-3">
                                ...
                                <div class="col">
                                    <a href="profile.php" class="mb-0 text-normal d-block text-color-theme">Jessica
                            ...
                            <div class="row py-3 gx-3">
                                ...
                                <div class="col">
                                    <a href="profile.php" class="mb-0 text-normal d-block text-color-theme">Bhagat
