...
<body class="body-scroll theme-pink" data-page="product">
    ...
    <main class="h-100">
        ...
        <div class="main-container container">
                            ...
                            <div class="row">
                                ...
                                <div class="col align-self-center ps-0">
                                    <h6 class="mb-1">San Jose, USA
                                        <a href="addaddress.php" class="text-color-theme float-end small">Change <i class="bi bi-chevron-right"></i></a>
                                    </h6>
            ...
            <div class="row mb-4">
                <div class="col">
                    <a href="cart.php" class="btn btn-default btn-lg shadow-sm w-100 btn-rounded">Add to Cart</a>
                </div>
                <div class="col">
                    <a href="cart.php" class="btn btn-success btn-lg shadow-sm w-100 text-white btn-rounded">Buy
                        Now</a>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-12 text-center mb-3">
                    <button class="btn btn-sm btn-outline-info me-2 btn-rounded" type="button" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    ...
                    <div class="swiper-container connectionwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide text-center">
                                <a href="product.php" class="card text-center bg-theme text-white">
