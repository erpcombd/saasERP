...
<body class="body-scroll theme-pink" data-page="profile">
        ...
        <div class="main-container container">
            <div class="row my-4">
                <div class="col-12 text-center">
                    <figure class="avatar avatar-100 rounded-20 bg-white shadow-sm mb-3">
                        <img src="assets/img/user1.jpg" alt="">
                    </figure>
                    <h1 class="mb-2"><span class="fw-light text-secondary">John</span> Doe</h1>
                    <p class="text-muted size-12">New York City, United States</p>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col">
                    <a href="" class="btn btn-outline-default btn-lg shadow-sm w-100 btn-rounded">Invite</a>
                </div>
                <div class="col">
                    <a href="message.php" class="btn btn-default btn-lg shadow-sm w-100 btn-rounded">Message</a>
                </div>
            </div>
            <!-- location map-->
            <div class="row mb-4">
            ...
            <div class="row mb-3">
                <div class="col">
                    <h6 class="title">Recent Purchases</h6>
                </div>
            </div>
            <!-- products -->
            <div class="row mb-2">
            ...
            <div class="row mb-2">
                ...
                <div class="col-auto">
                    <a href="userlist.php" class="small">View More</a>
                </div>
            </div>
            <div class="row mb-3">
