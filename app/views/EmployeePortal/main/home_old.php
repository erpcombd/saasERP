...
<div class="row  text-white">
                ...
                <div class="col-6 col-sm-3  p-2  align-self-center">

                    <div class="text-center rounded bg-theme py-4">
                ...
                <div class="col-6 col-sm-3  p-2   align-self-center">
                    ...
                    <div class="text-center rounded bg-theme3 py-4">
                ...
                <div class="col-6 col-sm-3  p-2  align-self-center">
                    ...
                    <div class="text-center rounded bg-theme1 py-4">
                ...
                <div class="col-6 col-sm-3  p-2  align-self-center">
                    ...
                    <div class="text-center rounded bg-theme2  py-4">
  ...
  <div class="col-12 col-sm-6 p-2">
  <div class="card" style="min-height: 293px;">
