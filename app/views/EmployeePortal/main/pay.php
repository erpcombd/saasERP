            ...
            <div class="row">
                <div class="col-12 mb-3">
                    ...
                    <p class="text-secondary mb-3">Its instant and easy. There are 1500k sellers accept payment via
                        oneuiux. To Scan Allow access to camera.</p>
                    <p class="text-secondary">Now you can also make payments for 100 other standard payment services.
                    </p>
                </div>
                <div class="col-12 mb-4 text-center">
                    <button class="btn btn-default btn-lg mb-3 px-4 shadow-sm btn-rounded" data-bs-target="#cammodal" data-bs-toggle="modal">
                ...
                <div class="modal-dialog modal-xsm modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body text-center">
                            <div class="avatar avatar-80 shadow-sm shadow-primary rounded-15 mb-4">
                            ...
                            <p class="text-secondary">To scan QR code we need to access camera please allow app to
                                access camera.
                            </p>
                        </div>
