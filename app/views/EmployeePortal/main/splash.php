...
<body class="body-scroll d-flex flex-column h-100 theme-pink" data-page="splash">
    ...
    <main class="container-fluid h-100">
        <div class="row h-100">
            <div class="col-10 col-md-6 col-lg-4 text-center align-self-center mx-auto">
                <a href="landing.php" class="logo-splash">
                    <img src="assets/img/logo.png" alt="" />
                    <h1 class="mt-4 mb-3">
                        <span class="text-color-theme">OneUIUX</span><br>
                        <span class="fw-light">Shopping</span>
                    </h1>
