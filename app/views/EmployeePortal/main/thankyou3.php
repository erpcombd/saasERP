...
<body class="body-scroll d-flex flex-column h-100 theme-pink" data-page="thankyou3">
            ...
            <div class="col-12 align-self-center pb-3">
                <div class="row mx-0">
                    <div class="col-11 col-md-8 col-lg-4  col-ld-6 mx-auto">
                            ...
                            <div class="col-11 z-index-1 mt-5">
                                <div class="card rounded-top-left-40 rounded-bottom-right-40 rounded-0 h-200 overflow-hidden">
                                    <div class="coverimg top-0 start-0 h-100 w-100">
                                        <img src="assets/img/thankyou3.jpg" alt="" />
                                    </div>
                                </div>
                            </div>
                        ...
                        <h2 class="mb-4">
                            <span class="text-secondary fw-light">Withdraw</span><br />Successfully!
                        </h2>
            ...
            <div class="col-11 col-sm-11 mt-auto mx-auto py-4">
                <div class="row ">
                    <div class="col-12 d-grid">
                        <a href="index.php" class="btn btn-default btn-lg shadow-sm btn-rounded">Back to Home</a>
                    </div>
                </div>
            </div>
        </div>
