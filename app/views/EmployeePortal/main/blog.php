...
<body class="body-scroll theme-pink" data-page="blog">
                ...
                <div class="col-12 col-md-6">
                    <div class="card card-theme mb-4 overflow-hidden shadow-sm text-white">
                        ...
                        <div class="card-body">
                            <div class="row mb-5">
                                <div class="col">
                                    <span class="tag bg-theme text-white">Popular</span>
                                </div>
                                <div class="col-auto">
                                    <button class="btn btn-theme avatar avatar-40 p-0 rounded-circle shadow-sm"><i class="bi bi-share"></i></button>
                                    <button class="btn btn-success text-white avatar avatar-40 p-0 rounded-circle shadow-sm"><i class="bi bi-bookmark"></i></button>
                                </div>
                            </div>
                            <br>
                            <a href="blogdetails.php" class="h4 mb-2 text-normal d-block text-white">Best Discovery
                                ever in UX</a>
            ...
            <div class="row">
                <div class="col-12 col-md-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="blogdetails.php" class="h5 mb-3 d-block text-normal">Maxartkiller has awesome
                                templae
                                to start</a>
                            <p class="text-secondary small">Lorem ipsum dolor sit amet, consect etur adipiscing elit.
                                Sndisse conv allis.</p>
                            <a href="blogdetails.php" class="text-normal small">Read More <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                </div>
                <div class="col-12 col-md-6 mb-3">
                    <div class="row">
                        ...
                        <div class="col align-self-center">
                            <a href="blogdetails.php" class="h5 mb-3 d-block text-normal">For the people by people Best
