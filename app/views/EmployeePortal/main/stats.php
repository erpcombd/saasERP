...
<body class="body-scroll theme-pink" data-page="stats">
                ...
                <div class="col-12 overflow-hidden">
                    ...
                    <div class="row">
                        <div class="col position-relative align-self-center">
                            ...
                            <h6 class="mb-1">Quick View Analysis</h6>
                ...
                <div class="col-6 col-md-3">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-40 bg-success text-white rounded-15 shadow-sm shadow-success">
                ...
                <div class="col-6 col-md-3">
                    <div class="card mb-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-auto">
                                    <div class="avatar avatar-40 bg-danger text-white rounded-15 shadow-sm shadow-danger">
                    ...
                    <div class="swiper-container connectionwiper">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide text-center">
                                <div class="avatar avatar-80 bg-white text-color-theme rounded-18 shadow-sm mb-2">
