				  ...
				  <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12 layout-spacing">
                        ...
                        <div class="widget widget-table-two">
                            ...
                            <div class="widget-heading">
                                ...
                                <h5 class="">Purchase Order History</h5>
                                    ...
                                    <table class="table">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th><div class="th-content">Supplier name</div></th>
...
$sql2="select p.*,i.*,b.* from purchase_master p,purchase_invoice i, vendor b where p.vendor_id=p.vendor_id and p.po_no=i.po_no and p.po_no='.$po_no.' and p.status='CHECKED' ";
...
?>
                                            ...
                                            <tr>
                                                ...
                                                <td><div class="td-content customer-name"><img src="assets/img/profile-7.jpg" alt="avatar"><?=$data->vendor_name; ?></div></td>
