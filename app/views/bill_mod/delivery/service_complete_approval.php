...
<th class="text-center">Action</th>
 ...
 $con=' and a.service_date between "'.date('Y-m-o1').'" and "'.date('Y-m-d').'"';
  ...
  where a.entry_by=u.user_id and a.status in ("READY") '.$con.' order by a.service_no desc';
...
<td class="text-center"><a href="feedback_approval.php?service_no=<?=$data->service_no?>"><button class="btn btn-success btn-sm">Feedback</button></a></td>
