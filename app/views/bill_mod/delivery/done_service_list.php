...
<form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      <tr>
        ...
        <td colspan="3"><?=$_SESSION['msgs']; unset($_SESSION['msgs']);?></td>
...
<th class="text-center">Action</th>
 ...
 $con=' and a.service_date between "'.date('Y-m-o1').'" and "'.date('Y-m-d').'"';
  ...
  where a.entry_by=u.user_id and a.status in ("DELIVERY UNCHECKED") '.$con.' order by a.service_no desc';
...
<td class="text-center"><a href="service_delivery.php?service_no=<?=$data->service_no?>"><button class="btn btn-success btn-sm">Feedback</button></a></td>
