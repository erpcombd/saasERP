...
<?php /*?>					<? if ($customer->bin !=''){?>
					<th><strong>BIN</strong></th><? } ?><?php */?>
				</tr>
				<tr>
					<td><?=$all->manual_bill_no?></td>
					<td><?php echo date("d-m-Y",strtotime($all->bill_date)); ?></td>
<?php /*?>					<? if ($customer->bin !=''){?>
					<td>003408615-0401</td><? } ?><?php */?>
				</tr>
				<? if ($customer->bin !=''){?>
				<tr>
					<td colspan="2" align="left" ><strong>BIN:</strong> <span>003408615-0401</span></td>
				</tr>
				<? } ?>
	<!--			<tr>
...
$pi=0;
$total=0;
$sql2="select b.*, a.type from bill_details b, acc_bill_type a,bill_info i where a.id=b.service_type and i.bill_no=b.bill_no  and i.bill_no='$bill_no'";
$data2=db_query($sql2);
//echo $sql2;
...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
		...
		<tr>
			<td width="20%" align="left" ><u><strong>Amount In Words</strong></u></td>
...
<? }?>
        ...
        <tr>
          <td colspan="5" align="left">H. S. Sohorowordy</td>
        </tr>
        <tr>
          <td colspan="5" align="left" style=" font-size: 14px; ">Head Of Operation </td>
        </tr>
		<br />
        <tr>
