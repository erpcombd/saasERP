...
$sql="select * from bill_info where  manual_bill_no='$manual_bill_no'";
$data=db_query($sql);
...
$pi=0;
$total=0;
 $sql2="select b.*, a.type from bill_details b, acc_bill_type a,bill_info i where a.id=b.service_type and i.bill_no=b.bill_no  and i.manual_bill_no='$manual_bill_no'";
$data2=db_query($sql2);
//echo $sql2;
