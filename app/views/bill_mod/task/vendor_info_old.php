...
$input_page="vendor_info_input.php"; $add_button_bar = 'Mhafuz';
...
function DoNav(theUrl){
	document.location.href = 'vendor_info_input.php?vendor_id='+theUrl;
}
...
<?php
    ...
    <?php /*?><td>
	<div class="right">  <form id="form2" name="form2" method="post" action="vendor_info.php?vendor_id=<?php echo $vendor_id;?>" onsubmit="return check()">
							  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                <tr>
                                  ...
                                  <td><div class="box">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
									  ...
									  <tr>
										...
										<input name="vendor_name" type="text" id="vendor_name" value="<?php echo $data[4];?>" size="30" maxlength="100" />
										</td>
									  </tr>
...
<script type="text/javascript">
function DoNav(theUrl){
window.open('../../pages/vendor<?=$root?>/<?=$input_page?>?<?=$unique?>='+lk  "_blank");
