...
$con .= 'and a.req_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
 ...
 $new_sql='select t.*,p.PBI_NAME,proj.project_name from task_assign_master t, personnel_basic_info p, task_project proj where t.assign_person=p.PBI_ID and proj.project_id=t.project and t.status="Processing" and 1 order by task_no desc';
