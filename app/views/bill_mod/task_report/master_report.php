...
<table width="60%" cellspacing="0" cellpadding="2" border="0" style="margin:auto;" align="center">
<thead>
...
if($_POST['PBI_ID']>0){
 $conn = ' and t.assign_person="'.$_POST['PBI_ID'].'"';
}
/*if($_POST['project']>0){
...
$res='select t.*, p.PBI_NAME from task_list t, personnel_basic_info p where t.assign_person=p.PBI_ID '.$conn.'';
$queryd=db_query($res);
while($data = mysqli_fetch_object($queryd)){
?>
<tr>
  <td bgcolor="#CCCCCC">Project Name</td>
  <td><?=find_a_field('project','PROJECT_NAME','PROJECT_ID="'.$data->project_id.'"')?></td>
  <td bgcolor="#CCCCCC">Given Date</td>
  <td><?=$data->task_date?></td>
</tr>

<tr>
  <td bgcolor="#CCCCCC">Assigned by</td>
  <td><?=$data->PBI_NAME?></td>
 <td bgcolor="#CCCCCC">Status</td>
  <td><span style="font-weight:bold; font-size:15px;"><?=$data->status?></span></td>

</tr>

<tr>
  <td bgcolor="#CCCCCC">Task</td>
  <td colspan="3"><span style="font-weight:bold; font-size:15px;"><?=$data->task?></span></td>
</tr>
...
<tr>
  <td colspan="4" style="border:0px;" align="center"><span style="font-weight:bold; border:0px; border-bottom:0px; font-size:15px;">Activity</span></td>
</tr>
<tr>
...
<?
$res='select a.*,p.PROJECT_NAME from user_productivity a, project p where p.PROJECT_ID=a.project_id and task_id="'.$data->id.'"';
$queryd=db_query($res);
while($data2 = mysqli_fetch_object($queryd)){
?>

<tr>
  <td><?=$data2->PROJECT_NAME?></td>
  <td><?=$data2->subject?></td>
  <td><?=$data2->task_request_by?></td>
  <td><?=$data2->req_date?></td>
  <td><?=$data2->complete_date?></td>
  <td><?=$data2->task_status?></td>
</tr>
...
<tr>
  <td colspan="4" style="border:0px;" align="center"><span style="font-weight:bold; border:0px; font-size:15px;">Comments</span></td>
</tr>
...
<tr>
  <td bgcolor="#CCCCCC">Commented By</td>
  <td bgcolor="#CCCCCC">Commented At</td>
  <td bgcolor="#CCCCCC">Comment</td>
  
</tr>
<?
$res='select c.* from comment_list c where  c.m_id="'.$data->id.'" and tr_from="task"';
$queryd=db_query($res);
while($data2 = mysqli_fetch_object($queryd)){
?>
<tr>
