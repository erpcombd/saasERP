						...
						<tbody>
							...
							?>
								<tr>
									...
									<button class="btn btn-primary" data-toggle="modal" data-target="#commentTaskModal<?=$task_data->id?>" type="button" id="new_productivity">
								 Comment</button>
        ...
        <form action="" method="post">
		  ...
		  <div class="form-group">
            ...
            <select class="form-control form-control-sm select2" name="task_id">
				<option></option>
				<? foreign_relation('task_list','id','task',$task_id,'1 and id = "'.$data->id.'" order by id asc');?>
			</select>
          </div>
		  <div class="form-group">
