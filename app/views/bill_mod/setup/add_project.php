...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>    <td width="66%" style="padding-right:5%">
	<div class="left">
						...
						<thead>
							  <tr>
								<th bgcolor="#45777B"><span class="style3">Project ID</span></th>
								<th bgcolor="#45777B"><span class="style3">Project</span></th>
							  </tr>
						</thead><tbody>
<?php 

$rrr="select a.project_id, a.project_name FROM task_project a where 1 order by a.project_id desc";
                                ...
                                <tr>
								  ...
								  <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                      ...
                                      <td><input name="Button" type="button" class="btn btn-warning" value="Clear" onClick="parent.location='add_project.php'"/></td>
