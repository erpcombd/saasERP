...
do_calander("#f_date");
do_calander("#t_date");
auto_complete_from_db('item_info','concat(item_name)','item_id','1 and finish_goods_code>0','item_id');
                    ...
                    <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                <td width="6%"><input name="report" type="radio" class="radio" value="1" class="form-control" /></td>
                                <td width="94%"><div align="left">Purchase Order Summary</div></td>
                              </tr>
                              
                              <tr>
                                <td><input name="report" type="radio" class="radio" value="2" class="form-control" /></td>
                                <td><div align="left">Purchase Receive Report(PO Wise)</div></td>
                              </tr>
                             <!-- <tr>
                                <td><input name="report" type="radio" class="radio" value="3" class="form-control" /></td>
                                <td><div align="left">Purchase Receive Report(Date Wise)</div></td>
                              </tr>-->
                              <!--<tr>
                                <td><input name="report" type="radio" class="radio" value="5" class="form-control" /></td>
                                <td><div align="left">Purchase History Report</div></td>
                              </tr>-->
                             <!-- <tr>
                                <td><input name="report" type="radio" class="radio" value="6" class="form-control" /></td>
                                <td><div align="left">Purchase Receive Report</div></td>
                              </tr>-->
                              <!--<tr>
                                <td><input name="report" type="radio" class="radio" value="4" class="form-control" /></td>
...
?>
				...
				<? foreign_relation('item_sub_group','sub_group_id','sub_group_name',$data->sub_group_id);?>
                  ...
                  <tr>
                    <td>From: </td>
                    <td><input  name="f_date" type="text" id="f_date" value="<?=date('Y-m-01')?>" required class="form-control" autocomplete="off"/></td>
                  </tr>
                  <tr>
                    <td>To: </td>
                    <td><input  name="t_date" type="text" id="t_date" value="<?=date('Y-m-d')?>" required class="form-control" autocomplete="off"/></td>
                  </tr>
				  <!--<tr>
                    <td>Vendor Name: </td>
                    <td><select name="vendor_id" id="vendor_id" class="form-control">
				  ...
				  <tr>
				    <td>Branch:</td>
				    <td><select name="warehouse_id" id="warehouse_id" style="width:200px;">
