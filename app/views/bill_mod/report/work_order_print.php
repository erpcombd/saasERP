...
$res='select a.id,b.item_name,a.style_no,a.specification,a.meassurment,a.qty,a.rate,a.amount from lc_workorder_details a,lc_product_item b where b.id=a.item_id and a.wo_id='.$_REQUEST["wo_id"];
...
<div class="main">
  ...
  <?
		...
		if($wo->for=='TT')
		{ 
		$str 	.= '<h1>TOTAL TRIMS</h1>';
		$str 	.= '<div>Office: House# 502(1st Floor), Road# 9(East Side), DOHS Baridhara, Dhaka-1206, Tel: 88-02-8413370, 8413371</div>Work Order No: '.$_REQUEST["wo_id"];
		}
		else
		{
		$str 	.= '<h1>NETRAKONA ACCESSORIES LTD.</h1>';
		$str 	.= '<div>Office: House# 502(1st Floor), Road# 9(East Side), DOHS Baridhara, Dhaka-1206, Tel: 88-02-8413370, 8413371</div>Work Order No: '.$_REQUEST["wo_id"];
		}
		if(isset($report)) 
		$str 	.= '<h2>'.$report.'</h2>';
