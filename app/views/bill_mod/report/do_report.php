        ...
        <div class="row m-0 p-0">
            ...
            <div class="col-sm-5">
				...
				<div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="77712345"  tabindex="1"/>

                    <label class="form-check-label p-0" for="report1-btn">

                       Monthly Collection Wise Report
				...
				<div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="7779"  tabindex="1"/>

                    <label class="form-check-label p-0" for="report1-btn">

                       Monthly Collection Bill Wise
				...
				<!--<div class="form-check">
                    ...
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="70707"  tabindex="1"/>

                    <label class="form-check-label p-0" for="report1-btn">

                       Closing Report (Periodical)
            ...
            <div class="col-sm-7">
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                      ...
                      <select name="customer_id" id="customer_id" class="form-control">
							...
							<? foreign_relation('service_customer','customer_id','customer_name',$data->customer_id);?>
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <label for="group_for" class="col-sm-4 m-0 p-0 d-flex align-items-center">Customer Type</label>
			   ...
			   <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                      ...
                      <select name="type" id="type" class="form-control">
                        ...
                        <? foreign_relation('acc_bill_type','id','type',$type,'1');?>
