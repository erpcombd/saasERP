...

{
		...
		header('location:unapprove_branch_po.php');
...
<table width="40%" border="1" align="center" cellpadding="0" cellspacing="0" style="border-collapse:collapse">
  ...
  <tr>
    ...
    <td rowspan="2" align="center" bgcolor="#CCFF99"><a href="po_print_view.php?po_no=<?=$po_no?>" target="_blank"><i class="fas fa-print" style="color:black;"></i></a></td>
