...
$table = 'daily_action_plan_master';

$unique = 'd_id';

$status = 'MANUAL';

$target_url = '../po/action_plan_print_view.php';
...
$cons =" and a.warehouse_id='".$_POST['warehouse_id']."' ";
    ...
    $res='select  a.d_id,a.d_id, DATE_FORMAT(a.progress_date, "%d-%m-%Y") as progress_date, s.type, c.fname as entry_by, a.entry_at, a.status
	 from daily_action_plan_master a, daily_progress_setup s,user_activity_management c
