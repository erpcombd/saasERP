...
/*}*/
	...
	<div class="form-container_large">
		...
		<form  id="form1" name="form1" method="post" action="">
				...
				<div class="n-form1 fo-short pt-2">
					<div class="container">
						<div class="form-group row  m-0 mb-1 pl-3 pr-3">
							<label for="group_for" class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Period :</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">
				<input name="fdate"  type="text" id="fdate" size="12" class="form-control" value="<?=($_REQUEST['fdate']!=''? $_REQUEST['fdate']: date('Y-m-01'));?>" />
			...
			<input name="tdate" type="text" id="tdate" size="12" class="form-control" value="<?=($_REQUEST['tdate']!=''? $_REQUEST['tdate']: date('Y-m-d'));?>"/>
						...
						<div class="form-group row  m-0 mb-1 pl-3 pr-3">
							<label for="group_for" class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Ledger Head :	</label>
							<div class="col-sm-9 col-md-9 col-lg-9 col-xl-9 p-0 pr-2">


<?php
$delId=find_a_field('user_activity_management','dealer_code','user_id="'.$_SESSION['user']['id'].'"');

$acCode=find_a_field('dealer_info','account_code','dealer_code="'.$delId.'"');
?>
								...
								<select name="ledger_id" id="ledger_id" class="form-control"  >
									...
									foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,"ledger_id='".$acCode."'");
		...
		<div class="container-fluid">
		 ...
		 from journal a,accounts_ledger b".$d_table." where a.ledger_id=b.ledger_id and a.jv_date between '$fdate' AND '$tdate' ".$cc_con." and a.ledger_id like '$sledger_id%' ".$d_where;
							...
							<?php } ?>
							<tr >
								<th colspan="5" class="bg-table1">Difference Balance : <?php echo number_format($t_total,2)." ".$t_type?> </th>
...
?>
                                        ...
                                        <td width="50%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
											<? if($_REQUEST['ledger_id']>0) echo find_a_field('accounts_ledger','ledger_name','ledger_id='.$_REQUEST['ledger_id']);?>&nbsp;</td>
                                      </tr>
						  ...
						  <option value="">Select Type</option>
                                      ...
                                      <tr>
                                        ...
                                        <td colspan="2" align="left">
											...
											<select name="cc_code" id="cc_code" style="width:250px;" class="form-control" >
							  ...
							  <tr>
								...
								<th width="37%" align="center">Acc Name</th>
								<th width="19%" align="center">Particulars</th>
...
//<?php /*?><?php $blance = $blance+($data[2]-$data[3]); if($blance>0) echo '(Dr) '.number_format($blance,2); elseif($blance<0) echo '(Cr) '.number_format(((-1)*$blance),2);else echo "0.00"; ?><?php //?><!--</th>-->
