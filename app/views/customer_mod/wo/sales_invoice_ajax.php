...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="8%"><input name="unit_name" type="text" class="input3"  value="<?=$item_all->unit_name;?>" id="unit_name" style="width:90%; height:30px;" /></td>
	 ...
	 <td width="12%"><input name="unit_price" type="text" class="input3" id="unit_price"  style="width:90%; height:30px;" required="required"  value="<?=$item_sales_price?>"   /></td>
</tr>
</table>
