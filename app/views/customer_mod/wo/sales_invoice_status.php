                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                   ...
                   <? 
					...
					where 
					  ...
					  m.group_for=u.id  and m.dealer_code=d.dealer_code and m.entry_by='".$_SESSION['user']['id']."' and m.do_no=c.do_no ".$group_for_con.$con.$dealer_con."  group by c.do_no order by m.do_no desc";
					...
					?>
                        ...
                        <tr> 
							...
							<td><?= ($data->status=="CUSTOMER")?"Requested" : $data->status ;?></td>

							

							<td><button class="btn1 btn1-bg-submit" onClick="custom('<?=url_encode($data->do_no);?>');">VIEW</button></td>
