...
$dcode=find_a_field('user_activity_management','dealer_code','user_id="'.$_SESSION['user']['id'].'"');

$ddate=date('Y-m-d');

 $sql='select * from customer_notice where dealer_code="'.$dcode.'" and start_date<="'.$ddate.'" and end_date>="'.$ddate.'"';
...
$exc=find_a_field('customer_notice','count(dealer_code)','dealer_code="'.$dcode.'" and start_date<="'.$ddate.'" and end_date>="'.$ddate.'"');
...
?>
 ...
 <? }?>
	...
	$exc1=find_a_field('customer_message','count(dealer_code)','dealer_code="'.$dcode.'" and start_date<="'.$ddate.'" and end_date>="'.$ddate.'"');
...
$ddate=date('Y-m-d');
 ...
 $sql1='select * from customer_message where dealer_code="'.$dcode.'" and start_date<="'.$ddate.'" and end_date>="'.$ddate.'"';
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats" style="border: 1px solid orange;">
                ...
                <div class="card-header card-header-warning card-header-icon">
                  ...
                  <h3 class="card-title font-siz"><span id="sales7day" class="loader">Checking..</span></h3>
               ...
               <div class="card-footer" style="border-top:1px solid orange">
				  ...
				  <h5 class="m-0 font-weight-bold"> TOTAL SALES</h5>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats" style="border: 1px solid green;">
                ...
                <div class="card-footer" style="border-top:1px solid green">
                  ...
                  <div class="stats m-0"><h5 class="m-0 font-weight-bold"> TOTAL POS SALES</h5></div>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats" style="border: 1px solid red;">
                ...
                <div class="card-footer" style="border-top:1px solid red">
				  ...
				  <h5 class="m-0 font-weight-bold"> TOTAL LOCAL SALES</h5>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              ...
              <div class="card card-stats" style="border: 1px solid #1ec1d5;">
                ...
                <div class="card-footer" style="border-top:1px solid #1ec1d5">
				  ...
				  <h5 class="m-0 font-weight-bold"> TOTAL SALES RETURN</h5>
				...
				<div class="col-lg-6 col-md-12">
					...
					<div class="card card-chart">
						...
						<div class="card-body">
							...
							<h4 class="card-title">ONE YEAR SEALS REPORTS </h4>
