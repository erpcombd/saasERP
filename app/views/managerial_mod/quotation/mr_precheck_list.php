                ...
                <table class="table1  table-striped table-bordered table-hover table-sm">
                    ...
                    <tbody class="tbody1">
						...
						<? 
							...
							$res='select  	a.quotation_no,a.quotation_no as quotation_no, DATE_FORMAT(a.quotation_date, "%d-%m-%Y") as quotation_date,  v.vendor_name as vendor_name,  c.fname as entry_by, a.entry_at,a.status 
							
							from quotation_master a,user_activity_management c, vendor v 
							
							where a.vendor_id=v.vendor_id  and a.entry_by=c.user_id '.$con.'  order by a.quotation_no DESC';
