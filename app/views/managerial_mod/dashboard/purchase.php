...
$title = "Purchase management Dashboard";
 ...
 function getMonthlySales($month, $year) {
    ...
    return  $new_purchase_order_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and pm.po_date BETWEEN  "'.$start_date.'" AND "'.$end_date.'" and pm.status  IN ("CHECKED","PROCESSING", "COMPLETED")');
...
$new_purchase_order_yesterday=find_a_field('purchase_master ','count(po_no)','1 and po_date ="'.$yesterday.'" and status in ("CHECKED","PROCESSING","COMPLETED")');
$new_purchase_order_yesterday_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and pm.po_date ="'.$yesterday.'" and pm.status IN ("CHECKED","PROCESSING","COMPLETED")');

$new_purchase_order_last_week=find_a_field('purchase_master ','count(po_no)','1 and po_date BETWEEN "'.$lastdays.'" and "'.$yesterday.'" and status in ("CHECKED","PROCESSING","COMPLETED")');
$new_purchase_order_last_week_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and pm.po_date  BETWEEN "'.$lastdays.'" and "'.$yesterday.'"  and pm.status IN ("CHECKED","PROCESSING","COMPLETED")');

$new_purchase_order_last_month=find_a_field('purchase_master ','count(po_no)','1 and po_date BETWEEN "'.$firstDayLastMonth.'" and "'.$lastDayLastMonth.'" and status in ("CHECKED","PROCESSING","COMPLETED")');
$new_purchase_order_last_month_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and pm.po_date  BETWEEN "'.$firstDayLastMonth.'" and "'.$lastDayLastMonth.'"  and pm.status IN ("CHECKED","PROCESSING","COMPLETED")');

$new_purchase_order=find_a_field('purchase_master ','count(po_no)','1 and YEAR(po_date) ="'.$current_year.'" and status in ("CHECKED","PROCESSING","COMPLETED")');
$new_purchase_order_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and YEAR(pm.po_date) ="'.$current_year.'" and pm.status IN ("CHECKED","PROCESSING","COMPLETED")');
 ...
 // Check if $approved_po_amount is null, and if so, set it to 0
  if ($new_local_purchase_order_amount == null) {
	$new_local_purchase_order_amount = 0;
}


$receive_order=find_a_field('purchase_receive pr, purchase_master pm','count(DISTINCT pr.pr_no)','1 and pr.status="Received" and pm.po_no=pr.po_no and YEAR(rec_date) ="'.$current_year.'"');
$receive_order_amount=find_a_field('purchase_receive pr, purchase_master pm','sum(pr.with_vat_amt)','1 and pr.status="Received" and pm.po_no=pr.po_no and YEAR(rec_date) ="'.$current_year.'"');
	
$receive_order_yesterday=find_a_field('purchase_receive pr, purchase_master pm','count(DISTINCT pr.pr_no)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date ="'.$yesterday.'"');
$receive_order_yesterday_amount=find_a_field('purchase_receive pr, purchase_master pm','sum(pr.with_vat_amt)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date ="'.$yesterday.'"');

$receive_order_last_week=find_a_field('purchase_receive pr, purchase_master pm','count(DISTINCT pr.pr_no)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date  BETWEEN "'.$lastdays.'" and "'.$yesterday.'" ');
$receive_order_last_week_amount=find_a_field('purchase_receive pr, purchase_master pm','sum(pr.with_vat_amt)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date  BETWEEN "'.$lastdays.'" and "'.$yesterday.'" ');

$receive_order_last_month=find_a_field('purchase_receive pr, purchase_master pm','count(DISTINCT pr.pr_no)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date  BETWEEN "'.$firstDayLastMonth.'" and "'.$lastDayLastMonth.'" ');
$receive_order_last_month_amount=find_a_field('purchase_receive pr, purchase_master pm','sum(pr.with_vat_amt)','1 and pr.status="Received" and pm.po_no=pr.po_no and rec_date  BETWEEN "'.$firstDayLastMonth.'" and "'.$lastDayLastMonth.'" ');
  ...
  // Check if $purchase_return_amount is null, and if so, set it to 0
  if ($purchase_return_amount == null) {
...
$approved_po_amount=find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.amount)','1 and pi.po_no = pm.po_no and YEAR(pm.po_date) ="'.$current_year.'" and pm.status="CHECKED"');
  ...
  // Check if $approved_po_amount is null, and if so, set it to 0
  if ($approved_po_amount == null) {
	$approved_po_amount = 0;
}
...
LEFT JOIN purchase_master pm ON dates.ji_date = DATE(pm.po_date)
    AND pm.status IN ("CHECKED","PROCESSING","COMPLETED")
...
$thisYearSales = find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.with_vat_amt)','1 and pi.po_no = pm.po_no and pm.po_date BETWEEN  "'.$thisYearSdate.'" AND "'.$thisYearEdate.'" and pm.status IN ("CHECKED","PROCESSING","COMPLETED")');
...
<div class="container-fluid">
			<div class="row m-0 p-0">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase <span> || <?=$yesterday; ?></span></h5>
						
						<div class="d-flex ustify-content-between p-3">
						<div class="new-icon primary">
						    <form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								name="submit" type="submit" value="<?=$new_purchase_order_yesterday?>" tabindex="6" />
							</form>
						...
						<div class="new-icon-text">
							...
							<p class="p-sub1">  <span><i class="fa-solid fa-bangladeshi-taka-sign"></i>: <?=number_format($new_purchase_order_yesterday_amount,2);?></span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Direct Purchase<span> || <?=$yesterday; ?></span></h5>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Receive <span> || <?=$yesterday; ?></span></h5>
						
						<div class="d-flex ustify-content-between p-3">
						<div class="new-icon danger">
						
						<form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								<input name="report" type="hidden" class="radio1" id="report1-btn" value="39" tabindex="1"/>
								<input name="f_date" type="hidden" id="f_date" value="<?=$firstDayOfYear = $yesterday;?>" />
								<input name="t_date" type="hidden" id="t_date" value="<?=$lastDayOfYear = $yesterday;?>" />
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$receive_order_yesterday?>" tabindex="6" />
							</form>
						
						</div>
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1"><span><i class="fa-solid fa-bangladeshi-taka-sign"></i>:<?=number_format($receive_order_yesterday_amount,2);?> </span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Return<span> || <?=$yesterday; ?></span></h5>
			...
			<div class="row m-0 p-0">
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase <span> || Last Week</span></h5>
						...
						<div class="new-icon primary">
						    <form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$new_purchase_order_last_week?>" tabindex="6" />
							</form>
						...
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1">  <span><i class="fa-solid fa-bangladeshi-taka-sign"></i>: <?=number_format($new_purchase_order_last_week_amount,2);?></span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Direct Purchase<span> || Last Week</span></h5>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Receive <span> || Last week</span></h5>
						...
						<form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input name="t_date" type="hidden" id="t_date" value="<?=$yesterday;?>" />
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$receive_order_last_week?>" tabindex="6" />
							</form>
						
						</div>
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1"><span><i class="fa-solid fa-bangladeshi-taka-sign"></i>:<?=number_format($receive_order_last_week_amount,2);?> </span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Return<span> || Last Week</span></h5>
			...
			<div class="row m-0 p-0">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase <span> || Last Month</span></h5>
						...
						<div class="new-icon primary">
						    <form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$new_purchase_order_last_month?>" tabindex="6" />
							</form>
						...
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1">  <span><i class="fa-solid fa-bangladeshi-taka-sign"></i>: <?=number_format($new_purchase_order_last_month_amount,2);?></span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Direct Purchase<span> || Last Month</span></h5>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Receive <span> || Last Month</span></h5>
						...
						<form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input name="t_date" type="hidden" id="t_date" value="<?=$lastDayLastMonth;?>" />
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$receive_order_last_month?>" tabindex="6" />
							</form>
						
						</div>
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1"><span><i class="fa-solid fa-bangladeshi-taka-sign"></i>:<?=number_format($receive_order_last_month_amount,2);?> </span></p>
						 </div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Purchase Return<span> || Last Month</span></h5>
					  ...
					  <div class="card-body">
						...
						<div class="new-icon primary">
						    <form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$new_purchase_order?>" tabindex="6" />
							</form>
						...
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1">  <span><i class="fa-solid fa-bangladeshi-taka-sign"></i>: <?=number_format($new_purchase_order_amount,2);?></span></p>
						 </div>
    ...
    <i class="fas fa-check-circle"></i> New Order 
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Direct Purchase<span> || Year <?=date('Y'); ?></span></h5>
					...
					<div class="card">
					  <div class="card-body">
						...
						<form action="../../purchase_mod/report/master_report.php" method="post" name="form1" target="_blank" id="form1">
								...
								<input name="t_date" type="hidden" id="t_date" value="<?=$lastDayOfYear = date('Y') .'-12-31';?>" />
								<input style="background: none; border: none; text-align: left; font-size: 18px !important; color:blue; white-space: nowrap; overflow: hidden;" 
								name="submit" type="submit" value="<?=$receive_order?>" tabindex="6" />
							</form>
						
						</div>
						<div class="new-icon-text">
						 	<p class="p-sub bold">&nbsp;</p>
							<p class="p-sub1"><span><i class="fa-solid fa-bangladeshi-taka-sign"></i>:<?=number_format($receive_order_amount,2);?> </span></p>
						 </div>
						...
						<a href="#" class="d-flex justify-content-center a">
                            ...
                            onclick="window.open('../mr/mr_pending.php', '_blank');">
                            <i class="fas fa-check-circle"></i> New Order 
                        </button>-->
						</a>
					  </div>
				  ...
				  <!--1st chart-->
						<div class="col-lg-6 col-md-12 p-2 mt-2">
							<div class="card card-chart">
								<div class="card-body">
									<h5 class="card-title bold">MONTHLY PURCHASE CHART<span> || Year <?=date('Y'); ?></span></h5>
								</div>
					  ...
					  <div class="col-lg-6 col-md-12 p-2 mt-2">
						<div class="card card-chart">
							<div class="card-body">
								<h4 class="card-title bold">ONE WEEK PURCHASE CHART<span> || Year <?=date('Y'); ?></span></h4>
							</div>
						...
						<div class="col-lg-6 col-md-12 p-2">
							<div class="card card-chart">
								<div class="card-body">
									<h5 class="card-title bold">ONE YEAR PURCHASE REPORTS<span> || Year <?=date('Y'); ?></span></h5>
								</div>
								<div class="card-header">
						...
						<div class="col-lg-6 col-md-12 p-2">
							<div class="card card-chart">
								<div class="card-body">
								<h5 class="card-title bold">LAST 4 YEAR PURCHASE REPORTS<span> || Year <?=date('Y'); ?></span></h5>
								</div>
								<div class="card-header">
...
///////////// 2nd chart//////////////////
	...
	var localPurchaseData = [
        <?php foreach ($local_purchase_data as $data) { echo $data->daily_total_amount . ', '; } ?>
    ];
    ...
    var data = {
        ...
        datasets: [
            ...
            },
            {
                ...
                data: localPurchaseData // Example data
            }
        ]
    };
