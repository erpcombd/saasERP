...
$total_voucherP = find_all_field_sql("SELECT COUNT(DISTINCT jv_no) AS n, SUM(dr_amt) AS m FROM journal WHERE jv_date >= '".$current_year."-01-01' AND tr_from IN ('Payment', 'Vendor_payment','Vendor_advance_payment','vendor_tds_payment','vendor_vds_payment')");
...
$total_voucherC = find_all_field_sql("select COUNT(DISTINCT jv_no)as n,SUM(dr_amt)as m from journal where 1 and jv_date>='".$current_year.'-01-01'."' and tr_from='Contra'  ");
 ...
 $MRR_Approve = find_all_field_sql("select COUNT(DISTINCT jv_no)as n,SUM(dr_amt)as m from journal where 1 and jv_date>='".$current_year.'-01-01'."' and tr_from in 
 ('Purchase')");
 
  $Chalan_Approve = find_all_field_sql("select COUNT(DISTINCT jv_no)as n,SUM(dr_amt)as m from journal where 1 and jv_date>='".$current_year.'-01-01'."' and tr_from in ('Sales') ");
 
   $GR_Approve = find_all_field_sql("select COUNT(DISTINCT jv_no)as n,SUM(dr_amt)as m from journal where 1 and jv_date>='".$current_year.'-01-01'."' and tr_from in 
 ('Goods Return') ");
 
 $PR_Approve = find_all_field_sql("select COUNT(DISTINCT jv_no)as n,SUM(dr_amt)as m from journal where 1 and jv_date>='".$current_year.'-01-01'."' and tr_from in 
 ('Purchase Return') ");
...
$asset_value = find_a_field('journal j, accounts_ledger a','sum(j.dr_amt-j.cr_amt)','j.jv_date between "'.$current_year.'-01-01'.'" and "'.$today.'" and j.ledger_id=a.ledger_id and a.acc_class=1');


$revenue_value = find_a_field('journal j, accounts_ledger a','sum(j.cr_amt-j.dr_amt)','j.jv_date between "'.$current_year.'-01-01'.'" and "'.$today.'" and j.ledger_id=a.ledger_id and a.acc_class=3');

$liability_value = find_a_field('journal j, accounts_ledger a','sum(j.dr_amt-j.cr_amt)','j.jv_date between "'.$current_year.'-01-01'.'" and "'.$today.'" and j.ledger_id=a.ledger_id and a.acc_class=2');

$expense_value = find_a_field('journal j, accounts_ledger a','sum(j.dr_amt-j.cr_amt)','j.jv_date between "'.$current_year.'-01-01'.'" and "'.$today.'" and 
j.ledger_id=a.ledger_id and a.acc_class=4');
...
$pSa=find_a_field('journal','sum(cr_amt)','jv_date = "'.$saturday.'" and 
tr_from IN ("Payment", "Vendor_payment","Vendor_advance_payment","vendor_tds_payment","vendor_vds_payment")');

$pSu=find_a_field('journal','sum(cr_amt)','jv_date = "'.$sunday.'" and tr_from IN ("Payment", "Vendor_payment","Vendor_advance_payment","vendor_tds_payment","vendor_vds_payment")');

$pMo=find_a_field('journal','sum(cr_amt)','jv_date = "'.$monday.'" and tr_from IN ("Payment", "Vendor_payment","Vendor_advance_payment","vendor_tds_payment","vendor_vds_payment")');

$pTu=find_a_field('journal','sum(cr_amt)','jv_date = "'.$tuesday.'" and tr_from IN ("Payment", "Vendor_payment","Vendor_advance_payment","vendor_tds_payment","vendor_vds_payment")');

$pWe = find_a_field(
    'journal',
    'SUM(cr_amt)',
    'jv_date = "'.$wednesday.'" AND tr_from IN ("Payment", "Vendor_payment", "Vendor_advance_payment", "vendor_tds_payment", "vendor_vds_payment")'
);

$pTh=find_a_field('journal','sum(cr_amt)','jv_date = "'.$thursday.'" and tr_from IN ("Payment", "Vendor_payment","Vendor_advance_payment","vendor_tds_payment","vendor_vds_payment")');

$pFr = find_a_field(
    'journal',
    'SUM(cr_amt)',
    'jv_date = "'.$friday.'" AND tr_from IN ("Payment", "Vendor_payment", "Vendor_advance_payment", "vendor_tds_payment", "vendor_vds_payment")'
);
...
<div class="container-fluid">
			<div class="row m-0 p-0">
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					...
					<!--	<a href="debit_note.php?new=2" class="d-flex justify-content-center a">
							<button type="button" class="btn bg-primary button-cs"> <i class="fas fa-check-circle"></i> New Voucher</button>
						</a>-->
					  </div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
					<div class="card">
					  <div class="card-body">
						<h5 class="card-title bold">Receipt  <span> || Year-<?php echo date("Y"); ?></span></h5>
					...
					<!--	<a href="credit_note.php?new=2" class="d-flex justify-content-center a">
							<button type="button" class="btn bg-success button-cs"> <i class="fas fa-check-circle"></i> New Voucher</button>
						</a>-->
					  </div>
					</div>
				</div>
				...
				<div class="col-lg-3 col-md-3 col-sm-12 new">
				  ...
				  <!--1st chart-->
						<div class="col-lg-3 col-md-3 col-sm-12 p-2 mt-2">
							<div class="card card-chart">
								<div class="card-body">
									<h5 class="card-title bold"> FINANCIAL OVERVIEW CHART <span> OF <?php echo date("Y"); ?></span></h5>
								</div>
					  ...
					  <div class="col-lg-3 col-md-3 col-sm-12 p-2 mt-2">
						<div class="card card-chart">
							<div class="card-body">
								<h4 class="card-title bold"> WEEKLY CASH FLOW CHART<span> OF <?php echo date("Y"); ?></span></h4>
							</div>
