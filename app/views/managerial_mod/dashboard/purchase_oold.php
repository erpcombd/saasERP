...
$thisYearSales = find_a_field('purchase_invoice pi, purchase_master pm','SUM(pi.amount)','1 and pi.po_no = pm.po_no and pm.po_date BETWEEN  "'.$thisYearSdate.'" AND "'.$thisYearEdate.'" and pm.status IN ("CHECKED","COMPLETED")');
