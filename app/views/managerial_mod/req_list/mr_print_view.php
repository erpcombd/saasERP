 ...
 <td align="right"> <strong><?=number_format($total_qty,2)?></strong></td>
  ...
  <tr>
	...
	<form method="post" action="">
	  ...
	  <input name="create_po" type="submit" class="btn btn-info" value="Create Requisition Order" style="width:200px; font-weight:bold; font-size:12px; height:30px; color:white; background:cornflowerblue; border:0px;" />
