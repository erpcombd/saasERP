...
$con .= ' and a.req_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
 ...
 $res='select  	a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by,a.vendor_status, c.fname as entry_by, a.entry_at,a.status from requisition_master a,warehouse b,user_activity_management c where  a.warehouse_id=b.warehouse_id and a.status="CHECKED" and a.entry_by=c.user_id and a.vendor_status="Yes" '.$con.' order by a.req_no desc';
                        ...
                        <tr>
                            ...
                            <td><button type="button" onclick="custom(<?=$row->req_no?>)" class="btn2 btn1-bg-submit"><i class="fa-solid fa-eye"></i></button></td>
