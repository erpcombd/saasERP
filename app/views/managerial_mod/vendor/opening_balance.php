				...
				<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 pt-1 pb-1">
					<div class="form-group row m-0 pb-1 pt-1">
						...
						<div class="col-sm-7 col-md-7 col-lg-7 col-xl-7 p-0">
							<input name="op_date" type="text" class="required " id="op_date" value="<?=$_POST['op_date']?>" size="30" maxlength="100" required />
						</div>
					</div>
...
value="<?=$_POST['op_date']?>" size="30" maxlength="100" required />
				  </td>
				  </tr>
