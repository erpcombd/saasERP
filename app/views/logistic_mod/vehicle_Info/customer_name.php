...
$title='Customer Name';			// Page Name and Page Title

do_datatable('table_head');

$page="customer_name.php";		// PHP File Name



$table='customer_list';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='customer_name';				// For a New or Edit Data a must have data field
...
$con .= 'and a.group_for="'.$_POST['group_for'].'"';
   ...
   $td='select a.'.$unique.',  a.'.$shown.',a.type, a.status from '.$table.' a	where 1  order by a.id ';
...
<tr<?=$cls?> onclick="DoNav('<?php echo $rp[0];?>');">
    <td><?=$rp[0];?></td>
    <td><?=$rp[1];?></td>
    <td><?php if($rp[2] == 1){echo 'Sister Concern';}else if($rp[2] == 2){echo '3rd Party';} ;?></td>
    <td><?=find_a_field('activation','activation','id = "'.$rp[3].'" ') ?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>customer Name</td>
                        				...
                        				<input name="customer_name" required type="text" id="customer_name" tabindex="1" value="<?=$customer_name?>"  style="width:220px;" >	
                                      ...
                                      <tr>
                                          ...
                                          <select name="type" required id="type"  tabindex="7" style="width:220px;">
                                              <option value="1">Sister Concern</option>
