...
$title='Vehicle Type';			// Page Name and Page Title

do_datatable('table_head');

$page="vehicle_type.php";		// PHP File Name



$table='vehicle_type_list';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='type_name';				// For a New or Edit Data a must have data field
...
$_POST['terms_condition']=mysqli_real_escape_string($conn,$_POST['terms_condition']);
...
<th bgcolor="#45777B"><span class="style3">Vehicle Type </span></th>

<th bgcolor="#45777B"><span class="style3">Category</span></th>
...
$con .= 'and a.group_for="'.$_POST['group_for'].'"';
  ...
  $td='select a.'.$unique.',  a.'.$shown.',  a.category , a.status from '.$table.' a	where 1  order by a.id ';
...
<td><?=find_a_field('vehicle_category','category_name','id = "'.$rp[2].'" ') ?></td>
<td><?=($rp[3] == 1) ? 'Active' : 'InActive';?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Vehicle type</td>
                        				...
                        				<input name="type_name" required type="text" id="type_name" tabindex="1" value="<?=$type_name?>"  style="width:220px;" >	
                                     ...
                                     <td>Category :</td>
                                        ...
                                        <td>
                        					...
                        					<select name="category" required id="category"  tabindex="7" style="width:220px;">


                     					<option>Select</option>
                     					
                     					 <? foreign_relation(' vehicle_category ','id','category_name',$category,'1');?>
                    					</select>
