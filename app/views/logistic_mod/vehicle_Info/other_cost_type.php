...
$title='Other Cost Type';			// Page Name and Page Title

do_datatable('table_head');

$page="other_cost_type.php";		// PHP File Name



$table='other_cost_type';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='ot_cost_name';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Other Cost Name </span></th>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Other Cost Type Entry</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                       					
                        				<input name="ot_cost_name" required type="text" id="ot_cost_name" tabindex="1" value="<?=$ot_cost_name?>"  style="width:220px;" >	
