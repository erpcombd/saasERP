...
$title='Vehicle Category Type';			// Page Name and Page Title

do_datatable('table_head');

$page="vehicle_category.php";		// PHP File Name



$table='vehicle_category';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Vehicle Category </span></th>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Vehicle Category</td>
                        				...
                        				<input name="category_name" required type="text" id="category_name" tabindex="1" value="<?=$category_name?>"  style="width:220px;" >	
