...
<table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody><tr class="oe_form_group_row">
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	   ...
	   <? 	 $res = 'select k.id, (select PBI_NAME from personnel_basic_info where PBI_ID=k.PBI_ID) as KPI_FOR,(select PBI_NAME from personnel_basic_info where PBI_ID=k.LINE_MANAGER) as KPI_AUTHORITY,(select PBI_NAME from personnel_basic_info where PBI_ID=k.DEPT_HEAD) as Department_head,k.status from  hrm_kpi_set k where 1 and status="Active"';
