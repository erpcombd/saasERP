...
//$crud->insert();
$ins_query='INSERT INTO salary_holy_day( holy_day, reason) VALUES ( "'.$_POST['holy_day'].'", "'.$_POST['reason'].'")';
db_query($ins_query);
}
            ...
            <td class="oe_form_group_cell"><table width="350" height="132" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              ...
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="holy_day2" type="text" id="holy_day2" value="<?=$holy_day2?>" /></td>
                </tr>
				<? }?>
