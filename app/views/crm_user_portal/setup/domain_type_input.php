...
$page="domain_type.php";		// PHP File Name
$input_page="domain_type_input.php";
$root='setup';

$table='domai';		// Database Table Name Mainly related to this page
$unique='DOMAIN_CODE';			// Primary Key of this Database table
$shown='DOMAIN_DESC';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Company Name:</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="DOMAIN_DESC" type="text" id="DOMAIN_DESC" value="<?=$DOMAIN_DESC?>" /></td>
