...
$title='IOM Application Form';			// Page Name and Page Title
...
$table='hrm_iom_info';		// Database Table Name Mainly related to this page
...
$leave_data = find_all_field('hrm_iom_info','','id='.$_REQUEST['id']);

$user = find_all_field('personnel_basic_info','','PBI_ID="'.$leave_data->PBI_ID.'"');
		...
		<div class="col-md-12">
			<div class="panel panel-primary" align="center">
				<div class="panel-heading">
					<h3 class="panel-title">Application For OD</h3>
				</div>
                                ...
                                <tr class="oe_form_group_row">
								  ...
								  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                                    ...
                                    <input name="PBI_ID" id="PBI_ID" value="<?=$_SESSION['employee_selected']?>" type="hidden" />
									 <input name="incharge_id" id="incharge_id" value="<?=$PBI->incharge_id?>" type="hidden" />
    ...
    var days   = ((to_leave - from_leave)/1000/60/60/24)+1;
           ...
           $( "#leave_join_date" ).datepicker({
            ...
            error: function () {}
                                    ...
                                    <input  name="iom_date" type="date" id="iom_date" value="<?=$iom_date; ?>" required/></td>
                        ...
                        <tr>
                          ...
                          <td><div align="center">
							  ...
							  <? if(isset($_GET[$unique]) && $_SESSION['employee_selected']==$user->incharge_id ){?>
