...
$title='Out Side Duty(OD';			// Page Name and Page Title
		...
		<div class="col-md-12">
			...
			<div class="panel panel-primary" align="center">
				...
				<div class="panel-heading">
					...
					<?php /*?><h3 class="panel-title">Out Side Duty(OD)</h3><?php */?>
...
<div class="oe_view_manager oe_view_manager_current">
  ...
  $res = "select o.id,a.PBI_NAME as name,t.type_name,DATE_FORMAT(o.od_date,'%d-%b-%Y') as submission_date,DATE_FORMAT(o.s_date,'%d-%b-%Y') as start_date,DATE_FORMAT(o.e_date,'%d-%b-%Y') as end_date,CONCAT_WS('', o.s_time , o.s_time_format) as start_time, CONCAT_WS('', o.e_time , o.e_time_format) as end_time,o.total_hrs,o.total_days, o.incharge_status as reporting_authority from personnel_basic_info a,designation c, department d,hrm_od_info o,od_type t where a.DESG_ID=c.DESG_ID and a.DEPT_ID=d.DEPT_ID  and o.type=t.id and a.PBI_ID=o.PBI_ID and o.incharge_status='Pending' and o.PBI_IN_CHARGE='".$PBI_ID."' order by o.s_date desc";
