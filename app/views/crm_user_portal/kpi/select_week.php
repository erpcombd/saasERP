...
<br />
	   ...
	   <tr>
	      ...
	      <td colspan="9"><div align="center" style="font-size:16px; font-weight:bold;"><select name="week" id="week" style="width:200px;height: 40px;width: 25%; border-radius: 0px; margin-top: -1px;border-color: #337AB7;" required>
		  <option></option>
		  <?
		    $sql = 'select * from hrm_weeks where 1';
			$query = db_query($sql);
		  ...
		  ?>
	          ...
	          <input type="submit" name="add" value="SELECT WEEK" style="Width: 150px; border-radius: 0px; height: 40px;background:#337AB7; color:#FFFFFF;" />
