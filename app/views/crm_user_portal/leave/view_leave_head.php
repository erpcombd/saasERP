...
var win = window.location.assign('../leave/leave_request_input.php?id='+lk, '');
  win.focus();
}</script>
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
            <!--<table width="80%" border="1" align="center">
              <tr>
                <td height="40" colspan="2" bgcolor="#00FF00"><div align="center" class="style1">Leave Information  Entry </div></td>
                </tr>
              <tr>
              ...
              <tr>
                ...
                <td><input type="text" name="s_date" id="s_date" style="width:100px;" /></td>
              </tr>
              <tr>
                <td align="right" bgcolor="#EBEBEB"><div align="right"> End Date :</div></td>
                <td bgcolor="#EBEBEB"><input type="text" name="e_date" id="e_date" style="width:100px;" /></td>
              </tr>
              <tr>
                <td><div align="right">Total  Days : </div></td>
                <td><input type="text" name="total_days" id="total_days" style="width:100px;" readonly="" required="required" /></td>
              </tr>
              <tr>
...
$res = "select o.id,a.PBI_NAME,(select PBI_NAME from personnel_basic_info where PBI_ID=o.leave_responsibility_name) as duties_carried_by,o.s_date as start_date, o.e_date as end_date,o.total_days, o.leave_status from personnel_basic_info a,designation c, department d,hrm_leave_info o where a.PBI_DESIGNATION=c.DESG_ID and a.PBI_DEPARTMENT=d.DEPT_ID  and a.PBI_ID=o.PBI_ID  and  o.PBI_DEPT_HEAD='".$_SESSION['employee_selected']."' and  o.leave_status='Reporting Authority Approved' order by o.id desc";
else
