...
$att_sql = "INSERT INTO hrm_attdump ( ztime, bizid, xenrollid, xdate, xtime) VALUES ('$access_time', '$emp_id', '$emp_id', '$access_date', '$access_time')"	;
...
<div class="oe_form_sheetbg">
          ...
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
            ...
            <table width="80%" border="1" align="center">
              ...
              <tr>
                ...
                <td><input type="text" name="m_date" autocomplete="off" id="m_date" style="width:50%;" /></td>
	  ...
	  ?>
              ...
              <tr>
                ...
                <td colspan="4" align="center"><input name="search" type="submit" class="btn btn-success" id="search" value="Manual Attendence" /></td>
