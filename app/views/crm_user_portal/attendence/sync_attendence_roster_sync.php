...
for($x=1;$x<=$sl;$x++)
{
	...
	VALUES 
('".$emp_ids[$x]."','".$att_date[$x]."', '".$in_time[$x]."','".$out_time[$emp_ids[$x]][$att_date[$x]]."','".$office_start_time[$x]."','".$office_end_time[$x]."', dayname('".$att_date[$x]."'))
ON DUPLICATE KEY UPDATE in_time = '".$in_time[$x]."',out_time = '".$out_time[$x]."',sch_in_time = '".$office_start_time[$x]."',sch_out_time = '".$office_end_time[$x]."'";
	$query=db_query($sql);
