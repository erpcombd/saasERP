...
tr:nth-child(Even){
                    ...
                    <tr>
						...
						<!--<tr>
                              ...
                              <td align="right"></td>
                              <td align="left"><span class="oe_form_group_cell"><input name="show" type="submit" class="btn btn-primary" id="show" value="View Sheet" /></span></td>
                            </tr>
-->
                      </thead>
...
//and a.entry_by='.$_SESSION['employee_selected'].'
  ...
  //and  a.PBI_ID="'.$PBI_ID.'"
	...
	where p.PBI_CODE=a.emp_code and status!="Checked" and p.incharge_id="'.$PBI_ID.'"  and a.conveyance_date between "'.$g_s_date.'" and "'.$g_e_date.'" '.$con.' GROUP by a.conveyance_no';
...
?>
						...
						<td style="width:50px"> 
						  ...
						  <div class="btn-group"><a href="conveyance_view_team_leader.php?con_id=<?=$data->conveyance_no?>" class="buttonn btn btn-primary">Open</a></div>
