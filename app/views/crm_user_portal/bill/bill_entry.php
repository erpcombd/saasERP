...
// ::::: Edit This Section :::::
$title = 'Conveyance Entry';			// Page Name and Page Title
...
<div class="form-container_large">
  ...
  <form id="form1" name="form1" method="post">
      <div class="row m-0">
         <div class="card">
          <h5 class="text-center bg-info bold pt-2 pb-2">Conveyance Entry Process </h5>
          <div class="card-body">
            <div class="row m-0">
       ...
       value="<?=find_a_field('personnel_basic_info','PBI_CODE','PBI_ID='.$PBI_ID);?>" required readonly/>
              ...
              <div class="col-md-2 form-group">
                <label class="label success" for="car_req4">Conveyance No : </label>
              <input name="conv_no" type="text" 
			         ...
			         <div class="col-md-2 form-group">
                <label class="label success" for="car_req4">Conveyance Date : </label>
                <input name="conveyance_date" type="date" id="conveyance_date" value="<?=$conveyance_date?>" class="form-control"  required="required">
              </div>

               <div class="col-md-2 form-group">
                <label class="label success" for="car_req4">Means of conveyance:</label>
              ...
              <!--<option value="Overtime">Overtime</option>-->
                ...
                <div class="col-md-2 form-group">
             <label for="success" class="">From Address</label>
<input type="text" name="from_address" class="form-control" id="from_address">
              </div>
...
$(document).ready(function() {
    ...
    $("#butsend").click(function() {
        ...
        $("#table1").append('<tr valign="top" id="'+newid+'">\n\
            ...
            <td width="100px" class="t_address'+newid+'">' + $("#to_address").val() + '</td>\n\
   ...
   /* crating new click event for save button*/
    ...
    $("#butsave").click(function() {
        ...
        for ( var i = 1; i <= lastRowId; i++) {
            ...
            t_address.push($("#"+i+" .t_address"+i).html()); 
        ...
        var sendToaddress = JSON.stringify(t_address);  
