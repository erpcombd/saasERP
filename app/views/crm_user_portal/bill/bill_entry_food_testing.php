      ...
      <div class="row m-0">
       ...
       value="<?=find_a_field('personnel_basic_info','PBI_CODE','PBI_ID='.$PBI_ID);?>" required readonly/>
              ...
              <div class="col-md-2 form-group">
			   ...
			   <input name="PBI_PICTURE_ATT_PATH" type="file" id="PBI_PICTURE_ATT_PATH" class="form-control" style="opacity:3!important;position:initial;">
...
$(document).ready(function() {
    ...
    $("#butsend").click(function() {
        ...
        $("#table1").append('<tr valign="top" id="'+newid+'">\n\
			...
			<td width="100px" class="DocImage'+newid+'">' + $("#DocImage").val() + '</td>\n\
   ...
   /* crating new click event for save button*/
    ...
    $("#butsave").click(function() {
        ...
        for ( var i = 1; i <= lastRowId; i++) {
			...
			DocImages.push($("#"+i+" .DocImage"+i).html());    
        }
		...
		var sendDocImages = JSON.stringify(DocImages);
	

	

        $.ajax({
            url: "save_food_testing.php",
            type: "post",
            data: {
              E_code    : sendE_code , 
