...
<div id="suggesstion-box"></div>
							   ...
							   <input type="text" id="PBI_ID" name="PBI_ID" value="<?=$_SESSION['employee_selected']?>" readonly="readonly" />
							  <? } ?>
							  </td>
                            ...
                            <tr >
                             <td align="right" style="background-color:#35b1ea; color:#FFFFFF; font-size:16px"><strong>KPI Weeks  :</strong></td>
