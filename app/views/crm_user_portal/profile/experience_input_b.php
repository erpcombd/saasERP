...
$input_page="experience_input_b.php";
        ...
        <td class="oe_form_group_cell"><table width="282" height="109" border="0" cellpadding="0" cellspacing="0" class="oe_form_group "><tbody>
         ...
         <td bgcolor="#E8E8E8" width="38%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Organization Name :</td>
                  ...
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                    ...
                    <input name="EXPERIENCE_NOO" type="text" id="EXPERIENCE_NOO" value="<?=$EXPERIENCE_NOO?>" style="width:250px; height:30px;" /></td>
                  ...
                  <td bgcolor="#E8E8E8" width="62%" class="oe_form_group_cell"><select name="EXPERIENCE_DOCUMENT" style="width:250px; height:30px;" >
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td class="oe_form_group_cell"><input name="EXPERIENCE_JOB_NATURE" type="text" id="EXPERIENCE_JOB_NATURE" value="<?=$EXPERIENCE_JOB_NATURE?>" style="width:250px; height:30px;"  /></td>
                  ...
                  <td class="oe_form_group_cell"><span class="oe_form_field oe_datepicker_root oe_form_field_date">
                    ...
                    <input name="EXPERIENCE_POST" type="text" id="EXPERIENCE_POST" value="<?=$EXPERIENCE_POST?>" style="width:250px; height:30px;"  />
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="EXPERIENCE_FROM" type="date" id="EXPERIENCE_FROM" value="<?=$EXPERIENCE_FROM?>" style="width:250px; height:30px;"  /></td>

                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;To :</span></td>

                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="EXPERIENCE_TO" type="date" id="EXPERIENCE_TO" value="<?=$EXPERIENCE_TO?>" style="width:250px; height:30px;"  /></td>
				...
				<tr class="oe_form_group_row">
                  ...
                  <td  colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Last Salary :</td>

                  <td  class="oe_form_group_cell"><input name="LAST_SALARY" type="text" required id="LAST_SALARY" value="<?=$LAST_SALARY?>" style="width:250px; height:30px;"  /></td>

                  <td  class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;</span></td>
			     ...
			     <td bgcolor="#E8E8E8">Document Upload</td>

				 <td bgcolor="#E8E8E8"><input type="file" name="att_file" id="att_file" style="width:250px; height:30px;" ></td>
			  ...
			  <? if($EXPERIENCE_NOO!=''){?>
				 ...
				 <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" colspan="4" class="oe_form_group_cell oe_form_group_cell_label"><object width="900" height="400" data="../../pic/experience/<?=$$unique?>.pdf"></object></td>
