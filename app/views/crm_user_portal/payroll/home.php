...
<div class="oe_view_manager oe_view_manager_current">
  ...
  <tr>
    ...
    <td height="30">&nbsp;</td>
		...
		<h1 style="color:green; text-align:center">PAYROLL MANAGEMENT SOLUTION</h1>
...
<a class="oe_app ab_app_descr" title="SALARY & ALLOWANCE" href="salary_information.php" style="width:320px!important; height:106px; text-decoration:none">
<div class="ab_app_descr">
                  <div class="oe_app_icon"><img src="../icon/salary.png"/></div>
                </div>
                <div class="oe_app_name">Salary & Allowance</div>
				<div class="oe_app_descr">
		Detail Salary & Allowance Information 
		</div>
                </a>
			
<a class="oe_app ab_app_descr" title="ADVANCED PAYMENT" href="advance_payment.php" style="width:320px!important; height:106px; text-decoration:none">
<div class="ab_app_descr">
                  <div class="oe_app_icon"><img src="../icon/designation.png"/></div>
                </div>
                <div class="oe_app_name">Advanced Payment</div>
				<div class="oe_app_descr">
		Advanced Payment Salary & Allowance
		</div>
                </a>
				
				<a class="oe_app ab_app_descr" title="MONTHLY ATTENDENCE(DEPT.)" href="monthly_attendence.php" style="width:320px!important; height:106px; text-decoration:none">
                <div class="ab_app_descr">
                    <div class="oe_app_icon"><img src="../icon/payroll.png"/></div>
                </div>
                <div class="oe_app_name">Monthly Attendence(Dept.)</div>
				<div class="oe_app_descr">
		Departmentwise Monthly Attendence view
		</div>
                </a>
				
				<a class="oe_app ab_app_descr" title="MONTHLY ATTENDENCE(DEPT.)" href="../attendence/monthly_attendence.php" style="width:320px!important; height:106px; text-decoration:none">
                <div class="ab_app_descr">
                    <div class="oe_app_icon"><img src="../icon/website_builder.png"/></div>
                </div>
                <div class="oe_app_name">Monthly Final Attendence</div>
				<div class="oe_app_descr">Monthly Final Attendence
		</div>
                </a> 
