...
<?php /*?><strong>TIN No. <!--<?=$vendor->tin_no;?>--> <br /> VAT No. <?=$vendor->vat_no;?> </strong><br /><?php */?>
...
<? // echo$data->payment_details?><br /><br />
        ...
        <tr>
          ...
          <td colspan="3" align="left" style="font-size:14px" >
            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
			  ...
			  <td align="center"> <!--<?=find_a_field('user_activity_management','fname','user_id='.$data->entry_by);?>--></td>
			  <td align="center">&nbsp;</td>
			  <td align="center">&nbsp;</td>
              <td align="center">&nbsp;</td>
			  <td align="center">&nbsp;</td>
