...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
		<div style="width:1000px; margin-left:5%;  margin-top:70px; font-size:18px">
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
	<thead>
       <tr>
		...
		<td width="11%" align="center"><strong>Component</strong></td>
		<td width="8%" align="center"><strong>Target %</strong></td>
		<td width="8%" align="center"><strong>Achieved %</strong></td>
		<td width="20%" align="center"><strong>Problem encountered</strong></td>
		<td width="20%" align="center"><strong>Corrective action</strong></td>
      </tr>
	</thead>
	  <?php
$final_amt=0;
$pi=0;
$total=0;
 $sql2='select a.id, a.day, a.customer_name, a.plan, a.man_power, a.progress,a.requisition , "x" from daily_progress_details a where  a.d_id='.$d_id;
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){ 
$pi++;
$sl=$pi;
...
<td width="33%" align="center" style="border:0px;border-color:#FFF;"><strong><u>Suggestion/Recommendation By</u></strong></td>
</tr>
<tr>
  <td align="center" style="border:0px;border-color:#FFF;"><strong>Manager, Engineering & Construction</strong></td>
  <td align="center" style="border:0px;border-color:#FFF;"><strong>AGM, Engineering & Construction</strong></td>
