...
$title='Unapproved Daily Progress Report';
...
<th class="text-center">Action</th>
 ...
 $con=' and a.progress_date between "'.date('Y-m-o1').'" and "'.date('Y-m-d').'"';
  ...
  from daily_progress_master a,user_activity_management u
  
  where a.entry_by=u.user_id  and a.status="PENDING" '.$con.' order by a.d_id desc';
...
<a href="../po/po_checking.php?d_id=<?=$data->d_id?>"><button class="btn btn-success btn-sm">VIEW DETAIL</button></a></td>
