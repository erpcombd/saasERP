...
$title='Daily Action Plan Report';
...
$cons =" and a.warehouse_id='".$_POST['warehouse_id']."' ";
    ...
    $res='select  a.d_id,a.d_id, DATE_FORMAT(a.progress_date, "%d-%m-%Y") as progress_date, s.type, c.fname as entry_by, a.entry_at
	 from daily_plan_master a, daily_progress_setup s,user_activity_management c
	  where  a.progress_for=s.id and a.entry_by=c.user_id  '.$con.$cons.' and a.entry_by='.$_SESSION['user']['id'].' order by a.d_id desc';
