...
<tr>
  ...
  <td width="33%" align="center" style="border:0px;border-color:#FFF;"><strong>Action Plan </strong></td>
...
<div><p style="font-size:18px"> <strong>Factory:<span style="margin-left:415px"><strong>Action Plan of</strong></span></strong></br>103/1, Promixco Industrial Park<span style="margin-left:230px"><strong><?=$dept?></strong></span></br>Mouchak, Kaliakair, Gazipur-1750,<span style="margin-left:260px"><strong><?=date('M-Y');?></strong></span></br>Bangladesh<span style="margin-left:800px"><strong><?=date('d-M-Y')?></strong></span></p></div>-->
		...
		<tr style="width:20%" align="center">
			<td align="center">Daily Action Plan</td>
		</tr>
		<tr style="width:20%" align="center">
...
?>
	<tr>
        ...
        <td width="20%" align="left" valign="top"><pre><?=$info->customer_name?></pre></td>
        <td width="8%" align="center" valign="top"><pre><?=$info->plan?></pre></td>
        <td width="22%" align="left" valign="top"><pre style="width:100%"><?=$info->man_power?></pre></td>
        <td width="22%" align="left" valign="top"><pre><?=$info->progress?></pre></td>
		<td width="22%" align="left" valign="top"><pre><?=$info->requisition?></pre></td>
		<td width="11%" align="left" valign="top"><pre><?=$info->amount?></pre></td>
     </tr>
<? 
