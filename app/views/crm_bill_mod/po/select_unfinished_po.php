...
<th class="text-center">Action</th>
 ...
 $con=' and a.progress_date between "'.date('Y-m-o1').'" and "'.date('Y-m-d').'"';
  ...
  where a.entry_by=u.user_id   and a.status="MANUAL" '.$con.'  order by a.d_id desc';
...
<td class="text-center"><a href="po_create.php?d_id=<?=$data->d_id?>"><button class="btn btn-success btn-sm">Complete</button></a></td>
