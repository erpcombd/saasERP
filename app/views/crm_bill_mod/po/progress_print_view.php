...
<td width="33%" align="center" style="border:0px;border-color:#FFF;"></td>
...
<tr>
  ...
  <td width="33%" align="center" style="border:0px;border-color:#FFF;"><strong>Progress Report </strong></td>
...
<tr>
  ...
  <td width="33%" align="center" style="border:0px;border-color:#FFF;"><?=date('d-M-Y',strtotime($data->progress_date))?></td>
</tr>
...
<!--<div><p style="font-size:18px"><strong>Head Office:</strong> </br>34 Topkhana Road, Dhaka-1000 
<img src="<?=SERVER_ROOT?>public/uploads/logo/demo7.png" style="float:right; margin-right:40px ; width:120px" ></p></div>
<div><p style="font-size:18px"> <strong>Factory:<span style="margin-left:415px"><strong>Progress Report of</strong></span></strong></br>103/1, Promixco Industrial Park<span style="margin-left:230px"><strong><?=$dept?></strong></span></br>Mouchak, Kaliakair, Gazipur-1750,<span style="margin-left:260px"><strong><?=date('M-Y');?></strong></span></br>Bangladesh<span style="margin-left:800px"><strong><?=date('d-M-Y')?></strong></span></p></div>-->
...
$pi=0;
$total=0;
 $sql2='select a.id, a.customer_name as name, a.address as section, a.pet_type as action_plan, a.delivery as target_amount, a.gap_analysis as challenges, a.collection as progress, a.next_visit as follow_up, "x" from daily_progress_details a where  a.d_id='.$d_id;
$data2=db_query($sql2);
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="0">
	<thead>
       <tr>
		...
		<td width="22%" align="center"><strong>Consumption Plan</strong></td>
		<td width="22%" align="center"><strong>Progress</strong></td>
		<td width="22%" align="center"><strong>Actual Consumption</strong></td>
...
$pi=0;
$total=0;
 $sql2='select a.id, a.day, a.customer_name, a.plan, a.man_power, a.progress,a.requisition , a.amount, "x" from daily_progress_details a where  a.d_id='.$d_id;
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){ 
$pi++;
$sl=$pi;
...
?>
	<tr>
        ...
        <td align="left" valign="top"><pre><?=$info->customer_name?></pre></td>
        <td align="center" valign="top"><?=$info->plan?></td>
        <td align="left" valign="top"><pre><?=$info->man_power?></pre></td>
        <td align="left" valign="top"><pre><?=$info->progress?></pre></td>
		<td align="left" valign="top"><pre><?=$info->requisition?></pre></td>
		<td align="center" valign="top"><pre><?=$info->amount?></pre></td>
     </tr>
<? 
...
$pi=0;
$total=0;
 $sql2='select a.id,  a.customer_name, a.man_power, a.plan, a.delivery, a.amount, a.collection, a.outstanding, a.category, a.pet_type, "x" from daily_progress_details a where  a.d_id='.$d_id;
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){ 
$pi++;
$sl=$pi;
...
$pi=0;
$total=0;
 $sql2='select a.id, a.customer_name as section, a.plan as action_plan, a.man_power as challenges,a.collection as qty, a.progress, a.gap_analysis as follow_up,  "x" from daily_progress_details a where  a.d_id='.$d_id;
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){ 
$pi++;
$sl=$pi;
