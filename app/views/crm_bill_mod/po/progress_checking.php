...
//db_query($update);
 ...
 db_query($insert);
		...
		//header('Location:progress_checking.php');
...
<input name="day<?=$data->id?>" type="day" class="input3" id="day<?=$data->id?>" style="width:98%;" value="<?=$data->day?>" /></td>
    ...
    <!--<td width="11%"><input name="customer_name<?=$data->id?>" type="text" class="input3" id="customer_name<?=$data->id?>" style="width:98%;" value="<?=$data->customer_name?>" /></td>-->
   ...
   <td><input name="plan<?=$data->id?>" type="text" class="input3" id="plan<?=$data->id?>" style="width:98%;" value="<?=$data->plan?>" /></td>
	...
	<!--<td align="center" bgcolor="#CCCCCC" width="25%"><input name="man_power<?=$data->id?>" type="text" class="input3" id="man_power<?=$data->id?>"  maxlength="100" style="width:98%;" value="<?=$data->man_power?>" /></td>-->
	...
	<!--<td align="center" bgcolor="#CCCCCC" width="25%"><input name="requisition<?=$data->id?>" type="text" class="input3" id="requisition<?=$data->id?>" style="width:98%;" value="<?=$data->requisition?>" /></td>-->
