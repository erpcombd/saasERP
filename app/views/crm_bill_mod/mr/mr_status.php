...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="1" bgcolor="#FF9966"><strong>
      <input type="text" name="fdate" id="fdate" style="width:107px;" value="<? if($_POST['fdate']=='') echo date('Y-m-d'); else echo $_POST['fdate'];?>" />
    </strong></td>
...
$con .= 'and a.req_date >="'.$_POST['fdate'].'" and a.req_date <="'.$_POST['tdate'].'"';
if(isset($_POST['submitit'])){
$res='select  	a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by, c.fname as entry_by, a.entry_at,a.status from requisition_master a,warehouse b,user_activity_management c where  a.warehouse_id=b.warehouse_id and a.entry_by=c.user_id '.$con.' and a.status in ("CHECKED","PENDING","STOPPED","CANCELED","COMPLETE") order by a.req_no';
