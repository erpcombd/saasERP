...
echo $_SESSION['proj_name'];
  ...
  <?= find_a_field('user_group','address',"id=".$_SESSION['user']['group']);?><br />
...
<tr>
	...
	<td>	<div align="center"><span class="style4">VAT NO: 001814707 </span><br />
  ...
  <tr>
	...
	<td>	<div align="center"><span class="style4">TIN NO: 359340366636  </span><br />
...
<strong>TIN No. <?=$vendor->tin_no;?> <br /> VAT No. <?=$vendor->vat_no;?></strong><br />
          ...
          <td width="26%" valign="top"><span style="font-size:10px">&nbsp;&nbsp;&nbsp;PO No.#
...
<? }?>
      ...
      <table width="100%" border="0" bordercolor="#000000" cellspacing="3" cellpadding="3" class="tabledesign1" style="width:700px">
		...
		<td colspan="2"><? //echo convertNumberMhafuz($payable_amount)?> <strong>Terms and Conditions: </strong></td>
