		...
		<div class="col-sm-7">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select * from crm_acc_bill_type where 1";
		...
		<div class="col-sm-5">
			<form id="form1" class="n-form" name="form1" method="post" action="" onsubmit="return check()">
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Billing Type </label>
					<div class="col-sm-9 p-0">
						<input name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"  />
						<input name="type" type="text" id="type" value="<?php echo $type;?>" class="required" />
					</div>
				</div>
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					...
					<div class="col-sm-9  p-0">
						<input name="note" type="text" id="note" value="<?php echo $note;?>" class="required" />
					</div>
				</div>
				
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					<label for="description" class="col-sm-3 pl-0 pr-0 col-form-label">Accounts Ledger</label>
					<div class="col-sm-9  p-0">
...
$con .= 'and b.group_for="'.$_POST['group_for'].'"';
	...
	$rrr = "select b.id,  b.group_name, b.description from crm_acc_bill_type b, user_group a where a.id=b.group_for  ".$con." ";
