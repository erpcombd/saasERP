		...
		<div class="col-sm-7">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select * from crm_service_customer where 1";
			...
			<form id="form1" class="n-form" name="form1" method="post" action="" onsubmit="return check()">
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1 ">
					...
					<div class="col-sm-9 p-0">
						...
						<input name="customer_name" type="text" id="customer_name" value="<?php echo $customer_name;?>" class="required" />
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					...
					<div class="col-sm-9  p-0">
						...
						<input name="short_name" type="text" id="short_name" value="<?php echo $short_name;?>" class="required" />
						...
						<?
						 ...
						 if ($ledger_name=='') {?>
									...
									<select name="ledger_group" required id="ledger_group" tabindex="9">
										<? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'group_id=122001');?>
										</select>
...
$con .= 'and b.group_for="'.$_POST['group_for'].'"';
	...
	$rrr = "select b.customer_id,  b.group_name, b.description from crm_service_customer b, user_group a where a.id=b.group_for  ".$con." ";
