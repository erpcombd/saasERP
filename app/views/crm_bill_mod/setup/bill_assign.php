		...
		<div class="col-sm-7">
			...
			<div class="container n-form1">
				...
				<table id="table_head" class="table table-bordered table-bordered table-striped table-hover table-sm" cellspacing="0">
					...
					$rrr = "select b.id,c.customer_name,a.type,b.service_charge,b.billing_cycle from crm_bill_assign b left join crm_service_customer c on c.customer_id=b.customer left join crm_acc_bill_type a on a.id=b.service_id where 1";
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					...
					<div class="col-sm-9 p-0">
						...
						<select name="customer" id="customer" class="required" required>
                          <option></option>
                          <? foreign_relation('crm_service_customer','customer_id','customer_name',$customer,'1')?>
                        </select>
					</div>
				</div>
				...
				<div class="form-group row m-0 pl-3 pr-3 p-1">
					...
					<div class="col-sm-9  p-0">
						<select name="service_id" id="service_id" class="required" required>
                          <option></option>
                          <? foreign_relation('crm_acc_bill_type','id','type',$service_id,'1')?>
                        </select>
					</div>
				</div>
