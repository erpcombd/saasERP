...
$con.=' and a.mobile_no = "'.$_POST['mobile_no'].'"';
        ...
        $sql="select a.dealer_code as customer_code,a.account_code as ledger_code,a.dealer_name_e as customer_name , a.mobile_no,a.address_e as customer_address ,  b.BRANCH_NAME as Division_Name, z.ZONE_NAME as Zone_Name, ar.AREA_NAME as Territory, a.credit_limit from dealer_info a, zon z, branch b, area ar  
