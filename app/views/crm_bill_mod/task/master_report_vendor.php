...
//$report="Vendor Information";
        ...
        $sql="select a.vendor_id as vendor_code,a.ledger_id as ledger_code,a.vendor_name as vendor_name , a.contact_no,a.vendor_company,a.address as vendor_address,a.contact_person_name,a.contact_person_mobile,a.email from vendor a  
		 where 1 order by vendor_name asc";
		break;
