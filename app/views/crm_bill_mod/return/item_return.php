...
if($_POST['vendor_id']>0) $dealer = $_POST['vendor_id'];
...

{
		...
		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['oi_date'],0,$_POST['qty'],'Purchase_return',$xid,$_POST['rate'],'',$_POST[$unique]);
...
<? $field='po_date'; if($receive_date=='') $receive_date =date(''); ?>
    ...
    <? $field='oi_subject';?>
      ...
      <div>
        ...
        <select name="vendor_id" id="vendor_id">
		 <option></option>
		 <? foreign_relation('vendor','vendor_id','vendor_name',$$field);?>
		</select>
...
<div>
          ...
          <label for="<?=$field?>">Issued By :</label>
...
<div>
          ...
          <label for="<?=$field?>">Issue To :</label>
...
<input  name="or_details" type="hidden" id="or_details" value="<?=$oi_details?>"/>
