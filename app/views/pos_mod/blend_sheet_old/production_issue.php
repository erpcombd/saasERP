...
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_description,"#>",item_id)','product_nature="Purchasable"','item_id');
  ...
  <tr>
    ...
    <td>
			...
			<fieldset style="width:220px;">
			  ...
			  <div>
			    ...
			    <label style="width:105px;">Blend Date : </label>
    ...
    <td><fieldset style="width:240px;">
      ...
      <div>
        ...
        <label style="width:75px;">Blend Name: </label>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <input  name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$warehouse_to?>"/>
      ...
      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:250px;" required="required" onblur="getData2('production_issue_ajax.php', 'pi', this.value, document.getElementById('warehouse_to').value);"/>
	...
	<input name="total_unit3" type="text" class="input3" id="total_unit3"  maxlength="100" style="width:50px;" required="required"/>      

	<input name="total_unit4" type="text" class="input3" id="total_unit4"  maxlength="100" style="width:50px;" required="required"/>      

	<input name="total_unit5" type="text" class="input3" id="total_unit5"  maxlength="100" style="width:50px;" required="required"/>
	</span>	</td>

    <td align="center" bgcolor="#CCCCCC"><input pattern="[1-9]" name="total_unit" type="text" class="input3" id="total_unit"  maxlength="100" style="width:67px;" required="required"/></td>
