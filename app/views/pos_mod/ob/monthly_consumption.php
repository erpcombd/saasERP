  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
    ...
    <td><span id="divi_<?=$data->item_id?>">
            ...
            <? 
			  ...
			  <input type="button" name="Button" value="Edit"  onclick="update_value(<?=$data->item_id?>)" style="width:46px; height:30px; background-color:#FF3366"/><?
