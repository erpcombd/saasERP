		...
		<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
			<div class="container-fluid p-0 ">
				...
				<div class="n-form-btn-class">
					   ...
					   <input name="return"  type="submit" class="btn1 btn1-submit-input" value="RETURN TO USER" onclick="return_function()" />
					   ...
					   <input name="cancel"  type="submit" class="btn1 btn1-bg-cancel" value="CANCEL"  />
						<input type="button" class="btn1 btn1-bg-cancel" value="CLOSE"  onclick="window.location.href='select_unapproved_mr.php'" /></td>
