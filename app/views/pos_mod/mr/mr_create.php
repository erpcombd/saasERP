				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6 ">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								<? $field='need_by';?>
								<label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Delivery Deadline(Date)</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
		...
		<form action="?<?=$unique?>=<?=$$unique?>" method="post" name="cloud" id="cloud">
			...
			<div class="container-fluid pt-5 p-0 ">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						<?
						$res='select a.id,b.item_name as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,a.unit_name,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
                        $qry = mysql_query($res);
