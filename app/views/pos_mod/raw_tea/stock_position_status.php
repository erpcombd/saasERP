...
$unique = 'po_no';
$status = 'CHECKED';
$target_url = '../raw_tea/stock_position_report.php';
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td rowspan="2" bgcolor="#FF9966"><div align="center"><strong>
...
$con .= ' and c.master_warehouse_id = "'.$_POST['line_id'].'" ';
 ...
 $res='select a.sale_no, a.sale_date as Date, c.company_name as warehouse_name,  u.fname as entry_by,a.entry_at
