		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
		          ...
		          <td width="40%" align="right" valign="middle">Item Group   : </td>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       ...
       <tr>
        ...
        <td align="center" bgcolor="#CCCCCC"><strong>Opening</strong></td>
        <td align="center" bgcolor="#CCCCCC"><strong>Received</strong></td>
        <td align="center" bgcolor="#CCCCCC"><strong>Issue</strong></td>
        <td align="center" bgcolor="#CCCCCC"><strong>Closing</strong></td>
        </tr>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr>
        ...
        <td align="left" valign="top"><?=number_format($today_open[$i],2);?></td>
        <td align="left" valign="top"><?=number_format($today_receive[$i],2);?></td>
        <td align="left" valign="top"><?=number_format($today_issue[$i],2);?></td>
      ...
      <tr>
        ...
        <td align="right" valign="top"><span class="style1">
          <?=number_format($tot_today_open,2)?>
        </span></td>
        <td align="right" valign="top"><span class="style1">
          <?=number_format($tot_today_receive,2)?>
        </span></td>
        <td align="right" valign="top"><span class="style1">
          <?=number_format($tot_today_issue,2)?>
        </span></td>
        <td align="right" valign="top"><span class="style1">
