              ...
              <tr>
                ...
                <td><? if($_SESSION['user']['depot']!=5){?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:16px; font-weight:bold;"><span class="style4">Cloud ERP Demo Concern
<br />

                          <span class="style6">Head Office: Dargamohalla, Sylhet. P: +880-821-716552, 718815</span></span></td>
