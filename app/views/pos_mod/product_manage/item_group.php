...
<?php
	$rrr = "select a.group_id,a.group_id,a.group_name from item_group a where 1";
                                ...
                                <tr>
                                  <td width="100%" colspan="2"><div class="box">
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        <td>Ledger Group ID: </td>
                                        <td><input name="ledger_group_id" type="text" id="ledger_group_id" value="<?php echo $ledger_group_id;?>" size="30" maxlength="100" class="required" /></td>
                                      </tr>
