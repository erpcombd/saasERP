  ...
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                ...
                <td><? if($_SESSION['user']['depot']!=5){?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:14px; font-weight:bold;"><span class="style4"><?php echo find_a_field('user_group','group_name','1')?><br />

                          <span class="style6"><?php echo find_a_field('project_info','proj_address','1')?></span></span></td>
      ...
      <tr>
        ...
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">Purchased Materials QC Inspection Note</td>
	...
	db_execute('update qc_receive_purchase set duplicate=1 where qc_no='.$qc_no);
		  ...
		  <tr>
		    ...
		    <td valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
		          ...
		          <td width="40%" align="right" valign="middle">Supplier Company Name: </td>
		        ...
		        <tr>
		          ...
		          <td align="right" valign="middle">QC Rec No :</td>
			...
			<td width="30%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
                ...
                <td align="right" valign="middle">QC No:</td>

			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">

                    <tr>

                      <td><strong><?php echo $qc_no;?></strong>&nbsp;</td>
			  ...
			  <tr>
			    ...
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                    ...
                    <tr>
                      ...
                      <td> <?=find_a_field('warehouse','warehouse_name','warehouse_id='.$warehouse_id);?></td>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5">
       ...
       <tr>
        ...
        <td align="center" bgcolor="#CCCCCC"><div align="center"><strong>Item Name</strong></div></td>
        ...
        <td align="center" bgcolor="#CCCCCC"><strong>Fresh Rec Qty</strong></td>
		 <td align="center" bgcolor="#CCCCCC"><strong>Damage Rec Qty</strong></td>
...
<? for($i=0;$i<$pi;$i++){?>
      ...
      <tr>
        ...
        <td align="right" valign="top"><?=round($unit_qty[$i],0)?></td>
		<td align="right" valign="top"><?=round($damage_qty[$i],0)?></td>
