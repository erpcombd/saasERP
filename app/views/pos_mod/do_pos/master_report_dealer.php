...
$con.=' and a.mobile_no = "'.$_POST['mobile_no'].'"';
		...
		if($_POST['contact_no']!='')
$con.=' and a.contact_no = "'.$_POST['contact_no'].'"';
		if($_POST['email']!='')
$con.=' and a.email = "'.$_POST['email'].'"';

        $sql="select dealer_code as customer_id,dealer_name as customer_name, contact_no from dealer_pos where 1";
		break;
