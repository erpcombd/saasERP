...
unset($$unique);
header("Location:dealer_type.php");
...
$unique=$_GET['id'];
$upsql='update dealer_type set dealer_type="'.$_POST['dealer_type'].'" where id='.$unique;
mysql_query($upsql);
header("Location:dealer_type.php");
//
//		$crud->update($unique);
...
eval("page" + id + " = window.open(URL, '" + id + "', 'toolbar=0,scrollbars=1,location=0,statusbar=1,menubar=0,resizable=1,width=800,height=800,left = 383,top = -16');");
    ...
    <div class="col-sm-10">
      <div class="md-form mt-0">
        <input name="dealer_type" class="form-control" style="border:1px solid black;" type="text" id="dealer_type" tabindex="2" value="<?=$dealer_type?>">
      </div>
    </div>
  </div>
