...
//auto_complete_start_from_db('item_info','concat(finish_goods_code,"#>",item_name,"#>",item_id)','finish_goods_code','product_nature="Salable"','item_id');?>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td align="center" bgcolor="#0099FF"><strong>Pkt</strong></td>
  ...
  <tr>
    ...
    <input  name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$warehouse_to?>"/>
      ...
      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:300px;" required="required" onblur="getData2('production_receive_ajax_fg.php', 'pr', this.value, document.getElementById('warehouse_from').value);"/></td>
    ...
    <input name="total_unit5" type="text" class="input3" id="total_unit5"  maxlength="100" style="width:85px;" required="required"/>

    </span></td>

    <td align="center" bgcolor="#CCCCCC">

<input name="total_unit" type="hidden" class="input3" id="total_unit"  maxlength="100" style="width:40px;" required="required"/>

<input name="total_pkt" type="text" class="input3" id="total_pkt" value="0"  maxlength="100" style="width:40px;" required="required"/></td>

    <td align="center" bgcolor="#CCCCCC">

<input name="total_pcs" type="text" class="input3" id="total_pcs"  maxlength="100" style="width:40px;" required="required" value="0"/></td>
...
$res='select a.id,b.item_id as item_code,b.item_name,a.total_unit,CAST((a.total_unit/b.pack_size) as UNSIGNED) as pkt_qty,a.total_unit%b.pack_size as pcs_qty,"X" from production_receive_detail a,item_info b where b.item_id=a.item_id and a.pr_no='.$$unique_master.' order by a.id';
...
<form action="select_prodiction_line_fg.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
...
<table width="100%" border="0">
  ...
  <tr>
	  ...
	  <input name="del" type="submit" class="btn1" value="DELETE PR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090; float:left" />
