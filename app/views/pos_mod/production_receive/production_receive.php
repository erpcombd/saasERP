...
$title='Receive from Blend Sheet';



do_calander('#pr_date','-20','0');
...

{
		...
		//$_POST['blend_id'] = $_POST['blend_id'];

		$xid = $crud->insert();

		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['pr_date'],$_POST['total_unit'],0,'Receive',$xid,'',$_SESSION['line_id'],$_POST['remarks']);

		journal_item_control($_POST['item_id'] ,$_SESSION['line_id'],$_POST['pr_date'],0,$_POST['total_unit'],'Receive',$xid,'',$_SESSION['user']['depot'],$_POST['remarks']);
    ...
    <td>
			...
			<fieldset style="width:220px;">
			  ...
			  <div>
			    ...
			    <label style="width:105px;">Blend No  : </label>

			    <input name="blend_id" type="text" id="blend_id" style="width:105px;" value="<?=$blend_id?>" tabindex="105" />
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="11%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Unit</span></td>

    <td width="11%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Stk</span></td>

    <td width="11%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">LIQ </span></td>

    <td width="11%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">LID</span></td>

    <td width="11%" align="center" bgcolor="#0099FF"><strong> Qty</strong></td>

    <td width="11%"  rowspan="2" align="center" bgcolor="#FF0000"><div class="button">
  ...
  <tr>
    ...
    <input  name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$warehouse_to?>"/>
	  ...
	  <input  name="blend_id" type="hidden" id="blend_id" value="<?=$blend_id?>"/>

      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:98%;" required="required" onblur="getData2('production_receive_ajax.php', 'pr', this.value, document.getElementById('warehouse_from').value);"/><input name="remarks" type="hidden" id="remarks" style="width:105px;" value="<?=$remarks?>" tabindex="105" /></td>

    <td  align="center" colspan="4" bgcolor="#CCCCCC"><span id="pr">
	<table style="width:100%;" border="1">
						 <tr>

    <td width="25%"><input name="total_unit2" type="text" class="input3" id="total_unit2"  maxlength="100" style="98%" required="required"/></td>

    <td width="25%"><input name="total_unit3" type="text" class="input3" id="total_unit3"  maxlength="100" style="98%" required="required"/></td>

    <td width="25%"><input name="total_unit4" type="text" class="input3" id="total_unit4"  maxlength="100" style="98%" required="required"/></td>

    <td width="25%"><input name="total_unit5" type="text" class="input3" id="total_unit5"  maxlength="100" style="98%" required="required"/></td>
    ...
    <td align="center" bgcolor="#CCCCCC"><input name="total_unit" type="text" class="input3" id="total_unit"  maxlength="100" style="width:98%;" required="required"/></td>
...
$res='select a.id,b.finish_goods_code as FG_code,b.item_id as item_code,b.item_name,b.unit_name,a.total_unit,"X" from production_receive_detail a,item_info b where b.item_id=a.item_id and a.pr_no='.$$unique_master.' order by a.id';
...
<table width="100%" border="0">
  ...
  <tr>
      ...
      <td align="center"><input  name="pr_no" type="hidden" id="pr_no" value="<?=$$unique_master?>"/></td><td align="right" style="text-align:right"><input name="delete" type="submit" class="btn1" value="DELETE PR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090; float:left" />
