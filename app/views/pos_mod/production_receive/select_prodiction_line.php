...
if(isset($_POST['delete']))
{
		...
		$det_id=mysql_query('SELECT  id  FROM  production_receive_detail  WHERE  pr_no='.$$unique_master);
		while($det_idd=mysql_fetch_object($det_id)){
		
		$sql = "delete from journal_item where tr_from = 'Receive' and tr_no = '".$det_idd->id."'";
		mysql_query($sql);
		}	
