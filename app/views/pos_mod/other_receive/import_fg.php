...
$title='Import Receive (Finish Goods)';
...
if(isset($_POST['add'])&&($_POST[$unique]>0))
{
		...
		journal_item_control($_POST['item_id'] ,$_SESSION['user']['depot'],$_POST['or_date'],$_POST['qty'],0,$page_for,$xid,$_POST['rate'],'',$_POST['or_no']);}
...
<input  name="receive_type" type="hidden" id="receive_type" value="<?=$page_for?>"  required/>
    ...
    <? $field='or_subject';?>
      ...
      <? $field='lc_no'; ?>
      <div>
        <label for="<?=$field?>">Party Name/LC NO :</label>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:320px;" required onblur="getData2('import_ajax.php', 'po',this.value,document.getElementById('warehouse_id').value);"/></td>
