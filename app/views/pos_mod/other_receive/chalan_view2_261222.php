	...
	<tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><? if($_SESSION['user']['group']==2){?>
                    <table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                      <tr>
                        <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:14px; font-weight:bold;"><span class="style4">Sajeeb Corporation<br />
                  ...
                  <table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                      <tr>
                        <td bgcolor="#FFFFCC" style="text-align:center; color:#333333; font-size:14px; font-weight:bold;"><span class="style4">Hashem Flour Mills Ltd.<br />
                              <span class="style6">Mahona, Gaosia, Narayanganj</span></span></td>
                      </tr>
                    </table>
                  <? }?>
                  ...
                  <table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                      <tr>
                        <td bgcolor="#FFFFCC" style="text-align:center; color:#333333; font-size:14px; font-weight:bold;"><span class="style4">Hashem Agro Processing Ltd.<br />
                              <span class="style6">Baipur, Chabbisnagar, Godagadi, Rajshahi</span></span></td>
                      </tr>
                    </table>
                  <? }?></td>
              </tr>
    ...
    <td colspan="2" align="center"><strong><br />
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td>&nbsp;</td>
          <td><div align="center">Authorized By </div></td>
          </tr>
      </table></td>
    </tr>
  <tr>
