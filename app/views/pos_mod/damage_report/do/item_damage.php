...
$found = find_a_field($table_master,'count(1)','manual_or_no='.$_POST['manual_or_no']);
  ...
  <tr>
    ...
    <? $field='or_subject';?>
      ...
      <div>
        ...
        <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<? if($vendor_name=='') echo find_a_field('dealer_info','dealer_name_e','dealer_code='.$dealer); else echo $vendor_name;?>" required="required"/>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      <tr>
                        ...
                        <td align="center" bgcolor="#0099FF"><strong>Type </strong></td>
...
<select name="receive_type" style="width:50px;" required>
<option></option>
...
<? 
$res='select a.id,b.finish_goods_code as code,b.item_name,d.damage_cause,a.rate as unit_price,a.qty ,a.unit_name,a.amount,"x" from warehouse_damage_receive_detail a,item_info b,damage_cause d where a.receive_type=d.id and b.item_id=a.item_id and a.or_no='.$or_no.' order by id';
...
<form action="select_dealer_damage.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <td align="center"><input name="confirmm" id="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD DR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" /></td>
    </tr>
  </table>
</form>
<? }?>
