...
//		
//mysql_query('update warehouse_transfer_master set status = "'.$_POST['status'].'", rec_sl_no = "'.$_POST['rec_sl_no'].'", receive_date = "'.$_POST['receive_date'].'", received_by = "'.$_POST['received_by'].'" where pi_no="'.$pi_no.'"');
//		
//
...
<table width="750" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<img src="../../../logo/<?=$group_for?>.png" style="width:100px;" />
