...
<div class="form-container_large">
      ...
      <tr>
        <td width="100%" align="center"><fieldset style="width:100%;">
          <div>
			...
			<input type="hidden" name="vat" id="vat" value="15" style="width:200px;" />
          </div>
		  ...
		  <div>
            ...
            <input name="warehouse_from3" readonly="" type="text" id="warehouse_from3" style="width:200px;" value="<?=find_a_field('warehouse','warehouse_name','warehouse_id='.$warehouse_from)?>" />
  ...
  <tr>
    ...
    <td rowspan="2" align="center" bgcolor="#CCFF99"><a href="depot_receive_print_view.php?pi_no=<?=$pi_no?>" target="_blank"><img src="../../../images/print.png" width="26" height="26" /></a></td>
  </tr>
  <tr>
    ...
    <table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:2px solid #fff;" cellpadding="2" cellspacing="2">
      ...
      <tr>
        <td align="center" bgcolor="#CCCCCC"><div align="center">
            ...
            <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:350px; " required onblur="getData2('depot_transfer_ajax.php', 'pr', this.value, document.getElementById('warehouse_to').value);"/>
  ...
  <form action="select_depot.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
    <table width="100%" border="0">
      <tr>
		...
		<input name="delete" type="submit" class="btn1" value="DELETE" style="width:150px; background:#0099CC; font-weight:bold; font-size:12px; height:30px; color:#000000; float:left" />
		
		<input name="confirm" type="submit" class="btn1" value="CONFIRM " style="width:150px;  background:#0099CC; font-weight:bold; font-size:12px; height:30px; color:#000000; float:right" />
        </td>
      </tr>
    </table>
    <? }?>
