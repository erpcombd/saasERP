...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td width="1" bgcolor="#FF9966"><strong>
      ...
      <input type="text" name="fdate" id="fdate" style="width:107px;" value="<?=$_POST['fdate']?>" class="form-control" />
    ...
    <td width="1" bgcolor="#FF9966"><strong>
      ...
      <input type="text" name="tdate" id="tdate" style="width:107px;" value="<?=$_POST['tdate']?>"  class="form-control"/>
...
$res='select  	a.req_no,a.req_no, DATE_FORMAT(a.req_date, "%d-%m-%Y") as req_date,  b.warehouse_name as despatch_order_depot,   DATE_FORMAT(a.need_by, "%d-%m-%Y") as need_by,  a.req_note as Transport , c.fname as entry_by, a.status from requisition_fg_master a,warehouse b,user_activity_management c where  a.sub_depot=b.warehouse_id and a.entry_by=c.user_id '.$con.' and a.status in ("UNCHECKED","CHECKED") order by a.req_no desc';
