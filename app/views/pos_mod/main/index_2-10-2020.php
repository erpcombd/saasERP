...
<title>Warehouse Module <?=PROJECT?></title>
...
.oe_enterprise_content {
    background: url(warehouse.png) no-repeat scroll 0px 0px transparent!important;
...
<div style="text-align:center"><img src="../../../logo/logo.png" width="200px;" ></div>
                            <h2 style="text-align:center; background-color:#256CBA; color:#FFFFFF; padding:5px; margin:5px; >Inventory Software Solution</h2>
