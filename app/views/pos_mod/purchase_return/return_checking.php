...
?>
    ...
    <form action="unapproved_pr.php" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
	 ...
	 <input type="button" class="btn btn-primary" value="CLOSE"  onclick="window.location.href='unapproved_pr.php'" />
 
	  <input name="confirmm" type="submit" class="btn btn-info" value="CONFIRM AND FORWARD PR"  />
