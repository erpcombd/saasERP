...
if(isset($_POST['confirmm']))
{
		...
		$or_no = $_POST['or_no'];
        $sql = 'select w.*,s.ledger_id from warehouse_other_receive_detail w, item_info i, item_sub_group s where i.item_id=w.item_id and s.sub_group_id=i.sub_group_id and w.or_no="'.$or_no.'"';
		$qry = mysql_query($sql);
...
$qry = mysql_query($res);
				...
				<tr>
                    ...
                    <td><?=$data->qty; $t_qty+=$data->qty;?></td>
					<td><?=$data->unit_name?></td>
                    <td><?=$data->amount; $t_amount+=$data->amount;?></td>
				...
				<tr>
					<td colspan="2" align="right"><span>Total</span></td>
					<td><?php echo number_format($t_qty,2); ?></td>
					<td></td>
					<td><span><?php echo number_format($t_amount,2);?></span></td>
					<td></td>
				</tr>
