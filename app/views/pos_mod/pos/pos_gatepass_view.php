...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr height="30" style=" background-color: #cccccc; ">
  	  ...
  	  <td width="50%"  style="text-align:center; color:#FFF; font-size:18px; padding:0px; color:#000000; font-weight:bold;">GATE PASS</td>
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
				 ...
				 <tr>
				  ...
				  <td rowspan="4" style="font-size:12px;">
						<img id="image_id" src="https://chart.googleapis.com/chart?chs=150x150&amp;cht=qr&amp;chl=<?=$group_data->group_name?>-&nbsp;POS No.<?=$pos_id?>.&nbsp;Customer :<?= find_a_field('dealer_pos','dealer_name','dealer_code="'.$master->dealer_id.'"');?>.&nbsp;Total Amt : <?=number_format($grand_total,2)?>&amp;choe=UTF-8" alt="QR code">					</td>
				</tr>
