...
<table width="1000" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr height="30" style=" background-color: #cccccc; ">
  	  ...
  	  <td width="50%"  style="text-align:center; color:#FFF; font-size:18px; padding:0px; color:#000000; font-weight:bold;"><span style="text-decoration:underline">POS SALES </span> </td>
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
				 ...
				 <tr>
				  ...
				  <td rowspan="4" style="font-size:12px;">
						<img id="image_id" src="https://chart.googleapis.com/chart?chs=150x150&amp;cht=qr&amp;chl=<?=$group_data->group_name?>-&nbsp;POS No.<?=$pos_id?>.&nbsp;Customer :<?=$dealer->dealer_name?>.&nbsp;Total Amt : <?=number_format($pos_payment->total_amt,2)?>&amp;choe=UTF-8" alt="QR code">
					</td>
				</tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
            ...
            <td align="center" colspan="2">
				...
				<h3 style="margin: 0; padding: 0px; font-size: 12px;font-weight: 600;">Prepared By</h3>
		    ...
		    <td  align="center" colspan="2">
				<p style="margin: 0; padding: 0px; font-size: 12px;font-weight: 600;">-----------------------------</p>
				<h3 style="margin: 0; padding: 0px; font-size: 12px;font-weight: 600;">Checked By</h3>
			</td>
