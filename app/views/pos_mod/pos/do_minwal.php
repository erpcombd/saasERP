	...
	<div class="container-fluid">
		...
		<div class="row">
			<div class="col-sm-8" id='item_details_section'>
				...
				<div class="container n-form1">
					<div class="n-form-btn-class">
						...
						<input class="btn1 btn1-bg-submit" name="dashboard" type="button" value="POS List" onClick="window.location.href='../pos/pos_status.php'">
					</div>
					...
					<div class="form-group row m-0 pl-3 pr-0">
						...
						<div class="col-sm-7 p-0">
							<div class="form-group row m-0 pl-3 pr-3">
								<label for="group_name" class="col-sm-5 pl-0 pr-0 col-form-label">Special Agent :</label>
								<div class="col-sm-7 p-0">
									<select name="sales_person" id="sales_person">
										<option value="">--Select One--</option>
										<? foreign_relation('personnel_basic_info','PBI_ID','PBI_NAME',$sales_person,'PBI_JOB_STATUS="In Service"')?>
									</select>
									<input type="hidden" name="register_mode" id="register_mode" value="sale" />
								</div>
							</div>
					...
					<div class="form-group row m-0 pl-3 pt-3 pr-3">
						...
						<?php
						auto_complete_from_db('item_info','concat(item_name,"#>",finish_goods_code)','finish_goods_code','1','item_id');
						?>
			...
			<div class="col-sm-4 n-form1">
                       ...
                       <legend style="background: #233f69; height:30px; text-align: left;color: #fff;font-weight: bold;">Existing Customer</legend><div class="form-group row m-0 pl-3 pr-3">
					...
					<div style="border: 2px solid #233f69;">
                       <legend style="background: #233f69; height:30px;text-align: left;color: #fff;font-weight: bold;">New Customer</legend><div class="form-group row m-0 pl-3 pr-3">
						...
						<input type="text" id="address_e" name="address_e" placeholder="Customer Address.." >
						<input type="text" id="email" name="email" placeholder="Email.." >
						<input type="text" id="contact_no" name="contact_no" placeholder="Contact No.." onkeyup="contact_check(this.value);">
						<input type="text" id="register_discount" name="register_discount" placeholder="Register Discount.." >
					...
					<div class="form-group row m-0 pl-3 pr-3">
						...
						<div class="col-sm-8 p-0">
							<select name="payment_method" id="payment_method">
								<option value="">-Select One-</option>
								<? foreign_relation('accounts_ledger','ledger_id','ledger_name',$payment_method,'ledger_group_id in (126001,126002)')?>
						...
						<div class="col-sm-8 p-0">
							<input type="text" name="paid_amt" id="paid_amt" readonly="readonly">
						</div>
						
						<label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Total Discount</label>
						<div class="col-sm-8 p-0">
							<input type="text" name="total_discount" id="total_discount" readonly="">
						</div>
						
						<label for="group_name" class="col-sm-4 pl-0 pr-0 col-form-label">Vat %</label>
						<div class="col-sm-8 p-0">
							<input type="text" name="vat_percent" id="vat_percent" value="15">
						</div>
...
<!--					<th id='company_logo' style="text-align: center;"><img src="../../../logo/demo7.png" alt="company_logo" style="width:100px"></th>-->
					<th id='company_logo' style="text-align: center;">Sales Invoice</th>
                ...
                <tr>
					<th style="font-weight: normal;">Customer Name: <span id="show_customer"></span></th>
				</tr>
				<tr>
					<th style="font-weight: normal;">Customer Contact: <span id="show_contact"></span></th>
				</tr>
				<tr>
				...
				<tr>
					<td>
						<table style="width:100%;">
							...
							<tr class="bold">
								<td colspan="5" style="text-align:right;  border-top:1px solid #333; color:#000; ">Total Discount :</td>
								<td colspan="1" id="tot_discount" style="text-align: left;  border-top:1px solid #333; color:#000; "></td>
							</tr>

							<tr class="bold">
								<td colspan="5" style="text-align:right;">VAT <span id="vat_perc"></span>%:</td>
								<td colspan="1" id="vat_amount" style="text-align: left;"></td>
							</tr>
							
							<tr class="bold">
								<td colspan="5" style="text-align:right;  border-top:1px solid #333; ">Grand Total :</td>
								<td colspan="1" id="grand_total" style="text-align: left;  border-top:1px solid #333; "></td>
							</tr>
							<!--<tr>
...
var actual_price = parseFloat($("#item_actual_price_"+details_id).val());
...
alert('Price Should Not Less Then MRP!');
$("#item_price_"+details_id).val(actual_price);
price = actual_price;
}else{
...
if(disc>0){
var new_amt = item_total_amt-disc;
...
tot_discount+=parseInt(val.discount_amt);
bonus = parseInt(val.register_bonus);
...
key++;
text+="<tr "+now_style+"><td><button title='Click here to remove this item' type='button' id='remove_item_"+val.id+"' title='Remove the item' onclick='remove_item("+val.id+")'>&times;</button></td><td>"+val.serial_no+"</td><td style='width:200px'>"+val.item_name+"</td><td>"+val.stock+"<input type='hidden' style='width:70px' id='stock_"+val.id+"' name='stock_[]' value='"+val.stock+"' /></td><td><input style='height:34px' id='item_price_"+val.id+"' name='item_price[]' value='"+val.rate+"' onchange='cal_again("+val.id+")' /><input type='hidden' id='item_actual_price_"+val.id+"' name='item_actual_price_[]' value='"+val.actual_price+"' /></td><td> <input style='width:50px' type='text' id='item_qty_"+val.id+"' name='item_qty[]' value='"+val.qty+"' "+val.unit_readonly+"  onchange='cal_again("+val.id+")'></td><td> <input style='width:50px' type='text' id='item_discount_"+val.id+"' name='item_discount[]' value='"+val.discount+"' onchange='cal_again("+val.id+")'></td><td id='total_item_amt_"+val.id+"' style='width:100px;'>"+val.total_amt+"</td>";
});
...
$("#total_amount").html(tot_amt-bonus);
$("#total_due_amt").html(tot_amt-bonus);
$("#paid_amt").val(tot_amt-bonus);
$("#total_discount").val(tot_discount+bonus);
select_payment();
}
...
var vat_percent = data.master_info.vat_percent;
var item_details_info = "";
var tot_discount = parseFloat(data.master_info.register_discount);
var payment_details = "";
var tot_amt = 0;
var tot_paid_amt = 0;
var left_amt = 0;
...
item_details_info+="<tr><td colspan='1' class='moveTextToCenter' style='color:#000'>"+val.qty+"</td><td colspan='4' style='color:#000'>"+val.item_name+"</td><td colspan='1' class='moveTextToCenter' style='color:#000'>"+val.total_amt+"</td></tr>";
});

vat = parseFloat(((tot_amt*vat_percent)/100));

$.each(data.payment_history, function(key2, val2){
tot_paid_amt+=parseFloat(val2.paid_amt);
paid_excluding_vat=parseFloat(+val2.paid_amt+ +vat);
r_payment_history+="<tr><td>"+val2.payment_method+"</td><td class='moveTextToRight'>"+paid_excluding_vat+"</td></tr>";
});
...
$("#show_customer").html(data.master_info.dealer_name);
$("#show_contact").html(data.master_info.contact_no);

$("#vat_amount").html(vat);
$("#vat_perc").html(vat_percent);
$("#tia").html(tot_amt);
$("#tot_discount").html(tot_discount+item_discount);
$("#grand_total").html((tot_amt+vat)-(tot_discount+item_discount));
