...
<div class="d-flex justify-content-center">
    <form class="n-form1 fo-width1 pt-4" action="pos_master_report.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-5">
                <div align="left">Select Report </div>
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1111" checked="checked" />
            ...
            <div class="col-sm-7">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
                           <select name="dealer_code" id="dealer_code">
					   		 <option></option>
							<? foreign_relation('dealer_pos','dealer_code','dealer_name',$_POST['dealer_code'],'1');?>
					   	 </select>
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
                           <input  name="warehouse_id" type="text" id="warehouse_id" value="<?=$_SESSION['user']['depot']?>" class="form-control" readonly="readonly" />
...
<!--<form action="pos_master.php" method="post" name="form1" target="_blank" id="form1">
                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td><div align="left">POS Details Report</div></td>
                              </tr>-->
