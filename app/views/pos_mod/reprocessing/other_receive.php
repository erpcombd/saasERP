...
auto_complete_from_db('item_info','finish_goods_code','concat(item_name,"#>",item_id)','product_nature in ("Salable","Both")','item_id');
...
<option></option>
<option <?=($vendor_name==0)?'Selected':'';?> value="0">Self Reprocess</option>
