...
$title='Process Loss';
$page = "process_loss.php";
$ajax_page = "other_issue_ajax.php";
$page_for = 'Process Loss';

/*if($_SESSION['user']['group']=='4'){
do_calander('#oi_date','-60','0');
}
do_calander('#oi_date','-5','0');*/


$din = find_a_field('menu_warehouse','process_loss','id="'.$_SESSION['user']['group'].'"');
  ...
  <tr>
	...
	<? $field='oi_date'; if($oi_date=='') $oi_date =''; ?>
      <div>
        ...
        <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>" readonly="readonly" required autocomplete="off"/>
      </div>
