...
$unique = 'po_no';
$status = 'CHECKED';
$target_url = '../purchase_return/purchase_return_report.php';
...
where ( a.issue_type = "Purchase Return") and a.oi_no=b.oi_no and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" '.$con.' group by a.oi_no order by a.oi_no desc';
