...
$title='New Gift Issue';

$page = "gift_issue.php";

$ajax_page = "gift_issue_ajax.php";
...
if($$unique>0) $btn_name='Update GI Information'; else $btn_name='Initiate GI Information';
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <div class="row ">
	     ...
	     <div class="col-md-3 form-group">
            <label for="do_no" >Gift issue No: </label>
		  ...
		  <div class="col-md-3 form-group">
            <label for="dealer_code">Gift Issue  Date: </label>
		 ...
		 <div class="col-md-3 form-group">
		   ...
		   <div class="col-md-3 form-group">
		    ...
		    <div class="col-md-3 form-group">
            <label for="wo_detail">Gift  To: </label>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD GI" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" />
