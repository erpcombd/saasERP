...
$title='New Entertainment Issue';

$page = "entertainment_issue.php";

$ajax_page = "entertainment_issue_ajax.php";

$page_for = 'Entertainment Issue';
...
if($$unique>0) $btn_name='Update EI Information'; else $btn_name='Initiate EI Information';
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <div class="row ">
	     ...
	     <div class="col-md-3 form-group">
		  ...
		  <div class="col-md-3 form-group">
            <label for="dealer_code">EI Date: </label>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td align="center" width="11%" bgcolor="#0099FF" style="width:100px;"><strong>Stock</strong></td>

                        <td align="center" width="11%" bgcolor="#0099FF" style="width:75px;"><strong>Unit</strong></td>

                        <td align="center" width="11%" bgcolor="#0099FF" style="width:100px;"><strong>Price</strong></td>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  ...
  <table width="100%" border="0">
    ...
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD EI" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" />
