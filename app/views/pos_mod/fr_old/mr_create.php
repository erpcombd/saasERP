...
auto_complete_from_db('item_info','finish_goods_code','concat("#>",item_name,"#>",item_id)',' 1 and product_nature="Salable" and finish_goods_code>0 ','item_id');
?>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      <tr>
                        <td align="center" bgcolor="#0099FF">Item Name</td>
                            <td align="center" bgcolor="#0099FF">FOR</td>
                            <td align="center" bgcolor="#0099FF">Stock</td>
                            <td align="center" bgcolor="#0099FF">Size</td>
                            <td align="center" bgcolor="#0099FF">Unit</td>
...
<input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:300px;" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/>

</td>
                        <td align="center" bgcolor="#CCCCCC">
						<select name="for" id="for" style="width:70px;">
						<option></option>
						<option>Machine-1</option>
						<option>Machine-2</option>
						</select>						</td>
                        <td colspan="3" align="center" bgcolor="#CCCCCC"><span id="mr">
<input name="qoh" type="text" class="input3" id="qoh" style="width:60px;" onfocus="focuson('qty_ctn')" readonly="readonly"/>
<input name="unit_name" type="text" class="input3" id="unit_name"  style="width:40px;" onfocus="focuson('qty_ctn')" readonly="readonly"/>
<input name="pack_size" type="text" class="input3" id="pack_size"  style="width:40px;" value="<?=$item_all->pack_size?>" onfocus="focuson('qty_ctn')" readonly/>
</span></td>
<td align="center" bgcolor="#CCCCCC"><input name="qty_ctn" type="text" class="input3" id="qty_ctn"  maxlength="100" style="width:50px;" required/></td>
      <td align="center" bgcolor="#CCCCCC"><input name="qty_pcs" type="text" class="input3" id="qty_pcs"  maxlength="100" style="width:50px;" required/></td>
      </tr>
    </table>
<br /><br /><br /><br />
<? 
$res='select a.id,concat(finish_goods_code,"-",b.item_name) as item_name,a.for,a.qoh as stock_qty,a.qty DIV b.pack_size as ctn,CAST(MOD(a.qty,b.pack_size) as DECIMAL) as pcs ,"x" from requisition_fg_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
?>
