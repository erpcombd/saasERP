    ...
    <form class="n-form1 pt-4" action="master_report.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-5">
				...
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="113"  tabindex="1"/>
                    <label class="form-check-label p-0" for="report1-btn">
                        Item Opening Report
                    </label>
                </div>
            ...
            <div class="col-sm-7">
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                       <select name="sales_item_type" id="sales_item_type">
                      		<option></option>
							<? foreign_relation('item_group','group_name','group_name',$PBI_GROUP,'1  order by group_name');?>
                    	</select>
                    </div>
                </div>
      			...
      			<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
                       <select name="item_sub_group" id="item_sub_group">
                     		 <option></option>
                      		<? foreign_relation('item_sub_group','sub_group_id','sub_group_name','1  order by group_name');?>
                    	</select>
                    </div>
                </div>
				...
				<div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
						...
						<input  name="warehouse_id" type="text" id="warehouse_id" value="<?=$_SESSION['user']['depot']?>" class="form-control" readonly="readonly" /><strong></strong>
                            
							<?php /*?><select name="warehouse_id" id="warehouse_id">
