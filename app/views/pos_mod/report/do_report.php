...
$title='Delivery Order Chalan Report';
                    ...
                    <div class="col-sm-8 p-0">
                        ...
                        <span class="oe_form_group_cell">
							...
							<select name="marketing_person" class="form-control" >
								  ...
								  <?
									$sql = mysql_query('select PBI_ID,PBI_NAME from personnel_basic_info where PBI_DEPARTMENT=2 and PBI_JOB_STATUS="In Service"');
									while($marketing = mysql_fetch_object($sql)){
								  ?>
