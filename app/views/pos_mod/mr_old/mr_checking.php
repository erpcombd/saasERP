...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td width="35%" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>

                        <td width="11%" align="center" bgcolor="#0099FF"><strong>Stock Qty</strong></td>

                        <td width="10%" align="center" bgcolor="#0099FF"><strong>L P QTY</strong></td>
...
<input name="qoh" type="text" class="input3" id="qoh" style="width:110px;float:left;" readonly/>  

<input name="last_p_qty" type="text" class="input3" id="last_p_qty" style="width:110px;float:left;" readonly/>  

<input name="last_p_date" type="text" class="input3" id=" 	last_p_date"  style="width:110px;float:left;" readonly/>  

<input name="unit_name" type="text" class="input3" id="unit_name"  maxlength="100" style="width:110px;float:left;" readonly/>
</span></div>	</td>


<td align="center" bgcolor="#CCCCCC"><input name="qty" type="text" class="input3" id="qty"  maxlength="100" style="width:60px;background-color:white;"/></td>
      </tr>
    </table>
...
$res='select a.id,concat(b.item_name) as item_name,a.qoh as stock_qty,a.last_p_qty as last_pur_qty,a.last_p_date as last_pur_date,a.qty,"x" from requisition_order a,item_info b where b.item_id=a.item_id and a.req_no='.$req_no;
