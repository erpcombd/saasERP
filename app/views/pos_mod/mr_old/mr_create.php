...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    <td colspan="2"><div align="center">
      <input name="new" type="submit" class="btn1" value="<?=$btn_name?>">
    </div></td>
  </tr>
  <tr>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      ...
                      <tr>
                        ...
                        <td width="11%" align="center" bgcolor="#0099FF"><strong>Stk Qty</strong></td>

                        <td width="10%" align="center" bgcolor="#0099FF"><strong>LPQ</strong></td>

                        <td width="11%" align="center" bgcolor="#0099FF"><strong>LPD</strong></td>

                        <td width="12%" align="center" bgcolor="#0099FF"><strong>Unit</strong></td>

                        <td width="7%" align="center" bgcolor="#0099FF"><strong>Req Qty</strong></td>

                          <td width="6%" align="center" bgcolor="#0099FF"><strong>Remarks</strong></td>
                      ...
                      <tr>
                        ...
                        <td align="center" bgcolor="#CCCCCC"><input  name="<?=$unique?>"i="i" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
                            ...
                            <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:250px;background-color:white;" required="required" onblur="getData2('mr_ajax.php', 'mr', this.value, document.getElementById('warehouse_id').value);"/></td>

                        <td colspan="4" align="center" bgcolor="#CCCCCC">
						 
						<div align="right"><span id="mr">
                          
                        <input name="qoh" type="text" class="input3" id="qoh" style="width:110px;float:left;" onfocus="focuson('qty')" />
                          
                        <input name="last_p_qty" type="text" class="input3" id="last_p_qty" style="width:110px;float:left;" onfocus="focuson('qty')" />
                          
                        <input name="last_p_date" type="text" class="input3" id=" 	last_p_date"  style="width:110px;float:left;" onfocus="focuson('qty')" />
                          
                        <input name="unit_name" type="text" class="input3" id="unit_name"  maxlength="100" style="width:110px;float:left;" onfocus="focuson('qty')" />
                          
                        </span></div>						</td>

                   
                     
                        <td align="center" bgcolor="#CCCCCC"><input name="qty" type="text" class="input3" id="qty"  maxlength="100" style="width:70px;background-color:white;" required/></td>
      <td align="center" bgcolor="#CCCCCC">
	  	<select name="remarks" id="remarks" style="width:50px;">
          <option></option>
