...
//
//$ji_query = mysql_query($ji_sql);	
//
//		while($data_ji=mysql_fetch_object($ji_query))
//
//		{
//
...
<tr>
  ...
  <tr>
   ...
   where i.item_id=s.item_id and s.do_no="'.$$unique.'"';
	...
	$itm_query = mysql_query($itm_sql);
	while($itm_dt=mysql_fetch_object($itm_query)){ 
