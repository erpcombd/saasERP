...
<td width="10%" align="center" bgcolor="#0073AA"><span class="style2">Category </span></td>

<td width="20%" align="center" bgcolor="#0073AA"><span class="style2">Item Name </span></td>
<td width="40%"colspan="4" align="center" bgcolor="#0073AA">

<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="0" cellspacing="2">
<tr>
	 <td width="25%"><span class="style2">Ctn-Stock</span></td>
	 <td width="25%"><span class="style2">Pcs-Stock</span></td>
	 <td width="25%"><span class="style2">Ctn-Price</span></td>
	 <td width="25%"><span class="style2">Pcs-Price</span></td>
</tr>
</table></td>

<td width="10%" align="center" bgcolor="#0073AA"><span class="style2">Ctn</span></td>
<td width="10%" align="center" bgcolor="#0073AA"><span class="style2">Pcs</span></td>
</tr>
...
$do_details="SELECT a.*, i.item_name FROM sale_return_details a, item_info i WHERE  a.item_id=i.item_id and do_no=".$do_no." order by id desc limit 1";
...
<select  name="sub_group_id" id="sub_group_id"  style="width:90%;" required   onchange="getData2('item_info_ajax.php', 'item_info_fount', this.value, document.getElementById('do_no').value);">
...
<tr bgcolor="#CCCCCC">
	 ...
	 <td width="25%"><input name="pcs_stock" type="text" class="input3"  readonly=""  autocomplete="off"  value="" id="pcs_stock" style="width:90%; height:30px;" /></td>
	 <td width="25%"><input name="ctn_price" type="text" class="input3" id="ctn_price" readonly=""   style="width:90%; height:30px;" required  value="<?=$do_data->ctn_price;?>"   /></td>
	 <td width="25%"><input name="pcs_price" type="text" class="input3" id="pcs_price" readonly=""   style="width:90%; height:30px;" required="required"  value="<?=$do_data->pcs_price;?>"  /></td>
</tr>
</table>
</span></td>
...
<? 
  ...
  $res='select a.id,b.item_name,a.crt_price as ctn_price, a.pkt_unit as ctn, a.dist_unit as pcs, a.total_amt as Net_sale, a.discount, a.vat_amt, a.total_amt_with_vat as Due_amt from 
   sale_return_details a,item_info b where b.item_id=a.item_id and a.do_no='.$$unique_master.' order by a.id';
...
<td colspan="3"><div align="right"><strong> Discount:</strong></div></td>

<td>&nbsp;</td>
<td>&nbsp;</td>
<td><?=number_format($cash_discount,2);?></td>
<td>&nbsp;</td>
</tr>
...
<td colspan="3"><div align="right"><strong> VAT (<?=$vat;?> %):</strong></div></td>

<td>&nbsp;</td>
<td>&nbsp;</td>
<td><?
$taxable_amount =  $tot_Net_sale-$cash_discount;
echo $tot_vat_amt = ($taxable_amount*$vat)/100;
?></td>
<td>&nbsp;</td>
</tr>
...
<td colspan="3"><div align="right"><strong>Total Amount Including VAT:</strong></div></td>

<td>&nbsp;</td>
<td>&nbsp;</td>
<td><?=number_format($amount_including_vat = $taxable_amount+$tot_vat_amt,0);?></td>
<td>&nbsp;</td>
</tr>
<?php */?>
...
<input name="delete"  type="submit" class="btn1" value="DELETE" style="width:60%; font-weight:bold; background:#0073AA; font-size:12px;color:#F00; height:30px" />
...
<input name="confirm" type="submit" class="btn1" value="CONFIRM" style="width:60%; background:#0073AA; font-weight:bold; font-size:12px; height:30px; color: #FFFFFF; float:right" />
