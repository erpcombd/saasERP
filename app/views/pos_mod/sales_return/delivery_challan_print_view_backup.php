...
<thead>
  <tr>
    <td><div class="header">
            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td width="17%">
                        <img src="../../../logo/<?=$master->group_for?>.png" width="100%" />
        ...
        <td bgcolor="#666666" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;">DELIVERY CHALLAN </td>
      </tr>
                          </table>
                        <td width="25%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px; color: #F00;">
                            ...
                            <tr>
                              <td align="right" valign="middle">Challan Date:  </td>
                              <td><table width="100%" border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="3">
                                  <tr>
                                    <td><strong><?php echo date('d-m-Y',strtotime($ch_data->chalan_date));?></strong></td>
                                  </tr>
                                </table></td>
                            </tr>
                      </table>                      </tr>
  ...
  <tr>
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:14px">
        ...
        <?  $sqlc = 'select c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_do_chalan c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.chalan_no='.$chalan_no.' group by c.id order by c.id asc';
