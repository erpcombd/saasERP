    ...
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          ...
          <input type="text" name="fdate" id="fdate" style="width:107px;" value="<?=isset($_POST['fdate'])?$_POST['fdate']:date('Y-m-01');?>" class="form-control" />
        ...
        <td width="1" bgcolor="#FF9966"><strong>
          ...
          <input type="text" name="tdate" id="tdate" style="width:107px;" value="<?=isset($_POST['tdate'])?$_POST['tdate']:date('Y-m-d');?>"  class="form-control"/>
