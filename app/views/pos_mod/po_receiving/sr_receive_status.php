...
where a.or_no=b.or_no and a.entry_by=c.user_id and a.warehouse_id = "'.$_SESSION['user']['depot'].'" and a.receive_type = "Sales Return" '.$con.' group by a.or_no order by a.or_no desc';
