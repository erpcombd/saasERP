...
`entry_at`,ch_no, transport_charge, other_charge, remarks, avg_price, status )
 VALUES('".$pr_no."', '".$group_for."', '".$po_no."', '".$data->id."', '".$rec_no."','".$rec_date."',".$vendor_id.", ".$item_id.",".$warehouse_id.", ".$rate.", '".$qty."', '".$unit_name."',  '".$amount."', '".$qc_by."',  '".$_SESSION['user']['id']."', '".$now."', '".$ch_no."', '".$transport_charge."', '".$other_charge."', '".$remarks."', '".$final_avg_price."', 'Received')";
									...
									<thead>
										...
										?>
												...
												<tr>
												  ...
												  <td ><a target="_blank" href="../po_receiving/chalan_view.php?v_no=<?=$aaa->pr_no?>"><img src="print.png" width="100%" height="100%" /></a></td>
            ...
            <table class="table1  table-striped table-bordered table-hover table-sm">
				...
				<td><?=$row->item_id?>
				  ...
				  <? if($unrec_qty>0){$cow++;?>
					...
					<input name="chalan_<?=$row->id?>" type="text" id="chalan_<?=$row->id?>"  class="text-center" value=""  />
