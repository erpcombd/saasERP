            ...
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td><? if($_SESSION['user']['depot']!=5){?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  <tr>
                    <td bgcolor="#00CC33" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;">Jamuna Industrial Agro Group.<span class="style4"><br />
                          <span class="style6"> Azmat Lunarium (4th & 6th Floor),House #04 Roade #33,Sector #7,Uttara,Dhaka-1230</span></span></td>
                  </tr>
                  
                </table><? }else{?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  <tr>
                    <td bgcolor="#00CC33" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;"><span class="style4">Jamuna Industrial Agro Group. <br />
                          <span class="style6">Azmat Lunarium (4th & 6th Floor),House #04 Roade #33,Sector #7,Uttara,Dhaka-1230</span></span></td>
                  </tr>
