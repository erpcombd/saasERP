              ...
              <tr>
                ...
                <td><? if($_SESSION['user']['depot']!=5){?><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#000000; font-size:20px; font-weight:bold; padding-bottom:10px;"><span class="style5"><?=foreign_relation('user_group','group_name','group_name','1');?>

                          <span class="style6"><?=find_a_field('user_group','address','1');?></span></span></td>
                  ...
                  <tr>
                    ...
                    <td bgcolor="#FFFFCC" style="text-align:center; color:#333333; font-size:14px; font-weight:bold;"><span class="style4"><?=foreign_relation('user_group','group_name','group_name','1');?><br />
