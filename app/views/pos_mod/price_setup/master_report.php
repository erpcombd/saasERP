...
if(isset($item_id)) 			{$item_name_con=' and i.item_id="'.$item_id.'"';}
...
//
//		if(isset($group_for))
//		$str 	.= '<img  src="../../../logo/'.$group_for.'.png" width="300" />';
//
//		if(isset($report))
//		$str 	.= '<h2>'.$report.'</h2>';
//
...
//
		...
		$str 	.= '<th style="border: 0px" colspan="3" width="25%" align="center" >';
		if(isset($_SESSION['user']['group']))
			$str 	.= '<img width="50%" src="../../../logo/'.$_SESSION['user']['group'].'.png'.'">';
		$str 	.= '</th>';

		$str 	.= '<th style="border: 0px" colspan="6" width="50%" align="center" >';
		$str 	.= '<h1 style="font-weight: bolder; text-align: center; text-align: center;">'.find_a_field('user_group','group_name','id='.$_SESSION['user']['group']).'</h1>';


		if(isset($report))
			$str 	.= '<h2 style="margin: 2px; font-size:15px;font-weight: bold; text-align: center;">'.$report.'</h2>';

		if(isset($group_for))
			$str 	.= '<h2 style="margin: 2px; font-size:14px; text-align: center;"><strong>Concern Name : </strong>' .find_a_field('user_group','group_name','id='.$group_for).'</h2>';

		if(isset($item_sub_group))
			$str 	.= '<h2 style="margin: 2px; font-size:14px; text-align: center;"><strong>Sub Group : </strong>' .find_a_field('item_sub_group','sub_group_name','sub_group_id='.$item_sub_group).'</h2>';



		if(isset($t_date))
			$str 	.= '<h2 style="margin: 2px; font-size:14px; text-align: center;"><strong>Date Interval : </strong>'.$f_date.' To '.$t_date.'</h2>';

		if(isset($product_group))
			$str 	.= '<h2 style="margin: 2px; font-size:14px; text-align: center;"><strong>Product Group : </strong>'.$product_group.'</h2>';
		...
		$str 	.= '</th>';
		$str 	.= '</tr>';
		$str 	.= '<tr><th style="border: 0px" colspan="12">';
...
<thead>
<tr><td style="border:0px; text-align:center;" colspan="9"><img src="../../../logo/80.png" width="300" /></td></tr>
...
?><table width="100%" cellspacing="0" cellpadding="2" border="0" id="ExportTable" style="font-size:14px;">
