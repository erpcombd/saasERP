...
$serial_qry = mysql_query($serial_sql);
$s_data = mysql_fetch_object($serial_qry);
...
<div class="row ">
      ...
      <div>
		...
		<select name="<?=$field?>" id="<?=$field?>" class="form-control" >
			...
			while($row2=mysql_fetch_object($re_query)){
			?>
	...
	<? foreign_relation('warehouse','warehouse_id','warehouse_name',$received_branch);?>
      ...
      <p>
        ...
        <input type="hidden" class="form-control" id="client_id" name="client_id" value="<?=$client_id?>" required>
        <input type="text" list="customer_list" class="form-control" id="client_name" name="client_name" value="<?=$client_name?>" required>
	   ...
	   <? $field='client_address';?>
          ...
          <input class="form-control"  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$client_address?>"/>
</div>
		
		<div class="col-md-3 form-group" >
		<? $field='mobile_no';?>
          <label for="<?=$field?>">Customer Mobile :</label>
          <input class="form-control"  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$mobile_no?>"/>
        </div>
	...
	<option></option>
	<option <?=($warranty_status=='YES')? 'selected':''?>>YES</option>
	<option <?=($warranty_status=='NO')? 'selected':''?>>NO</option>
	</select>
</div>
...
<select name="item_id" id="item_id" style="width:98%;" class="form-control" required>
<? foreign_relation('item_info','item_id','item_name',$service_info->item_id)?>
</select>
...
<td align="center" bgcolor="#CCCCCC"><input  name="serial_no" type="hidden" id="serial_no" value="<?=$service_info->serial_no?>"/><?=$service_info->serial_no?></td>
<td align="center" bgcolor="#CCCCCC"><input  name="invoice_no" type="hidden" id="invoice_no" value="<?=$service_info->chalan_no?>"/><?=$service_info->chalan_no?></td>
