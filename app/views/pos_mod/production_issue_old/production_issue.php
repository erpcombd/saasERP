...
auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_id)','sub_group_id=1096001000010000','item_id');
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td width="33%"><fieldset style="width:308px;">

    <div>

      <label style="width:85px;">PI No : </label>
    ...
    <div>
      ...
      <label style="width:85px;">Carried by : </label>
    ...
    <td width="33%">
			...
			<fieldset style="width:308px;">
			  ...
			  <div>
			    ...
			    <label style="width:85px;">Issue Date : </label>
			  ...
			  <div>
			    ...
			    <label style="width:85px;">SR NO: </label>

			    <input name="remarks" type="text" id="remarks"  value="<?=$remarks?>" tabindex="105" />
		      </div>
		</fieldset>	</td>

    <td width="21%"><fieldset style="width:308px;">

      <div>

        <label style="width:85px;">From: </label>
        ...
        <label style="width:85px;">PL Name: </label>
  ...
  <tr>
    <td colspan="3"><div align="center"><span class="buttonrow" style="margin-left:240px;">
      <? if($$unique_master>0) {?>
      <input name="new" type="submit" class="btn1" value="Update Packing Materials Issue " style="width:250px; font-weight:bold; font-size:12px;" tabindex="12" />
      <input name="flag" id="flag" type="hidden" value="1" />
      <? }else{?>
      <input name="new" type="submit" class="btn1" value="Initiate Packing Materials Issue " style="width:250px; font-weight:bold; font-size:12px;" tabindex="12" />
  ...
  <tr>
    ...
    <td colspan="3"><div class="buttonrow" style="margin-left:240px;"></div></td>
    </tr>
</table>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
  ...
  <tr>
    ...
    <td width="38%" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>

    <td width="13%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Unit</span></td>

    <td width="8%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">Stk</span></td>

    <td width="9%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">LIQ </span></td>

    <td width="8%" align="center" bgcolor="#0099FF"><span style="font-weight: bold">LID</span></td>

    <td width="9%" align="center" bgcolor="#0099FF"><strong> Qty</strong></td>

    <td width="9%" align="center" bgcolor="#0099FF"><strong>Note</strong></td>
  ...
  <tr>
    ...
    <input  name="warehouse_to" type="hidden" id="warehouse_to" value="<?=$warehouse_to?>"/>
      ...
      <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:250px;"  onblur="getData2('production_issue_ajax.php', 'pi', this.value, document.getElementById('warehouse_to').value);"/>
	...
	<input name="total_unit2" type="text" class="input3" id="total_unit2"  maxlength="100" style="width:50px;" />      

	<input name="total_unit3" type="text" class="input3" id="total_unit3"  maxlength="100" style="width:50px;" />      

	<input name="total_unit4" type="text" class="input3" id="total_unit4"  maxlength="100" style="width:50px;" />      

	<input name="total_unit5" type="text" class="input3" id="total_unit5"  maxlength="100" style="width:50px;" />
	</span>	</td>

    <td align="center" bgcolor="#CCCCCC"><input name="total_unit" type="text" class="input3" id="total_unit"  maxlength="100" style="width:67px;" /></td>
    <td align="center" bgcolor="#CCCCCC"><input name="note" type="text" class="input3" id="note"  maxlength="100" style="width:67px;"/></td>
  </tr>
</table>
...
$res='select a.id,b.item_id as item_code,b.item_name,b.unit_name,a.total_unit,"X" from production_issue_detail a,item_info b where b.item_id=a.item_id and a.pi_no='.$$unique_master.' order by a.id';
