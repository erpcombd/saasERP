...
$title='Other Receive (Black Tea)';

$page_for = 'Sample Receive';
//do_calander('#or_date','-10','0');
do_calander('#or_date');
do_calander('#quotation_date');

$table_master='warehouse_black_tea_other_receive';
$table_details='warehouse_black_tea_other_receive_detail';
$unique='or_no';
...
//auto_complete_from_db('item_info','item_name','concat(item_name,"#>",item_id)','product_nature!="Salable"','item_id');
...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
    ...
    <? $field='or_no';?>
      <div>
        <label for="<?=$field?>">OR  No: </label>
        <input  name="<?=$field?>" type="text" id="<?=$field?>" value="<?=$$field?>"/>
      </div>
<? $field='or_date'; if($or_date=='') $or_date =date(''); ?>
      <div>
        <label for="<?=$field?>">Other Receive Date:</label>
...
<table  width="100%" border="1" align="left"  style="border-collapse:collapse; border:1px solid #caf5a5;" cellpadding="2" cellspacing="2">
                      <tr>
                        <td width="21%" align="center" bgcolor="#0099FF"><strong>Garden Name</strong> </td>
                        <td width="21%" align="center" bgcolor="#0099FF"><strong>Item Name</strong></td>
                        ...
                        <td width="8%" align="center" bgcolor="#0099FF"><strong>Qty</strong></td>
                        <td width="12%" align="center" bgcolor="#0099FF"><strong>Amount</strong></td>
                      ...
                      <tr>
<td align="center" bgcolor="#CCCCCC"><input name="garden_id" type="text" class="input3" id="garden_id"   style="width:150px;" onchange="count()" required="required"/></td>
<td align="center" bgcolor="#CCCCCC"><input  name="receive_type2" type="hidden" id="receive_type2" value="<?=$page_for?>"  required="required"/>
  <input  name="<?=$unique?>" type="hidden" id="<?=$unique?>" value="<?=$$unique?>"/>
  <input  name="warehouse_id2" type="hidden" id="warehouse_id2" value="<?=$warehouse_id?>"/>
  ...
  <input  name="item_id" type="text" id="item_id" value="<?=$item_id?>" style="width:150px;" required="required" onblur="getData2('other_receive_black_tea_ajax.php', 'po',this.value,document.getElementById('warehouse_id').value);"/></td>
...
<form action="" method="post" name="cz" id="cz" onSubmit="if(!confirm('Are You Sure Execute this?')){return false;}">
  <table width="100%" border="0">
    <tr>
      ...
      <input name="confirmm" type="submit" class="btn1" value="CONFIRM AND FORWARD SR" style="width:270px; font-weight:bold; font-size:12px; height:30px; color:#090" />
