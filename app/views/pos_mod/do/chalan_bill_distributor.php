...
$sql1="select d.*,b.*, sum(b.total_unit) as total_unit, d.total_unit as ord_unit, sum(b.total_amt) as total_amt, b.total_unit as item_ex, m.depot_id as depot, m.remarks
                ...
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#00CC33" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;"><span class="style4"><span style="font-size:20px; color:#000000;">এম&sbquo; আহমেদ টি এন্ড ল্যান্ডস কোঃ লিঃ </span> <br />
                          ...
                          <span class="style6" style="font-size:14px; color: #000000;  "><b>দরগাহ মহল্লা&sbquo; সিলেট।</b> <br /> ফোন নং- ০৮২১-৭১৮৮১৫, ৭১৬৫৫২ <br /> <b>মূল্য সংযোজন কর নিবন্ধন নং- ৭০১১০২৮৮৯২ </b> </span></span></td> 
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
		            ...
		            <tr>
		              ...
		              <td height="60" valign="top"><span style="font-size:14px; " class="style8"><?php echo $dealer->address_b.'&nbsp;'.' Mobile: '.$dealer->mobile_no;?>&nbsp;</span></td>
		        ...
		        <tr>
		          ...
		          <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                      ...
                      <tr>
						  ...
						  <td><span style="font-size:16px; font-weight:bold;" class="style8"><?php echo $dealer->propritor_name_b;?>&nbsp;</span></td>
...
?>
      ...
      <tr>
		...
		<? $tttt=($t_price[$i]==0&&$dealer->dealer_type=='SuperShop')?(($unit_price[$i]*$fit_size)*$item_ex[$i]):(($t_price[$i]*$fit_size)*$item_ex[$i]);
echo  number_format($tttt,2); $ttttt = $ttttt + $tttt;
?></td>

        <td align="right" valign="top"><? if($dealer->dealer_type=='SuperShop') $discount =($t_price[$i]-$unit_price[$i])* $item_ex[$i]; else $discount = ($t_price[$i]-$unit_price[$i])* $item_ex[$i];
		 echo  number_format($discount,2); $tdiscount = $tdiscount + $discount;?></td>
