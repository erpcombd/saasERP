                ...
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#00CC33" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;"><span class="style4"><span style="font-size:20px; color:#000000;">এম&sbquo; আহমেদ টি এন্ড ল্যান্ডস কোঃ লিঃ </span> <br />
                          ...
                          <span class="style6" style="font-size:14px; color: #000000;  "><b>দরগাহ মহল্লা&sbquo; সিলেট।</b> ফোন নং- ০৮২১-৭১৬৫৫২<br /> 
                          ঢাকা- ০২-৪৯৩৪৯৮৭৫&cedil; চট্টগ্রাম- ০৩১-৭১৩৬৩২<br /> <b>মূল্য সংযোজন কর নিবন্ধন নং- ২২০২১০১৩৫৮০ </b>  </span></span></td>
		  ...
		  <tr>
			...
			<tr>
			  ...
			  <tr>
			    ...
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
			      ...
			      <tr>
			        ...
			        <td><strong><?php echo $mr_no;?></strong>&nbsp;</td>
			        </tr>
			  ...
			  <tr>
			    ...
			    <td align="right" valign="middle">Rcv. Amount:</td>

			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">

			      <tr>

			        <td><strong><?php echo number_format($rcv_amt,2);?></strong>&nbsp;</td>
			        </tr>
...
<? }?>
  ...
  <tr>
    ...
    <td colspan="2" style="font-size:10px"><em>N B : This is software generated bill, Signature is not required.&nbsp;&nbsp;||&nbsp;&nbsp;&nbsp;All goods are received in a good condition as per Terms </em> </td>
