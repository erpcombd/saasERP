...
$unique='id';  		
$title='Vendor Massage' ; 	
$page="vendor_massage.php";		
$table='rfq_vendor_massage';		
...
<h2 class="container" style=" font-size: 30px !important; ">Vendor Massage</h2>
...
<input type="hidden" name="id" id="id" value="<?=$$unique?>" />
  <textarea id="editor" name="vendor_massage"><?=$vendor_massage?></textarea>
</div>

<div>
<input type="submit" class="btn1 btn1-bg-update" name="update" id="update" value="Update" />
</div>
