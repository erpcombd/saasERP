				...
				<tbody>
					...
					<tr class="tr">
						...
						<td class="td2"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$_SESSION[$unique]?>" type="hidden" />
							...
							<input name="fname" required type="text" id="fname" tabindex=2 value="<?=$fname?>" required ></td>
					</tr>
					
					<tr class="tr">
						<td class="td1 fs-14 bold req-input">E-mail</td>
						<td class="td2">
						<input name="email" type="email" id="email" tabindex=3 value="<?=$email?>" required class="required">
					...
					<tr class="tr">
						...
						<td class="td2"><input name="expire_date" type="date" id="expire_date"  required value="<?=$expire_date?>" tabindex=4/></td>
					</tr>
				...
				<tbody>
					...
					<tr class="tr">
						...
						<td class="td2"><select name="division" id="division" >
									<option <?php if($division=='division1') echo 'selected'; ?> value="division1" >division1</option>
									<option <?php if($division=='division2') echo 'selected'; ?> value="division2" >division2</option>
