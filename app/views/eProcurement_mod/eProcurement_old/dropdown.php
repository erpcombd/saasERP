...
<table class="w-100" >
 <thead>
  <tr>
    <th scope="col">Dropdown-<?=$unique_no?></th>
    <th scope="col"><button type="button" name="more_option" class="btn1 btn1-bg-cancel" onClick="select_html('Dropdown','remove');">Remove</button></th>
  </tr>
 </thead>
...
<table class="w-100"   id="optionsTable_<?=$unique_no?>">
  <tr>
     ...
     <td><button type="button" name="more_option" class="btn1 btn1-bg-warning" onclick="addOption('dropdown',<?=$i?>)">Add Option +</button></td>
   </tr>
</table>
<hr/>