...
<table class="100" >
 <thead>
  <tr>
    <th scope="col">Text Field-<?=$unique_no?></th>
    <th scope="col"><button type="button" name="more_option" class="btn1 btn1-bg-cancel" onClick="select_html('Text Field','remove');">Remove</button></th>
  </tr>
 </thead>
