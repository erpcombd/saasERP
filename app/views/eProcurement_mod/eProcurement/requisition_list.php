 ...
 .dropdown {
  ...
  .modal-dialog {
   ...
   .modal-header .modal-title, .modal-header button i {
    ...
    .green-button {
    background-color: #28a745; /* Adjust the green shade as needed */
    color: white;
    border: none;
}

</style>
<h1 class="container" style="font-size: 30px !important; text-align: center;">Requisition List</h1>
...
<table id="example" class="table1 table-striped table-bordered table-hover table-sm">
    ...
    <thead class="thead1">
        <tr class="bgc-info">
            ...
            <th scope="col">Manual REQ No</th>
            <th scope="col">REQ Date</th>
            <th scope="col">REQ for</th>
            <th scope="col">Warehouse</th>
            <th scope="col">REQ Note</th>
    ...
    <tbody>
        <?php
          $data = "SELECT * FROM requisition_master  ORDER BY req_no DESC"; 
            $query = db_query($data);
        ...
        ?>
            ...
            <tr>
                ...
                <td><a href="eprocurement_entry_entry.php?clear=1&rfx_stage=REQ&req=<?=$row->req_no?>"  style="background-color: background-color: #28a745 !important;"  >
                <button type="button" class="btn1 btn1-bg-submit green-button"   > RFQ</button>
                </a><br>
                <a href="eprocurement_entry_entry.php?clear=1&rfx_stage=REQ&req=<?=$row->req_no?>"  style="background-color: background-color: #28a745 !important;"  >
                <button type="button" class="btn1 btn1-bg-submit green-button"   > RFI</button></a><br>
                <a href="eprocurement_entry_entry.php?clear=1&rfx_stage=REQ&req=<?=$row->req_no?>"  style="background-color: background-color: #28a745 !important;"  >
                <button type="button" class="btn1 btn1-bg-submit green-button"   >RFP</button></a><br>
                </a>
            </td>
