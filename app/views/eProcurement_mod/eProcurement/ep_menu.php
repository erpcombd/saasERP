	 ...
	 //if($_SESSION['user']['level']==5 || $_SESSION['user']['level']==3 || $_SESSION['user']['level']==4){
	  ?>
        <ul class="navbar-nav mr-auto">
          <li class="nav-item">
            <a class="nav-link menu-option <?php if ($current_page == 'events') {echo 'ep_selected';} ?>" href="../eProcurement/eprocurement_entry.php">RFQ List</a>
          </li>
		   <li class="nav-item">
            <a class="nav-link menu-option <?php if ($current_page == 'setup') {echo 'ep_selected';} ?>" href="requisition_list.php">Requisition List</a>
          </li>
          <li class="nav-item">
