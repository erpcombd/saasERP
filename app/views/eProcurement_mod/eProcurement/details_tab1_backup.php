...
<div class="modal fade" id="addattachmentsEdit" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document" style="max-width: 650px;">
    <div class="modal-content">
      ...
      <div class="modal-footer justify-content-center">
	  			<? if($_SESSION['master_status']=='MANUAL'){?>
				 <button type="button" name="att_details" class="btn1 btn1-bg-update" id="uploadButtonedit" onclick="event_att_insert_edit(document.getElementById('gsection_name_edit').value,document.getElementById('gterms_edit').value,document.getElementById('gsection_type').value,document.getElementById('att_response_general').value,document.getElementById('is_required_general').value,'details_att_general')" data-dismiss="modal" style="display: none;">Add Attachment</button>
				 <? } ?>
