...
{
	$found = find_a_field('currency_info','count(id)','currency like "'.$_POST['currency'].'" and id != "'.$_POST['id'].'"');
	if($found<1){
		$group_name = trim($_POST['currency']);
		if (!empty($group_name)) {
	
			$found2 = find_a_field('currency_info','count(id)','currency_code like "'.$_POST['currency_code'].'" and id != "'.$_POST['id'].'"');
			if($found2<1){
				$group_name2 = trim($_POST['currency_code']);
				if (!empty($group_name2)) {
...
<h1 class="container" style=" font-size: 30px !important; ">Currency Information</h1>
	...
	<!-- <div class="col-sm-2 col-md-2 col-lg-2"></div> -->
		<div class="col-sm-8 col-md-8 col-lg-8">
			...
			<table  class="w-100">
				<caption></caption>
					<tr class="tr">
						<td class="td1 fs-14 bold req-input">Add New Carrency</td>
						<td class="td2">
							...
							<input class="m-0" name="currency" required type="text" id="currency" tabindex="1"  value="<?=$currency?>" tabindex=1/>
						
						</td>
						<td class="td1 fs-14 ml-3 bold req-input">Carrency Code</td>
						<td class="td2">
							<input class="m-0" name="currency_code" required type="text" id="currency_code" tabindex="2"  value="<?=$currency_code?>" tabindex=1/>
...
<tr class="bgc-info" >
	...
	<th scope="col" scope="col">Currency Code</th>
	<th scope="col" scope="col">Currency Name</th>
...
<tbody>
				<?  $data = "SELECT * FROM  currency_info WHERE 1"; 
					$query = db_query($data);
