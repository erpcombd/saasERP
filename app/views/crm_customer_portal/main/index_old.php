...
if(strpos($_SERVER['PHP_SELF'], 'CloudERP')==true){
$company_id = "clouderp";
}else{
$company_id = "";	
	}
                ...
                <div class="oe_login_pane oe_enterprise_pane">
                    <form action="" method="post">
                        ...
                        <div style="opacity: 1; display: block;" class="oe_enterprise_signup">
                            <h2>Sales - ERP Solution</h2>
                        </div>
                        <div class="oe_login_error_message oe_enterprise_error_message"></div>

                        
                        <p>Welcome to the Sales Modules. Please provide access information to enter in.</p>
    ...
    <select name="db">
                ...
                <option value="openerp">openerp</option>
                      ...
                      <fieldset>
                          ...
                          <input autofocus class="oe_enterprise_login_input" name="cid" value="<?=$company_id?>" type="text" width="95%">
                        </fieldset>
                        <fieldset>
