 ...
 <tr> <td><hr /></td></tr>
  ...
  <tr><td>&nbsp;</td></tr>
  	...
  	<tr height="30">
  	  ...
  	  <td width="50%"  style="text-align:center; "><span style="color:#FFF; font-size:18px; background:#c5f591; padding:8px 30px; color:#000000; font-weight:bold; border: 2px solid #000000; border-radius: 5px; ">
	  SALES ORDER</span> </td>
