...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4" action="other_master_report_order.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-6">
                <div align="left">Select Report </div> <br />
				
				
              <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1" checked="checked" />
                    Other Order Brief Report(1)</div>
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1991" />
                    <label class="form-check-label p-0" for="report1-btn">Other Order Brief Report with Chalan Amount(1991)</label>
				</div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1992"  />
                  <label class="form-check-label p-0" for="report1-btn">Sales Statement(As Per DO)(1992)</label>
			  </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="191" />
                  <label class="form-check-label p-0" for="report1-btn">Other Order  Report (At A Glance)(191)</label>
			  </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="2" />
                    Delivered Do Details Report(2)</div>
			
				
				
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="3" />
                    <label class="form-check-label p-0" for="report1-btn">Delivered Do Report Dealer Wise(3)</label>
                </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="4" />
                  <label class="form-check-label p-0" for="report1-btn">Chalan Report(Chalan Date Wise)(4)</label>
			  </div>
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="5" />
                    <label class="form-check-label p-0" for="report1-btn">Other Order Brief Report (Region Wise)(5)</label>
				</div>
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="7" />
                    <label class="form-check-label p-0" for="report1-btn">Item Wise DO Report(7)</label>
				</div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="702" />
                    <span style="color:#FF6633">Party Wise Undelivered DO Report(Bulk)(702)</span></div>
					
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="701" />
                    Item Wise Undelivered DO Report(With Gift)(701)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="7011" />
                    Item Wise Undelivered DO Report(Without Gift)(7011)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="14" />
                    Item DO Report (Region)(14)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="9" />
                    Item DO Report (Region+Zone)(9)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="6" />
                    View DO  (Single)(6)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="8" />
                    Dealer Performance Report(8)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="10" />
                    Daily Collection Summary(10)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="13" />
                    Daily Collection Summary(Ext)(13)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="11" />
                    Daily Collection &amp; Order Summary(11)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1999" />
                    DO Report for Scratch Card(1999)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="2000" />
                    DO Summery Report Region Wise(2000)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="2001" />
                    Item Wise Chalan Details Report (DO Entry Date)(2001)</div>
