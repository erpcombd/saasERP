...
<div class="d-flex justify-content-center">
    <form class="n-form1 pt-4" action="other_master_report_chalan.php" method="post" name="form1" target="_blank" id="form1">
        <div class="row m-0 p-0">
            <div class="col-sm-6">
              ...
              <div class="form-check">
                    ...
                    Other Chalan Brief Report(1)</div>
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="101" />
                    <label class="form-check-label p-0" for="report1-btn">Other Order wise Chalan Brief Report(101)</label>
				</div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="2"  />
                  <label class="form-check-label p-0" for="report1-btn">Item Wise Chalan  Brief Report(2)</label>
			  </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="401" />
                  <label class="form-check-label p-0" for="report1-btn">Item Wise Chalan  Brief Report(Main Product)(401)</label>
			  </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="402" />
                    Item Wise Chalan  Brief Report(By Product)(402)</div>
			
				
				
                <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="201" />
                    <label class="form-check-label p-0" for="report1-btn">Item Wise Chalan  Details Report(HFML)(201)</label>
                </div>
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="191" />
                  <label class="form-check-label p-0" for="report1-btn">Party Wise Delivery Chalan  Report (At A Glance)(191)</label>
			  </div>
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="3" />
                    <label class="form-check-label p-0" for="report1-btn">Delivered Chalan Report (Chalan Wise)(3)</label>
				</div>
				<div class="form-check">
			  ...
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1004" />
                    Warehouse Stock Position Report(Closing)(1004)</div>
					
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="1006" />
                    Warehouse Stock Position Report(Promotion)(1006)</div>
					<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn" value="6" />
                    View Chalan Report(Single)(6)</div>
