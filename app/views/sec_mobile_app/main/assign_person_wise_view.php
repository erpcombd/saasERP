...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    // Get the employee ID and name from the form submission
    $emp_id = $_POST['emp_id'];
                 ...
                 $sqlRemainder= "SELECT * FROM crm_task_add_information a WHERE 
				assign_person = $emp_id  AND status != 'cancelled' ORDER BY `task_id` DESC;";
