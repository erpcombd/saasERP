...
<div class="box" style="width:100%;">
					...
					<? if ($_POST['bill_type']==1) {?>
								 ...
								 <td>&nbsp;</td>
									...
									<select name="cr_ledger_id" id="cr_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$_POST['cr_ledger_id'],'ledger_group_id=30219');?>
									</select>
	...
	<select name="payment_method" id="payment_method" required style="width:220px;" >
									...
									<select name="cr_ledger_id" id="cr_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$bank_ledger,'ledger_group_id in (10210,10211)');?>
									</select>
									</span>
									</td>
									<td>REMARKS:</td>
...
<tr>
						...
						<tr>
								 ...
								 <td>C&amp;F COMPANY:</td>
									...
									<select name="cr_ledger_id" id="cr_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$_POST['cr_ledger_id'],'ledger_group_id=420135');?>
									</select>
									</td>
									<td>R. NO: </td>
									<td>
...
<tr>
	...
	<select name="payment_method" id="payment_method" required style="width:220px;" >
									...
									<select name="cr_ledger_id" id="cr_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$_POST['cr_ledger_id'],'ledger_group_id in (1009,1011)');?>
									</select>
									</span>
									</td>
									<td>REMARKS:</td>
