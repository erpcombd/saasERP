...
<table width="99%" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <tr>
    ...
    <td valign="top" width="45%" ><fieldset style="width:100%;">
      ...
      <input  name="Supplier" type="text" id="Supplier" value="<?=find_a_field('vendor','vendor_name','vendor_id="'.$ci_data->vendor_id.'"');?>"  readonly="readonly"/>
      ...
      <tbody>
          ...
          <tr bgcolor="<?=(($bg%2)==1)?'#FFEAFF':'#DDFFF9'?>">
            ...
            <td><?=$row->item_name?>
			  ...
			  <? if($unrec_qty>0){$cow++;?>
			  <input name="chalan_<?=$row->id?>" type="text" id="chalan_<?=$row->id?>" style="width:80px; float:none" value=""  />
