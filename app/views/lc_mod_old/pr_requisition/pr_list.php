...
$target_url = '../pr_requisition/mr_print_view.php';
...
<div class="form-container_large">
 ...
 where  a.warehouse_id=b.warehouse_id and a.requisition_type=3  and  a.status in ("CHECKED","COMPLETED") and a.entry_by=c.user_id '.$con.$con2.'  order by a.req_no desc';
