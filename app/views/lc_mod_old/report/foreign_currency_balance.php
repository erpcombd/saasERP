                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
																				...
																				<?php /*?>	 <? if($_SESSION['user']['id']==10002) {?>  <? }?><?php */?>
																					 <tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="220307005" checked="checked" /></td>

																							<td><div align="left">Foreign Currency Balance</div></td>
																					 </tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				  ...
				  <tr>
					...
					<select name="ledger_id" id="ledger_id">
                      ...
                      <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$item_id, "ledger_group_id=1010");?>
