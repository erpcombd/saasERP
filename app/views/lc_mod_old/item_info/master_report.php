...
<thead>
<tr><td style="border:0px; text-align:center;" colspan="12"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?= $_SESSION['user']['group']?>.png" width="100" /></td></tr>
...
<th colspan="2" bgcolor="#00A59A"><div align="center">Product Pricing In Carton</div></th>
<th rowspan="2" bgcolor="#FF0000">Status</th>
<th rowspan="2" bgcolor="#FF0000">Submit</th>
</tr>
<tr>
  <th bgcolor="#00A59A">Buy Price</th>
  <th bgcolor="#00A59A">Sale Price </th>
  </tr>
</thead>
...
<tr><td><?=$s?></td>
  ...
  <input name="pack_size#<?=$datas[2]?>" type="text" id="pack_size#<?=$datas[2]?>" value="<?=$datas[6]?>"  style="width:60px;" />  </td>
  <td><input name="cost_crt_price#<?=$datas[2]?>" type="text" id="cost_crt_price#<?=$datas[2]?>" value="<?=$datas[11]?>"  style="width:80px;" placeholder="Cost Price" /></td>
  <td><input name="sale_crt_price#<?=$datas[2]?>" type="text" id="sale_crt_price#<?=$datas[2]?>" value="<?=$datas[12]?>"  style="width:80px;" placeholder="Sale Price"/></td>
  <td>
