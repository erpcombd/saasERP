...
<form action="commission_master_report.php" method="post" name="form1" target="_blank" id="form1">
                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
																					...
																					<!-- <tr>
																					 ...
																					 <tr>
																							...
																							<td><div align="left">MONTH BY MONTH PRODUCT VALUE WISE SALES REPORT</div></td>
																					 </tr>
																					 ...
																					 <tr>
																							...
																							<td><div align="left">MONTH BY MONTH PRODUCT QTY WISE SALES REPORT</div></td>
																					 </tr>
																					 ...
																					 <tr>
																					  ...
																					  <tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="20060202" checked="checked" /></td>
																					 ...
																					 <tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="2006020211" /></td>

																							<td><div align="left">YEARLY SALES COMMISSION REPORT</div></td>
																					 </tr>
...
document.getElementById('item_group').value);">
                 ...
                 <!-- <tr>
				  ...
				  <tr>
                    ...
                    <td><span id="zone"><select name="commission_year" id="commission_year" required >

                      <option></option>

                      <? foreign_relation('commission_year','id','commission_year',$commission_year,' 1 order by id');?>
				  ...
				  <tr>
                    ...
                    <td><select name="item_type" id="item_type"  >
                      ...
                      <? foreign_relation('item_type','id','item_type',$id,' 1 order by item_type');?>
                  ...
                  <tr>
                    ...
                    <td><span id="zone"><select name="zone_id" id="zone_id"  >
