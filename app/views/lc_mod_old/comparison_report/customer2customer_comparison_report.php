...
auto_complete_from_db('dealer_info','concat(dealer_name_e)','dealer_code','1','dealer_search');
                              ...
                              <tr>
                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
																			...
																			<tr>
							  													 ...
							  													 <td><input name="report" type="radio" class="radio" value="220202001"  checked="checked"/></td>
...
document.getElementById('item_sub_group').value);">
				...
				<tr>
                    ...
                    <input  name="dealer_code" type="text" id="dealer_code" required />
