...
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_1');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_2');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_3');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_4');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_5');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_6');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_7');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_8');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_9');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_10');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_11');
auto_complete_from_db('zon','concat(ZONE_CODE,"-",ZONE_NAME)','concat(ZONE_CODE,"-",ZONE_NAME)','1','zone_id_12');
...
<form action="master_report.php" method="post" name="form1" target="_blank" id="form1">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td><div class="box4" style="width:95%;">
...
document.getElementById('item_sub_group').value);">
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_1" type="text" id="zone_id_1" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_2" type="text" id="zone_id_2" />
				   ...
				   <tr>
                    ...
                    <input  name="zone_id_3" type="text" id="zone_id_3" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_4" type="text" id="zone_id_4" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_5" type="text" id="zone_id_5" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_6" type="text" id="zone_id_6" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_7" type="text" id="zone_id_7" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_8" type="text" id="zone_id_8" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_9" type="text" id="zone_id_9" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_10" type="text" id="zone_id_10" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_11" type="text" id="zone_id_11" />
				  ...
				  <tr>
                    ...
                    <input  name="zone_id_12" type="text" id="zone_id_12" />
