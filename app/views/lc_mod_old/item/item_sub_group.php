...
$con .= ' and b.group_id = "'.$_POST['item_group'].'" ';
	  ...
	  $rrr = "select b.sub_group_id,b.sub_group_id,a.group_name, b.sub_group_name from item_sub_group b,item_group a where a.group_id=b.group_id ".$con."  order by a.status";
    ...
    <td valign="top" width="40%"><div class="right"> <form id="form1" name="form1" method="post" action="" onsubmit="return check()">
                        ...
                        <input name="ledger_id" type="text" id="ledger_id" value="<?php echo $ledger_id;?>" style="width:250px" maxlength="100" class="required" />
