...
$target_url = '../po_bill/po_bill_update.php';
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
        <tr>
          ...
          <td width="538" colspan="3" bgcolor="#FF9966">
	...
	<select name="purchase_manager" id="purchase_manager" style="width:250px;">
        ...
        <? foreign_relation('purchase_manager','id','purchase_manager',$_POST['purchase_manager'],'1 order by id'); ?>
          ...
          <td width="342" rowspan="5" bgcolor="#FF9966"><strong>
      ...
      <tr>
        ...
        <? foreign_relation('po_bill_master','bill_id','bill_no',$_POST['bill_no'],'1 order by bill_no'); ?>
    </select>		</td>
      </tr>
      <tr>
...
if($_POST['fdate']!=''&&$_POST['tdate']!='') $con .= ' and bill_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';


if($_POST['bill_no']!='') 
$con .= ' and bill_id in ('.$_POST['bill_no'].') ';

if($_POST['purchase_manager']!='') 
$con .= ' and purchase_manager in ('.$_POST['purchase_manager'].') ';


   $res="select * from po_bill_master where status!='COMPLETED'  ".$con."  order by bill_no";
