...
$target_url = '../po_bill/po_bill_approval.php';
...
$con .= ' and a.purchase_manager in ('.$_POST['purchase_manager'].') ';
     ...
     $res="select a.* from po_bill_master a, po_bill_details b where a.bill_id=b.bill_id and a.status='CHECKED'  ".$con."  group by a.bill_id order by a.bill_date,a.bill_id";
