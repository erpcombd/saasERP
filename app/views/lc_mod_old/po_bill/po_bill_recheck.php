...
<? //if($po_no[$data->po_no]==0) { } ?>
  ...
  <tr bgcolor="<?=($i%2)?'#E8F3FF':'#fff';?>">
	...
	<input type="button" name="Button" value="Remove"  onclick="update_value(<?=$data->po_no?>)" style="width:70px; font-size:12px; height:30px;background-color: #FF6347; font-weight:700;"/>
