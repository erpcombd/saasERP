...
$title='Vendor Agent';			// Page Name and Page Title

do_datatable('table_head');

$page="agent_info.php";		// PHP File Name



$table='agent_info';		// Database Table Name Mainly related to this page

$unique='agent_id';			// Primary Key of this Database table

$shown='agent_name';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Agent Name </span></th>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.contact_no, a.address from '.$table.' a where 1 order by a.agent_id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Agent Name  :</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="agent_id" type="hidden" id="agent_id" tabindex="1" value="<?=$agent_id?>" readonly>
                        				<input name="agent_name" required type="text" id="agent_name" tabindex="1"  style="width:250px;" value="<?=$agent_name?>"  >	
                                     ...
                                     <td>Contact No:</td>
                        				...
                        				<input name="contact_no"  type="text" id="contact_no" tabindex="2"  style="width:250px;" value="<?=$contact_no?>"  >	
                                     ...
                                     <td>Email:</td>
                        				...
                        				<input name="email"  type="text" id="email" tabindex="3"  style="width:250px;" value="<?=$email?>"  >	
                                     ...
                                     <td>Address:</td>
                        				...
                        				<input name="address"  type="text" id="address" tabindex="4"  style="width:250px;" value="<?=$address?>"  >	
