...
$title=' Country Of Origin Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="country_of_origin.php";		// PHP File Name



$table='origin_type';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='country_name';				// For a New or Edit Data a must have data field
  ...
  <tr>
    ...
    <td valign="top" width="60%">
        ...
        <div class="left">
          ...
          <!--                              <td width="40%" align="left"> Company: </td>-->
          ...
          <!--                              <td width="60%" align="right">-->
                                     ...
                                     <!--</tr>-->
                                      ...
                                      <!--    <input class="btn btn-danger" name="cancel" type="submit" id="cancel" value="Cancel" />-->
                                      <!--  </div></td>-->
...
<thead>
<tr>
  <th bgcolor="#20975E"><span class="style3">ID</span></th>

<th bgcolor="#20975E"><span class="style3">Country Of Origin </span></th>
<th bgcolor="#20975E"><span class="style3">Description </span></th>
</tr>
</thead>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.'.$Desc.' from '.$table.' a where 1 order by  a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box style2" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                      ...
                                      <tr>
                                        ...
                                        <th style="font-size:16px; padding:5px; color:#FFFFFF" bgcolor="#20975E"> <div align="center">
                                          <?=$title?>
                                        </div></th>
                                      </tr></table>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Country Of Origin:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="country_name" required type="text" id="country_name" tabindex="1"  style="width:250px;" value="<?=$country_name?>"  >	
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Description:</td>
										...
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="description" required type="text" id="description" tabindex="1"  style="width:250px;" value="<?=$description?>"  >	
