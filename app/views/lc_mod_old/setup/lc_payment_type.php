...
$title='L/C Payment Type';			// Page Name and Page Title

do_datatable('table_head');

$page="lc_payment_type.php";		// PHP File Name



$table='lc_bill_type';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Payment Type </span></th>
</tr>
</thead>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Category:</td>
                        				...
                        				<input name="bill_type" required type="text" id="bill_type" tabindex="1"  style="width:250px;" value="<?=$bill_type?>"  >	
