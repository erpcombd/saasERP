...
$custome_codes = find_a_field('transport_company','max(sub_ledger_id)','1');
if($custome_codes>0){
	$custome_code = $custome_codes+1;
	}
	else{
	$custome_code = 14000001;
	}
...
createSubLedger($custome_code,$_POST['company_name'],'Transport_Company',$_POST[$unique],$_POST['account_code'] ,0);
}
$crud->insert();
//
