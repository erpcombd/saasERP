...
$title=' Port Of Destination Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="port_of_destination.php";		// PHP File Name



$table='port_of_destination';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='destination_type';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Port Of Destination Setup </span></th>
<th bgcolor="#45777B"><span class="style3">Description </span></th>
</tr>
</thead>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Port Of Destination Setup:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="destination_type" required type="text" id="destination_type" tabindex="1"  style="width:250px;" value="<?=$destination_type?>"  >	
