...
$title='L/C Payment Category';			// Page Name and Page Title

do_datatable('table_head');

$page="lc_payment_category.php";		// PHP File Name



$table='lc_bill_category';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='bill_category';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Payment Category </span></th>
<th bgcolor="#45777B"><span class="style3">Acc Ledger</span></th>
<th bgcolor="#45777B"><span class="style3">Type</span></th>
</tr>
</thead>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.bill_type,a.ledger_id from '.$table.' a where 1 order by a.bill_type, a.id  ';
...
<td><?=$rp[1];?></td>
<td><?=find_a_field('accounts_ledger','ledger_name','ledger_id='.$rp[3]); ?></td>

<td><?=find_a_field('lc_bill_type','bill_type','id='.$rp[2]); ?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Category:</td>
                        				...
                        				<input name="bill_category" required type="text" id="bill_category" tabindex="1"  style="width:250px;" value="<?=$bill_category?>"  >	
                                     ...
                                     <td>Type:</td>
                        				...
                        				<select name="bill_type" id="bill_type" style="width:250px;" required>
											  <option></option>
											  <?
										
										foreign_relation('lc_bill_type','id','bill_type',$bill_type,'1');
                                     ...
                                     <td>A/C Ledger:</td>
                        				...
                        				<select id="ledger_id" name="ledger_id" style="width:250px;" >
											  <option></option>
											  <?
