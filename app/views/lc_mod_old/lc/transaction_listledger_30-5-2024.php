									...
									<table width="100%" border="0" cellspacing="2" cellpadding="2">
                                      <tr>
                                        ...
                                        <td  align="left"><input name="fdate"  type="text" id="fdate" size="12" class="form-control" style="max-width:250px;" value="<?php echo $_REQUEST['fdate'];?>" /> </td>
                                            ...
                                            <td align="left"><input name="tdate" type="text" id="tdate" size="12" class="form-control" style="max-width:250px;" 
                                      ...
                                      <tr>
                                        ...
                                        <td width="50%" align="left">&nbsp;&nbsp;&nbsp;<? if($_REQUEST['ledger_id']>0) { ?> Status View:
										<? $lc_preview_no=find_a_field('lc_number_setup','id','ledger_id="'.$_REQUEST['ledger_id'].'"'); ?>
										 &nbsp;<a href="lc_costing_print_view.php?lc_no=<?=$lc_preview_no;?>" target="_blank" style=" color:#000000; text-decoration:none; font-size:12px; padding: 2px 5px;
	 background:  #99CCFF; font-weight:700; margin: 3px 3px; border:1px solid #000000; hover: none; ">Click Me</a> <? }?></td>
                                      </tr>
						  ...
						  <option value="">Select Type</option>
							  ...
							  <tr>
								...
								<th width="25%" align="center">Acc Name</th>
								<th width="27%" align="center">Particulars</th>
...
if(isset($_REQUEST['show']))
{
	...
	$d_where = ' and d.account_code=b.ledger_id and d.dealer_type="'.$dealer_type.'" ';
		...
		echo $p="select a.jv_date,b.ledger_name,a.dr_amt,a.cr_amt,a.tr_from,a.narration,a.jv_no,a.tr_no,a.jv_no,a.cheq_no,a.cheq_date,a.relavent_cash_head , a.cc_code
  ...
  <tr <?=($xx%2==0)?' bgcolor="#EDEDF4"':'';$xx++;?>>
	...
	if($data[4]=='Receipt'||$data[4]=='Journal'||$data[4]=='Contra')
	{
		...
		$link="../../../acc_mod/pages/files/general_voucher_print_view_from_journal.php?jv_no=".$data[8];
