...
$target_url = '../lc/lc_costsheet_print_view.php';
...
$con .= ' and id in ('.$_POST['lc_no'].') ';
   ...
   $res="select * from lc_number_setup where 1 ".$con."  order by id";
