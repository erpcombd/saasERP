...
$dr_ledger=$ledger_id;
      ...
      $ins_invoice = 'INSERT INTO lc_bill_payment (payment_no, payment_date, lc_no, lc_number, lc_ledger, bank_pay_id, lc_part_no, group_for, bill_type, bill_category, category_view, cr_ledger_id, pay_amt_in, pay_amt_out, remarks, note, r_no, r_date, status, entry_by, entry_at, boe_no, boe_date,sub_ledger_id,dr_sub_ledger_id,exchange_rate,loan_ledger)
...
$redirect = "lc_all_payment.php"; // page you want current tab to go
