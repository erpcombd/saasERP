					...
					<? if ($_POST['bill_type']==1) {?>
								 ...
								 <td>&nbsp;</td>
									...
									<select name="cr_sub_ledger_id" id="cr_sub_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('insurance_company','ledger_id','company_name',$_POST['cr_sub_ledger_id'],'1');?>
									</select>
	...
	<select name="payment_method" id="payment_method" required style="width:220px;" onchange="getData2('cash_bank_ajax.php', 'cash_bank_filter', this.value,  document.getElementById('payment_method').value);">
						...
						<tr>
								 ...
								 <td>SHIPMENT NO</td>
									...
									<select name="cr_sub_ledger_id" id="cr_sub_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('transport_company','ledger_id','company_name',$_POST['cr_sub_ledger_id'],'1');?>
						...
						<tr>
								...
								<!--	
									...
									<select name="cr_sub_ledger_id" id="cr_sub_ledger_id" required="required" style="width:220px;">
									  <option></option>
									  <? foreign_relation('cnf_company','ledger_id','company_name',$_POST['cr_sub_ledger_id'],'1');?>
									</select>
						...
						<tr>
								 ...
								 <td>SHIPMENT NO</td>
								  ...
								  <tr>
								  <td>Exchange Rate</td>
								  <td><input name="exchange_rate" type="text" id="exchange_rate"  style="width:220px; height:32px;" value=""   tabindex="105" /></td>
								  </tr>
