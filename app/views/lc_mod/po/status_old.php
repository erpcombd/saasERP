...
<table width="900" border="0" cellspacing="0" cellpadding="0" align="center">
 ...
 <td class="Qrl_code" style="text-align:right">
<?php 
    ...
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign"   border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <tr>
          ...
          <th  align="center" bgcolor="#CCCCCC">Rate(<?php echo $currency_name[$data->currency];?>)</th>
		  <th  align="center" bgcolor="#CCCCCC">Amount(<?php echo $currency_name[$data->currency];?>) </th>
