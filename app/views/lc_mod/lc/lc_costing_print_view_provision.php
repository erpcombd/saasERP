...
$lc_no = $_REQUEST['lc_no']=$_GET['lc_no'];
...
<?php 
	...
	$req_no_qr_data = urlencode(base64_encode($req_no));

    $print_url = "https://erp.jamunapaper.com/2025/app/views/warehouse_mod/mr/mr_print_view_qr.php?c=7oKXlrqDK1N%2FpLMXEJWzTQ%3D%3D&v=" . $req_no_qr_data;
 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  	<td colspan="2">
        ...
        <tr>
          <td colspan="4" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>L/C Payment Details </strong></td>
          </tr>
...
$jv_no[$data->tr_no]=$data->jv_no;
      ...
      <!--    <td align="right" valign="top"><?=number_format($datac->pay_amt_out,2); $tot_pay_amt_out +=$datac->pay_amt_out; ?></td>-->
        ...
        <? }?>
        <tr style="font-size:12px;">
        <td colspan="2" align="right" valign="middle"><strong> Sub Total: <? $grn_value_usd; ?> </strong></td>
     ...
     <!--   <td align="right" valign="middle"><strong><?=number_format($tot_pay_amt_out,2) ;?></strong></td>-->
        ...
        <tr style="font-size:12px;">
          <td colspan="2" align="right" valign="right"><strong>Total Expenses:</strong></td>
	 ...
	 $tot_carrying_charge[$row->lc_no]=$row->tot_carry_charge;  
	  ...
	  $tot_exp_without_carry_and_partial=$total_exp_bdt-($tot_carrying_charge[$lc_no]+$gr_tot_item_pay_amt);
  ...
  <tr>
  	<td colspan="2">
        ...
        <tr>
          <td colspan="5" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>L/C Goods Recive Details </strong></td>
          </tr>
        <tr>
...
<?  		
		  //$sqlr = 'SELECT b.item_name, b.unit_name, a.po_date, a.warehouse_id, a.qty from lc_purchase_invoice a, item_info  b
		// where a.item_id=b.item_id and a.lc_no="'.$lc_no.'" group by a.id order by a.rec_date,b.item_name ';
		 $sqlr='SELECT b.item_name, b.unit_name, a.po_date, a.qty,m.lc_no from lc_purchase_invoice a,lc_purchase_master m, item_info b where m.po_no=a.po_no and a.item_id=b.item_id and m.lc_no="'.$lc_no.'" group by a.id order by a.po_date,b.item_name';
...
$gr_invoice_qty_get_invoice+=$data->invoice_qty;
			...
			while($datac = mysqli_fetch_object($queryc)){
			 ...
			 $amount_without_carry_and_duty_get=(($tot_exp_without_carry_and_partial*$value_based_percentage_get)/100);
			  ...
			  $cost_rate=$final_cost_of_item/$datac->qty;
        ...
        <tr style="font-size:12px;">
          ...
          <td align="right" valign="top"><?=$cost_price_bdt = $cost_rate;?></td>
          <td align="right" valign="top"><?=number_format($cost_amt_bdt=$cost_price_bdt*$datac->qty,2);  $tot_cost_amt_bdt +=$cost_amt_bdt;?></td>
        </tr>
