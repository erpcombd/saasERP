...
$grn_value_usd = find_a_field('lc_purchase_invoice','sum(amount_usd)','po_no='.$po_data->po_no);



$bill_type_sql = "select * from lc_bill_type order by ordering";
$bill_type_query = db_query($bill_type_sql);
$p=0;
while($data = mysqli_fetch_object($bill_type_query)){
$p++;
$bill_type[$p] = $data->bill_type;
$bill_type_id[$p] = $data->id;
}
 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="96%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        <tr>
		          <td align="left" valign="middle"><strong>Ref  No. </strong></td>
			...
			<tr>
                ...
                <td width="51%" align="right" valign="middle"><strong> PO No: </strong></td>
			  ...
			  <tr>
                ...
                <td width="51%" align="right" valign="middle"><strong>PO Date:</strong></td>


			    <td width="49%"><table width="100%" border="1" cellspacing="0" cellpadding="1">
                  <tr height="20">
                    <td>
                      &nbsp;<?=date("d M, Y",strtotime($po_data->po_date))?>                    </td>
                  </tr>
                </table></td> </tr>
  ...
  <tr>
  	<td colspan="2">
        ...
        <tr>
          <td colspan="<?=3*$p?>" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>L/C Payment Details </strong></td>
          </tr>
        <tr>
          <td rowspan="2" width="4%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>SL</strong></td>
          <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item </strong></td>
		  <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Unit </strong></td>
		  
		  <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Qty </strong></td>
		  
		  
		  <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Rate </strong></td>
          <td  colspan= "<?=$p?>" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong> Payment Type </strong></td>
		   <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Cost Price </strong></td>

          <td  rowspan="2" width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Total </strong></td>
		...
		<tr>
			...
			for($i=1;$i<=$p;$i++){ ?>	
				...
				<td align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong><?=$bill_type[$i];?></strong></td>
			<? } ?>
		</tr>
...
<?  
  ...
  $sql = 'SELECT sum(a.pay_amt_in) as pay_amt_in, sum(a.pay_amt_out) as pay_amt_out,  a.order_no , a.payment_no, a.payment_date, b.bill_type, b.id as bill_type_id from lc_provision_payment a, lc_bill_type b, lc_bill_category c 
		 where b.id=c.bill_type and a.bill_category=c.id  and a.lc_no="'.$lc_no.'" group by a.payment_no,a.order_no';
$query = db_query($sql);
while($data=mysqli_fetch_object($query)){
$provision[$data->bill_type_id][$data->order_no]=$data->pay_amt_in;
}
		
		
			  $sqlc = 'SELECT d.*,i.item_name from lc_purchase_master m,lc_purchase_invoice d,item_info i   where m.po_no=d.po_no and d.item_id=i.item_id and  m.lc_no ='.$lc_no.'';
        ...
        <tr style="font-size:12px;">
		  ...
		  <td align="left" valign="top">
		  <?=number_format($datac->qty,2)?></td>
		  
		  <td align="left" valign="top">
		  <?=number_format($datac->rate_bdt,2)?></td>
		  
          <? for($j=1;$j<=$p;$j++) { ?>
          <td align="right" valign="top"><?=number_format($provision[$bill_type_id[$j]][$datac->id],2); $tot_pay_amt_in[$bill_type_id[$j]] +=$provision[$bill_type_id[$j]][$datac->id];  $tot_pay_amt_order[$datac->id] +=$provision[$bill_type_id[$j]][$datac->id] ;  ?></td>
		  <? } ?>
		  
		  <td align="right" valign="top"><strong><?=number_format(($tot_pay_amt_order[$datac->id]/$datac->qty),2)?></strong></td>

		  <td align="right" valign="top"><strong><?=number_format($tot_pay_amt_order[$datac->id],2)?></strong></td>
		...
		<? for($k=1;$k<=$p;$k++) { ?>
        <td align="right" valign="middle"><strong><?=number_format($tot_pay_amt_in[$bill_type_id[$k]],2);  $total_exp_bdt +=$tot_pay_amt_in[$bill_type_id[$k]];?></strong></td>
		 <? } ?>
		 <td>&nbsp;</td>
		 <td>&nbsp;</td>
        </tr>
        <tr style="font-size:12px;">
          <td colspan="<?=$p+6?>" align="right" valign="middle"><strong>Total Expenses:</strong></td>
          <td  align="center" valign="middle">
		  <strong><?=number_format($total_exp_bdt,2);?></strong></td>
          </tr>
  ...
  <?php /*?><tr>
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <tr>
          <td width="7%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>SL</strong></td>
          <td width="29%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item Name </strong></td>
          <td width="8%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Unit  </strong></td>
          <td colspan="5" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PI Details </strong></td>
          
          <td width="12%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong> Pre Costing Price </strong></td>
          <td width="15%" rowspan="2" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Value (BDT) </strong></td>
        </tr>
        <tr>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Qty</strong></td>
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Rate($)</strong></td>
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Amount($)</strong></td>
		  
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Rate(BDT)</strong></td>
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Amount(BDT)</strong></td>
...
$grn_amount_usd[$data->order_no]=$data->grn_amount_usd;
			  ...
			  $sqlc = 'select d.*, sum(pay_amt_in) as amt ,i.item_name from lc_purchase_master m, lc_purchase_invoice d,item_info i,lc_provision_payment p where m.po_no=d.po_no and p.order_no=d.id and i.item_id=d.item_id and m.lc_no='.$lc_no.'
        ...
        <tr style="font-size:12px;">
          ...
          <td align="right" valign="top"><?=number_format($datac->rate_bdt,2);?></td>
          <td align="right" valign="top"><?=number_format($datac->amount_bdt,2);  $tot_amount_bdt +=$datac->amount_bdt;?></td>
          
          <td align="right" valign="top"><?=number_format($cost_price_bdt=$datac->amt/$datac->qty,2);?></td>
          <td align="right" valign="top">
		  <?=$datac->amt;
		  //number_format($cost_amt_bdt=$cost_price_bdt*$grn_qty[$datac->id],2);  $tot_cost_amt_bdt +=$cost_amt_bdt;?>
		...
		<td align="right" valign="middle">&nbsp;</td>
		<td align="right" valign="middle"><b><?=number_format($tot_amount_bdt,2) ;?></b></td>
        <td align="right" valign="middle">&nbsp;</td>
        <td align="right" valign="middle"><strong>
          <?=number_format($total_exp_bdt,2) ;?>
        </strong></td>
        </tr>
      </table>      </td>
  </tr><?php */?>
