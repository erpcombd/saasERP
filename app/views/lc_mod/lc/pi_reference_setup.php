...
$title='PI Reference No';			// Page Name and Page Title

do_datatable('table_head');

$page="pi_reference_setup.php";		// PHP File Name
...
<th bgcolor="#45777B"><span class="style3"> PI Number </span></th>
</tr>
</thead>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
  ...
  $td='select a.'.$unique.',  a.'.$shown.' from '.$table.' a where 1 order by a.id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>PI Number:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="pi_number" required type="text" id="pi_number" tabindex="1"  style="width:250px;" value="<?=$pi_number?>"  >	
