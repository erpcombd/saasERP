...
$target_url = '../lc/lc_costing_print_view_provision.php';
...
div.form-container_large input {
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      <tr>
        <td width="336" align="right" bgcolor="#FF9966"><strong>L/C NO:</strong></td>
        <td width="498" colspan="3" bgcolor="#FF9966">
		<select name="lc_no" id="lc_no" style="width:250px;">
		
		<option></option>
<? foreign_relation('lc_number_setup','id','lc_number',$_POST['lc_no'],'1');?>
    </select>		</td>
        <td width="342" rowspan="4" bgcolor="#FF9966"><strong>
