 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
  	<td colspan="2">
        ...
        <?  $sqlc = 'SELECT sum(a.pay_amt_in-a.pay_amt_out) as pay_amt_in, a.payment_date, c.bill_category from lc_bill_payment a, lc_bill_category c
        ...
        <td align="right" valign="middle"><strong><?=number_format($total_exp_bdt = $tot_pay_amt_in,2) ;?> <? $exchange_rate_bdt = $total_exp_bdt/$grn_value_usd;?></strong></td>
        </tr>
...
$grn_amount_usd[$data->order_no]=$data->grn_amount_usd;
        ...
        <tr style="font-size:12px;">
          ...
          <td align="right" valign="top"><?=$cost_amt_bdt=$cost_price_bdt*$grn_qty[$datac->id];  $tot_cost_amt_bdt +=$cost_amt_bdt;?></td>
        </tr>
