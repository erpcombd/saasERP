...
createSubLedger($custome_code,$_POST['ledger_name'],'LC',$lc_no_ins_id,$_POST['account_code'] ,'');
  ...
  VALUES("'.$tr_no.'", "'.$lc_issue_date.'",  "'.$pi_reference.'", "'.$lc_no_ins_id.'", "'.$_POST['ledger_name'].'", "'.$po_no.'", "'.$group_for.'", "'.$bank_lc_no.'", "'.$pi_no.'", "'.$lc_expiry_date.'", "'.$tolerance.'", "'.$insurance_cover_note_no.'", "'.$shipment_date.'", "'.$shipment_expiry_date.'", "'.$lc_af_no.'", "'.$bank_name.'", "'.$lc_type.'", "'.$lc_value.'","'.$ud_amount.'", "'.$mode_of_transport.'", "'.$cover_note_date.'", "'.$ammendment_date.'", "'.$remarks.'", "CHECKED", "'.$entry_at.'", "'.$entry_by.'","'.$tenor_days.'")';
