...
//}
		...
		$link = "lc_costing_print_view.php?lc_no=".$lc_no;
$redirect = "select_upcoming_shipment.php"; // page you want current tab to go
    ...
    <tr>
      ...
      <tbody>
          ...
          <tr>
            ...
            <th bgcolor="#FF99FF"><strong>Rate(<?php echo $currency_name[$ms_data->currency];?>)</strong></th>
            <th bgcolor="#FF99FF"><strong>Amount(<?php echo $currency_name[$ms_data->currency];?>) </strong></th>
