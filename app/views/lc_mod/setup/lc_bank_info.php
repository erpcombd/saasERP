...
$title='LC Bank Info';			// Page Name and Page Title

do_datatable('table_head');

$page="lc_bank_info.php";		// PHP File Name



$table='bank_info';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Branch Name </span></th>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.branch_name, a.ledger_id from '.$table.' a where 1 order by a.bank_id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Bank Name:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="bank_id" type="hidden" id="bank_id" tabindex="1" value="<?=$bank_id?>" readonly>
                        				<input name="bank_name" required type="text" id="bank_name" tabindex="1"  style="width:250px;" value="<?=$bank_name?>"  >	
                                     ...
                                     <td>Branch Name:</td>
                        				...
                        				<input name="branch_name"  type="text" id="branch_name" tabindex="2"  style="width:250px;" value="<?=$branch_name?>"  >	
                                     ...
                                     <td>Ledger ID:</td>
                        				...
                        				<input name="ledger_id"  type="text" id="ledger_id" tabindex="3"  style="width:250px;" value="<?=$ledger_id?>" required  >	
