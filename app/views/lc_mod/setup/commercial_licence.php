...
$title='Commercial Licence';			// Page Name and Page Title

do_datatable('table_head');

$page="commercial_licence.php";		// PHP File Name



$table='commercial_licence_info';		// Database Table Name Mainly related to this page
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.contact_no, a.contact_person_name from '.$table.' a where 1 order by a.company_id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Contact Person:</td>
                        				...
                        				<input name="contact_person_name"  type="text" id="contact_person_name" tabindex="2"  style="width:250px;" value="<?=$contact_person_name?>"  >	
