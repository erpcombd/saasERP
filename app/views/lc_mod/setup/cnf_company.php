...
$title='C & F Agent Info';			// Page Name and Page Title

do_datatable('table_head');

$page="cnf_company.php";		// PHP File Name



$table='cnf_company';		// Database Table Name Mainly related to this page
...
//$custome_codes = find_a_field('cnf_company','max(sub_ledger_id)','1');
//if($custome_codes>0){
//	$custome_code = $custome_codes+1;
//	}
//	else{
//	$custome_code = 11000001;
//	}
...
createSubLedger($custome_code,$_POST['company_name'],'CNF_Company',$_POST[$unique],$_POST['account_code'] ,0);
}
...
if ($ledger_gl_found==0) {
  ...
  VALUES("'.$_POST['ledger_sl'].'", "'.$_POST['ledger_name'].'", "'.$_POST['ledger_group_id'].'", "Both", "'.$proj_id.'",  "'.$gl_group->acc_class.'", 
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>GL Configuration:</td>
										...
										<? if ($ledger_id==0) {?>
											<select name="ledger_group" required="required" id="ledger_group" style="width:250px; font-size:12px;" tabindex="9">
											  ...
											  <option></option>
											   <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'group_id=123005'); //acc_sub_class=203?>
											  <? //foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,'ledger_id="'.$config_all->cnf_agent_lg.'" and group_for="'.$_SESSION['user']['group'].'"');?>
