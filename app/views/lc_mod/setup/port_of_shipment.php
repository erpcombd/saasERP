...
$title=' Port Of Shipment Setup';			// Page Name and Page Title

do_datatable('table_head');

$page="port_of_shipment.php";		// PHP File Name



$table='port_of_shipment';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='port_name';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Port Of Shipment </span></th>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Port Of Shipment:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="port_name" required type="text" id="port_name" tabindex="1"  style="width:250px;" value="<?=$port_name?>"  >	
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Description:</td>
										...
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="description"   type="text" id="description" tabindex="1"  style="width:250px;" value="<?=$description?>"  >	
