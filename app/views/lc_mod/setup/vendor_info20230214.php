...
create_combobox('country');
// ::::: Edit This Section ::::: 



$title='Foreign Vendor Information';			// Page Name and Page Title
...
$table='vendor_foreign';		// Database Table Name Mainly related to this page
                                ...
                                <tr>
								  ...
								  <table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<td width="10%"><select name="country" required id="country" style="width:95%; font-size:12px;" tabindex="3">
											
											<option></option>
									
                    					  <? foreign_relation('country','country_name','country_name',$country,'1');?>
                    					</select></td>
										</tr>
										...
										<tr>
											...
											<select name="country" required id="country" style="width:95%; font-size:12px;" tabindex="3">
...
<th bgcolor="#45777B"><span class="style3">Country</span></th>
</tr>
</thead>
...
$con .= 'and a.depot="'.$_POST['depot'].'"';
    ...
    $td='select a.'.$unique.',  a.'.$shown.' as vendor_name,   a.country, a.ledger_id from '.$table.' a
				where 1 '.$con.' order by a.vendor_id ';
