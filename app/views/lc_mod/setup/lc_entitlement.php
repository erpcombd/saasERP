...
do_calander('#entitlement_date');

$title='L/C Entitlement';			// Page Name and Page Title

do_datatable('table_head');

$page="lc_entitlement.php";		// PHP File Name



$table='lc_entitlement';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='entitlement_value';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Item Name</span></th>
  <th bgcolor="#45777B"><span class="style3">Entitlement Value </span></th>
<th bgcolor="#45777B"><span class="style3">Entitlement Date </span></th>
</tr>
</thead>
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.entitlement_date, a.item_id from '.$table.' a where 1 order by  a.id  ';
...
<tr<?=$cls?> onclick="DoNav('<?php echo $rp[0];?>');">
  ...
  <td><?=find_a_field('item_info','item_name','item_id="'.$rp[3].'"')?></td>
  <td><?=$rp[1];?></td>
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
									...
									<tr>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Item Name:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<select name="item_id" id="item_id" style="width:220px;" required>
										  <option></option>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Entitlement Value:</td>

                                        <td>
										
                        				<input name="entitlement_value" required type="text" id="entitlement_value" tabindex="1"  style="width:220px;" value="<?=$entitlement_value?>"  >	
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Entitlement Date:</td>

                                        <td>
										
                        				<input name="entitlement_date" required type="text" id="entitlement_date" tabindex="2"  style="width:220px;" value="<?=$entitlement_date?>"  >	
