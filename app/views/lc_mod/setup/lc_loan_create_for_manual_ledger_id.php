...
//
//$_POST['ledger_name'] = $_POST['lc_number'];

$name = $_POST['ltr_number'];


$under=$_POST['under_ledger'];
...
//$con .='and a.category_name like "%'.$_POST['category_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', b.bank_group from '.$table.' a, bank_group b where a.bank_group=b.id order by b.bank_group, a.id  ';
									...
									<?php /*?>  <tr>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>GL Configuration:</td>
									  ...
									  <tr>
										...
										<select name="bank_group" required id="bank_group" style="width:200px;"  tabindex="3">
									   ...
									   <tr>
										...
										<input name="ledger_id" type="text" id="ledger_id" tabindex="2" value="<?=$ledger_id?>"   style="width:250px; font-size:12px;" /></td>
                                      </tr>
