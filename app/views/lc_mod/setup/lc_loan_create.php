...
<? //}?>
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>GL Configuration:</td>
									  ...
									  <tr>
									   ...
									   <tr>
										...
										//echo 'select * from accounts_ledger where ledger_id="'.$config_all->lc_loan_lg.'"';
										if ($ledger_id==0) {
						...
						<? foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,'ledger_group_id="'.$config_all->lc_loan_lg.'"  ');?>
                                            </select>
											<? }?>
                                     ...
                                     <td>Reference No:</td>
									  ...
									  <tr>
										...
										<option></option>
										  ...
										  <? foreign_relation('user_group','id','group_name',$group_for,'id not in (7,8)');?>
										</select></td>
                                      </tr>
                        ...
                        <tr>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Currency Type:</td>
         ...
         <? foreign_relation('currency_type','id','currency_type',$currency, '1 limit 100 offset 1');?>
				 ...
				 <tr>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Loan Value(Foreign Currency):</td>
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Loan Paid(Foreign Currency):</td>
