								  ...
								  <table width="100%" border="0" cellspacing="0" cellpadding="0">
										...
										<tr>
											...
											<select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
											  ...
											  <option></option>
                                              <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_class=3'); //acc_sub_class=203?>
                                            </select>
											<? }?>
...
$con .= 'and a.depot="'.$_POST['depot'].'"';
  ...
  $td='select a.'.$unique.',  a.'.$shown.' as vendor_name,   a.address, a.ledger_id from '.$table.' a
