	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
	    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="1%">
			<img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$jv->group_for?>.png" style="width:150px;" />		</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#00CC00">
  <tr>
	...
	<? if($jv->note=='Cash Purchase Bill'){?>
	<a target="_blank" class="jvbutton" href="../../../spare_parts_inventory/pages/po_bill/po_bill_print_view.php?bill_id=<?=$jv->tr_id;?>">PO Bill  </a>	
	
	<a target="_blank" class="jvbutton" href="../../../spare_parts_inventory/pages/po_bill/po_bill_top_shit_print_view.php?bill_id=<?=$jv->tr_id;?>">Top Sheet </a>	
	<? }?>
	</td>
  ...
  <tr>
    <td><table width="100%" border="0" cellpadding="0" cellspacing="0" bordercolor="#000000" class="tabledesign">
      <tr>
        ...
        <td align="center" bgcolor="#82D8CF"><strong>Control Head</strong></td>
        <td align="center" bgcolor="#82D8CF"><strong>A/C Ledger Head</strong></td>
        <td align="center" bgcolor="#82D8CF"><strong>Particulars</strong></td>
        <td bgcolor="#82D8CF"><strong>Debit</strong></td>
        <td bgcolor="#82D8CF"><strong>Credit</strong></td>
      </tr>
      
	  <?
 $sql2="SELECT a.ledger_id,a.ledger_name,sum(dr_amt) as dr_amt, a.ledger_group_id, b.narration FROM accounts_ledger a, journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and jv_no=$jv_no and dr_amt>0 group by b.id order by dr_amt desc";
$data2=db_query($sql2);
...
<?php }?>
<?
 $sql2="SELECT a.ledger_id,a.ledger_name,sum(cr_amt) as cr_amt, a.ledger_group_id, b.narration FROM accounts_ledger a, journal b where b.jv_no='$jv_no' and a.ledger_id=b.ledger_id and jv_no=$jv_no and cr_amt>0 group by b.id order by cr_amt desc";
$data2=db_query($sql2);
while($info=mysqli_fetch_object($data2)){		  
	  ?>
      <tr>
...
<?php }?>
  ...
  <tr>
    <td><?php /*?>Amount in Word : 

	 (<? echo convertNumberMhafuz($ttc)?>)	 <?php */?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
	...
	<tr>
        <td align="center" valign="bottom"><? echo find_a_field('user_activity_management','fname','user_id='.$jv->user_id);?></td>
