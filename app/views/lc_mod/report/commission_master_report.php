...
echo $sql = "select i.item_id, i.finish_goods_code as code,i.item_name,i.item_brand,i.sales_item_type as `group`

from item_info i

where  i.product_nature='Salable'  ".$item_con.$item_brand_con.$pg_con.' group by i.finish_goods_code';
...
elseif($_POST['report']=='3333'){
       ...
       <table width="100%">
		...
		<tr>
          ...
          <?php /*?><tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong><img src="<?=SERVER_ROOT?>public/uploads/logo/fg-logo.png" style="width:100px;"></strong></td>
          </tr>
        <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong>MONTHLY DEALER WISE SALES REPORT (PRODUCT VALUE)</strong></td>
         </tr>
	  ...
	  if($nm_date>$ets_date) break;
	           ...
	           $year_sql = 'select year(a.chalan_date) yr, month(a.chalan_date) mon, sum(a.total_amt) as total_amt,b.dealer_code,c.zone_code from sale_do_chalan a, sale_do_master b, dealer_info c, zon z,  item_info i, item_sub_group s, item_group g where 
...
a.chalan_date BETWEEN  "'.$_POST['f_date'].'" AND "'.$_POST['t_date'].'" and a.item_id Not LIKE "9%" 
'.$group_for_con.$zone_con.$item_sub_con.$item_group_con.$item_mother_group_con.'  group by c.dealer_code, month(a.chalan_date), year(a.chalan_date) order by a.chalan_date';
...
elseif($_POST['report']=='333311'){
  ...
  <? if ($item_mother_group>0) {?>
        ...
        <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong>MONTHLY DEALER WISE SALES REPORT (PRODUCT QUANTITY)</strong></td>
         </tr>
...
a.chalan_date BETWEEN  "'.$_POST['f_date'].'" AND "'.$_POST['t_date'].'" and a.item_id Not LIKE "9%" 
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.'  group by a.item_id, month(a.chalan_date), year(a.chalan_date)';
	  ...
	  ?>
		...
		and s.group_id=g.group_id '.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.' and g.product_type="Finish Goods" 
...
elseif($_POST['report']=='33333311'){
	   ...
	   <tr>
		...
		<td  width="50%" style="border:0px; border-color:white;">
			<table width="100%"  >
				...
				<tr align="center" >
					<td style="font-size:14px; border:0px; border-color:white;"><strong>MONTH BY MONTH PRODUCT QTY WISE SALES REPORT</strong></td>	
				</tr>
	  ...
	  <?
		...
		if(isset($item_group)) 					{$item_group_con=' and s.group_id='.$item_group;}
		if(isset($item_mother_group)) 			{$item_mother_group_con=' and g.mother_group_id='.$item_mother_group;}
		//if(isset($dealer_code)) 				{$dealer_con=' and b.dealer_code='.$dealer_code;}
 ...
 i.item_id=a.item_id and a.do_no = b.do_no and b.dealer_code = c.dealer_code and c.zone_code=z.ZONE_CODE and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and
a.chalan_date BETWEEN  "'.$_POST['f_date'].'" AND "'.$_POST['t_date'].'" and a.item_id Not LIKE "9%" 
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.'  group by a.item_id, month(a.chalan_date), year(a.chalan_date) order by a.chalan_date';
	  ...
	  ?>
		...
		if ($group_for==4) {
		 ...
		 '.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.' and g.product_type="Finish Goods" order by  s.group_for, s.sub_group_sl, i.item_type, i.item_id, i.item_name ';
	   	$query_101 = db_query($sql_101 );
		$sl = 1 ;
		while($r = mysqli_fetch_object($query_101)){
...
elseif($_POST['report']=='33333322'){
 ...
 i.item_id=a.item_id and a.do_no = b.do_no and b.dealer_code = c.dealer_code and c.zone_code=z.ZONE_CODE and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and
a.chalan_date BETWEEN  "'.$_POST['f_date'].'" AND "'.$_POST['t_date'].'" and a.item_id Not LIKE "9%"
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.'  group by s.sub_group_id, month(a.chalan_date), year(a.chalan_date) order by s.sub_group_id';
	  ...
	  ?>
		...
		if(isset($item_group)) 						{$item_group_con=' and s.group_id="'.$item_group.'"';}
		 ...
		 where i.sub_group_id=s.sub_group_id and s.group_id=g.group_id '.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.' and g.product_type="Finish Goods" 
...
elseif($_POST['report']==20060201)
{
  ...
  <? if ($item_mother_group>0) {?>
	  ...
	  $sql_sub="select i.sub_group_id, s.sub_group_name from item_info i, item_sub_group s, item_group g where  
		i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and g.product_type='Finish Goods' ".$item_type_con.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con." group by i.sub_group_id order by s.group_for, s.sub_group_sl ";
		...
		<?
		 ...
		 ".$item_type_con.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con." order by i.item_type, i.item_id, i.item_name";
  ...
  <? if ($item_mother_group>0) {?>
		...
		if(isset($item_mother_group)) 			{$item_mother_group_con=' and g.mother_group_id='.$item_mother_group;}
		 ...
		 where c.dealer_code=d.dealer_code  and z.ZONE_CODE=d.zone_code and m.do_no=c.do_no and i.sub_group_id=s.sub_group_id  and c.item_id=i.item_id and
		  c.chalan_date between '".$f_date."' and '".$t_date."' ".$item_type_con.$con.$group_for_con.$dealer_con.$item_sub_con.$item_group_con." group by s.sub_group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 ...
		 $sales_amt[$info->sub_group_id]=$info->sales_amt;	 
		  ...
		  where c.dealer_code=d.dealer_code and z.ZONE_CODE=d.zone_code  and m.do_no=c.do_no and i.sub_group_id=s.sub_group_id  and c.item_id=i.item_id and
		  c.do_date between '".$f_date."' and '".$t_date."'  ".$item_type_con.$con.$group_for_con.$dealer_con.$item_sub_con.$item_group_con." group by s.sub_group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
	  ...
	  $sql_sub="select i.sub_group_id, s.sub_group_name, g.group_id, g.group_name from item_info i, item_sub_group s, item_group g  where  
		 s.group_id=g.group_id and i.sub_group_id=s.sub_group_id  and g.product_type='Finish Goods' ".$item_type_con.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con." 
		...
		<?
		 ...
		 $sql="select distinct i.item_id, i.item_name, s.sub_group_id, s.sub_group_name from item_info i, item_sub_group s, item_group g  where 
		  s.group_id=g.group_id and i.sub_group_id=s.sub_group_id  and s.group_id='".$info_sub->group_id."'
		   ".$item_type_con.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con."
...
elseif($_POST['report']==2006020211)
{
  ...
  <? if ($item_mother_group>0) {?>
		...
		<tr>
		<th width="8%" rowspan="2">SL</th>
		<th width="25%" rowspan="2">Item Group Name </th>
		<th colspan="2" bgcolor="#99FFFF" style="text-align:center">Gradation </th>
		<th width="15%" rowspan="2" bgcolor="#33CCCC" style="text-align:center">Commission Per Unit </th>
		<th colspan="2" bgcolor="#FFCC99" style="text-align:center">Sales</th>
		</tr>
		<tr>
		  <th width="14%" bgcolor="#99FFFF" style="text-align:center">Minimum</th>
		  <th width="15%" bgcolor="#99FFFF" style="text-align:center">Maximum</th>
		  <th width="9%" bgcolor="#FFCC99" style="text-align:center">Quantity</th>
		  <th width="14%" bgcolor="#FFCC99" style="text-align:center">Commission Amt </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		if(isset($item_mother_group)) 			{$item_mother_group_con=' and g.mother_group_id='.$item_mother_group;}
		  ...
		  $sql = "select g.group_id, g.group_name, sum(c.total_unit) as sales_qty , sum(c.total_amt) as sales_amt
		 from sale_do_master m, sale_do_chalan c, dealer_info d,  zon z, item_info i, item_sub_group s, item_group g
		 where c.dealer_code=d.dealer_code  and z.ZONE_CODE=d.zone_code and m.do_no=c.do_no and g.group_id=s.group_id  and i.sub_group_id=s.sub_group_id  and c.item_id=i.item_id and
		  c.chalan_date between '".$f_date."' and '".$t_date."' ".$con.$group_for_con.$dealer_con.$item_sub_con.$item_group_con." group by g.group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $sales_qty[$info->group_id]=$info->sales_qty;
		 $sales_qty_avl[$info->group_id]=$info->sales_qty;
		 $sales_amt[$info->group_id]=$info->sales_amt;	 
		}
		  ...
		  where c.dealer_code=d.dealer_code and z.ZONE_CODE=d.zone_code  and m.do_no=c.do_no and  g.group_id=s.group_id  and i.sub_group_id=s.sub_group_id  and c.item_id=i.item_id and
		  c.do_date between '".$f_date."' and '".$t_date."'  ".$con.$group_for_con.$dealer_con.$item_sub_con.$item_group_con." group by g.group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $return_qty[$info->group_id]=$info->return_qty;
		 $return_amt[$info->group_id]=$info->return_amt;
		...
		if($_POST['commission_year']!='')
 		$commission_yr_con=" and r.commission_year=".$_POST['commission_year'];
		...
		<?
		 ...
		 $sql="select   g.group_id, g.group_name, y.commission_year, r.sale_type, r.minimum_qty, r.maximum_qty, r.commission_rate from item_group g, item_sub_group s, commission_rate r, commission_year y   where 
		g.group_id=s.group_id and g.group_id=r.group_id and r.commission_year=y.id 
		   ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$commission_yr_con."
		  order by s.group_id, r.id";
		
		$res	 = db_query($sql);
		while($row=mysqli_fetch_object($res))
		{
$slab_qty = $row->maximum_qty - $row->minimum_qty;
if($sales_qty_avl[$row->group_id]>=$slab_qty) {$offer_qty = $slab_qty; $sales_qty_avl[$row->group_id] = $sales_qty_avl[$row->group_id] - $offer_qty; }
else {$offer_qty = $sales_qty_avl[$row->group_id]; $sales_qty_avl[$row->group_id] = 0;}
		...
		<td><?php /*?><?=$sales_qty_avl[$row->group_id];?><?php */?> <?=number_format($offer_qty,2);?></td>
		<td><?= number_format($commission_amt = ($offer_qty*$row->commission_rate),2);?></td>
		</tr>
<? } ?>
		<tr>
		  <td>&nbsp;</td>
...
elseif($_POST['report']==20060203)
{
		...
		if(isset($group_for)) 		{$group_for_con=' and m.group_for="'.$group_for.'"';}
		 ...
		 where m.do_no=c.do_no and c.dealer_code=d.dealer_code and c.item_id=i.item_id and s.sub_group_id=i.sub_group_id and s.group_id=g.group_id  and d.zone_code=z.ZONE_CODE and
		  c.chalan_date between '".$f_date."' and '".$t_date."' and c.item_id Not LIKE '9%'  ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con."  group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 ...
		 $sales_qty[$info->dealer_code]=$info->sales_qty;
		  ...
		  where  m.do_no=c.do_no and c.dealer_code=d.dealer_code and c.item_id=i.item_id and s.sub_group_id=i.sub_group_id  and s.group_id=g.group_id and d.zone_code=z.ZONE_CODE and
		  c.do_date between '".$f_date."' and '".$t_date."' and c.item_id Not LIKE '9%' ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con." group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
...
elseif($_POST['report']==2006020311)
{
 ...
 and  d.zone_code=z.ZONE_CODE and
		  c.chalan_date between '".$f_date."' and '".$t_date."' and c.item_id Not LIKE '9%' and m.do_type in ('REGULAR','MAT','CASH SALE','WASTAGE') ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con."  group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 ...
		 from sale_do_master m, sale_do_chalan c, dealer_info d, item_info i, item_sub_group s, item_group g, zon z
		 where m.do_no=c.do_no and  c.dealer_code=d.dealer_code and c.item_id=i.item_id and  s.sub_group_id=i.sub_group_id  and s.group_id=g.group_id and  d.zone_code=z.ZONE_CODE and
		  c.chalan_date between '".$f_date."' and '".$t_date."' and c.item_id Not LIKE '9%' and m.do_type='ADVANCE' ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con."  group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 ...
		 $advance_amt[$info->dealer_code]=$info->advance_amt;
		  ...
		  from sale_return_master m, sale_return_details c, dealer_info d, item_info i, item_sub_group s, item_group g, zon z
		  where  m.do_no=c.do_no and c.dealer_code=d.dealer_code and c.item_id=i.item_id and  s.sub_group_id=i.sub_group_id  and s.group_id=g.group_id and  d.zone_code=z.ZONE_CODE and
		  c.do_date between '".$f_date."' and '".$t_date."' and c.item_id Not LIKE '9%' and m.sr_invoice>0 ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con." group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 $return_qty[$info->dealer_code]=$info->return_qty;
  		 $return_amt[$info->dealer_code]=$info->return_amt;
...
elseif($_POST['report']==2006020322)
{
	 ...
	 $sql_sub="select i.sub_group_id, s.sub_group_name from item_info i, item_sub_group s, item_group g where  
		i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and g.product_type='Finish Goods' ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con." group by i.sub_group_id order by  s.group_for, s.sub_group_sl";
		$data_sub=db_query($sql_sub);
		...
		<?
		 ...
		 $sql="select distinct i.item_id, i.item_name, s.sub_group_name from item_info i, item_sub_group s, item_group g where i.sub_group_id=s.sub_group_id and 
		  ...
		  and i.sub_group_id='".$info_sub->sub_group_id."' ".$item_sub_con.$group_for_item_con.$item_group_con." order by i.item_type, i.item_id, i.item_name";
  ...
  <? if ($item_mother_group>0) {?>
		...
		if(isset($item_mother_group)) 			{$item_mother_group_con=' and g.mother_group_id='.$item_mother_group;}
		 ...
		 where c.dealer_code=d.dealer_code  and z.ZONE_CODE=d.zone_code and m.do_no=c.do_no and c.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and 
		  c.chalan_date between '".$f_date."' and '".$t_date."' ".$con.$group_for_con.$dealer_con_d1.$item_sub_con.$item_group_con.$item_mother_group_con." group by i.sub_group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		 ...
		 from sale_do_master m, sale_do_chalan c, dealer_info d,  zon z, item_info i, item_sub_group s, item_group g
		 where c.dealer_code=d.dealer_code  and z.ZONE_CODE=d.zone_code and m.do_no=c.do_no and c.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and 
		  c.chalan_date between '".$f_date."' and '".$t_date."' ".$con.$group_for_con.$dealer_con_d2.$item_sub_con.$item_group_con.$item_mother_group_con." group by i.sub_group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
	   ...
	   $sql_sub="select i.sub_group_id, s.sub_group_name, g.group_id, g.group_name from item_info i, item_sub_group s, item_group g where  s.group_id=g.group_id and
		i.sub_group_id=s.sub_group_id and g.product_type='Finish Goods' ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con." 
		group by g.group_id order by g.group_for, g.item_group_sl";
		$data_sub=db_query($sql_sub);
