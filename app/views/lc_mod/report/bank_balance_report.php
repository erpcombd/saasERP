...
<form action="bank_master_report.php" method="post" name="form1" target="_blank" id="form1">
                              ...
                              <tr>
                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
											 ...
											 <tr>
							  					  ...
							  					  <td><input name="report" type="radio" class="radio" value="210617005"  checked="checked" /></td>

													<td><div align="left">BANK BALANCE REPORT</div></td>
											 </tr>
...
document.getElementById('item_group').value);">
				  ...
				  <tr>
                    ...
                    <td><select name="bank_group" id="bank_group"   >
					
					<option></option>

                     

                      <? foreign_relation('bank_group','id','bank_group',$bank_group,'1 order by bank_group');?>
