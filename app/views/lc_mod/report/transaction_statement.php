...
foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,"ledger_group_id in (1010,1011,1013)  order by ledger_group_id,ledger_name ");

?>
</select>										</td>
                                        <td width="50%" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?php /*?><? if($_REQUEST['ledger_id']>0) echo find_a_field('accounts_ledger','ledger_name','ledger_id='.$_REQUEST['ledger_id']);?><?php */?>&nbsp;</td>
                                      </tr>
						  ...
						  <option value="">Select Type</option>
										 ...
										 <option value="Journal"<?=($_POST['tr_from']=="Journal")?'selected':'';?>>Journal</option>
										  ...
										  <option value="Sales Return"<?=($_POST['tr_from']=="Sales Return")?'selected':'';?>>Sales Return</option>
...
if(isset($_REQUEST['show']))
{
  ...
  <?php } ?>
  <tr>
    <th colspan="5" align="center"><?php /*?>Difference Balance : <?php echo number_format($t_total,2)." ".$t_type?><?php */?> </th>
