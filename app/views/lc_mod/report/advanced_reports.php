                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
																					 ...
																					 <!--<tr>
																					  ...
																					  <tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="21052001" checked="checked" /></td>

																							<td><div align="left">DAILY PRODUCTION DETAILS REPORT</div></td>
																					 </tr>
																					 
																					 
																					 <tr>

							  															  <td><input name="report" type="radio" class="radio" value="21052002" /></td>

																							<td><div align="left">DAILY PRODUCTION SUMMARY REPORT</div></td>
																					 </tr>
																					 
																					 
																					 <tr>

							  															  <td><input name="report" type="radio" class="radio" value="250421002"  /></td>

																							<td><div align="left">BARCODE WISE SALES REPORT</div></td>
																					 </tr>
																					 ...
																					 <?php /*?><tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="250421003"  /></td>
...
document.getElementById('item_group').value);"  >
				  ...
				  <tr>
                    ...
                    <td><select name="status" id="status"  >
                      ...
                      <? foreign_relation('production_receive_detail','status','status',$status,'status in ("RECEIVED","SOLD OUT") group by status ');?>
                  ...
                  <tr>
                    ...
                    <td><input  name="f_date" type="text" id="f_date" value="<?=date('Y-m-01')?>"  style="width:220px"/></td>
				  ...
				  <tr>
					...
					<input  name="barcode" type="text" id="barcode" value="<?=$barcode;?>"  style="width:220px"/>
