...
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.$item_type_con.'  group by a.item_id, month(a.chalan_date), year(a.chalan_date)';
	  ...
	  ?>
		...
		and s.group_id=g.group_id '.$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.' and g.product_type="Finish Goods" 
		order by  s.group_for, s.sub_group_sl, i.item_type, i.item_id, i.item_name ';
	   	$query_101 = db_query($sql_101 );
		$sl = 1 ;
		while($r = mysqli_fetch_object($query_101)){
...
elseif($_POST['report']==250421001)
{
  ...
  <? if ($item_mother_group>0) {?>
		...
		<th width="10%" rowspan="2">TR No </th>
		<th width="20%" rowspan="2">Item Name </th>
		<th width="9%" rowspan="2">PR Date </th>
		<th colspan="3" bgcolor="#33CCCC" style="text-align:center">Production</th>
		<th width="11%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Scaleman</th>
		<th width="9%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Entry By </th>
		<th width="8%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Status</th>
		</tr>
		<tr>
		  <th width="7%" bgcolor="#33CCCC" style="text-align:center">Net Weight </th>
		  <th width="6%" bgcolor="#33CCCC" style="text-align:center">Weight Loss </th>
		  <th width="7%" bgcolor="#33CCCC" style="text-align:center">Final Weight </th>
		  </tr>
		</thead><tbody>
		<? $sl=1;
		...
		if(isset($item_id)) 					{$item_id_con=' and i.item_id='.$item_id;}
			...
			$status_con .= ' and p.status = "'.$_POST['status'].'" ';
			
			if($_POST['barcode']!='')

			$barcode_con .= ' and p.barcode = "'.$_POST['barcode'].'" ';

		
		
	 $sql_sub="select i.sub_group_id, s.sub_group_name from production_receive_detail p, item_info i, item_sub_group s, item_group g where  
		p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and p.barcode>0 and  p.pr_date between '".$f_date."' and '".$t_date."'
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con." group by i.sub_group_id order by s.group_for, s.sub_group_sl ";
		...
		<?
		 ...
		 $sql="select  i.item_id, i.item_name, s.sub_group_name, p.* from  production_receive_detail p, item_info i, item_sub_group s, item_group g where 
		 p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and i.sub_group_id='".$info_sub->sub_group_id."' and p.barcode>0
		 and p.pr_date between '".$f_date."' and '".$t_date."'
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con." group by p.id order by i.item_type, i.item_id, i.item_name";
		...
		<td><?=$sl++;?></td>
		<td><a title="WO Preview" target="_blank" href="../production_receive_fn/barcode_print_view.php?v_no=<?=$row->barcode?>"><?=$row->barcode?></a></td>
		<td><?=$row->item_name?></td>
		<td><?=$row->pr_date?></td>
		<td><?=number_format($row->net_weight,3); $total_net_weight +=$row->net_weight;?> </td>
		<td><?=number_format($row->weight_loss,3); $total_weight_loss +=$row->weight_loss;?>        </td>
		<td><?=number_format($row->total_unit,3); $total_total_unit +=$row->total_unit;?>        </td>
		<td><?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$row->PBI_ID)?></td>
		<td><?=find_a_field('user_activity_management','fname','user_id='.$row->entry_by)?></td>
		<td>
		<? if($row->status=="SOLD OUT") {?> 
			<a title="WO Preview" target="_blank" href="../production_receive_fn/barcode_sales_print_view.php?v_no=<?=$row->barcode?>"><?=$row->status;?></a>
		<? }?>
...
<? } ?>
		<tr>
		  ...
		  <td><span class="style7">
		    <?=number_format($total_net_weight,3); $total_total_net_weight +=$total_net_weight;?>
		  </span></td>
		  <td><span class="style7">
            <?=number_format($total_weight_loss,3); $total_total_weight_loss +=$total_weight_loss;?>
          </span></td>
		  <td><span class="style7">
            <?=number_format($total_total_unit,3); $total_total_total_unit +=$total_total_unit;?>
          </span></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
 ...
 <tr>
		  ...
		  <td>&nbsp;</td>
		  <td><span class="style7">
		    <?=number_format($total_total_net_weight,3);?>
		  </span></td>
		  <td><span class="style7">
            <?=number_format($total_total_weight_loss,3);?>
          </span></td>
		  <td><span class="style7">
            <?=number_format($total_total_total_unit,3);?>
          </span></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
...
elseif($_POST['report']==21052001)
{
		$report="DAILY PRODUCTION DETAILS REPORT";		
		if(isset($warehouse_id)){$con.=' and j.warehouse_id="'.$warehouse_id.'"';}
        ...
        <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;"><strong>Warehouse: 
		  <?=find_a_field('warehouse','warehouse_name','warehouse_id='.$_POST['warehouse_id'])?></strong></td>
         </tr>
		 <? }?>
  ...
  <? if ($item_mother_group>0) {?>
		...
		<tr>
		<th width="2%" rowspan="2">SL</th>
		<th width="5%" rowspan="2">TR No </th>
		<th width="19%" rowspan="2">Item Name </th>
		<th width="7%" rowspan="2">PR Date </th>
		<th colspan="4" bgcolor="#33CCCC" style="text-align:center">Production</th>
		<th width="9%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Scaleman</th>
		<th width="7%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Entry By </th>
		<th width="7%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Status</th>
		<th width="15%" rowspan="2" bgcolor="#FF0000" style="text-align:center">Entry At </th>
		</tr>
		<tr>
		  <th width="8%" bgcolor="#33CCCC" style="text-align:center">Net Weight </th>
		  <th width="8%" bgcolor="#33CCCC" style="text-align:center">Weight Loss </th>
		  <th width="7%" bgcolor="#33CCCC" style="text-align:center">Final Weight </th>
...
if(isset($group_for)) 					{$group_for_con=' and p.group_for='.$group_for;}
		...
		if(isset($item_id)) 					{$item_id_con=' and i.item_id='.$item_id;}
			...
			$warehouse_con .= ' and p.warehouse_to = "'.$_POST['warehouse_id'].'" ';
			
			if($_POST['item_type']!='')

			$item_type_con .= ' and i.item_type = "'.$_POST['item_type'].'" ';
		...
		$t_date = $t_date;
   		$to_date =  date('Y-m-d', strtotime($t_date.' + 1 day'));
   		$to_date;
		
		$from_time = $from_date.' 07:00:00';
		$to_time = $to_date.' 06:59:00';
		 ...
		 $sql="select  i.item_id, i.item_name, s.sub_group_name, p.* from  production_receive_detail p, item_info i, item_sub_group s, item_group g where 
		 p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and p.barcode>0 and p.total_unit>0
		 and p.pr_date between '".$from_date."' and '".$to_date."' and p.entry_at BETWEEN  '".$from_time."' and '".$to_time."'
		 ".$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con.$warehouse_con." group by p.id order by p.entry_at";
		...
		<td><?=number_format($row->weight_loss,3); $total_weight_loss +=$row->weight_loss;?>        </td>
		<td><?=number_format($row->total_unit,3); $total_total_unit +=$row->total_unit;?>        </td>
		<td><?=number_format($row->bag_unit,0); $total_bag_unit +=$row->bag_unit;?></td>
		<td><?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID='.$row->PBI_ID)?></td>
		<td><?=find_a_field('user_activity_management','fname','user_id='.$row->entry_by)?></td>
		<td>
		<? if($row->status=="SOLD OUT") {?> 
...
<? } ?>
		<tr>
		  ...
		  <td>&nbsp;</td>
		  <td><span class="style7">
		    <?=number_format($total_net_weight,3);?>
		  </span></td>
		  <td><span class="style7">
            <?=number_format($total_weight_loss,3);?>
          </span></td>
		  <td><span class="style7">
            <?=number_format($total_total_unit,3);?>
          </span></td>
		  <td><span class="style7">
...
elseif($_POST['report']==21052002)
{
		$report="DAILY PRODUCTION SUMMARY REPORT";		
		if(isset($warehouse_id)){$con.=' and j.warehouse_id="'.$warehouse_id.'"';}
...
//		}
		...
		$to_time = $to_date.' 06:59:00';
		 ...
		 $sql_sub="select  i.item_id, i.item_name, s.sub_group_name, p.* from  production_receive_detail p, item_info i, item_sub_group s, item_group g where 
		 p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and p.barcode>0 and p.total_unit>0
		 and p.pr_date between '".$from_date."' and '".$to_date."' and p.entry_at BETWEEN  '".$from_time."' and '".$to_time."'
		 ".$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con.$warehouse_con.$item_type_con." group by p.item_id order by p.item_id";
		$data_sub=db_query($sql_sub);
		...
		<tr >
		  ...
		  <td bgcolor="#CCFFFF">&nbsp;</td>
		  <td colspan="10" bgcolor="#CCFFFF"><div align="left" style="text-transform:uppercase; font-size:14px; font-weight:700;"><strong>
		    <?=$info_sub->item_name?>
          </strong></div></td>
		  </tr>
		...
		<?
		  ...
		  $sql="select  i.item_id, i.item_name, s.sub_group_name, p.* from  production_receive_detail p, item_info i, item_sub_group s, item_group g where 
		 p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and p.barcode>0 and p.total_unit>0
		 and p.pr_date between '".$from_date."' and '".$to_date."' and p.entry_at BETWEEN  '".$from_time."' and '".$to_time."' and p.item_id='".$info_sub->item_id."'
		 ".$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con.$warehouse_con." group by p.id order by p.entry_at";
...
<? } ?>
		<tr>
		  ...
		  <td><span class="style7">
		    <?=number_format($total_bag_unit,0); $total_total_bag_unit +=$total_bag_unit;?>
		  </span></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		...
		<tr>
		  ...
		  <td><span class="style7">
            <?=number_format($total_total_bag_unit,0);?>
          </span></td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
...
elseif($_POST['report']==250421002)
{
		$report="BARCODE WISE SALES REPORT";		
		if(isset($warehouse_id)){$con.=' and j.warehouse_id="'.$warehouse_id.'"';}
  ...
  <? if ($item_mother_group>0) {?>
		...
		<th width="11%" bgcolor="#FF0000" style="text-align:center">Customer Name </th>
		<th width="9%" bgcolor="#FF0000" style="text-align:center">Scane By </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
...
//		}
	 ...
	 $sql_sub="select i.sub_group_id, s.sub_group_name from sale_do_chalan p, item_info i, item_sub_group s, item_group g where  
		p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and p.barcode>0 and p.item_id NOT LIKE '9%' and  p.chalan_date between '".$f_date."' and '".$t_date."'
		 ".$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con.$item_type_con." group by i.sub_group_id order by s.group_for, s.sub_group_sl ";
		$data_sub=db_query($sql_sub);
		...
		<?
		 ...
		 $sql="select  m.do_no, m.do_date, i.item_id, i.item_name, s.sub_group_name, p.* from  sale_do_master m, sale_do_details p, item_info i, item_sub_group s, item_group g where 
		m.do_no=p.do_no and p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and i.sub_group_id='".$info_sub->sub_group_id."' and p.barcode>0 
		 and p.item_id NOT LIKE '9%'
		 and m.do_date between '".$f_date."' and '".$t_date."'
		 ".$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$barcode_con." group by p.id order by i.item_type,  i.item_name";
		...
		<td><? echo find_a_field('user_activity_management','fname','user_id='.$row->entry_by);?></td>
		</tr>
<? } ?>
		<tr>
		  <td>&nbsp;</td>
...
elseif($_POST['report']==250421003)
{
		$report="SCANE WISE SALES ORDER";		
		if(isset($warehouse_id)){$con.=' and j.warehouse_id="'.$warehouse_id.'"';}
  ...
  <? if ($item_mother_group>0) {?>
		 ...
		 <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;">For the Date of:<strong> <?php echo date('d-m-Y',strtotime($_POST['t_date']));?></strong></td>
         </tr>
			</table>
		...
		<th width="5%" bgcolor="#33CCCC">SL</th>
		<th width="25%" bgcolor="#33CCCC">Item Sub Group </th>
		<th width="38%" bgcolor="#33CCCC">Item Name </th>
		<th width="17%" bgcolor="#33CCCC">Bag</th>
		<th width="15%" bgcolor="#33CCCC" style="text-align:center">Quantity</th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		if(isset($item_id)) 					{$item_id_con=' and i.item_id='.$item_id;}
			...
			$dealer_code_con .= ' and m.dealer_code = "'.$_POST['dealer_code'].'" ';
			
			
				
	 	$sql_dealer="select i.sub_group_id, s.sub_group_name, p.depot_id , w.warehouse_name, d.dealer_code, d.dealer_name_e from sale_do_master m, sale_do_details p, item_info i, item_sub_group s, item_group g, warehouse w, dealer_info d where  
		m.dealer_code=d.dealer_code and m.do_no=p.do_no and p.depot_id=w.warehouse_id and p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and p.barcode>0 and p.item_id NOT LIKE '9%' and  
		m.do_date='".$t_date."'
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$dealer_code_con." group by p.dealer_code order by s.group_for, s.sub_group_sl ";
		$query_dealer=db_query($sql_dealer);
		...
		<tr >
		  <td bgcolor="#CCCCCC" >&nbsp;</td>
		  <td bgcolor="#CCCCCC" ><div align="left" style="text-transform:uppercase; font-size:14px; font-weight:700;"><strong><?=$data_dealer->dealer_name_e?>
		  </strong></div></td>
		  <td bgcolor="#CCCCCC" >&nbsp;</td>
		  <td bgcolor="#CCCCCC" >&nbsp;</td>
		  <td bgcolor="#CCCCCC" >&nbsp;</td>
	 ...
	 $sql_sub="select i.sub_group_id, s.sub_group_name, p.depot_id , p.dealer_code, w.warehouse_name from sale_do_master m, sale_do_details p, item_info i, item_sub_group s, item_group g, warehouse w where  
		m.do_no=p.do_no and p.depot_id=w.warehouse_id and p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and p.barcode>0 
		and m.dealer_code ='".$data_dealer->dealer_code."' and p.item_id NOT LIKE '9%' and  
		m.do_date='".$t_date."'
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$dealer_code_con." group by p.depot_id order by s.group_for, s.sub_group_sl ";
		$data_sub=db_query($sql_sub);
		...
		<tr>
		  <td >&nbsp;</td>
		  <td >&nbsp;</td>
		  <td ><div align="left" style="text-transform:uppercase; font-size:14px; font-weight:700;"><strong><?=$info_sub->warehouse_name?>
		  </strong></div></td>
		  <td >&nbsp;</td>
		  <td >&nbsp;</td>
		  </tr>
		...
		<?
		 ...
		 $sql="select  m.do_no, m.do_date, i.item_id, i.item_name, s.sub_group_name, sum(p.bag_unit) as bag_unit, sum(p.total_unit) as total_unit, p.do_type from  sale_do_master m, sale_do_details p, item_info i, item_sub_group s, item_group g where 
		m.do_no=p.do_no and p.item_id=i.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id and p.depot_id ='".$info_sub->depot_id."' and m.dealer_code ='".$info_sub->dealer_code."'
		and p.barcode>0 
		 and p.item_id NOT LIKE '9%'  and m.do_date='".$t_date."'
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_id_con.$status_con.$dealer_code_con." group by p.item_id, p.do_type, p.depot_id order by i.item_name";
		...
		<td><?=$row->item_name?> <? if($row->do_type=="ADVANCE") {?> <b style="color:#FF0000;">(<?=$row->do_type;?>)</b> <? }?></td>
		<td><?=$row->bag_unit; $total_bag_unit +=$row->bag_unit;?></td>
		<td><?=number_format($row->total_unit,3); $total_total_unit +=$row->total_unit;?>        </td>
		</tr>
<? } 
...
?>
		<tr>
		  <td>&nbsp;</td>
		  <td>&nbsp;</td>
		  <td><div align="right" style="text-transform:uppercase"><strong>Warehouse Total:</strong></div></td>
		  <td><span class="style7">
            <?=$total_bag_unit; $total_total_bag_unit +=$total_bag_unit;?>
          </span></td>
		  <td><span class="style7">
            <?=number_format($total_total_unit,3); $total_total_total_unit +=$total_total_unit;?>
          </span></td>
 		...
 		<tr>
		  ...
		  <td bgcolor="#99CC99">&nbsp;</td>
		  <td bgcolor="#99CC99"><div align="right" style="text-transform:uppercase"><strong>Dealer Total:</strong></div></td>
		  <td bgcolor="#99CC99"><span class="style7">
            <?=$total_total_bag_unit; $total_total_total_bag_unit +=$total_total_bag_unit;?>
          </span></td>
		  <td bgcolor="#99CC99"><span class="style7">
            <?=number_format($total_total_total_unit,3); $total_total_total_total_unit +=$total_total_total_unit;?>
          </span></td>
		  </tr>
		  
		  <? $total_total_bag_unit = 0;
		     $total_total_total_unit = 0;
 }?>
 ...
 <tr>
		  ...
		  <td bgcolor="#CCCCFF">&nbsp;</td>
		  <td bgcolor="#CCCCFF"><div align="right" style="text-transform:uppercase"><strong>Grand Total:</strong></div></td>
		  <td bgcolor="#CCCCFF"><span class="style7">
            <?=$total_total_total_bag_unit;?>
          </span></td>
		  <td bgcolor="#CCCCFF"><span class="style7">
            <?=number_format($total_total_total_total_unit,3);?>
          </span></td>
		  </tr>
	 ...
	 $sql_sub="select i.sub_group_id, s.sub_group_name from item_info i, item_sub_group s, item_group g where  
		...
		<?
		 ...
		 $sql="select distinct i.item_id, i.item_name, s.sub_group_name from item_info i, item_sub_group s, item_group g where i.sub_group_id=s.sub_group_id and 
		  ...
		  and i.sub_group_id='".$info_sub->sub_group_id."' ".$item_sub_con.$group_for_item_con.$item_group_con.$item_type_con.$item_id_con." order by i.item_type, i.item_id, i.item_name";
  ...
  <? if ($item_mother_group>0) {?>
	 ...
	 $sql_sub="select i.sub_group_id, s.sub_group_name from sale_return_master m, sale_return_details d, item_info i, item_sub_group s, item_group g where  
		...
		<?
		 ...
		 ".$item_sub_con.$group_for_item_con.$item_group_con.$item_mother_group_con.$item_type_con.$return_type_con.$item_id_con." order by i.item_type, i.item_id, i.item_name";
