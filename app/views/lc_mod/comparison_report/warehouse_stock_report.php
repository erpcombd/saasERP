                        ...
                        <tr>
                          ...
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
							    ...
							    <td><input name="report" type="radio" class="radio" value="210709001" checked="checked"  /></td>

							    <td><div align="left">Finished Goods Present Stock</div></td>
						      </tr>
...
document.getElementById('item_sub_group').value);">
				  ...
				  <tr>
                    <td>Company:</td>
                    <td><span class="oe_form_group_cell" >
                      <select class="form-control" name="group_for" required id="group_for" >
                        <option></option>
