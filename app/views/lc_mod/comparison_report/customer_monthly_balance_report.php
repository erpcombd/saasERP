...
$title='CUSTOMER MONTHLY BALANCE REPORT';
            ...
            <tr>
                              ...
                              <tr>
                                ...
                                <td colspan="2" class="title1"><div align="left">Select Report </div></td>
											 ...
											 <tr>
							  					  ...
							  					  <td><input name="report" type="radio" class="radio" value="220209001" checked="checked" /></td>

													<td><div align="left">CUSTOMER MONTHLY BALANCE REPORT</div></td>
											 </tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				  ...
				  <tr>
                    ...
                    <td><select name="ledger_id" id="ledger_id" required  >
					
			

                     

                      <? foreign_relation('accounts_ledger','ledger_id','ledger_name',$ledger_id,'ledger_group_id IN (1027,1028,1029) AND ledger_layer = 2');?>
