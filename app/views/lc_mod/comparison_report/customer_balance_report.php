            ...
            <tr>
              ...
              <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0" align="center">
				  ...
				  <tr>
                    ...
                    <td><select name="ledger_group" id="ledger_group" required  >
					
					<option></option>

                     

                      <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'group_id in (1027, 1028, 1029) order by group_id');?>
