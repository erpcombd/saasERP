...
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.$item_type_con.'  group by a.item_id, month(a.chalan_date), year(a.chalan_date)';
	  ...
	  ?>
		...
		and a.chalan_date BETWEEN  "'.$_POST['f_date'].'" AND "'.$_POST['t_date'].'" and g.product_type="Finish Goods" group by i.item_id
...
elseif($_POST['report']=='33333311'){
	   ...
	   <tr>
		...
		<td style="border:0px; border-color:white;">
		 ...
		 <? if ($group_for>0) {?>
        <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Company: <?=find_a_field('user_group','group_name','id='.$group_for)?></strong></td>
         </tr>
		 <? }?>
		 
		  <? if ($item_sub_group>0) {?>
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Product Sub Group: <?=find_a_field('item_sub_group','sub_group_name','sub_group_id='.$item_sub_group)?></strong></td>
         </tr>
		 <? }?>
		  ...
		  <? if ($zone_id>0) {?>
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Zone Name: <?=find_a_field('zon','ZONE_NAME','ZONE_CODE='.$zone_id)?></strong></td>
         </tr>
		 <? }?>
		 
		 <? if ($dealer_code>0) {?>
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Dealer Name: <?=find_a_field('dealer_info','dealer_name_e','dealer_code='.$dealer[0])?></strong></td>
         </tr>
		 <? }?>
		 
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;">For the Period of: <?php echo date('d-m-Y',strtotime($_POST['f_date']));?>
		   <strong>To</strong> <?php echo date('d-m-Y',strtotime($_POST['t_date']));?></td>
         </tr>
			</table>
		...
		<td  width="25%" style="border:0px; border-color:white;">
		<img src="<?=SERVER_ROOT?>public/uploads/logo/fg-logo.png" style="width:100px;">
		</td>
		</tr>
...
'.$group_for_con.$zone_con.$item_sub_con.$dealer_con.$item_group_con.$item_mother_group_con.$item_type_con.'  group by a.item_id, month(a.chalan_date), year(a.chalan_date) order by a.chalan_date';
	  ...
	  ?>
        ...
        <? for($i=1;$i<=$t;$i++){ ?><td ><strong><?=$period_name[$i].'-'.substr($period[$i],2,2)?></strong></td> 
        <? }?> 
...
elseif($_POST['report']=='210501004'){
       ...
       <table >
	   <tr>
		<td align="center" style="border:0px; border-color:white;">
		<img src="<?=SERVER_ROOT?>public/uploads/logo/fg-logo.png" style="width:100px;">
		</td>
		<td style="border:0px; border-color:white;">
			<table>
	   ...
	   <tr>
        ...
        <tr>
		 ...
		 <? }?>
		    ...
		    <? if ($item_mother_group>0) {?>
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Product Mother Group: <?=find_a_field('item_mother_group','mother_group_name','id='.$item_mother_group)?></strong></td>
         </tr>
		 <? }?>
		 
		   <? if ($item_group>0) {?>
		 <tr>
          <td colspan="15" style="font-size:14px;border:0px; border-color:white;"><strong>Product Group: <?=find_a_field('item_group','group_name','group_id='.$item_group)?></strong></td>
         </tr>
		 <? }?>
...
elseif($_REQUEST['report']==211100707)
{
		...
		<?
 		 ...
 		 $sql="select *from sale_do_chalan where  dealer_code='".$_REQUEST['dealer_code']."' and item_id='".$_REQUEST['item_id']."' and 	order by a.ledger_id";
...
elseif($_POST['report']==223101001)
{
		...
		<table width="100%">
	   	<tr>
		<td width="25%" align="center" style="border:0px; border-color:white;"><img src="<?=SERVER_ROOT?>public/uploads/logo/fg-logo.png" style="width:100px;" /></td>
		<td  width="50%" style="border:0px; border-color:white;">
			<table width="100%"  >
				<tr align="center" >
					<td style="font-size:20px; border:0px; border-color:white;"><strong><?=$_SESSION['company_name'];?></strong></td>	
		...
		<td  width="25%" align="center" style="border:0px; border-color:white;">
		<img src="<?=SERVER_ROOT?>public/uploads/logo/fg-logo.png" style="width:100px;">		</td>
		</tr>
...
elseif($_POST['report']==211100705)
{
  ...
  <? if ($item_mother_group>0) {?>
		...
		<tr>
		<th width="2%" rowspan="2" bgcolor="#9999FF">SL</th>
		<th width="34%" rowspan="2" bgcolor="#9999FF">Item Group Name </th>
		<th colspan="3" bgcolor="#99FFFF" style="text-align:center">SALES  </th>
		<th colspan="3" bgcolor="#33CCCC" style="text-align:center">SALES RETURN</th>
		<th colspan="3" bgcolor="#FF0000" style="text-align:center">NET SALES </th>
		</tr>
		<tr>
		  <th width="6%" bgcolor="#99FFFF" style="text-align:center">BAG</th>
		  <th width="6%" bgcolor="#99FFFF" style="text-align:center">QUANTITY</th>
		  <th width="8%" bgcolor="#99FFFF" style="text-align:center">AMOUNT</th>
		  <th width="6%" bgcolor="#33CCCC" style="text-align:center">BAG</th>
		  ...
		  <th width="8%" bgcolor="#FF0000" style="text-align:center">QUANTITY</th>
		...
		$sql = "select c.item_id, s.sub_group_id, sum(c.bag_unit) as bag_unit 
		 from sale_do_master m, sale_do_chalan c, dealer_info d,  zon z, item_info i, item_sub_group s
		 where c.dealer_code=d.dealer_code  and z.ZONE_CODE=d.zone_code and m.do_no=c.do_no and i.sub_group_id=s.sub_group_id  and c.item_id=i.item_id and s.group_id!=900000000 and
		  c.chalan_date between '".$f_date."' and '".$t_date."' ".$con.$group_for_con.$dealer_con.$item_sub_con.$item_group_con.$item_type_con.$do_type_con." group by s.sub_group_id ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
	  ...
	  $sql_sub="select i.sub_group_id, s.sub_group_name, g.group_id, g.group_name from sale_do_chalan c, item_info i, item_sub_group s, item_group g  where  
		...
		<td><? if ($return_amt[$row->sub_group_id]>0) {?>
		  <?=number_format($return_amt[$row->sub_group_id],2); $total_return_amt +=$return_amt[$row->sub_group_id];?>
          <? }?></td>
		<td><?=$net_sales_bag_unit=($bag_unit[$row->sub_group_id]-$return_bag_unit[$row->sub_group_id]); $total_net_sales_bag_unit +=$net_sales_bag_unit;?></td>
		<td>
		<?=number_format($net_sales_qty=($sales_qty[$row->sub_group_id]-$return_qty[$row->sub_group_id]),2); $total_net_sales_qty +=$net_sales_qty;?></td>
		<td>
		  <?=number_format($net_sales_amt=($sales_amt[$row->sub_group_id]-$return_amt[$row->sub_group_id]),2); $total_net_sales_amt +=$net_sales_amt;?>		  </td>
		</tr>
<? }  }?>
		<tr>
		  <td>&nbsp;</td>
...
$report_type_com_con .= " and m.group_for!=5";
		...
		$sql = "select c.dealer_code, sum(c.total_unit) as regular_qty , sum(c.total_amt) as regular_amt
		 from sale_do_master m, sale_do_chalan c, dealer_info d, item_info i, item_sub_group s, item_group g, zon z
		 where m.do_no=c.do_no and  c.dealer_code=d.dealer_code and c.item_id=i.item_id and  s.sub_group_id=i.sub_group_id  and s.group_id=g.group_id and  d.zone_code=z.ZONE_CODE and
		 c.chalan_date between '".$f_date."' and '".$t_date."' and g.product_type='Finish Goods' and m.do_type in ('REGULAR','MAT','CASH SALE','WASTAGE') and g.group_id!=900000000
		 ...
		 from sale_do_master m, sale_do_chalan c, dealer_info d, item_info i, item_sub_group s, item_group g, zon z
		 where m.do_no=c.do_no and  c.dealer_code=d.dealer_code and c.item_id=i.item_id and  s.sub_group_id=i.sub_group_id  and s.group_id=g.group_id and  d.zone_code=z.ZONE_CODE and
		 c.chalan_date between '".$f_date."' and '".$t_date."' and g.product_type='Finish Goods' and m.do_type in ('REGULAR','MAT','CASH SALE','WASTAGE') 
		 ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con.$item_con_in.$report_type_con."  group by c.dealer_code ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
...
elseif($_POST['report']==220202001)
{
		...
		$do_type_con .= ' and m.do_type = "'.$_POST['do_type'].'" ';
				...
				echo $sql  = 'select d.dealer_code, d.dealer_name_e
				from dealer_info d 
...
elseif($_POST['report']==210617002)
{
		...
		<th width="13%" bgcolor="#99FFFF" style="text-align:center">DEBIT</th>
		<th width="15%" bgcolor="#ebdef0" style="text-align:center">CREDIT</th>
		<th width="11%" bgcolor="#ebdef0" style="text-align:center">BALANCE</th>
		<th width="11%" bgcolor="#ebdef0" style="text-align:center">PERCENTAGE</th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		if($_POST['ledger_group']) 		{$ledger_group_con=' and ledger_group_id="'.$_POST['ledger_group'].'"';}
		 ...
		 $sql_sub="select ledger_id, ledger_name from accounts_ledger where ledger_layer=1 ".$ledger_group_con." group by ledger_name";
			$data_sub=db_query($sql_sub);
		...
		<tr>
		  <td bgcolor="#CCCCCC">&nbsp;</td>
		  <td bgcolor="#CCCCCC"><div align="left" style="text-transform:uppercase; font-size:14px; font-weight:700;"><strong><?=$info_sub->ledger_name?></strong></div></td>
		  <td bgcolor="#CCCCCC">&nbsp;</td>
		  <td bgcolor="#CCCCCC">&nbsp;</td>
		  <td bgcolor="#CCCCCC">&nbsp;</td>
		  <td bgcolor="#CCCCCC">&nbsp;</td>
		...
		<tr <?=($xx%2==0)?' bgcolor="#CCCCCC"':'';$xx++;?>>
		<td><?=$sl++;?></td>
		<td><a href="customer_ledger_statment.php?show=show&fdate=<?=$_REQUEST['f_date']?>&tdate=<?=$_REQUEST['t_date']?>&ledger_id=<?=$row->ledger_id?>" target="_blank">
...
elseif($_REQUEST['report']==210617005)
{
		...
		<th width="36%" bgcolor="#99CCFF">ACCOUNT NO. </th>
		<th width="6%" bgcolor="#99CCFF" style="text-align:center">SIDE</th>
		<th width="9%" bgcolor="#99CCFF" style="text-align:center">OPENING</th>
		<th width="10%" bgcolor="#99CCFF" style="text-align:center">DEBIT</th>
		<th width="10%" bgcolor="#99CCFF" style="text-align:center">CREDIT</th>
		<th width="10%" bgcolor="#99CCFF" style="text-align:center">BALANCE</th>
		<th width="6%" bgcolor="#99CCFF" style="text-align:center">SIDE</th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		<?
 		 ...
 		 $sql="select a.bank_group,  b.ledger_id, b.bank_name as ledger_name, b.account_no from bank_group a, bank_ledger b  
