...
$title='Monthly Sales Comparison Reports';
							  ...
							  <tr>
                                ...
                                <td width="94%"><div align="left">Four(4) Months Area Report(CTR)</div></td>
																					 ...
																					 <tr>
																							...
																							<td><div align="left">MONTHLY PRODUCT SIZE WISE SALES REPORT (VALUE) </div></td>
																					 </tr>
																					 ...
																					 <tr>
																							...
																							<td><div align="left">MONTHLY PRODUCT SIZE WISE SALES REPORT (QUANTITY) </div></td>
																					 </tr>
																					 ...
																					 <!--<tr>
							  															  ...
							  															  <td><input name="report" type="radio" class="radio" value="3333334411" /></td>

																							<td><div align="left">MONTHLY PRODUCT GROUP WISE DEMEND REPORT (QUANTITY)</div></td>
																					 </tr>-->
...
document.getElementById('item_sub_group').value);">
				  ...
				  <tr>
                    ...
                    <td><select name="sale_type" id="sale_type"  >

                      <option></option>

                      <? foreign_relation('sale_type','sale_type','sale_type',$sale_type,' 1 order by id');?>
