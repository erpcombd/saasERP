...

{
          ...
          $sql="select g.group_name, s.sub_group_name, i.item_id, i.item_name, i.unit_name, i.item_short_name,  i.d_price,  i.status, i.finish_goods_code  from item_group g, item_sub_group s, item_info i where g.group_id=s.group_id and s.sub_group_id=i.sub_group_id ".$item_sub_group_con.$zon_id_con.$product_nature.$group_for_con.$group_id_con;
...
<td><?=$datas[1]?></td>
  ...
  <td><input name="finish_goods_code#<?=$datas[2]?>" type="text" id="finish_goods_code#<?=$datas[2]?>" value="<?=$datas[8]?>" style="width:150px;" /></td>
  <td>
  <input name="item_name#<?=$datas[2]?>" type="text" id="item_name#<?=$datas[2]?>" value="<?=$datas[3]?>" style="width:400px;" />  </td>

  <td><?=$datas[4]?></td>
  <td><input name="item_short_name#<?=$datas[2]?>" type="text" id="item_short_name#<?=$datas[2]?>" value="<?=$datas[5]?>" style="width:150px;" />  	  </td>
  <td><input name="d_price#<?=$datas[2]?>" type="text" id="d_price#<?=$datas[2]?>" value="<?=$datas[6]?>"  style="width:50px;" /></td>
  <td>
  ...
  <td><div id="po<?=$datas[2]?>"><input type="button" name="Change" value="Change" onclick="getData2('<?=$ajax_page?>', 'po<?=$datas[2]?>',<?=$datas[2]?>,
document.getElementById('finish_goods_code#<?=$datas[2]?>').value+'#'+
