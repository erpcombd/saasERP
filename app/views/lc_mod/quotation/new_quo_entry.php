...
while($row=mysqli_fetch_object($query)){
  ...
  $res='select  	o.req_no,o.id,o.item_id,a.req_no,a.req_no, a.req_date, a.req_for, b.warehouse_name as warehouse, a.req_note as note, a.need_by,a.vendor_status, c.fname as entry_by, a.entry_at,a.status,o.qty
 
 from requisition_order o,requisition_master a,warehouse b,user_activity_management c
 
 where  o.req_no=a.req_no and a.warehouse_id=b.warehouse_id and a.requisition_type=3 and  a.status in ("CHECKED","COMPLETED") and o.addi_status not in("QUOTATION_CREATED") and a.entry_by=c.user_id '.$con.$con2.'  order by a.req_no desc';
