...
//		}
     ...
     $res="select  m.* from   purchase_quotation_master pq, requisition_master m,  requisition_order d where pq.req_no=m.req_no and m.req_no=d.req_no and  m.status!='MANUAL'  ".$con." 
