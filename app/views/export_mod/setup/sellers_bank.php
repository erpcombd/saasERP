...
$title="SELLER'S BANK";			// Page Name and Page Title

do_datatable('table_head');

$page="sellers_bank.php";		// PHP File Name



$table='bank_sellers';		// Database Table Name Mainly related to this page

$unique='bank_id';			// Primary Key of this Database table
...
<th bgcolor="#45777B"><span class="style3">A/C No </span></th>
<th bgcolor="#45777B"><span class="style3">Swift Code </span></th>
</tr>
</thead>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.branch_name, a.account_no, a.swift_code from '.$table.' a	where 1 order by a.bank_id  ';
...
<? //}?>
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Seller Name:</td>
										...
										<select name="group_for" required id="group_for" style="width:220px; float:left;">
                      ...
                      <? foreign_relation('user_group','id','group_name',$group_for,'1');?>
                                        ...
                                        <td>
										<input name="bank_name" required type="text" id="bank_name" tabindex="1" value="<?=$bank_name?>"  style="width:220px;" >	
										</td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td>
										<input name="account_no"  type="text" id="account_no" tabindex="1" value="<?=$account_no?>"  style="width:220px;" >	
										</td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td>
										<input name="swift_code"  type="text" id="swift_code" tabindex="1" value="<?=$swift_code?>"  style="width:220px;" >	
										</td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td>
										<input name="ad_code"  type="text" id="ad_code" tabindex="1" value="<?=$ad_code?>"  style="width:220px;" >	
										</td>
                                      </tr>
                                     ...
                                     <td> Brance:</td>
                        				...
                        				<input name="branch_name"  type="text" id="branch_name" tabindex="1" value="<?=$branch_name?>"  style="width:220px;" >	
