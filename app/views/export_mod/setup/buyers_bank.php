...
$title="BUYER'S BANK";			// Page Name and Page Title

do_datatable('table_head');

$page="buyers_bank.php";		// PHP File Name



$table='bank_buyers';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Brance</span></th>
</tr>
</thead>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.branch_name, a.account_no, a.swift_code, a.dealer_code, a.branch_name from '.$table.' a	where 1 order by a.bank_id  ';
