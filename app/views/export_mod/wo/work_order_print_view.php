...
$master= find_all_field('sale_do_master_foreign','','do_no='.$do_no);
...
$ssql = 'select a.*,b.do_date, b.group_for, b.via_customer from dealer_info_foreign a, sale_do_master_foreign b where a.dealer_code=b.dealer_code and b.do_no='.$do_no;
...
$ordered_total_ctn = find_a_field('sale_do_details_foreign','sum(pkt_unit)','dist_unit = 0 and do_no='.$do_no);

$ordered_total_pcs = find_a_field('sale_do_details_foreign','sum(dist_unit)','do_no='.$do_no); 
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr>
		<td width="25%" valign="top"></td>
			<td width="50%" valign="middle" align="center"><strong></strong></td>
 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="96%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          <td align="left" valign="middle"><strong>WO No: </strong></td>
		          <td><strong><?php echo $master->wo_no;?></strong></td>
	            </tr>
		        <tr>
		          <td width="16%" align="left" valign="middle"><strong>Job No: </strong></td>
		          <td width="84%"><strong><?php echo $master->job_no;?></strong></td>
	            </tr>
		        <tr>
		          <td align="left" valign="middle"><strong>Customer Name: </strong></td>
		          <td><?= find_a_field('dealer_info_foreign','dealer_name_e','dealer_code="'.$master->dealer_code.'"');?></td>
	            </tr>
		        <tr>
			...
			<?php /*?><td width="32%" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="2"  style="font-size:11px">
			...
			<tr>
                ...
                <td width="66%" align="right" valign="middle"><strong> FSC  100% </strong></td>
			  ...
			  <tr>
                ...
                <td width="66%" align="right" valign="middle"><strong> FSC  MIX </strong></td>
				...
				<td align="right" valign="middle"><strong> FSC  RECYCLED </strong></td>
  ...
  <tr>
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr>
          <td width="2%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>SL</strong></td>
		   <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Measurement</strong></td>
          <td width="10%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Size </strong></td>
          <td width="6%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PO No</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Style No </strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Color</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Weight</strong></td>
   
          <td width="9%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>U.Price($US)</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Qty</strong></td>
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Amt in USD </strong></td>
          
        </tr>
        
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm, c.color, c.referance, c.pack_type, c.sst, c.total_weight, c.size from sale_do_details_foreign c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
        ...
        <tr style="font-size:10px;">
		  ...
		  ?>		  </td>
          <td align="center" valign="top"><?=$datac->total_weight;?></td>
 
          <td align="center" valign="top"><?=number_format($datac->unit_price,3);?></td>
          <td align="center" valign="top"><?=number_format($datac->total_unit,2); $grand_tot_unit1 +=$datac->total_unit; ?></td>
          <td align="center" valign="top"><?=number_format($datac->total_amt,2); $grand_tot_amt +=$datac->total_amt; ?></td>
        ...
        <td colspan="9" align="right" valign="middle"><strong> Total:</strong></td>
 
        <td align="center" valign="middle"><strong>
          <?=number_format($grand_tot_unit1,2) ;?>
        </strong></td>
        <td align="center" valign="middle"><strong>
          <?=number_format($grand_tot_amt,2) ;?>
        </strong></td>
  ...
  <tr>
  	<td colspan="2">
        ...
        <tr>
          <td colspan="4" width="50%"><?php /*?><table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_do_details_foreign c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.L_cm, c.W_cm, c.H_cm, c.measurement_unit order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_do_details_foreign c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
		  ...
		  <td colspan="3" width="40%">
			...
			<tr>
				...
				<td width="39%" align="center"><strong>
				  ...
				  $ <?=number_format($grand_tot_amt=find_a_field('sale_do_details_foreign','sum(total_amt)','do_no='.$master->do_no),2);?>
				</strong></td>
			</tr>
	  </table>
		  </td>
