	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr>
		  ...
		  <td rowspan="5" align="center">
		    ...
		    <? if ($ch_data->authorized_by>0) {?>
		  	<p style="font-size:16px; color:#000000; margin:0; padding: 0; font-family: 'Andina Demo'; font-weight:400; "> <?= find_a_field('authorized_by','authorized_by','id="'.$ch_data->authorized_by.'"');?></p>
