...
<tr>
  ...
  <th width="9%">Gate Pass </th>
  <th width="9%">Challan Date</th>
...
if($_POST['fdate']!=''&&$_POST['tdate']!='') $con .= ' and c.chalan_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
    ...
    $res="select c.chalan_no, c.gate_pass, c.chalan_date,  m.do_no, m.job_no, m.wo_no,  m.do_date, m.dealer_code, m.buyer_code, m.merchandizer_code,  d.dealer_name_e, c.entry_by, c.status from 
