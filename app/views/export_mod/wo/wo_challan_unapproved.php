...
$con .= ' and m.do_no in ('.$_POST['old_do_no'].') ';
  ...
  $res="select m.do_no as old_do_no, m.do_no,  d.chalan_no, d.chalan_date,  m.job_no, m.dealer_code, m.do_date,   m.buyer_code, m.merchandizer_code, m.status from sale_do_master m, sale_do_chalan d where m.do_no=d.do_no and d.status='UNCHECKED'  ".$con." group by d.chalan_no order by d.chalan_date, m.do_no ";
