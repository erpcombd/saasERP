  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
        ...
        <? foreign_relation('sale_sample_chalan','chalan_no','chalan_no',$_POST['chalan_no'],'1 group by chalan_no');?>
    	</select>
		</td>
      </tr>
...
if($_POST['fdate']!=''&&$_POST['tdate']!='') $con .= ' and c.chalan_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
    ...
    $res="select c.chalan_no, c.gate_pass, c.chalan_date,  m.do_no, m.job_no,  m.do_date, m.dealer_code, m.buyer_code, m.merchandizer_code,  d.dealer_name_e, c.entry_by, c.status from 
sale_sample_master m, sale_sample_chalan c, dealer_info d, user_group u 
where 
...
<tr <?=($data->RCV_AMT>0)?'style="background-color:#FFCCFF"':'';?>>
  ...
  <td><a title="Gate Pass Preview" target="_blank" href="gate_pass_print_view.php?v_no=<?=$data->chalan_no?>"  style=" font-weight:700; color:#000000" ><?=$data->gate_pass;?></a></td>
