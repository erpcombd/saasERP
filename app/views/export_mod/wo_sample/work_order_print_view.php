...
$master= find_all_field('sale_sample_master','','do_no='.$do_no);
...
$ssql = 'select a.*,b.do_date, b.group_for, b.via_customer from dealer_info a, sale_sample_master b where a.dealer_code=b.dealer_code and b.do_no='.$do_no;
...
$to_ctn = find_a_field('sale_sample_chalan','sum(pkt_unit)','chalan_no='.$chalan_no);

$to_pcs = find_a_field('sale_sample_chalan','sum(dist_unit)','chalan_no='.$chalan_no); 



$ordered_total_ctn = find_a_field('sale_sample_details','sum(pkt_unit)','dist_unit = 0 and do_no='.$do_no);

$ordered_total_pcs = find_a_field('sale_sample_details','sum(dist_unit)','do_no='.$do_no); 
 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr>
          ...
          <td width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Item Name </strong></td>
          <td width="4%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Style No </strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PO No </strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Additional Info</strong></td>
          <td width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Paper Combination</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Ply</strong></td>
          <td width="10%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Measurement</strong></td>
          <td width="5%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Printing Info </strong></td>
          <td width="5%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Date </strong></td>
          <td width="14%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Place </strong></td>
          <td width="17%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Delivery Address</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Unit Price </strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Quantity</strong></td>
        </tr>
        
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_sample_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
        ...
        <tr style="font-size:10px;">
          ...
          <td align="left" valign="top">
		   <? 
		  if ($datac->additional_info>0) {
		  echo find_a_field('additional_information','additional_information','id='.$datac->additional_info);
		  } else {
		  echo 'N/A';
		  }
		  ?>		  </td>
          ...
          <td align="center" valign="top"><?= find_a_field('delivery_place_info','address_e','id="'.$datac->delivery_place.'"');?></td>
  ...
  <tr>
  	<td colspan="2">
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_sample_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.L_cm, c.W_cm, c.H_cm, c.measurement_unit order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_sample_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
		  ...
		  <td colspan="3" width="40%">
			...
			<tr>
				...
				<td width="39%" align="center"><strong>
				  ...
				  $ <?=number_format($grand_tot_amt=find_a_field('sale_sample_details','sum(total_amt)','do_no='.$master->do_no),2);?>
				</strong></td>
			</tr>
	  </table>
		  </td>
