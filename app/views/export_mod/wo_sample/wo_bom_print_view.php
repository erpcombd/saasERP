    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr>
          ...
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Sqm</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Outer Liner</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>BFLUTE</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PLAIN MEDIUM</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>CFLUTE</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PLAIN MEDIUM</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>BFLUTE</strong></td>
          <td width="3%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>INNER LINER</strong></td>
        </tr>
        
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, c.sqm, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm ,  c.tot_sqm, c.gsm1, c.gsm1_qty, c.gsm2, c.gsm2_qty, c.gsm3, c.gsm3_qty, c.gsm4, c.gsm4_qty, c.gsm5, c.gsm5_qty, c.gsm6, c.gsm6_qty, c.gsm7, c.gsm7_qty from corrugation_details_bom c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.do_no='.$do_no.' group by c.id order by c.id asc';
        ...
        <tr style="font-size:10px;">
          ...
          <td align="center" valign="top"><?=$datac->tot_sqm;?></td>
          <td align="center" ><?=$datac->gsm1_qty; $tot_gsm1_qty +=$datac->gsm1_qty;?></td>
          <td align="center" ><?=$datac->gsm2_qty; $tot_gsm2_qty +=$datac->gsm2_qty;?></td>
          <td align="center" ><?=$datac->gsm3_qty; $tot_gsm3_qty +=$datac->gsm3_qty;?></td>
          <td align="center" ><?=$datac->gsm4_qty; $tot_gsm4_qty +=$datac->gsm4_qty;?></td>
          <td align="center" ><?=$datac->gsm5_qty; $tot_gsm5_qty +=$datac->gsm5_qty;?></td>
          <td align="center" ><?=$datac->gsm6_qty; $tot_gsm6_qty +=$datac->gsm6_qty;?></td>
          <td align="center" ><?=$datac->gsm7_qty; $tot_gsm7_qty +=$datac->gsm7_qty;?></td>
        </tr>
        ...
        <td align="center" valign="middle">&nbsp;</td>
        <td align="center" valign="middle"><?=$tot_gsm1_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm2_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm3_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm4_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm5_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm6_qty;?></td>
        <td align="center" valign="middle"><?=$tot_gsm7_qty;?></td>
        </tr>
      </table>
