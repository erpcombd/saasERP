...
$target_url = '../wo_sample/delivery_challan_print_view.php';
...
if(isset($_POST['approved'])){
	...
	$sql = "update sale_sample_chalan set status='CHECKED', checked_by='".$_POST['checked_by']."', checked_at='".$_POST['checked_at']."' where chalan_no=".$_POST['chalan_no']."";
	db_query($sql);
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
		...
		foreign_relation('sale_sample_master','do_no','job_no',$_POST['old_do_no'],'1');
...
$con .= ' and m.do_no in ('.$_POST['old_do_no'].') ';
  ...
  $res="select m.do_no as old_do_no, m.do_no,  d.chalan_no, d.chalan_date,  m.job_no, m.dealer_code, m.do_date,   m.buyer_code, m.merchandizer_code, m.status from sale_sample_master m, sale_sample_chalan d where m.do_no=d.do_no and d.status='UNCHECKED'  ".$con." group by d.chalan_no order by d.chalan_date, m.do_no ";
