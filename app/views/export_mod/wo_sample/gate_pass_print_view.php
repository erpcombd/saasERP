		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
	              ...
	              <td width="6%">PO No </td>
	              <td width="15%">: &nbsp;<?=$master->customer_po_no;?></td>
    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <?    $sqlc = 'select c.order_no, c.item_name as ch_item_name, c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, sum(c.bundle_1+c.bundle_2+c.bundle_3) as tot_bundle,
		 ...
		 from sale_sample_chalan c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.chalan_no='.$chalan_no.' and c.total_unit>0 group by c.item_id, c.L_cm, c.W_cm, c.H_cm, c.measurement_unit, c.ply  order by c.id asc';
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          ...
		          <td width="28%">:	&nbsp;
                    <?= find_a_field('dealer_info','dealer_name_e','dealer_code="'.$master->dealer_code.'"');?></td>
	              <td width="7%">PO No </td>
	              <td width="14%">: &nbsp;<?=$master->customer_po_no;?></td>
	              <td width="8%">Challan No </td>
	              <td width="11%">: &nbsp;<?=$ch_data->chalan_no;?></td>
	              <td width="8%">Vehicle No </td>
	              <td width="14%">: &nbsp;<?=$ch_data->vehicle_no;?></td>
