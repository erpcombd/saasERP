...
<!--<input  name="additional_info" type="hidden" class="input3" id="additional_info" style="width:60px; height:30px;"  readonly="" value="<?=$do_data->additional_info?>" />
-->
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select a.id, a.item_id, s.sub_group_name,  b.item_name, a.dealer_code,
...
<td align="center">
<span id="trrr<?=$data->id?>"><input name="<?='edit#'.$data->id?>" type="button" id="Edit" value="Edit" style="width:60px; height:30px; color:#000; font-weight:700" onclick="update_edit(<?=$data->id?>);start(this);"  />
</span></td>
