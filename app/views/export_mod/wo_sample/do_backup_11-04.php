...
<input type="hidden" id="job_no" name="job_no" value="<?=$job_no?>"  />
  ...
  <input   name="number_format" type="hidden" class="input3" id="number_format" style="width:60px; height:30px;" value="<?=$nom_digit;?>"  autocomplete="off"  />
  <input   name="style_no" type="text" class="input3" id="style_no" style="width:60px; height:30px;" value="<?=$_POST['style_no'];?>"  autocomplete="off"   tabindex="0"/>
  </span>  </td>
  <td width="4%" align="center" ><span class="style2">
  
 
  
  <input   name="po_no" type="text" class="input3" id="po_no" style="width:50px; height:30px;" value="<?=$_POST['po_no'];?>"  autocomplete="off"   tabindex="0"/>
...
<td width="8%" align="center" ><span class="style2">
		 ...
		 <input  type="text" name="destination" id="destination" class="input3" style="width:80px;  height:30px;"  value="<?=$_POST['destination'];?>"  autocomplete="off"   tabindex="0">
...
<input name="referance" type="text" class="input3" id="referance" style="width:60px; height:30px;" value="<?=$_POST['referance'];?>" autocomplete="off"   tabindex="0"/>
</span></td>
<td width="6%" align="center"><span class="style2">
<input name="sku_no" type="text" class="input3" id="sku_no" style="width:60px; height:30px;"  value="<?=$_POST['sku_no'];?>" autocomplete="off"    tabindex="0"/>
</span></td>
<td width="6%" align="center"><span class="style2">
...
<input  name="color" type="text" class="input3" id="color" style="width:60px; height:30px;" value="<?=$_POST['color'];?>"  autocomplete="off"   tabindex="0"/>
</span></td>
<td width="8%" align="center" ><span class="style2"> 
...
<input list="additional_information" name="additional" id="additional"  style="width:120px;  height:30px;"  onchange="getData2('additional_charge_ajax.php', 'additional_filter', this.value, document.getElementById('additional').value);"  autocomplete="off"   >
  <datalist id="additional_information">
	  ...
	  'dealer_code="'.$dealer_code.'" and buyer_code="'.$buyer_code.'" and approval="Yes" order by additional_information');?>
  </datalist>
</span></td>
...
<tr bgcolor="#CCCCCC">
  <td width="4%" align="center"><span class="style2">
<input   name="L_cm" type="text" class="input3" id="L_cm" style="width:35px; height:30px;"  value=""  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span></td>


  <td width="4%" align="center">
  <span class="style2">
<input  name="W_cm" type="text" class="input3" id="W_cm" style="width:35px; height:30px;"  value=""  autocomplete="off"  required="required"  onchange="count_formula()" tabindex="0"/>
</span>  </td>
  <td width="8%" align="center">
  <span class="style2">
<input name="H_cm" type="text" class="input3" id="H_cm" style="width:35px; height:30px;"  value=""  autocomplete="off"  required="required" onchange="count_formula()" tabindex="0"/>
</span>  </td>
  <td width="8%" align="center" ><span class="style2">
<select  name="ply" id="ply"  style="width:50px; height:30px;" required  onchange="getData2('paper_combination_ajax.php', 'paper_comb_filter', this.value, document.getElementById('do_no').value);">
...
<span id="sqm_filter">
<input  name="sqm_rate" type="text" class="input3" id="sqm_rate" style="width:55px; height:30px;" readonly=""  required="required"  tabindex="0"/>
</span>

</span></td>
<td width="8%" align="center"><span class="style2">
<span id="sqm_filter">
<input placeholder="Quantity" name="total_unit" type="text" class="input3" id="total_unit" style="width:70px; height:30px;"  value="<?=$_POST['total_unit'];?>" required="required"  onchange="count_formula()" />
</span>


 </span></td>
<td width="8%" align="center"><span class="style2">
  <input name="final_price" type="text"  readonly="" required class="input3" id="final_price" style="width:60px; height:30px;" utocomplete="off"  onchange="count_formula()" />
</span></td>
<td width="8%" align="center">
<span class="style2">
<input name="unit_price" type="text" class="input3" id="unit_price"  style="width:60px; height:30px;" required utocomplete="off"  onchange="TRcalculation()" />
 </span></td>
<td width="8%" align="center">
<span class="style2"> 
<input placeholder="Total Amt" name="total_amt" type="text" class="input3" required utocomplete="off"  id="total_amt" style="width:70px; height:30px;" />
</span></td>
<td width="5%" align="center">
...
<select  name="delivery_place" id="delivery_place"  style="width:90px; height:30px;" required="required">
    <option></option>
    <? foreign_relation('delivery_place_info','id','delivery_place',$_POST['delivery_place'],'dealer_code="'.$dealer_code.'"');?>
  </select> </span></td>
<td width="6%" align="center">
<span class="style2">
 <input  name="delivery_date" type="text" class="input3" id="delivery_date" style="width:90px; height:30px;" utocomplete="off" value="<?=$_POST['delivery_date'];?>" />
</span></td>
</tr>
...
//, (a.init_pkt_unit*a.unit_price) as Total,(a.init_pkt_unit-a.inStock_ctn) as Shortage
  ...
  $res='select a.id, a.item_id, s.sub_group_name,  b.item_name, a.additional_info, a.printing_info,  a.ply, a.paper_combination, a.L_cm, a.W_cm, a.H_cm, a.measurement_unit, a.unit_price, a.final_price, a.total_unit, a.total_amt from sale_do_details a, item_info b, item_sub_group s where b.item_id=a.item_id  and b.sub_group_id=s.sub_group_id and a.do_no='.$$unique_master.' order by a.id desc';
...
<th width="5%"> Pcs Price </th>
<th width="5%"> Negotiate Price </th>
