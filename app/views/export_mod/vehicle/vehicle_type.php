...
$table='vehicle_type';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='vehicle_type';				// For a New or Edit Data a must have data field
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Vehicle Type:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="vehicle_type" required type="text" id="vehicle_type" tabindex="1" value="<?=$vehicle_type?>"  style="width:220px;" >	
