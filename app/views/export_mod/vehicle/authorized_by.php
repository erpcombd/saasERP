...
$title='Prepared By';			// Page Name and Page Title

do_datatable('table_head');

$page="authorized_by.php";		// PHP File Name



$table='authorized_by';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='authorized_by';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Authorized By </span></th>
<th bgcolor="#45777B"><span class="style3">Designation</span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.designation, a.status from '.$table.' a where 1  '.$con.' order by a.id  ';
                                ...
                                <tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Authorized By:</td>

                                        <td>
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                       					<input name="id" type="hidden" id="id" tabindex="1" value="<?=$id?>" readonly>
                        				<input name="authorized_by" required type="text" id="authorized_by" tabindex="1" value="<?=$authorized_by?>"  style="width:220px;" >	
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Designation:</td>
                        				...
                        				<input name="designation" required type="text" id="designation" tabindex="1" value="<?=$designation?>"  style="width:220px;" >	
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;"></span>Status:</td>

                                        <td>
										
										<select name="status" required id="status" style="width:220px;" tabindex="7" >
