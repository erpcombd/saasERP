...
$title='Beneficiary Bank';			// Page Name and Page Title

do_datatable('table_head');

$page="beneficiary_bank.php";		// PHP File Name



$table='bank_beneficiary';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Branch</span></th>
