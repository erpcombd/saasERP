...
$title='Delivery Man';			// Page Name and Page Title

do_datatable('table_head');

$page="delivery_man.php";		// PHP File Name



$table='delivery_man';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='delivery_man';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Delivery Man </span></th>

<th bgcolor="#45777B"><span class="style3">Mobile No</span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.mobile, a.status from '.$table.' a,  user_group u	where a.group_for=u.id   '.$con.' order by a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Delivery Man:</td>
                        				...
                        				<input name="delivery_man" required type="text" id="delivery_man" tabindex="1" value="<?=$delivery_man?>"  style="width:220px;" >	
                                     ...
                                     <td> Mobile No:</td>
                        				...
                        				<input name="mobile"  type="text" id="mobile" tabindex="1" value="<?=$mobile?>"  style="width:220px;" >	
