...
$title='Vehicle Info';			// Page Name and Page Title

do_datatable('table_head');

$page="vehicle_info.php";		// PHP File Name



$table='vehicle_registration';		// Database Table Name Mainly related to this page

$unique='vehicle_id';			// Primary Key of this Database table

$shown='vehicle_name';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Vehicle Name </span></th>

<th bgcolor="#45777B"><span class="style3">Vehicle No</span></th>
<th bgcolor="#45777B"><span class="style3">Driver</span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.', a.registration_no, a.driver_name, a.status from '.$table.' a,  user_group u	where a.group_for=u.id   '.$con.' order by a.vehicle_id  ';
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Vehicle Name:</td>
                        				...
                        				<input name="vehicle_name" required type="text" id="vehicle_name" tabindex="1" value="<?=$vehicle_name?>"  style="width:220px;" >	
									  ...
									  <tr>
										...
										<select name="vehicle_type" required id="vehicle_type"  tabindex="7" style="width:220px;">
										<option></option>
                      ...
                      <? foreign_relation('vehicle_type','id','vehicle_type',$vehicle_type,'1');?>
                                     ...
                                     <td>Vehicle No:</td>
                        				...
                        				<input name="registration_no" required type="text" id="registration_no" tabindex="1" value="<?=$registration_no?>"  style="width:220px;" >	
                                     ...
                                     <td>Driver Name:</td>
                        				...
                        				<input name="driver_name"  type="text" id="driver_name" tabindex="1" value="<?=$driver_name?>"  style="width:220px;" >	
                                     ...
                                     <td>Driver Mobile:</td>
                        				...
                        				<input name="driver_mobile"  type="text" id="driver_mobile" tabindex="1" value="<?=$driver_mobile?>"  style="width:220px;" >	
