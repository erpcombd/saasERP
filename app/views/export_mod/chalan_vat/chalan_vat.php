...
<table width="80%" border="0" align="center">
  ...
  <tr>
    ...
    <td bgcolor="#FF9966"><input name="fdate" type="text" id="fdate" style="width:107px;" value="<?=$fdate?>" /></td>
    <td align="center" bgcolor="#FF9966">TO </td>
    <td align="right" bgcolor="#FF9966"><input name="tdate" type="text" id="tdate" style="width:107px;" value="<?=$tdate?>" /></td>
    <td bgcolor="#FF9966">&nbsp;</td>
  </tr>
  <tr>
    <td align="right" bgcolor="#FF9966"><strong>Depot : </strong></td>
...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0">
  <tr>
    <th width="2%">S/L</th>
    <th width="10%"><div align="center">Challan No </div></th>
    <th width="5%"><div align="center">Do No </div></th>
    <th width="14%"><div align="center">Chalan Date</div></th>
    <th width="31%">Dealer Name</th>
    <th width="11%">Area</th>
    <th width="14%"><div align="center">Total Chalan Amt </div></th>
    <th width="3%"><div align="center">VAT</div></th>
