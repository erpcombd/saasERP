		  ...
		  <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-info">
                  ...
                  <p class="card-category" style="color:#FFFFFF">TOTAL SALES</p>
                  <h3 class="card-title"><?=$cur.number_format(find_a_field('sale_do_chalan','sum(total_amt)','1 and chalan_date="'.$today.'"'),0);?></h3>
                </div>
				
				
                <div class="card-footer">
                  <div class="stats">
				  <i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> Last 24 Hours
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-stats">
                <div class="card-header card-header-danger">
                  ...
                  <p class="card-category" style="color:#FFFFFF">TOTAL POS SALES</p>
                  <h3 class="card-title"><?=$cur.number_format(find_a_field('pos_payment','sum(total_amt)','1 and created_at = "'.$today.'"'),0);?></h3>
                </div>
                <div class="card-footer">
                  <div class="stats">
				     <i class="fa-solid fa-tag pt-1 mr-1"></i> Last 24 Hours
                  </div>
                </div>
              </div>
            </div>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                <div class="card-header card-header-primary">
                  ...
                  <p class="card-category" style="color:#FFFFFF">TOTAL COMMISSION</p>
			...
			<div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
				   <i class="fa-solid fa-calendar-days pt-1 mr-1"></i> Last 24 Hours
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">
                    <span class="text-success"><i class="fa-solid fa-arrow-up"></i> 55% </span> increase in today sales.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                 ...
                 <p class="card-category">
                    <span class="text-success"><i class="fa-solid fa-arrow-up"></i> 40% </span> increase in Collection.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
				  <i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> Last 7 Days
            ...
            <div class="col-md-4">
              <div class="card card-chart">
                ...
                <div class="card-body">
                  ...
                  <p class="card-category">
                    <span class="text-success"><i class="fa-solid fa-arrow-up"></i> 15% </span> Increase in Sales Return.</p>
                </div>
                <div class="card-footer">
                  <div class="stats">
				  <i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> Last 7 Days
		  ...
		  <div class="col-md-12">
			...
			<div class="card card-chart">
                ...
                <div class="card-body">
                 ...
                 <p class="card-category">
                    <span class="text-success"><i class="fa-solid fa-arrow-up"></i> 15% </span> increase. </p>
                </div>
		  ...
		  <div class="row">
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="card card-stats">
                ...
                <div class="card-footer">
                  <div class="stats">
				  <i class="fa-solid fa-tag pt-1 mr-1"></i> Tracked from Warehouse
                  </div>
                </div>
              </div>
            </div>
