...
$do_master = find_all_field('sale_do_master','','do_no='.$pi_d->do_no); 
                      ...
                      <tr>
                        <td width="68%">
                       		<table  width="97%" border="0" cellspacing="0" cellpadding="0"  style="font-size:15px">
								<tr>
					    <td width="50%" align="left" style="padding-bottom:0px;"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['user']['depot']?>.png"  width="35%" /></td>
                        ...
                        <td width="32%"> 
							<table width="100%" border="0" cellspacing="0" cellpadding="0" style="font-size:15px">
							  ...
							  <tr>
									...
									<tr>
									  <td style="padding-bottom:3px; font-size:12px;">Zerabo, Ashulia, Savar, Dhaka.</td>
									</tr>
 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
			...
			<tr>
			  ...
			  <? if($do_master->fsc_claim==4) {?>
			  <tr>
			    <td align="right" valign="middle"><div align="left">FSC MIX CREDIT</div></td>
			    <td>: </td>
			    <td><table width="100%" border="1" cellspacing="0" cellpadding="1">
                  <tr height="20">
                    <td>&nbsp; <img src="tick.png" width="30"  style="padding:2px 0 0 0;"/> </td>
                  </tr>
                </table></td>
			  </tr>
			  <? }?>
	...
	<tr>
	  <td colspan="3" valign="top" style="font-size:13px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px" ><div align="justify">This Proforma Invoice (PI) has been issued in relation to the Purchase Order (PO) number 
	    <b>  
	      <?  
$o=0;
		$po_sql = 'SELECT m.customer_po_no, m.customer_po_date, m.job_no FROM pi_details p, sale_do_master m WHERE p.do_no=m.do_no and p.pi_id="'.$pi_no.'" GROUP by p.do_no ';
    ...
    <td colspan="2">
      ...
      <table width="100%" class="tabledesign"   border="1" bordercolor="#CCCCCC" cellspacing="0" cellpadding="5"  style="font-size:12px">
        ...
        <tr >
          ...
          <td width="10%" align="center"  bgcolor="#CCCCCC">Style No </td>
          <td width="9%" align="center"  bgcolor="#CCCCCC">PO No </td>
          <td width="9%" align="center"  bgcolor="#CCCCCC">Referance </td>
          <td width="4%" align="center"  bgcolor="#CCCCCC">UOM</td>
          <td width="7%" align="center" bgcolor="#CCCCCC">Quantity</td>
