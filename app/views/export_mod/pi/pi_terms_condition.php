...
$title='PI Terms & Condition';			// Page Name and Page Title

//do_datatable('table_head');

$page="pi_terms_condition.php";		// PHP File Name



$table='pi_terms_condition';		// Database Table Name Mainly related to this page
  ...
  <tr>
    ...
    <td valign="top" width="60%"><div class="left">
		    ...
		    PI No:                                       </td>
										...
										<select name="pi_no"  id="pi_no"  tabindex="7" style="width:220px;">
										<option></option>
...
<thead>
<tr>
  <th bgcolor="#45777B"><span class="style3">Sl No </span></th>

<th bgcolor="#45777B"><span class="style3">Terms & Condition: </span></th>

<th bgcolor="#45777B"><span class="style3">PI No </span></th>
</tr>
</thead>
...
//$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.sl_no, a.pi_id from '.$table.' a	where 1  '.$con.' order by a.pi_id, a.id ';
...
<td><?=find_a_field('pi_master','pi_no','id='.$rp[3]);?></td>
</tr>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Terms & Condition:</td>
                        				...
                        				<input name="terms_condition" required type="text" id="terms_condition" tabindex="1" value="<?=$terms_condition?>"  style="width:220px;" >										</td>
                                      </tr>
                                     ...
                                     <td>Sl No:</td>
                        				...
                        				<input name="sl_no" required type="text" id="sl_no" tabindex="1" value="<?=$sl_no?>"  style="width:220px;" >										</td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td><select name="pi_id" required id="pi_id"  tabindex="7" style="width:220px;">
										<option></option>
                                          <? foreign_relation('pi_master','id','pi_no',$pi_id,'1');?>
                                        </select></td>
                                      </tr>
