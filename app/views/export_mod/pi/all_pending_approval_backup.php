...
<table width="80%" border="0" align="center">
      ...
      <tr>
        <td align="right" bgcolor="#FF9966"><strong>Approve Date:</strong></td>
        <td width="16%" bgcolor="#FF9966"><input type="hidden" name="fdate" id="fdate" style="width:120px;" value="<?=$_POST['fdate']?>" />
		<input type="text" name="app_date" id="app_date" style="width:120px;" value="<?=date('Y-m-d')?>" />		</td>
        <td width="34%" bgcolor="#FF9966"><input type="hidden" name="tdate" id="tdate" style="width:120px;" value="<?=$_POST['tdate']?>" /></td>
