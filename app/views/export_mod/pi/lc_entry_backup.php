...
$shown='pi_no';				// For a New or Edit Data a must have data field
							...
							<tr>
							  ...
							  <td width="100%" colspan="2"><div class="box" style="width:100%;">
								...
								<?
									 ...
									 $pi_no_generate='NPL-'.$year.''.$month.''.$cy_id;
									 
									 
								?>
								
								<input name="pi_no" type="text" id="pi_no" style="width:220px;" value="<?=$pi_no_generate?>" readonly="" tabindex="105" />
...
onchange="getData2('job_no_ajax.php', 'pi_no', this.value,document.getElementById('id').value);" />
									...
									<td>&nbsp;&nbsp;&nbsp;Remarks:</td>
									<td><input name="remarks" type="text" id="remarks" tabindex="1" value="<?=$remarks?>"  style="width:220px;" />										</td>
								  </tr></table>
...
$td='select a.'.$unique.',  a.'.$shown.',  a.pi_date, a.pi_type, a.dealer_group, a.dealer_code from '.$table.' a	where a.pi_type!=1 order by a.id  ';
