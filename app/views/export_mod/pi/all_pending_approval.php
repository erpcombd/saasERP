...
<table width="100%" border="0" align="center" id="grp" cellpadding="0" cellspacing="0" style="font-size:10px; text-transform:uppercase;">
  ...
  <tr>
    ...
    <th width="10%">Pending Value/ <br />Over 90 Days </th>
