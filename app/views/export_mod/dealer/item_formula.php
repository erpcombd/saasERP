...
$title='Item Formula';			// Page Name and Page Title

do_datatable('vendor_table');

$page="item_formula.php";		// PHP File Name

$table='item_formula';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='formula_name';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Formula Name </span></th>

<th bgcolor="#45777B"><span class="style3">Item Formula</span></th>
</tr>
</thead>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select '.$unique.',  '.$shown.', item_formula from '.$table.' 
				where 1 order by id  ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Formula Name:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="formula_name" required type="text" id="formula_name" tabindex="2" value="<?=$formula_name?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Item Formula: </td>

                                        <td>

                                       <input name="item_formula" type="text" id="item_formula" tabindex="2" value="<?=$item_formula?>" style="width:250px;">
