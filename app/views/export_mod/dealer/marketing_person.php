...
$title='Marketing Person Setup';			// Page Name and Page Title

do_datatable('vendor_table');

$page="marketing_person.php";		// PHP File Name

$table='marketing_person';		// Database Table Name Mainly related to this page

$unique='person_code';			// Primary Key of this Database table

$shown='marketing_person_name';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Marketing Team</span></th>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select '.$unique.',  '.$shown.', team_code, status from '.$table.' 
				where 1 order by team_code  ';
...
<td><?=find_a_field('marketing_team','team_name','team_code="'.$rp[2].'"');?></td>
<td><?=$rp[3];?></td>
</tr>
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <input name="marketing_person_name" required type="text" id="marketing_person_name" tabindex="2" value="<?=$marketing_person_name?>" style="width:220px;"></td>
									  </tr>
									  
									  
									  <tr>

                                        <td><span class="style1" style="padding-top:5px;">*</span>Marketing Team:</td>

                                        <td>
										
										<select name="team_code" required id="team_code" style="width:220px;" tabindex="7" >
										<option></option>

                     					 <? foreign_relation('marketing_team','team_code','team_name',$team_code,'1');?>
                   						 </select></td>
                                      </tr>
									  ...
									  <tr>
                                       ...
                                       <input name="contact_person" type="text" id="contact_person" tabindex="2" value="<?=$contact_person?>" style="width:220px;">
									  ...
									  <tr>
                                       ...
                                       <input name="mobile_no" type="text" id="mobile_no" tabindex="2" value="<?=$mobile_no?>" style="width:220px;">
									  ...
									  <tr>
                                       ...
                                       <input name="email" type="text" id="email" tabindex="2" value="<?=$email?>" style="width:220px;">
									  ...
									  <tr>
										...
										<select name="group_for" required id="group_for" style="width:220px;" tabindex="7" >
					  ...
					  id="'.$_SESSION['user']['group'].'"');?>
									 ...
									 <tr>
                                        ...
                                        <td><select name="status" id="status" style="width:220px;"  tabindex="10">
