...
value="<?=$_POST['op_date']?>" size="30" maxlength="100" readonly minlength="4" /></td>
				  </tr>
				...
				<td><table width="100%" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FF9999">
                  ...
                  <tr>
                    ...
                    <td rowspan="2" bgcolor="#99CCCC"><input type="submit" name="submitit" id="submitit" value="Set Opening Balance" style="width:170px; font-weight:bold; font-size:12px; height:30px; color:#090"/></td>
                  </tr>
                  <tr>
                    <td bgcolor="#99CCCC"><div align="right"><span class="style5">Ledger Group:</span></div></td>
                    <td bgcolor="#99CCCC"><div align="center">
                      <select name="group_id" id="group_id" style="width:400px; font-size:12px; font-weight:bold;">
                        <?

foreign_relation('ledger_group','group_id','group_name',$_POST['group_id'],'group_for="'.$_SESSION['user']['group'].'" and (group_id like "1002") ');
...
//$jv->dr_amt = $opening;
      ...
      <td align="center"><span id="divi_<?=$data[0]?>">
            ...
            <? 
			  ...
			  <input type="button" name="Button" value="Edit"  onclick="update_value(<?=$data[0]?>)" style="width:60px; height:30px; background-color:#FF3366"/><?
			  ...
			  <input type="button" name="Button" value="Save"  onclick="update_value(<?=$data[0]?>)" style="width:60px; height:30px;background-color:#66CC66"/><? }?>
