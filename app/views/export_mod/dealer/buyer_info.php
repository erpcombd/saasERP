...
$title='ADD Buyer Information';			// Page Name and Page Title
...
$table='buyer_info';		// Database Table Name Mainly related to this page

$unique='buyer_code';			// Primary Key of this Database table
...
<th bgcolor="#45777B"><span class="style3">Buyer Name </span></th>
</tr>
</thead>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select a.'.$unique.',  a.'.$shown.' as customer_name from '.$table.' a, user_group u
				where   a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.buyer_code asc ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Buyer Name:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="buyer_name" required type="text" id="buyer_name" tabindex="2" value="<?=$buyer_name?>" style="width:250px;"></td>
									  </tr>
