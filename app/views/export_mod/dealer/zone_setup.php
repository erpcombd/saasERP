...
$title='Zone Setup';			// Page Name and Page Title

do_datatable('vendor_table');

$page="zone_setup.php";		// PHP File Name
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Zone Name </span></th>
  </tr>
</thead>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <input name="ZONE_NAME" required type="text" id="ZONE_NAME" tabindex="2" value="<?=$ZONE_NAME?>" style="width:250px;"></td>
									  </tr>
