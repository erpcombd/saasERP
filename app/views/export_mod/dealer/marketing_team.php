...
$title='Marketing Team Setup';			// Page Name and Page Title

do_datatable('vendor_table');

$page="marketing_team.php";		// PHP File Name

$table='marketing_team';		// Database Table Name Mainly related to this page

$unique='team_code';			// Primary Key of this Database table

$shown='team_name';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Team Name </span></th>

  <th bgcolor="#45777B"><span class="style3">Contact Person</span></th>
</tr>
</thead>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select '.$unique.',  '.$shown.', contact_person from '.$table.' 
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Team Name:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="team_name" required type="text" id="team_name" tabindex="2" value="<?=$team_name?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
                                       ...
                                       <input name="contact_person" type="text" id="contact_person" tabindex="2" value="<?=$contact_person?>" style="width:250px;">
									  ...
									  <tr>
                                       ...
                                       <input name="mobile_no" type="text" id="mobile_no" tabindex="2" value="<?=$mobile_no?>" style="width:250px;">
									  ...
									  <tr>
                                       ...
                                       <input name="email" type="text" id="email" tabindex="2" value="<?=$email?>" style="width:250px;">
