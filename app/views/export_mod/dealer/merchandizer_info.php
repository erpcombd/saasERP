...
$title='ADD Merchandiser Information';	// Page Name and Page Title

do_datatable('vendor_table');			

$page="merchandizer_info.php";			// PHP File Name

$table='merchandizer_info';				// Database Table Name Mainly related to this page

$unique='merchandizer_code';			// Primary Key of this Database table

$shown='merchandizer_name';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Merchandiser</span></th>
...
$con .='and a.merchandizer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select a.'.$unique.', a.'.$shown.', d.dealer_group from '.$table.' a, dealer_group d
				where   d.id=a.dealer_group   and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.merchandizer_code asc ';
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Merchandiser:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="merchandizer_name" required type="text" id="merchandizer_name" tabindex="2" value="<?=$merchandizer_name?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
										...
										<select name="dealer_group" required id="dealer_group" style="width:250px;" >
										<option></option>
									  ...
									  <tr>
                                       ...
                                       <input name="contact_person" type="text" id="contact_person" tabindex="2" value="<?=$contact_person?>" style="width:250px;"></td>
									  </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="email" type="text" id="email" tabindex="8" value="<?=$email?>" required style="width:250px;">
						 ...
						 <input name="entry_by" type="hidden" required id="entry_by" tabindex="10" value="<?=$_SESSION['user']['id']?>"  style="width:250px;"/></td>
									  ...
									  <tr>
                                        ...
                                        <td><input name="password" type="password" id="password"  required tabindex="8" value="<?=$password?>" style="width:250px;">
                                      ...
                                      <!--<tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Location:</td>

                                        <td><select name="area_code" required id="area_code" style="width:250px;" tabindex="7" >
					  
					  <option></option>

                      <? foreign_relation('area','AREA_CODE','AREA_NAME',$area_code,' 1');?>
                    </select></td>
									  </tr>-->
									  ...
									  <tr>
                                        ...
                                        <td><input name="address_e" type="text" id="address_e" tabindex="4" value="<?=$address_e?>" style="width:250px;"></td>
									  </tr>
