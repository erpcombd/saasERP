...
create_combobox('zone_code');

// ::::: Edit This Section ::::: 

$title='ADD Delivery Place Information';			// Page Name and Page Title

do_datatable('vendor_table');

$page="delivery_place.php";		// PHP File Name

$table='delivery_place_info';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='delivery_place';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Delivery Place </span></th>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';





  $td='select a.'.$unique.',  a.'.$shown.', c.dealer_name_e from '.$table.' a, user_group u, dealer_info c
				where   a.group_for=u.id  and c.dealer_code=a.dealer_code and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.id asc ';
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Delivery Place:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="delivery_place" required type="text" id="delivery_place" tabindex="2" value="<?=$delivery_place?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
										...
										<select name="dealer_code" required id="dealer_code" style="width:250px;" tabindex="7" >
										<option></option>
                      ...
                      <? foreign_relation('area','AREA_CODE','AREA_NAME',$area_code,' 1');?>
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Zone Name:</td>

                                        <td>
										
										<select name="zone_code" id="zone_code" style="width:250px;" tabindex="7" >
										<option></option>
