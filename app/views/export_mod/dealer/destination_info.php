...
$title='Destination Info';			// Page Name and Page Title

do_datatable('vendor_table');

$page="destination_info.php";		// PHP File Name

$table='destination_info';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='destination_name';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Destination Name </span></th>
  </tr>
</thead>
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select '.$unique.',  '.$shown.' from '.$table.' 
				where 1 order by id  ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Destination Name:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                       <input name="destination_name" required type="text" id="destination_name" tabindex="2" value="<?=$destination_name?>" style="width:200px;">
