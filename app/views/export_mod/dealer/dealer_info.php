...
$table='dealer_info_foreign';		// Database Table Name Mainly related to this page
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Customer Group</span>  </th>
  <th bgcolor="#45777B"><span class="style3">Customer Name </span></th>

<th bgcolor="#45777B"><span class="style3">Marketing Person </span></th>
</tr>
</thead>
...
$con .='and a.dealer_code like "%'.$_POST['customer_code'].'%" ';
   ...
   $td='select a.'.$unique.',  a.'.$shown.' as customer_name, a.dealer_group, a.marketing_person from '.$table.' a, user_group u
...
<tr<?=$cls?> onclick="DoNav('<?php echo $rp[0];?>');">
  ...
  <td><?=find_a_field('dealer_group','dealer_group',"id=".$rp[2]);?> </td>
  <td><?=$rp[1];?></td>

<td><?=find_a_field('marketing_person','marketing_person_name',"person_code=".$rp[3]);?> </td>
</tr>
...
<? //}?>
    ...
    <td valign="top" width="40%"><div class="right">    <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <input name="dealer_name_e" required type="text" id="dealer_name_e" tabindex="2" autocomplete="off"  value="<?=$dealer_name_e?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Customer Group:</td>

                                        <td>
										
										<select name="dealer_group" required id="dealer_group" style="width:220px;" tabindex="3" >
											<option></option>

                      						<? foreign_relation('dealer_group','id','dealer_group',$dealer_group,'1');?>
                   						</select></td>
                                      </tr>
									   ...
									   <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Marketing Person:</td>

                                        <td>
										
										<select name="marketing_person" required id="marketing_person" style="width:220px;" tabindex="4" >
											<option></option>

                      						<? foreign_relation('marketing_person','person_code','marketing_person_name',$marketing_person,'status="Active"');?>
                   						</select></td>
                                      </tr>
									   ...
									   <tr>
                                        ...
                                        <td><input name="mobile_no" type="text" id="mobile_no" tabindex="6" value="<?=$mobile_no?>"  autocomplete="off"  style="width:250px;"/></td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="email" type="text" id="email" tabindex="7" value="<?=$email?>" autocomplete="off"  style="width:250px;">
						
						
					
						
						
						 <input name="entry_by" type="hidden" required id="entry_by" tabindex="10" value="<?=$_SESSION['user']['id']?>"  style="width:250px;"/></td>
                                      </tr>
									  ...
									  <tr>
                                        ...
                                        <td><input name="address_e" type="text" id="address_e" tabindex="8" value="<?=$address_e?>" autocomplete="off"  style="width:250px;"></td>
									  </tr>
                                      ...
                                      <tr>
										...
										<select name="group_for" required id="group_for" style="width:250px;" tabindex="9" >

                      <? foreign_relation('user_group','id','group_name',$group_for,'
					  id="'.$_SESSION['user']['group'].'"');?>
                    </select>
					
					<input name="depot" type="hidden" id="depot" tabindex="20" value="1" autocomplete="off"  style="width:250px;">
									  ...
									  <tr>
                                        ...
                                        <td><select name="status" id="status" style="width:250px;"  tabindex="10">
                  ...
                  <td><div class="button">
                      ...
                      <input name="insert" type="submit" id="insert" value="SAVE" class="btn" tabindex="11" />
                      <? }?>
                    </div></td>
                  <td><div class="button">
                      <? if(isset($_GET[$unique])){?>
