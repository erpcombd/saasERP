...
$title='Customer Group';			// Page Name and Page Title

do_datatable('vendor_table');

$page="dealer_group.php";		// PHP File Name



$table='dealer_group';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='dealer_group';				// For a New or Edit Data a must have data field
...
$con .='and a.buyer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select a.'.$unique.',  a.'.$shown.' from '.$table.' a, user_group u
				where   a.group_for=u.id  and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.id asc ';
    ...
    <td valign="top" width="40%"><div class="right">   <form action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Group Name:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                                        <input name="dealer_group" required type="text" id="dealer_group" tabindex="1" value="<?=$dealer_group?>"  autocomplete="off" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
                                       ...
                                       <input name="contact_person" type="text" id="contact_person" tabindex="2" value="<?=$contact_person?>" autocomplete="off" style="width:250px;"></td>
									  </tr>
									   ...
									   <tr>
                                        ...
                                        <td><input name="mobile_no" type="text" id="mobile_no" tabindex="3" value="<?=$mobile_no?>" autocomplete="off"  style="width:250px;"/></td>
                                      </tr>
                                      ...
                                      <tr>
                                        ...
                                        <td><input name="email" type="text" id="email" tabindex="4" value="<?=$email?>" autocomplete="off" style="width:250px;">
                      ...
                      <? foreign_relation('area','AREA_CODE','AREA_NAME',$area_code,' 1');?>
									  ...
									  <tr>
                                        ...
                                        <td><input name="address_e" type="text" id="address_e" tabindex="5" value="<?=$address_e?>" autocomplete="off" style="width:250px;"></td>
									  </tr>
                                      ...
                                      <tr>
										...
										<select name="group_for" required id="group_for" style="width:250px;" tabindex="6" >
