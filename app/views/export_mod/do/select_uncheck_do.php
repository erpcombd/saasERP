...
$title='Unapproved Sales Requisition';
do_calander('#fdate');
do_calander('#tdate');
...
//where m.status in ('PROCESSING') and d.area_code=a.AREA_CODE  and m.dealer_code=d.dealer_code ".$con." and d.dealer_type='Distributor' order by m.do_date,d.dealer_name_e";
 ...
 $res="select m.do_no,m.do_date,concat(d.dealer_code,'- ',d.dealer_name_e) as dealer_name,  concat(m.payment_by) as Payment_Details,m.rcv_amt, m.mr_no from 
