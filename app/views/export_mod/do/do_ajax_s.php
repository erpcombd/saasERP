...
<td><input name="item_description" type="text" class="input3" id="item_description"  style="width:260px;" required="required" tabindex="3" value="<?=$item_all->item_name?>" onfocus="focuson('pkt_unit')"/></td>
...
<input name="unit_name" type="text" class="input3" id="unit_name"  style="width:55px;" value="<?=$item_all->unit_name?>"/>
</td>


<td>

<input name="unit_price" type="text" class="input3" id="unit_price"  style="width:55px;"  value="<?=$item_all->d_price?>" onkeyup="count()" />
