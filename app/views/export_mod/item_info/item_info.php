  ...
  <tr>
    ...
    <td valign="top"><div class="left">
		    ...
		    Product Group:                                       </td>
										...
										<select name="item_group" id="item_group" style="width:250px; float:left"  onchange="getData2('item_sub_group_ajax.php', 'item_sub_group', this.value, 
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Product Code:</td>
									  ...
									  <tr>
                                        ...
                                        <td>
										<select name="formula_id" required id="formula_id" style="width:250px;"   >
										
										<option></option>

                     					 <? foreign_relation('item_formula','id','CONCAT(formula_name," - ",item_formula)',$formula_id,'1');?>
                    					</select>
										</td>
...
?></td>
                                      ...
                                      <tr>
                                        ...
                                        <td><input type="text" name="sale_price" id="sale_price" value="<?=$sale_price?>" /></td>
