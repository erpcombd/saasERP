...
<?php */?>
							  ...
							  <tr>
							    <th width="101" bgcolor="#45777B"><span class="style1">Product Group </span></th>
							    <th width="121" bgcolor="#45777B"><span class="style1">Product  Category </span></th>
								<th width="99" bgcolor="#45777B"><span class="style1">Sub Category</span></th>
							  </tr>
								</thead>
...
$con .= ' and b.group_id = "'.$_POST['item_group'].'" ';
	  ...
	  $rrr = "select b.sub_group_id,b.sub_group_id,a.group_name, b.sub_group_name, b.sub_category from item_sub_group b,item_group a where a.group_id=b.group_id ".$con."  order by a.status";
	...
	while($rp=mysqli_fetch_row($report)){$i++; if($i%2==0)$cls=' class="alt"'; else $cls='';?>
							   ...
							   <tr<?=$cls?> onclick="DoNav('<?php echo $rp[0];?>');">
							     <td><?=$rp[2];?></td>
							     <td><?=$rp[3];?></td>
								 <td><?=find_a_field('item_sub_category','item_sub_category','id='.$rp[4]);?></td>
							   </tr>
    ...
    <td valign="top" width="40%"><div class="right"> <form id="form1" name="form1" method="post" action="" onsubmit="return check()">
						...
						<? $_POST['entry_by'] = $_SESSION['user']['id'];?>
						 ...
						 <input name="entry_at" type="hidden" required id="entry_at" tabindex="10" value="<?=$now=date('Y-m-d H:i:s');?>" />
                                 ...
                                 <select name="sub_category" required id="sub_category" style="width:250px;" tabindex="6" >
								 <option></option>

                    			  <? foreign_relation('item_sub_category','id','item_sub_category',$sub_category,'1');?>
                  				  </select>
