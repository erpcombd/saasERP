...
$title='Item Sub Category';			// Page Name and Page Title

do_datatable('table_head');

$page="item_sub_category.php";		// PHP File Name



$table='item_sub_category';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='item_sub_category';				// For a New or Edit Data a must have data field
...
<th bgcolor="#45777B"><span class="style3">Sub Category </span></th>
</tr>
</thead>
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Sub Category:</td>
                        				...
                        				<input name="item_sub_category" required type="text" id="item_sub_category" tabindex="1" value="<?=$item_sub_category?>"  style="width:220px;" >	
