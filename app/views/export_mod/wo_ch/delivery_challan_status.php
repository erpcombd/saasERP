...
if($_POST['fdate']!=''&&$_POST['tdate']!='') $con .= ' and c.chalan_date between "'.$_POST['fdate'].'" and "'.$_POST['tdate'].'"';
    ...
    $res="select c.chalan_no, c.chalan_date,  m.do_no, m.job_no,  m.do_date, m.wo_no, m.dealer_code,  d.dealer_name_e, c.entry_by, c.status from 
