...
$title='Pending Sales Order List';
do_calander('#fdate');
do_calander('#tdate');
...
$target_url = '../wo_ch/delivery_challan.php';
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
 ...
 $res="select  m.do_no, m.job_no, m.wo_no, m.dealer_code, m.do_date,  m.status, sum(d.total_unit) as wo_qty,m.status
