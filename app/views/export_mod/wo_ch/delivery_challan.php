...
<? if($$unique>0){
   ...
   $sql='select a.id,  a.item_id,  a.unit_price, a.color, a.referance, a.shade, a.po_no, a.style_no, a.count_id, a.count, a.length, a.length_unit,  b.item_name,  b.unit_name,  a.total_unit as qty 
      ...
      <tbody>
          ...
          <tr bgcolor="<?=(($bg%2)==1)?'#FFEAFF':'#DDFFF9'?>">
			...
			<?=$row->color?>			</td>
              ...
              <td width="9%" align="center"><? echo number_format($so_qty = (find_a_field('sale_do_chalan','sum(total_unit)','order_no="'.$row->id.'" and item_id="'.$row->item_id.'"')*(1)),2);?></td>
