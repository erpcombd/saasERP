...
$title='Paper Grade Type';			// Page Name and Page Title

do_datatable('table_head');

$page="paper_grade_type.php";		// PHP File Name



$table='paper_grade_type';		// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='paper_grade_type';				// For a New or Edit Data a must have data field
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  a.ply, a.status from '.$table.' a	where 1 '.$con.' order by a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Grade Type:</td>
                        				...
                        				<input name="paper_grade_type" required type="text" id="paper_grade_type" tabindex="1" value="<?=$paper_grade_type?>"  style="width:220px;" >	
                                      ...
                                      <tr>
										...
										<select name="ply" required id="ply"  tabindex="7" style="width:220px;">
