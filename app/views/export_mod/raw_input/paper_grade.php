...
$title='Paper Grade';			// Page Name and Page Title

do_datatable('table_head');

$page="paper_grade.php";		// PHP File Name



$table='paper_grade';		// Database Table Name Mainly related to this page
...
<th bgcolor="#45777B"><span class="style3">Paper Grade </span></th>

<th bgcolor="#45777B"><span class="style3">Grade Type</span></th>
...
$con .='and a.warehouse_name like "%'.$_POST['warehouse_name'].'%" ';
 ...
 $td='select a.'.$unique.',  a.'.$shown.',  u.paper_grade_type, a.status, a.ply from '.$table.' a,  paper_grade_type u	where a.paper_grade_type=u.id   '.$con.' order by a.id  ';
                                  ...
                                  <td width="100%" colspan="2"><div class="box" style="width:400px;">
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td>Paper Grade:</td>
                        				...
                        				<input name="paper_grade" required type="text" id="paper_grade" tabindex="1" value="<?=$paper_grade?>"  style="width:220px;" >	
									  ...
									  <tr>
										...
										<select name="paper_grade_type" required id="paper_grade_type"  tabindex="7" style="width:220px;">
