...
$title='FOC Criteria';	// Page Name and Page Title

do_datatable('vendor_table');			

$page="foc_criteria.php";			// PHP File Name

$table='foc_criteria';				// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='criteria';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th width="105" bgcolor="#45777B"><span class="style3">FOC Criteria</span></th>
  </tr>
</thead>
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Criteria:</td>

                                        <td>
										
										<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
										
										<input name="criteria" required type="text" id="criteria" tabindex="2" value="<?=$criteria?>" style="width:250px;">
