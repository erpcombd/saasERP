...
$title='ADD Merchandizer Information';	// Page Name and Page Title
		    ...
		    Company:                                       </td>
                      ...
                      <? foreign_relation('warehouse','warehouse_id','warehouse_name',$_POST['depot'],'1');?>
                                      ...
                                      <tr>
                                        ...
                                        <td align="right"> Merchandizer Code:                                         </td>
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Merchandizer</span></th>
...
$con .='and a.merchandizer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select a.'.$unique.', a.'.$shown.', b.buyer_name, c.dealer_name_e from '.$table.' a, user_group u, dealer_info c, buyer_info b
				where   a.group_for=u.id  and c.dealer_code=a.dealer_code and a.buyer_code=b.buyer_code and a.group_for="'.$_SESSION['user']['group'].'"   '.$con.' order by a.merchandizer_code asc ';
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
                                      ...
                                      <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Merchandizer:</td>
