...
//create_combobox('paper_grade');

// ::::: Edit This Section :::::

$title=' Paper Combination Setup';	// Page Name and Page Title

do_datatable('vendor_table');			

$page="paper_combination.php";			// PHP File Name

$table='paper_combination';				// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='paper_grade';				// For a New or Edit Data a must have data field
...
$paper=find_all_field('paper_grade','',"id=".$_POST['paper_grade']);

$_POST['paper_combination'] = $paper->paper_grade;
$_POST['ply'] = $paper->ply;
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Paper Combination</span></th>
  <th bgcolor="#45777B"><span class="style3">Ply</span></th>
  <th bgcolor="#45777B"><span class="style3">Sqm Rate </span></th>
  <th bgcolor="#45777B"><span class="style3">Buyer </span></th>

<th bgcolor="#45777B"><span class="style3">Customer </span></th>
<th bgcolor="#45777B"><span class="style3">Approval</span></th>
</tr>
</thead>
...
$con .='and a.merchandizer_code like "%'.$_POST['customer_code'].'%" ';
   ...
   $td='select a.'.$unique.', a.'.$shown.', b.buyer_name, c.dealer_name_e, a.sqm_rate, a.approval, a.ply, a.paper_combination from '.$table.' a, user_group u, dealer_info c, buyer_info b
                                    ...
                                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                     ...
                                     <td><span class="style1" style="padding-top:5px;">*</span>Customer Code:</td>
									  ...
									  <tr>
										...
										<select name="dealer_code" required id="dealer_code" style="width:250px;" onchange="getData2('paper_comb_buyer_ajax.php', 'buyer_filter', this.value, 
...
document.getElementById('dealer_code').value);" >
									  ...
									  <!--<tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Paper Combination:</td>

                                        <td>
										
										

                                        <input name="paper_combination" required type="text" id="paper_combination" tabindex="2" value="<?=$paper_combination?>" style="width:250px;"></td>
									  </tr>-->
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>No of Ply:</td>

                                        <td>
										
					
							  <select name="paper_grade_type" required id="paper_grade_type" style="width:250px;" tabindex="3" 
							 onchange="getData2('paper_grade_ajax.php', 'paper_grade_filter', this.value, document.getElementById('paper_grade_type').value);"  >
											<option></option>

                      						<? foreign_relation('paper_grade_type','id','paper_grade_type',$paper_grade_type,'1');?>
                   						</select>
									  ...
									  <tr>
										...
										<span id="paper_grade_filter">
											
							  <select name="paper_grade" required id="paper_grade" style="width:250px;" tabindex="3" >
											<option></option>

                      						<? foreign_relation('paper_grade','id','paper_grade',$paper_grade,'1');?>
                   						</select>
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Sqm Rate: </td>

                                        <td>
			

                                       <input name="sqm_rate" type="text" id="sqm_rate" tabindex="2" value="<?=$sqm_rate?>"  required style="width:250px;">
									  ...
									  <!--<tr>
										...
										<select name="ply"  id="ply" style="width:250px;" required >
