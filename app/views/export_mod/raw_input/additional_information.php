...
$title='Additional Information';	// Page Name and Page Title

do_datatable('vendor_table');			

$page="additional_information.php";			// PHP File Name

$table='additional_information';				// Database Table Name Mainly related to this page

$unique='id';			// Primary Key of this Database table

$shown='additional_information';				// For a New or Edit Data a must have data field
...
<tr>
  ...
  <th bgcolor="#45777B"><span class="style3">Additional Information</span></th>
  <th bgcolor="#45777B"><span class="style3">Addi. Charge </span></th>
...
$con .='and a.merchandizer_code like "%'.$_POST['customer_code'].'%" ';
  ...
  $td='select a.'.$unique.', a.'.$shown.', b.buyer_name, c.dealer_name_e, a.additional_charge, a.approval from '.$table.' a, user_group u, dealer_info c, buyer_info b
...
document.getElementById('dealer_code').value);" >
									  ...
									  <tr>
                                        ...
                                        <td><span class="style1" style="padding-top:5px;">*</span>Additional Information:</td>

                                        <td>
										
										

                                        <input name="additional_information" required type="text" id="additional_information" tabindex="2" value="<?=$additional_information?>" style="width:250px;"></td>
									  </tr>
									  ...
									  <tr>
                                       ...
                                       <input name="additional_charge" type="text" id="additional_charge" tabindex="2" value="<?=$additional_charge?>" style="width:250px;">
