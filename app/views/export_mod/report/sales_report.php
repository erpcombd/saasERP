...
$title='Store to Store Sales Reports';
                        ...
                        <tr>
                          <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                              ...
                              <tr>
                                ...
                                <td width="94%"><div align="left">Sales Report (Details) </div></td>
                              </tr>
							  <tr>
                                <td width="6%"><input name="report" type="radio" class="radio" value="6" /></td>
                                <td width="94%"><div align="left"> Sales Report (Brief)</div></td>
                              </tr>
							  <tr>
                                <td width="6%"><input name="report" type="radio" class="radio" value="7" /></td>
                                <td width="94%"><div align="left"> Chalan Wise Sales Report</div></td>
                              </tr>
                          </table></td>
                        </tr>
                    </table></td>
