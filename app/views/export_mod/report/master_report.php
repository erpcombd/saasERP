...
elseif($_POST['report']==210001)
{
		...
		<img src="<?=SERVER_ROOT?>public/uploads/logo/<?= $_SESSION['proj_id']?>.png" style="width:150px;">
		</td>
		...
		<td><?=$sl++;?></td>
		<td><a title="WO Preview" target="_blank" href="../wo/work_order_print_view.php?v_no=<?=$row->do_no?>"><?=$row->job_no?></a></td>
...
// 		$merchandizer_con=" and sm.merchandizer_code=".$merchandizer[0];
        ...
        <tr>
		 ...
		 <? if ($_POST['dealer_group']>0) {?>
		 <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;">Customer Group: <?=find_a_field('dealer_group','dealer_group','id='.$_POST['dealer_group'])?></td>
         </tr>
		 <? }?>
		 
		  <? if ($_POST['marketing_person']>0) {?>
		 <tr>
          <td colspan="15" align="center" style="font-size:14px;border:0px; border-color:white;">Marketing Person: <?=find_a_field('marketing_person','marketing_person_name','person_code='.$_POST['marketing_person'])?></td>
         </tr>
		 <? }?>
		...
		<td  width="25%" align="center" style="border:0px; border-color:white;">
		<?php /*?><img src="<?=SERVER_ROOT?>public/uploads/logo/<?= $_SESSION['proj_id']?>.png" style="width:150px;"><?php */?>
		</td>
		</tr>
		...
		<tr height="30">
		<th width="2%" bgcolor="#66CCFF">SL</th>
		<th width="5%" bgcolor="#66CCFF">Code</th>
		<th width="29%" bgcolor="#66CCFF">Vendor Name </th>
		<th width="16%" bgcolor="#66CCFF">Accounts No </th>
		<th width="11%" bgcolor="#66CCFF"><span id="buyer_filter">Contact No </span></th>
		<th width="11%" bgcolor="#66CCFF">Email</th>
		<th width="26%" bgcolor="#66CCFF">Address</th>
		</tr>
		</thead>
		...
		<?
			...
			$con .= ' and dealer_group = "'.$_POST['dealer_group'].'" ';


			if($_POST['marketing_person']!='')

			$con .= ' and marketing_person = "'.$_POST['marketing_person'].'" ';
			
			if($_POST['dealer_code']!='')

			$con .= ' and dealer_code = "'.$_POST['dealer_code'].'" ';
		
		

		
		  $sql="select * from vendor 
		 where 1 ".$con."  order by vendor_id";
...
// 		$merchandizer_con=" and sm.merchandizer_code=".$merchandizer[0];
		...
		<tr height="30">
		<th width="6%" bgcolor="#66CCFF">SL</th>
		<th width="5%" bgcolor="#66CCFF">Code</th>
		<th width="20%" bgcolor="#66CCFF">Customer Name </th>
		<th width="17%" bgcolor="#66CCFF">Customer Group </th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Marketing Person</span></th>
		<th width="13%" bgcolor="#66CCFF">Mobile No </th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Email</span></th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Address</span></th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		<?
		 ...
		 where 1 ".$con."  order by dealer_code";
		...
		<td><?=$row->dealer_name_e?></td>
		<td><?=find_a_field('dealer_group','dealer_group','id='.$row->dealer_group);?></td>
		<td><?=find_a_field('marketing_person','marketing_person_name','person_code='.$row->marketing_person);?></td>
		<td><?=$row->mobile_no?></td>
		<td><?=$row->email;?></td>
		<td><?=$row->address_e;?></td>
...
elseif($_POST['report']==210710002)
{
		$report="Buyer Details Report";	
...
// 		$merchandizer_con=" and sm.merchandizer_code=".$merchandizer[0];
		...
		<th width="6%" bgcolor="#66CCFF">SL</th>
		<th width="5%" bgcolor="#66CCFF">Code</th>
		<th width="14%" bgcolor="#66CCFF">Buyer Name </th>
		<th width="23%" bgcolor="#66CCFF">Customer Name </th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Contact  Person</span></th>
		<th width="13%" bgcolor="#66CCFF">Mobile No </th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Email</span></th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Address</span></th>
		</tr>
		...
		<?
			...
			$con .= ' and d.dealer_group = "'.$_POST['dealer_group'].'" ';


			if($_POST['marketing_person']!='')

			$con .= ' and d.marketing_person = "'.$_POST['marketing_person'].'" ';
			
			if($_POST['dealer_code']!='')

			$con .= ' and d.dealer_code = "'.$_POST['dealer_code'].'" ';
		
		

		
		  $sql="select b.*, d.dealer_name_e from buyer_info b, dealer_info d
		 where b.dealer_code=d.dealer_code ".$con."  order by b.dealer_code,b.buyer_code";
...
elseif($_POST['report']==210710003)
{
		$report="Merchandiser Details Report";	
...
// 		$merchandizer_con=" and sm.merchandizer_code=".$merchandizer[0];
		...
		<th width="6%" bgcolor="#66CCFF">SL</th>
		<th width="5%" bgcolor="#66CCFF">Code</th>
		<th width="14%" bgcolor="#66CCFF">Merchandiser Name</th>
		<th width="14%" bgcolor="#66CCFF">Buyer Name </th>
		<th width="23%" bgcolor="#66CCFF">Customer Name </th>
		<th width="13%" bgcolor="#66CCFF"><span id="buyer_filter">Contact  Person</span></th>
		<th width="13%" bgcolor="#66CCFF">Mobile No </th>
		...
		<?
		  ...
		  $sql="select a.*, b.buyer_name,  d.dealer_name_e from merchandizer_info a, buyer_info b, dealer_info d
		 where a.buyer_code=b.buyer_code and b.dealer_code=d.dealer_code ".$con."  order by b.dealer_code,b.buyer_code,a.merchandizer_code";
...
elseif($_POST['report']==210003)
{
		...
		<th width="30%" bgcolor="#99FFFF">Marketing Person rrr</th>
		...
		<td><? if ($sales_qty[$row->person_code]>0) {?>
		  <?=number_format($sales_qty[$row->person_code],2); $total_sales_qty +=$sales_qty[$row->person_code]; ?>
		  <? }?></td>
...
elseif($_POST['report']==210004)
{
		...
		<th width="3%" colspan="2" bgcolor="#28AA6C" style="text-align:center">Previous  Delivery </th>
...
sc.chalan_no, sc.chalan_date, sc.style_no, sc.po_no, sc.destination, sc.referance, sc.sku_no, sc.pack_type, sc.color, sc.size, sc.ply, sc.L_cm, sc.W_cm, sc.H_cm, sc.measurement_unit, sc.paper_combination, sc.sqm_rate, sc.unit_name, sc.final_price, sc.unit_price, sc.printing_info, sc.additional_info, sc.additional_charge, sc.delivery_date, sc.delivery_place, sc.order_no, sum(sc.total_unit) as total_unit, sum(sc.total_amt) as total_amt
		...
		<td><?=date("d-M-Y",strtotime($row->do_date))?></td>
		<td><?=$row->order_no?></td>
		<td><a title="WO Preview" target="_blank" href="../wo/delivery_challan_print_view.php?v_no=<?=$row->chalan_no?>">
		  <?=$row->chalan_no?>
		</a></td>
...
<?=$row->final_price?></td>
		...
		<td>$
<?=$wo_amt[$row->order_no]; $tot_wo_amt +=$wo_amt[$row->order_no];?></td>
		<td><?=$pre_qty[$row->order_no]; $tot_pre_qty +=$pre_qty[$row->order_no];?></td>
		<td>$
<?=$pre_amt[$row->order_no]; $tot_pre_amt +=$pre_amt[$row->order_no];?></td>
		<td><?=$row->total_unit;  $total_sales_qty +=$row->total_unit;?></td>
		<td>
		  $
<?=number_format($row->total_amt,2); $total_sales_amt +=$row->total_amt;?>		 </td>
		...
		<td>$
<?= $pending_amt = ($wo_amt[$row->order_no]-($pre_amt[$row->order_no]+$row->total_amt)); $total_pending_amt += $pending_amt;?></td>
		<td><?=find_a_field('printing_information','printing_information','id='.$row->printing_info);?></td>
		<td><?=find_a_field('additional_information','additional_information','id='.$row->additional_info);?></td>
		<td><?=$row->additional_charge?></td>
		<td><?php echo date('d-m-Y',strtotime($row->delivery_date));?></td>
...
<?=number_format($total_sales_amt,2);?>
		  ...
		  <td><span class="style7">
		    <?=number_format($total_pending_qty,2);?>
		  </span></td>
		  <td><span class="style7">
		    $
...
sc.chalan_no, sc.chalan_date, sc.style_no, sc.po_no, sc.destination, sc.referance, sc.sku_no, sc.pack_type, sc.color, sc.size, sc.ply, sc.L_cm, sc.W_cm, sc.H_cm, sc.measurement_unit, sc.paper_combination, sc.sqm_rate, sc.unit_name, sc.final_price, sc.unit_price, sc.printing_info, sc.additional_info, sc.additional_charge, sc.delivery_date, sc.delivery_place, sc.order_no, sum(sc.total_unit) as total_unit, sum(sc.total_amt) as total_amt
		...
		<td><?=date("d-M-Y",strtotime($row->do_date))?></td>
		<td><?=$row->order_no?></td>
		<td><!--<a title="WO Preview" target="_blank" href="../wo/delivery_challan_print_view.php?v_no=<?=$row->chalan_no?>"></a>-->
		  <?=$row->chalan_no?>
		</td>
		<td><?=date("d-M-Y",strtotime($row->chalan_date))?></td>
		<td><?=$row->dealer_name_e?></td>
...
elseif($_POST['report']==210008)
{
		...
		if(isset($item_type)) 					{$item_type_con=' and i.item_type='.$item_type;}
		 ...
		 from sale_do_master m, sale_do_details c, marketing_person p
		 where m.do_no=c.do_no and m.marketing_person=p.person_code and c.do_date between '".$f_date."' and '".$t_date."' and m.status not in ('CANCELED','CANCEL REQUEST')
		   ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con."  group by m.marketing_person ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
		...
		<td><? if ($wo_qty[$row->person_code]>0) {?>
            <?=number_format($wo_qty[$row->person_code],2); $total_wo_qty +=$wo_qty[$row->person_code]; ?>
            <? }?></td>
		<td>$ &nbsp;&nbsp;&nbsp;
		...
		<td><? if ($production_qty[$row->person_code]>0) {?>
            <?=number_format($production_qty[$row->person_code],2); $total_production_qty +=$production_qty[$row->person_code]; ?>
            <? }?></td>
		<td>$ &nbsp;&nbsp;&nbsp;
		...
		<td><? if ($challan_qty[$row->person_code]>0) {?>
		  <?=number_format($challan_qty[$row->person_code],2); $total_challan_qty +=$challan_qty[$row->person_code]; ?>
		  <? }?></td>
...
<?  }?>
		<tr <?=($xx%2==0)?' bgcolor="#CCCCCC"':'';$xx++;?>>
		  ...
		  <td bgcolor="#FFFFFF"><div align="right"><strong>SUB TOTAL: </strong></div></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_wo_qty,2); $total_total_wo_qty +=$total_wo_qty;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($total_wo_amt,2); $total_total_wo_amt +=$total_wo_amt;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_production_qty,2); $total_total_production_qty +=$total_production_qty;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($total_production_amt,2); $total_total_production_amt +=$total_production_amt;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
		    <?=number_format($total_challan_qty,2); $total_total_challan_qty +=$total_challan_qty;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
		...
		<tr <?=($xx%2==0)?' bgcolor="#CCCCCC"':'';$xx++;?>>
		  ...
		  <td bgcolor="#FFFFFF"><div align="right"><strong>GRAND TOTAL:</strong></div></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_total_wo_qty,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($total_total_wo_amt,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_total_production_qty,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($total_total_production_amt,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
		    <?=number_format($total_total_challan_qty,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
...
elseif($_POST['report']==21110301)
{
		...
		<th width="18%" bgcolor="#99FFFF">Marketing Person </th>
		<th width="9%" bgcolor="#99FFFF" style="text-align:center">Total Opening Qty (PCS) </th>
		<th width="11%" bgcolor="#99FFFF" style="text-align:center">Total Opening Value (USD) </th>
		<th width="10%" bgcolor="#99FFFF" style="text-align:center">Total Order Produced Qty (PCS) </th>
		<th width="10%" bgcolor="#99FFFF" style="text-align:center">Total Order Produced Value (USD) </th>
		<th width="11%" bgcolor="#99FFFF" style="text-align:center">Total Order Delivered Qty (PCS) </th>
		<th width="10%" bgcolor="#99FFFF" style="text-align:center">Total Order Delivered Value (USD) </th>
		<th width="10%" bgcolor="#99FFFF" style="text-align:center">Total Closing Qty (PCS) </th>
		<th width="10%" bgcolor="#99FFFF" style="text-align:center">Total Closing Value (USD) </th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		...
		if(isset($item_type)) 					{$item_type_con=' and i.item_type='.$item_type;}
		 ...
		 $sql = "select m.marketing_person, sum(c.total_amt) as opening_production_amt, sum(c.total_unit) as opening_production_qty  
		 from sale_do_master m, sale_do_production_issue c, marketing_person p
		 where m.do_no=c.do_no and m.marketing_person=p.person_code and c.chalan_date<'".$f_date."' 
		   ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con."  group by m.marketing_person ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $opening_production_amt[$info->marketing_person]=$info->opening_production_amt;
		 $opening_production_qty[$info->marketing_person]=$info->opening_production_qty;
		
		}
		
		
		 $sql = "select m.marketing_person, sum(c.total_amt) as opening_challan_amt, sum(c.total_unit) as opening_challan_qty  
		 from sale_do_master m, sale_do_chalan c, marketing_person p
		 where m.do_no=c.do_no and m.marketing_person=p.person_code and c.chalan_date<'".$f_date."'
		   ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con."  group by m.marketing_person ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $opening_challan_amt[$info->marketing_person]=$info->opening_challan_amt;
		 $opening_challan_qty[$info->marketing_person]=$info->opening_challan_qty;
		
		}
		
		
		
		$sql = "select m.marketing_person, sum(c.total_amt) as closing_production_amt, sum(c.total_unit) as closing_production_qty  
		 from sale_do_master m, sale_do_production_issue c, marketing_person p
		 where m.do_no=c.do_no and m.marketing_person=p.person_code and c.chalan_date<='".$t_date."' 
		   ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con."  group by m.marketing_person ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $closing_production_amt[$info->marketing_person]=$info->closing_production_amt;
		 $closing_production_qty[$info->marketing_person]=$info->closing_production_qty;
		
		}
		
		
		 $sql = "select m.marketing_person, sum(c.total_amt) as closing_challan_amt, sum(c.total_unit) as closing_challan_qty  
		 from sale_do_master m, sale_do_chalan c, marketing_person p
		 where m.do_no=c.do_no and m.marketing_person=p.person_code and c.chalan_date<='".$t_date."'
		   ".$con.$item_sub_con.$group_for_con.$item_group_con.$item_mother_group_con.$item_type_con."  group by m.marketing_person ";
		 $query = db_query($sql);
		 while($info=mysqli_fetch_object($query)){
  		 $closing_challan_amt[$info->marketing_person]=$info->closing_challan_amt;
		 $closing_challan_qty[$info->marketing_person]=$info->closing_challan_qty;
		...
		<td><?=$row->marketing_person_name?></td>
		<td>
            <?= number_format($opening_qty =  $opening_production_qty[$row->person_code] - $opening_challan_qty[$row->person_code],2); 
			$tot_opening_qty += $opening_qty =  $opening_production_qty[$row->person_code] - $opening_challan_qty[$row->person_code];  ?>            </td>
		<td>$ &nbsp;&nbsp;&nbsp;
		   
		  <?=number_format($opening_amt =  $opening_production_amt[$row->person_code] - $opening_challan_amt[$row->person_code],2);
		  $tot_opening_amt += $opening_amt =  $opening_production_amt[$row->person_code] - $opening_challan_amt[$row->person_code];?>		  </td>
		<td><? if ($production_qty[$row->person_code]>0) {?>
            <?=number_format($production_qty[$row->person_code],2); $total_production_qty +=$production_qty[$row->person_code]; ?>
            <? }?></td>
		<td>$ &nbsp;&nbsp;&nbsp;
		...
		<td><? if ($challan_qty[$row->person_code]>0) {?>
		  ...
		  <? }?></td>
		<td>$ &nbsp;&nbsp;&nbsp;<? if ($challan_amt[$row->person_code]>0) {?><?=number_format($challan_amt[$row->person_code],2); $total_challan_amt +=$challan_amt[$row->person_code]; ?><? }?></td>
		<td><?= number_format($closing_qty =  $closing_production_qty[$row->person_code] - $closing_challan_qty[$row->person_code],2); 
			$tot_closing_qty += $closing_qty =  $closing_production_qty[$row->person_code] - $closing_challan_qty[$row->person_code];  ?>
        </td>
		<td>$ &nbsp;&nbsp;&nbsp;
            <?=number_format($closing_amt =  $closing_production_amt[$row->person_code] - $closing_challan_amt[$row->person_code],2);
		  $tot_closing_amt += $closing_amt =  $closing_production_amt[$row->person_code] - $closing_challan_amt[$row->person_code];?>
        </td>
		</tr>
<?  }?>
		<tr <?=($xx%2==0)?' bgcolor="#CCCCCC"':'';$xx++;?>>
		  ...
		  <td bgcolor="#FFFFFF"><div align="right"><strong>SUB TOTAL: </strong></div></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($tot_opening_qty,2); $total_tot_opening_qty +=$tot_opening_qty;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($tot_opening_amt,2); $total_tot_opening_amt +=$tot_opening_amt;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_production_qty,2); $total_total_production_qty +=$total_production_qty;?>
          </span></td>
		  ...
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($tot_closing_qty,2); $total_tot_closing_qty +=$tot_closing_qty;?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
                <?=number_format($tot_closing_amt,2); $total_tot_closing_amt +=$tot_closing_amt;?>
          </span></td>
		</tr>
		...
		<tr <?=($xx%2==0)?' bgcolor="#CCCCCC"':'';$xx++;?>>
		  ...
		  <td bgcolor="#FFFFFF"><div align="right"><strong>GRAND TOTAL:</strong></div></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_tot_opening_qty,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
		        <?=number_format($total_tot_opening_amt,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_total_production_qty,2);?>
          </span></td>
		  ...
		  <td bgcolor="#FFFFFF"><span class="style7">
            <?=number_format($total_tot_closing_qty,2);?>
          </span></td>
		  <td bgcolor="#FFFFFF"><span class="style7"> $ &nbsp;&nbsp;&nbsp;
                <?=number_format($total_tot_closing_amt,2);?>
          </span></td>
		</tr>
...
<?=$chalan_amt[$row->id]; $tot_chalan_amt +=$chalan_amt[$row->id];?></td>
		<td><?= $pending_qty  = ($row->total_unit - $chalan_qty[$row->id]); $tot_pending_qty += $pending_qty  = ($row->total_unit - $chalan_qty[$row->id])?></td>
		<td>$
...
elseif($_POST['report']=='210013'){
		...
		echo '<h1>'.find_a_field('user_group','group_name','id='.$_SESSION['proj_id']).'</h1>';
		if(isset($report)) 
		echo '<h2>'.$report.'</h2>';
