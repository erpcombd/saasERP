...
<table width="800" border="0" cellspacing="0" cellpadding="0" align="center">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td bgcolor="#00CC66" style="text-align:center; color:#FFF; font-size:18px; font-weight:bold;"><span class="style1">WORK ORDER </span></td>
      </tr>
    </table></td>
              </tr>
            </table></td>
		  ...
		  <tr>
		    <td valign="top">
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
		        ...
		        <tr>
                  <td width="20%" align="left" valign="middle">Party Name:</td>
			...
			<td width="30%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
			    <td align="right" valign="middle"><div align="left"><strong>DO No:</strong></div></td>
			    <td><strong><?php echo $do_no;?></strong></td>
			  </tr>
			  <tr>
			    <td width="48%" align="right" valign="middle"><div align="left">DO Date: </div></td>
			    <td width="52%"><?=$do->do_date?></td>
			    </tr>
			  <tr>
			    <td align="right" valign="middle"><div align="left">DO Status: </div></td>
...
<table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="2" style="font-size:11px;">
       ...
       <tr>
         ...
         <td rowspan="2" align="center" bgcolor="#FFFFFF"><strong>Dis%</strong></td>
         <td rowspan="2" align="center" bgcolor="#FFFFFF"><strong>TP/Pc</strong></td>
         <td rowspan="2" align="center" bgcolor="#FFFFFF"><strong>TP/Ctn </strong></td>
...
?>
      <tr>
        ...
        <td align="left" valign="top"><?=$items->finish_goods_code?>-<?=$items->item_name;?><? if($gift_o->gift_id>0) echo '[D/O-'.find_a_field('sale_gift_offer','offer_name','id='.$gift_o->gift_id).']';?></td>
        <td align="right" valign="top"><?=($items->demo_price==0&&$dealer->dealer_type='SuperShop')?number_format($items->m_price*$fit_size,0):number_format($items->demo_price*$fit_size,0);?></td>
        <td align="right" valign="top"><strong>
          <?=($items->demo_price==0&&$dealer->dealer_type='SuperShop')?number_format((@(($items->m_price-$unit_price[$i])/($items->m_price))*100),2):number_format((@(($items->demo_price-$unit_price[$i])/($items->demo_price))*100),2);?>%</strong></td>
...
<? }?>
      ...
      <tr>
        <td colspan="11" align="center" valign="top"><div align="right"><strong>Special Discount <?=$do->sp_discount?> %: </strong></div></td>
        <td align="right" valign="top"><strong>
	  ...
	  <? }if($cash_discount>0){?>
      <tr>
        <td colspan="11" align="center" valign="top"><div align="right"><strong>Cash Discount  : </strong></div></td>
        <td align="right" valign="top"><strong>
	  ...
	  <? }?>
      <tr>
        <td colspan="11" align="center" valign="top"><div align="right"><strong>Total Payable Amount : </strong></div></td>
        <td align="right" valign="top"><strong>
  ...
  <tr>
    <td colspan="2" align="center"><div class="footer_left">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td><div align="center"><span class="style7"><u> <?=find_a_field('user_activity_management','fname','user_id='.$do->entry_by);?></u></span> </div></td>
        ...
        <tr>
          <td width="33%">            <div align="center" class="style5">Prepared By</div></td>
          <td width="33%"><div align="center" class="style5">Deputy / Asst. MGR </div></td>
          <td width="33%"><div align="center" class="style5">HOMT</div></td>
          <td width="33%"><div align="center" class="style5">GM Sales </div></td>
          <td width="34%"><div align="center" class="style5">Approved By </div></td>
        </tr>
      </table>
      </div>      <strong><br />
      </strong></td>
