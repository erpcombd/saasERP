                  ...
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr>
                              <td><input name="report" type="radio" class="radio" value="210001" checked="checked" /></td>
                              <td><div align="left">Work Order Brief Report</div></td>
                            </tr>
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210002"  /></td>
                              <td><div align="left">Work Order Summary Report</div></td>
                            </tr>
							
							<?php /*?><? if($_SESSION['user']['id']==10001) {?>
							
								<? }?><?php */?>
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210003"  /></td>
                              <td><div align="left">Order Receiving Summary</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210004"  /></td>
                              <td><div align="left">Delivery Challan Details Report</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210005"  /></td>
                              <td><div align="left">Delivery Challan Summary</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210006"  /></td>
                              <td><div align="left">Production Details Report</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210007"  /></td>
                              <td><div align="left">Production Summary</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210008"  /></td>
                              <td><div align="left">Performance Report</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210012"  /></td>
                              <td><div align="left">Daily Sales Report</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210013"  /></td>
                              <td><div align="left">Team Wise Sales Qty</div></td>
                            </tr>
							
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210014"  /></td>
                              <td><div align="left">Team Wise Sales Value</div></td>
                            </tr>
