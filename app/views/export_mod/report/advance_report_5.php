                  ...
                  <td valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
							...
							<tr>
                              <td><input name="report" type="radio" class="radio" value="210008" checked="checked"  /></td>
                              <td><div align="left">Performance Report</div></td>
                            </tr>
							
							<tr>
                              <td><input name="report" type="radio" class="radio" value="21110301"   /></td>
                              <td><div align="left">Stock Movement Report</div></td>
                            </tr>
								...
								<?php /*?><? if($_SESSION['user']['id']==10001) {?><? }?><?php */?>
