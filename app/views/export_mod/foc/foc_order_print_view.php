...
require_once ('../../../acc_mod/common/class.numbertoword.php');
 ...
 $foc_no 		= $_REQUEST['v_no'];


$master= find_all_field('sale_foc_master','','foc_no='.$foc_no);
...
$$key=$value;
 ...
 $ssql = 'select a.*,b.do_date, b.group_for, b.via_customer from dealer_info a, sale_foc_master b where a.dealer_code=b.dealer_code and b.foc_no='.$foc_no;
...
$ordered_total_ctn = find_a_field('sale_foc_details','sum(pkt_unit)','dist_unit = 0 and foc_no='.$foc_no);

$ordered_total_pcs = find_a_field('sale_foc_details','sum(dist_unit)','foc_no='.$foc_no); 
...
<table width="1200" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr height="30">
  	  <td valign="top"></td>
  	  <td  style="text-align:center; color:#FFF; font-size:18px; padding:0px 0px 10px 0px; color:#000000; font-weight:bold;"><span style="text-decoration:underline">FOC WORK ORDER</span> </td>
 ...
 <tr> <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="96%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
		          <td width="30%" align="left" valign="middle"><strong>FOC Job No: </strong></td>
		          <td width="70%"><strong><?php echo $master->job_no;?></strong></td>
	            </tr>
		        <tr>
		          <td align="left" valign="middle"><strong>FOC Criteria: </strong></td>
		          <td><?= find_a_field('foc_criteria','criteria','id="'.$master->foc_type.'"');?></td>
	            </tr>
		        <tr>
    ...
    <td><div id="pr">
      ...
      <table width="100%" class="tabledesign" border="1" bordercolor="#000000" cellspacing="0" cellpadding="5"  style="font-size:10px">
        ...
        <tr>
          ...
          <td width="9%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Color</strong></td>
          <td width="12%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Referance</strong></td>
          <td width="9%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Style No </strong></td>
          <td width="9%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>PO No </strong></td>
          <td width="11%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Type</strong></td>
          <td width="10%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>SST</strong></td>
          <td width="8%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Count</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Length</strong></td>
          <td width="7%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Quantity</strong></td>
          <td width="6%" align="center" bordercolor="#000000" bgcolor="#CCCCCC"><strong>Reason</strong></td>
        </tr>
        
        <?  $sqlc = 'select c.*,  i.item_id, i.item_name from sale_foc_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.foc_no='.$foc_no.' group by c.id order by c.id asc';
        ...
        <tr style="font-size:10px;">
          ...
          <td align="left" valign="top"><? 
		  if ($datac->pack_type!="") {
		  echo $datac->pack_type;
		  } else {
		  echo 'N/A';
		  }
		  ?></td>
          <td align="left" valign="top"><?=$datac->sst;?></td>
          <td align="left" valign="top"><?=$datac->count;?></td>
          <td align="center" valign="top"><?=$datac->length;?></td>
          <td align="center" valign="top"><?=number_format($datac->total_unit,2); $grand_tot_unit1 +=$datac->total_unit; ?></td>
          <td align="center" valign="top"><?=$datac->reason; ?></td>
        </tr>
  ...
  <tr>
  	<td colspan="2">
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, sum(c.total_unit) as total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.style_no, c.po_no,  c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_foc_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.foc_no='.$foc_no.' group by c.L_cm, c.W_cm, c.H_cm, c.measurement_unit order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
        ...
        <?  $sqlc = 'select c.delivery_date, c.delivery_place,c.printing_info,c.additional_info, c.measurement_unit, c.total_unit, c.unit_price, i.unit_name, c.total_amt, i.item_id, i.item_name, c.ply, c.paper_combination, c.L_cm, c.W_cm, c.H_cm from sale_foc_details c, item_info i,  item_sub_group s, item_group g where i.item_id=c.item_id and i.sub_group_id=s.sub_group_id and s.group_id=g.group_id  and c.foc_no='.$foc_no.' group by c.id order by c.id asc';
			$queryc=db_query($sqlc);
			while($datac = mysqli_fetch_object($queryc)){
		  ...
		  <td colspan="3" width="40%">
			...
			<tr>
				...
				<td width="39%" align="center"><strong>
				  ...
				  $ <?=number_format($grand_tot_amt=find_a_field('sale_foc_details','sum(total_amt)','foc_no='.$master->foc_no),2);?>
				</strong></td>
			</tr>
	  </table>
		  </td>
