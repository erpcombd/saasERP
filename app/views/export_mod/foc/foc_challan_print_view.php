		    ...
		    <td width="100%" valign="top">
		      ...
		      <table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:12px">
		        ...
		        <tr>
	              ...
	              <td width="12%">: &nbsp;<?=$ch_data->foc_chalan_no;?></td>
...
<table width="1200" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
  	...
  	<tr height="30">
  	  <td valign="top"></td>
  	  <td  style="text-align:center; color:#FFF; font-size:18px; padding:0px 0px 10px 0px; color:#000000; font-weight:bold;"><span style="text-decoration:underline">DELIVERY CHALLAN</span> </td>
  	  <td valign="right" align="right">&nbsp;</td>
	  </tr>
  	<tr>
		<td width="25%" valign="top"></td>
