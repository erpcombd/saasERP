...
$target_url = '../foc/foc_delivery_challan.php';
...
{
	window.open('<?=$target_url?>?foc_no='+theUrl);
}
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      ...
      <tr>
		...
		foreign_relation('sale_foc_master','foc_no','job_no',$_POST['foc_no'],'status="CHECKED"');
...
<tr>
  <th width="10%">FOC NO </th>
  <th width="14%">FOC Date </th>
...
$con .= ' and m.foc_no in ('.$_POST['foc_no'].') ';
  ...
  $res="select m.foc_no, m.foc_no, m.job_no, m.dealer_code, m.foc_date,  m.buyer_code, m.merchandizer_code, m.status from sale_foc_master m, sale_foc_details d where m.foc_no=d.foc_no and m.status='CHECKED'  ".$con." group by m.foc_no order by m.foc_date, m.foc_no ";
