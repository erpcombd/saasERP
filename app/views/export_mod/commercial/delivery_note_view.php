...
$dn_data = find_all_field('delivery_note','','dn_no='.$dn_no); 

$master= find_all_field('pi_master','','id='.$pi_no);



		  $barcode_content = $dn_no;
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
						...
						<tr>
					    <td align="left" width="50%"><span style="font-size:14px; padding: 3px 0 0 5px; letter-spacing:5px;"><?=$dn_no;?></span></td>
					    <td align="left" width="50%">&nbsp;</td>
						</tr>
 ...
 <tr> <td colspan="2"><table width="100%" border="0" cellspacing="0" cellpadding="0">
		  ...
		  <tr>
		    ...
		    <td width="68%" valign="top">
		      ...
		      <table width="97%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px; letter-spacing:.3px;">
		        ...
		        <tr>
				 ...
				 <tr>
		          <td colspan="2" align="left" valign="middle" style=" font-size:14px; text-transform: uppercase; font-weight:700; margin-bottom:10px;"><?= find_a_field('dealer_info','dealer_name_e','dealer_code='.$dn_data->dealer_code);?> </td>
	            </tr>
		        
		        <tr>
		          <td align="left" valign="middle" style=" text-transform:capitalize;" width="60%" ><?= find_a_field('dealer_info','address_e','dealer_code='.$dn_data->dealer_code);?></td>
			...
			<tr>
                ...
                <td width="56%" align="right" valign="middle"><div align="left">P/I No</div></td>


			    <td width="4%">: </td> 
			    <td width="40%"><span><?php echo $dn_data->view_pi_no;?></span></td>
			</tr>
			  ...
			  <tr>
                ...
                <td width="56%" align="right" valign="middle"><div align="left">P/I Date</div></td>


			    <td>:</td> 
			    <td><?=date("d M, Y",strtotime($dn_data->pi_date))?></td>
			  </tr>
			  
			  <tr>
			    <td align="right" valign="middle"><div align="left"> L/C/ Sales Contract No </div></td>
			    <td>: </td>
			    <td><?php echo $dn_data->sc_invoice_no;?></td>
			  </tr>
			  
			  <tr>
			    <td align="right" valign="middle"><div align="left"> L/C/ Sales Contract Date </div></td>
			    <td>: </td>
			    <td><?=date("d M, Y",strtotime($dn_data->sc_invoice_date))?></td>
			  </tr>
			  ...
			  <tr>
			    ...
			    <td>: </td>
			    <td><?=date("d M, Y",strtotime($dn_data->dn_date))?></td>
			  </tr>
	 ...
	 echo ' Only';
		...
		?>.		</td>
		  ...
		  <tr style="font-size:14px; font-weight:700; letter-spacing:.5px; line-height:20px; text-transform:uppercase;">
		    <td colspan="3" align="left">
			L/C No. <?php echo $dn_data->export_lc_no;?> Dated 
			<?=date("d M, Y",strtotime($dn_data->export_lc_date))?>
			. EXPORT CONTRACT NO. <?php echo $dn_data->sc_invoice_no;?>.
			PROFORMA INVOICE NO. <?php echo $dn_data->view_pi_no;?> DATED 
			<?=date("d M, Y",strtotime($dn_data->pi_date))?>
			. APPICANT BIN NO.
...
AND ALL THE TERMS & CONDITIONS HAVE BEEN FULLY COMPLIED WITH.
WE HAVE RECEIVED THE GOODS IN GOOD ORDER AND SATISFACTORY CONDITION
AS PER PROFORMA INVOICE AND ALSO COMPLY WITH L/ C TERMS.		</td>
		    </tr>
      </table>	</td>
  </tr>
	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr style="font-size:12px">
		  <td align="center" style="font-size:14px; text-transform: uppercase; font-weight:700; "><?= find_a_field('dealer_info','dealer_name_e','dealer_code='.$dn_data->dealer_code);?></td>
		  <td  align="center">&nbsp;</td>
		  <td  align="center">&nbsp;</td>
