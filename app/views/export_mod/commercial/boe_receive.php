...
if(isset($_POST['confirm'])){
	...
	$invoice_no = next_transection_no('0',$invoice_date,'boe_receive','invoice_no');	
   ...
   $so_invoice = 'INSERT INTO boe_receive ( invoice_no, invoice_date, lc_no, year, lc_id, lc_no_view, lc_date, export_lc_no, export_lc_date, expiry_date, pi_id, pi_no, pi_date, pi_type, bank_buyers, dealer_group, dealer_code, marketing_team, marketing_person, tolerance, tenor_days, contact_no, remarks, status, entry_at, entry_by)
