...
if(isset($_POST['confirm'])){
	...
	$invoice_no = next_transection_no('0',$invoice_date,'boe_submission','invoice_no');	
   ...
   $so_invoice = 'INSERT INTO boe_submission ( invoice_no, invoice_date, lc_no, year, lc_id, lc_no_view, lc_date, export_lc_no, export_lc_date, expiry_date, pi_id, pi_no, pi_date, pi_type, bank_buyers, dealer_group, dealer_code, marketing_team, marketing_person, tolerance, tenor_days, contact_no, remarks, status, entry_at, entry_by)
  ...
  "'.$data->tenor_days.'", "'.$data->contact_no.'", "'.$data->remarks.'", "CHECKED", "'.$entry_at.'", "'.$entry_by.'")';
...
<div class="box" style="width:100%;">
			...
			<input style="width:220px; height:32px;"  name="invoice_date" type="text" id="invoice_date"  value="<?=($invoice_date!='')?$invoice_date:date('Y-m-d')?>"   required />
