...
if(isset($_POST['confirm'])){
	...
	$invoice_no = next_transection_no('0',$invoice_date,'maturity_receive','invoice_no');	
		...
		$upsql = 'update maturity_receive set status="CHECKED",  ldbc_no="'.$ldbc_no.'", ldbc_no_date="'.$ldbc_no_date.'", maturity_rec_date="'.$maturity_rec_date.'", 
		 checked_by="'.$checked_by.'" , checked_at="'.$checked_at.'" where lc_no = '.$lc_no;
		db_query($upsql);
		  	...
		  	<tr>
				...
				<td>&nbsp;&nbsp; %(+/-)</td>
								  ...
								  <tr>
								    ...
								    <td><input name="maturity_rec_date" type="text" id="maturity_rec_date" style="width:220px; height:32px;" value="<?=$maturity_rec_date?>"  required tabindex="105" /></td>
							      </tr>
								</table>
