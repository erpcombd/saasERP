  ...
  <table width="100%" border="0" cellspacing="0" cellpadding="0"  style="font-size:12px">
    ...
    <td colspan="2"><div id="pr">
  	...
  	<tr style="font-size:16px">
		...
		<td width="25%" valign="right" align="left">Date: <?php  //date('d-m-Y',strtotime($lc_data->lc_date));?></td>
	</tr>
  	<tr>
  	  <td valign="top">&nbsp;</td>
  	  <td valign="middle" align="center">&nbsp;</td>
...
THIS IS TO CERTITY THAT THE GOODS DELVERED OF <?php echo $dealer->dealer_name_e;?>,<?php echo $dealer->address_e;?> TO THE <?=$buyer_bank->bank_name;?>,<?=$buyer_bank->branch_name;?> AS PER PROFORMA INVOICE NO. 
	      <?  
$a=0;
...
echo find_a_field('pi_master','manual_pi_no','pi_no="'.$pi_data->pi_no.'"').' Date. '.date('d-m-Y',strtotime($pi_data->pi_date));}?>. 
	...
	<tr>
	  ...
	  <tr>
		...
		<tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; text-transform:uppercase;" >WE ARE ALSO CERTIFY THAT THE GOODS ARE OF BANGLADESHI ORIGIN.</td>
	    </tr>
	  <tr>
	    <td colspan="3" valign="top" style="font-size:14px; padding: 5px 0px 0px 0px; letter-spacing: .3px; line-height:20px; text-transform:uppercase;" >&nbsp;</td>
	    </tr>
