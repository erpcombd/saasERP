...
if(isset($_POST['confirm'])){
		...
		$dn_no = next_transection_no('0',$_POST['dn_date'],'delivery_note','dn_no');
		

 
   $so_invoice = 'INSERT INTO delivery_note (dn_no, dn_date, sc_invoice_no, sc_invoice_date, export_lc_no, export_lc_date,  group_for, pi_id, pi_no, view_pi_no, pi_date, pi_type, dealer_group, dealer_code, remarks, status, entry_at, entry_by)
  
  VALUES("'.$dn_no.'", "'.$_POST['dn_date'].'", "'.$_POST['sc_invoice_no'].'", "'.$_POST['sc_invoice_date'].'", "'.$_POST['export_lc_no'].'", "'.$_POST['export_lc_date'].'",  "'.$_POST['group_for'].'", "'.$_POST['pi_id'].'", "'.$_POST['pi_no'].'", "'.$_POST['view_pi_no'].'", "'.$_POST['pi_date'].'", "'.$_POST['pi_type'].'", "'.$_POST['dealer_group'].'", "'.$_POST['dealer_code'].'", "'.$_POST['remarks'].'", 
...
<table width="100%" align="center">
  ...
  <tr>
	...
	<tr>
		  ...
		  <? $sc_data = find_all_field('sales_contract','','pi_id='.$pi_no);?>
		  D/N No: </td>
		  <td><input name="dn_no" type="text" id="" readonly="dn_no"  style="width:220px; height:30px;" autocomplete="off"  value="<?=$_POST['dn_no'];?>" /></td>
		  </tr>
	...
	<table width="100%" align="center">
		<tr>
		  <td>D/N Date : </td>
		  <td><input name="dn_date" type="text" id="dn_date"  required style="width:220px; height:30px;" autocomplete="off" 
		   value="<?=$_POST['dn_date'];?>" /></td>
		  </tr>
		<tr>
