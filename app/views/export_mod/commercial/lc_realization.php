...
do_calander('#realization_date');
  ...
  $maturity_all = find_all_field('maturity_receive','','lc_no="'.$lc_no.'"');
...
if(isset($_POST['confirm'])){
	...
	$realization_date = $_POST['realization_date'];
	$realization_value = $_POST['realization_value'];
	
	$invoice_no = next_transection_no('0',$invoice_date,'lc_realization','invoice_no');	
			...
			<input style="width:220px; height:32px;"  name="invoice_date" type="text" id="invoice_date"  value="<?=($invoice_date!='')?$invoice_date:date('Y-m-d')?>"   required />									</td>
		  	...
		  	<tr>
				...
				<td>&nbsp;&nbsp; %(+/-)</td>
								  ...
								  <tr>
								    <td>LDBC No: </td>
								    <td><input name="ldbc_no" type="text" id="ldbc_no" style="width:220px; height:32px;" value="<?=$maturity_all->ldbc_no;?>"  required tabindex="105" /></td>
								    <td>LDBC Date: </td>
								    <td><input name="ldbc_no_date" type="text" id="ldbc_no_date" style="width:220px; height:32px;" value="<?=$maturity_all->ldbc_no_date?>" required  tabindex="105" /></td>
								    <td>Maturity Receive Date:</td>
								    <td><input name="maturity_rec_date" type="text" id="maturity_rec_date" style="width:220px; height:32px;" value="<?=$maturity_all->maturity_rec_date?>"  tabindex="105" /></td>
							      </tr>
								  <tr>
								    <td>&nbsp;</td>
								    <td>&nbsp;</td>
								    <td>Realization Date:</td>
								    <td><input name="realization_date" type="text" id="realization_date" style="width:220px; height:32px;" value="<?=$realization_date?>" required  tabindex="105" /></td>
								    <td>Realization Value:</td>
								    <td><input name="realization_value" type="text" id="realization_value" style="width:220px; height:32px;" value="<?=$realization_value?>" required  tabindex="105" /></td>
							      </tr>
								</table>
