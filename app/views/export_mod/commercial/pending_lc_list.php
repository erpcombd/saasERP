...
$target_url = '../commercial/lc_update.php';
  ...
  <form action="" method="post" name="codz" id="codz">
    <table width="80%" border="0" align="center">
      <tr>
		...
		foreign_relation('lc_buyer','id','buyer_name',$_POST['dealer_code'],'1 order by buyer_name');
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
   ...
   $res="select * from lc_master where status='MANUAL'  ".$con."  order by lc_no";
