...
$title='Pending PI For Delivery Note Entry';
do_calander('#fdate');
do_calander('#tdate');
...
$target_url = '../commercial/delivery_note_entry.php';
...
$con .= ' and m.id in ('.$_POST['pi_no'].') ';
 		...
 		$sql = "select pi_id, count(pi_no) as pi_no  from delivery_note where1 group by pi_id ";
		 $query = db_query($sql);
