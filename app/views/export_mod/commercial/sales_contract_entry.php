...
$title='Pending PI For Commercial Entry';
do_calander('#fdate');
do_calander('#tdate');
...
$target_url = '../commercial/Sales_Contract_Generate.php';
...
$con .= ' and m.id in ('.$_POST['pi_no'].') ';
 		...
 		$sql = "select pi_id, count(pi_no) as pi_no  from sales_contract where1 group by pi_id ";
		 $query = db_query($sql);
