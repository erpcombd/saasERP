...
if(isset($_POST['confirm'])){
		...
		$invoice_no = next_transection_no('0',$invoice_date,'commercial_pa_receive','invoice_no');	
 
   $so_invoice = 'INSERT INTO commercial_pa_receive (invoice_no, invoice_date, export_lc_no, export_lc_date, expiry_date, bank_buyers, group_for, pi_id, pi_no, view_pi_no, pi_date, pi_type, dealer_group, dealer_code, remarks, tolerance, tenor_days, status, entry_at, entry_by, do_no, job_no, marketing_team, marketing_person,contact_no)
