...
if(isset($_POST['confirm'])){
		...
		$invoice_no = next_transection_no('0',$invoice_date,'commercial_lc_receive','invoice_no');	
 
   $so_invoice = 'INSERT INTO commercial_lc_receive (invoice_no, invoice_date, export_lc_no, export_lc_date, expiry_date, bank_buyers, group_for, pi_id, pi_no, view_pi_no, pi_date, pi_type, dealer_group, dealer_code, remarks, tolerance, tenor_days, status, entry_at, entry_by, do_no, job_no, marketing_team, marketing_person,contact_no)
  ...
  <tr>
	...
	<tr>
        ...
        <? foreign_relation('bank_buyers','bank_id','bank_name',$_POST['bank_buyers'],'dealer_code="'.$pi_data->dealer_code.'" order by bank_id');?>
		  ...
		  value="<?=$_POST['export_lc_date'];?>" /></td>
		  </tr>
		  
		<tr>
			<td width="38%">&nbsp;&nbsp;EXPIRY DATE:</td>
			<td width="62%">
			<input name="expiry_date" type="text" id="expiry_date"  required style="width:220px; height:30px;" autocomplete="off"  
		  value="<?=$_POST['expiry_date'];?>" /></td>
		</tr>
		<tr>
		  <td>&nbsp;&nbsp;REMARKS:</td>
		  <td><input name="remarks" type="text" id="remarks"  required style="width:220px; height:30px;" autocomplete="off"  value="<?=$remarks;?>" /></td>
		  </tr>
	</table>	</td>
...
<input name="marketing_person" type="hidden" id="marketing_person" readonly="" required style="width:200px; height:30px;" autocomplete="off"  value="<?=$pid_data->marketing_person;?>" />
		...
		<tr>
		  ...
		  <td><table>
		  	<tr>
				<td><input name="tolerance" type="text" id="tolerance" required style="width:100px; height:30px;" autocomplete="off"  value="5" /> </td>
				<td>&nbsp;&nbsp; %(+/-)</td>
			</tr>
		  </table></td>
		  </tr>
		<tr>
		  ...
		  <td>
		  <?
		  $tolerance_value = ($order_value*5)/100;
        ...
        <? foreign_relation('tenor_days','tenor_days','tenor_type',$_POST['tenor_days'],'1 order by id');?>
    </select></td>
		  </tr>
		  
		  <tr>
		  <td>&nbsp;&nbsp;CONTACT NO:</td>
		  <td><input name="contact_no" type="text" id="contact_no"   style="width:220px; height:30px;" autocomplete="off"  value="<?=$contact_no;?>" /></td>
		  </tr>
	</table>	</td>
	</tr>
</table>
