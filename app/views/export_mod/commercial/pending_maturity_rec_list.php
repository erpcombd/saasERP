...
$target_url = '../commercial/maturity_receive.php';
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
    ...
    $res="select a.* from lc_master a, boe_receive b where a.status='CHECKED' and a.lc_no=b.lc_no  ".$con." group by b.lc_no  order by a.lc_no";
