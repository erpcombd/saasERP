...
$target_url = '../commercial/boe_submission.php';
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
 		...
 		$sql = "select lc_no, lc_no as lc_no  from boe_submission where 1 group by lc_no ";
		 $query = db_query($sql);
   ...
   $res="select * from lc_master where status='CHECKED'  ".$con."  order by lc_no";
