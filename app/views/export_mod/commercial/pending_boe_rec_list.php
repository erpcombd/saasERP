...
$target_url = '../commercial/boe_receive.php';
...
$con .= ' and m.do_no in ('.$_POST['do_no'].') ';
 		...
 		$sql = "select lc_no, lc_no as lc_no  from boe_receive where 1 group by lc_no ";
		 $query = db_query($sql);
   ...
   $res="select a.* from lc_master a, boe_submission b where a.status='CHECKED' and a.lc_no=b.lc_no  ".$con." group by b.lc_no  order by a.lc_no";
