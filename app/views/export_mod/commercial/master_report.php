...
elseif($_POST['report']==210704002)
{
		...
		<tr style="font-size:12px; height:25px;">
		<th width="3%" bgcolor="#99FFFF">SL</th>
		<th width="10%" bgcolor="#99FFFF">PI No </th>
		<th width="14%" bgcolor="#99FFFF" style="text-align:center">PI Date </th>
		<th width="14%" bgcolor="#99FFFF" style="text-align:center">Customer Name </th>
		<th width="14%" bgcolor="#99FFFF" style="text-align:center">PI Type </th>
		<th width="14%" bgcolor="#99FFFF" style="text-align:center">PI Value </th>
		<th width="17%" bgcolor="#99FFFF" style="text-align:center">Prepared By</th>
		<th width="20%" bgcolor="#99FFFF" style="text-align:center">Approved By</th>
		</tr>
		</thead><tbody>
		<? $sl=1;
		 ...
		 $sql="select  m.id, m.pi_no, m.pi_date, m.pi_type, m.dealer_code, m.entry_by, m.entry_at, m.checked_by, m.checked_at, sum(d.total_amt) as total_amt from  pi_master m, pi_details d  where m.id=d.pi_id   ".$pi_date_con.$job_con.$pi_con.$customer_con.$pi_type_con." group by d.pi_id order by m.id";
...
<? if ($row->pi_type==2){  ?><a href="../pi/master_pi_print_view.php?v_no=<?=$row->id;?>" target="_blank" style=" color:#000000; font-size:12px; font-weight:700;"> <?=$row->pi_no;?></a><? }?>
...
//			$pi_type_con .= ' and m.pi_type = "'.$_POST['pi_type'].'" ';
		  ...
		  $sql="select a.lc_no_view, a.lc_no, a.lc_date, a.export_lc_no, a.export_lc_date, a.expiry_date, a.dealer_code, a.bank_buyers, a.tenor_days, sum(c.total_amt) as total_amt, b.marketing_person  from  lc_master a, lc_receive b, pi_details c  where a.lc_no=b.lc_no  and b.pi_id=c.pi_id ".$pi_date_con.$job_con.$pi_con.$customer_con.$pi_type_con." group by b.lc_no order by a.lc_no";
		...
		<?  
$o=0;
		 $po_sql = 'SELECT  c.job_no FROM lc_master a, lc_receive b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.do_no ';
...
echo $po_data->job_no;}?>
		...
		<?  
$a=0;
		 $pi_sql = 'SELECT  c.pi_no FROM lc_master a, lc_receive b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.pi_id ';
...
//			$pi_type_con .= ' and m.pi_type = "'.$_POST['pi_type'].'" ';
		  ...
		  $sql="select a.lc_no_view, a.lc_no, a.lc_date, a.export_lc_no, a.export_lc_date, a.expiry_date, a.dealer_code, a.bank_buyers, a.tenor_days, sum(c.total_amt) as total_amt, b.marketing_person  from  lc_master a, boe_submission b, pi_details c  where a.lc_no=b.lc_no  and b.pi_id=c.pi_id ".$pi_date_con.$job_con.$pi_con.$customer_con.$pi_type_con." group by b.lc_no order by a.lc_no";
		...
		<?  
$o=0;
		 $po_sql = 'SELECT  c.job_no FROM lc_master a, boe_submission b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.do_no ';
			$po_query=db_query($po_sql);
			while($po_data= mysqli_fetch_object($po_query)){
			$o++;
...
echo $po_data->job_no;}?>
		...
		<?  
$a=0;
		 $pi_sql = 'SELECT  c.pi_no FROM lc_master a, boe_submission b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.pi_id ';
			$pi_query=db_query($pi_sql);
			while($pi_data= mysqli_fetch_object($pi_query)){
			$a++;
...
elseif($_POST['report']==210802003)
{
		...
		<tr style="font-size:12px; height:25px;">
		<th width="2%" bgcolor="#99FFFF">SL </th>
		<th width="4%" bgcolor="#99FFFF">Job No </th>
		<th width="4%" bgcolor="#99FFFF">PI No </th>
		<th width="7%" bgcolor="#99FFFF" style="text-align:center">LC Rec. Date </th>
...
//			$pi_type_con .= ' and m.pi_type = "'.$_POST['pi_type'].'" ';
 	 ...
 	 $sql = "select lc_no, count(lc_no) as lc_no_count  from boe_receive where1 group by lc_no ";
		 ...
		 while($info=mysqli_fetch_object($query)){
		  ...
		  $sql="select a.lc_no_view, a.lc_no, a.lc_date, a.export_lc_no, a.export_lc_date, a.expiry_date, a.dealer_code, a.bank_buyers, a.tenor_days, sum(c.total_amt) as total_amt, b.marketing_person, b.invoice_date  from  lc_master a, boe_submission b, pi_details c  where a.lc_no=b.lc_no  and b.pi_id=c.pi_id ".$pi_date_con.$job_con.$pi_con.$customer_con.$pi_type_con." group by b.lc_no order by a.lc_no";
...
//			$pi_type_con .= ' and m.pi_type = "'.$_POST['pi_type'].'" ';
		  ...
		  $sql="select a.lc_no_view, a.lc_no, a.lc_date, a.export_lc_no, a.export_lc_date, a.expiry_date, a.dealer_code, a.bank_buyers, a.tenor_days, sum(c.total_amt) as total_amt, b.marketing_person  from  lc_master a, boe_receive b, pi_details c  where a.lc_no=b.lc_no  and b.pi_id=c.pi_id ".$pi_date_con.$job_con.$pi_con.$customer_con.$pi_type_con." group by b.lc_no order by a.lc_no";
		...
		<?  
$o=0;
		 $po_sql = 'SELECT  c.job_no FROM lc_master a, boe_receive b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.do_no ';
			$po_query=db_query($po_sql);
			while($po_data= mysqli_fetch_object($po_query)){
			$o++;
...
echo $po_data->job_no;}?>
		...
		<?  
$a=0;
		 $pi_sql = 'SELECT  c.pi_no FROM lc_master a, boe_receive b, pi_details c 
		 WHERE a.lc_no=b.lc_no  and b.pi_id=c.pi_id and a.lc_no="'.$row->lc_no.'" GROUP by c.pi_id ';
			$pi_query=db_query($pi_sql);
			while($pi_data= mysqli_fetch_object($pi_query)){
			$a++;
