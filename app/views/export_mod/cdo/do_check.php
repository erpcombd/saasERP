  ...
  <tr>
    ...
    <div>
      <label style="width:75px;">Dealer : </label>
        <select style="width:180px;" id="dealer_code" name="dealer_code" readonly="readonly">
        <option value="<?=$dealer->dealer_code;?>"><?=$dealer->dealer_name_e.'-'.$dealer->dealer_code;?></option>
        </select>
    </div>
      <div>
          <label style="width:75px;">Depot : </label>
          <select style="width:180px;" id="depot_id2" name="depot_id2" readonly="readonly">
    ...
    <td><fieldset style="width:230px;">
      <div>
        ...
        <textarea name="delivery_address" id="delivery_address" style="width:155px;"><? if($delivery_address!='') echo $delivery_address; else echo $dealer->address_e?></textarea>
            ...
            <div>
        <label style="width:65px;">Note: </label>
...
<? if($$unique_master>0){?>
<table width="100" border="0" align="center" cellpadding="5" cellspacing="0" bgcolor="#FFFF00">
  <tr>
    <td><div align="center"><a target="_blank" href="../report/work_order_bill_corporate.php?v_no=<?=$$unique_master?>">Print This DO</a></div></td>
  </tr>
</table>
<form action="<?=$page?>" method="post" name="codz2" id="codz2">
