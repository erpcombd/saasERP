...
<div class="oe_view_manager oe_view_manager_current">
  <form action=""  method="post">
   ...
   $res = "select o.id,a.fname as name,DATE_FORMAT(o.leave_apply_date,'%d-%b-%Y') as submission_date,DATE_FORMAT(o.s_date,'%d-%b-%Y') as start_date, DATE_FORMAT(o.e_date,'%d-%b-%Y') as end_date,o.total_days,(select leave_type_name from hrm_leave_type where id=o.type) as leave_type,o.incharge_status as status  from ss_user a, hrm_leave_info o where a.user_id=o.PBI_ID and o.incharge_status='Approve' and o.leave_status='GRANTED' order by o.s_date desc";
