...
<form  method="post" action="">
	<h3 align="center" class="n-form-titel1">Tracking Individual</h3>
<table width="100%" border="0" cellspacing="0" cellpadding="4">


<tr>
<td class=" pl-3" style="width: 100px;">Date : </td>
<td><input class="form-control" name="visit_date" type="date" value="<?=$_POST['visit_date']?>" required/></td>

<td class=" pl-3 "> SO List : </td> 
<td>
...
<td>&nbsp;&nbsp;</td>
<td><input name="search" type="submit" id="search" value="Search" class="btn1 btn1-bg-submit" /></td>
