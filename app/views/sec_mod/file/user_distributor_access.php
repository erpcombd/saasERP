...
unset($_POST);
unset($$unique);
header('location:user_warehouse_access.php');
...
$sql = 'select c.*, d.dealer_code, d.dealer_name_e, u.user_id, u.fname from user_warehouse_access c, dealer_info d, ss_user u where c.warehouse_id=d.dealer_code and c.user_id=u.user_id';
$report=db_query($sql);
...
<? //}?>
		...
		<?php
		///user name////
		$sql='select * from ss_user where 1 group by user_id';
		$query=db_query($sql);
            ...
            <form class="n-form"   action="" method="post" enctype="multipart/form-data" name="form1" id="form1" onsubmit="return check()">
                ...
                <div class="form-group row m-0 pl-3 pr-3">
                    ...
                    <div class="col-sm-7 p-0">
                        ...
                        <input type="text" class="m-0" name="user_id" id="user_id" list="dealer_list" value="<?=$user_name_get[$user_id]."|".$user_id?>" tabindex="1" required>
						<datalist id="dealer_list">
						 <? foreign_relation('ss_user','concat(fname,"|",user_id)','""','1')?>
						</datalist>
