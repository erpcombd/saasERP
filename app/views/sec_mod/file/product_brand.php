...
//  mysqli_query($conn, "delete from item_brand where id='".$delid."'");
//  $msg="Delete successfully";
//  redirect('item_brand.php');
//}
...
if (isset($_REQUEST['delid']) && $_REQUEST['delid'] > 1) {
    ...
    $stmt = $conn->prepare("DELETE FROM item_brand WHERE id = ?");
    ...
    // Redirect
    header('Location: item_brand.php');
    exit();
}
...
if(isset($_POST['update'])){
  ...
  update('item_brand','user_id="'.$_GET['edit_id'].'"');
...
<div class="row mb-10 form-group">
	<label class="control-label col-md-6 col-sm-6" for="group_name">Product Brand<span class="required"></span></label>
...
?>                  	
                    <tr>
                      ...
                      <td>
	<a href="product_brand.php?edit_id=<?=$data->id;?>">Edit</a> || 
	<a href="product_brand.php?delid=<?=$data->id;?>" onClick="return confirm('Do you want to delete')">Delete</a>
					</td>
                    </tr>
<? } ?>                    
                  </tbody>
