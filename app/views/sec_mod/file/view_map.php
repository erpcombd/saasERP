...
const secondRouteCoords1 = [
 ...
 // Create waypoints for the second route
                let secondRouteWaypoints = [];
                                
                    secondRouteCoords.forEach(coord => {
                        secondRouteWaypoints.push({
                        location: coord,
                        stopover: true
                });
            });
                let secondRouteWaypoints1 = [];
                                
                    secondRouteCoords1.forEach(coord => {
                        secondRouteWaypoints1.push({
                        location: coord,
                        stopover: true
                });
            });
            ...
            <?php endforeach; ?>
                ...
                // Request directions from Google Maps Directions Service for the second route
                directionsService.route({
                origin: secondRouteWaypoints[0].location,
                destination: secondRouteWaypoints[secondRouteWaypoints.length - 1].location,
                waypoints: secondRouteWaypoints.slice(1, secondRouteWaypoints.length - 1),
                ...
                directionsService.route({
                origin: secondRouteWaypoints1[0].location,
                destination: secondRouteWaypoints1[secondRouteWaypoints1.length - 1].location,
                waypoints: secondRouteWaypoints1.slice(1, secondRouteWaypoints1.length - 1),
                travelMode: google.maps.TravelMode.DRIVING,
                }, function(response, status) {
                if (status === 'OK') {
