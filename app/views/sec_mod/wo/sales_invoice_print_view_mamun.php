	...
	<table width="100%" cellspacing="0" cellpadding="0"  >
		...
		<tr>
		 ...
		 $ucid=find_a_field('sale_do_master','entry_by','do_no="'.$do_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$ucid.'"')?><?php */?></td>
		  <td align="center">
		 <?php /*?><?php
		  
		 $uid=find_a_field('sale_do_chalan','entry_by','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$uid.'"')?><?php */?></td>
		  <td align="center">
		   <?php /*?><?php
		  
		 $euid=find_a_field('sale_do_chalan','checked_by','chalan_no="'.$chalan_no.'"');
		   echo find_a_field('user_activity_management','fname','user_id="'.$euid.'"')?><?php */?>		  </td>
		  <td align="center"> <?php /*?><?php
