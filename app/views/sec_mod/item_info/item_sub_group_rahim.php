                        ...
                        <div class="col-sm-8 p-0">
                            	...
                            	<? if ($item_ledger==0) {?>
									<select name="ledger_group" required="required" id="ledger_group" tabindex="9">
										...
										<option></option>
										<? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class in(123) and group_for="'.$_SESSION['user']['group'].'"');?>
									</select>
								<? }?>
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
                        ...
                        <div class="col-sm-8 p-0">
									...
									<select name="cogs_ledger" id="cogs_ledger" tabindex="9">
										...
										foreign_relation('accounts_ledger','ledger_id','ledger_name',$cogs_ledger,'ledger_group_id 																in(411002,411003) and group_for="'.$_SESSION['user']['group'].'"');?>
									</select>
