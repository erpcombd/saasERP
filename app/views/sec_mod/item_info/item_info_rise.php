...
$unique_field='item_description';

$table='item_info_rise';

$page="item_info_rise.php";
...
$_POST['item_name']=$_POST['item_description'];

$custome_codes = find_a_field('item_info_rise','max(sub_ledger_id)','1');
if($custome_codes>0){
...
$_POST[$unique]=number_format(next_value('item_id','item_info_rise','1',$min,$min,$max), 0, '.', '');
...
$folder='item_info';
$field = 'product_image';
$file_name = $custome_code;
if($_FILES['product_image']['tmp_name']!=''){
$_POST['product_image']=upload_file($folder,$field,$file_name);
$tr_type="Add";
}
$crud->insert();
...
unset($$unique);
//header("Location: item_info_rise.php");
}
						...
						if($_SESSION['item_group']>0||$_SESSION['src_sub_group_id']>0||$_SESSION['src_item_id']!=''||$_SESSION['fg_code']>0){
							...
							<table id="item_table" class="table table-striped table-bordered table-hover table-sm" cellspacing="0">
								...
								<?php
								 ...
								 $td="select a.item_id,a.item_name,b.sub_group_name,a.item_description,a.finish_goods_code, a.status FROM item_info_rise a, item_sub_group b where b.sub_group_id=a.sub_group_id ".$con." order by item_id";
...
<!--					</div>-->
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						...
						<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Style No</label>
						<div class="col-sm-9 p-0">
							<input type="text" name="style_no" class="m-0" id="style_no" value="<?=$style_no?>" required />
						</div>
					</div>

<script>
	function product_description(){
		var get_product_name = document.getElementById("item_name_cus").value;
		var get_color = document.getElementById("color").value;
		var get_size = document.getElementById("size").value;
		var get_fit = document.getElementById("fit").value;
		
		// Combine the values with spaces or other delimiters
		var description = get_product_name + " (" + get_color + ") (" + get_size + ") (" + get_fit + ")";
		...
		document.getElementById("item_description").value = description;
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						...
						<div class="col-sm-9 p-0">
							...
							<input name="item_name_cus" class="m-0" type="text" id="item_name_cus" value="<?php echo $item_name_cus;?>"  required />
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Color  </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="color" id="color" value="<?=$color?>" />

						</div>
					</div>
									<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Size </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="size" id="size" value="<?=$size?>" />

						</div>
					</div>
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Fit </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="fit" id="fit" value="<?=$fit?>" onkeyup="product_description()" />
			...
			<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Product Type  </label>
						<div class="col-sm-9 p-0">
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Gender  </label>
						<div class="col-sm-9 p-0">
...
<!--					</div>-->
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Product Category:</label>
						<div class="col-sm-9 p-0">
...
<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label req-input">Vendor Name  </label>
						<div class="col-sm-9 p-0">

								<?php

								$a2="select vendor_id,vendor_name from vendor where 1 order by vendor_id";

								//echo $a2;

								$a1=db_query($a2);

								echo "<select name=\"vendor_name\" id=\"vendor_name\"\">";
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						...
						<div class="col-sm-9 p-0">
							...
							<input type="text" class="m-0" name="vat" id="vat" value="<?=$vat?>" />

						</div>
					</div>
						<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Profit Percentage  </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="profit_percentage" id="profit_percentage" value="<?=$profit_percentage?>" />

						</div>
					</div>
					
				<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Designer </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="designer" id="designer" value="<?=$designer?>" />
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Season </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="season" id="season" value="<?=$season?>" />
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Composition </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="composition" id="composition" value="<?=$composition?>" />
					...
					<div class="form-group row m-0 pl-3 pr-3 p-1">
						...
						<div class="col-sm-9 p-0">
							...
							<input type="text" class="m-0" name="min_stock" id="min_stock" value="<?=$min_stock?>" />
								...
								<div class="form-group row m-0 pl-3 pr-3 p-1">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Product Image </label>
						<div class="col-sm-9 p-0">

							<input type="file" class="m-0" name="product_image" id="product_image" value="<?=$product_image?>" />
