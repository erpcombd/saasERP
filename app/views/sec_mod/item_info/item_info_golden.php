...
<!---->
					...
					<div class="form-group row m-0 pl-3 pr-3">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Secondary unit name </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="secondary_unit_name" id="secondary_unit_name" value="<?=$secondary_unit_name?>" />
					...
					<div class="form-group row m-0 pl-3 pr-3">
						<label for="group_name" class="col-sm-3 pl-0 pr-0 col-form-label">Secondary quantity </label>
						<div class="col-sm-9 p-0">

							<input type="text" class="m-0" name="secondary_unit_quantity" id="secondary_unit_quantity" value="<?=$secondary_unit_quantity?>" />
