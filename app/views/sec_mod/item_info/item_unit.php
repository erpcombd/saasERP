...
$table='unit_management';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='unit_name';				// For a New or Edit Data a must have data field
							    ...
							    <table width="100%" border="0" cellspacing="0" cellpadding="0">
								  <tr>
									...
									<div>
                                          ...
                                          <input name="unit_name" type="text" id="unit_name" value="<?=$unit_name?>" />
									</div>
