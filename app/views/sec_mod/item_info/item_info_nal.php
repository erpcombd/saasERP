...
<!--					</div>-->
					...
					<div class="form-group row m-0 pl-3 pr-3">
						...
						<div class="col-sm-9 p-0">
							<input type="text" name="finish_goods_code" class="m-0" id="finish_goods_code" value="<?php if($finish_goods_code>0){echo $finish_goods_code;}else{echo find_a_field('item_info','max(finish_goods_code)','1')+1;}?>" required />
						</div>
					</div>
