...
$title='Unapproved Sales Order List';
do_calander('#fdate');
do_calander('#tdate');
...
<div class="form-container_large">
    ...
    <form action="" method="post" name="codz" id="codz">
		<h3 align="center" class="n-form-titel1 mb-0">Search</h3>
...
and w.warehouse_id=m.depot_id and m.entry_by=u.user_id order by m.do_date desc,d.dealer_name_e ";
                    ...
                    where m.status in ('PROCESSING')  and m.dealer_code=d.dealer_code ".$con."
                    and w.warehouse_id=m.depot_id  order by m.do_date desc,d.dealer_name_e ";
                    $query = db_query($res2);
                    while($data = mysqli_fetch_object($query))
                    {?>
