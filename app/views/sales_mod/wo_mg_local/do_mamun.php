				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						<td id="sub">
							...
							<input name="item_id" type="text" value="" id="item_id" onblur="getData2('sales_invoice_mamun_ajax.php', 'so_data_found', this.value, document.getElementById('do_no').value);"/>
						 ...
						 <td id="so_data_found" colspan="14">

							<table  width="100%" border="1" align="left" cellpadding="0" cellspacing="2">
							<tr>
								 <td ><input name="item_name" type="text" readonly=""  autocomplete="off"  value="" id="item_name" /> </td>
								 <td> <input type="text" readonly="" autocomplete="off"  name=""  value="" id="" /> </td>
								 <td> <input type="text" readonly="" autocomplete="off"  name=""  value="" id="" /></td>
								 <td> <input type="text" readonly="" autocomplete="off"  name=""  value="" id="" /></td>
								 <td> <input type="text" readonly="" autocomplete="off"  name=""  value="" id="" /></td>
								 ...
								 <td ><input name="pcs_stock" type="text" readonly=""  autocomplete="off"  value="" id="pcs_stock" /></td>
								 <td ><input name="ctn_price" type="text" id="ctn_price" readonly="" required  value="<?=$do_data->ctn_price;?>" /></td>
								 <td ><input name="pcs_price" type="text" id="pcs_price" readonly="" required="required"  value="<?=$do_data->pcs_price;?>"  /></td>
							</tr>
							</table>
