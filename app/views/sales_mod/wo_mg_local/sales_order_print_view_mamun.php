...
<td  align="right"><?=$data->sale_qty; $total_so_qty +=$data->sale_qty?></td>
...
<td  align="right"><?=$data->total_amt; $tot_total_amt +=$data->total_amt;?></td>
        ...
        <tr>
			...
			<td  align="right" style="text-align:right;"><strong> <?=number_format($total_so_qty,2);?></strong></td>
...
<td align="right"><?=$data->sale_rate?></td>
<td align="right"><?=$data->roll_pcs?></td>
<td  align="right"><?=$data->sale_qty; $total_sale_qty +=$data->sale_qty;?></td>
...
<td  align="right"><?=$data->total_amt; $tot_total_amt +=$data->total_amt;?></td>
        ...
        <tr>
			<td colspan="6"  align="right" style="text-align:right;"><strong>  Sub Total</strong></td>
			<td  align="right" style="text-align:right;"><strong> <?=number_format($total_sale_qty,2);?></strong></td>
			<td  align="right" style="text-align:right;"><strong> <?=number_format($tot_total_amt,2);?></strong></td>
		</tr>
