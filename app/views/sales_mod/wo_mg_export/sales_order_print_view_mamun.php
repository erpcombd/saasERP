...
<td  align="right"><?=$data->sale_qty?></td>
<td align="right"><?=$data->sale_rate?></td>
<td  align="right"><?=$data->total_amt; $tot_total_amt +=$data->total_amt;?></td>
</tr>
        
        <?  } ?>
        <tr>
			<td colspan="7"  align="right" style="text-align:right;"><strong>  Sub Total</strong></td>
			<td  align="right" style="text-align:right;"><strong> <?=number_format($tot_total_amt,2);?></strong></td>
		</tr>

<tr >
          <td colspan="7"  align="right" style="text-align:right;"><strong> Discount (<?=$master->discount;?>%)</strong></td>
 ...
 <? $tot_amt_after_discount = $tot_total_amt-$discount_amt; ?>
        ...
        <tr >
          <td colspan="7"  align="right" style="text-align:right;"><strong> VAT (<?=$master->vat?>%)</strong></td>
          <td  align="right" style="text-align:right;">
		  	<strong>
        ...
        <tr >
          <td colspan="7"  align="right" style="text-align:right;"><strong> Invoice Amount </strong></td>
          <td  align="right" style="text-align:right;">
		  <strong>
...
<td align="right"><?=$data->d_amount; $tot_d_amount +=$data->d_amount;?></td>
...
<td  align="right"><?=$data->total_amt; $tot_total_amt +=$data->total_amt;?></td>
        ...
        <tr>
			<td colspan="7"  align="right" style="text-align:right;"><strong>  Sub Total</strong></td>
			<td align="right" style="text-align:right;"><strong><?=number_format($tot_d_amount,2);?></strong></td>
			<td  align="right" style="text-align:right;"><strong> <?=number_format($tot_total_amt,2);?></strong></td>
		</tr>
...
<div class="footer"  id="footer">
	...
	<table class="footer-table">
		...
		<tr class="text-center"> 
		  ...
		  <?php /*?><?  $receipt=find_a_field('journal','sum(dr_amt)','tr_from="Receipt" and ledger_id='.$dealer->account_code);
		...
		<tr class="text-center w-25"> 
          <td class="text-center w-25">Order Balance   &nbsp;&nbsp;&nbsp;: <?php /*?><?=$order_balance=find_a_field('sale_do_details','sum(total_amt)','dealer_code="'.$dealer->dealer_code.'" and do_no='.$do_no);?><?php */?></td>
        </tr>
		<tr class="text-center w-25"> 
         
          <td class="text-center w-25">Current Balance : <?php /*?><?=number_format($current_balanced=($previous_balanced+$order_balance),2);?><?php */?></td>
        </tr>
        <tr>
