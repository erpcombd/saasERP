    ...
    <form action="" method="post" name="codz" id="codz">
		...
		<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
				<div class="form-group row m-0">
					...
					<a href="do_with_kg.php?new=2" class="btn btn-info btn-block">Create New Order</a>
                   ...
                   <? 
					...
					?>
						...
						?>
							...
							<td>
							<button type="button" onClick="custom('<?=url_encode($data->do_no);?>');" class="btn2 btn1-bg-submit"><i class="fa-solid fa-eye"></i></button>
							</td>
							<td>
