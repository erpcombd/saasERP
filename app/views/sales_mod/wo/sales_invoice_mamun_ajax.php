...
<tr bgcolor="#CCCCCC">
	 ...
	 <td ><input name="unit_name" type="text" class="input3"  value="<?=$item_all->unit_name;?>" id="unit_name" style="width:90%; height:30px;" /></td>

								 
	 <td ><input name="pcs_stock" type="text" class="input3"  value="<?=(int)$stock_in_pcs;?>" id="pcs_stock" style="width:90%; height:30px;" /></td>
	 <td ><input name="unit_price" type="text" class="input3" id="unit_price" onkeyup="count()"  style="width:90%; height:30px;" required="required"  value="<?=$item_sales_price?>"   /></td>
</tr>
</table>
