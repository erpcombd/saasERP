...
$title='Advanced Promotional Offer';
...
<div>
  <div align="center"><strong>Advance Setting</strong></div>
</div>
	  
	   <div>
        <label style="width:150px;">Region: </label>
...
<div>
        <label style="width:150px;">Zone: </label>
<span id="zone"><select name="zone_id" id="zone_id"  onchange="getData2('ajax_area.php', 'area', this.value,  this.value)">
                      <option></option>
...
<span id="area"><select name="area_id" id="area_id"  onchange="getData2('ajax_area.php', 'area', this.value,  this.value)">
                    <option></option>
