              ...
              <tr>
                ...
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#00CC33" style="text-align:center; color:#FFF; font-size:14px; font-weight:bold;"><span class="style4"><span style="font-size:20px; color:#000000;"><?=find_a_field('user_group','group_name','id="'.$_SESSION['user']['group'].'"');?></span> <br />
                    ...
                    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                          ...
                          <td><span class="style5">
                            <?=date("j-M-Y",strtotime($chalan_date));?>
                          </span>
                            &nbsp;</td>
