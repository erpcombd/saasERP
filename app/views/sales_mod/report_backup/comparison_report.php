                                ...
                                <td width="94%"><div align="left">Four(4) Months Area Report(CTR)</div></td>
																					  ...
																					  <tr>
                                                                                        ...
                                                                                        <td><input name="report" type="radio" class="radio" value="1007" /></td>
							  							                                ...
							  							                                <td><div align="left">Yearly Sales Report (Item Wise in KG)</div></td>
																					 ...
																					 <tr>
                                                                                        ...
                                                                                        <td><input name="report" type="radio" class="radio" value="1008" /></td>
							  							                                ...
							  							                                <td><div align="left">Yearly Sales Report (Item Wise in TK)</div></td>
              ...
              <td valign="top"><table width="100%" class="table table-bordered" cellspacing="0" cellpadding="0" align="center">
                 ...
                 <!-- <tr>
                  ...
                  <tr>
                    ...
                    <td><input class="form-control"  name="f_date" type="text" id="f_date" value="<?=date('Y-m-d')?>"/></td>
				  ...
				  <tr>
                    ...
                    <input  name="dealer_code" type="text" id="dealer_code" class="form-control"/>
                  ...
                  <tr>
                    ...
                    <td><span id="branch" class="oe_form_group_cell">
                      ...
                      <select class="form-control" name="region_id" id="region_id" onchange="getData2('ajax_zone.php', 'zone', this.value,  this.value)">
                  ...
                  <tr>
                    ...
                    <td><span id="zone"><select class="form-control" name="zone_id" id="zone_id"  onchange="getData2('ajax_area.php', 'area', this.value,  this.value)">
                  ...
                  <tr>
                    ...
                    <td><span id="area"><select class="form-control" name="area_id" id="area_id"  onchange="getData2('ajax_area.php', 'area', this.value,  this.value)">
                  ...
                  <tr>
                    ...
                    <td><span class="oe_form_group_cell" style="padding: 2px 0 2px 2px;">
                      ...
                      <select class="form-control" name="depot_id" id="depot_id" style="width:220px;">
      ...
      <td><div class="box">
        ...
        <table width="1%" border="0" cellspacing="0" cellpadding="0" align="center">
            ...
            <tr>
              ...
              <td><input class="form-control btn-success" name="submit" type="submit" class="btn" value="Report" /></td>
