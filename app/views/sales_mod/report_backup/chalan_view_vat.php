...
$sql1="select d.*,b.*, sum(b.total_unit) as total_unit, d.total_unit as ord_unit, sum(b.total_amt) as total_amt, b.total_unit as item_ex, m.depot_id as depot, m.remarks, m.cash_discount as cash_discountm
              ...
              <tr>
                ...
                <td><table  width="80%" border="0" align="center" cellpadding="3" cellspacing="0">
                  ...
                  <tr>
					...
					<span style="font-size:20px; color:#000000;"><?=find_a_field('user_group','group_name','id="'.$_SESSION['user']['group'].'"');?></span> <br />

                          <span class="style6" style="font-size:14px; color: #000000;  "><br /> <b>মূল্য সংযোজন কর নিবন্ধন নং- ২২০২১০১৩৫৮০ </b>  </span></span></td>
                  ...
                  <tr>
                    ...
                    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                          ...
                          <td><?=date("j-M-Y",strtotime($chalan_date));?>
		  ...
		  <tr>
			...
			<td width="30%"><table width="100%" border="0" cellspacing="0" cellpadding="3"  style="font-size:13px">
			  ...
			  <tr>
			    ...
			    <td align="right" valign="middle">Memo No:</td>

			    <td><table width="100%" border="1" cellspacing="0" cellpadding="3">

			      <tr>

			        <td style="font-size:16px; font-weight:bold"><?php echo $memo_no;?>&nbsp;</td>
			        </tr>
