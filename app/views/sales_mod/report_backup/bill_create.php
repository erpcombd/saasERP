...
if($count>0)
{
 $csql = "INSERT INTO `sale_chalan_bill` (`chalan_no`, `entry_at`, `entry_by`, `delete`, `bill_date`) VALUES ('".$_POST['chalan_no']."', '".date('Y-m-d H:i:s')."', '".$_SESSION['user']['id']."', 'NO', '".$_POST['bill_date']."')";
 db_query($csql);
}
}
?>
