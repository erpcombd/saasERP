        ...
        <div class="row m-0 p-0">
            <div class="col-sm-5">
              ...
              <div class="form-check">
				...
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn4" value="7111" />
                    <label class="form-check-label p-0" for="report1-btn4">SO wise delivery report (7111)</label>
				</div>
				
<!--				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn1" value="301" />
                    <label class="form-check-label p-0" for="report1-btn1">DO Pending Brief Report</label>
				</div>-->
				
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn2" value="1991"  />
                  <label class="form-check-label p-0" for="report1-btn2">Delivery Order Challan Amt Report (1991)</label>
                </div>
				
								
			  <div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn8" value="20231"  />
                  <label class="form-check-label p-0" for="report1-btn8">SO Wise Work Order & Chalan Report (20231)</label>
                </div>
				
				
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn7" value="2023"  />
                  <label class="form-check-label p-0" for="report1-btn7">Delivery Chalan Brief Report (2023)</label>
                </div>
				
								
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn10" value="231119"  />
                  <label class="form-check-label p-0" for="report1-btn10">Final Delivery Challan  Report (231119)</label>
                </div>
				
				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn9" value="20232"  />
                  <label class="form-check-label p-0" for="report1-btn9">Sales Report (20232)</label>
                </div>
				
				
				<!--<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn5" value="1992" />
                    <label class="form-check-label p-0" for="report1-btn5">Sales Statement(As Per DO)</label>
                </div>-->
				<!--<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn6" value="1993" />
                    <label class="form-check-label p-0" for="report1-btn6">Party Collection Summery Group wise</label>
				</div>-->
<!--				<div class="form-check">
                    <input name="report" type="radio" class="radio1" id="report1-btn3" value="191" />
                    <label class="form-check-label p-0" for="report1-btn3">Delivery Order Report (At A Glance)</label>
				</div>-->
            ...
            <div class="col-sm-7">
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
					  ...
					  <input  name="f_date" type="text" id="f_date" value=""  autocomplete="off"/>
                       <?php /*?> <input  name="f_date" type="text" id="f_date" value="<?=date('Y-m-01')?>"/><?php */?>
                      </span>
                ...
                <div class="form-group row m-0 mb-1 pl-3 pr-3">
                    ...
                    <div class="col-sm-8 p-0">
							<input  name="t_date" type="text" id="t_date" value=""  autocomplete="off"/>
                        <?php /*?><input  name="t_date" type="text" id="t_date" value="<?=date('Y-m-d')?>"/><?php */?>
