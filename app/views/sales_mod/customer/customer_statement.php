            ...
            <div class="row p-3">
                <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="form-group row m-0 p-0">
                        ...
                        <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 p-0">
                            <input name="fdate" type="date" id="fdate" class="form-control req"  value="<?php echo $_REQUEST['fdate'];?>" required /> 
                        </div>
                    </div>
				...
				<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 p-2">
                    <div class="form-group row m-0 p-0">
                        ...
                        <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10 p-0">
	                       <input name="tdate" type="date" id="tdate" class="form-control req" value="<?php echo $_REQUEST['tdate'];?>" required />
                        </div>
                    </div>
