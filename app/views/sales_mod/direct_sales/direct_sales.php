...
if(isset($_POST['confirmm']))
{
		...
		$avg_rate = find_a_field('journal_item','final_price','item_id="'.$data->item_id.'"  order by id desc');
		...
		journal_item_control($data->item_id ,$_POST['warehouse_id'],$data->oi_date,0,$data->qty,$page_for,$tr_id,$avg_rate,'',$_SESSION['oi_no2']);
				...
				<div class="row">
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<input  name="warehouse_id" type="hidden" id="warehouse_id" value="<?=$_POST['warehouse_id']?>"  required/>
					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
							      <? $field='vendor_id'; ?>
								<label for="<?=$field?>" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Customer:</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										<input type="text" list="dealerList" name="dealer_code" id="dealer_code" value="<?=find_a_field('dealer_info','concat(dealer_name_e,"#",dealer_code)','dealer_code="'.$vendor_id.'"');?>" required />
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tbody class="tbody1">
						...
						<tr>
							...
							<input  name="dist_unit" type="text" class="input3" id="dist_unit" value="" required  onkeyup="count()" />
