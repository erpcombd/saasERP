...
<!--        top form start hear-->
        <div class="container-fluid bg-form-titel">
            <div class="row">
                <!--left form-->
				     <div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
                 <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Offer ID</label>
                  ...
                  <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Dealer Type</label>
						...
						<div class="form-group col-sm-4 col-md-4 col-lg-4 col-xl-4 row m-0 pb-1">
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">On Unit Qty (Pcs)</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
