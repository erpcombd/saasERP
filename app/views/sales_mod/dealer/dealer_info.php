				...
				<div class="row">
					...
					<?php /*?>	<?php
						...
						?>
							...
							<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$tin?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$tin?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" /></a>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						?>
							...
							<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$trade?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$trade?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" /></a>
						</div>
					</div>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						?>
    						...
    						<img src="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=customer_bin&&name=<?=$bin;?>" onerror="this.onerror=null; this.src='<?= $defaultImage ?>';" alt="Image" />
								...
								<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$bin?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$bin?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" /></a>
							</div>
					</div>
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						?>
							...
							<a href="<?=SERVER_CORE?>core/upload_view.php?name=<?=$cheque?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" target="_blank" ><img src="<?=SERVER_CORE?>core/upload_view.php?name=<?=$cheque?>&folder=customer&proj_id=<?=$_SESSION['proj_id']?>" /></a>
						</div>
					</div>
