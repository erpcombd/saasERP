...
$newFileName = 'customer_tin_'.$random;
$ext = end(explode(".",$_FILES['tin']['name']));
$_POST['tin']=upload_file($folder,$field,$file_name);
//file_upload_aws('tin','customer_tin',$newFileName);
...
$random = random_int(10000,99999);
$newFileName = 'customer_trade_'.$random;
$ext = end(explode(".",$_FILES['trade']['name']));
$_POST['tin']=upload_file($folder,$field,$file_name);
//file_upload_aws('trade','customer_trade',$newFileName);
...
$random = random_int(10000,99999);
$newFileName = 'customer_bin_'.$random;
$ext = end(explode(".",$_FILES['bin']['name']));
$_POST['tin']=upload_file($folder,$field,$file_name);
//file_upload_aws('bin','customer_bin',$newFileName);
...
$random = random_int(10000,99999);
$newFileName = 'customer_cheque_'.$random;
$ext = end(explode(".",$_FILES['cheque']['name']));
$_POST['tin']=upload_file($folder,$field,$file_name);
//file_upload_aws('cheque','customer_cheque',$newFileName);
...
$_POST['cheque']=upload_file($folder,$field,$file_name);
	...
	$sub_ledger_id = $_POST['sub_ledger_id'];
	  ...
	  $sql1 = 'update  general_sub_ledger set sub_ledger_name="'.$_POST['dealer_name_e'].'",group_for="'.$_POST['group_for'].'"  
			...
			<div class="container-fluid n-form1">
				<div class="row">
					...
					<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3 pt-1 pb-1">
						...
						<?php /*?>	<a href="../../../controllers/uploader/upload_view.php?proj_id=<?=$_SESSION['proj_id']?>&&folder=customer_tin&&name=<?=$tin;?>" target="_blank">
