...
$title='Sales Executive  Add';			// Page Name and Page Title
do_datatable('vendor_table');
$page="dealer_info_vision.php";		// PHP File Name
		...
		<div class="row">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Executive Name:</label>
					...
					<!--<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">                             Marketing Person:</label>
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">

							<?php /*?><input name="mkt_perspn" type="text" id="mkt_perspn" tabindex="2" value="<?=$mkt_perspn?>" /><?php */?>
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Executive Type :</label>
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Mobile No:</label>
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
											...
											<select name="ledger_group" required="required" id="ledger_group" style="width:95%; font-size:12px;" tabindex="9">
                                              ...
                                              <?php /*?><? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_class=1 and group_id in("10306","10307")');?><?php */?>
											   ...
											   <? foreign_relation('ledger_group','group_id','group_name',$ledger_group,'acc_sub_sub_class="122" and group_for="'.$_SESSION['user']['group'].'"');?>
						...
						<div class="form-group row m-0">
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
								...
								<select name="region_code" id="region_code" tabindex="9"
										...
										onchange="getData2('dealer_zone_vision_ajax.php', 'dealer_zone_find', this.value,  document.getElementById('region_code').value);">
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex vendor_label_text justify-content-start align-items-center pr-1 bg-form-titel-text">Marketing Person:</label>
					...
					<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
						...
						<div class="form-group row m-0">
							...
							<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 vendor_label_text d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Warehouse:</label>
							...
							<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
								...
								<select name="depot" required="required" id="depot" tabindex="9">
									...
									<? foreign_relation('warehouse','warehouse_id','warehouse_name',$depot,'1 and group_for="'.$_SESSION['user']['group'].'"');?>
