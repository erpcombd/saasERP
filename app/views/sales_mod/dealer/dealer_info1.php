...
$_POST['cheque']=upload_file($folder,$field,$file_name);
	...
	$sub_ledger_id = $_POST['sub_ledger_id'];
	  ...
	  $sql1 = 'update  general_sub_ledger set sub_ledger_name="'.$_POST['dealer_name_e'].'" 
...
<ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item" role="presentation">
    <button class="nav-link active customer_button" id="home-tab" data-toggle="tab" data-target="#customer" type="button" role="tab" aria-controls="home" aria-selected="true">Customer Information</button>
  </li>
  <li class="nav-item" role="presentation">
    <button class="nav-link customer_button" id="profile-tab" data-toggle="tab" data-target="#file" type="button" role="tab" aria-controls="profile" aria-selected="false">Customer File Upload</button>
  </li>
</ul>
