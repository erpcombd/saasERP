				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						...
						<td>
							...
							<a href="mr_print_pdf_new.php?do_no=<?=$row->do_no?>" class="btn1 btn1-bg-submit" target="_blank">Pdf</a><br>
							<a href="mr_print_pdf_new_no_pad.php?do_no=<?=$row->do_no?>" class="btn1 btn1-bg-cancel" target="_blank">Pdf Without Pad</a><br>
