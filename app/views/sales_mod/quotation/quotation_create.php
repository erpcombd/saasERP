...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Quo. No :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Sale Type :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Quo. By:</label>
...
<div class="form-check">
    ...
    <input type="checkbox" id="vat_box" name="vat_box" value="1" <?php if($vat_box==1) echo "checked='checked'"; ?> onclick="vat_fnc()" >
    <label class="form-check-label p-0 pr-1 pt-1" for="vat_box">VAT : </label>
</div>

<div id="vat_div" class="form-group row m-0 pb-1" style="display:<?php if($vat > 0) echo "block"; else echo "none"; ?>">
...
<div id="ait_div"  class="form-group row m-0 pb-1" style="display:<? if( $ait >0 ) echo "block"; else echo "none"; ?>">
...
<div id="vat_ait_div" style="display:<? if( $vat_ait >0 ) echo "block"; else echo "none"; ?>" class="form-group row m-0 pb-1">





<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">VAT & AIT (%):</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Rate Type :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Concern :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Deduct :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Transport Cost :</label>
...
<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Payment terms :</label>
...
<td width="44%"><input name="item_name" type="text"  readonly=""  autocomplete="off"  value="" id="item_name"  /> </td>





<td width="14%"><input name="pcs_stock" type="text"  readonly=""  autocomplete="off"  value="" id="pcs_stock"  /></td>





<td width="17%"><input name="ctn_price" type="text" id="ctn_price" readonly=""   required  value="<?=$do_data->ctn_price;?>"   /></td>
