										...
										<div class="row">
											...
											<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 pt-1 pb-1">
												...
												<div class="form-group row m-0">
													...
													<label class="col-2 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Customer Name:</label>
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
																...
																<div
																	...
																	<div class="form-group row m-0">
																		...
																		<label
																			class="col-2 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Customer
																			Type :</label>
																...
																<div
																	...
																	<div class="form-group row m-0">
																		...
																		<label
																			class="col-2 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">A/C
																			Configuration:</label>
																...
																<div
																	...
																	<div class="form-group row m-0">
																		...
																		<label
																			class="col-2 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Address:</label>
																...
																<div
																	...
																	<div class="form-group row m-0">
																		...
																		<label
																			class="col-2 m-0 p-0 vendor_label_text d-flex justify-content-end align-items-center pr-1 bg-form-titel-text req-input">Depot:</label>
