					...
					<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
						<div class="container n-form2">
							...
							<div class="form-group row m-0 pb-1">
								...
								<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">File Upload</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
							...
							<div class="form-group row m-0 pb-1">
								<label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">View Attached File</label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
				...
				<table class="table1  table-striped table-bordered table-hover table-sm">
					...
					<tr>
						<td id="sub">
							...
							<?php /*?><input name="item_id" type="text" value="" id="item_id" onblur="getData2('sales_invoice_ajax.php', 'so_data_found', this.value, document.getElementById('do_no').value);"/><?php */?>
							
							<input list="item_list"  name="item_id" type="text" id="item_id" value="<?=$item_id?>" required="required" onblur="getData2('sales_invoice_ajax.php', 'so_data_found', this.value, document.getElementById('warehouse_id').value);"/>
						 ...
						 <td id="so_data_found" colspan="4">
							...
							<tr>
								 ...
								 <td width="20%"><input name="ctn_price" type="text" id="ctn_price"  required  value="<?=$do_data->ctn_price;?>" /></td>
