...
$title='Asset/Device Return Clearance';			// Page Name and Page Title
?>
            ...
            <div class="modal-dialog">
              <div class="modal-content">
                <div class="modal-header">
                  ...
                  <h4 id="myModalLabel">
                    Product Received Entry from Emp. 
                  </h4>
              </div>
              <div class="modal-body">
                  ...
                  <div class="form-group">
                      ...
                      <datalist id='eip_ids'>
                      <option></option>
				<? foreign_relation('personnel_basic_info','PBI_ID','concat(PBI_ID," - ",PBI_NAME)',$emp_id,'PBI_JOB_STATUS="In Service"');?>
					  </datalist>
                  ...
                  <div class="form-group">
				    ...
				    <div class="form-group">
                      <label for="qty">Received QTY:</label>
	  ...
	  <form method="post" id="editform">
        <div class="modal" id="editModal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            <div class="modal-dialog">
			 ...
			 <button type="button" class="btn btn-danger btn-md" data-toggle="modal" data-target="#recivedModal"> <i class="fa fa-plus"></i> Product Received</button>
...
<?					  
 ...
 $sql = 'select a.asign_id,p.PBI_NAME,i.item_name,a.item_in,a.asign_date
from product_asign a,personnel_basic_info p,item_info i
where tr_from="receive" and a.emp_id=p.PBI_ID and a.product=i.item_id order by a.asign_id desc';
$query=db_query($sql);		
...
<a href="edit_product_received.php?asign_id=<?=$data->asign_id;?>" data-id='' class="btn btn-primary btn-flat manage_establishment"> <i class="fa fa-edit"></i> </a>
<a href="delete_product_received.php?asign_id=<?=$data->asign_id;?>" onclick="return confirm('Are you sure you want to delete this item?');"   class="btn btn-danger btn-flat"> <i class="fa fa-trash"></i> </a>
	                      </div>
						</td>
                        </tr>
