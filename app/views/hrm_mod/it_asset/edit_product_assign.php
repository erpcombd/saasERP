...
//Update details and activation code in the users table
 ...
 $sqlupdate="UPDATE product_asign SET emp_id = '$emp_id',product='$product_name',item_ex='$product_qty',asign_date='$assign_date' WHERE asign_id ='".$_GET['asign_id']."' ";
...
?>
      ...
      <input type="text" class="form-control" list='item' name="product" id="product" value="<?=$productt;?>" requierd/>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="item_ex" class="form-control col-md-7 col-xs-12" type="number" value="<?=$item_ex;?>" name="item_ex">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                         <a href="product_assign.php"> <button class="btn btn-primary" type="button">Cancel</button></a>
