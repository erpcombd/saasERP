...
<table class="table table-bordered table-sm" id="sales_list">
	...
	<?php 
	   ...
	   $sql="select * from performance_appraisal where status in('FINAL APPROVAL')  order by id desc ";
	   }
	...
	?>
		<tr>
			...
			<td><a href="performance_apprisial_view_md_check.php?emp_id=<?php echo $pbi_all->PBI_ID;?>&id=<?php echo $data->id;?>"  ><input type="button" value="View" /></a></td>
