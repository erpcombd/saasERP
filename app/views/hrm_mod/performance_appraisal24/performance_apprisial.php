...
$datediff = $now - $your_date;
  ...
  $tot_day=round($datediff / (60 * 60 * 24));
    ...
    $tot_day_tpc=round($datediff_tpc / (60 * 60 * 24));
							...
							<div class="input-group mb-3 input-group-sm">
							  <div class="input-group-prepend" style="width:38%">
								<span class="input-group-text"  style="font-weight:bold; font-size:14px;">Experience in NAGAT Group </span>
							  </div>
					...
					<h4 style="text-align:center;">Necessary Information (During appraisal period):</h4> 
					  ...
					  <div class="row m-0 p-0">
						...
						<div class="input-group mb-3 input-group-sm">
							...
							//echo 'select id from salary_attendence where mon="'.$date_mon_from[1].'" and year="'.$date_mon_from[0].'" and EMP_ID="'.$all_data_master->employee_id.'"';
							 ...
							 // echo 'select sum(ab+lwp) from salary_attendence where EMP_ID="'.$all_data_master->employee_id.'" and id between "'.$from_id.'" and "'.$to_id.'"';
							  ?>
