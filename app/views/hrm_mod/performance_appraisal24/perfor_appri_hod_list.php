...
<table class="table table-bordered table-sm" id="sales_list">
	...
	if($_SESSION['user']['id']==1 || $_SESSION['user']['id']==10130){
	   ...
	   $sql="select * from performance_appraisal where status in('CHECKED') and  employee_id in(select EMP_ID from personnel_basic_info where incharge_id='".$hod_pbi."')  order by id desc ";
	   }
