...
$title='Self Assessment Status List ';
...
<table class="table table-bordered table-sm" id="sales_list">
	...
	<?php 
	   ...
	   $sql="select * from self_assessment_appraisal where 1  order by id desc ";
	...
	?>
		<tr>
		 ...
		 <td><?=$data->from_date." To ".$data->to_date?></td>
		  <td><?=$data->status?></td>
			<td><a href="self_assessment_view_final.php?emp_id=<?php echo $pbi_all->PBI_ID;?>&id=<?php echo $data->id;?>"  ><input type="button" value="View" /></a></td>
