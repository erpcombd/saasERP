...
// ::::: Edit This Section ::::: 
$title='Profession Type Information';			// Page Name and Page Title
$page="profession_type.php";		// PHP File Name
$input_page="profession_type_input.php";
$root='setup';

$table='profession';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='profession_name';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Profession Type :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="profession_name" type="text" id="profession_name" value="<?=$profession_name?>" /></td>
