...
// ::::: Edit This Section ::::: 
$title='Level Name';			// Page Name and Page Title
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Level Name :</td>
                  <td bgcolor="#E8E8E8" width="40%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="level_name" type="text" id="level_name" value="<?=$level_name?>" /></td>
                   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Class Name :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <select name="class_id" id="class_id">
                <option value="<?=$class_id?>"><?=find_a_field('hrm_class','class_name','id="'.$class_id.'"');?></option>
                  <?php 
