...
// ::::: Edit This Section ::::: 
$title='section Setup';			// Page Name and Page Title
$page="section_type.php";		// PHP File Name
$input_page="section_type_input.php";
$root='setup';

$table=' PBI_Section';		// Database Table Name Mainly related to this page
$unique='sec_id';			// Primary Key of this Database table
$shown='sec_name';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Section:</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="sec_name" type="text" id="sec_name" value="<?=$sec_name?>" required /></td>
