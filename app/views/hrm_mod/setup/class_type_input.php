...
// ::::: Edit This Section ::::: 
$title='Class Type Information';			// Page Name and Page Title
$page="class_type.php";		// PHP File Name
$input_page="class_type_input.php";
$root='setup';

$table=' hrm_class';		// Database Table Name Mainly related to this page
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Class :</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="class_name" type="text" id="class_name" value="<?=$class_name?>" required /></td>
