...
$page="branch_type.php";		// PHP File Name
$input_page="branch_type_input.php";
$root='setup';
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Branch Name :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="BRANCH_NAME" type="text" id="BRANCH_NAME" value="<?=$BRANCH_NAME?>" /></td>
