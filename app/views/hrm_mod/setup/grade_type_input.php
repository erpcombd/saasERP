...
// ::::: Edit This Section ::::: 
$title='Grade Type';			// Page Name and Page Title
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Grade Name :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="grade_name" type="text" id="grade_name" value="<?=$grade_name?>" /></td>
                </tr>
