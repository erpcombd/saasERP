...
// ::::: Edit This Section ::::: 
$title='Division Information';			// Page Name and Page Title
$page="division.php";		// PHP File Name
$input_page="division_input.php";
$root='setup';

$table='division';		// Database Table Name Mainly related to this page
$unique='division_CODE';			// Primary Key of this Database table
$shown='division_name';				// For a New or Edit Data a must have data field
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <input name="division_name" id="division_name" value="<?=$division_name?>" style="width:150px;"/> 
				  <input name="division_CODE" type="hidden" value="<?=$division_CODE?>"/>                 </td>
