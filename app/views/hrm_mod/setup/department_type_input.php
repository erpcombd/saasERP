...
// ::::: Edit This Section ::::: 
$title='Department Type Information';			// Page Name and Page Title
$page="department_type.php";		// PHP File Name
$input_page="department_type_input.php";
$root='setup';

$table='department';		// Database Table Name Mainly related to this page
$unique='DEPT_ID';			// Primary Key of this Database table
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Department Type :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                    <input name="DEPT_DESC" type="text" id="DEPT_DESC" value="<?=$DEPT_DESC?>" required /></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td width="18%" height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">Short Name:</td>
                  <td width="82%" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="DEPT_SHORT_NAME" type="text" id="DEPT_SHORT_NAME" value="<?=$DEPT_SHORT_NAME?>" required /></td>
