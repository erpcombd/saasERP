...
// ::::: Edit This Section ::::: 
$title='Line Type Information';			// Page Name and Page Title
...
{		
$now				= time();
$_POST['line_name'] = $_POST['line_name'];
$crud->insert();
$type=1;
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Line :</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="line_name" type="text" id="line_name" value="<?=$line_name?>" required /></td>
