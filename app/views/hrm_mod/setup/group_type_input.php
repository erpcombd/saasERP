...
// ::::: Edit This Section ::::: 
$title='Group Type Information';			// Page Name and Page Title
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Group :</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="group_name" type="text" id="group_name" value="<?=$group_name?>" required /></td>
