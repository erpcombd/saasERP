...
// ::::: Edit This Section ::::: 
$title='Salary Group';			// Page Name and Page Title
$page="dept_group.php";		// PHP File Name
$input_page="dept_group_input.php";
$root='setup';

$table='salary_group';		// Database Table Name Mainly related to this page
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Group Name :</td>
