...
// ::::: Edit This Section ::::: 
$title='Location Type Information';			// Page Name and Page Title
$page="location_type.php";		// PHP File Name
$input_page="location_type_input.php";
$root='setup';

$table='office_location';	    	// Database Table Name Mainly related to this page
$unique='ID';			// Primary Key of this Database table
$shown='LOCATION_NAME';				// For a New or Edit Data a must have data field
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Location Name :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="LOCATION_NAME" type="text" id="LOCATION_NAME" value="<?=$LOCATION_NAME?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label"> Organization Name::</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <select name="GROUP_ID">
                    <? foreign_relation('user_group','id','group_name',$REGION_ID);?>
                  </select></td>
