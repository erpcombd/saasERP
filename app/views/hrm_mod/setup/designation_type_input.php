...
$input_page="designation_type_input.php";
$root='setup';
...
{		
$now				= time();
$_POST['DESG_SHORT_NAME'] = $_POST['DESG_SHORT_NAME'];
$crud->insert();
$type=1;
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Designation:</td>
                  ...
                  <input name="DESG_DESC" type="text" id="DESG_DESC" value="<?=$DESG_DESC?>" required /></td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">In Short: </td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label"><input name="DESG_SHORT_NAME" type="text" id="DESG_SHORT_NAME" value="<?=$DESG_SHORT_NAME?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Level:</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                      <select name="level_id" id="level_id">
                <option value="<?=$level_id?>"><?=find_a_field('hrm_level','level_name','id="'.$level_id.'"');?></option>
                  <?php 
                  $sql='select * from hrm_level';
                  $query=db_query($sql);
                  ...
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label"> </td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label"> </td>
                </tr>
                <tr class="oe_form_group_row">
