...
$friday_of_month = $_POST['friday_of_month'];

$ss="INSERT INTO hrm_payroll_setup (year ,mon ,days_of_month)
VALUES($year, $mon, $days_of_month,$friday_of_month)";
db_query($ss);*/
...
while (list($key, $value1)=each($data))
{ $$key=$value1;}
}
...
<td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Value :</td>
<td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
<input name="value" type="hidden" id="value" value="<?=$value?>" /></td>
</tr>
				
				
<tr class="oe_form_group_row">
<td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Year :</td>
<td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">
<input name="year" type="text" id="year" value="<?=$year?>" /></td>
</tr>				

				
<tr class="oe_form_group_row">
<td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Month :</td>
<td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">
<input name="mon" type="text" id="mon" value="<?=$mon?>" /></td>
</tr>

<tr class="oe_form_group_row">
<td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Days of Month :</td>
<td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">
<input name="days_of_month" type="text" id="days_of_month" value="<?=$days_of_month?>" /></td>
</tr>

<tr class="oe_form_group_row">
<td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Friday count :</td>
<td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">
<input name="friday_of_month" type="text" id="friday_of_month" value="<?=$friday_of_month?>" /></td>
</tr>
