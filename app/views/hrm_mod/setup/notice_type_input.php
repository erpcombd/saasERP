...
<body>
   ...
   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Notice Title:</td>
                  ...
                  <input name="notice_title" type="text" id="notice_title" value="<?=$notice_title?>" />
				  </td>
				  
				  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Notice Description :</span>
				  </td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
				  
				   <textarea id="notice_description" name="notice_description" rows="4" cols="50"><?=$notice_description?></textarea>
				...
				<tr class="oe_form_group_row">
   <td bgcolor="#fff" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Notice Date :</td>
                  <td bgcolor="#fff" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="notice_date" type="date" id="notice_date" value="<?=$notice_date?>" />
                  
				  </td>
				  
				  <td bgcolor="#fff" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Notice Expaire Date	 :</span>
				  </td>
                  <td bgcolor="#fff" width="25%" class="oe_form_group_cell">
				<input name="notice_expaire_date" type="date" id="notice_expaire_date" value="<?=$notice_expaire_date?>" />
				  </td>
   ...
   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Status :</td>
				...
				<tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;department</td>
                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                 <select name="department" style="width:160px;" id="department" required>
                    <? foreign_relation('department','DEPT_ID','DEPT_DESC',$department);?>
                  </select>
                  
				  </td>
				  
				  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label"></span> &nbsp;</td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">&nbsp;</td>
