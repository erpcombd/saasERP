...
if(isset($emp_id)){$emp_id_con=" and d.EMP_CODE IN (".$emp_id.")";
...
echo  $sql = " SELECT d.EMP_CODE,a.roster_date,min(d.xtime) in_time,max(d.xtime) out_time,a.shedule_1,p.schedule_type,p.PBI_ID
