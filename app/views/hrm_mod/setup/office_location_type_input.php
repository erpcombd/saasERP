...
// ::::: Edit This Section ::::: 
$title='Office Location Information';			// Page Name and Page Title
$page="office_location_type.php";		// PHP File Name
$input_page="office_location_type_input.php";
$root='setup';
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Location Name  :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="PROJECT_DESC" type="text" id="PROJECT_DESC" value="<?=$PROJECT_DESC?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
                  ...
                  <select name="GROUP_ID">
                      <option></option>
                    <? foreign_relation('user_group','id','group_name',$GROUP_ID,' 1');?>
                  </select></td>
                </tr>
                <tr class="oe_form_group_row">
