...
// ::::: Edit This Section ::::: 
$title='Cost Center Setup';			// Page Name and Page Title
$page="cost_center_type.php";		// PHP File Name
$input_page="cost_center_type_input.php";
$root='setup';

$table=' hrm_cost_center';		// Database Table Name Mainly related to this page
...
{		
$now				= time();
$_POST['center_name'] = $_POST['center_name'];
$crud->insert();
$type=1;
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Cost Center :</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="center_name" type="text" id="center_name" value="<?=$center_name?>" required /></td>
