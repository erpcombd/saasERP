...
// ::::: Edit This Section ::::: 
$title='Group Information';			// Page Name and Page Title
$page="dept_assign.php";		// PHP File Name
$input_page="dept_assign_input.php";
$root='setup';

$table='department_group';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='group_id';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Group :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <select name="group_id" id="group_id">
				  <option></option>
				  <? foreign_relation('salary_group','id','group_name',$group_id)?>
				  </select></td>
                </tr>
				<tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Department :</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
