...
// ::::: Edit This Section ::::: 
$title='Action Type Information';			// Page Name and Page Title
$page="action_type.php";		// PHP File Name
$input_page="action_type_input.php";
$root='setup';

$table='action_type';		// Database Table Name Mainly related to this page
$unique='ACTION_TYPE_CODE';			// Primary Key of this Database table
$shown='ACTION_TYPE';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Action Type :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="ACTION_TYPE" type="text" id="ACTION_TYPE" value="<?=$ACTION_TYPE?>" /></td>
                </tr><tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Action Effect :</td>
                  <td bgcolor="#E8E8E8" width="100%" class="oe_form_group_cell oe_form_group_cell_label">
                  <select name="effect">
