...
// ::::: Edit This Section ::::: 
$title='Bank Information';			// Page Name and Page Title
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="37%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Bank Name :</td>
                  <td bgcolor="#E8E8E8" width="63%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="BANK_NAME" type="text" id="BANK_NAME" value="<?=$BANK_NAME?>" /></td>
