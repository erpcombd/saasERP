...
// ::::: Edit This Section ::::: 
$title='District Type Information';			// Page Name and Page Title
$page="zone_type.php";		// PHP File Name
$input_page="zone_type_input.php";
$root='setup';
            ...
            <td class="oe_form_group_cell"><table width="261" height="99" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Zone Name :</td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input name="ZONE_NAME" type="text" id="ZONE_NAME" value="<?=$ZONE_NAME?>" /></td>
                </tr>
                <tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label"> Region Name::</td>
                  <td bgcolor="#E8E8E8" width="82%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <select name="REGION_ID">
                    <? foreign_relation('branch','BRANCH_ID','BRANCH_NAME',$REGION_ID);?>
                  </select></td>
