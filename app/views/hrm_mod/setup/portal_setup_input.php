...
$page="portal_setup.php";		// PHP File Name
$input_page="portal_setup_input.php";
$root='setup';

$table='hrm_portal_setup';		// Database Table Name Mainly related to this page
$unique='id';			// Primary Key of this Database table
$shown='mon';				// For a New or Edit Data a must have data field
...
<div class="ui-dialog ui-widget ui-widget-content ui-corner-all oe_act_window ui-draggable ui-resizable openerp" style="outline: 0px none; z-index: 1002; position: absolute; height: auto; width: 900px; display: block; /* [disabled]left: 217.5px; */ left: 16px; top: 21px;" tabindex="-1" role="dialog" aria-labelledby="ui-id-19">
      ...
      <div style="display: block; max-height: 464px; overflow-y: auto; width: auto; min-height: 82px; height: auto;" class="ui-dialog-content ui-widget-content" scrolltop="0" scrollleft="0">
        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td class="oe_form_group_cell"><table width="418" height="66" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Type Name:</td>
                  <td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">

<input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
<input name="portal" type="text" id="portal" value="<?=$portal?>" readonly="readonly" /></td>
               
			    </tr>
				
<tr class="oe_form_group_row">
<td bgcolor="#E8E8E8" width="35%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Value :</td>
<td bgcolor="#E8E8E8" width="65%" class="oe_form_group_cell oe_form_group_cell_label">
