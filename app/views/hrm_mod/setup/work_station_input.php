...
{		
$now				= time();
$_POST['work_station_name'] = $_POST['work_station_name'];
$crud->insert();
$type=1;
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="21%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Work Station:</td>
                  <td bgcolor="#E8E8E8" width="79%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                  <input name="work_station_name" type="text" id="work_station_name" value="<?=$work_station_name?>" required /></td>
