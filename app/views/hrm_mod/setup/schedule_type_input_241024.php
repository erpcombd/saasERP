...
<form action="" method="post">
  ...
  <div class="tab-button-outer">
    <ul id="tab-button">
      ...
      <li><a href="#tab02">WEEKEND</a></li>
      <li><a href="#tab03">DAY-OFF</a></li>
	   <li><a href="#tab04">HOLI-DAY</a></li>
    </ul>
  </div>
  <div class="tab-select-outer">
    <select id="tab-select">
      <option value="#tab01">WORKING DAY</option>
      <option value="#tab02">WEEKEND</option>
      <option value="#tab03">DAY-OFF</option>
	  <option value="#tab04">HOLI-DAY</option>
    </select>
  </div>
                  ...
                  <div class="oe_form_sheet oe_form_sheet_width">
                    <table width="100%" class="oe_form_group " border="0" cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr class="oe_form_group_row">
                          <td class="oe_form_group_cell">
							  ...
							  <tr class="oe_form_group_row">
								  ...
								  <select name="sch_type_weekend" class="form-control" id="sch_type_weekend" required>
                                     
                                  
                                      <option value="offday" <?=($sch_type=='offday') ? 'selected' : '' ?>>Weekend</option>
                                  ...
                                  <select  class="form-control">
                                            <option selected="selected"><?=$schedule_type?></option>
                                            <option>Regular</option>
                                            <option>Roster</option>
                                          </select>
                                ...
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Shift  Name :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                    <input  type="text" value="<?=$schedule_name?>" class="form-control"/>
                                  </td>
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Acronyms :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      <input  type="text" value="<?=$acronyms?>"  class="form-control"/>
                                  </td>
                                </tr>
								
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; 
								   Shift Time  :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      
                                      <input type="time" id="week_shift_time" name="week_shift_time" value="<?=$week_shift_time?>" class="form-control">
                                 ...
                                 <input type="time" id="week_end_time" name="week_end_time" value="<?=$week_end_time?>">
                        ...
                        <td bgcolor="#83B0DE" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Start Time  :</td>
                        <td bgcolor="#83B0DE" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                        <input type="time" id="week_start_time" name="week_start_time" value="<?=$week_start_time?>" class="form-control">
                         </td>
                                  
								  
						<td bgcolor="#83B0DE" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Last Time :</span> </td>
                        <td bgcolor="#83B0DE" width="25%" class="oe_form_group_cell">
                         <input type="time" id="week_last_time" name="week_last_time" value="<?=$week_last_time?>"class="form-control">
                           ...
                           <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Break Start : </td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                       ...
                                       <input type="time" id="week_break_start" name="week_break_start" value="<?=$week_break_start?>" class="form-control">
                                  ...
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <input type="time" id="week_break_end" name="week_break_end" value="<?=$week_break_end?>" class="form-control">
                     ...
                     <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">In Grace Time : </span></td>
                     <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell"><input type="text" id="weekly_grace_in" name="weekly_grace_in" value="<?=$weekly_grace_in?>" class="form-control"></td>
                     <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label"></span> Early Out Grace Time : </td>
                     <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell"><input type="text" id="weekly_grace_out" name="weekly_grace_out" value="<?=$weekly_grace_out?>" class="form-control"></td>
                                </tr>
                        ...
                        <tr class="oe_form_group_row">
                          <td class="oe_form_group_cell">
							  ...
							  <?php /*?><tr class="oe_form_group_row">
								  ...
								  <select  class="form-control" id="group_for" required>
                                      <? foreign_relation('user_group','id','group_name',$group_for);?>
                                    </select></td>
									
									
                                   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Status :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label"><select class="form-control">
                                      <option selected> <?=$status?> </option>
                                      <option>Enable</option>
                                      <option>Disable</option>
                                    </select>
							  ...
							  <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
								    ...
								    <select name="sch_type_day_off" class="form-control" id="sch_type_day_off" required>
                                
									  <option value="Day_Off" <?=($sch_type=='Day_Off') ? 'selected' : '' ?>>Day-Off</option>
                                    </select>
                                  </td>
                                ...
                                <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Acronyms :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      <input type="text" id="acronyms" value="<?=$acronyms?>"  class="form-control"/>
                                  </td>
                                </tr>
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;  Shift Time  :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <input type="time" id="dayoff_shift_time" name="dayoff_shift_time" value="<?=$dayoff_shift_time?>" class="form-control">
                                  
                                  </td>
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; End Time :</span> </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
                                      
                                 <input type="time" id="dayoff_end_time" name="dayoff_end_time" value="<?=$dayoff_end_time?>">
                                ...
                                <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#83B0DE" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                     ...
                                     <input type="time" id="dayoff_start_time" name="dayoff_start_time" value="<?=$dayoff_start_time?>" class="form-control">
                                      
                                      
                                  </td>
                                  <td bgcolor="#83B0DE" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Last Time :</span> </td>
                                  <td bgcolor="#83B0DE" width="25%" class="oe_form_group_cell">
                                       <input type="time" id="dayoff_last_time" name="dayoff_last_time" value="<?=$dayoff_last_time?>"class="form-control">
                                ...
                                <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                       ...
                                       <input type="time" id="day_off_break_start" name="day_off_break_start" value="<?=$day_off_break_start?>" class="form-control">
                                  ...
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      ...
                                      <input type="time" id="day_off_break_end" name="day_off_break_end" value="<?=$day_off_break_end?>" class="form-control">
                                ...
                                <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label"></span>In Grace Time: </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell"><input type="text" id="dayoff_grace_in" name="dayoff_grace_in" value="<?=$dayoff_grace_in?>" class="form-control"></td>
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label"></span> Early Out Grace Time : </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell"><input type="text" id="dayoff_grace_out" name="dayoff_grace_out" value="<?=$dayoff_grace_out?>" class="form-control"></td>
                                </tr>
                                <!--<tr class="oe_form_group_row">
                    ...
                    <table class="table table-bordered table-sm" align="center">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="time" id="day_off_quater1_in" name="day_off_quater1_in" value="<?=$day_off_quater1_in?>"></td>
                          <td><input type="time" id="day_off_quater1_out" name="day_off_quater1_out" value="<?=$day_off_quater1_out?>" ></td>
                          
                          <td><input type="time" id="day_off_quater2_in" name="day_off_quater2_in" value="<?=$day_off_quater2_in?>"></td>
                          <td><input type="time" id="day_off_quater2_out" name="day_off_quater2_out" value="<?=$day_off_quater2_out?>"></td>
                    ...
                    <table class="table table-bordered table-sm" align="center">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="time" id="day_off_quater3_in" name="day_off_quater3_in" value="<?=$day_off_quater3_in?>"></td>
                          <td><input type="time" id="day_off_quater3_out" name="day_off_quater3_out" value="<?=$day_off_quater3_out?>"></td>
                          
                          <td><input type="time" id="day_off_quater4_in" name="day_off_quater4_in" value="<?=$day_off_quater4_in?>"></td>
                          <td><input type="time" id="day_off_quater4_out" name="day_off_quater4_out" value="<?=$day_off_quater4_out?>"></td>
                    ...
                    <table class="table table-bordered table-sm" align="center">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td><input type="time" id="day_off_first_half_in" name="day_off_first_half_in" value="<?=$day_off_first_half_in?>"></td>
                          <td><input type="time" id="day_off_first_half_out" name="day_off_first_half_out" value="<?=$day_off_first_half_out?>"></td>
                          
                          <td><input type="time" id="day_off_sec_half_in" name="day_off_sec_half_in" value="<?=$day_off_sec_half_in?>"></td>
                          <td><input type="time" id="day_off_sec_half_out" name="day_off_sec_half_out" value="<?=$day_off_sec_half_out?>"></td>
                          ...
                          <td class="oe_form_group_cell">
							  ...
							  <tr class="oe_form_group_row">
                                  ...
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
								    ...
								    <select name="sch_type_holiday" class="form-control" id="sch_type_holiday" required>
                                    <option value="holiday" <?=($sch_type=='holiday') ? 'selected' : '' ?>>Holi-Day</option>
                                    </select>
                                  </td>
                                ...
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;  Holi day  Shift Time  :</td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      
                                      <input type="time" id="holi_day_shift_time" name="holi_day_shift_time" value="<?=$holi_day_shift_time?>" class="form-control">
                                  
                                  </td>
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; holi day End Time :</span> </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
                                      
                                 <input type="time" id="holi_day_end_time" name="holi_day_end_time" value="<?=$holi_day_end_time?>">
                                  
                                  </td>
                                </tr>
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#83B0DE" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Holi day Start Time  :</td>
                                  <td bgcolor="#83B0DE" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      
                                     <input type="time" id="holi_day_start_time" name="holi_day_start_time" value="<?=$holi_day_start_time?>" class="form-control">
                                      
                                      
                                  </td>
                                  <td bgcolor="#83B0DE" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Holi day Last Time :</span> </td>
                                  <td bgcolor="#83B0DE" width="25%" class="oe_form_group_cell">
                                       <input type="time" id="holi_day_last_time" name="holi_day_last_time" value="<?=$holi_day_last_time?>"class="form-control">
                                ...
                                <tr class="oe_form_group_row">
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Holi Day Break Start : </td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      
                                       <input type="time" id="holi_day_break_start" name="holi_day_break_start" value="<?=$holi_day_break_start?>" class="form-control">
                                      
                                   
                                  </td>
                                  <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Holi day Break End : </td>
                                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                                      
                                      <input type="time" id="holi_day_break_end" name="holi_day_break_end" value="<?=$holi_day_break_end?>" class="form-control">
                                  ...
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label"></span>In Grace Time: </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
								  <input type="text" id="holiday_grace_in" name="holiday_grace_in" value="<?=$holiday_grace_in?>" class="form-control"></td>
                                  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label"></span> Early Out Grace Time : </td>
                                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
								  <input type="text" id="holiday_grace_out" name="holiday_grace_out" value="<?=$holiday_grace_out?>" class="form-control"></td>
                                </tr>
