...
$title='Demotion Reason Information';			// Page Name and Page Title
$page="demotion_reason.php";		// PHP File Name
$input_page="demotion_reason_input.php";
$root='setup';

$table='demotion_reason';		// Database Table Name Mainly related to this page
$unique='REASON_CODE';			// Primary Key of this Database table
$shown='REASON';				// For a New or Edit Data a must have data field
...
<body>
   ...
   <td bgcolor="#E8E8E8" width="18%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Reason :</td>
