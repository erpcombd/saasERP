...
<tr class="oe_list_header_columns">
  <th colspan="4"><span style="text-align: center; font-size:18px; color:#09F">Dealer Reporting</span></th>
  </tr>
<tr class="oe_list_header_columns">
  ...
  <tr >
	...
	<select name="product_group" style="width:160px;">
  ...
  <tr >
    ...
    <td><span class="oe_form_group_cell">
      ...
      <tr >
    <td align="right"><strong>Appointment Type   :</strong></td>
    <td align="left"><span class="oe_form_group_cell">
      <select name="app_type" style="width:160px;">
    ...
    <tr >
      ...
      <td align="left"><input name="f_date" type="text" id="f_date" size="30" style="width:160px;" /></td>
    <td align="right"><strong>To Date  :</strong></td>
    <td><input name="t_date" type="text" id="t_date" size="30" style="width:160px;" /></td>
  </tr>
    <tr >
    <td align="right">&nbsp;</td>
    <td align="left">&nbsp;</td>
...
<tr class="oe_list_header_columns">
  ...
  <tbody>
    <tr>
      <td width="4%" align="center"><input name="report" type="radio" class="radio" value="1001" checked="checked"/></td>
      <td width="44%"><strong> Distributor Dealer </strong> <strong>Information(1001)</strong></td>
      <td width="4%" align="center">&nbsp;</td>
      <td width="44%">&nbsp;</td>
      </tr>
    <tr  class="alt">
      <td align="center"><input name="report" type="radio" class="radio" value="1002" /></td>
      <td><strong>Super Shop  Dealer </strong> <strong>Information(1002)</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
      <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1003" /></td>
      <td class="alt"><strong>Corporate Dealer </strong> <strong>Information(1003)</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr class="alt">
      <td align="center">
        <input name="report" type="radio" class="radio" value="1004" />      </td>
      <td><strong>Trade Fair Dealer </strong> <strong>Information(1004)</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
      <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1005" />      </td>
      <td class="alt"><strong>BulkBuyer Dealer </strong> <strong>Information(1005)</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
    ...
    <tr >
      <td align="center"><input name="report" type="radio" class="radio" value="1006" /></td>
      <td><strong> Dealer Closing Report(1006) </strong><strong></strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
    </tr>
    <tr >
    ...
    <tr >
      <td align="center"><input name="report" type="radio" class="radio" value="1007" /></td>
      <td><strong> Bangladesh Geo Location(1007) </strong><strong></strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
  </tbody>
