...
<form action="../report/master_report.php" target="_blank" method="post">
  ...
  <tr>
           ...
           <!--     <td><input type="radio" placeholder="test 2" id="4" id="report" name="report" value="81" /></td>
            <td class="bold" align="left"> <label for="4"> Attendance Summary Portal </label> </td> -->
			<td><input type="radio" placeholder="test 2" id="report" name="report" value="1000" checked="checked" /></td>
            <td class="bold" align="left"> <label for="666"> Monthly OD Report</label> </td>
            
            <td><input type="radio" placeholder="test 2" id="report" name="report" value="10000" checked="checked" /></td>
            <td class="bold" align="left"> <label for="666"> Monthly IOM Report</label> </td>
  ...
  <tr>
           ...
           <!--     <td><input type="radio" placeholder="test 2" id="4" id="report" name="report" value="81" /></td>
            <td class="bold" align="left"> <label for="4"> Attendance Summary Portal </label> </td> -->
			<td><input type="radio" placeholder="test 2" id="report" name="report" value="2000" checked="checked" /></td>
            <td class="bold" align="left"> <label for="666"> Iom Details Report</label> </td>
