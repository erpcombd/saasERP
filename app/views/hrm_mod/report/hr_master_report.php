...

{
	...
	$sql="SELECT a.PBI_ID as CODE,a.PBI_NAME as Name,a.PBI_DESIGNATION as designation ,a.PBI_DEPARTMENT as department,b.od,b.hd,b.lt,b.ab,b.lv,b.pre,b.pay,b.over_time_amount,b.basic_salary,b.total_salary as consolidated_salary,b.house_rent,b.medical_allowance,b.other_allowance,b.special_allowance,b.ta_da as TA_DA, b.food_allowance as fooding, b.mobile_allowance,b.over_time_amount,b.absent_deduction,b.advance_install,b.other_install,b.bonus_amt,b.deduction,b.benefits,b.total_salary,b.total_deduction,b.total_benefits,b.total_payable*(1.00) as total_payable FROM personnel_basic_info a,salary_attendence b where	a.PBI_ID=b.PBI_ID and b.mon='".$mon."' and b.year='".$year."'".$con." order by a.PBI_DOJ asc";
...

{
	...
	$sql="SELECT a.PBI_ID as CODE,a.PBI_NAME as Name,a.PBI_DESIGNATION as designation ,a.PBI_DEPARTMENT as department,b.over_time_amount,b.absent_deduction,b.advance_install,b.other_install,b.bonus_amt,b.deduction,b.benefits,b.total_salary,b.total_deduction,b.total_benefits,b.total_payable FROM personnel_basic_info a,salary_attendence b where	a.PBI_ID=b.PBI_ID and b.mon='".$mon."' and b.year='".$year."'".$con." order by a.PBI_DOJ asc";
...
<table width="800" border="1" cellpadding="0" cellspacing="0" align="center" style="font-size:14px; font-family:Cambria;" id="grp">
<thead>
<tr style="background:#ccc;">
<td text-align:center;"><strong>Date</strong></td>
<td  align="center"><strong>In Time</strong></td>
<td  align="center"><strong>Out Time</strong></td>
<td  align="center"><strong>Over Time</strong></td>
...
<tr>
<td>Basic Salary</td>
<td  align="center"><?=number_format($paySlip->basic_salary);?></td>
<td  align="center"><?=number_format($paySlip->basic_salary);?></td>
<td align="center"><?=number_format($paySlip->basic_salary);?></td>
<td align="center"><?=number_format($paySlip->basic_salary);?></td>
...
<tr><td style="border:0px;">______________________________________</td></tr>
<tr><td style="border:0px;  font-size:16px;">Mohammad Tanvir Gias</td></tr>
</tbody>
</table>
</div>
...
if($_POST['JOB_LOCATION']!='')
$cons.=' and b.pbi_organization ="'.$_POST['PBI_ORG'].'"';
...
s.PBI_ID=b.PBI_ID and b.bonus_type=".$_POST['bonus_type']." and b.bonus_percent not like 0 and
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <td style="border:0px;" colspan="4" align="left"><img src="../../img/company_logo.png" style="height:50px; width:100px;"  /></td>
...
where t.designation = d.DESG_ID and t.pay>0 and t.remarks_details!="hold" and  t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' and
...
?></td>
      ...
      <td align="right"><?=($data->pf>0)? $data->pf : '';       $totOtherDeduct += $data->pf?></td>
...
echo $sqld = 'select t.*,i.*, a.PBI_ID, a.PBI_NAME,a.PBI_CODE, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation from salary_attendence t,designation d, personnel_basic_info a, salary_info i



where t.DESG_ID = d.DESG_ID and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' and t.PBI_ID=a.PBI_ID '.$salaryConCash.' and i.PBI_ID = t.PBI_ID AND t.bank_or_cash like "Cash" order by t.gross_salary desc';
...
echo $sqld = 'select t.*,i.*, a.PBI_ID, a.PBI_NAME,a.PBI_CODE, a.PBI_DESIGNATION , a.PBI_DEPARTMENT, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation
...
where a.DESG_ID = d.DESG_ID and t.pay>0 and t.remarks_details!="hold" and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' and
...
where a.DESG_ID = d.DESG_ID and t.pay>0 and t.remarks_details!="hold" and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' and t.PBI_ID=a.PBI_ID '.$con.'
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr><td style="border:0px solid white; font-family: bankgothic;"><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></td></tr>
...
<table style="width: auto; margin: 0 auto;text-align:center;" cellpadding="0" cellspacing="0" class="oe_list_content">
  ...
  <tbody>
    ...
    <?
	  ...
	  $basic_sql='select a.PBI_ID,a.PBI_CODE, a.PBI_NAME, a.PBI_DEPARTMENT, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation,



		e.DEPT_SHORT_NAME as  Department,a.PBI_MOBILE as mobile, i.food_allowance,i.gross_salary,
...
a.PBI_EMAIL as email, (select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) as JOB_LOCATION
           ...
           where  a.DESG_ID = d.DESG_ID and a.DEPT_ID=e.DEPT_ID and i.PBI_ID=a.PBI_ID '.$join_con.'  group by a.PBI_ID';
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr><td style="border:0px solid white; font-family: bankgothic;"><strong><?= foreign_relation('user_group','id','group_name',$PBI_ORG);?></strong></td></tr>
...
$join_con .= ' and a.JOB_LOCATION="'.$_POST['JOB_LOCATION'].'"';
	  ...
	  $basic_sql='select i.*,j.ESSENTIAL_RESIG_DATE, a.PBI_ID,a.PBI_CODE, a.PBI_NAME, a.PBI_DESIGNATION , a.PBI_DEPARTMENT, a.PBI_DOJ,(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) as JOB_LOCATION,
    ...
    where j.PBI_ID=a.PBI_ID and a.DESG_ID = d.DESG_ID and a.DEPT_ID=e.DEPT_ID and i.PBI_ID=a.PBI_ID  '.$join_con.'';
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr><td style="border:0px solid white;"><strong><?=foreign_relation('user_group','id','group_name',$PBI_ORG);?></strong></td></tr>
...
<table style="width: auto; margin: 0 auto;text-align:center;" cellpadding="0" cellspacing="0" class="oe_list_content">
  ...
  <tbody>
    ...
    <?
	  ...
	  $join_con = ' and j.REJOIN_DATE between "'.$_POST['year'].'-'.$_POST['mon'].'-1" and "'.$_POST['year'].'-'.$_POST['mon'].'-31"';}
	  ...
	  $basic_sql='select i.*,j.ESSENTIAL_RESIG_DATE,j.REJOIN_DATE, a.PBI_ID,a.PBI_CODE, a.PBI_NAME, a.PBI_DESIGNATION , a.PBI_DEPARTMENT, a.PBI_DOJ,(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) AS JOB_LOCATION, d.DESG_SHORT_NAME as Designation, e.DEPT_SHORT_NAME as Department,a.PBI_MOBILE as mobile,
 ...
 where j.PBI_ID=a.PBI_ID and a.DESG_ID = d.DESG_ID and a.DEPT_ID=e.DEPT_ID and i.PBI_ID=a.PBI_ID  '.$join_con.' group by a.PBI_ID';
...
$leave_con .= ' and l.year="'.$_POST['year'].'"';
    ...
    l.PBI_ID,p.PBI_NAME,p.PBI_CODE,p.PBI_SEX,p.PBI_DOJ,p.PBI_DESIGNATION,dept.DEPT_DESC,desg.DESG_DESC
...
where l.PBI_ID=p.PBI_ID and

p.DEPT_ID=dept.DEPT_ID and  l.leave_status="GRANTED" AND p.DESG_ID=desg.DESG_ID '.$leave_con.' group by l.PBI_ID';
...
//$tr_con .= ' and t.TRANSFER_ORDER_DATE between "'.$_POST['year'].'-'.$_POST['mon'].'-1" and "'.$_POST['year'].'-'.$_POST['mon'].'-30"';
    ...
    $sqldd = 'select l.PBI_ID,p.PBI_NAME,p.PBI_CODE,p.PBI_DEPARTMENT,(select PROJECT_DESC from project where PROJECT_ID=p.JOB_LOCATION) as project,
	 ...
	 from hrm_od_info l,personnel_basic_info p,department dept,designation desg
	 ...
	 p.DEPT_ID=dept.DEPT_ID and l.od_status="Granted" and  p.DESG_ID=desg.DESG_ID '.$od_con.' order by s_date desc';
...
<table width="100%" cellspacing="0" cellpadding="2" border="0" align="center">
    ...
    <td style="border:0px solid white; font-family: bankgothic;"><div align="center" style="font-size:20px;"><strong><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></strong></div></td>
    ...
    <tr>
      ...
      <td style="border:0px solid white;"><div align="center" style="font-size:20px;">Transfer Report of
...
$tr_con .= ' and t.TRANSFER_AFFECT_DATE between "'.$_POST['year'].'-'.$_POST['mon'].'-1" and "'.$_POST['year'].'-'.$_POST['mon'].'-30"';
 ...
 $basic_sql='select p.PBI_NAME,(select DEPT_DESC from department where DEPT_ID=p.DEPT_ID) as department,
 ...
 (select DESG_DESC from designation where DESG_ID=p.DESG_ID) as designation, t.TRANSFER_ORDER_NO,p.PBI_ID,(select PROJECT_DESC from project
...
<table width="100%" cellspacing="0" cellpadding="2" border="0">
  ...
  <tbody>
    ...
    $dept_sql = 'select d.DEPT_ID,d.DEPT_DESC, sum(s.total_payable) as total_pay 

   from department d, salary_attendence s 
   where 1 and s.department=d.DEPT_ID and s.year="'.$_POST['year'].'"  group by s.department';
...
for ($i = 1; $i <= 12; $i++) { ?>
      ...
      <td style="text-align: right;"><? $drow = find_a_field('salary_attendence','sum(total_payable)','mon="'.$i.'" and year="'.$_POST['year'].'" and department="'.$dept_data->DEPT_ID.'" and pay>0 and remarks_details!="hold"'); echo number_format($drow,0); $drow_total += $drow?></td>
...
for ($i = 1; $i <= 12; $i++) { ?>
      ...
      <td style="text-align: right;"><strong>
        ...
        <? $rowColmTotal = find_a_field('salary_attendence','sum(total_payable)','year="'.$_POST['year'].'" and mon="'.$i.'"  and pay>0'); echo number_format($rowColmTotal,0);?>
...
<tr>
<td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;">Provident Fund Report
<?=$_POST['year']?>
</div></td>
</tr>
...
<tr>
      ...
      <th rowspan="2"><div align="center">January<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">February<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">March<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">April<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">May<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">June<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">July<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">August<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">September<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">October<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">November<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">December<br><?=$_POST['year']?></div></th>



      <th rowspan="2"><div align="center">Total</div></th></tr>
...
$salary_sql = 'select p.PBI_ID,p.PBI_CODE, p.PBI_NAME,p.PBI_DOJ,
(select DESG_DESC from designation where DESG_ID=p.PBI_DESIGNATION) as designation 
...
while($tf = mysqli_fetch_object($s_query)){
  ...
  $final_sql = 'select pf_amount as total_amt from  provident_fund 
  where year="'.$_POST['year'].'" and PBI_ID="'.$tf->PBI_ID.'" group  by PBI_ID desc';
...
?>
    ...
    <tr>
     ...
     <td align="right"><?=(number_format($jan =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=1 and year="'.$_POST['year'].'"'),0)>0)? number_format($jan,0) : '';?></td>



      <td align="right"><?=(number_format($feb =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=2 and year="'.$_POST['year'].'" '),0)>0)? number_format($feb,0) : '';?></td>



      <td align="right"><?=(number_format($march =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=3 and year="'.$_POST['year'].'" '),0)>0)? number_format($march,0) : '';?></td>



      <td align="right"><?=(number_format($april =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=4 and year="'.$_POST['year'].'" '),0)>0)? number_format($april,0) : '';?></td>



      <td align="right"><?=(number_format($may =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=5 and year="'.$_POST['year'].'" '),0)>0)? number_format($may,0) : '';?></td>



      <td align="right"><?=(number_format($june =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=6 and year="'.$_POST['year'].'" '),0)>0)? number_format($june,0) : '';?></td>



      <td align="right"><?=(number_format($july =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=7 and year="'.$_POST['year'].'" '),0)>0)? number_format($july,0) : '';?></td>



      <td align="right"><?=(number_format($august =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=8 and year="'.$_POST['year'].'" '),0)>0)? number_format($august,0) : '';?></td>



      <td align="right"><?=(number_format($sept =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=9 and year="'.$_POST['year'].'" '),0)>0)? number_format($sept,0) : '';?></td>



      <td align="right"><?=(number_format($oct =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=10 and year="'.$_POST['year'].'" '),0)>0)? number_format($oct,0) : '';?></td>



      <td align="right"><?=(number_format($nov =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mom=11 and year="'.$_POST['year'].'" '),0)>0)? number_format($nov,0) : '';?></td>



      <td align="right"><?=(number_format($dec =find_a_field('provident_fund','pf_amount','PBI_ID="'.$tf->PBI_ID.'" and mon=12 and year="'.$_POST['year'].'" '),0)>0)? number_format($dec,0) : '';?></td>
...
<tr>
  ...
  <td style="border:0px;" colspan="28"><div align="center" style="font-size:20px;"><?=foreign_relation('user_group','id','group_name',$PBI_ORG);?></div></td>
...
<table style="width:auto;margin:0 auto; text-align:center; background-color:#9ed5cd;" cellpadding="0" cellspacing="0" border="1">
 ...
 $basic_sql="select a.PBI_ID as Emp_ID,a.PBI_CODE,a.PBI_DOJ,a.pass,a.PBI_NAME as Name,(select DESG_SHORT_NAME from designation where DESG_ID=a.DESG_ID) as designation,



(select if(DEPT_DESC='NO DEPARTMENT','',DEPT_DESC) from department where DEPT_ID=a.DEPT_ID) as department,a.PBI_GROUP as `Group`, DATE_FORMAT(a.PBI_DOJ,'%d-%b-%Y') as joining_date,



a.PBI_DOJ as total_service_length,a.PBI_MOBILE as mobile  from personnel_basic_info a, essential_info e where a.PBI_ID=e.PBI_ID ".$con." order by a.PBI_DOJ asc";
...
?>
  ...
  <tr>
    ...
    <td style="background-color:#525252; color:#5ebcd2"><?=$r->PBI_ID?></td>
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr>
    ...
    <td style="border:0px solid white;font-family:bankgothic; font-size:20px"><strong><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></strong></td>
  ...
  <tr>
    ...
    <td style="border:0px solid white; ">Employee Basic Information</td>
...
<table style="width:auto;margin:0 auto;" cellpadding="0" cellspacing="0" border="1">
 ...
 echo $basic_sql="select a.PBI_ID as Emp_ID,a.PBI_CODE as PBI_CODE,a.PBI_NAME as Name,(select DESG_SHORT_NAME from designation where DESG_ID=a.DESG_ID) as designation,
...
(select if(DEPT_DESC='NO DEPARTMENT','',DEPT_DESC) from department where DEPT_ID=a.DEPT_ID) as department,(select PROJECT_DESC
...
<table style="width:auto;margin:0 auto;" cellpadding="0" cellspacing="0" border="1">
  ...
  $basic_sql="select a.PBI_ID,a.PBI_CODE as Emp_ID,a.PBI_NAME as Name,(select DESG_SHORT_NAME from designation where DESG_ID=a.DESG_ID) as designation,

 a.ESSENTIAL_TIN_NO as tin_no,



e.ESSENTIAL_REPORTING as reporting,(select if(DEPT_DESC='NO DEPARTMENT','',DEPT_DESC) from department where DEPT_ID=a.DEPT_ID) as department,(select PROJECT_DESC
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr>
    ...
    <td style="border:0px solid white;"><strong><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></strong></td>
...
(select DESG_SHORT_NAME from designation where DESG_ID=a.DESG_ID) as designation,(select if(DEPT_DESC='NO DEPARTMENT','',DEPT_DESC) from department where DEPT_ID=a.DEPT_ID) as department,
...
<table style="width: auto; margin: 0 auto; text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <td style="border:0px solid white; font-size: 25px; font-family: bankgothic;"><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></td>
...
a.PBI_NAME as Name,(select DESG_SHORT_NAME from designation where DESG_ID=a.DESG_ID) as designation,(select if(DEPT_DESC='NO DEPARTMENT','',DEPT_DESC)



from department where DEPT_ID=a.DEPT_ID) as department,(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) as project_name,a.PBI_GROUP as `Group`,
...
from department where DEPT_ID=a.DEPT_ID) as department,(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) as project_name,a.PBI_DOJ as total_service_length,
...
<table style="width: auto; margin: 0 auto; font-size: 20px;text-align:center;" border="1" bordercolor="#FFFFFF">
  ...
  <tr>
    ...
    <td style="border:0px solid white; font-family: bankgothic;"><? foreign_relation('user_group','id','group_name',$PBI_ORG);?></td>
  ...
  <tr>
    ...
    <td style="border:0px solid white;"><div>
...
<table style="width: auto; margin: 0 auto;text-align:center;" cellpadding="0" cellspacing="0" class="oe_list_content">
  ...
  $basic_sql='select a.PBI_ID,a.PBI_CODE, a.PBI_NAME, a.PBI_DESIGNATION , a.PBI_DEPARTMENT,(select PROJECT_DESC from project where PROJECT_ID=a.JOB_LOCATION) AS Job_Location, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation, e.DEPT_SHORT_NAME as Department,a.PBI_MOBILE as mobile,i.gross_salary,i.food_allowance,
 ...
 where  a.DESG_ID = d.DESG_ID and a.DEPT_ID=e.DEPT_ID  '.$join_con.' and i.PBI_ID = a.PBI_ID  group by a.PBI_ID';
...
<table style="width: auto; margin: 0 auto;text-align:center;" cellpadding="0" cellspacing="0" class="oe_list_content">
  ...
  <tbody>
    ...
    <?
	  ...
	  $basic_sql='select a.PBI_ID, a.PBI_CODE,a.PBI_NAME,j.ESSENTIAL_RESIG_DATE, (SELECT DESG_DESC FROM designation WHERE DESG_ID=a.DESG_ID) AS DESIGNATION , (SELECT DEPT_DESC FROM department WHERE DEPT_ID=e.DEPT_ID) as Department, a.PBI_DOJ,(SELECT PROJECT_DESC FROM project WHERE PROJECT_ID=a.JOB_LOCATION) as JOB_LOCATION, d.DESG_SHORT_NAME as Designation, e.DEPT_SHORT_NAME as Department,a.PBI_MOBILE as mobile,i.gross_salary,i.food_allowance,
 ...
 where j.PBI_ID=a.PBI_ID and  a.DESG_ID = d.DESG_ID and a.DEPT_ID=e.DEPT_ID '.$join_con.' and i.PBI_ID = a.PBI_ID ';
...
<table style="width: auto; margin: 0 auto;text-align:center;" cellpadding="0" cellspacing="0" class="oe_list_content">
  ...
  <tbody>
    ...
    <?
	  ...
	  echo   $emp ='SELECT r.*  FROM `hrm_employee_requisition` r where EXPECTED_DATE_TO between "'.$_POST['year'].'-'.$_POST['mon'].'-1" and "'.$_POST['year'].'-'.$_POST['mon'].'-30" ' ;
...
<table  width="100%" cellspacing="0" id="ExportTable" cellpadding="2" border="0">
  ...
  <thead>
    ...
    <tr>
      ...
      <th>Receiving Bank Routing No</th>
      <th>Beneficiary Bank Account No</th>
      <th>Account Type</th>
      <th><div align="center">Amount</div></th>
      <th>Receiver ID</th>
      <th align="center"><div align="center">Receiver Name</div></th>
      <th>Remarks</th>
 ...
 $sqld = 'select t.*, a.PBI_ID, a.PBI_CODE ,a.PBI_NAME, t.designation , t.department, a.PBI_DOJ, d.DESG_SHORT_NAME as Designation,t.cash_amt, t.bank_amt, t.bank_or_cash as cash_bank,a.PBI_BANK_ACC_NO,a.PBI_PHONE,a.PBI_EMAIL
...
where t.pay>0 and t.total_payable>0  and t.designation = d.DESG_ID and t.mon='.$_POST['mon'].' and



 t.year='.$_POST['year'].' and t.PBI_ID=a.PBI_ID '.$advice_con.'  order by a.PBI_ID asc';
...
?>
    ...
    <tr>
      ...
      <td>&nbsp;&nbsp;&nbsp;1403640997001&nbsp;&nbsp;&nbsp;</td>
      <td></td>
      <td>&nbsp;&nbsp;&nbsp;<?=$data->PBI_BANK_ACC_NO;?>&nbsp;&nbsp;&nbsp;</td>
      <td>Salary</td>
      <td><?=$data->total_payable; $tot_payble +=$data->total_payable;?></td>
      <td><?=$data->PBI_CODE?></td>
      <td nowrap="nowrap"><?=$data->PBI_NAME?></td>
      <td></td>
      <td align="right"><?=$data->PBI_PHONE?></td> 
      <td align="right"><?=$data->PBI_EMAIL?></td> 
...
?>
    ...
    <tr>
      ...
      <td colspan="5" align="right"><b>Total:</b></td>
       ...
       <td rowspan="2"><b><?=number_format(($tot_payble>0)? $tot_payble : '');?></b></td>
