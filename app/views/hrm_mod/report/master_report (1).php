...
b.ac_no as AC_NO,
b.consolidated_salary as Consolidated_Salary,
b.gross_salary,
...
if($_POST['PBI_ORG']!='') { $con_3.=' and a.PBI_ORG = "'.$_POST['PBI_ORG'].'"'; }
...
if($_POST['department']!=''){ $con_3.=' and a.PBI_DEPARTMENT = "'.$_POST['department'].'"';}
...
if($_POST['JOB_LOCATION']!=''){ $con_3.=' and a.JOB_LOCATION = "'.$_POST['JOB_LOCATION'].'"';}
...
if($_POST['PBI_GROUP']!=''){ $con_3.=' and a.PBI_GROUP = "'.$_POST['PBI_GROUP'].'"';}
...
if($_POST['branch']>0) { $con_3.=' and a.PBI_BRANCH ="'.$_POST['branch'].'"';}	
...
if($_POST['zone']>0) { $con_3.=' and a.PBI_ZONE ="'.$_POST['zone'].'"';}	
...
if($_POST['area']>0) { $con_3.=' and a.PBI_AREA ="'.$_POST['area'].'"';}	
...
b.td as Tot_days, b.pre as Present,b.od as Weekend ,b.hd as Holiday, b.lv as leave_day , b.ab AS Absent, b.pay as Payble_days , b.lt as In_Late_days,b.eo as Early_Out_Days,
...
?>
      <tr>
        ...
        <td><span style="text-align:right; font-weight:bold;">
          <?php if($data->held_up_status=='0'){echo number_format($data->total_payable); $total_cash = $total_cash + $data->total_payable;}?>
          </span></td>
        <td><?php
...
if($data->reg_date>0){ $date2 = $data->reg_date; } else {
...
?>
  <table width="100%" cellspacing="0" cellpadding="2" border="0">
    <thead>
      <tr>
        <th style="border:0px;" width="10%" align="left"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png" width="100%"></th>
  ...
  <table width="100%" cellspacing="0" cellpadding="2" border="1" id="ExportTable">
    <thead>
      <tr>
        ...
        <th colspan="8"><div align="center">Salary and Allowance </div></th>
        <th rowspan="2"><div align="center">Arrear</div></th>
        <th rowspan="2"><div align="center">Total Payment</div></th>
      ...
      <tr>
        ...
        <th><div align="center">Food</div></th>
        ...
        <th><div align="center">Advance</div></th>
...
?>
      <tr>
        ...
        <td align="right"><?=($data->ta_da_data>0)? $data->ta_da_data : '';     $totspecial += $data->ta_da_data?></td>
        <td align="right"><?=($data->entertainment>0)? $data->entertainment : '';     $totEntertainment += $data->entertainment?></td>
        <td align="right"><?=($data->food_allowance>0)? $data->food_allowance : '';     $totFood+= $data->food_allowance?></td>
        <td align="right"><?=($data->mobile_allowance>0)? $data->mobile_allowance : '';     $totMobile += $data->mobile_allowance?></td>
        ...
        <td align="right"><?=($data->pf>0)? $data->pf : '';         $totPfDeduct += $data->pf?></td>
        <td align="right"><?=($data->pf_loan>0)? $data->pf_loan : '';           $totPfLoan += $data->pf_loan?></td>

        <td align="right"><?=($data->advance_install>0)? $data->advance_install : '';         $totAdvance += $data->advance_install?></td>
        <td align="right"><?=($data->late_deduction>0)? $data->late_deduction : '';           $totLate += $data->late_deduction?></td>
    ...
    <thead>
      <tr>
        ...
        <th rowspan="2"><div align="center">Department</div></th>
     	...
     	<th rowspan="2" nowrap="nowrap"><div align="center"> Date of Birth</div></th>
        <th rowspan="2" nowrap="nowrap"><div align="center"> Joining Date </div></th>
		
		<th rowspan="2" nowrap="nowrap"><div align="center"> Grade </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Salary Schedule </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Class </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Employment Type </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Location </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Work Station </div></th>
		
		<th rowspan="2" nowrap="nowrap"><div align="center"> 1st Reporting Supervisor </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> 2nd Reporting Supervisor </div></th>
		<th rowspan="2" nowrap="nowrap"><div align="center"> Default Shift  </div></th>
        ...
        <th rowspan="2"><div align="center">Bank A/C</div></th>
		<th rowspan="2" align="center"><div align="center">Bank Name </div></th>
      </tr>
      <tr>
        <th><div align="center">Gross </div></th>
        <th><div align="center">Basic</div></th>
...
if ($_POST['department'] !='')
$salaryConn .= ' and a.department='.$_POST['department'];

if ($_POST['PBI_DESIGNATION'] !='')
$salaryConn .= ' and a.designation='.$_POST['PBI_DESIGNATION'];
...
a.MACHINE_ID as Machine_ID,
(select DESG_DESC from designation where DESG_ID = a.DESG_ID) as designation,(select group_name from user_group where id=a.PBI_ORG) as group_name,
(select DEPT_DESC from department where DEPT_ID = a.DEPT_ID) as department,DATE_FORMAT(a.PBI_DOJ,'%d-%m-%Y') as joining_date,a.PBI_DOB,DATE_FORMAT(a.PBI_DOC2,'%d-%m-%Y') as confirmation_date,
CONCAT(TIMESTAMPDIFF(YEAR, `PBI_DOJ`, CURDATE()),' Year,',TIMESTAMPDIFF(MONTH, `PBI_DOJ`, CURDATE()) % 12,' mon') as service,
PBI_SEX as gender,PBI_RELIGION as religion,PBI_BLOOD_GROUP as blood_group,a.PBI_MOBILE as mobile,a.PBI_EMAIL as email,
a.nid as NID,a.PBI_BANK_ACC_NO as Bank_Account,EMPLOYMENT_TYPE as Employment_Type,a.salary_schedule,a.grade
from personnel_basic_info a , salary_info s
where	1 ".$con.$id_con.$salaryConn." and s.PBI_ID=a.PBI_ID order by a.PBI_ID asc";
...
?>
      <tr>
		...
		<td><? if($data->PBI_DOB>0) echo date('d-M-Y',strtotime($data->PBI_DOB));?></td>
        <td><? if($data->joining_date>0) echo date('d-M-Y',strtotime($data->joining_date))?></td>
        ...
        <td align="right"><?=($data->house_rent>0)? $data->house_rent : '';                   $totHouse += $data->house_rent?></td>
        <td align="right"><?=($data->medical_allowance>0)? $data->medical_allowance : '';     $totMedical += $data->medical_allowance?></td>
        <td align="right"><?=($data->convenience>0)? $data->convenience : '';     $totspecial += $data->convenience?></td>
		<td align="right"><?=$data->ac_no;?></td>
		<td align="right"><?=find_a_field('bank','BANK_NAME','BANK_CODE='.$data->bank_name);?></td>

    

        <?php /*?><td align="right"><?=($data->salary_arrear>0)? $data->salary_arrear : '';     $totArrear += $data->salary_arrear?></td>
        <td align="right"><?=($data->total_salary>0)? $data->total_salary : '';     $totSalary += $data->total_salary?></td>
        <td align="right"><?=($data->income_tax>0)? $data->income_tax : '';                   $totIincomeTax += $data->income_tax?></td>
        <td align="right"><?=($data->pf>0)? $data->pf : '';         $totPfDeduct += $data->pf?></td><?php */?>
        <?php /*?><td align="right"><?=($data->pf_loan>0)? $data->pf_loan : '';           $totPfLoan += $data->pf_loan?></td>
        ...
        <td align="right"><?=($data->total_deduction>0)? $data->total_deduction : '';         $totTotalDeduct += $data->total_deduction?></td>
        <td align="right"><? echo ($data->total_payable>0)? $data->total_payable : '';        $total_cash = $total_cash + $data->total_payable;?></td>
        <td><?=($data->card_no>0)? $data->card_no : '';?></td><?php */?>
      </tr>
      <?  } ?>
...
if($_POST['PBI_ORG']!=''){$PBI_ORG_con=' and t.pbi_organization = "'.$_POST['PBI_ORG'].'"';}

if($_POST['department']!=''){$department_con=' and DEPT_ID = "'.$_POST['department'].'"';}

if($_POST['JOB_LOCATION']!=''){$job_location_con=' and t.pbi_job_location = "'.$_POST['JOB_LOCATION'].'"';}

if($_POST['pbi_id_in']!='')  $pbi_id_con= " and t.PBI_ID in (".$_POST['pbi_id_in'].")";

if($_POST['PBI_DOMAIN']!=''){$section_con=' and a.PBI_DOMAIN = "'.$_POST['PBI_DOMAIN'].'"';}
...
?>
      <tr>
        ...
        <td><span style="text-align:right; font-weight:bold;">
          <?php if($data->held_up_status=='0'){echo $data->total_payable; $total_cash = $total_cash + $data->total_payable;}?>
          </span></td>
        <td><?php
...
?>
  ...
  and PBI_ORG in ("'.$_POST['PBI_ORG'].'") and a.PBI_DOMAIN = "'.$data->PBI_DOMAIN.'" and t.pbi_job_location !=1 and t.pbi_region =0 and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].''); $total_cash_payment = $total_cash_payment + $cash_paid; ?></td>
  ...
  and PBI_ORG in ("'.$_POST['PBI_ORG'].'") and a.PBI_DOMAIN = "'.$data->PBI_DOMAIN.'" and t.pbi_job_location !=1 and t.pbi_region =0 and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' '); $total_bank_payment_dbbl = $total_bank_payment_dbbl + $dbbl_paid;?></td>
...
$total_bank_payment_prime = $total_bank_payment_prime + $prime_paid;?></td>
  ...
  and PBI_ORG in ("'.$_POST['PBI_ORG'].'") and a.PBI_DOMAIN = "'.$data->PBI_DOMAIN.'" and t.pbi_job_location !=1 and t.pbi_region =0 and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' '); $total_bank_payment_ibbl = $total_bank_payment_ibbl + $ibbl_paid;?></td>
  ...
  and PBI_ORG in ("'.$_POST['PBI_ORG'].'") and a.PBI_DOMAIN = "'.$data->PBI_DOMAIN.'" and t.pbi_job_location !=1 and t.pbi_region =0 and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' ');$total_net_payable = $total_net_payable + $net_payable;?></span></td>
        <td>&nbsp;</td>
        <td style="color:#FF0000; font-weight:bold">&nbsp;</td>
      </tr>
      <?
...
?>
  ...
  and t.pbi_region =0 and t.mon='.$_POST['mon'].' and t.year='.$_POST['year'].' '); $total_help_up_paid = $total_help_up_paid + $help_up_paid;?> </td>
    ...
    <tr>
      <td style="border:0px;"><table width="600" border="1" cellpadding="0" cellspacing="0"  align="center" style="font-size:15px;">
          ...
          <tr>
            ...
            <td align="right"><? if($paySlip->basic_salary>0) echo number_format($paySlip->basic_salary,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          <tr>
            <td colspan="2" align="left">House Rent</td>
            <td align="right"><? if($paySlip->house_rent>0) echo number_format($paySlip->house_rent,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          <tr>
            <td colspan="2" align="left">Medical Allowance</td>
            <td align="right"><? if($paySlip->medical_allowance>0) echo number_format($paySlip->medical_allowance,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          <tr>
            <td colspan="2" align="left">Conveyance</td>
            <td align="right"><? if($paySlip->ta_da_data>0) echo number_format($paySlip->ta_da_data,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>

            <tr>
            <td colspan="2" align="left">Mobile Bill</td>
            <td align="right"><? if($paySlip->mobile_allowance>0) echo number_format($mobile_bill = $paySlip->mobile_allowance,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          
          <tr>
            <td colspan="2" align="left"><strong>Gross</strong></td>
            <td align="right"><? if($paySlip->gross_salary>0) echo number_format($gross = $paySlip->gross_salary,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          <tr>
            <td colspan="2" align="left">Arrears</td>
            <td align="right"><? if($paySlip->salary_arrear>0) echo number_format($arrear = $paySlip->salary_arrear,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          ...
          <tr>
           ...
           <? $total_gross = $gross+$arrear; if($total_gross>0) echo number_format($total_gross,2); else echo '-';?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td align="right"><? if($paySlip->pf_deduction>0) echo number_format($pf = $paySlip->pf_deduction,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          <tr>
            <td colspan="2" align="left">Income Tax</td>
            <td align="right"><? if($paySlip->income_tax>0) echo number_format($income_tax = $paySlip->income_tax,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>

           <tr>
            <td colspan="2" align="left">Advance</td>
            <td align="right"><? if($paySlip->advance_install>0) echo number_format($advance_tot = $paySlip->advance_install,0); else echo '-';?></td>
            <td colspan="2" align="right"></td>
          </tr>
          ...
          <tr>
            ...
            <td align="right"></td>
            <td colspan="2" align="right"><? $total_deduction = $income_tax+$pf; if($paySlip->total_deduction>0) 
            echo number_format($paySlip->total_deduction,2); else echo '-';?></td>
          </tr>
        </table></td>
    </tr>
    <tr>
      <td style="border:0px;"><table width="600" align="center" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            echo number_format($paySlip->total_payable,0); else echo '-';?>" readonly="readonly" style="text-align:right; height:30px; width:120px; font-weight:bold;"></td>
          </tr>
          <tr>
            <td style="border:0px;" colspan="3">&nbsp;</td>
          </tr>
...
if($r_date !='0000-00-00'){ $last_date =$r_date; }else{ $last_date = date("$year-12-26"); }
...
if($_POST['PBI_ORG']) {$com_con=' and p.PBI_ORG='.$_POST['PBI_ORG'];} 
...
?>
      <tr>
        ...
        <td><?php echo round($data->cash_paid,0); $tcash_paid += round($data->cash_paid);?></td>
        <td><?php echo round($data->bank_paid,0); $tbank_paid += round($data->bank_paid);?></td>
        <td><?php echo round($data->damount,0); $tdamount += round($data->damount);?></td>
        <td><?php echo round($data->pamount,0); $tpamount += round($data->pamount);?></td>
        <td>&nbsp;</td>
      </tr>
      <? } ?>
      <tr>
