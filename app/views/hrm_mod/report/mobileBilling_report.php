...
<!--            table start hear-->
            <table class="table1  table-striped table-bordered table-hover table-sm">
                ...
                <tr>
                    <td><input type="radio" placeholder="test 2" id="1" id="report" name="report" value="781" checked="checked"/></td>
                    <td class="bold" align="left"> <label for="1">Mobile Bill Report</label> </td>
                </tr>
				
				 <tr>
                    <td><input type="radio" id="2" placeholder="test 2" id="report" name="report" value="2244"/></td>
                    <td class="bold" align="left"> <label for="2">Mobile Bill Summary Report</label> </td>
                </tr>
                        ...
                        <table width="100%" border="0" class="table table-bordered table-sm">
                          ...
                          <tbody>
                            ...
                            <tr >
                              ...
                              <td style="font-size:16px"><span class="oe_form_group_cell">
                            ...
                            <tr >
                             <td align="right" style="background-color:#3d6485; color:#FFFFFF; font-size:16px"><span>Month:</span> </td>
                              <td align="left" style="background-color:#3d6485; font-size:16px"><span class="oe_form_group_cell">
                              ...
                              <td align="right" style="background-color:#3d6485; color:#FFFFFF; font-size:16px; "><span style="float:right">Year  :</span></td>
                              <td style="background-color:#3d6485; font-size:16px;padding-top:4px"><select name="year" style="width:160px;" id="year" required="required">
                                  <option <?=($year=='2013')?'selected':''?>>2013</option>
                                  <option <?=($year=='2014')?'selected':''?>>2014</option>
                                  <option <?=($year=='2015')?'selected':''?>>2015</option>
                                  <option <?=($year=='2016')?'selected':''?>>2016</option>
