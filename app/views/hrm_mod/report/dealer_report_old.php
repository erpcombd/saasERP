...
<tr class="oe_list_header_columns">
  ...
  <tbody>
    <tr>
      <td width="4%" align="center"><input name="report" type="radio" class="radio" value="1001" /></td>
      <td width="44%"><strong> Distributor Dealer </strong> <strong>Information</strong></td>
      <td width="4%" align="center">&nbsp;</td>
      <td width="44%">&nbsp;</td>
      </tr>
    <tr  class="alt">
      <td align="center"><input name="report" type="radio" class="radio" value="1002" /></td>
      <td><strong>Super Shop  Dealer </strong> <strong>Information</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
      <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1003" /></td>
      <td class="alt"><strong>Corporate Dealer </strong> <strong>Information</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr class="alt">
      ...
      <td><strong>Trade Fair Dealer </strong> <strong>Information</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
      <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1005" />
      </td>
      <td class="alt"><strong>BulkBuyer Dealer </strong> <strong>Information</strong></td>
      <td align="center">&nbsp;</td>
      <td>&nbsp;</td>
      </tr>
    <tr >
