  ...
  <tr>
    ...
    <td align="left" class="alt"><span class="oe_form_group_cell">
      <select name="PBI_ORG" style="width:160px;" id="PBI_ORG">
        <option value="<?=$_SESSION['user']['group']?>">
...
<? if($_SESSION['user']['username']=='faysal'){ ?> <? } ?>
	      ...
	      <tr  class="alt">
	        <td align="center"><input name="report" type="radio" checked="checked" class="radio" value="301"></td>
	        <td><strong>Factory Leave Report(301)</strong></td>
	        <td align="center">&nbsp;</td>
	        <td>&nbsp;</td>
	        </tr>
<!--    <tr >
