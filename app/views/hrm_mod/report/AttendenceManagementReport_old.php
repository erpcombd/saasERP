  ...
  <div class="oe_view_manager oe_view_manager_current">
                      ...
                      <div  class="oe_list oe_view">
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td>
								  <select name="service_length" style="width:160px;" id="service_length" class="form-control">
						...
						<tr>
                              <td width="17%" align="right" ><strong>Group : </strong></td>
                              <td width="25%" align="left" ><span class="oe_form_group_cell">
                        ...
                        <div style="text-align:center">
                          <table width="100%" class="table table-bordered table-sm">
                            ...
                            <tbody align="left">
							  ...
							  <tr>
							   <td align="center"><input name="report" type="radio" class="radio" value="101010" /></td>
                                <td align="left"><strong>Leave Report Summary (Monthly) New</strong></td>
								  
								  <td align="center"><input name="report" type="radio" class="radio" value="998" /></td>
                                <td align="left"><strong>In Punch Missing Report</strong></td>
                              ...
                              <tr>
							    ...
							    <td align="center"><input name="report" type="radio" class="radio" value="997" /></td>
                                <td align="left"><strong>Out Punch Missing Report</strong></td>
							    ...
							    <td align="center"><input name="report" type="radio" class="radio" value="620" /></td>
                                <td align="left"><strong>Attendance Summary Report</strong></td>
	...
	<tr>
     ...
     <td>&nbsp;</td>
                          ...
                          <input name="submit" type="submit" id="submit" value="&emsp;SHOW&emsp;" class="btn btn-danger" />
                        </div>
                      </div>
                    </div>
                  </div>
