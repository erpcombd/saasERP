...
require_once "../../../controllers/core/class.numbertoword.php";
	...
	echo $query2 = 'select g.id,g.grade,g.zero_increment,g.each_increment,g.upto_ten_incre,g.DA,g.TA,g.Night,g.total_night,g.each_increment_two,g.up_to_twenty_incre,p.grade,p.PBI_ID from payscale g,personnel_basic_info p where p.PBI_ID="' . $emp_id . '" and g.id=p.grade ';
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td>তারিখ :<?php echo $_POST['effect_date'];?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>প্রতি,</td>
  ...
  <tr>
    <td>নাম : <?php echo $info->PBI_NAME;;?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>আইডি নং : <?php echo $info->PBI_CODE;?>	</td>
    <td>পদবী : <?php echo $info->PBI_DESIGNATION;?></td>
  </tr>
  <tr>
    <td>ফ্যাক্টরী : <?php echo find_a_field('user_group','group_name','id='.$info->PBI_ORG);?></td>
    <td>বিভাগ  : <?php echo $info->PBI_DEPARTMENT;;?></td>
  </tr>
</table>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  ...
  <tr>
    <td>আপনার সদয় অবগতির জন্য জানানো যাইতেছে যে, কোম্পানীর প্রয়োজনে কর্তৃপক্ষ আপনাকে <?php echo $info->PBI_DEPARTMENT;?> বিভাগ এর 
	<?php echo $info->section; echo find_a_field('PBI_section','sec_name','sec_id="'.$info->section.'"');?> সেকশন হইতে প্রডাকশন বিভাগ এর ঝবরিহম সেকশনে বদলি করার সিদ্ধান্ত গ্রহন করেছে যাহা আগামী <?php echo $_POST['effect_date'];?> তারিখ হইতে কার্যকর হইবে ।</td>
  </tr>
  <tr>
    <td>আপনার বর্তমান দায়িত্ব আপনার সুপারভাইজারকে বুিঝয়ে দিয়ো আগামী <?php echo $_POST['effect_date'];?> তারিখে <?php echo $info->PBI_DEPARTMENT;?> এর সুপারভাইজারকে রিপোট পূর্বক নতুন দায়িত্ব বুঝে নেওয়ার জন্য অনুরোধ করা যাইতেছে ।</td>
  </tr>
  <tr>
    <td><ul type="square">
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td colspan="2">তারিখঃ <?=$_POST['effect_date'];?></td>
  ...
  <tr>
    <td>এই মর্মে আপনাকে জানানো যাইতেছে যে, আপনার বিগত দিনের কর্ম মূল্যায়ন করে কর্তৃপক্ষের নিকট সন্তোসজনক পরিলক্ষিত হওয়াতে আপনার বেতন বৃদ্ধি করার সিদ্ধান্ত গ্রহন
	 করেছে যাহা <?=$_POST['effect_date'];?>ইং তারিখ  হইতে কার্যকর হইবে। 
</td>
  </tr>
  <tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td colspan="2" width="50%">তারিখঃ <?=$_POST['effect_date'];?></td>
	<td>&nbsp;</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  ...
  <tr>
    <td>এই মর্মে আপনাকে অত্যন্ত আনন্দের সাথে জানানো যাইতেছে যে, আপনার বিগত বছরের কর্ম মূল্যায়ন এবং পর্যালোচনা করে কর্তৃপক্ষের নিকট সন্তোসজনক বিবেচিত হওয়ায় আপনাকে
	 পদন্নোতি প্রদানের সিদ্ধান্ত নেওয়া হয়েছে। আপনার পদবী পূনঃনির্ধারন পূর্বক পদবী <?=$info->PBI_DESIGNATION?>, গ্রেড <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> –  এ নির্ধারন করা হইল যাহা <?=$_POST['effect_date'];?>ইং  তারিখ  হইতে কার্যকর হইবে।</td>
  </tr>
  <tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px; border:none!important;">
  <tr style="border:none!important;" class="bor-none">
    <td colspan="2" class="bor-none" >তারিখঃ <?php echo $_POST['effect_date'];?></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;" class="bor-none">
  ...
  <tr>
    <td colspan="3" class="bor-none">০১। পূর্ন নাম (ডাক নাম সহ): <?php echo $info->PBI_NAME;?> ফোন নং <?php echo $info->PBI_MOBILE;?></td>
    
  </tr>
  <tr>
    <td colspan="3" class="bor-none">০২। পিতার নামঃ <?php echo $info->PBI_FATHER_NAME;?> পেশাঃ <?php echo $info->PBI_DESIGNATION;?></td>
    
  </tr>
  <tr>
    <td colspan="3" class="bor-none">০৩। মাতার নামঃ <?php echo $info->PBI_FATHER_NAME;?> ০৪। স্বামী/স্ত্রীর নামঃ ------------------------পেশাঃ -----------------</td>
  ...
  <tr>
    <td  colspan="3" class="bor-none">০৬। বর্তমান ঠিকানা- বাসা নং <?=$info->pre_house_no;?> বাড়ীর মালিকের নামঃ <?=$info->house_owener;?></td>
    
  </tr>
  <tr>
    <td colspan="3" class="bor-none">পাড়া/মহল্লাঃ <?=$info->para_moholla;?>  ডাকঘরঃ <?=$info->post_office;?> থানাঃ <?=$info->pre_ps;?> জেলাঃ <?=$info->pre_district;?></td>
    
  </tr>
  <tr>
    <td colspan="3" class="bor-none">০৭। স্থায়ী ঠিকানা- গ্রামঃ <?=$info->para_moholla2;?>  ডাকঘরঃ <?=$info->pr_post_office;?>  থানাঃ <?=$info->pre_ps2;?> জেলাঃ <?=$info->pre_district2;?></td>
    
  </tr>
  <tr>
    <td colspan="2" class="bor-none">০৮। জাতীয় পরিচয় পত্র নংঃ <?=$info->nid;?></td>
    <td class="bor-none">০৯। জন্ম নিবন্ধন নংঃ <?=$info->birth_reg_no;?></td>
    
  </tr>
  <tr>
    <td colspan="3" class="bor-none">১০। জন্ম তারিখঃ <?=$info->PBI_DOB;?>    ১১।  জাতীয়তাঃ <?=$info->PBI_NATIONALITY;?> ১২। ধর্মঃ <?=$info->PBI_RELIGION;?></td>
...
ফোন নং-------------------------</td>
  ...
  <tr>
    <td colspan="3" class="bor-none">খ) অত্র প্রতিষ্ঠানে- নামঃ <?=find_a_field('user_group','group_name','id='.$info->PBI_ORG);?> আইডি নং <?=$info->PBI_CODE?></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td style="width:275px !important;"> যোগদানের তারিখঃ   <?=$info->PBI_DOJ?></td>
	<td class="bor-none">&nbsp;</td>
	 <td style="width:200px !important;"> আই ডি নংঃ  <?=$info->PBI_CODE?></td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td width="50%">তারিখঃ <?=$_POST['effect_date'];?></td>
    <td width="50%">&nbsp;</td>
  </tr>
    <tr>
  ...
  <tr>
    <td>নামঃ <?=$info->PBI_NAME?></td>
    <td>&nbsp;</td>
  </tr>
  <tr>
    <td>আইডি নংঃ <?=$info->PBI_CODE?></td>
    <td>পদবীঃ <?=$info->PBI_DESIGNATION?></td>
  </tr>
  <tr>
    <td>ফ্যাক্টরীঃ <?=find_a_field('user_group','group_name','id='.$info->PBI_ORG);?></td>
    <td>বিভাগঃ <?=$info->PBI_DEPARTMENT?>
</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  ...
  <tr>
    <td>এই মর্মে আপনাকে জানানো যাইতেছে যে, আপনার শিক্ষানবীশকাল সাফল্যজনকভাবে অতিক্রান্তের ফলে এবং কর্তৃপক্ষের সন্তুষ্টির পরিপ্রেক্ষিতে আপনার চাকুরী অত্র কোম্পানীতে <?=$info->PBI_DEPARTMENT?> (পদবী) <?=$info->PBI_DESIGNATION?> হিসেবে <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?>(গ্রেড)-এ স্থায়ীকরন করা হইল যাহা <?=$_POST['effect_date']?> ইং তারিখ হইতে কার্যকর হইবে।</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td>তারিখঃ <?=$_POST['effect_date'];?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    <td>আপনার শিক্ষানবীশ কালের কার্যক্রম পর্যালোচনা করে সন্তোষজনক উন্নতি পরিলক্ষিত হয়নি। তাই কর্তৃপক্ষ আগামী <?=$_POST['effect_date'];?> তারিখ হতে আপনার শিক্ষানবীশকাল আরো ০৩ মাস বর্ধিত করনের সিদ্ধান্ত গ্রহন করছেন।</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto" class="bord-none">
  ...
  <tr>
    <td colspan="2" style="text-align:center">কারখানাঃ <?=find_a_field('user_group','group_name','id='.$info->PBI_ORG);?></td>
  ...
  <tr>
    ...
    <td width="50%" style="text-align:center">তারিখঃ <?=$_POST['effect_date'];?></td>
  </tr>
  <tr>
    <td>
		<table width="100%" border="1">
  ...
  <tr>
	...
	<table width="100%" border="1">
	  <tr>
		...
		<td>&#10245;</td>
		<td>অত্র প্রতিষ্ঠানে আপনার পদবী হবে <?=$info->PBI_DESIGNATION?> গ্রেড <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?></td>
	  </tr>
	</table>
  ...
  <tr>
	...
	<table width="100%" border="1">
	  <tr>
		...
		<td width="2%">&#10245;</td>
		<td width="73%">আপনার চাকরী <?=$_POST['effect_date'];?> ইং তারিখ থেকে কার্যকর হবে। </td>
	  </tr>
	</table>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  ...
  <tr>
    <td>এই মর্মে আপনাকে জানানো যাইতেছে যে, আপনার শিক্ষানবীশকাল সাফল্যজনকভাবে অতিক্রান্তের ফলে এবং কর্তৃপক্ষের সন্তুষ্টির পরিপ্রেক্ষিতে আপনার চাকুরী অত্র কোম্পানীতে <?=$info->PBI_DESIGNATION?> (পদবী)................. হিসেবে.............(গ্রেড)<?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> -এ স্থায়ীকরন করা হইল যাহা <?=$_POST['effect_date'];?>  ইং তারিখ হইতে কার্যকর হইবে।</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="1" style="width:800px; margin:0px auto;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td> ফ্যাক্টরীঃ<?=find_a_field('user_group','group_name','id='.$info->PBI_ORG);?></td>
    <td> বিভাগঃ <?=$info->PBI_DEPARTMENT?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
...
পরিপ্রেক্ষিতে আপনার চাকুরী অত্র কোম্পানীতে <?=$info->PBI_DESIGNATION?> হিসেবে <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> -এ স্থায়ীকরন করা হইল যাহা 02-01-2023 ইং তারিখ হইতে 
কার্যকর হইবে।</td>
...
<table width="100%" border="1" style="width:800px; margin:0px auto;" cellpadding="0" cellspacing="0">
  ...
  <tr>
    <td colspan="2">এই মর্মে আপনাকে জানানো যাইতেছে যে, আপনার শিক্ষানবীশকাল  সাফল্যজনকভাবে অতিক্রান্তের ফলে এবং কর্তৃপক্ষের সন্তুষ্টির 
পরিপ্রেক্ষিতে আপনার চাকুরী অত্র কোম্পানীতে <?=$info->PBI_DESIGNATION?> হিসেবে <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> -এ স্থায়ীকরন করা হইল যাহা <?=$_POST['effect_date'];?> ইং তারিখ হইতে 
কার্যকর হইবে।</td>
...
<div class="header">
	...
	<table width="100%" border="1">
		<tr>
			...
			<td width="37%">ইস্যুয় তাংঃ <?=$_POST['effect_date']?></td>
		</tr>
		...
		<tr>
			<td colspan="2">নামঃ <?=$info->PBI_NAME?></td>
			
		</tr>
				
		<tr>
			<td colspan="2">পদবীঃ <?=$info->PBI_DESIGNATION?></td>
			
		</tr>
				
		<tr>
			<td colspan="2">কাজের ধরণঃ <?=$info->PBI_DEPARTMENT?></td>
		...
		<tr>
			<td colspan="2">যোগদানের তারিখঃ <?=$info->PBI_DOJ?></td>
			<td>কার্ডে নংঃ..................... </td>
	...
	<div class="id_back">
		...
		<tr>
			...
			<td width="50%">রক্তের গ্রুপঃ <?=$info->PBI_BLOOD_GROUP;?></td>
		</tr>
		...
		<tr>
			...
			<td width="50%">গ্রামঃ <?=$info->para_moholla2;?></td>
		</tr>
		
		<tr>
			
			<td width="50%">থানাঃ <?=$info->pre_ps2?></td>
		</tr>		
		
		<tr>
			
			<td width="50%">জেলাঃ <?=$info->pre_district2?></td>
		</tr>
		...
		<tr>
			<td width="50%"><p class="p">জাতীয় পরিচয়পত্রের নং- <?=$info->nid?></p>
			<br />
			<p class="p"> ........................................... </p></td>
		</tr>
		
		<tr>
			<td colspan="2" class="center"> <strong>উক্ত পরিচয়পত্র হারাইয়া গেলে তাৎক্ষণিক কর্তৃপক্ষকে জানাইতে হবে।</strong></td>
		</tr>
            ...
            <td width="50%" style=" padding: 10px; border-left: 0px; ">
                <table class="border-none" style="width:100%; border-collapse: collapse;">
                    ...
                    <tr>
                        ...
                        <td width="40%"><p class="m-0">অনুপস্থিত (দিন/সময়)  </p></td>
                    ...
                    <tr>
                        ...
                        <td><p class="m-0">বিনা বেতনে ছুটি   </p>   </td>
                    ...
                    <tr>
                        ...
                        <td>: 0.00  </td>
                        <td><p class="m-0">স্ববেতনে ছুটি    </p></td>
                        <td align="right">0.00</td>
                    </tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; font-size:18px;">
  <tr>
    <td colspan="5" width="50%">তারিখঃ <?=$_POST['effect_date'];?></td>
  </tr>
  <tr>
    <td>&nbsp;</td>
	<td>&nbsp;</td>
  ...
  <tr>
    <td>এই মর্মে আপনাকে অত্যন্ত আনন্দের সাথে জানানো যাইতেছে যেআপনার শিক্ষানবীশকাল সাফল্যজনকভাব  অতিক্রান্তের     ফলে এবং কর্তৃপক্ষের সন্তুষ্টির পরিপ্রেক্ষিতে আপনার চাকুরী অত্র কোম্পানীতে, 
<?=$info->PBI_DESIGNATION?> হিসেবে <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> – স্থায়ীকরন করা হইল যাহা <?=$_POST['effect_date'];?>ইং  তারিখ  হইতে কার্যকর হইবে।</td>
  </tr>
  ...
  <tr>
    <td>আপনার মাসিক বেতন এবং অন্যান্য সুবিধাদি    নিম্নোক্তত হারে ধার্য্য করা হইলঃ</td>
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<?=$info->PBI_DESIGNATION?> হিসেবে <?=find_a_field('hrm_grade','grade_name','id='.$info->grade);?> – স্থায়ীকরন করা হইল যাহা <?=$_POST['effect_date'];?>ইং  তারিখ  হইতে কার্যকর হইবে।</td>
  ...
  <tr>
    <td>   আপনার মাসিক বেতন এবং অন্যান্য সুবিধাদি নিয়োগের শর্তানুযায়ী অপরিবর্তিত থাকবে     |</td> 
  </tr>
  <tr>
    <td>&nbsp;</td>
  </tr>
...
<table width="100%" border="1" cellpadding="0" cellspacing="0" style="width:800px; margin:0px auto; line-height:25px">
  <tr>
    <td colspan="2">৪. প্রবেশনারী পিরিয়ড/শিক্ষানবিসিকালঃ আপনার চাকরীর প্রথম  ৬(ছয়) মাস প্রবেশনারী/ শিক্ষানবিসিকাল হিসাবে গণ্য হবে। এই সময়ে অপনার কর্ম 
সন্তোষজনক না হলে কর্তৃপক্ষ শিক্ষানবিসিকাল আরও তিন মাস বৃদ্ধি করতে পারবেন কিংবা উক্ত পদে নিয়োগ করতে বাধ্য থাকবেন না। </td>
  </tr>
  <tr>
    <td colspan="2">৫. চাকরী স্থায়ী হবার পর ৬০ (ষাট) দিনের লিখিত নোটিশ অথবা নোটিশের পরিবর্তে ৬০ (ষাট) দিনের মূল মজুরী কোম্পানীকে প্রদান সাপেক্ষে আপনি স্বেচ্ছায় চাকরী হতে 
ইস্তফা দিতে পারবেন। </td>
