...
<input type="hidden" name="t_date" value="<?=date("Y-m-d")?>">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
						...
						<i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> Today
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <div class="card card-stats">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
					 		 <i class="fa-solid fa-calendar-days pt-1 mr-1"></i> Today
                      </div>
                  ...
                  <div class="card card-stats">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
						 ...
						 <i class="fa-solid fa-calendar-days pt-1 mr-1"></i> Last 7 Days
                  ...
                  <div class="card card-stats">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
						...
						<i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> Last 7 Days
                  ...
                  <div class="card card-stats">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
						...
						<i class="fa-solid fa-calendar-days pt-1 mr-1"></i> In Office
                  ...
                  <div class="card card-stats">
                    ...
                    <div class="card-footer">
                      ...
                      <div class="stats">
						...
						<i class="fa-solid fa-clock-rotate-left pt-1 mr-1"></i> In Office
...
if ($resultActivities) {
    while ($activityRow = mysqli_fetch_object($resultActivities)) {
        ...
        if (!isset($activitiesByDate[$activityDate])) {
            ...
            $activitiesProject[$activityDate] = [];
            $activitiesPerson[$activityDate] = [];
        }
...
<div class="calendar">
    <div class="cal-header">
        <h4>Available Meeting Schedule Overview</h4>
        ...
        <?php foreach ($calendarDates as $date): ?>
            ...
            <div class="cal-date-box <?php echo $statusClass; ?>">
                ...
                <?php if ($activityDetails): ?>
                    <?php
                    $sqlQuery = "SELECT PBI_NAME, PBI_ID FROM personnel_basic_info WHERE PBI_ID IN ($activitiesPersonn) ORDER BY PBI_ID DESC";
                    ...
                    <?php if ($totalEmployees > $maxToShow): ?>
                        <div class="cal-activity-details mt-1">
                            <a href="meeting_details.php?date=<?= $date ?>" class="btn btn-sm btn-primary">View Details</a>
                        </div>
                    <?php endif; ?>
                <?php endif; ?>
            </div>
