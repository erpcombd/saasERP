                  ...
                  <td class="oe_form_group_cell"><table width="100%" height="279" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
                    <tbody>
                        ...
                        <tr class="oe_form_group_row">
                          ...
                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="consolidated_salary" type="text" id="consolidated_salary" value="<?=$consolidated_salary?>" /></td>
                       ...
                       <tr class="oe_form_group_row">
                        ...
                        <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="house_rent" type="text" id="house_rent" value="<?=$house_rent?>" /></td>
                          ...
                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><span class="oe_form_field oe_datepicker_root oe_form_field_date"><input name="pf_organization" type="text" id="pf_organization" value="<?=$pf_organization?>" /></span></td>
                       </tr>
                        <tr class="oe_form_group_row">
                        ...
                        <tr class="oe_form_group_row">
                          <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Conv. :</td>
                        ...
                        <tr class="oe_form_group_row">
                          <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;City Allo. :</td>
                          <td class="oe_form_group_cell">
  <input name="da" type="text" id="da" value="<?=$da?>" />                            </td>
                        ...
                        <tr class="oe_form_group_row">
                          ...
                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><input name="cash_bank" type="text" id="cash_bank" value="<?=$cash_bank?>" /></td>
                        </tr>
                        <tr class="oe_form_group_row">
