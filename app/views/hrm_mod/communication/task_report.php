  ...
  <tr>
    ...
    <td align="left" width="30%">
      ...
      <?
	   ...
	   if($_SESSION['employee_selected']==2 || $_SESSION['employee_selected']==61 || $_SESSION['employee_selected']==120 || $_SESSION['employee_selected']==169 || $_SESSION['employee_selected']==130 || $_SESSION['employee_selected']==116 || $_SESSION['employee_selected']==173){
