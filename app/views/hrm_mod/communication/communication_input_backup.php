...
padding: 3px;
		...
		<script>
		function sr_customer_change(str) {
  if (str=="") {
  ...
  xmlhttp.open("GET","get_customer_info.php?q="+str,true);
  xmlhttp.send();
}
		</script>
			...
			<table width="100%" height="231" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  <td height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">Company Name </td>
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><select name="service_id" id="service_id" >
                    <option value=""></option>
                ...
                <tr class="oe_form_group_row">
				  ...
				  <select name="EMP_ID" id="EMP_ID"  style="width:150px;"  class="form-control"  required>
                      <option value=""></option>
                      <? foreign_relation('personnel_basic_info c','c.PBI_ID','c.PBI_NAME',$EMP_ID,'1')?>
                  </select></td>
                  <td height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">Lead No </td>
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><select name="lead_no" id="lead_no"  style="width:150px;"  class="form-control">
                      <option value=""></option>
                      <? foreign_relation('crm_lead_master','lead_no','lead_no',$lead_no,'1')?>
                  </select></td>
                </tr>
                <tr class="oe_form_group_row">
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><input type="date" name="c_date" id="c_date"  value="<?=$c_date?>"  width="150px"></td>
                </tr>
                <!--<tr class="oe_form_group_row">
                ...
                <tr class="oe_form_group_row">
				  ...
				  <table class="table " width="100%" cellpadding="5" align="center" style="background:#f0f0f0">
				<thead>
					<tr >
					
    					<th class="text-center"  style="text-align: center; padding: 5px;">
							Select Customer Person
						</th>
					</tr>
				</thead>
				<tbody>
				...
				<tr  >
    					...
    					<td data-name="se" style="background: #1ABB9C;">
						    ...
						    <select name="dealer_code[]"  class="selectpicker" data-live-search="true" style="border-color: 1px solid green;width:100%">
        				        ...
        				        <option value="<?=$rows->dealer_code?>"><?=find_a_field('crm_customer_info','dealer_name_e','dealer_code="'.$rows->dealer_code.'"')?>-<?=find_a_field('crm_customer_info a, crm_project b','b.PROJECT_DESC','a.PROJECT_ID=b.PROJECT_ID and a.dealer_code="'.$rows->dealer_code.'"')?></option>
					 ...
					 ?>
					 <option value="<?=$row->dealer_code?>"><?=$row->dealer_name_e?>-<?=find_a_field('crm_project','PROJECT_DESC','PROJECT_ID="'.$row->PROJECT_ID.'"')?></option>
				...
				<?
				 ...
				 $select = 'select * from crm_com_detail_emp where com_id="'.$$unique.'"';
				...
				<tr>
    					...
    					<td data-name="se" style="background: #1ABB9C;">
						    ...
						    <select name="PBI_ID[]"  style="width:100%"  class="selectpicker" data-live-search="true">
        				        ...
        				        <option value="<?=$row->PBI_ID?>"><?=find_a_field('personnel_basic_info','PBI_NAME','PBI_ID="'.$row->PBI_ID.'"')?></option>
								<option value="">&emsp;</option>
				...
				<td>
					 ...
					 $sql = "select * from personnel_basic_info where 1";
					 $query = db_query($sql);
					 
					 while($row = mysqli_fetch_object($query)){
					 
					 ?>
					 <option value="<?=$row->PBI_ID?>"><?=$row->PBI_NAME?></option>
				...
				<tr  >
    					...
    					<td data-name="se" style="background: #1ABB9C;">
						    ...
						    <select name="unassign[]"  style="width:100%"  class="selectpicker" data-live-search="true">
        				        ...
        				        <option value="<?=$rows->dealer_code?>"><?=find_a_field('crm_customer_info','dealer_name_e','dealer_code="'.$rows->dealer_code.'"')?></option>
								<option value="">&emsp;</option>
								<?
					 ...
					 ?>
					 <option value="<?=$row->dealer_code?>"><?=$row->dealer_name_e?></option>
