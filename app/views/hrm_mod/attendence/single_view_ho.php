...
$title='Single Attendance  Roster (After IN OUT Process)';
...
<!--<tr class="oe_list_header_columns" style="text-align:center">
  ...
  <tr  class="alt">
	...
	<input name="PBI_ID"  type="text" id="PBI_ID" size="10" onblur="" tabindex="1" style="width:400px;" required="required" value="<?=$_POST['PBI_ID']?>" / class="form-control"></td>
	...
	value="<? if(isset($_POST['start_date'])){ echo $_POST['start_date']; }else{echo date('Y-m-01'); } ?>" / class="form-control"></td>
...
<table  border="0" class="table table-bordered table-sm" cellspacing="0" cellpadding="0">
...
<tr class="oe_list_header_columns">
  ...
  <table  border="0" class="table table-bordered table-sm" cellspacing="0" cellpadding="0" id="grp">
