...
$sql2="DELETE FROM hrm_iom_info WHERE id = '".$id."' and dept_head_status IN ('Pending','Pre Approve')";
$q3 = db_query($sql2);
    ...
    <form action=""  method="post" enctype="multipart/form-data">
        <div class="d-flex justify-content-center">
            ...
            <div class="n-form1 fo-white pt-0">
                <h4 class="text-center bg-titel bold pt-2 pb-2">      Delete IOM    </h4>

                        <div class="container">
                            <div class="form-group row  m-0 mb-1 pl-3 pr-3">
                                <label for="group_for" class="col-sm-3 col-md-3 col-lg-3 col-xl-3 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">IOM ID :  </label>
                    ...
                    <div class="n-form-btn-class">
                        <input name="delete" class="btn1 btn1-bg-submit" type="submit" id="delete" value="IOM Delete" />
                    </div>
