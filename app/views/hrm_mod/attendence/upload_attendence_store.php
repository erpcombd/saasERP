...
$title="Upload Attendence(Others)";
do_calander('#m_date');
...
'".$td_days_mon."','".$emapData[11]."', '".$emapData[12]."','0','".($td_days_mon-($emapData[10]))."','".$emapData[9]."','".$emapData[7]."','".$emapData[10]."','0',
'".$emapData[14]."','".$emapData[13]."','".$_SESSION['user']['id']."','".date('Y-m-d H:i:s')."')";
db_query($sql);
				}
				else
				{
...
lv = "'.$emapData[9].'",td = "'.$td_days_mon.'",od = "'.$emapData[11].'",ab = "'.($td_days_mon-$emapData[10]).'",pre = "'.$emapData[7].'",pay = "'.$emapData[10].'",edit_by = "'.$_SESSION['user']['id'].'",edit_at = "'.date('Y-m-d H:i:s').'"
    ...
    <form  action=""  method="post" enctype="multipart/form-data">
        <div class="d-flex justify-content-center">
            ...
            <div class="n-form1 fo-white pt-0">
                <h4 class="text-center bg-titel bold pt-2 pb-2">  Upload Store Monthly Attendence   </h4>
                ...
                <div class="alert alert-danger p-1 pl-2 pr-2 m-0" role="alert">
                    Note: File must be at CSV format. Example: sales.csv
                </div>
          ...
          <div  class="oe_view_manager_view_list"><div  class="oe_list oe_view">
            ...
            <table width="80%" border="1" align="center">
              ...
              <tr>
                ...
                <td height="40" colspan="4" bgcolor="#00FF00"><div align="center" class="style1">Upload Store Monthly Attendence</div></td>
                </tr>
...
<option value="12" <?=($mon=='12')?'selected':''?>>Dec</option>
              ...
              <tr>
                <td> Upload  File :</td>
                <td colspan="3"><input name="mobile_bill"  type="file" id="mobile_bill" class="form-control"/></td>
                </tr>
              <tr>
