...
<?
  ...
  echo $sql = 'select o.id,p.PBI_NAME,p.PBI_ID,p.DEPT_ID,p.PBI_CODE,p.cost_center,p.section,
...
?>
                        ...
                        <tr>
                        <td style="width:50px"><input type="checkbox" style="width:50px" name="check_list[]" value="<?=$data->id;?>"></td>
                          <td><?=++$s?></td>
