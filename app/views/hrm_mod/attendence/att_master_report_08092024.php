...
elseif($_REQUEST['report']==210907001) {
		...
		<tr>
			...
			<td colspan="15" style="font-size:16px;border:0px; border-color:white;">&nbsp;</td>
        ...
        <th width="10%" bgcolor="#FFFACD">Cost Center</th>
       	<th width="10%" bgcolor="#FFFACD">Class</th>
	

		<th width="9%" bgcolor="#FFFACD">ID NO</th>
		...
		<th width="8%" bgcolor="#FFFACD">Attendance Date</th>

		<th width="8%" bgcolor="#FFFACD">In Time</th>

		<th width="8%" bgcolor="#FFFACD">Out Time</th>

		<th width="8%" bgcolor="#FFFACD">Shift</th>
       
        <th width="8%" bgcolor="#FFFACD">Location</th>
...
?>
	    ...
	    <td><?=find_a_field('hrm_cost_center','center_name','id="'.$row->cost_center.'"');?></td>

       <td><?=find_a_field('hrm_class','class_name','id="'.$row->class.'"');?></td>
	   ...
	   <td><?=find_a_field('designation','DESG_DESC','DESG_ID='.$row->DESG_ID);?></td>
		...
		<td><?=find_a_field('PBI_Section','sec_name','sec_id='.$row->section);?></td>
	   ...
	   <td align="center"><?=find_a_field('hrm_schedule_info','schedule_name','id="'.$shift_id.'"');?>
