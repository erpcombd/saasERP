...
<tr class="oe_list_header_columns">
  ...
  <tr  class="alt">
	...
	where PBI_ORG='".$_SESSION['user']['group']."' and PBI_JOB_STATUS = 'In Service' and JOB_LOCATION not in('1')"); ?>
	</select>
	</td>
    </tr>
	  <tr >
...
if($sch[$day_date]['sch_name']=='Leave')
$val[$day_date]['final_status'] = 'LEAVE';
...
if($val[$day_date]['final_status']=='LATE')
{$text_color = 'Red';} 
