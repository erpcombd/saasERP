...
if ($damp_query) {
    ...
    // Check if array has elements before using min()
    if (!empty($formatted_xtime_values)) {
        ...
        // Only add comma and remaining times if there are remaining elements
        if (!empty($formatted_xtime_values)) {
            echo ', ';
        ...
        echo '<span style="color: red;">No attendance records</span>, ';
    }
} else {
