...
foreign_relation('office_location','ID','LOCATION_NAME',$_POST['JOB_LOCATION'],'1 and store="1"');		
?>
      </select>
    </span></td>
    </tr>
  <tr >
<?
$month_find = find_a_field('hrm_portal_setup','mon','1 and level=56');
...
and p.PBI_DEPARTMENT IN ('STO','Store (Transport)')
...
<td align="center"><span id="divi_<?=$info->PBI_ID?>">
            <? 
			  ...
			  if($status=='Edit')
			  {
			  if($_SESSION['user']['level']==5||$_SESSION['user']['id']==10485)
