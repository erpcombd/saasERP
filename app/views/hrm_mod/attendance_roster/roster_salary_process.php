...
$lyear = $_POST['year']-1;
$fiscal_start = $lyear.'-12-26';
$fiscal_end = $_POST['year'].'-12-25';
...
if($PBI_ORG>0) {$ORG_con = " and p.PBI_ORG='".$PBI_ORG."'";}
 ...
 $sql = "SELECT h.emp_id,(count(1)-sum(h.leave_duration)) pre, sum(h.leave_duration) lv, sum(h.final_late_min) l_min,sum(h.final_late_status) l_status,sum(h.panalty_leave_duration) panalty_lv,p.PBI_DOJ,p.PBI_ID,p.PBI_DUE_DOJ,p.PBI_DOC2
