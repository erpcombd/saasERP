...
$all_edu=find_all_field('hrm_education_detail','*','PBI_ID="'.$all_data->PBI_ID.'" order by EDUCATION_D_ID desc ');
  ...
  $up_sql='update performance_appraisal_details_two set authorize_comments="'.$_POST['authorize_comments'].'",authorize_by="'.$_SESSION['user']['id'].'" where pa_id='.$_GET['id'];
  db_query($up_sql);
    ...
    <section >
	  ...
	  <br>
			...
			<div   style="border:2px solid black;" class="first_part">  
					<a href="perfor_appri_autho_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-bottom:5px; margin-left:10px;"></a>
