    ...
    <section >
	  ...
	  <br>
            ...
            <br>
					...
					<a href="self_assessment_hod_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-left:10px; margin-top:10px;"></a>
      ...
      <div class="col-6">
	  	<div class="input-group mb-3 input-group-sm">
			  ...
			  <select name="appraisal_for" id="appraisal_for" class="form-control" style="color:red;font-weight:bold;">
	 ...
	 $tot_point=find_a_field('self_assessment_details','sum(outstanding+excellent+good+average+below_average+unsatisfactory)','pa_id='.$_GET['id'])+$group_point;
	  ?>
	  <span style="font-size:30px; font-weight:bold;">Points Gain <span style="color:red;font-size:30px;font-weight:bold;"><?php echo $tot_point; ?></span> Out of 100</span>
