...
$all_edu=find_all_field('hrm_education_detail','*','PBI_ID="'.$all_data->PBI_ID.'" order by EDUCATION_D_ID desc ');
  ...
  db_query($up_sql);
  $up_sql='update performance_appraisal set status="APPROVED" where id="'.$_GET['id'].'"';
			db_query($up_sql);
    ...
    <section >
	  ...
	  <br>
			...
			<div  style="border:2px solid black;" class="first_part">  
					<a href="perfor_appri_hr_check_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-left:10px; margin-bottom:5px;"></a>
			<div class="row m-0 p-0">
      <div class="col-6">
