...
<table class="table table-bordered table-sm" id="sales_list">
	...
	//}
	//else{
	   //$sql="select * from performance_appraisal where status in('VERIFIED') and  employee_id in(select PBI_ID from personnel_basic_info where authorized_by='".$autho_pbi."')  order by id desc ";
	 //  }
	...
	?>
		<tr>
			...
			<td><a href="performance_apprisial_view_autho.php?PBI_ID=<?php echo $pbi_all->PBI_ID;?>&id=<?php echo $data->id;?>"  ><input type="button" value="View" /></a></td>
