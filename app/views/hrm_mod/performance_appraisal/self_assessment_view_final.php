...
$all_edu=find_all_field('hrm_education_detail','*','PBI_ID="'.$all_data->PBI_ID.'" order by EDUCATION_D_ID desc ');
  ...
  $all_data_details_two=find_all_field('self_assessment_details_two','*','pa_id='.$_GET['id']);
  if(isset($_POST['submit'])){
  
  $up_sql='update self_assessment_details_two set approve_amt="'.$_POST['approve_amt'].'",md_comments="'.$_POST['md_comments'].'",md_entry_by="'.$_SESSION['user']['id'].'" where pa_id='.$_GET['id'];
  db_query($up_sql);
  $up_sql='update self_assessment_appraisal set status="COMPLETED" where id="'.$_GET['id'].'"';
			db_query($up_sql);
    ...
    <section >
	  ...
	  window.print();
	   document.getElementById("cus_print_span").style.display="";
			...
			<a href="self_assessment_status_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-bottom:5px;"></a>
	 ...
	 $tot_point=find_a_field('self_assessment_details','sum(outstanding+excellent+good+average+below_average+unsatisfactory)','pa_id='.$_GET['id'])+$group_point;
	  ?>
		...
		<table class="table table-bordered table-sm" style="width:100%;">
			...
			?>
				<tr>
					...
					<td>
					<?php 
					$check_outstanding=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.outstanding=h.outstanding and d.outstanding=5');
					$check_outstanding_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.outstanding=5');
				    ...
				    <td>
					<?php 
					$check_excellent=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.excellent=h.excellent and d.excellent=4');
					$check_excellent_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.excellent=4');
				    ...
				    <td>
							<?php 
					$check_good=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.good=h.good and d.good=3');
					$check_good_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.good=3');
					...
					<?php 
					$check_average=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.average=h.average and d.average=2');
					$check_average_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.average=2');
				    ...
				    <td>
					<?php 
					$check_below_average=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.below_average=h.below_average and d.below_average=1');
					$check_below_average_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.below_average=1');
				    ...
				    <td>
					<?php 
					$check_unsatisfactory=find_a_field('self_assessment_details d,self_assessment_details_history h','count(d.id)','d.pa_id="'.$_GET['id'].'" and d.pa_id=h.pa_id and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'" and d.unsatisfactory=h.unsatisfactory and d.unsatisfactory!=""');
					$check_unsatisfactory_history=find_a_field('self_assessment_details_history d','count(d.id)','d.pa_id="'.$_GET['id'].'"  and d.criteria="'.$row->id.'" and d.employee_id="'.$all_data_master->employee_id.'"  and d.unsatisfactory!=""');
		...
		<br>  
				<table style="width:25%;" >	  
					...
					<tr style="border:0px solid;">
						...
						<tr style="border-top:1px solid black;">
						<td style="text-align:center;font-weight:bold;">Signature of the Appraiser </td>
					</tr>		  
              </table>
		<br>
