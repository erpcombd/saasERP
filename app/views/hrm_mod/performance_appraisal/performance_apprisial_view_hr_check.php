...
$all_edu=find_all_field('hrm_education_detail','*','PBI_ID="'.$all_data->PBI_ID.'" order by EDUCATION_D_ID desc ');
  ...
  $up_sql='update performance_appraisal_details_two set hr_remarks="'.$_POST['hr_remarks'].'",hr_development_plan="'.$_POST['hr_development_plan'].'",hr_entry_by="'.$_SESSION['user']['id'].'" where pa_id='.$_GET['id'];
  db_query($up_sql);
  $up_sql='update performance_appraisal set status="FINAL APPROVAL" where id="'.$_GET['id'].'"';
			db_query($up_sql);
			
				header("Location: performance_apprisial_view_hr_view.php?id=".$_GET['id']);
  }
    ...
    <section >
	  ...
	  <br>
			...
			<div   style="border:2px solid black;" class="first_part">  
				<div class="pb-2">
					<a href="perfor_appri_autho_list.php"><input type="button" class="btn btn-primary" style="margin-left: 10px;" value="Go Back"></a>
				</div>
			<div class="row p-0 m-0">
      <div class="col-6">
