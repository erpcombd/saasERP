...
div .cus{
  ...
  <body style="width:90%;margin:0 auto;">
    ...
    <section >
	  ...
	  <br>
			...
			<div   style="border:2px solid black;" class="first_part">  
					<a href="perfor_appri_md_check_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-bottom:5px; margin-left:10px;"></a>
			<div class="row m-0 p-0">
      <div class="col-6">
    ...
    document.getElementById("other_recommendation").style.display = vis;
		...
		<tr>
				<td  >Comments<br>
			<textarea style="height: 70px;width: 80%;" name="md_comments" id="md_comments">With Effective From : <?php echo $all_data_details_two->md_comments;?></textarea>
			</td>
		</tr>
		</tbody>
		</table>
