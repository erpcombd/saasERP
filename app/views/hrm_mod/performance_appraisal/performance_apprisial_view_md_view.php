  ...
  <script>
	  ...
	  window.print();
	   document.getElementById("cus_print_span").style.display="";
			...
			<a href="perfor_appri_md_check_list.php"><input type="button" class="btn btn-primary" value="Go Back" style="margin-left:2px; margin-bottom:5px;"></a>
			 <input type="button" class="btn btn-primary" value="Print" onClick="cus_print()" style="margin-left:10px; margin-bottom:5px;"> 
			 </span>
    ...
    document.getElementById("other_recommendation").style.display = vis;
		...
		<tbody>
				<tr>
			<td>Approve Amount <input type="text" name="autho_increment_amount" value="<?php echo $all_data_details_two->autho_increment_amount;?>" id="autho_increment_amount" style="background:#a1f9a4;"></td>
		...
		<tr>
			...
			<input type="text" name="approve_amt" id="approve_amt" value="<?php echo $all_data_details_two->approve_amt;?> " style="background:#a1f9a4;">
			</td>
		</tr>
		<tr>
				<td  >Comments<br>
