...
$title='Upcomming Performance Appraisal List(HRD)';
...
<table class="table table-bordered table-sm" id="sales_list">
	...
	?>
		<tr>
			...
			<td><a href="performance_apprisial_view_hr_check.php?PBI_ID=<?php echo $pbi_all->PBI_ID;?>&id=<?php echo $data->id;?>"  ><input type="button" value="View" /></a></td>
