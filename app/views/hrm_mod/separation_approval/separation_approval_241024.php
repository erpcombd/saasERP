...
$title = 'Employee Separation Form';			// Page Name and Page Title
        ...
        <table class="table1  table-striped table-bordered table-hover table-sm">
          <thead class="thead1 bg-titel">
            <tr class="bgc-info">
              ...
              <th style="text-align: center">Date of Separation</th>
              <th style="text-align: center">Reason for Separation</th>
...
//and a.entry_by='.$_SESSION['employee_selected'].'
  ...
  //and  a.PBI_ID="'.$PBI_ID.'"
 	 echo $sql = 'SELECT * FROM `separation_details`'; 
...
?>
            <tr>
              ...
              <td style="width:180px"> <?=date('d-M-Y',strtotime($data->separationdate))?> </td>
              <td style="text-align:center">
                  <?php 
                    if ($data->separationreason == 1) {
                      echo "Resignation";
                    } elseif ($data->separationreason == 2) {
                      echo "Retirement";
                    } else {
                      echo "No data";
                    }
              ...
              <td style="width:50px,text-align:center">
                    <?php 
                    if ($data->separation_status == 1) {
                      echo "Pending";
                    } elseif ($data->separation_status == 2) {
                      echo "Approve";
                    } else {
                      echo "No data";
                    }
              ...
              <td style="width:50px,text-align:center">
                 <a href="separation_approval_view.php?id=<?= $data->separation_details_no; ?>" class="btn btn-primary">
