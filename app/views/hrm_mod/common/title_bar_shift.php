    ...
    <div class="col-md-2 form-group">
     ...
     <div class="col-md-2 form-group">
      ...
      <label class="label" for="fdate">Search From Date :</label>
        <input type="date" name="fdate" autocomplete="off" id="fdate"  value="<?=($_POST['fdate'] > 0) ? $_POST['fdate'] : date("Y-m-01");?>"  class="form-control" required />
                                         
    </div>
    
    <div class="col-md-2 form-group">
      <label class="label" for=" "> Search To  Date </label>
      <input type="date" name="tdate" autocomplete="off" id="tdate" value="<?=($_POST['tdate'] > 0) ? $_POST['tdate'] : date("Y-m-d");?>""  class="form-control" required/>
