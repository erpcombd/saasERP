    ...
    <div class="row">
      ...
      <form action="" method="post">
        ...
        <div class="row  p-0 m-0">
          ...
          <div class="col-md-4" style="padding-right:0px!important;">
		  <input name="reset" type="button" class="btn1 btn1-bg-cancel" id="reset" value="Reset" onclick="parent.location='<?=$page?>'" style=" height: 100%; width: 95%; "/>
  ...
  document.getElementById("employee_selected").value="";
    ...
    <div class="col-md-2 form-group">
      ...
      <select name="grade" id="grade" class="form-control">
        ...
        <? foreign_relation('hrm_grade','id','grade_name',$grade,'1 order by id');?>
      </select>
    </div>
    <div class="col-md-2 form-group">
    ...
    <div class="col-md-2 form-group">
      <label class="label" for="level"> Date Of Joining :</label>
      <input type="date"  name="DOJ" id="DOJ" value="<?=$DOJ?>" class="form-control" />
    </div>
    <div class="col-md-2 form-group">
      ...
      <select name="PBI_RELIGION" class="form-control">
       ...
       <div class="col-md-2 form-group">
      <label class="label" for="JOB_LOCATION"> Schedule Date :</label>
      <input type="date"  name="roster_date" id="roster_date" value="<?=$roster_date?>" class="form-control" />
    </div>
	...
	<div class="col-md-2 form-group">
      <label class="label" for="JOB_LOCATION">Bonus Type :</label>
      <select name="type" id="type"  class="form-control"  >
        <option></option>
        <option selected>
        <?=find_a_field('bonus_type','type','id="'.$_POST['type'].'"');?>
        </option>
        <? foreign_relation('bonus_type','id','type',$type);?>
      </select>
    </div>
