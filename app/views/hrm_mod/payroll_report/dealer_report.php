...
<tr class="oe_list_header_columns">
  ...
  <tr >
    ...
    <td align="left"><select name="team_name" style="width:160px;">
...
<tr class="oe_list_header_columns">
  ...
  <tbody>
    ...
    <tr >
      ...
      <td class="alt"><strong>Corporate Customer </strong> <strong>Information</strong></td>
    ...
    <tr >
      ...
      <td align="center" class="alt"><input name="report" type="radio" class="radio" value="1004" />

      <td><strong>Personal Sales </strong> <strong>Information</strong></td>
