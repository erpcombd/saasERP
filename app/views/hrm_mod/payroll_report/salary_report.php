...
<form action="../payroll_report/master_report.php" target="_blank" method="post">
                          ...
                          <table width="100%" class="oe_list_content">
                            ...
                            <td align="center" class="alt"><input name="report" type="radio" class="radio" value="21211212" /></td>   
							  ...
							  <!--<tr >
							    ...
							    <td align="center" class="alt"><input name="report" type="radio" class="radio" value="5312022" /></td>



							    <td class="alt"><strong>Salary Certificate Tax(Old)</strong></td>
                            ...
                            <td align="center" class="alt"><input name="report" type="radio" class="radio" value="283544" /></td>   
                                ...
                                <td class="alt"><strong>Salary Report (Tax purpose underconstruction)</strong></td>
							   ...
							   <td align="center" class="alt"></td>   
                                ...
                                <td class="alt"><a href="datatables.php" target="_blank">DataTables</a></td>
