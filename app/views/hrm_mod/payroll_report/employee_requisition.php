...
<div class="oe_form_sheetbg">
        ...
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	 $res='select '.$unique.','.$unique.', '.$shown.'  `DESIGNAITION`, `DEPARTMENT`, `JOB_LOCATION`, `SALARY_TO`, `SALARY_FROM`, `EXPECTED_DATE_TO`, `EXPECTED_DATE_FROM`, `VACANCY`, `REQ_BY from '.$table;
