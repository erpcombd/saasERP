                        ...
                        <div style="text-align:center">
                          <table width="100%" class="oe_list_content">
                            ...
                            <tbody>
							  ...
							  <tr >
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="133332" /></td>
                                <td class="alt"><strong>TAX Information Report</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
							  ...
							  <tr >
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="144657" /></td>
                                <td class="alt"><strong>Statement regarding the payment of salary</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
							   ...
							   <tr>
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="144658"/></td>
                                <td class="alt"><strong>Statement of Tax Deducted from Salaries</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
							  
							  <tr>
                                <td align="center" class="alt"><input name="report" type="radio" class="radio" value="144659"/></td>
                                <td class="alt"><strong>Tax investment Report</strong><strong></strong></td>
                                <td align="center">&nbsp;</td>
                                <td>&nbsp;</td>
                              </tr>
