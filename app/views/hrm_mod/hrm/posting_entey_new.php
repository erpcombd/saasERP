            ...
            <div class="row">
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        ...
                        <div class="form-group row m-0 pb-1">
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Notes</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                                <input type="text" name="POSTING_DOMAIN" id="POSTING_DOMAIN" value="<?=$POSTING_DOMAIN?>"/>
                ...
                <div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
                    <div class="container n-form2">
                        <div class="form-group row m-0 pb-1">
                            ...
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                               <select name="division" onchange="divi(this.value)">
							   	<option></option>
                              		<? foreign_relation('division','division_CODE','division_name',$division);?>
                         	   </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group row m-0 pb-1">
                            ...
                            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">District</label>
                            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
							<span id="dis">
                                ...
                                <select name="district" required>
									<option></option>
                              		 <? foreign_relation('district_list','id','district_name',$district,'division_id="'.$division.'"' );?>
