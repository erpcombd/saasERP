...
$all=find_all_field('personnel_basic_info','','PBI_ID='.$_GET['pbi_id']);
$info=find_all_field('salary_info','','PBI_ID='.$_GET['pbi_id']);
$inc_info=find_all_field('increment_detail','','INCREMENT_D_ID="'.$_GET['id'].'" and PBI_ID='.$_GET['pbi_id']);
...
//$pbi_info="UPDATE personnel_basic_info set PBI_ORG='".$_POST['PBI_ORG_NEW']."' , PBI_FUNCTION='".$_POST['PBI_FUNCTION_NEW']."' , cost_center='".$_POST['cost_center_new']."',DEPT_ID='".$_POST['DEPT_ID_NEW']."',section='".$_POST['section_new']."',DESG_ID='".$_POST['DESG_ID_NEW']."',grade='".$_POST['grade_new']."',salary_schedule='".$_POST['salary_schedule']."',class='".$_POST['class_new']."',JOB_LOC_ID='".$_POST['JOB_LOC_ID_NEW']."'  where PBI_ID='".$_SESSION['employee_selected']."' ";
//
//mysql_query($pbi_info);

 $updates="UPDATE increment_detail
	SET 
	INCREMENT_EFFECT_DATE='".$_POST['INCREMENT_EFFECT_DATE']."',
	INCREMENT_TYPE='".$_POST['INCREMENT_TYPE']."',
	score='".$_POST['score']."',
	INCREMENT_AMT='".$_POST['INCREMENT_AMT']."',
	
	PBI_ORG_NEW='".$_POST['PBI_ORG_NEW']."',
	PBI_FUNCTION_NEW='".$_POST['PBI_FUNCTION_NEW']."',
	cost_center_new='".$_POST['cost_center_new']."',
	DEPT_ID_NEW='".$_POST['DEPT_ID_NEW']."',
	section_new='".$_POST['section_new']."',
	DESG_ID_NEW='".$_POST['DESG_ID_NEW']."',
	grade_new='".$_POST['grade_new']."',
	JOB_LOC_ID_NEW='".$_POST['JOB_LOC_ID_NEW']."',
	salary_schedule_new='".$_POST['salary_schedule_new']."',
	class_new='".$_POST['class_new']."',
	
	new_basic_salary='".$_POST['new_basic_salary']."',
	new_house_rent='".$_POST['new_house_rent']."',
	new_convenience='".$_POST['new_convenience']."',
	new_medical_allowance='".$_POST['new_medical_allowance']."',
	grossSalary_new='".$_POST['grossSalary_new']."',
	new_food_allowance='".$_POST['new_food_allowance']."',
	technical_new='".$_POST['technical_new']."',
	technical_status_new='".$_POST['technical_status_new']."',
	new_special_allowance='".$_POST['new_special_allowance']."',  
	special_status_new='".$_POST['special_status_new']."',
	dislocation_new='".$_POST['dislocation_new']."',
	dislocation_status_new='".$_POST['dislocation_status_new']."',
	new_mobile_allowance='".$_POST['new_mobile_allowance']."',
	mobile_status_new='".$_POST['mobile_status_new']."'
	 where INCREMENT_D_ID=".$_GET['id']." and  PBI_ID=".$_GET['pbi_id']." ";
	mysql_query($updates);
}
...
if (isset($$unique)) {
	...
	$data = mysql_fetch_object($table, $condition);
							  ...
							  <div class="row ">
								...
								<div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
								  <div class="form-group row m-0">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									  <input type="date" name="INCREMENT_EFFECT_DATE" autocomplete="off" id="INCREMENT_EFFECT_DATE" value="<?=$inc_info->INCREMENT_EFFECT_DATE?>" style="width:50%;" class="form-control" />
								  ...
								  <div class="form-group row m-0">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									  <select name="INCREMENT_TYPE" id="INCREMENT_TYPE"  >
										<option><?=$inc_info->INCREMENT_TYPE?></option>
										<option></option>
										<option value="Confirmation" <?= ($_POST['INCREMENT_TYPE'] == 'Confirmation') ? 'selected' : ''; ?>>Confirmation</option>
										<option value="Confirmation and Promotion" <?= ($_POST['INCREMENT_TYPE'] == 'Confirmation and Promotion') ? 'selected' : ''; ?>>Confirmation and Promotion</option>
										<option value="Merit Increment" <?= ($_POST['INCREMENT_TYPE'] == 'Merit Increment') ? 'selected' : ''; ?>>Merit Increment</option>
										<option value="Promotion" <?= ($_POST['INCREMENT_TYPE'] == 'Promotion') ? 'selected' : ''; ?>>Promotion</option>
										<option value="Transfer" <?= ($_POST['INCREMENT_TYPE'] == 'Transfer') ? 'selected' : ''; ?>>Transfer</option>
										<option value="Salary re-fixation" <?= ($_POST['INCREMENT_TYPE'] == 'Salary re-fixation') ? 'selected' : ''; ?>>Salary re-fixation</option>
									  </select>
									</div>
								  </div>
								</div>
								<div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
								  <div class="form-group row m-0">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									  <input type="text" name="score" autocomplete="off" value="<?=$inc_info->score?>" id="score" style="width:50%;" class="form-control" />
								...
								<div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
								  <div class="form-group row m-0">
									...
									<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
									  <input type="text" name="INCREMENT_AMT" value="<?=$inc_info->INCREMENT_AMT?>" autocomplete="off" id="INCREMENT_AMT" oninput="calculateSalary()" style="width:50%;" class="form-control" />
								...
								<div class="col-sm-2 col-md-2 col-lg-2 col-xl-2">
								  ...
								  <input name="update" id="update" value="Update" type="submit" class="btn1 btn1-bg-cancel">
								</div>
							  </div>
    </div>
...
<input type="hidden" id="designation" name="designation" value="<?php echo find_a_field('personnel_basic_info','DESG_ID','PBI_ID='.$_SESSION['employee_selected']); ?>">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select  id="PBI_ORG_OLD" class="form-control" name="PBI_ORG_OLD" >
                                            <?php foreign_relation('user_group','id','group_name',$PBI_ORG_OLD,' id='.$all->PBI_ORG); ?>
                                          </select>
                                        </div>
                                      </div>
          ...
          <div class="container n-form2">
                ...
                <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
										  ...
										  <option selected="selected">
                                            <? foreign_relation('user_group','id','group_name',$inc_info->PBI_ORG_NEW,' 1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="PBI_FUNCTION_NEW" id="PBI_FUNCTION_NEW" class="form-control">
                                            <option selected="selected">
                                            <? foreign_relation('hrm_function','id','function_name',$inc_info->PBI_FUNCTION_NEW, '1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="cost_center_new" id="cost_center_new" class="form-control">
                                            <option selected="selected">
                                            <? foreign_relation('hrm_cost_center','id','center_name',$inc_info->cost_center_new,'1');?>
                                          </select>
                                        </div>
                                      </div>
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="DEPT_ID_NEW" id="DEPT_ID_NEW" class="form-control">
                                             <option selected="selected">
                                            <? foreign_relation('department','DEPT_ID','DEPT_DESC',$inc_info->DEPT_ID_NEW,'1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="section_new" id="section_new" class="form-control" >
                                            <option selected="selected">
                                            <? foreign_relation('PBI_Section','sec_id','sec_name',$inc_info->section_new,' 1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="DESG_ID_NEW" id="DESG_ID_NEW" class="form-control">
                                           <option selected="selected">
                                            <? foreign_relation('designation','DESG_ID','DESG_DESC',$inc_info->DESG_ID_NEW,'1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="grade_new" id="grade_new" class="form-control" >
                                            <option selected="selected">
                                            <? foreign_relation('hrm_grade','id','grade_name',$inc_info->grade_new,' 1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        <label for="salary_schedule" class="col-sm-4 req-input col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Salary Schedule : </label>
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="salary_schedule_new" id="salary_schedule_new" class="form-control">
                                           <option selected="selected">
                                            <? foreign_relation('salary_schedule','id','schedule_name',$inc_info->salary_schedule_new,' 1');?>
                                          </select>
                                        </div>
                                      </div>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="class_new" id="class_new" class="form-control" >
                                            <option selected="selected">
                                            <? foreign_relation('hrm_class','id','class_name',$inc_info->class_new,' 1');?>
                                          </select>
                                        </div>
                                      </div>
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="JOB_LOC_ID_NEW" id="JOB_LOC_ID_NEW" class="form-control">
                                            <option selected="selected">
                                            <? foreign_relation('project','PROJECT_ID','PROJECT_DESC',$inc_info->JOB_LOC_ID_NEW,' 1'); ?>
                                          </select>
                                        </div>
                                      </div>
                ...
                <label for="gross_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Gross Salary : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input type="text" id="grossSalary_new" name="grossSalary_new"  value="<?=$inc_info->grossSalary_new?>">
                </div></div>
                                    
                <div class="form-group row m-0 pb-1">
                <label for="basic_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Basic Salary : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input type="text" id="new_basic_salary" name="new_basic_salary" value="<?=$inc_info->new_basic_salary?>">
                </div>
                </div> 
                ...
                <label for="basic_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> House Rent : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input type="text" id="new_house_rent" name="new_house_rent" value="<?=$inc_info->new_house_rent?>">
                </div>
                </div> 
                ...
                <label for="basic_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Medical Allowance  : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input type="text" id="new_medical_allowance" name="new_medical_allowance" value="<?=$inc_info->new_medical_allowance?>">
                </div>
                </div> 
                ...
                <label for="basic_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Conveyance Allowance : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                <input type="text" id="new_convenience" name="new_convenience" value="<?=$inc_info->new_convenience?>">
                </div>
                </div> 
                ...
                <label for="basic_salary" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Food Allowance : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                 <input type="text" id="new_food_allowance" name="new_food_allowance" value="<?=$inc_info->new_food_allowance?>">
                </div>
                </div> 
                <div class="form-group row m-0 pb-1">
				...
				<label for="special_allowance" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Special Allowance : </label>
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 p-0 pr-2 ">
                <input name="new_special_allowance" type="text" id="new_special_allowance" class="form-control"  value="<?=$inc_info->new_special_allowance?>" />
                </div>
                ...
                <select name="special_status_new" type="text" id="special_status_new" class="form-control" >
					<option></option>
					<option value="1" <?= ($special_status_new == 1) ? 'selected' : ''; ?>>With Salary</option>
					<option value="0" <?= ($special_status_new == 0) ? 'selected' : ''; ?>>Without Salary</option>
				</select>
                </div>
                </div>
				...
				<label for="special_allowance" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Technical Allowance : </label>
                <div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 p-0 pr-2 ">
               <input name="technical_new" type="text" id="technical_new" class="form-control"  value="<?=$inc_info->technical_new?>" />
                </div>
