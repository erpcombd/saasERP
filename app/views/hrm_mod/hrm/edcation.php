...
$table='hrm_education_detail';		// Database Table Name Mainly related to this page
...
<script type="text/javascript"> function DoNav(lk){
    ...
    <form  action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            <? $res='select '.$unique.',EDUCATION_NOE as Exam, EDUCATION_NOI as Institute_Name, EDUCATION_TOTAL_MARK as Mark, EDUCATION_GRADE_CLASS as Grade_Class from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
