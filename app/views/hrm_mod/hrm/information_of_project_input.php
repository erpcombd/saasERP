        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td colspan="1" class="oe_form_group_cell" width="50%"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody>
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" width="43%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Name of Projeect :</td>
                  <td bgcolor="#E8E8E8" width="57%" colspan="1" class="oe_form_group_cell">
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell"><input name="PS_DOJ" type="text" id="PS_DOJ" value="<?=$PS_DOJ?>" /></td>
                      ...
                      <tr class="oe_form_group_row">
                        <td bgcolor="#E8E8E8" width="42%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">Duration: </td>
                <td bgcolor="#E8E8E8" width="58%" colspan="1" class="oe_form_group_cell"><input name="PS_DURATION" type="text" id="PS_DURATION" value="<?=$PS_DURATION?>" /></td>
                      </tr>
                      <tr class="oe_form_group_row">
