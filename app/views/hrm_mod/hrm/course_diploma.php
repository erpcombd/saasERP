...
<script type="text/javascript"> function DoNav(lk){
    ...
    <form  action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid pt-5 p-0 ">
            ...
            $res='select '.$unique.',CD_NOCD as Name_of_CD, CD_SUBJECT as Subject, CD_NOI as Institute_Name, CD_DURATION as Duration from '.$table.' where PBI_ID='.$employee_selected .'';
