...
<div class="oe_form_sheetbg">
        <div class="oe_form_sheet oe_form_sheet_width">
          ...
          <? 	$res='select '.$unique.',APR_YEAR as Year, APR_MARKS as marks,APR_RECOMMENDATION as Recommend, APR_STATUS as Status, APR_RESULT as Result from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
