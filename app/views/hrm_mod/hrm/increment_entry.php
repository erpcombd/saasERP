...
<script type="text/javascript"> function DoNav(lk){
    ...
    <form  action="" method="post" enctype="multipart/form-data">
        ...
        <div class="container-fluid pt-5 p-0 ">
				<?   $res='select '.$unique.',INCREMENT_D_ID as id,INCREMENT_TYPE as Type,  INCREMENT_EFFECT_DATE as Date,
		  
new_basic_salary as new_basic,past_basic_salary as old_basic

 from '.$table.' where PBI_ID='.$_SESSION['employee_selected'];
