  ...
  <div class="oe_view_manager oe_view_manager_current">
    <div class="oe_view_manager_body">
      ...
      <div class="oe_view_manager_view_form">
		...
		$point_2 = $rosterAllocation->point_2 ;
		$shedule_2 = $rosterAllocation->shedule_2 ;
		?>
...
<? foreign_relation('hrm_roster_point','id','point_short_name',$point_1,'group_for = "'.$_POST['group_for'].'"');?>
                                          ...
                                          <select name="point_2_<?=$info->PBI_ID?>" id="point_2_<?=$info->PBI_ID?>" style="display:none">
                                            <? foreign_relation('hrm_roster_point','id','concat(point_short_name," [",point_code,"]")',$point_2);?>
                                          </select>
                                        </span></td>
                                        <td><span class="oe_form_group_cell">
