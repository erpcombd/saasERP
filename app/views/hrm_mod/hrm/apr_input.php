        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td class="oe_form_group_cell"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0">
              <tbody>
                ...
                <tr class="oe_form_group_row">
                  <td bgcolor="#E8E8E8" width="1%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Year :</td>
                  <td bgcolor="#E8E8E8" width="49%" colspan="1" class="oe_form_group_cell">
                  ...
                  <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Marks :</td>
                ...
                <tr class="oe_form_group_row">
                  <td colspan="4" bgcolor="#FF99CC" class="oe_form_group_cell"><strong>APR Final Decision:</strong></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Designation From :</span></td>
                  <td class="oe_form_group_cell"><select name="APR_DESG_FROM">
                    <? foreign_relation('designation','DESG_SHORT_NAME','DESG_DESC',$APR_DESG_FROM);?>
                  </select></td>
                  <td class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Result :</span></td>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="APR_DESG_TO">
                    <? foreign_relation('designation','DESG_SHORT_NAME','DESG_DESC',$APR_DESG_TO);?>
                  </select></td>
