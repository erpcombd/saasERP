            ...
            <td colspan="1" class="oe_form_group_cell" width="50%"><table width="1155" height="288" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
              <tbody>
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell"><table border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
                    <tbody>
                        <tr class="oe_form_group_row">
                          <td width="35%" height="33" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Posting Name :</td>
                          <td bgcolor="#E8E8E8" width="65%" colspan="1" class="oe_form_group_cell"><input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />
                            <input name="POSTING_NAME" type="text" id="POSTING_NAME" value="<?=$POSTING_NAME?>" /></td>
                        </tr>
                        <tr class="oe_form_group_row">
                        ...
                        <tr class="oe_form_group_row">
                          <td height="28" colspan="1" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Domain :</td>
                          <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell"><select name="POSTING_DOMAIN" id="POSTING_DOMAIN">
