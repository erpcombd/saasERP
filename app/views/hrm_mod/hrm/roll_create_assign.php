...
<form action="" method="post" enctype="multipart/form-data">
  ...
  <div class="container-fluid">
            ...
            <div class="col-sm-6">
              ...
              <div class="form-group row m-0 mb-1 pl-3 pr-3">
                ...
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
                  ...
                  <!--                           <input type="text" name="PBI_ID" id="PBI_ID" value="-->
                  <?//=$PBI_ID=$_GET['user_id'];?>
                  <!--"  class="form-control"/>-->
                </div>
              </div>
    ...
    <div class="oe_form_sheet oe_form_sheet_width">
      <?php /*?><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0">
...
<? }?>
  ...
  $module_name=$mod['module_name'];
   ...
   ?>
          ...
          <li class="active ml-1 mr-1 mt-3"><a href="roll_create_assign.php?user_id=<?php echo $user_id; ?>&module_id=<?php echo $module_id; ?> " class="btn1 btn1-bg-submit" >
            <?=$module_name;?>
            </a></li>
          <?php } else { ?>
          <li class="active ml-1 mr-1 mt-3"><a href="roll_create_assign.php?user_id=<?php echo $user_id; ?>&module_id=<?php echo $module_id; ?>  " class="btn1 btn1-bg-hrm" >
            <?=$module_name;?>
            </a></li>
          <?php }} ?>
        </ul>
        <br>
        <br>
        <span onclick="selectedAll()" class="btn" style="color:#242020;background-color:#80c4c7;border-color:#408d99;margin-bottom:12px;">CHECK ALL</span> </div>
...
if($counts>0){
          ...
          <table class="table1  table-striped table-bordered table-hover table-sm" border="0" cellspacing="0" cellpadding="0">
            <thead class="thead1">
              <tr class="bgc-info">
                <th> <?=$info->feature_name?>
                  </td>
                <th width="8%" ><div align="center"><span class="style3">Access</span></div>
                  </td>
                <th width="8%" ><div align="center"><span class="style3">Add</span></div>
                  </td>
                <th width="8%"><div align="center"><span class="style3">Edit</span></div>
                  </td>
                <th width="8%" ><div align="center"><span class="style3">Delete</span></div>
                  </td>
                <th width="8%" >&nbsp;
                  </td>
              </tr>
...
?>
              <tr  <? if((++$i%2)==0) echo 'bgcolor="#99FFCC"'; else echo 'bgcolor="#C1F0FF"';?>>
                ...
                <td valign="middle"><div align="center">
                    ...
                    <input type="checkbox"  name="add<?=$infos->id?>" id="add<?=$infos->id?>" value="1"  <?=($find->add>0)?'checked="checked";':'';?>/>
                  </div></td>
                <td valign="middle"><div align="center">
                    <input type="checkbox"  name="edit<?=$infos->id?>" id="edit<?=$infos->id?>" value="1" <?=($find->edit>0)?'checked="checked";':'';?>/>
                  </div></td>
                <td valign="middle"><div align="center">
                    <input type="checkbox"  name="delete<?=$infos->id?>" id="delete<?=$infos->id?>" value="1"  <?=($find->delete>0)?'checked="checked";':'';?>/>
                  </div></td>
                <td valign="middle"><label>
                  <div id="pv<?=$infos->id?>">
                    <input type="button" name="Submit" value="OK" class="btn1 btn1-bg-submit" onclick="access_update(<?=$infos->id?>)" />
                  </div>
                  <span class="btn1 btn-primary" onclick="select_all(<?=$infos->id?>)">Select All</span> <span class="btn1 btn-danger" onclick="remove_all(<?=$infos->id?>)">Remove All</span>
                  </label></td>
              </tr>
              <? }?>
            </tbody>
        ...
        <br>
        <span class="btn btn-warning" onclick="updatingAll()">UPDATE</span> </div>
    </div>
  </div>
</form>
