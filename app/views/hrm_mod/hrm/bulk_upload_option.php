	...
	if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["grace"]) &&$_POST['grace_date']!='') {
		...
		$out_grace_time=($_POST['out_grace_time']);
          ...
          foreach ( $display as $key  ) {
			 ...
			 $sql='update hrm_att_summary set manual_in_grace="'.$in_grace_time.'" , manual_out_grace="'.$out_grace_time.'"
   ...
   <div class="padding"> 
    <div class="row">
      <div class="col-lg-12">
          ...
          <div class="card" >
            <div class="card-header" style="background-color: #D8F6C8;"><strong> Time Grace</strong></div>
            <div class="card-body" style="background-color: #D8F6C8;">
