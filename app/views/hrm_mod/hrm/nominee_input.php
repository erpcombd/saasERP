        ...
        <a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
            ...
            <td class="oe_form_group_cell"><table class="oe_form_group " border="0" cellpadding="0" cellspacing="0"><tbody>
                ...
                <tr class="oe_form_group_row">
                  ...
                  <td colspan="2" rowspan="2" align="center" class="oe_form_group_cell oe_form_group_cell_label"><img src="../../pic/nominnee/<?=$_SESSION['employee_selected']?>.jpg" width="105" height="90" border="1" /></td>
                </tr>
                <tr class="oe_form_group_row">
