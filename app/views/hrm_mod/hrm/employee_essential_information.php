...
<div class="oe_view_manager oe_view_manager_current">
        ...
        <div class="oe_form_container"><div class="oe_form">
          <div class="">
                      ...
                      <div class="oe_form_sheetbg">
						...
						<h3 style="text-align:center;font-weight:bold;color:red;"><?=$title?></h3>
   <!--     <h1><label for="oe-field-input-27" title="" class=" oe_form_label oe_align_right">
        <!--<a href="home2.php" rel = "gb_page_center[940, 600]"><?=$title?></a>
		  ...
		  <table width="1050" border="0" cellpadding="0" cellspacing="0" class="oe_form_group " style="border:5px solid #0270b9;">
                  ...
                  <td class="oe_form_group_cell"><table width="100%" height="279" border="0" cellpadding="0" cellspacing="0" class="oe_form_group ">
                    <tbody>
                        <tr class="oe_form_group_row">
                          ...
                          <td width="15%" colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>&nbsp;&nbsp;Bank Name :</label></td>
                          ...
                          <input name="PBI_ID" id="PBI_ID" value="<?=$_SESSION['employee_selected']?>" type="hidden" />
                            <select name="ESSENTIAL_BANK_NAME">
							  ...
							  <td width="10%"  class="oe_form_group_cell"></td>
                          <td width="15%" class="oe_form_group_cell"><span class="oe_form_group_cell oe_form_group_cell_label">Bank List :</span></td>
                          <td width="20%" class="oe_form_group_cell"><input name="bank" type="text" id="bank" value="<?=$bank?>" /></td>
                        </tr>
                        <tr class="oe_form_group_row">
                          ...
                          <input name="ESSENTIAL_BRANCH" type="text" id="ESSENTIAL_BRANCH" value="<?=$ESSENTIAL_BRANCH?>" /></td>
						   <td width="15px"  class="oe_form_group_cell"></td>
                       ...
                       <tr class="oe_form_group_row">
                        ...
                        <tr class="oe_form_group_row">
                          <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;National ID :</td>
                          <td class="oe_form_group_cell"><input name="ESSENTIAL_VOTER_ID" type="text" id="ESSENTIAL_VOTER_ID" value="<?=$ESSENTIAL_VOTER_ID?>" /></td>
						  <td width="22px"  class="oe_form_group_cell"></td>
                        ...
                        <tr class="oe_form_group_row">
                          <td bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;&nbsp;Type of License :</td>
                          <td bgcolor="#E8E8E8" class="oe_form_group_cell"><select name="ESSENTIAL_TYPE_OF_LICENSE">
                            <option selected="selected">
                        ...
                        <tr class="oe_form_group_row">
                          <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Driving License # :</td>
                          <td class="oe_form_group_cell">
<input name="ESSENTIAL_DRIVING_LICENSE_NO" type="text" id="ESSENTIAL_DRIVING_LICENSE_NO" value="<?=$ESSENTIAL_DRIVING_LICENSE_NO?>" />
                          </td>
						  <td width="15px"  class="oe_form_group_cell"></td>
