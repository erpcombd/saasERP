...
$_SESSION['employee_selected'] = $_GET['asign_id']; //$_POST['employee_selected'];
}
...
$required_id=find_a_field($table,$unique,'PBI_ID='.$_GET['asign_id']);
                      ...
                      <div class="card-body">
                        <div class="row ">
                          ...
                          <div class="col-md-3 form-group">
                            <label class="label req-input" for="PBI_NAME">Full Name : </label>
...
value="<?=$PBI_SERVICE_LENGTH?>" readonly="readonly">
                          ...
                          <div class="col-md-3 form-group">
							  ...
							  <input name="PBI_DOJ" type="date" id="PBI_DOJ" value="<?=$PBI_DOJ?>" class="form-control" onchange="calculateDuration()" />
							</div>

							<div class="col-md-3 form-group">
							  <label class="label req-input" for="PBI_DOC2">Confirm Date :</label>
							  <input name="PBI_DOC2" type="date" id="PBI_DOC2" value="<?=$PBI_DOC2?>" class="form-control" onchange="calculateDuration()" />
							</div>
						...
						<div class="col-md-3 form-group">
							...
							<div class="col-md-3 form-group">
							  ...
							  <input name="PBI_DURATION" type="text" id="PBI_DURATION" class="form-control" readonly />
							</div>
						...
						<div class="col-md-2 form-group">
                          ...
                          <div class="col-md-2 form-group">
                            ...
                            <select name="PBI_JOB_STATUS" class="form-control">
                              <option <?=($PBI_JOB_STATUS=='On Board')?'selected':'';?>>On Board</option>
