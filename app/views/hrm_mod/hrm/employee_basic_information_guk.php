...
$_POST['PBI_SERVICE_LENGTH'] = $service_length;
 ...
 if (empty($last_id) && isset($_POST['define_schedule']) && isset($_POST['PBI_DOJ'])) {
   $att_sql = "INSERT INTO hrm_roster_assign (PBI_ID,roster_start_date,roster_end_date,shedule_1,entry_by) 
        VALUES ('".$_SESSION['employee_selected']."','".$_POST['PBI_DOJ']."', '2030-10-31' , '".$_POST['define_schedule']."','$entry_by')";
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                      <div class="container new-bg-color">
                                        ...
                                        <div class="form-group row m-0 pb-1">
                                          ...
                                          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                            <input name="PBI_DOB" type="date" required="required" id="birthdate" value="<?=$PBI_DOB?>" class="form-control"  autocomplete="off" onChange="calculateAge()"/>
                                          </div>
                                        </div>
                                        <div class="form-group row m-0 pb-1">
                                      ...
                                      <div class="container new-bg-color">
                                        ...
                                        <div class="container-fluid p-0">
                                          ...
                                          <div class="mx-auto col-md-4">
                                            ...
                                            <? }else{ ?>
                                            <img src="../../pic/employee.png" width="150px" height="160"/>
                                            <? } ?>
                                          </div>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="container new-bg-color">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="PBI_FUNCTION" id="PBI_FUNCTION" class="form-control" required="required">
                                            <option selected="selected">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="cost_center" id="cost_center" class="form-control" required="required">
                                            <option selected="selected">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="JOB_LOC_ID" id="JOB_LOC_ID"  class="form-control" required="required" >
                                            <option></option>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="DESG_ID" id="DESG_ID" class="form-control" required="required">
                                            <option></option>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="salary_schedule" id="salary_schedule" class="form-control" required="required">
                                            <option selected="selected">
                                  ...
                                  <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="container new-bg-color">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <input name="PBI_DOJ" type="date" id="joiningdate" required="required"  value="<?=$PBI_DOJ?>" class="form-control" autocomplete="off" onChange="calculateAge()"/>
                                        </div>
                                      </div>
                                      <div class="form-group row m-0 pb-1">
                                      ...
                                      <table align="center" class="table table-bordered table-sm">
                                        ...
                                        <tbody>
                                          <tr>
                                            ...
                                            <td><select class="status-dropdown form-control" name="Friday" id="Friday" required="required">
                                                <option></option>
                                                <option selected="selected">
                                                <?=$Friday?>
                                                </option>
                            ...
                            <select name="LEAVE_RULE_ID" id="LEAVE_RULE_ID" class="form-control">
                              ...
                              <option <?=($LEAVE_RULE_ID==1)? 'selected' : '' ?> value="1">General</option>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="define_schedule" id="define_schedule" class="form-control" required="required">
                                            <option></option>
