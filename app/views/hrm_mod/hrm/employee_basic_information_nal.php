...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    <div id="customPopup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); 
            padding: 20px; background: #ffffff; border-radius: 8px; border: 1px solid #ddd; 
            box-shadow: 0px 8px 16px rgba(0, 0, 0, 0.2); font-family: Arial, sans-serif; z-index: 9999; text-align: center; width: 400px;">
       <h1 style="color: #333; font-size: 32px; font-weight: bold; margin-bottom: 20px; text-transform: uppercase;">Employee Info</h1>

        <p style="color: #007BFF; font-size: 24px; margin: 8px 0;"><strong>EMP ID:</strong> ' . htmlspecialchars($_POST['PBI_CODE'], ENT_QUOTES) . '</p>
       
        <p style="color: #DC3545; font-size: 24px; margin: 8px 0;"><strong>EMP Name:</strong> ' . htmlspecialchars($_POST['PBI_NAME'], ENT_QUOTES) . '</p>
        <button onclick="closePopup()" 
                style="margin-top: 20px; padding: 10px 20px; background: #007BFF; color: #fff; border: none; 
                cursor: pointer; border-radius: 5px; font-size: 16px; transition: background 0.3s;">
            Close
        </button>
    </div>
    <script>
...
<form action="" method="post" enctype="multipart/form-data">
  <div class="oe_view_manager oe_view_manager_current">
    ...
    <div class="oe_view_manager_body mt-4">
 ...
 <li class="nav-item"><a class="nav-link" href="../salary_config/salary_information.php" style="color:#333;font-weight:bold"> <i class="fa-regular fa-folder-open"></i> SALARY </a> </li>
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="container new-bg-color">
                                        <div class="form-group row m-0 pb-1">
                                          ...
                                          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                            ...
                                            <input   name="PBI_CODE" type="text" id="PBI_CODE"  
                                            value="<?=$PBI_CODE;?>" />
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-6">
                                      <div class="container new-bg-color">
                                        ...
                                        <div class="form-group row m-0 pb-1">
                                          <label for="PBI_PHONE" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Personal Number: </label>
                                          <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                        ...
                                        <div class="container-fluid p-0">
                                          ...
                                          <div class="mx-auto col-md-4">
                                            ...
                                            <? }else{ ?>
                                            <img src="<?=SERVER_CORE?>core/hrm_def.png" width="150px" height="160"/>
                                            <? } ?>
                                          </div>
                                        </div>
                                      </div>
							...
							<?*/ ?>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-6">
                                  <div class="container new-bg-color">
                                    ...
                                    <div class="form-group row m-0 pb-1">
                                    	<label for="PBI_MOBILE" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text req-input">Office Number  : </label>
                                    	<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                    ...
                                    <div class="container-fluid p-0">
                                      ...
                                      <div class="mx-auto col-md-4">
                                        ...
                                        <? }else{ ?>
                                        <img src="<?=SERVER_CORE?>core/default.png" width="150px" height=""/>
                                        <? } ?>
                                      </div>
                                    </div>
                                    <!--<div class="form-group row m-0 pb-1">-->
                                  ...
                                  <div class="card-body new-color">
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-md-4 form-group">
                                       ...
                                       <div class="col-md-4 form-group">
                                       <label class="label" for="PBI_PRESENT_DISTRICT">District :</label>
										<select name="pre_district" id="pre_district" class="form-control" onchange="getData2('ajax_thana.php', 'pre_ps',this.value,this.value);">
											<option ></option>
											<? foreign_relation('uploadpost','district','district',$pre_district,' 1 group by district order by district');?>
										</select>
                                      </div> 
                                      ...
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="PBI_PRESENT_POLICE">Police Station :</label>
										<span id="pre_ps">
										<select name="pre_ps" id="pre_ps" class="form-control" onchange="getData2('ajax_post.php', 'post_office', this.value);">

											<option ></option>
											<? foreign_relation('uploadpost','thana','thana',$pre_ps,' 1 and  district like "'.$pre_district.'" group by thana order by thana');?>
										</select>
                                      ...
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="PBI_PRESENT_PO">Post Office  :</label>
										<span id="post_office">
											
                											<select name="post_office" id="post_office" class="form-control" onchange="getData2('ajax_post_code.php', 
                											'post_code', this.value,this.value);">
                    <option value=""></option>
                    <?php foreign_relation('uploadpost', 'post', 'post', $post_office, '1 AND thana LIKE "' . $pre_ps . '" ORDER BY post'); ?>
                </select>

										</span>
                                      </div>
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="post_code">Postal Code :</label>
                                  ...
                                  <div class="card-body new-color">
                                    ...
                                    <div class="form-row">
                                      ...
                                      <div class="col-md-4 form-group">
                                        ...
                                        <div class="col-md-4 form-group">
                                        <label class="label" for="PBI_PER_DISTRICT">District :</label>
									<select name="pre_district2" id="pre_district2" class="form-control" onchange="getData2('ajax_per_thana.php', 'PBI_per_thana',this.value,this.value);">
						<option ></option>
						<? foreign_relation('uploadpost','district','district',$PBI_PER_DISTRICT,' 1 group by district order by district');?>
					</select>
                                      </div> 
                                      
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="PBI_PER_POLICE">Police Station :</label>
										<span id="PBI_per_thana">
										<select name="pre_ps2" id="pre_ps2" class="form-control" onchange="getData2('ajax_per_post.php', 'PBI_per_post',this.value,this.value);">
								<option ></option>
									
									
									<? foreign_relation('uploadpost','thana','thana',$pre_ps2,'  1 and  district like "'.$pre_district2.'" group by thana order by thana');?>
								</select>  
                                      ...
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="PBI_PER_PO">Post Office  :</label>
										<span id="PBI_per_post">
											<select name="pr_post_office" id="pr_post_office" class="form-control" onchange="getData2('ajax_per_post_code.php', 'PBI_per_postCode',this.value,this.value);">
											<option ></option>
												<? foreign_relation('uploadpost','post','post',$pr_post_office,'  1 and thana like "'.$pre_ps2.'"group by post order by post');?>
											</select>
										</span>
                                      </div>
									  
                                      <div class="col-md-4 form-group">
                                        <label class="label" for="post_code2">Postal Code :</label>
										 <span id="PBI_per_postCode">
											<input name="post_code2" type="text" id="post_code2" class="form-control" value="<?=$post_code2?>"/>
										</span>
                                      </div>
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="DEPT_ID" id="DEPT_ID" class="form-control" >
                                            ...
                                            <? foreign_relation('department','DEPT_ID','DEPT_DESC',$DEPT_ID,' 1 order by DEPT_DESC');?>
                                                                 ...
                                                                 <div class="form-group row m-0 pb-1">
    <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 req-input d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Division :</label>
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">

        <select name="division_id" id="division_id" onchange="test(this)" class="form-control" >
            <option value=""></option>
            <?php foreign_relation('division', 'division_CODE', 'division_name', $division_id, ' 1 order by division_name'); ?>
        </select>
    </div>
</div>
     <script>
function test(el){
    var division_id = $(el).val();  // now it gets the correct value
...
<!-- Region -->
<div class="form-group row m-0 pb-1">
    <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 req-input d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Region :</label>
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
        <select name="region_id" id="region_id" onchange="test1(this)"class="form-control">
            <option value=""></option>
			  <?php foreign_relation('branch', 'BRANCH_ID', 'BRANCH_NAME', $region_id, ' division_id="'.$division_id.'" order by BRANCH_NAME'); ?>
        </select>
    </div>
</div>
 <script>
function test1(el){
    ...
    var region_id = $(el).val();  // now it gets the correct value
    $("#area_id").html('<option value="">Select Region</option>');
    ...
    if(division_id !== '') {
        $.ajax({
            ...
            error: function(){
                $("#area_id").html('<option value="">Error Loading Regions</option>');
            }
        });
    }
}
...
<!-- Area -->
<div class="form-group row m-0 pb-1">
    <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 req-input d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Area :</label>
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
        <select name="area_id" id="area_id"  onchange="test2(this)"class="form-control">
            <option value=""></option>
			  <?php foreign_relation('area', 'AREA_CODE', 'AREA_NAME', $area_id, ' Branch_CODE="'.$region_id.'" order by AREA_NAME'); ?>
        </select>
    </div>
</div>
 <script>
function test2(el){
    ...
    if(area_id !== '') {
        $.ajax({
            ...
            error: function(){
                $("#zone_id").html('<option value="">Error Loading Zone</option>');
            }
        });
    } else {
        $("#zone_id").html('<option value="">Select Area First</option>');
    }
}
</script>
<!-- Zone -->
<div class="form-group row m-0 pb-1">
    <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 req-input d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Zone :</label>
    <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
        <select name="zone_id" id="zone_id" class="form-control">
            <option value=""></option>
			 <?php foreign_relation('zon', 'ZONE_CODE ', 'ZONE_NAME ', $zone_id, ' Area_ID="'.$area_id.'" order by ZONE_NAME'); ?>
        </select>
    </div>
</div>
                                  ...
                                  <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="container new-bg-color">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <input name="PBI_DURATION" type="number" id="monthNumber" value="<?=$PBI_DURATION?>"  class="form-control"  />
                                        </div>
                                      </div>
                                      <div class="form-group row m-0 pb-1">
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <select name="JOB_LOC_ID" id="JOB_LOC_ID"  class="form-control"  >
                                            <option></option>
                                            <? foreign_relation('crm_project_org','id','name',$JOB_LOC_ID);?>
                                          </select>
                                        </div>
                                      </div>
                                  ...
                                  <div class="col-sm-6 col-md-6 col-lg-6">
                                    <div class="container new-bg-color">
                                      <div class="form-group row m-0 pb-1">
                                        ...
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                          <input name="resign_date"  id="resign_date" value="<?=$resign_date?>" autocomplete="off" class="form-control"/>
                                        </div>
                                      </div>
                                      <div class="form-group row m-0 pb-1">
                            ...
                            <select name="LEAVE_RULE_ID" id="LEAVE_RULE_ID" class="form-control">
                              ...
                              <option <?=($LEAVE_RULE_ID==1)? 'selected' : '' ?> value="1">General</option>
                                      ...
                                      <div class="form-group row m-0 pb-1">
                                       ...
                                       <div class="form-group row m-0 pb-1">
                                        <label for="define_schedule" class="col-sm-4 col-md-4 req-input col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text">Roster Type : </label>
                                        <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                                         <select name="employee_type" id="employee_type" class="form-control" >
										...
										<? foreign_relation('hrm_employee_type','id','employee_type',$employee_type,'1'); ?>
