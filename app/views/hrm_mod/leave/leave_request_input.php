...
// ::::: End Edit Section :::::
//echo $_SESSION['employee_selected'];
...
$_REQUEST['leave_status'] = "Dept. Head Unapproved";
			...
			<table width="100%" border="0" cellpadding="2" cellspacing="0" class="oe_form_group ">
              <tbody>
                ...
                <tr class="oe_form_group_row">
				  ...
				  <input name="first_name_bangla" type="text" id="first_name_bangla" value="<?=$PBI->PBI_NAME?>"  style="width:420px;"/>                  </td>
                  </tr>
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label"><label>&nbsp;&nbsp;Department :</label></td>
                  <td class="oe_form_group_cell"><input name="department" type="text" id="department" value="<?=$PBI->PBI_DEPARTMENT?>" /></td>
...
<select name="type" id="type">
				 <option <?=($type=='Annual')?'Selected':'';?> >Annual</option>
				  ...
				  <!--<option <?=($type=='Compensatory Off')?'Selected':'';?> >Compensatory Off</option>-->
				  <option <?=($type=='LWP (Leave Without Pay)')?'Selected':'';?> >LWP (Leave Without Pay)</option>
                  ...
                  <td colspan="4" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label"><textarea name="reason" style="width:500px;" required><?=$leave_causes?></textarea></td>
                  </tr>
...
<input name="total_days" type="hidden" id="total_days"  value="<?php if($total_days>0) echo date('d-m-Y',strtotime($total_days)); ?>" /> 
&nbsp;&nbsp;<b id="total_leave"> Total<? if($s_date!=''){$diff = date_diff(date_create($s_date),date_create($e_date)); echo $diff->format("%a")+1;?> Days <? }?></b></td>
                    </tr>
                  </table></td>
                </tr>
                <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;</td>
                  <td class="oe_form_group_cell" colspan="4">&nbsp;</td>
                  </tr>
				  <tr class="oe_form_group_row">
                  <td  bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Leave Address  : </td>
                  <td  bgcolor="#E8E8E8" class="oe_form_group_cell" colspan="4">
				  <textarea required name="leave_address" style="width:500px"><?=$leave_address?></textarea></td>
				  </tr>
				  <tr class="oe_form_group_row">
                  <td colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Contact No.  : </td>
                  <td class="oe_form_group_cell" colspan="4"><input name="leave_mobile_number" type="text" id="leave_mobile_number" value="<?=$leave_mobile_number?>" required/></td>
                  </tr>
				  <tr class="oe_form_group_row">
                  <td  bgcolor="#E8E8E8" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Authorised Person  : </td>
                  <td  bgcolor="#E8E8E8" class="oe_form_group_cell" colspan="4">
				  <input name="leave_responsibility_name" type="hidden" id="leave_responsibility_name" value="<?=$PBI->incharge_id?>"/>
				  <?=find_a_field('personnel_basic_info','concat(PBI_NAME," :: ",PBI_ID)',' PBI_JOB_STATUS="In Service"  and PBI_ID ='.$PBI->incharge_id)?>				  </td></tr>
                </tbody></table>
            </td>
            </tr>
