...
if($_REQUEST['s_date']!=''){
$d_con= " and o.s_date<='".$e_date."' and o.e_date>='".$s_date."' ";}
}
...

{
	...
	window.open('detail_leave_report_2016.php?PBI_ID='+theUrl);
...
(select sum(total_days) from hrm_leave_info  where type='Casual Leave' and PBI_ID=o.PBI_ID ".$d_con.") as Casual,
(select sum(total_days) from hrm_leave_info  where type='Sick Leave' and PBI_ID=o.PBI_ID ".$d_con.") as Sick,
(select sum(total_days) from hrm_leave_info  where type='Annual' and PBI_ID=o.PBI_ID ".$d_con.") as Annual,
(select sum(total_days) from hrm_leave_info  where type='Maternity Leave' and PBI_ID=o.PBI_ID ".$d_con.") as Maternity,
(select sum(total_days) from hrm_leave_info  where type='Compensatory Off' and PBI_ID=o.PBI_ID ".$d_con.") as Compensatory,
(select sum(total_days) from hrm_leave_info  where type='LWP (Leave Without Pay)' and PBI_ID=o.PBI_ID ".$d_con.") as LWP,
