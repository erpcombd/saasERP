...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" eight="790">
  ...
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="9"  bgcolor="#FFFFFF"><h2>Individual Leave Status <?php echo date('Y')?></h2></td>
 ...
 and s_date>='".$g_s_date."' and e_date<='".$g_e_date."'  and o.PBI_ID=".$hrm_leave_info->PBI_ID;
