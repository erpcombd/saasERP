...
if($full_leave->PBI_IN_CHARGE!='')
$_REQUEST['leave_status'] = "VERIFIED by HR";
elseif($full_leave->PBI_IN_CHARGE=='' && $full_leave->PBI_DEPT_HEAD!='')
$_REQUEST['leave_status'] = "VERIFIED by HR";
else
...
$_REQUEST['leave_join_date']= date('Y-m-d',strtotime($_REQUEST['leave_join_date']));
		...
		$msg='Successfully Updated.';
				echo '<script type="text/javascript">parent.parent.document.location.href = "../leave/leave_entry.php?notify=121";</script>';
}
...
parent.parent.document.location.href = "../leave/view_leave_head.php";
</script>';
}
...
{		$condition=$unique."=".$$unique;		$crud->delete($condition);
		unset($$unique);
		echo '<script type="text/javascript">
parent.parent.document.location.href = "../leave/leave_entry.php?notify=12";
</script>';
		$type=1;
              ...
              <tbody>
			   <tr class="oe_form_group_row">
                ...
                <tr class="oe_form_group_row">
				  ...
				  <input name="first_name_bangla" type="text" id="first_name_bangla" value="<?=$row->PBI_NAME?>"  style="width:420px;"/>                  </td>
                  </tr>
                <tr class="oe_form_group_row">
...
<input required name="leave_join_date" type="text" id="leave_join_date" value="<?php  echo $full_leave->leave_join_date; ?>" /></td>
                  ...
                  <td  bgcolor="#E8E8E8" class="oe_form_group_cell" colspan="4">
				   ...
				   <select name="leave_responsibility_name" id="leave_responsibility_name" style="width:420px;" required >
                       <option value=""></option>
<? foreign_relation('personnel_basic_info','PBI_ID','concat(PBI_NAME," :: ",EMP_ID)',$full_leave->leave_responsibility_name,' 1  and PBI_DEPARTMENT="'.$row->PBI_DEPARTMENT.'"   and PBI_ID != '.$_SESSION['user']['id']);?>
                   </select>
                  <tr class="oe_form_group_row">
    ...
    <? if($full_leave->leave_status=="HRM UNCHECKED"){?>
    <span class="oe_form_buttons_edit" style="display: inline;">
      <button style="float:right" name="update" accesskey="S" class="oe_button oe_form_button_save oe_highlight" type="submit"><span class="oe_form_buttons_edit" style="display: inline;">Verified by HR</span></button>
    </span>
    <? }?>
