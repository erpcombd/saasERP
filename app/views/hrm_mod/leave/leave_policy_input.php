...
// ::::: Edit This Section ::::: 
$title='Leave Policy Setup';			// Page Name and Page Title
...
<html style="height: 100%;"><head>
        ...
        <link href="../../../../public/assets/css/css.css" rel="stylesheet"></head>
<body>
        <!--[if lte IE 8]>
   ...
   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Leave Policy Type:</td>
                  ...
                  <input name="rule_name" type="text" id="rule_name" value="<?=$rule_name?>" />
				  </td>
				  
				  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Casual Leave :</span>
				  </td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell">
				
				    <input name="CL" type="text" id="CL" value="<?=$CL?>" />
				...
				<tr class="oe_form_group_row">
   <td bgcolor="#fff" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Sick Leave :</td>
                  <td bgcolor="#fff" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                  <input name="MED" type="text" id="MED" value="<?=$MED?>" />
                  
				  </td>
				  
				  <td bgcolor="#fff" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Annual leave	 :</span>
				  </td>
                  <td bgcolor="#fff" width="25%" class="oe_form_group_cell">
				<input name="ANU" type="text" id="ANU" value="<?=$ANU?>" />
				  </td>
				...
				<tr class="oe_form_group_row">
              <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Marriage Leave (ML)</td>
                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
              <input name="ML" type="text" id="ML" value="<?=$ML?>" />
					  ...
					  <td bgcolor="#fff" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Paternity Leave (PL) :</span>
				  </td>
                  <td bgcolor="#fff" width="25%" class="oe_form_group_cell">
				<input name="PL" type="text" id="PL" value="<?=$ANU?>" />
				  </td>
				...
				<tr class="oe_form_group_row">
              <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Hajj Leave (HL)</td>
                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
              <input name="HL" type="text" id="HL" value="<?=$HL?>" />
				...
				<tr class="oe_form_group_row">
   <td bgcolor="#E8E8E8" width="32%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp; Maternity Leave (MLV) :</td>
                  <td bgcolor="#E8E8E8" width="30%" class="oe_form_group_cell oe_form_group_cell_label">
                 <input name="MTR" type="text" id="MTR" value="<?=$MTR?>" />
				  </td>
				  
				  <td bgcolor="#E8E8E8" width="23%" class="oe_form_group_cell">
				  <span class="oe_form_group_cell oe_form_group_cell_label"></span> Group For : </td>
                  <td bgcolor="#E8E8E8" width="25%" class="oe_form_group_cell"><select name="organization" style="width:160px;" id="organization" required>
