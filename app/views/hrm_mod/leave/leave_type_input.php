...
<body>
   ...
   <td bgcolor="#FFFFFF" width="14%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;Leave Type :</td>

                  <td bgcolor="#FFFFFF" width="27%" class="oe_form_group_cell oe_form_group_cell_label">

                  <input name="<?=$unique?>" id="<?=$unique?>" value="<?=$$unique?>" type="hidden" />

                  <input name="rule_name" type="text" id="rule_name" value="<?=$rule_name?>" /></td>

                </tr><tr class="oe_form_group_row">

   <td bgcolor="#E8E8E8" width="14%" height="33" colspan="1" class="oe_form_group_cell oe_form_group_cell_label">&nbsp;&nbsp;leave Days :</td>

                  <td width="27%" align="center" valign="middle" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
				  CASUAL
				    <input name="CL" type="text" id="CL" value="<?=$CL?>" />
                  </td>
				  
				  <td width="28%" align="center" valign="middle" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
				  MEDICAL
				    <input name="MED" type="text" id="MED" value="<?=$MED?>" />
                  </td>
				  
				  <td width="31%" align="center" valign="middle" bgcolor="#E8E8E8" class="oe_form_group_cell oe_form_group_cell_label">
				  ANNUAL
