...
<div class="oe_view_manager oe_view_manager_current">
  ...
  $res = "select o.id,a.PBI_CODE as ID_NO , a.PBI_NAME as name,
  ...
  (select PBI_NAME from personnel_basic_info where PBI_ID=o.PBI_IN_CHARGE) as Reporting_Supervisor_Name,
  o.incharge_status as reporting_authority 
  
  from personnel_basic_info a,designation c, department d,hrm_leave_info o where a.DESG_ID=c.DESG_ID and a.DEPT_ID=d.DEPT_ID  and a.PBI_ID=o.PBI_ID and o.incharge_status !='Approve' and o.leave_status='Pending'  order by o.s_date desc";
