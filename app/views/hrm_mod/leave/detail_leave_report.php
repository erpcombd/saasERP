...
$g_s_date=date($year_value.'-01-01');
$g_e_date=date($year_value.'-12-31');
  ...
  <tr>
    ...
    <td height="" colspan="5"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          ...
          <td width="1"><img src="<?=SERVER_ROOT?>public/uploads/logo/<?=$_SESSION['proj_id']?>.png" width="200"  style="padding-left:20px;" />
...
<table width="100%" border="1" align="center" cellpadding="0" cellspacing="0" eight="790">
  ...
  <table width="100%" border="1" align="center" cellpadding="0" cellspacing="0">
    ...
    <tr>
      ...
      <td colspan="9"  bgcolor="#FFFFFF"><h2>Individual Leave Status <?php echo $year_value; ?></h2></td>
    ...
    <tr>
      ...
      <td width="53" height="25" align="center" valign="middle"  bgcolor="#FFFFFF"><div align="center"><span class="style4">
		...
		<?=$leave_rule->CL-$leave_days_casual?>
      ...
      <td width="102" height="25" align="center" valign="middle"  bgcolor="#FFFFFF"><div align="center"><span class="style4">
        ...
        <?=$leave_rule->MED-$leave_days_sick?>
...
while ($data=mysqli_fetch_object($sqll)){?>
 ...
 <tr>
      ...
      <td width="102"  bgcolor="#FFFFFF"><div align="center" class="style16"><?=($data->type==2)?$data->total_days:"";?></div></td>
