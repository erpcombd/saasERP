...
$days_mon = date('t',strtotime($salary_dat));
			...
			<div class="n-form1 fo-width pt-4">
				<div class="container-fluid p-0">
					<div class="row">
						...
						<div class="col-sm-6 col-md-6 col-lg-6 col-xl-6">
							<div class="form-group row m-0 mb-1 pl-3 pr-3">
								<label for="group_for" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text">Branch :   </label>
								<div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2">
									<span class="oe_form_group_cell">
