...
<div class="form-container_large">
  ...
  <form action="?"  method="post">
   ...
   <? include('../../common/title_bar_bulk_increment.php');?>
      ...
      <div class="row">
        ...
        <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"> Effective Date : </label>
		  ...
		  <div class="col-sm-3 col-md-3 col-lg-3 col-xl-3">
          <div class="form-group row m-0">
            <label class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-end align-items-center pr-1 bg-form-titel-text"> Amount % : </label>
            <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0">
           
			  
			   <input type="text" name="inc_amount" autocomplete="off" id="inc_amount"  style="width:50%;" class="form-control" />
            </div>
          </div>
        </div>
      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <?
						  ...
						  echo $sql = "select a.PBI_NAME,a.PBI_ID,a.PBI_DESIGNATION,a.PBI_DEPARTMENT,a.JOB_LOC_ID, a.PBI_CODE,
						   a.define_schedule,b.gross_salary
						   
						   
						   from 

							personnel_basic_info a,salary_info b

							where  a.PBI_ID=b.PBI_ID and a.PBI_DOJ < '".$_POST['fdate']."'  
