 ...
 <p class="new-header"><strong> Please fill the information to continue </strong>  </p> 
      <div class="card-body">
	    ...
	    <input type="hidden" id="designation" name="designation" value="<?=find_a_field('personnel_basic_info','DESG_ID','PBI_ID='.$_SESSION['employee_selected']);?>">
                ...
                <div class="form-group row m-0 pb-1">
                <label for="technical" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Technical Allowance : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                ...
                <div class="form-group row m-0 pb-1">
                <label for="dislocation" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Dislocation Allowance : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
                ...
                <div class="form-group row m-0 pb-1">
                <label for="mobile_allowance" class="col-sm-4 col-md-4 col-lg-4 col-xl-4 m-0 p-0 d-flex justify-content-start align-items-center pr-1 bg-form-titel-text"> Mobile Allowance : </label>
                <div class="col-sm-8 col-md-8 col-lg-8 col-xl-8 p-0 pr-2 ">
