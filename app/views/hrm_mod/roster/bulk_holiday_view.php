      ...
      <table class="table1  table-striped table-bordered table-hover table-sm">
        ...
        <tbody class="tbody1">
          <?
						   ...
						   a.define_schedule,b.roster_date,c.holy_day
						   
						   
						   from 

							personnel_basic_info a,hrm_roster_allocation b,salary_holy_day_individual c

							where  a.PBI_ID=b.PBI_ID and a.PBI_ID=c.PBI_ID and c.holy_day = '".$_POST['fdate']."' and 
							
							b.roster_date='".$_POST['fdate']."'  ".$codeConn.$idConn.$genderConn.$NameConn.$ReligionConn.$DOJConn.$OrgConn.$classConn.$gradeConn.$work_station.
