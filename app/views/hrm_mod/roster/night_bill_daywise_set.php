  ...
  <div class="oe_view_manager oe_view_manager_current">
    <div class="oe_view_manager_body">
      ...
      <div class="oe_view_manager_view_form">
                        ...
                        <table width="100%" border="0" class="oe_list_content">
                          ...
                          <tbody>
						    <tr class="oe_list_header_columns">
                              <td colspan="6"><h3 align="center"><span style="font-size:14px; font-weight:bold;">Roster Day Set</span></div></td>
                            </tr>
                            <tr >
								<td width="10%"></td>
                              <td style="text-align:left";width="5%"><div align="left"><strong>Date :</strong></div></td>
                              <td style="text-align:left">
								  <div align="left">
									  <span class="oe_form_group_cell">
										<input name="roster_date" type="text" id="roster_date" value="<?=$_POST['roster_date']?>" required="required"  class="form-control"/>
									  </span>
								  </div>
							  </td>
							  
							  <td style="text-align:left";width="5%"><div class="pl-4" align="left"><strong>Company : </strong> </div></td>
                              <td style="text-align:left"><div align="left"><span class="oe_form_group_cell">
							  
							  							  
							  <select name="group_for" id="group_for"   onchange="getData2('ajax_location.php', 'loc', this.value,  this.value)" required="required"  class="form-control">
							...
							<tr>
                              <td></td>
                              <td  style="text-align: left"><div  align="left"><strong>Department : </strong></div></td>
                              <td><select name="department" id="department"  class="form-control">
							    <option selected="selected"></option><? foreign_relation('department', 'DEPT_ID', 'DEPT_DESC',$_POST['department'],'1')?>
                               
                              </select></td>
                              
							  							  
							  <td style="text-align:left";width="5%"><div class="pl-4" align="left"><strong>Job Location : </strong> </div></td>
                              <td style="text-align:left"><div align="left"><span class="oe_form_group_cell">
		...
		echo $sql = "select a.PBI_NAME,a.PBI_ID,a.PBI_DESIGNATION,a.PBI_DEPARTMENT from 
		personnel_basic_info a
		where  1 ".$con."  and a.PBI_JOB_STATUS='In Service' and employee_type like 'Roster' order by a.PBI_ID ";
		$query = db_query($sql);
		while($info=mysqli_fetch_object($query))
		{
...
<option selected="selected"></option><? foreign_relation('hrm_roster_point','id','point_short_name',$point_1,'group_for = "'.$_POST['group_for'].'"');?>
                                          </select>
                                        </span></td>
                                        <td><span class="oe_form_group_cell">
                                          <select name="shedule_1_<?=$info->PBI_ID?>" id="shedule_1_<?=$info->PBI_ID?>">
<option selected="selected"></option><? foreign_relation('hrm_schedule_info','id','schedule_name',$shedule_1,'group_for = "'.$_POST['group_for'].'"');?>
                                          </select>
                                          </span></td>
                                      </tr>
                                      <?
