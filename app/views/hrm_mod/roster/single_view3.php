...
$sec_name_con = " and PBI_DOMAIN='".$sec_name."'";
}
...
<tr class="oe_list_header_columns">
  <th colspan="4" style="text-align:center"><span style="text-align: center; font-size:18px; color:#09F">Single Attendance  Report (After IN OUT Process) </span></th>
  </tr>
<tr class="oe_list_header_columns">
  <th colspan="4" style="text-align:center"><span style="text-align: center; font-size:16px; color:#C00">Select Options</span></th>
  </tr>
</thead><tfoot>
</tfoot><tbody>
  ...
  <tr  class="alt">
	...
	<select name="PBI_ID" id="PBI_ID" required="required">
	<option><? if(isset($_POST['PBI_ID'])){ echo $_POST['PBI_ID']; }else{echo''; } ?></option>
	<?php 
...
$sql  = 'select iom_sl_no,leave_id,att_date from hrm_att_summary2 where emp_id="'.$PBI_ID.'" and  att_date between "'.$start_date.'" and "'.$end_date.'" and (iom_sl_no>0 or leave_id>0) order by att_date asc';
$query = db_query($sql);
while($data=mysqli_fetch_object($query)){
if($data->iom_sl_no>0)
