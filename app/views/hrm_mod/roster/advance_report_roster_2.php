...
<tr class="oe_list_header_columns">
  <th colspan="4" style="text-align:center"><span style="text-align: center; font-size:18px; color:#09F"> Roster Reporting</span></th>
  </tr>
<tr class="oe_list_header_columns">
         ...
         <div class="col-md-3 form-group">
           ...
           <div class="col-md-3 form-group">
            ...
            <input name="rcv_amt" type="text" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
			 ...
			 <div class="col-md-3 form-group">
            <label for="rcv_amt">PBI IN : </label>
            <input name="rcv_amt" type="text" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
            </div>
			 <div class="col-md-3 form-group">
            <label for="rcv_amt">Start Date : </label>
            <input name="rcv_amt" type="date" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
            </div>
			 <div class="col-md-3 form-group">
            <label for="rcv_amt">End Date : </label>
            <input name="rcv_amt" type="date" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
            </div>
			 <div class="col-md-3 form-group">
            ...
            <input name="rcv_amt" type="text" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
			 ...
			 <div class="col-md-3 form-group">
            <label for="rcv_amt">Schedule : </label>
            <input name="rcv_amt" type="text" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>" tabindex="101" />
            </div>
			 <div class="col-md-3 form-group">
