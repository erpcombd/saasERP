      ...
      <div class="oe_view_manager_view_form">
        ...
        <div style="opacity: 1; text-align: right;" class="oe_formview oe_view oe_form_editable">
          ...
          <div class="oe_form_container">
                        ...
                        <table width="100%" border="0" class="oe_list_content">
                          ...
                          <thead>
                            ...
                            <tr class="oe_list_header_columns">
                              ...
                              <th colspan="2" style="text-align:center;"><span style="text-align: center; font-size:18px; color:#09F">Roster Day Set</span></th>
            ...
            <label for="rcv_amt">Roster Schedule : </label>

            <input name="rcv_amt" type="date" class="form-control" id="rcv_amt"  value="<?=$rcv_amt?>"  />

            </div>

		  <div class="col-md-3 form-group">

            <label for="rcv_amt">Date: </label>
