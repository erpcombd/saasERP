...
//echo $dealer_code = $_SESSION['warehouse_id'];
...
<!--        <div><strong>Report Filter</strong></div>
		...
		<div class="col-6 p-1">
			...
			<input type="date" name="f_date" required="required" autocomplete="off" value="<?= date('Y-m-d') ?>" class="form-control validate-text" />
		</div>
 ...
 <!--new report     -->
      ...
      <div class="form-check icon-check">
        ...
        <label class="form-check-label" for="704">Draft Party Ledger Report(704)</label>
        <i class="icon-check-1 fa fa-circle color-gray-dark font-16"></i>
        <i class="icon-check-2 fa fa-check-circle font-16 color-highlight"></i>
      </div> 
