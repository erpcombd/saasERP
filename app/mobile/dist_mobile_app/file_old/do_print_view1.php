...
<div class="page-content header-clear-medium">
	<div class="d-flex justify-content-center row mt-0">
		<div class="col-6 ps-1 ">
			<a href="#" class="btn btn-m btn-full mb-3 rounded-xl text-uppercase text-center font-900 border-mint-dark color-mint-dark  bg-theme"> Print View</a>
		</div>
	</div>
	<div class="d-flex justify-content-end mx-5 row">
		<div class="col-4">
			<input onclick="window.print()" id="printButton" class="btn btn-3d btn-s btn-full mb-3 rounded-xs text-uppercase font-900 shadow-s border-mint-dark bg-mint-dark w-100" value="print">
		</div>
	</div>
		...
		<table class="table table-bordered text-center rounded-sm shadow-l" style="overflow: hidden;">
			<thead>
				<tr class="bg-night-light text-center">
					...
					<th scope="col" class="color-white">Total Amt</th>
				</tr>
			</thead>
			<tbody>
