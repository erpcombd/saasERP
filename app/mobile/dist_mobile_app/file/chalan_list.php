                            ...
                            <div class="d-flex gap-2 justify-content-end align-items-center">
								...
								<div class="w-50">
									   <a href="chalan_print.php?v=<?= $data->chalan_no ?>">
										<button class="b-n btn btn-warning btn-3d btn-block p-2 mb-1  text-light w-100" style=" height: 35px !important; padding-top: 5px !important;"><i class="fa-solid fa-print"></i></button>
										</a>
                                </div>
