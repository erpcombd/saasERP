  ...
  <div class="tab-group-1">
    <div class="card card-style">
      <div class="content mb-0">
        ...
        <div class="ms-auto float-end"> <a href="#" data-menu="scheduletask" class="icon icon-xxl bg-theme gradient-green color-white shadow-l rounded-m"><i class="fa fa-plus"></i></a> <span class="font-11 font-500 color-theme d-block">
          <center>
            Task
          </center>
          </span> </div>
    ...
    <div class="content" id="tab-group-1">
      <!-- All Tab -->
                    <?php
                                ...
                                ?>
      <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-1"> <a href="#" class="card mx-0 card-style">
        <div class="content">
