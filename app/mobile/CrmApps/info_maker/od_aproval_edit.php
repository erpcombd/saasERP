...
<form action="" method="post" enctype="multipart/form-data">
  <div class="oe_view_manager oe_view_manager_current mt-5 pb-5">
                    ...
                    <div class="card-body">
                      ...
                      <div class="card mb-4 bg-light">
                        <div class="card-body">
                          ...
                          <? 
                          $full_att_in = find_all_field('hrm_attdump_apps','*',' xdate="'.$full_att->xdate.'" order by sl asc');
                          $full_att_out = find_all_field('hrm_attdump_apps','*',' xdate="'.$full_att->xdate.'" order by sl desc');
                          ?>
                          
                          <div class="mb-4">
                            <label class="form-label fw-bold text-secondary">Location IN:</label>
                            <div class="border rounded overflow-hidden">
                              <iframe id="map" src="https://maps.google.com/maps?q=<?=$full_att_in->latitude?>,<?=$full_att_in->longitude?>&z=17&output=embed" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div class="border rounded overflow-hidden">
                              <iframe id="map" src="https://maps.google.com/maps?q=<?=$full_att_out->latitude?>,<?=$full_att_out->longitude?>&z=17&output=embed" width="100%" height="250" frameborder="0" style="border:0" allowfullscreen></iframe>
                            </div>
                          </div>
                        </div>
                      </div>
