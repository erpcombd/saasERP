...
<nav class="navbar navbar-light bg-light" style="box-shadow: 0 3px #888888;">
  <form class="form-inline">
    ...
    <div style="right;!important;">
                ...
                <a href="task_purpose.php?update=<?=encrypTS('new')?>" class="btn btn-outline-info btn-sm">Add New <i class="fa fa-plus-square" aria-hidden="true"></i></a>
                <a href="task_purpose.php" class="btn btn-outline-warning btn-sm">Refresh <i class="fa fa-refresh" aria-hidden="true"></i></a>
        </div>
</nav>
            ...
            <table id="example" class="table">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?=$row->entry_at?></td>
                        <td><a class="btn btn-sm <?php if($row->is_active=='1'){echo 'btn-warning';}else{echo 'btn-danger';}?>" href="task_purpose.php?update=<?=encrypTS($row->id)?>"><i class="fa-solid fa-pencil"></i></a></td>
                    </tr>
    ...
    <div class="modal fade bd-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg">
        ...
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">Task Purpose Management</h5>
          ...
          <h5 class=text-center>Purpose Information</h5>
            <div class="row">
            ...
            <div class="col-md-12">
                  <table class="table">
                    <tbody>
                      ...
                      <tr>
                        <td>Purpose Name: </td>
                        <td><input type="text" name="purpose" class="form-control" value="<?=$datas->purpose?>" style="border-left:3.5px solid #df5b5b!important;" required></td>
                      </tr>
