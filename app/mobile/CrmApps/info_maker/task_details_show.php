  ...
  <div data-card-height="230" class="card card-style round-medium shadow-huge top-30">
	...
	<div class="content">
			<div class="d-flex text-center px-2">
				...
				<div class="ms-auto">
					<a href="#" data-menu="scheduletask" class="icon icon-xxl bg-theme gradient-yellow color-white shadow-l rounded-m"><i class="far fa-sync"></i></a>
	...
	<div id="schedulemeeting" class="menu menu-box-bottom menu-box-detached">
		...
		<div class="input-style has-borders has-icon validate-field mb-4">
					...
					<label for="form1" class="color-highlight">Lead Organization</label>
                    <input type="name" class="form-control validate-name" id="form1"  value="<?=$orgname?>">
...
<!-- Request Task  ---- -->
	<div id="scheduletask" class="menu menu-box-bottom menu-box-detached">
		...
		<div class="input-style has-borders has-icon validate-field mb-4">
				...
				<div class="input-style has-borders no-icon mb-4">
                    <textarea id="form7" name="subject" placeholder="Task Name"></textarea>
				...
				<div class="input-style has-borders no-icon mb-4 input-style-active">
				   ...
				   <div class="input-style has-borders no-icon mb-4 input-style-active">
                    ...
                    <input type="date" name="remainder_date" class="form-control validate-text" id="date" placeholder="Remainder date">
                    <label for="form6" class="color-highlight">Task Date</label>
                    <i class="fa fa-check disabled valid me-4 pe-3 font-12 color-green-dark"></i>
                    <i class="fa fa-check disabled invalid me-4 pe-3 font-12 color-red-dark"></i>
                </div>
				   ...
				   <div class="input-style has-borders no-icon mb-4 input-style-active">
                    ...
                    <input type="time"  name="remainder_time" class="form-control validate-text" id="form6">
