...
var win = window.location.assign('../appsAtt/.php?sl='+lk, '');
win.focus();
}</script>-->
...
<div class="right_col" style="margin-top: 60px;" role="main">
...
*/
 ...
 <?php
   ...
   if ( isset($_GET['sl_no'])) {
    ...
    echo '<script type="text/javascript">parent.parent.document.location.href = "../appsAtt/od_aproval_edit.php";</script>';
    exit();
}
...
while($data = mysqli_fetch_object($queryd)){
  ...
  ?>
	...
	<a href="od_aproval_edit.php?sl=<?=$data->sl?>"> <button type="button" class="btn btn-primary"><i class="far fa-eye"></i></button></a>
