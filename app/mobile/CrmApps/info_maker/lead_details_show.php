...
$user_role  =  $_SESSION['user']['fname'];
 ...
 $orgname=$rows->name;
 $orgPerson=$rows->contact_person;
 $orgPhone=$rows->contact_number;
 $orgEmail=$rows->contact_email;
    ...
    <form method="post" action="">
	    ...
	    <div class="modal-body">
            ...
            <div class="content px-1">
                ...
                <div class="input-style has-borders no-icon mb-4 input-style-active">
                    <label for="priority_status" class="color-highlight"> Status</label>
                  	<select class="form-control req" name="status" id="status" required>
                ...
                <!--<div class="row mb-0">
                    <div class="col-6">
                        <div class="input-style has-borders no-icon mb-4 input-style-active">
                            ...
                            <input type="time" name="time"  class="form-control validate-text" id="deal_time">
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-style has-borders no-icon mb-4 input-style-active">
                            <label for="meeting_date" class="color-highlight text-uppercase font-700 font-10 mt-1">Meeting Date</label>
                            <input type="date" name="date" class="form-control validate-text" id="deal_date" style="width: 100%;">
                        </div>
                    </div>
                </div>-->
                ...
                <div class="input-style has-borders no-icon mb-4 input-style-active">
                    ...
                    <input type="text" id="deal_location"  name="location">
                </div>
                <div class="input-style has-borders no-icon mb-4 input-style-active">
                    <label for="meeting_subject" class="color-highlight">Meeting Subject</label>
					<input type="text" name="subject" id="deal_subject"/>
                
                </div>
                <div class="input-style has-borders no-icon mb-4 input-style-active">
                    <label for="meeting_details" class="color-highlight">Details</label>
						<input type="text" name="details" id="deal_details"/>
              
                </div>
                <button type="submit" name="UpdateMettingActivity" class="close-menu btn btn-full btn-m bg-blue-dark rounded-sm text-uppercase font-800 mb-4 width-100">Confirm</button>
            </div>
        </div>
    </form>
</div>   
...
<!--  Deal Status Start -->
	...
	<div id="UpdateDealStatus" class="menu menu-box-modal menu-box-detached">
		<form method="post">
			<div class="modal-body">
				...
				<div class="content px-1">
					<div class="input-style input-style-always-active no-borders no-icon">
						<label for="f1" class="color-theme opacity-30 text-uppercase font-700 font-10 mt-1">Select Stage</label>
						<select class="form-control req" name="status" id="status">
							<? foreign_relation('crm_deal_stage_status','id','status',$status,'1'); ?>
					...
					<input name="updatestatus" type="submit" id="updatestatus" value="Update" class="close-menu btn btn-full btn-m bg-highlight rounded-sm text-uppercase font-800 mb-3 width-100">
				</div>
			</div>
		</form>
	</div>
  ...
  <div class="page-content header-clear-medium">
              ...
              <?php
					$sqlTasks = "SELECT l.organization,l.lead_name,l.lead_value, l.assign_person, l.product, l.property_type, l.status, l.campaign,  l.req_loc, l.req_size, l.customer_bud, l.req_loan, l.cus_remarks, l.visitor_type, l.lead_source, l.lead_doc1, l.lead_doc2, l.lead_doc3, l.reamarks, o.id, o.assigned_person_id, o.name, o.website, o.total_employees, o.annual_revenue, o.lead_source, o.lead_type, o.company_name, o.address, o.city, o.zip, o.country, o.division, o.district, o.description, o.logo, o.visiting_card_img, o.product, o.lead 
					
					FROM crm_project_lead l, crm_project_org o WHERE  l.organization =o.id AND l.id= ".$id."";
  ...
  <div data-card-height="230" class="card card-style round-medium shadow-huge top-30">
            ...
            <div class="card-top mt-3 me-3">
                <a href="#" class="btn btn-m float-end rounded-xl shadow-xl text-uppercase font-800 <?=$class?> fa-2x mt-1 modal-icon bg-highligh"
				data-menu="UpdateDealStatus">
				<?=find_a_field('crm_deal_stage_status', 'status', 'id = "'.$row->status.'"')?></a>
	...
	<div class="card card-style">
            <div class="content mb-3">
                <h4 class="font-700 text-uppercase font-12 color-highlight opacity-70 mb-3 mt-n2">Deal Overview</h4>
				
				
                <div class="mb-3">
                    <div class="progress mb-4" style="height:7px;">
                     <div class="progress-bar bg-highlight" role="progressbar" 
					 style="width: <?=find_a_field('crm_deal_stage_status', 'probability', 'id = "'.$project_status.'"')?>%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
                    </div>
                    <div class="row mb-0">
                        <div class="col-6">
                            <h5 class="mt-n3">Probability (%)</h5>
                        </div>
                        <div class="col-6">
						     
				
               <h5 class="mt-n3 text-end color-red-dark"><?=find_a_field('crm_deal_stage_status', 'probability', 'id = "'.$project_status.'"')?> %</h5>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-0">
                     <div class="row mb-0">
                        <div class="col-6">
                            <h5 class="mt-n3">Start Date : 23 Aug 23 </h5>
                        </div>
                        <div class="col-6">
                            <h5 class="mt-n3 text-end color-blue-dark">CLOSING : 22 Jul 24</h5>
                        </div>
                    </div>
                </div>
...
<div class="card card-style">
       ...
       <h3>Product List</h3><p>
	   <button class="float-end bg-highlight btn btn-xs text-uppercase font-900 rounded-xl font-11" data-menu="addProduct">Add</button></p>
                ...
                <table class="table table-borderless text-center rounded-sm shadow-l" style="overflow: hidden;">
                    ...
                    <tbody>
					   ...
					   <?php
                               $sqlTasks = "SELECT * FROM crm_lead_products
                               JOIN crm_lead_product_individual ON crm_lead_products.id=crm_lead_product_individual.product_id WHERE 
                               crm_lead_product_individual.lead_id=$id;";
						$resultTasks = db_query($sqlTasks);
...
<!--Contact Information Section Start -->   
		...
		<?php /*?>   <div data-card-height="170" class="card card-style rounded-m shadow-xl bg-18">
...
<!--New Contact Information Section End -->				  	
...
<div class="d-flex text-center px-2">
    ...
    <div class="ms-auto">
        <a href="#" data-menu="scheduletasks" class="icon icon-xxl bg-theme gradient-yellow color-white shadow-l rounded-m">
...
<div class=" mb-0">
  ...
  <div class="card card-style">
    ...
    <?php /*?>    <button class="fa fa-edit color-brown-dark" data-menu="editmeetingmodal" onclick="openModalEditTask('<?=$row->activity_id;?>')"></button><?php */?>
      </div>
    </div>
    <!-- End of card-->
    <div class="content mb-0" id="tab-group-2">
      ...
      <div data-bs-parent="#tab-group-2" class="collapse show" id="tab-1">
       ...
       $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Meeting'  AND status in (1,3) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
  ...
  <a href="#" data-menu="editmeetingmodal" 
  onclick="taskedit('<?=$row->activity_id;?>','<?=$row->subject;?>','<?=$row->location;?>','<?=$row->details;?>')">
  <i class="fa font-14 fa-download color-blue-dark opacity-60"></i>Edit<i class="fa"></i></a> 
		
  <a href="#" data-menu="menu-delete"><i class="fa font-14 fa-trash color-red-dark opacity-60"></i>Delete<i class="fa"></i></a> </div>
              </div>
            </div>
          </div>
      ...
      <div data-bs-parent="#tab-group-2" class="collapse" id="tab-2" >
        <div class="list-group">
                   <?php
                                $currentDateTime = date("Y-m-d H:i:s");
         $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Meeting'  AND status in (2) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
    ...
    <div class="content mb-0" id="tab-group-1">
      ...
      <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-3">
        <div class="list-group">
          <?php
                                $currentDateTime = date("Y-m-d H:i:s");
         $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Call'  AND status in (1,2,3,4,5,6) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
          ...
          <div class="d-flex align-items-center justify-content-center">
            ...
            <div class="align-self-center ms-auto"> <a href="#" data-bs-toggle="dropdown" class="icon icon-m color-theme"><i class="fa fa-ellipsis-h"></i></a>
              <div class="dropdown-menu border-0 bg-theme rounded-m shadow-xl px-2 mt-n4">
                <div class="list-group list-custom-small mt-n2 mb-n2">  
				<a href="#" data-menu="editschedulecall" onclick="calledit('<?=$row->activity_id;?>','<?=$row->call_to;?>','<?=$row->call_type;?>','<?=$row->subject;?>')"><i class="fa font-14 fa-download color-blue-dark opacity-60"></i>Edit<i class="fa"></i></a> 
      ...
      <div data-bs-parent="#tab-group-1" class="collapse" id="tab-4" >
        <div class="list-group">
                   <?php
                                $currentDateTime = date("Y-m-d H:i:s");
         $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Call'  AND status in (7,8,9) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
...
<a href="#" data-menu="menu-transaction-1" onclick="taskedit('<?=$row->activity_id;?>')">
<i class="fa font-14 fa-download color-blue-dark opacity-60"></i>Edit<i class="fa"></i></a> 
    ...
    <div class="content mb-0" id="tab-group-1">
      ...
      <div data-bs-parent="#tab-group-1" class="collapse show" id="tab-5">
        <div class="list-group">
          <?php
                                $currentDateTime = date("Y-m-d H:i:s");
                             $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Task'  AND 
							 
							 status in (1,3) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
...
<a href="#" data-menu="edittaskmodal" onclick="taskedit('<?=$row->activity_id;?>')"><i class="fa font-14 fa-download color-blue-dark opacity-60"></i>Edit<i class="fa"></i></a> 
      ...
      <div data-bs-parent="#tab-group-1" class="collapse" id="tab-6" >
        <div class="list-group">
                   <?php
                                $currentDateTime = date("Y-m-d H:i:s");
                                $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE lead_id = $id AND activity_type = 'Task'  AND 
								status in (2) ORDER BY lead_id DESC;";
                                $resultTasks = db_query($sqlTasks);
    ...
    <!-- All Menus, Action Sheets, Modals, Notifications, Toasts, Snackbars get Placed outside the <div class="page-content"> -->
	      ...
	      <script>
                        document.addEventListener("DOMContentLoaded", function () {
						  ...
						  function taskedit(activityId,subject,location,details) {
                                console.log(activityId)
                                document.getElementById('activity_id').value = activityId;
							    document.getElementById('deal_subject').value = subject;
					            document.getElementById('deal_location').value = location;
								document.getElementById('deal_details').value = details;
						  ...
						  function calledit(activityId,call_to,subject) {
                                console.log(activityId)
                                document.getElementById('activity_id').value = activityId;
							    document.getElementById('deal_call_to').value = call_to;
								document.getElementById('deal_subject').value = subject;
...
<div class="input-style has-borders no-icon mb-4">
  ...
  <!-- ___________ Deal Status update option _________  -->
	
<!-- edit Meeting Modal -->
<div id="UpdateProjectStatus" class="menu menu-box-modal menu-box-detached">
    <div class="menu-title">
...
<!-- Edit Task Modal -->
<div id="scheduletasks" class="menu menu-box-modal menu-box-detached">
  <div class="menu-title">
    ...
    <div class="content px-1">
        <form method="post" action="">
	     ...
	     <input type="hidden" name="lead_id" id="lead_id" value="<?=$id?>" />
            ...
            <div class="input-style has-borders no-icon validate-field mb-4">
                <input type="text" name="call_to" class="form-control validate-text" id="deal_call_to" placeholder="Call To">
                <label for="call_to" class="color-highlight">Call To:</label>

            </div>
			
			<div class="input-style has-borders no-icon validate-field mb-4">
                <input type="text" name="subject" class="form-control validate-text" id="deal_subject" placeholder="Subject">
                <label for="call_to" class="color-highlight">Call Subject:</label>
            </div>
