  ...
  <div class="tab-group-1">
    <div class="card card-style">
      <div class="content mb-0">
        ...
        <div class="ms-auto float-end"> <a href="../info_maker/task_details_entry.php"  class="icon icon-xxl bg-theme gradient-green color-white shadow-l rounded-m"><i class="fa fa-plus"></i></a> <span class="font-11 font-500 color-theme d-block">
          <center>
            Task
          </center>
          </span> </div>
