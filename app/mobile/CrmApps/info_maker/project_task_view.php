    ...
    <div class="page-content header-clear-medium">
        ...
        <div class="calendar bg-theme shadow-xl rounded-m">
            <div class="cal-footer">
                <h6 class="cal-sub-title uppercase bold bg-highlight color-white">Individual Project Taks <?=$orgname?></h6>
               ...
               $sqlRemainder= "SELECT * FROM crm_task_add_information a WHERE lead_id = '".$_GET['lead_id']."'  AND status != 'cancelled' ORDER BY `task_id` DESC;";
