...
<a href="do_status.php"><button class="btn btn-print view-order-btn text-center" style="background-color:#00BCD4 !important; margin-left: 5px; color: #fff !important;">Back </button></a>
	<!--<div class=" mb-1">
		<img alt="this is img" src="../assets/images/logo/mepdemo.png" style=" 	width: 250px;" class="logo">
	</div>-->
				...
				<div class="col-6 table-responsive justify-content-end d-flex mb-2 ">
					<table cellspacing="0" cellpadding="2" border="0">
						<thead>
							...
							<td width="3%">:</td>
							<td width="60%">Tonmoy Electric</td>
							</tr>
							<tr>
								<td>Address</td>
								<td >:</td>
								<td >Rohim Uddin Plaza, M.A Khan Lane, Bogra</td>
							</tr>
							<tr>
								<td class="table2">Mobile No</td>
								<td >:</td>
								<td >8801711-869249</td>
