...
$unique = 'or_no'; // Fixed: should be 'or_no' not 'po_no'
$status = 'CHECKED';
...
if (isset($_POST['submitit'])) {
    ...
    $res = 'SELECT a.or_no, a.or_no as Replace_No, a.or_date as return_date, 
            ...
            WHERE a.receive_type = "Other Receive" 
                ...
                <table class="table table-borderless text-center table-scroll table_new_border" style="overflow: hidden;">
                    <thead>
                        <tr class="bg-night-light1">
                            <th scope="col" class="color-white">Replace Return NO </th>
                            <th scope="col" class="color-white">Replace Return Date</th>
                            <th scope="col" class="color-white">Party Code</th>
                            <th scope="col" class="color-white">Party Name</th>
                            <th scope="col" class="color-white">Replace Return Qty</th>
                            <th scope="col" class="color-white">Replace Return Amount</th>
                    ...
                    ?>
                            <tr>
                                ...
                                <td class="d-flex gap-2 justify-content-center align-items-center">
                                    <a href="receive_view.php?do=<?= urlencode($data->Replace_No); ?>"> 
