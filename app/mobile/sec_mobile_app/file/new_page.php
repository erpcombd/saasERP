        ...
        <div class="card card-style">
			<form action="">
				<div class="content">
					...
					<div class="input-style has-borders no-icon mb-4">
						<input type="date" value="2030-12-31" max="2030-01-01" min="2029-12-30" class="form-control validate-text" id="form6" placeholder="Phone">
			...
			<div class="content">
				<div class="d-flex pb-2">
					<div class="align-self-center pe-3">
						<img src="images/pictures/faces/2s.png" width="38" class="rounded-xl">
					</div>
