...
<div class="page-content header-clear-medium">
    ...
    <a href="return_sales_status.php" class="back_button "><button class="btn btn-print" style="background-color:#00BCD4 !important; margin-bottom: 3px; margin-left:5px; color: #fff !important;">Back </button></a>
					...
					<table  cellspacing="0" cellpadding="2" border="0" class="hhs  mb-2">
						<thead>
							...
							<tr>
								...
								<td  width="30%"> Sales Return NO </td>
								<td width="3%">:</td>
