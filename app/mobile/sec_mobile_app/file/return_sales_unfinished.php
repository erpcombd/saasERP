...
<label for="tdate">Type</label>
<select name="return_type" id="return_type" class="form-control validate-text">
	<option></option>
	<option value="INVOICE">INVOICE</option>
	<option value="MANUAL">MANUAL</option>
	<option value="CURRENT RATE">CURRENT RATE</option>
</select>
...
<?php	if(isset($_POST['submitit'])){
			...
			$con_type .= 'and a.return_type = "'.$_POST['return_type'].'"';
?>
<div class="card card-style">
