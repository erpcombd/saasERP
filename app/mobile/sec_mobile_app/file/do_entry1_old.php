						...
						<div class="content">
						  ...
						  <div class="d-flex justify-content-between align-items-center">
							  ...
							  <div class="text-end">
								...
								if($total_amt_data >0){ echo $total_amt_data; }else{?>
					...
					<table class="table table-borderless text-center table-scroll">
						...
						<tbody>
							...
							<tr class="sr-td-b1">
								...
								<td class="text_br"><?=$data->pcs; $gqty+=$data->pcs;?></td>
								<td class="text_br"><?=floatval($data->amt); $gamt+=$data->amt;?></td>
								<td><a href="?del=<?=$data->id?>" style=" color: red; ">&nbsp;<i class="fa-solid fa-trash"></i>&nbsp;</a></td>
							</tr>
							<? } ?>    
							<tr class="sr-td-b1"><td colspan='6' align="left"><span style='text-align:right;'> Total: </span></td>
