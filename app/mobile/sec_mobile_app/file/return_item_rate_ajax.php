...
<input name="nsp_per_<?=$data->item_id?>" type="number" max="<?=number_format($data->nsp_per, 2)?>"  id="nsp_per_<?=$data->item_id?>" onChange="update_nsp_amt(<?=$data->item_id?>)" value="<?=number_format($data->nsp_per, 2)?>"  readonly/>
								</td>
								...
								<td>
								 ...
								 <?php
								$final_total_amt_cal =  $data->pkt_unit*$nsp_amt_cus;
								 ?>	
								<td >
									<input name="total_amt_<?=$data->item_id?>" value="<?=$final_total_amt_cal?>" type="text"  id="total_amt_<?=$data->item_id?>" readonly />
