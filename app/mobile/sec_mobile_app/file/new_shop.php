            ...
            <div class="content">
                ...
                <div class="row mb-0">
                    <div class="col-6">
                        ...
                        <input type="text" class="form-control validate-text" name="manager_name" id="manager_name" value="" placeholder="Manager Name" >
                    </div>
                    <div class="col-6">
                ...
                <div class="row mb-0">
                    <!--<div class="col-6">
                        ...
                        <input type="text" class="form-control validate-text" name="electrician_name" id="electrician_name" placeholder="Electrician Name" >
                    </div>-->
                    <!--<div class="col-6">
                        <label for="mobile">Electrician Mobile No.</label>
                        <input type="number" class="form-control validate-text" name="electrician_mobile_no" id="electrician_mobile_no" value="8801" placeholder="Electrician mobile no" >
                    </div>-->
                </div>
                <div class="row mb-0">
                    <div class="col-6">
                ...
                <input type="text" class="form-control validate-text" name="cluster_market_name" id="cluster_market_name" value=""  placeholder="Enter cluster market name" >-->
