...
<div class="page-content header-clear-medium">
	...
	<div class="card card-style">
		<form action="<?= $page ?>" method="post" name="codz2" id="codz2" class="codz2" >
			<div class="content">
				<div class="row mb-0">
					<div class="col-6">
	...
	<input name="do_date" type="date" id="do_date" value="<?= ($do_date != '') ? $do_date : date('Y-m-d') ?>" required class="form-control validate-text" placeholder="Order Date" />
		...
		<? if ($$unique_master > 0) { ?>
			<style> .codz2{ display:none !important;}</style>
			<form action="<?= $page ?>" method="post" name="codz2" id="codz2">
				...
				<div class="content mt-2">
					<div class="row mb-0">
					<div class="col-12">
						<label for="form1" >Item Code</label>
					
						<select name="item_id" id="item_id" onchange="callthegetdata(this.value)" autocomplete="off" placeholder="Item Code" autofocus>
							<option></option>
...
<input name="pcs_price" type="text" id="pcs_price" readonly="" required="required" value="<?= $do_data->pcs_price; ?>" class="form-control validate-name" placeholder="Price" />
					...
					<div class="row d-flex justify-content-center">
						<div class="col-6">
				<input name="add" type="submit" id="add" value="ADD" class="btn  mt-3 btn-success w-100" />
						</div>
    ...
    <div class="content">
        <table class="table-borderless text-center table-scroll" style="width:100%; Zoom: 85% !important">
            <thead>
...
<!-- Method 2: Both horizontal and vertical scroll with fixed height -->
<div class="table-container" style="overflow: auto; width: 100%; max-height: 400px;">
    <div class="content">
        <table class="table-borderless text-center table-scroll" style="width:100%; Zoom: 85% !important">
				...
				<div class="container">
					...
					<div class="n-form-btn-class" align="center">
						<div class="row m-0 p-0">
							<div class="col-sm-6">
								<input name="delete" type="submit" class="b-n btn btn-danger btn-3d btn-block text-light w-100 py-3" value="DELETE SO" />
								<input name="do_no2" type="hidden" id="do_no2" value="<?= $$unique_master ?>" />
							</div>
							<div class="col-sm-6">
								<input name="do_date" type="hidden" id="do_date" value="<?= $do_date ?>" />
								<input name="confirm" type="submit" class="b-n btn btn-success btn-3d btn-block text-light w-100 py-3" value="CONFIRM SO" />
							</div>
