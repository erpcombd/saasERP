...
//var_dump($_SESSION);
$title = "Sales Return Current Wise";
$page = "return_sales_rate.php";
...
if(isset($_POST['new'])){
		...
		$_POST['return_type'] = 'CURRENT RATE';
		
		$$unique=$_SESSION['or_no2']=$crud->insert();
		//unset($$unique);
		$type=1;
		$msg=$title.'  No Created. (No :-'.$_SESSION['or_no2'].')';	
		?><script>window.location.href = "return_sales_rate_entry.php?or_no=<?=$$unique;?>";</script><?
		} else {
