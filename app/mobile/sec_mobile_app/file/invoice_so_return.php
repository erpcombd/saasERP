                ...
                <div class="row mb-1">
					...
					<div class="col-12">
							...
							<select  name="item_id" id="item_id" tabindex="1">
								<option></option>
								<?php if($_SESSION['subcategory_id']>0){ optionlist('select item_id,concat(finish_goods_code,"#",item_name) from item_info where 1  and subcategory_id="'.$_SESSION['subcategory_id'].'" and status="Active" order by item_name'); } ?>
							</select>
                    </div>
					...
					<table class="table table-borderless text-center table-scroll table_new_border" style="overflow: hidden;">
						...
						<tbody>	
							<?php
                             ...
                             and c.entry_by='".$emp_code."' " .$con.$shop_con.$item_con. "
