...
$sql = "SELECT * FROM ss_location_log WHERE ".$con.$user_con." and status='UNAPPROVED' ORDER BY id DESC";
 $query=db_query($sql);
...
?>                            
   							<tr>
								...
								<?php /*?><td><?=$data->access_date;?></td><?php */?>
								...
								<td><a href="daily_attendance_approved.php?id=<?=$data->id?>"><button class=" b-n btn btn-info btn-3d btn-block  text-light "><i class="fa-solid fa-eye"></i>	</button></a></td>
							</tr>	
