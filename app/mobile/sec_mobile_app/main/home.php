...
$total_visit =   find1("select COUNT(DISTINCT dealer_code) from ss_do_master where do_date='" . date('Y-m-d') . "' and entry_by='" . $emp_code . "'");


$query_r = db_query($sql_r);
$row_r = mysqli_fetch_object($query_r);

$count_target_Shops = find1("SELECT COUNT(*) FROM ss_shop WHERE route_id = '" . $row_r->route_id . "'");
...
for ($i = 0; $i < 4; $i++) {
	...
	$st = "select target_amount from ss_target_upload where target_year='" . $year . "' and target_month='" . $previousMonthNumber . "' and so_code='" . $emp_code . "'";
...
<?php /*?>		<div class="header header-fixed header-logo-center">
		...
		<div class="row mb-n2">
			...
			<div class="col-12 pe-2">
				<div class="card  card-style mx-0 mb-3">
					<div class="p-3 text-center">
						...
						?>
						<h4 class="font-700 text-uppercase font-12 opacity-80 mt-n2"><?= $region_name ?>-<?= $zone_name ?>-<?= $area_name ?> </h4>
			...
			<div class="col-6 pe-2">
				<div class="card borderWH card-style mx-0 mb-3">
					<div class="p-3">
						<h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2"> Total Outlet to visit</h4>
			...
			<div class="col-6 ps-2 pe-2">
				<div class="card borderWH card-style mx-0 mb-3">
					<div class="p-3">
						<h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2"> Visited Today</h4>
			...
			<div class="col-6 pe-2">
				<div class="card borderWH card-style mx-0 mb-3">
					<div class="p-3">
						<h4 class="font-700 text-uppercase font-12 opacity-50 mt-n2"> Total Sales This Month</h4>
	...
	<div class="card borderWH card-style">
		<div class="content">
			<h2 class="text-center">Sales Component </h2>
			<p class="text-center mt-n2 mb-1 font-11 color-highlight">Sales Component Yearly</p>
