                    ...
                    <div class="row ds-row">
                        <div class="col-md-6 col-sm-6 col-lg-12 d-flex justify-content-center align-items-center p-0">
                            <div class="col-12 w-100 ">
                                ...
                                <div style="text-align:center;margin-bottom: 10px; padding: 10px;" class="image-logo">
                                    <?
                                    $cloud_logo = "../assets/images/logo/Logo MEP Png.png";
                                    ...
                                    ?>
                                    <img alt="this is img" src="<?= $show_logo ?>" style=" width: 140px; margin-top: 60px;">
                                  ...
                                  <!--  <h1 class="header1 text-center">Welcome Back!</h1>-->
                                    <form>
                                        <div>
                                            ...
                                            <input type="text" autofocus="autofocus" name="uid" value="" class="form-control" id="username" placeholder="User ID" required>
