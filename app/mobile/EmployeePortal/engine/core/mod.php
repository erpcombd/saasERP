...

{
	...
	//add_to_sec_journal($proj_id, $jv_no, $jv_date, $config->cogs_ledger, $narration,   $data->total_amt, '0',  $tr_from, $tr_no,'',$tr_id, $cc_code, $group_for);
		 ...
		 $sql2 = 'select s.item_ledger as item_ledger,s.cogs_ledger as cogs_ledger, c.cost_amt as item_amt,i.sub_ledger_id from sale_do_chalan c, item_info i, item_sub_group s 
		...
		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data2->cogs_ledger, $narration,($data2->item_amt), '0',$tr_from, $tr_no,$data2->sub_ledger_id,$tr_id, $cc_code, $group_for);

		add_to_sec_journal($proj_id, $jv_no, $jv_date, $data2->item_ledger, $narration,   '0', ($data2->item_amt), $tr_from, $tr_no,$data2->sub_ledger_id,$tr_id, $cc_code, $group_for);
...
$d_sql = "select r.id as tr_id,r.amount,s.item_ledger,i.sub_ledger_id  from purchase_receive r,item_info i,item_sub_group s  where  r.pr_no=".$pr_no." and i.item_id=r.item_id and i.sub_group_id=s.sub_group_id";
...
add_to_sec_journal($proj_id, $jv_no, $jv_date, $data->item_ledger, $narration,($data->amount+$vat_on_purchase), '0', $tr_from, $pr_no,$data->sub_ledger_id,$data->tr_id,$cc_code,$group_for);
