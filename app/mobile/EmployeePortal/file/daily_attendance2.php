...
$office_location  = find_a_field('personnel_basic_info', 'JOB_LOC_ID', 'PBI_ID='.$PBI_ID);
// Configuration Constants
define('MAX_ATTENDANCE_DISTANCE', 600);
if($office_location == 110){
define('OFFICE_LATITUDE', 23.180277);
define('OFFICE_LONGITUDE', 89.206491);
}else{
define('OFFICE_LATITUDE', 23.840419931321687);
define('OFFICE_LONGITUDE', 90.3656383041611);
}
define('GOOGLE_MAPS_API_KEY', 'AIzaSyAlikB8yJL0j_2j_ofL0xIHR6WkmAWYBN8');
...
?>
   ...
   <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAlikB8yJL0j_2j_ofL0xIHR6WkmAWYBN8&libraries=places,geometry&callback=initMap" async defer onerror="handleMapLoadError()"></script>
