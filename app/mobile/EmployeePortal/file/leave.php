    ...
    <div class="card card-style">
        <form action="leave.php" method="post" id="form1">
            <div class="content m-0">
                ...
                <div class="row mb-0">
					<div class="col-12">
						<label for="form4">Leave Types </label>
						
					<select name="type" id="type" class="form-control validate-text">
                        <option value=""></option>
                        ...
                        <option value="7">Hajj Leave (HL)</option>
					...
					<div class="col-6">
						<label for="form4">Duration From </label>
						    <input type="date" name="s_date" id="s_date" class="form-control validate-text" onchange="calculateTotalDays()" placeholder="Duration From">
						
					</div>
					
					<div class="col-6">
						<label for="form4">Duration To </label>
						    <input type="date" name="e_date" id="e_date" class="form-control validate-text" onchange="calculateTotalDays()" placeholder="Duration To">
						
					</div>
					<div class="col-6">
						<label for="form4">Total Days </label>
						    <input type="text" name="total_days"  class="form-control validate-text" id="total_days" readonly="readonly">
						
					</div>
					<div class="col-6">
						<label for="form4">Reason </label>
						     <textarea id="form4" placeholder="" name="reason" required></textarea>
						
					</div>
					<div class="col-6">
						<label for="form4">Submission Date </label>
						     <input type="date" name="leave_apply_date" value="<?=$leave_apply_date?>" class="form-control validate-text" id="form6" placeholder="Submission Date">
						
					</div>
					<div class="col-6">
						<label for="form4">Joining Date </label>
						     <input type="date" name="leave_join_date" id="leave_join_date" value="<?php if($leave_join_date) echo $leave_join_date; ?>" class="form-control validate-text" placeholder="Joining Date After Leave">
						
					</div>	
					<div class="col-6">
						<label for="form4">Substitute </label>
					...
					<div class="col-6">
						<label for="form4">Supporting Doc </label>
                ...
                <div class="d-flex justify-content-center row mt-4">
                    <div class="col-6">
                        <input type="submit" name="save_leave" id="save_leave" value="Apply" class="btn btn-3d btn-m btn-full mb-0 b-n rounded-xs font-900 shadow-s btn-success w-100">
                    </div>
                </div>
