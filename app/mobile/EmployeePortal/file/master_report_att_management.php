...
FROM hrm_att_summary l, personnel_basic_info a where   a.PBI_ID=l.emp_id " . $pbi_con . $org_con . $date_con . $con . " group by l.emp_id order by a.DEPT_ID";
 ...
 att_date between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '"');
  ...
  <table style="width:auto;margin:0 auto;" cellpadding="0" cellspacing="0" border="1" id="ExportTable">
   ...
   FROM personnel_basic_info a  where a.PBI_ID not in (1006,1009,1007,1932,1952)  " . $con_pbi . $salaryConn . $basicConn . " 
   ...
   group by a.PBI_ID   order by a.DEPT_ID";
				...
				while ($r = mysqli_fetch_object($basic_query)) {
					...
					$ac_absent = find_a_field('hrm_att_summary', 'count(id)', 'emp_id="' . $r->PBI_ID . '" and absent =1 and dayname != "Friday" and att_date between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '"');
					...
					$extra_holy = find_a_field('salary_holy_day_individual', 'count(id)', 'PBI_ID="' . $r->PBI_ID . '"  and holy_day between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '"');
					
					$lt_summary = find_a_field('hrm_att_summary', 'count(id)', 'emp_id="' . $r->PBI_ID . '"  and att_date between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '" and late_min>30 and iom_type=""');
					
					$tot_iom = find_a_field('hrm_iom_info', 'count(total_days)', 'PBI_ID="' . $r->PBI_ID . '" and dept_head_status = "Approve" and iom_status= "GRANTED" and  e_date between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '"  and s_date between "' . $_POST['fdate'] . '" and  "' . $_POST['tdate'] . '"');
    ...
    <tr> 
	  ...
	  <td></td>
      <td><?= $present_days ?></td>
      <td><?= $payble_days-($ac_absent+$total_ld_days) ?></td>
  ...
  <table width="70%" cellspacing="0" cellpadding="2" border="0" style="margin:auto;">
    <thead>
      ...
      <tr>
        ...
        <th colspan="3"> <div align="center">Leave Availed</div></th>
