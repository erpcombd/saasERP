...
if (isset($_POST['punch_in']) || isset($_POST['punch_out'])) {
    $att_punch_in_id = $_POST['od_id']; 
    ...
    $status = isset($_POST['punch_in']) ? 'PROCESSING' : 'COMPLETED';
    ...
    $sql_att = 'INSERT INTO hrm_attdump (`ztime`, `bizid`, `EMP_CODE`, `xenrollid`, `time`, `xtime`, `xdate`, `xlocationid`, 
        ...
        "'.date('Y-m-d H:i:s').'", "'.date('Y-m-d').'", "999", "'.$_POST['latitude_od'].'", 
        "'.$_POST['longitude_od'].'", "'.$_POST['schedule_notes'].'", "'.$_POST['latitude_od'].'", 
        "'.$_POST['longitude_od'].'")';
    ...
    <form action="od_entry.php" method="post">
        <div class="content">
             <div class="row">
                <div class="col-md-4">
                            <div class="input-style has-borders no-icon mb-4 input-style-active">
                                ...
                                <label for="form2" class="color-highlight">Employee Code</label>
                ...
                <div class="col-md-4">
                 <div class="input-style-new input-style-always-active has-borders no-icon mb-4"> 
                    <label for="project_id" class="color-highlight">Project Name</label>
            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="input-style-new input-style-always-active has-borders no-icon mb-4">
                        <label for="end_time" class="color-highlight">Date</label>
                ...
                <div class="col-md-4">
                    ...
                    <div class="input-style-new input-style-always-active has-borders no-icon mb-4">
                        <label for="start_time" class="color-highlight">Start Time</label>
                ...
                <div class="col-md-4">
                    <div class="input-style-new input-style-always-active has-borders no-icon mb-4">
                        <label for="end_time" class="color-highlight">End Time</label>
...
<?php */?>
            ...
            <div class="d-flex justify-content-center row">
                <div class="col-6">
                    <input type="submit" name="save_leave" class="btn btn-3d btn-m btn-full mb-3 rounded-xs text-uppercase font-900 shadow-s border-mint-dark bg-mint-dark w-100" id="form1" value="Submit OD">
                </div>
            </div>
        </div>
    </form>
...
<table id="table2" name="table2" class="table table-bordered table-sm mt-4" style=" font-size: 11px !important;"> 
    <thead>
        <tr class="table-success" style="text-wrap: nowrap;">
            <th>SL</th>
            <!--<th>Lacation</th>-->
			<th>Punch</th>
            <th>Date Time</th>
...
?>
    <tr class="table-row">
		...
		<td>
		<form action="od_entry.php" method="post">
			<input type="hidden" name="od_id" id="od_id" class="form-control" required value="<?=$data2->id;?>"  readonly/>
		    <input type="hidden" name="latitude_od" id="latitude_od" class="form-control" required value="<?=$_POST['latitude_od']?>" readonly/>
        	<input type="hidden" name="longitude_od" id="longitude_od" class="form-control" required value="<?=$_POST['longitude_od']?>"  readonly/>   
			<input type="hidden" name="schedule_notes" id="schedule_notes" class="form-control" required value="OUT OF OFFICE"  readonly/>
		<? if ($data2->od_att_status == 'STARTED'){?>
		      <input type="submit" name="punch_in" class="btn btn-sm bg-mint-dark"value="In Punch">
		<? } elseif($data2->od_att_status == 'PROCESSING'){?> 
			 <input type="submit" name="punch_out" class="btn btn-sm btn-danger"value="Out Punch">
...
function showPosition(position) {
    ...
    document.getElementById("latitude_od").value = latitude;
    document.getElementById("longitude_od").value = longitude;
