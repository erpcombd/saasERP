  ...
  <div class="tab-group-1">
            <div class="card card-style">
				...
				<div class="ms-auto float-end">
					<a href="#" data-menu="scheduletask" class="icon icon-xxl bg-theme gradient-green color-white shadow-l rounded-m"><i class="fa fa-plus"></i></a>
					<span class="font-11 font-500 color-theme d-block"><center>Task</center></span>
				</div>
				   
				   			<div class="ms-auto float-end">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</div>
								
					<div class="ms-auto float-end">
			<a href="#" data-menu="schedulemeeting" class="icon icon-xxl bg-theme gradient-red color-white shadow-l rounded-m"><i class="fa fa-calendar"></i></a>
					<span class="font-11 font-500 color-theme d-block"> <center>Metting</center> </span>
				</div>
                ...
                <div class="tab-controls content tabs-small tabs-rounded" data-highlight="bg-blue-dark">
                    ...
                    <a href="#" data-bs-toggle="collapse" data-bs-target="#tab-3">PENDING</a>
                    <a href="#" data-bs-toggle="collapse" data-bs-target="#tab-4">CANCELLED</a>
          ...
          $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE entry_by = $u_id  AND status != 3 and mode ='postsale' ORDER BY `activity_id` DESC;";
...
<div class="position-absolute top-0 end-0 mt-3 me-3">
    <button class="fa fa-edit color-brown-dark" data-menu="edittaskmodal" onclick="openModalcancelmeeting('<?=$row->activity_id;?>')"></button>
								...
								<p class="font-11 mt-n2 mb-0 opacity-50">Company Name:<?=find_a_field('crm_project_org', 'name', 'id = "'.$row->project_id.'"')?></p>
                ...
                <!-- End of Feedback Section -->
                  ...
                  <?php } ?>
                    ...
                    <!--  COMPLETE Tab -->   
					        ...
					        <?php
                                $currentDateTime = date("Y-m-d H:i:s");
         $sqlTasks = "SELECT * FROM crm_lead_activity a WHERE entry_by = $u_id  AND status = '2' and mode ='postsale' ORDER BY activity_id DESC;";
                                $resultTasks = db_query($sqlTasks);
    ...
    <button class="fa fa-edit color-brown-dark" data-menu="edittaskmodal" onclick="openModalcancelmeeting('<?=$row->activity_id;?>')"></button>
                 ...
                 <?php } ?>
				   ...
				   <!-- PENDING  Tab -->    
	                                ...
	                                <?php
			    $currentDateTime = date("Y-m-d H:i:s");
				$sqlTasks = "SELECT * FROM crm_lead_activity a WHERE entry_by = $u_id AND status = '1' and mode ='postsale' ORDER BY activity_id DESC;";
							$resultTasks = db_query($sqlTasks);
