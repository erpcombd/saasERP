            ...
            <div class="content p-3">
                <div class="d-flex align-items-start">
                    <div>
                        ...
                        <p class="mb-1 f-14">
                            <strong>Route Name:</strong> <span class="text-primary"><?= htmlspecialchars($data->do_date) ?></span>
                        </p>
                        <p class="mb-1 f-14">
                            <strong>Shop Address:</strong> <span class="text-success"><?= htmlspecialchars($data->do_date) ?></span>
                        </p>
                        <p class="mb-1 f-14">
                            <strong>Owner Name:</strong> <span class="text-primary"><?= htmlspecialchars($data->do_date) ?></span>
                        </p>
                        <p class="mb-1 f-14">
                            <strong>Mobile No:</strong> <span class="text-danger"><?= htmlspecialchars($data->do_date) ?></span>
                        </p>
                    </div>
                    <div class="ms-auto">
