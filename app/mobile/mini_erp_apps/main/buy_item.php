...
?>
  ...
  <div class="container mt-5 pt-3">
        <!-- Header -->
        <h5 class="mb-3 text-danger">Select product to purchase</h5>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Supplier Mobile -->
                    <div class="mb-3">
                        <label class="form-label">Supplier Mobiler Number</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- Supplier Mobile -->
                    <div class="mb-3">
                        <label class="form-label">Supplier Mobiler Number  <span class="text-danger">*</span></label>
