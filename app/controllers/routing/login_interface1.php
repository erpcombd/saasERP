    ...
    <style type="text/css">
        ...
        *{
        ...
        body{
			...
			background: linear-gradient(45deg,#e84e10,#801b61);
        }
        .AppFormLeft{
            width: 300px;
        }
        ...
        .AppForm .AppFormRight{
			...
			background: linear-gradient(45deg,#cd3b00,#060506);
            height: 100%;
...
<div><?=$_SESSION['mmsg'];unset($_SESSION['mmsg']);?></div>
                            ...
                            <div style="display:none" class="form-group position-relative mb-4">
                                <input type="hidden" autofocus="autofocus" name="cid" value="<?=$cid?>" class="form-control border-top-0 border-right-0 border-left-0 rounded-0 shadow-none" id="Companyid" placeholder="Company ID" required>
                    ...
                    <div class="col-md-6 p-0 sec-display" >
                        <div class="AppFormRight position-relative d-flex justify-content-center flex-column align-items-center text-center p-5 text-white">
                            <img src="../../../../public/assets/images/login/erp01.png" class="w-100" height="100%" alt="The is Image">
                        </div>
                    </div>
                </div>
            </div>
